...
public final class PartnerCryptoAsset extends Message {
    ...
    public PartnerCryptoAsset() {
        this(null, null, null, false, null, 31, null);
    }

    public /* synthetic */ PartnerCryptoAsset(String str, String str2, List list, boolean z, ByteString byteString, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public /* bridge */ /* synthetic */ Message.Builder newBuilder() {
        return (Message.Builder) m27916newBuilder();
    }
    ...
    public PartnerCryptoAsset(String asset_symbol, String asset_name, List<PartnerAssetBalance> balance, boolean z, ByteString unknownFields) {
    ...
    public /* synthetic */ Void m27916newBuilder() {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PartnerCryptoAsset)) {
            return false;
        }
        PartnerCryptoAsset partnerCryptoAsset = (PartnerCryptoAsset) other;
        return Intrinsics.areEqual(unknownFields(), partnerCryptoAsset.unknownFields()) && Intrinsics.areEqual(this.asset_symbol, partnerCryptoAsset.asset_symbol) && Intrinsics.areEqual(this.asset_name, partnerCryptoAsset.asset_name) && Intrinsics.areEqual(this.balance, partnerCryptoAsset.balance) && this.is_supported == partnerCryptoAsset.is_supported;
    }
    ...
    public String toString() {
        ...
        return CollectionsKt.joinToString$default(arrayList, ", ", "PartnerCryptoAsset{", "}", 0, null, null, 56, null);
    }

    public static /* synthetic */ PartnerCryptoAsset copy$default(PartnerCryptoAsset partnerCryptoAsset, String str, String str2, List list, boolean z, ByteString byteString, int i, Object obj) {
        if ((i & 1) != 0) {
            str = partnerCryptoAsset.asset_symbol;
        }
        if ((i & 2) != 0) {
            str2 = partnerCryptoAsset.asset_name;
        }
        if ((i & 4) != 0) {
            list = partnerCryptoAsset.balance;
        }
        if ((i & 8) != 0) {
            z = partnerCryptoAsset.is_supported;
        }
        if ((i & 16) != 0) {
            byteString = partnerCryptoAsset.unknownFields();
        }
        ByteString byteString2 = byteString;
        List list2 = list;
        return partnerCryptoAsset.copy(str, str2, list2, z, byteString2);
    }

    public final PartnerCryptoAsset copy(String asset_symbol, String asset_name, List<PartnerAssetBalance> balance, boolean is_supported, ByteString unknownFields) {
        Intrinsics.checkNotNullParameter(asset_symbol, "asset_symbol");
        Intrinsics.checkNotNullParameter(asset_name, "asset_name");
        Intrinsics.checkNotNullParameter(balance, "balance");
        Intrinsics.checkNotNullParameter(unknownFields, "unknownFields");
        return new PartnerCryptoAsset(asset_symbol, asset_name, balance, is_supported, unknownFields);
    }

    static {
        final FieldEncoding fieldEncoding = FieldEncoding.LENGTH_DELIMITED;
        final KClass orCreateKotlinClass = Reflection.getOrCreateKotlinClass(PartnerCryptoAsset.class);
        final Syntax syntax = Syntax.PROTO_3;
        ADAPTER = new ProtoAdapter<PartnerCryptoAsset>(fieldEncoding, orCreateKotlinClass, syntax) { // from class: crypto_portkey.service.v1.PartnerCryptoAsset$Companion$ADAPTER$1
            @Override // com.squareup.wire.ProtoAdapter
            public int encodedSize(PartnerCryptoAsset value) {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(ProtoWriter writer, PartnerCryptoAsset value) throws IOException {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(ReverseProtoWriter writer, PartnerCryptoAsset value) throws IOException {
                Intrinsics.checkNotNullParameter(writer, "writer");
                Intrinsics.checkNotNullParameter(value, "value");
                writer.writeBytes(value.unknownFields());
                if (value.getIs_supported()) {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public PartnerCryptoAsset decode(ProtoReader reader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag == -1) {
                        return new PartnerCryptoAsset(strDecode, strDecode2, arrayList, zBooleanValue, reader.endMessageAndGetUnknownFields(jBeginMessage));
                    }
                    if (iNextTag == 1) {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public PartnerCryptoAsset redact(PartnerCryptoAsset value) {
                Intrinsics.checkNotNullParameter(value, "value");
                return PartnerCryptoAsset.copy$default(value, null, null, Internal.m26823redactElements(value.getBalance(), PartnerAssetBalance.ADAPTER), false, ByteString.EMPTY, 11, null);
            }
        };
    }
}

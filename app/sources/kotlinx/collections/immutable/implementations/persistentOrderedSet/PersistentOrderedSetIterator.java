...
public class PersistentOrderedSetIterator<E> implements Iterator<E>, KMarkers {
    ...
    public PersistentOrderedSetIterator(Object obj, Map<E, PersistentOrderedSet3> map) {
    ...
    public E next() {
        ...
        this.index++;
        PersistentOrderedSet3 persistentOrderedSet3 = this.map.get(e);
        if (persistentOrderedSet3 != null) {
            this.nextElement = persistentOrderedSet3.getNext();
            return e;
        }

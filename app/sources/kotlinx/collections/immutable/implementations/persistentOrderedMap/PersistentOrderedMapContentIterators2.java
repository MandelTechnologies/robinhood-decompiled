...
public final class PersistentOrderedMapContentIterators2<K, V> implements Iterator<K>, KMarkers {
    ...
    public PersistentOrderedMapContentIterators2(PersistentOrderedMap<K, V> map) {

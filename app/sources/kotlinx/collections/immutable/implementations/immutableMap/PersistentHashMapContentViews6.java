...
/* renamed from: kotlinx.collections.immutable.implementations.immutableMap.PersistentHashMapValues, reason: use source file name */
/* loaded from: classes14.dex */
public final class PersistentHashMapContentViews6<K, V> extends AbstractCollection<V> implements ImmutableCollection<V> {
    private final PersistentHashMap<K, V> map;

    public PersistentHashMapContentViews6(PersistentHashMap<K, V> map) {

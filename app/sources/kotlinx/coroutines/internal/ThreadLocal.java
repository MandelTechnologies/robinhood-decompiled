...
public final class ThreadLocal<T> implements ThreadContextElement<T> {
    ...
    public CoroutineContext minusKey(CoroutineContext.Key<?> key) {
        return Intrinsics.areEqual(getKey(), key) ? CoroutineContextImpl6.INSTANCE : this;
    }

...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public SafeCollector(FlowCollector<? super T> flowCollector, CoroutineContext coroutineContext) {
        super(SafeCollector3.INSTANCE, CoroutineContextImpl6.INSTANCE);
    ...
    @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2, kotlin.coroutines.jvm.internal.CoroutineStackFrame
    ...
    public CoroutineContext getContext() {
        ...
        return coroutineContext == null ? CoroutineContextImpl6.INSTANCE : coroutineContext;
    }
    ...
    protected Object invokeSuspend(Object result) {
        ...
        if (thM28553exceptionOrNullimpl != null) {
            this.lastEmissionContext = new SafeCollector2(thM28553exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion_;
    ...
    @Override // kotlin.coroutines.jvm.internal.ContinuationImpl, kotlin.coroutines.jvm.internal.ContinuationImpl2
    ...
    public Object emit(T t, Continuation<? super Unit> continuation) {
        try {
            ...
            this.lastEmissionContext = new SafeCollector2(th, continuation.getContext());
            throw th;
        }
    }

    private final Object emit(Continuation<? super Unit> uCont, T value) {
        CoroutineContext coroutineContext = uCont.getContext();
        ...
        Function3 function3 = SafeCollector4.emitFun;
    ...
    private final void checkContext(CoroutineContext currentContext, CoroutineContext previousContext, T value) {
        if (previousContext instanceof SafeCollector2) {
            exceptionTransparencyViolated((SafeCollector2) previousContext, value);
        }
        SafeCollector_commonKt.checkContext(this, currentContext);
    }

    private final void exceptionTransparencyViolated(SafeCollector2 exception, Object value) {

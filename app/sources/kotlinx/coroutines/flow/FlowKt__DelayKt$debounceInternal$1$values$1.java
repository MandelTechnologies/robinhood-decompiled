...
@DebugMetadata(m3644c = "kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$values$1", m3645f = "Delay.kt", m3646l = {204}, m3647m = "invokeSuspend")
/* loaded from: classes14.dex */
final class FlowKt__DelayKt$debounceInternal$1$values$1 extends ContinuationImpl7 implements Function2<Produce4<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke2(Produce4<Object> produce4, Continuation<? super Unit> continuation) {
        return ((FlowKt__DelayKt$debounceInternal$1$values$1) create(produce4, continuation)).invokeSuspend(Unit.INSTANCE);
    }

    /* compiled from: Delay.kt */
    @Metadata(m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    /* renamed from: kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$values$1$1 */
    static final class C460811<T> implements FlowCollector {
        final /* synthetic */ Produce4<Object> $$this$produce;

        C460811(Produce4<Object> produce4) {
        ...
        */
        public final Object emit(T t, Continuation<? super Unit> continuation) {
            ...
            if (i2 == 0) {
                ...
                if (produce4.send(t, flowKt__DelayKt$debounceInternal$1$values$1$1$emit$1) == coroutine_suspended) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            C460811 c460811 = new C460811(produce4);
            this.label = 1;
            if (flow.collect(c460811, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {

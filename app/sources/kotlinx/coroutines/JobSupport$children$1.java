...
@Metadata(m3635d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\n"}, m3636d2 = {"<anonymous>", "", "Lkotlin/sequences/SequenceScope;", "Lkotlinx/coroutines/Job;"}, m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
@DebugMetadata(m3644c = "kotlinx.coroutines.JobSupport$children$1", m3645f = "JobSupport.kt", m3646l = {1003, ErrorCodes.SOCKET_TIMEOUT_EXCEPTION}, m3647m = "invokeSuspend")
@SourceDebugExtension
/* loaded from: classes14.dex */
final class JobSupport$children$1 extends ContinuationImpl5 implements Function2<SequenceBuilder2<? super Job>, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(SequenceBuilder2<? super Job> sequenceBuilder2, Continuation<? super Unit> continuation) {
        return ((JobSupport$children$1) create(sequenceBuilder2, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (state$kotlinx_coroutines_core instanceof ChildHandleNode) {
                Job3 job3 = ((ChildHandleNode) state$kotlinx_coroutines_core).childJob;
                this.label = 1;
            ...
            if (!Intrinsics.areEqual(nextNode, lockFreeLinkedListHead)) {
                if (nextNode instanceof ChildHandleNode) {
                    Job3 job32 = ((ChildHandleNode) nextNode).childJob;

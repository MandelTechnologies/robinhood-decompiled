...
public final class CoroutineStart {
    ...
    static {
        ...
        $ENTRIES = EnumEntries2.enumEntries(coroutineStartArr$values);
    }
    ...
    public final <R, T> void invoke(Function2<? super R, ? super Continuation<? super T>, ? extends Object> block, R receiver, Continuation<? super T> completion) {
        ...
        if (i == 1) {
            Cancellable2.startCoroutineCancellable(block, receiver, completion);
            return;
        }
        if (i == 2) {
            Continuation3.startCoroutine(block, receiver, completion);
        } else if (i == 3) {
            Undispatched.startCoroutineUndispatched(block, receiver, completion);
        } else if (i != 4) {

...
public final class Unconfined extends CoroutineDispatcher {
    ...
    public void dispatch(CoroutineContext context, Runnable block) {
        Unconfined2 unconfined2 = (Unconfined2) context.get(Unconfined2.INSTANCE);
        if (unconfined2 != null) {
            unconfined2.dispatcherWasUnconfined = true;
            return;
        }

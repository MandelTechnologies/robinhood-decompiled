...
public final class Supervisor3 {
    ...
    public static final <R> Object supervisorScope(Function2<? super CoroutineScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        Supervisor supervisor = new Supervisor(continuation.get$context(), continuation);
        Object objStartUndispatchedOrReturn = Undispatched.startUndispatchedOrReturn(supervisor, supervisor, function2);

...
@Metadata(m3635d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010 \n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0007\u001a\u001f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u0001¢\u0006\u0004\b\u0005\u0010\u0006\u001a!\u0010\u0007\u001a\n\u0012\u0004\u0012\u00020\u0004\u0018\u00010\u0003*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u0001¢\u0006\u0004\b\u0007\u0010\u0006\u001a-\u0010\f\u001a\n\u0012\u0004\u0012\u00020\u0004\u0018\u00010\u0003*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u00012\b\b\u0002\u0010\t\u001a\u00020\bH\u0002¢\u0006\u0004\b\n\u0010\u000b\u001a/\u0010\u0010\u001a\n\u0012\u0004\u0012\u00020\u0004\u0018\u00010\u0003*\u00020\u00002\n\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\r2\u0006\u0010\t\u001a\u00020\bH\u0002¢\u0006\u0004\b\u000e\u0010\u000f\u001aI\u0010\u0017\u001a\n\u0012\u0004\u0012\u00028\u0000\u0018\u00010\u0003\"\b\b\u0000\u0010\u0011*\u00020\u0004*\u00020\u00002\f\u0010\u0012\u001a\b\u0012\u0004\u0012\u00028\u00000\r2\u0014\u0010\u0014\u001a\u0010\u0012\f\u0012\n\u0012\u0006\u0012\u0004\u0018\u00010\u00040\u00030\u0013H\u0002¢\u0006\u0004\b\u0015\u0010\u0016\u001a+\u0010\u001b\u001a\n\u0012\u0004\u0012\u00020\u0004\u0018\u00010\u0003*\u00020\u00002\u0006\u0010\u0002\u001a\u00020\u00182\u0006\u0010\t\u001a\u00020\bH\u0002¢\u0006\u0004\b\u0019\u0010\u001a\u001a\u0017\u0010\u001e\u001a\u0006\u0012\u0002\b\u00030\r*\u00020\u0001H\u0002¢\u0006\u0004\b\u001c\u0010\u001d¨\u0006\u001f"}, m3636d2 = {"Lkotlinx/serialization/modules/SerializersModule;", "Ljava/lang/reflect/Type;", "type", "Lkotlinx/serialization/KSerializer;", "", "serializer", "(Lkotlinx/serialization/modules/SerializersModule;Ljava/lang/reflect/Type;)Lkotlinx/serialization/KSerializer;", "serializerOrNull", "", "failOnMissingTypeArgSerializer", "serializerByJavaTypeImpl$SerializersKt__SerializersJvmKt", "(Lkotlinx/serialization/modules/SerializersModule;Ljava/lang/reflect/Type;Z)Lkotlinx/serialization/KSerializer;", "serializerByJavaTypeImpl", "Ljava/lang/Class;", "typeSerializer$SerializersKt__SerializersJvmKt", "(Lkotlinx/serialization/modules/SerializersModule;Ljava/lang/Class;Z)Lkotlinx/serialization/KSerializer;", "typeSerializer", "T", "jClass", "", "typeArgumentsSerializers", "reflectiveOrContextual$SerializersKt__SerializersJvmKt", "(Lkotlinx/serialization/modules/SerializersModule;Ljava/lang/Class;Ljava/util/List;)Lkotlinx/serialization/KSerializer;", "reflectiveOrContextual", "Ljava/lang/reflect/GenericArrayType;", "genericArraySerializer$SerializersKt__SerializersJvmKt", "(Lkotlinx/serialization/modules/SerializersModule;Ljava/lang/reflect/GenericArrayType;Z)Lkotlinx/serialization/KSerializer;", "genericArraySerializer", "prettyClass$SerializersKt__SerializersJvmKt", "(Ljava/lang/reflect/Type;)Ljava/lang/Class;", "prettyClass", "kotlinx-serialization-core"}, m3637k = 5, m3638mv = {2, 0, 0}, m3640xi = 48, m3641xs = "kotlinx/serialization/SerializersKt")
@SourceDebugExtension
/* renamed from: kotlinx.serialization.SerializersKt__SerializersJvmKt, reason: use source file name */
/* loaded from: classes14.dex */
final /* synthetic */ class SerializersJvm {
    public static final KSerializer<Object> serializer(SerializersModule serializersModule, Type type2) {
        Intrinsics.checkNotNullParameter(serializersModule, "<this>");
        Intrinsics.checkNotNullParameter(type2, "type");
        KSerializer<Object> kSerializerSerializerByJavaTypeImpl$SerializersKt__SerializersJvmKt = serializerByJavaTypeImpl$SerializersKt__SerializersJvmKt(serializersModule, type2, true);
        ...
        Platform2.serializerNotRegistered(prettyClass$SerializersKt__SerializersJvmKt(type2));
    ...
    public static final KSerializer<Object> serializerOrNull(SerializersModule serializersModule, Type type2) {
        Intrinsics.checkNotNullParameter(serializersModule, "<this>");
        Intrinsics.checkNotNullParameter(type2, "type");
        return serializerByJavaTypeImpl$SerializersKt__SerializersJvmKt(serializersModule, type2, false);
    }

    static /* synthetic */ KSerializer serializerByJavaTypeImpl$SerializersKt__SerializersJvmKt$default(SerializersModule serializersModule, Type type2, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return serializerByJavaTypeImpl$SerializersKt__SerializersJvmKt(serializersModule, type2, z);
    }

    private static final KSerializer<Object> serializerByJavaTypeImpl$SerializersKt__SerializersJvmKt(SerializersModule serializersModule, Type type2, boolean z) {
        ArrayList<KSerializer> arrayList;
        if (type2 instanceof GenericArrayType) {
            return genericArraySerializer$SerializersKt__SerializersJvmKt(serializersModule, (GenericArrayType) type2, z);
        }
        if (type2 instanceof Class) {
            return typeSerializer$SerializersKt__SerializersJvmKt(serializersModule, (Class) type2, z);
        }
        if (type2 instanceof ParameterizedType) {
            ...
            if (z) {
                ...
                for (Type type4 : actualTypeArguments) {
                    ...
                    KSerializer<Object> kSerializerSerializerOrNull = SerializersKt.serializerOrNull(serializersModule, type4);
            ...
            if (Set.class.isAssignableFrom(cls)) {
                KSerializer<Object> kSerializerSetSerializer = BuiltinSerializers.SetSerializer((KSerializer) arrayList.get(0));
            ...
            if (List.class.isAssignableFrom(cls) || Collection.class.isAssignableFrom(cls)) {
                KSerializer<Object> kSerializerListSerializer = BuiltinSerializers.ListSerializer((KSerializer) arrayList.get(0));
            ...
            if (Map.class.isAssignableFrom(cls)) {
                KSerializer<Object> kSerializerMapSerializer = BuiltinSerializers.MapSerializer((KSerializer) arrayList.get(0), (KSerializer) arrayList.get(1));
            ...
            if (Map.Entry.class.isAssignableFrom(cls)) {
                KSerializer<Object> kSerializerMapEntrySerializer = BuiltinSerializers.MapEntrySerializer((KSerializer) arrayList.get(0), (KSerializer) arrayList.get(1));
            ...
            if (Tuples2.class.isAssignableFrom(cls)) {
                KSerializer<Object> kSerializerPairSerializer = BuiltinSerializers.PairSerializer((KSerializer) arrayList.get(0), (KSerializer) arrayList.get(1));
            ...
            if (Tuples3.class.isAssignableFrom(cls)) {
                KSerializer<Object> kSerializerTripleSerializer = BuiltinSerializers.TripleSerializer((KSerializer) arrayList.get(0), (KSerializer) arrayList.get(1), (KSerializer) arrayList.get(2));
    ...
    private static final KSerializer<Object> typeSerializer$SerializersKt__SerializersJvmKt(SerializersModule serializersModule, Class<?> cls, boolean z) {
        ...
        if (cls.isArray() && !cls.getComponentType().isPrimitive()) {
            ...
            KClass kotlinClass = JvmClassMapping.getKotlinClass(componentType);
            Intrinsics.checkNotNull(kotlinClass, "null cannot be cast to non-null type kotlin.reflect.KClass<kotlin.Any>");
            KSerializer<Object> kSerializerArraySerializer = BuiltinSerializers.ArraySerializer(kotlinClass, kSerializerSerializerOrNull);
    ...
    private static final <T> KSerializer<T> reflectiveOrContextual$SerializersKt__SerializersJvmKt(SerializersModule serializersModule, Class<T> cls, List<? extends KSerializer<Object>> list) {
        ...
        KSerializer<T> kSerializerConstructSerializerForGivenTypeArgs = Platform2.constructSerializerForGivenTypeArgs(cls, (KSerializer<Object>[]) Arrays.copyOf(kSerializerArr, kSerializerArr.length));
        if (kSerializerConstructSerializerForGivenTypeArgs != null) {
            return kSerializerConstructSerializerForGivenTypeArgs;
        }
        KClass<T> kotlinClass = JvmClassMapping.getKotlinClass(cls);
    ...
    private static final KSerializer<Object> genericArraySerializer$SerializersKt__SerializersJvmKt(SerializersModule serializersModule, GenericArrayType genericArrayType, boolean z) {
        ...
        if (genericComponentType instanceof ParameterizedType) {
            ...
            Intrinsics.checkNotNull(rawType, "null cannot be cast to non-null type java.lang.Class<*>");
            kotlinClass = JvmClassMapping.getKotlinClass((Class) rawType);
        } else {
    ...
    private static final Class<?> prettyClass$SerializersKt__SerializersJvmKt(Type type2) {
        if (type2 instanceof Class) {
            return (Class) type2;
        }
        if (type2 instanceof ParameterizedType) {

...
public final class JsonElementSerializers implements KSerializer<JsonElement2> {
    ...
    private static final class JsonArrayDescriptor implements SerialDescriptor {
        ...
        private final /* synthetic */ SerialDescriptor $$delegate_0 = BuiltinSerializers.ListSerializer(JsonElementSerializers2.INSTANCE).getDescriptor();
    ...
    public void serialize(Encoding4 encoder, JsonElement2 value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        JsonElementSerializers3.verify(encoder);
        BuiltinSerializers.ListSerializer(JsonElementSerializers2.INSTANCE).serialize(encoder, value);
    }

    @Override // kotlinx.serialization.KSerializer2
    public JsonElement2 deserialize(Decoding2 decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        JsonElementSerializers3.verify(decoder);
        return new JsonElement2((List) BuiltinSerializers.ListSerializer(JsonElementSerializers2.INSTANCE).deserialize(decoder));
    }
}

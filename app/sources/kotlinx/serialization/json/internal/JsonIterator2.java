...
final class JsonIterator2<T> implements Iterator<T>, KMarkers {
    ...
    public JsonIterator2(Json json, ReaderJsonLexer lexer, KSerializer2<? extends T> deserializer) {

...
public final class Json4 {
    ...
    public final JsonConfiguration build$kotlinx_serialization_json() {
        if (this.useArrayPolymorphism) {
            ...
            if (this.classDiscriminatorMode != JsonConfiguration2.POLYMORPHIC) {

...
public interface Encoding3 {
    ...
    Encoding4 encodeInlineElement(SerialDescriptor descriptor, int index);
    ...
    <T> void encodeNullableSerializableElement(SerialDescriptor descriptor, int index, KSerializer3<? super T> serializer, T value);

    <T> void encodeSerializableElement(SerialDescriptor descriptor, int index, KSerializer3<? super T> serializer, T value);

...
public abstract class AbstractDecoder implements Decoding2, Decoding {
    ...
    @Override // kotlinx.serialization.encoding.Decoding
    public Decoding2 decodeInlineElement(SerialDescriptor descriptor, int index) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
    ...
    @Override // kotlinx.serialization.encoding.Decoding
    public final <T> T decodeNullableSerializableElement(SerialDescriptor descriptor, int index, KSerializer2<? extends T> deserializer, T previousValue) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        Intrinsics.checkNotNullParameter(deserializer, "deserializer");

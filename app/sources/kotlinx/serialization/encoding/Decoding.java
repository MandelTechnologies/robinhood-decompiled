...
public interface Decoding {
    ...
    Decoding2 decodeInlineElement(SerialDescriptor descriptor, int index);

    int decodeIntElement(SerialDescriptor descriptor, int index);

    long decodeLongElement(SerialDescriptor descriptor, int index);

    <T> T decodeNullableSerializableElement(SerialDescriptor descriptor, int index, KSerializer2<? extends T> deserializer, T previousValue);

    boolean decodeSequentially();

    <T> T decodeSerializableElement(SerialDescriptor descriptor, int index, KSerializer2<? extends T> deserializer, T previousValue);
    ...
    /* renamed from: kotlinx.serialization.encoding.CompositeDecoder$DefaultImpls */
    public static final class DefaultImpls {
        public static int decodeCollectionSize(Decoding decoding, SerialDescriptor descriptor) {
            Intrinsics.checkNotNullParameter(descriptor, "descriptor");
            return -1;
        }

        public static boolean decodeSequentially(Decoding decoding) {
            return false;
        }

        public static /* synthetic */ Object decodeSerializableElement$default(Decoding decoding, SerialDescriptor serialDescriptor, int i, KSerializer2 kSerializer2, Object obj, int i2, Object obj2) {
            if (obj2 != null) {
            ...
            return decoding.decodeSerializableElement(serialDescriptor, i, kSerializer2, obj);
        }
    }
}

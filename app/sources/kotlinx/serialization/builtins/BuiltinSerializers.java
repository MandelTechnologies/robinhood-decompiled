...
import kotlinx.serialization.internal.BuiltInSerializers;
import kotlinx.serialization.internal.BuiltInSerializers2;
import kotlinx.serialization.internal.BuiltInSerializers3;
...
import kotlinx.serialization.internal.Tuples6;
import kotlinx.serialization.internal.Tuples7;
import kotlinx.serialization.internal.Tuples8;
...
public final class BuiltinSerializers {
    ...
    public static final <K, V> KSerializer<Tuples2<K, V>> PairSerializer(KSerializer<K> keySerializer, KSerializer<V> valueSerializer) {
        Intrinsics.checkNotNullParameter(keySerializer, "keySerializer");
        Intrinsics.checkNotNullParameter(valueSerializer, "valueSerializer");
        return new Tuples7(keySerializer, valueSerializer);
    }
    ...
    public static final <K, V> KSerializer<Map.Entry<K, V>> MapEntrySerializer(KSerializer<K> keySerializer, KSerializer<V> valueSerializer) {
        Intrinsics.checkNotNullParameter(keySerializer, "keySerializer");
        Intrinsics.checkNotNullParameter(valueSerializer, "valueSerializer");
        return new Tuples6(keySerializer, valueSerializer);
    }

    public static final <A, B, C> KSerializer<Tuples3<A, B, C>> TripleSerializer(KSerializer<A> aSerializer, KSerializer<B> bSerializer, KSerializer<C> cSerializer) {
        Intrinsics.checkNotNullParameter(aSerializer, "aSerializer");
        Intrinsics.checkNotNullParameter(bSerializer, "bSerializer");
        Intrinsics.checkNotNullParameter(cSerializer, "cSerializer");
        return new Tuples8(aSerializer, bSerializer, cSerializer);
    }

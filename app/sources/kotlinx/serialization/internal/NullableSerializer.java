...
public final class NullableSerializer<T> implements KSerializer<T> {
    ...
    public NullableSerializer(KSerializer<T> serializer) {
        ...
        this.descriptor = new NullableSerializer2(serializer.getDescriptor());
    }

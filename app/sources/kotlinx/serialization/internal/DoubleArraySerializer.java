...
public final class DoubleArraySerializer extends PrimitiveArraySerializer<Double, double[], DoubleArrayBuilder> implements KSerializer<double[]> {
    ...
    private DoubleArraySerializer() {
        super(BuiltinSerializers.serializer(DoubleCompanionObject.INSTANCE));
    }
    ...
    public void readElement(Decoding decoder, int index, DoubleArrayBuilder builder, boolean checkIndex) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // kotlinx.serialization.internal.PrimitiveArraySerializer
    public void writeContent(Encoding3 encoder, double[] content, int size) {

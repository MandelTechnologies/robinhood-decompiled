...
public final class CharArraySerializer extends PrimitiveArraySerializer<Character, char[], CharArrayBuilder> implements KSerializer<char[]> {
    ...
    private CharArraySerializer() {
        super(BuiltinSerializers.serializer(CharCompanionObject.INSTANCE));
    }
    ...
    public void readElement(Decoding decoder, int index, CharArrayBuilder builder, boolean checkIndex) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // kotlinx.serialization.internal.PrimitiveArraySerializer
    public void writeContent(Encoding3 encoder, char[] content, int size) {

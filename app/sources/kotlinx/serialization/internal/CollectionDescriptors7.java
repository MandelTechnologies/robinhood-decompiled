...
public abstract class CollectionDescriptors7 implements SerialDescriptor {
    ...
    private CollectionDescriptors7(SerialDescriptor serialDescriptor) {
    ...
    public SerialKinds3 getKind() {
        return SerialKinds4.LIST.INSTANCE;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CollectionDescriptors7)) {
            return false;
        }
        CollectionDescriptors7 collectionDescriptors7 = (CollectionDescriptors7) other;
        return Intrinsics.areEqual(this.elementDescriptor, collectionDescriptors7.elementDescriptor) && Intrinsics.areEqual(getSerialName(), collectionDescriptors7.getSerialName());
    }

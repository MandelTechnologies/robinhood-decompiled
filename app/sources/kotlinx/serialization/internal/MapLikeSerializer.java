...
public abstract class MapLikeSerializer<Key, Value, Collection, Builder extends Map<Key, Value>> extends AbstractCollectionSerializer<Map.Entry<? extends Key, ? extends Value>, Collection, Builder> {
    ...
    public final void readAll(Decoding decoder, Builder builder, int startIndex, int size) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        Intrinsics.checkNotNullParameter(builder, "builder");
        if (size < 0) {
            throw new IllegalArgumentException("Size must be known in advance when using READ_ALL");
        }
        Progressions2 progressions2Step = RangesKt.step(RangesKt.until(0, size * 2), 2);
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // kotlinx.serialization.internal.AbstractCollectionSerializer
    public final void readElement(Decoding decoder, int index, Builder builder, boolean checkIndex) {
        int iDecodeElementIndex;
        Object objDecodeSerializableElement$default;
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        Intrinsics.checkNotNullParameter(builder, "builder");
        Object objDecodeSerializableElement$default2 = Decoding.DefaultImpls.decodeSerializableElement$default(decoder, getDescriptor(), index, this.keySerializer, null, 8, null);
        if (checkIndex) {
        ...
        if (builder.containsKey(objDecodeSerializableElement$default2) && !(this.valueSerializer.getDescriptor().getKind() instanceof SerialKinds2)) {
            ...
            objDecodeSerializableElement$default = Decoding.DefaultImpls.decodeSerializableElement$default(decoder, getDescriptor(), i, this.valueSerializer, null, 8, null);
        }
        builder.put(objDecodeSerializableElement$default2, objDecodeSerializableElement$default);
    }

    @Override // kotlinx.serialization.KSerializer3
    public void serialize(Encoding4 encoder, Collection value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        int iCollectionSize = collectionSize(value);
        SerialDescriptor descriptor = getDescriptor();
        Encoding3 encoding3BeginCollection = encoder.beginCollection(descriptor, iCollectionSize);
        ...
        while (itCollectionIterator.hasNext()) {
            ...
            int i2 = i + 1;
            encoding3BeginCollection.encodeSerializableElement(getDescriptor(), i, getKeySerializer(), key);
            i += 2;
            encoding3BeginCollection.encodeSerializableElement(getDescriptor(), i2, getValueSerializer(), value2);
        }
        encoding3BeginCollection.endStructure(descriptor);
    }
}

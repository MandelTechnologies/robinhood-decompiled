    ...
    public boolean equals(Object other) {
        ...
        if (classifier instanceof KClass) {
            ...
            if (classifier2 != null && (classifier2 instanceof KClass)) {
                return Intrinsics.areEqual(JvmClassMapping.getJavaClass((KClass) classifier), JvmClassMapping.getJavaClass((KClass) classifier2));
            }
        }
        return false;
    }

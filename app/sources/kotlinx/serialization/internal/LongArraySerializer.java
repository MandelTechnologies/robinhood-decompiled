...
public final class LongArraySerializer extends PrimitiveArraySerializer<Long, long[], LongArrayBuilder> implements KSerializer<long[]> {
    ...
    private LongArraySerializer() {
        super(BuiltinSerializers.serializer(LongCompanionObject.INSTANCE));
    }
    ...
    public void readElement(Decoding decoder, int index, LongArrayBuilder builder, boolean checkIndex) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // kotlinx.serialization.internal.PrimitiveArraySerializer
    public void writeContent(Encoding3 encoder, long[] content, int size) {

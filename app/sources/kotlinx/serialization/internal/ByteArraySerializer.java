...
public final class ByteArraySerializer extends PrimitiveArraySerializer<Byte, byte[], ByteArrayBuilder> implements KSerializer<byte[]> {
    ...
    private ByteArraySerializer() {
        super(BuiltinSerializers.serializer(ByteCompanionObject.INSTANCE));
    }
    ...
    public void readElement(Decoding decoder, int index, ByteArrayBuilder builder, boolean checkIndex) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // kotlinx.serialization.internal.PrimitiveArraySerializer
    public void writeContent(Encoding3 encoder, byte[] content, int size) {

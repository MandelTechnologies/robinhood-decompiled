...
public final class BooleanArraySerializer extends PrimitiveArraySerializer<Boolean, boolean[], BooleanArrayBuilder> implements KSerializer<boolean[]> {
    ...
    private BooleanArraySerializer() {
        super(BuiltinSerializers.serializer(BooleanCompanionObject.INSTANCE));
    }
    ...
    public void readElement(Decoding decoder, int index, BooleanArrayBuilder builder, boolean checkIndex) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // kotlinx.serialization.internal.PrimitiveArraySerializer
    public void writeContent(Encoding3 encoder, boolean[] content, int size) {

...
public class PluginGeneratedSerialDescriptor implements SerialDescriptor, CachedNames {
    ...
    private final PluginHelperInterfaces<?> generatedSerializer;
    ...
    public PluginGeneratedSerialDescriptor(String serialName, PluginHelperInterfaces<?> pluginHelperInterfaces, int i) {
        Intrinsics.checkNotNullParameter(serialName, "serialName");
        this.serialName = serialName;
        this.generatedSerializer = pluginHelperInterfaces;
        ...
        this.childSerializers = LazyKt.lazy(lazyThreadSafetyMode, new Function0() { // from class: kotlinx.serialization.internal.PluginGeneratedSerialDescriptor$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return PluginGeneratedSerialDescriptor.childSerializers_delegate$lambda$0(this.f$0);
            }
        });
        this.typeParameterDescriptors = LazyKt.lazy(lazyThreadSafetyMode, new Function0() { // from class: kotlinx.serialization.internal.PluginGeneratedSerialDescriptor$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return PluginGeneratedSerialDescriptor.typeParameterDescriptors_delegate$lambda$2(this.f$0);
            }
        });
        this._hashCode = LazyKt.lazy(lazyThreadSafetyMode, new Function0() { // from class: kotlinx.serialization.internal.PluginGeneratedSerialDescriptor$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public /* synthetic */ PluginGeneratedSerialDescriptor(String str, PluginHelperInterfaces pluginHelperInterfaces, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, (i2 & 2) != 0 ? null : pluginHelperInterfaces, i);
    }
    ...
    public SerialKinds3 getKind() {
        return SerialKinds4.CLASS.INSTANCE;
    }
    ...
    public static final KSerializer[] childSerializers_delegate$lambda$0(PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor) {
        ...
        PluginHelperInterfaces<?> pluginHelperInterfaces = pluginGeneratedSerialDescriptor.generatedSerializer;
        return (pluginHelperInterfaces == null || (kSerializerArrChildSerializers = pluginHelperInterfaces.childSerializers()) == null) ? PluginHelperInterfaces2.EMPTY_SERIALIZER_ARRAY : kSerializerArrChildSerializers;
    }
    ...
    public static final SerialDescriptor[] typeParameterDescriptors_delegate$lambda$2(PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor) {
        ...
        PluginHelperInterfaces<?> pluginHelperInterfaces = pluginGeneratedSerialDescriptor.generatedSerializer;
        if (pluginHelperInterfaces == null || (kSerializerArrTypeParametersSerializers = pluginHelperInterfaces.typeParametersSerializers()) == null) {
            arrayList = null;
        } else {
    ...
    public static final int _hashCode_delegate$lambda$3(PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor) {
        return PluginGeneratedSerialDescriptor2.hashCodeImpl(pluginGeneratedSerialDescriptor, pluginGeneratedSerialDescriptor.getTypeParameterDescriptors$kotlinx_serialization_core());
    }

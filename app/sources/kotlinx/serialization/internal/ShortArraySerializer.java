...
public final class ShortArraySerializer extends PrimitiveArraySerializer<Short, short[], ShortArrayBuilder> implements KSerializer<short[]> {
    ...
    private ShortArraySerializer() {
        super(BuiltinSerializers.serializer(ShortCompanionObject.INSTANCE));
    }
    ...
    public void readElement(Decoding decoder, int index, ShortArrayBuilder builder, boolean checkIndex) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // kotlinx.serialization.internal.PrimitiveArraySerializer
    public void writeContent(Encoding3 encoder, short[] content, int size) {

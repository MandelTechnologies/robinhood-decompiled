...
public final class FloatArraySerializer extends PrimitiveArraySerializer<Float, float[], FloatArrayBuilder> implements KSerializer<float[]> {
    ...
    private FloatArraySerializer() {
        super(BuiltinSerializers.serializer(FloatCompanionObject.INSTANCE));
    }
    ...
    public void readElement(Decoding decoder, int index, FloatArrayBuilder builder, boolean checkIndex) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // kotlinx.serialization.internal.PrimitiveArraySerializer
    public void writeContent(Encoding3 encoder, float[] content, int size) {

...
public final class ContextAware {
    public static final KClass<?> getCapturedKClass(SerialDescriptor serialDescriptor) {
        ...
        if (serialDescriptor instanceof NullableSerializer2) {
            return getCapturedKClass(((NullableSerializer2) serialDescriptor).getOriginal());
        }
        return null;
    }

...
public final class SerialDescriptors2 implements SerialDescriptor, CachedNames {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SerialDescriptors2)) {
            return false;
        }
        SerialDescriptor serialDescriptor = (SerialDescriptor) other;
        if (!Intrinsics.areEqual(getSerialName(), serialDescriptor.getSerialName()) || !Arrays.equals(this.typeParametersDescriptors, ((SerialDescriptors2) other).typeParametersDescriptors) || getElementsCount() != serialDescriptor.getElementsCount()) {
            return false;
        }
    ...
    public SerialDescriptors2(String serialName, SerialKinds3 kind, int i, List<? extends SerialDescriptor> typeParameters, SerialDescriptors builder) {
        ...
        for (IndexedValue indexedValue : iterableWithIndex) {
            arrayList.add(Tuples4.m3642to(indexedValue.getValue(), Integer.valueOf(indexedValue.getIndex())));
        }
        ...
        this._hashCode = LazyKt.lazy(new Function0() { // from class: kotlinx.serialization.descriptors.SerialDescriptorImpl$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                return Integer.valueOf(SerialDescriptors2._hashCode_delegate$lambda$1(this.f$0));
            }
        });
    }
    ...
    public static final int _hashCode_delegate$lambda$1(SerialDescriptors2 serialDescriptors2) {
        return PluginGeneratedSerialDescriptor2.hashCodeImpl(serialDescriptors2, serialDescriptors2.typeParametersDescriptors);
    }
    ...
    public String toString() {
        return CollectionsKt.joinToString$default(RangesKt.until(0, getElementsCount()), ", ", getSerialName() + '(', ")", 0, null, new Function1() { // from class: kotlinx.serialization.descriptors.SerialDescriptorImpl$$ExternalSyntheticLambda1
            ...
            public final Object invoke(Object obj) {
                return SerialDescriptors2.toString$lambda$3(this.f$0, ((Integer) obj).intValue());
            }
        }, 24, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final CharSequence toString$lambda$3(SerialDescriptors2 serialDescriptors2, int i) {
        return serialDescriptors2.getElementName(i) + ": " + serialDescriptors2.getElementDescriptor(i).getSerialName();
    }
}

...
public final class SerialDescriptors {
    ...
    public SerialDescriptors(String serialName) {
    ...
    public static /* synthetic */ void element$default(SerialDescriptors serialDescriptors, String str, SerialDescriptor serialDescriptor, List list, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
        ...
        serialDescriptors.element(str, serialDescriptor, list, z);
    }

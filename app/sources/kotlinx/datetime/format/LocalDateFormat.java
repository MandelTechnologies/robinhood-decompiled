...
public final class LocalDateFormat extends DateTimeFormat2<LocalDate, IncompleteLocalDate> {
    ...
    /* compiled from: LocalDateFormat.kt */
    @Metadata(m3635d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J%\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u00042\u0017\u0010\u0006\u001a\u0013\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\t0\u0007¢\u0006\u0002\b\n¨\u0006\u000b"}, m3636d2 = {"Lkotlinx/datetime/format/LocalDateFormat$Companion;", "", "()V", "build", "Lkotlinx/datetime/format/DateTimeFormat;", "Lkotlinx/datetime/LocalDate;", "block", "Lkotlin/Function1;", "Lkotlinx/datetime/format/DateTimeFormatBuilder$WithDate;", "", "Lkotlin/ExtensionFunctionType;", "kotlinx-datetime"}, m3637k = 1, m3638mv = {1, 9, 0}, m3640xi = 48)
    ...
    public static final class Builder implements DateTimeFormatBuilder2<DateFieldContainer, Builder>, AbstractWithDateBuilder {
        private final Builder2<DateFieldContainer> actualBuilder;

        public Builder(Builder2<DateFieldContainer> actualBuilder) {
        ...
        public void dayOfMonth(DateTimeFormat3 dateTimeFormat3) {
            AbstractWithDateBuilder.DefaultImpls.dayOfMonth(this, dateTimeFormat3);
        }

        @Override // kotlinx.datetime.format.DateTimeFormatBuilder2
        public Builder2<DateFieldContainer> getActualBuilder() {
            return this.actualBuilder;
        }

        @Override // kotlinx.datetime.format.DateTimeFormatBuilder.WithDate
        public void monthNumber(DateTimeFormat3 dateTimeFormat3) {
            AbstractWithDateBuilder.DefaultImpls.monthNumber(this, dateTimeFormat3);
        }

        @Override // kotlinx.datetime.format.DateTimeFormatBuilder.WithDate
        public void year(DateTimeFormat3 dateTimeFormat3) {
            AbstractWithDateBuilder.DefaultImpls.year(this, dateTimeFormat3);
        }

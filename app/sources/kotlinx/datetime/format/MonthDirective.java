...
final class MonthDirective extends FieldFormatDirective6<DateFieldContainer> {
    private final DateTimeFormat3 padding;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MonthDirective(DateTimeFormat3 padding) {
        super(DateFields.INSTANCE.getMonth(), padding == DateTimeFormat3.ZERO ? 2 : 1, padding == DateTimeFormat3.SPACE ? 2 : null);

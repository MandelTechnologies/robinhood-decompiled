...
final class MinuteDirective extends FieldFormatDirective6<TimeFieldContainer> {
    private final DateTimeFormat3 padding;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MinuteDirective(DateTimeFormat3 padding) {
        super(TimeFields.INSTANCE.getMinute(), padding == DateTimeFormat3.ZERO ? 2 : 1, padding == DateTimeFormat3.SPACE ? 2 : null);

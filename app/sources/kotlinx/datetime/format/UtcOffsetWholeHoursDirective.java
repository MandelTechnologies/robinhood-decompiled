...
public final class UtcOffsetWholeHoursDirective extends FieldFormatDirective6<UtcOffsetFieldContainer> {
    private final DateTimeFormat3 padding;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UtcOffsetWholeHoursDirective(DateTimeFormat3 padding) {
        super(OffsetFields.INSTANCE.getTotalHoursAbs(), padding == DateTimeFormat3.ZERO ? 2 : 1, padding == DateTimeFormat3.SPACE ? 2 : null);

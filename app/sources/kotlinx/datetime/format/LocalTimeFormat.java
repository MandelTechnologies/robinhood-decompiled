...
public final class LocalTimeFormat extends DateTimeFormat2<LocalTime, IncompleteLocalTime> {
    ...
    /* compiled from: LocalTimeFormat.kt */
    @Metadata(m3635d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001f\u0010\u0003\u001a\u00020\u00042\u0017\u0010\u0005\u001a\u0013\u0012\u0004\u0012\u00020\u0007\u0012\u0004\u0012\u00020\b0\u0006¢\u0006\u0002\b\t¨\u0006\n"}, m3636d2 = {"Lkotlinx/datetime/format/LocalTimeFormat$Companion;", "", "()V", "build", "Lkotlinx/datetime/format/LocalTimeFormat;", "block", "Lkotlin/Function1;", "Lkotlinx/datetime/format/DateTimeFormatBuilder$WithTime;", "", "Lkotlin/ExtensionFunctionType;", "kotlinx-datetime"}, m3637k = 1, m3638mv = {1, 9, 0}, m3640xi = 48)
    ...
    private static final class Builder implements DateTimeFormatBuilder2<TimeFieldContainer, Builder>, AbstractWithTimeBuilder {
        private final Builder2<TimeFieldContainer> actualBuilder;

        public Builder(Builder2<TimeFieldContainer> actualBuilder) {
        ...
        @Override // kotlinx.datetime.format.DateTimeFormatBuilder2
        public Builder2<TimeFieldContainer> getActualBuilder() {
        ...
        public void hour(DateTimeFormat3 dateTimeFormat3) {
            AbstractWithTimeBuilder.DefaultImpls.hour(this, dateTimeFormat3);
        }

        @Override // kotlinx.datetime.format.DateTimeFormatBuilder.WithTime
        public void minute(DateTimeFormat3 dateTimeFormat3) {
            AbstractWithTimeBuilder.DefaultImpls.minute(this, dateTimeFormat3);
        }

        @Override // kotlinx.datetime.format.DateTimeFormatBuilder.WithTime
        public void second(DateTimeFormat3 dateTimeFormat3) {
            AbstractWithTimeBuilder.DefaultImpls.second(this, dateTimeFormat3);
        }

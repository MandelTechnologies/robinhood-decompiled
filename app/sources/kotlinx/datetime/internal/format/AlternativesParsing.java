...
public final class AlternativesParsing<T> implements NonConcatenatedFormatStructure<T> {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.mainFormat, alternativesParsing.mainFormat) && Intrinsics.areEqual(this.formats, alternativesParsing.formats);
    }
    ...
    public Parser6<T> parser() {
        ...
        return new Parser6<>(listEmptyList, CollectionsKt.build(listCreateListBuilder));
    }

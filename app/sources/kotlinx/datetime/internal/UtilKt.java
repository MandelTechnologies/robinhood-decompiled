...
@Metadata(m3635d1 = {"\u0000\u001e\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\f\n\u0000\n\u0002\u0010\u000b\n\u0000\u001a\u0018\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00012\u0006\u0010\u0003\u001a\u00020\u0004H\u0002\u001a\u0010\u0010\u0005\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0001H\u0000\u001a\u0010\u0010\u0006\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0001H\u0000\u001a\f\u0010\u0007\u001a\u00020\u0004*\u00020\bH\u0000\u001a\f\u0010\t\u001a\u00020\n*\u00020\bH\u0000¨\u0006\u000b"}, m3636d2 = {"removeLeadingZerosFromLongYearForm", "", "input", "minStringLengthAfterYear", "", "removeLeadingZerosFromLongYearFormLocalDate", "removeLeadingZerosFromLongYearFormLocalDateTime", "asciiDigitToInt", "", "isAsciiDigit", "", "kotlinx-datetime"}, m3637k = 2, m3638mv = {1, 9, 0}, m3640xi = 48)
    ...
    private static final String removeLeadingZerosFromLongYearForm(String str, int i) {
        if (str.length() >= i + 12) {
            ...
            if (StringsKt.contains$default((CharSequence) "+-", str.charAt(0), false, 2, (Object) null)) {
                ...
                return iIndexOf$default - i2 >= 12 ? str : StringsKt.removeRange(str, 1, iIndexOf$default - 10).toString();
            }
        }
        return str;
    }

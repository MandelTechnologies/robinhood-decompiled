...
public abstract class CoroutineWorker extends ListenableWorker {
    ...
    @DebugMetadata(m3644c = "androidx.work.CoroutineWorker$startWork$1", m3645f = "CoroutineWorker.kt", m3646l = {EnumC7081g.SDK_ASSET_ICON_HOME_VALUE}, m3647m = "invokeSuspend")
    /* renamed from: androidx.work.CoroutineWorker$startWork$1 */
    static final class C30451 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        int label;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return CoroutineWorker.this.new C30451(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C30451) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final ListenableFuture<ListenableWorker.Result> startWork() {
        BuildersKt__Builders_commonKt.launch$default(CoroutineScope2.CoroutineScope(getCoroutineContext().plus(this.job)), null, null, new C30451(null), 3, null);
        return this.future;
    }
    ...
    public final Object setProgress(Data data, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (progressAsync.isDone()) {
            ...
            progressAsync.addListener(new ListenableFuture3(cancellableContinuationImpl, progressAsync), DirectExecutor.INSTANCE);
            cancellableContinuationImpl.invokeOnCancellation(new ListenableFuture4(progressAsync));
    ...
    public final Object setForeground(ForegroundInfo foregroundInfo, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (foregroundAsync.isDone()) {
            ...
            CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(continuation), 1);
            cancellableContinuationImpl.initCancellability();
            foregroundAsync.addListener(new ListenableFuture3(cancellableContinuationImpl, foregroundAsync), DirectExecutor.INSTANCE);
            cancellableContinuationImpl.invokeOnCancellation(new ListenableFuture4(foregroundAsync));
            Object result = cancellableContinuationImpl.getResult();
            if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                DebugProbes.probeCoroutineSuspended(continuation);
            }
    ...
    public final ListenableFuture<ForegroundInfo> getForegroundInfoAsync() {
        ...
        CoroutineScope CoroutineScope = CoroutineScope2.CoroutineScope(getCoroutineContext().plus(completableJobJob$default));
        ListenableFuture2 listenableFuture2 = new ListenableFuture2(completableJobJob$default, null, 2, null);
        BuildersKt__Builders_commonKt.launch$default(CoroutineScope, null, null, new C30441(listenableFuture2, this, null), 3, null);
        return listenableFuture2;
    }

    /* compiled from: CoroutineWorker.kt */
    @Metadata(m3635d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m3636d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m3637k = 3, m3638mv = {1, 8, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "androidx.work.CoroutineWorker$getForegroundInfoAsync$1", m3645f = "CoroutineWorker.kt", m3646l = {EnumC7081g.SDK_ASSET_ILLUSTRATION_DEV_LOGS_VALUE}, m3647m = "invokeSuspend")
    /* renamed from: androidx.work.CoroutineWorker$getForegroundInfoAsync$1 */
    /* loaded from: classes16.dex */
    static final class C30441 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ ListenableFuture2<ForegroundInfo> $jobFuture;
        Object L$0;
        int label;
        final /* synthetic */ CoroutineWorker this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C30441(ListenableFuture2<ForegroundInfo> listenableFuture2, CoroutineWorker coroutineWorker, Continuation<? super C30441> continuation) {
            super(2, continuation);
            this.$jobFuture = listenableFuture2;
            this.this$0 = coroutineWorker;
        }

        @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C30441(this.$jobFuture, this.this$0, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C30441) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                ListenableFuture2<ForegroundInfo> listenableFuture22 = this.$jobFuture;
                CoroutineWorker coroutineWorker = this.this$0;
                this.L$0 = listenableFuture22;
                this.label = 1;
                Object foregroundInfo = coroutineWorker.getForegroundInfo(this);
                if (foregroundInfo == coroutine_suspended) {
                    return coroutine_suspended;
                }
                listenableFuture2 = listenableFuture22;
                obj = foregroundInfo;
            } else {
                if (i != 1) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                }
                listenableFuture2 = (ListenableFuture2) this.L$0;
                ResultKt.throwOnFailure(obj);
            }
            listenableFuture2.complete(obj);
            return Unit.INSTANCE;
        }
    }

            ...
            if (i >= 30) {
                ...
                if (historicalProcessExitReasons != null && !historicalProcessExitReasons.isEmpty()) {
                    ...
                    for (int i2 = 0; i2 < historicalProcessExitReasons.size(); i2++) {
                        ApplicationExitInfo applicationExitInfoM709m = ForceStopRunnable$$ExternalSyntheticApiModelOutline1.m709m(historicalProcessExitReasons.get(i2));
                        if (applicationExitInfoM709m.getReason() == 10 && applicationExitInfoM709m.getTimestamp() >= lastForceStopEventMillis) {
                            return true;
                        }
                    }
                }

...
@Metadata(m3635d1 = {"\u0000 \n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\u0006\u0010\u0002\u001a\u00020\u0003\u001a\u001c\u0010\u0004\u001a\u00060\u0005R\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\u0001H\u0000\"\u000e\u0010\u0000\u001a\u00020\u0001X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\n"}, m3636d2 = {"TAG", "", "checkWakeLocks", "", "newWakeLock", "Landroid/os/PowerManager$WakeLock;", "Landroid/os/PowerManager;", "context", "Landroid/content/Context;", "tag", "work-runtime_release"}, m3637k = 2, m3638mv = {1, 8, 0}, m3640xi = 48)
@JvmName
...
public final class WakeLocks {
    ...
    public static final PowerManager.WakeLock newWakeLock(Context context, String tag) {
        ...
        WakeLocks2 wakeLocks2 = WakeLocks2.INSTANCE;
        synchronized (wakeLocks2) {
            wakeLocks2.getWakeLocks().put(wakeLock, str);
        }
    ...
    public static final void checkWakeLocks() {
        ...
        WakeLocks2 wakeLocks2 = WakeLocks2.INSTANCE;
        synchronized (wakeLocks2) {
            linkedHashMap.putAll(wakeLocks2.getWakeLocks());

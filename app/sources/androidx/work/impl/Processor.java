...
public class Processor implements ForegroundProcessor {
                    ...
                    try {
                        ...
                        future.addListener(new Runnable() { // from class: androidx.work.impl.Processor$$ExternalSyntheticLambda1
                            ...
                            public final void run() {
                                Processor.$r8$lambda$muVKxZSPLZrj3l8zDW2pghfHiMM(this.f$0, future, workerWrapperBuild);
                            }
    ...
    private void onExecuted(WorkerWrapper wrapper, boolean needsReschedule) {
        synchronized (this.mLock) {
            try {
                ...
                Logger.get().debug(TAG, getClass().getSimpleName() + PlaceholderUtils.XXShortPlaceholderText + workSpecId + " executed; reschedule = " + needsReschedule);
    ...
    private void runOnExecuted(final WorkGenerationalId id, final boolean needsReschedule) {
        this.mWorkTaskExecutor.getMainThreadExecutor().execute(new Runnable() { // from class: androidx.work.impl.Processor$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                Processor.m8360$r8$lambda$DL8iMB7FHX_9lduQzH0vxRBBwQ(this.f$0, id, needsReschedule);
            }
        });
    }

    /* renamed from: $r8$lambda$DL8iM-B7FHX_9lduQzH0vxRBBwQ, reason: not valid java name */
    public static /* synthetic */ void m8360$r8$lambda$DL8iMB7FHX_9lduQzH0vxRBBwQ(Processor processor, WorkGenerationalId workGenerationalId, boolean z) {

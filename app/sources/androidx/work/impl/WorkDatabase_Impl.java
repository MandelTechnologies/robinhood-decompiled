        ...
        return configuration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(configuration.context).name(configuration.name).callback(new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(20) { // from class: androidx.work.impl.WorkDatabase_Impl.1
            ...
            public void dropAllTables(SupportSQLiteDatabase _db) throws SQLException {
                ...
                if (((RoomDatabase) WorkDatabase_Impl.this).mCallbacks != null) {
                    ...
                    for (int i = 0; i < size; i++) {
                        ((RoomDatabase.Callback) ((RoomDatabase) WorkDatabase_Impl.this).mCallbacks.get(i)).onDestructiveMigration(_db);
                    }
                }
            }
            ...
            public void onCreate(SupportSQLiteDatabase _db) {
                if (((RoomDatabase) WorkDatabase_Impl.this).mCallbacks != null) {
                    int size = ((RoomDatabase) WorkDatabase_Impl.this).mCallbacks.size();
                    for (int i = 0; i < size; i++) {
                        ((RoomDatabase.Callback) ((RoomDatabase) WorkDatabase_Impl.this).mCallbacks.get(i)).onCreate(_db);
                    }
                }
            }
            ...
            public void onOpen(SupportSQLiteDatabase _db) throws SQLException {
                ...
                if (((RoomDatabase) WorkDatabase_Impl.this).mCallbacks != null) {
                    int size = ((RoomDatabase) WorkDatabase_Impl.this).mCallbacks.size();
                    for (int i = 0; i < size; i++) {
                        ((RoomDatabase.Callback) ((RoomDatabase) WorkDatabase_Impl.this).mCallbacks.get(i)).onOpen(_db);
                    }
                }
            }

...
public class SystemForegroundDispatcher implements WorkConstraintsTracker3, ExecutionListener {
        ...
        this.mTaskExecutor.executeOnTaskThread(new Runnable() { // from class: androidx.work.impl.foreground.SystemForegroundDispatcher.1
            ...
            public void run() {
                ...
                synchronized (SystemForegroundDispatcher.this.mLock) {
                    SystemForegroundDispatcher.this.mWorkSpecById.put(WorkSpec3.generationalId(runningWorkSpec), runningWorkSpec);
                    SystemForegroundDispatcher systemForegroundDispatcher = SystemForegroundDispatcher.this;
                    SystemForegroundDispatcher.this.mTrackedWorkSpecs.put(WorkSpec3.generationalId(runningWorkSpec), WorkConstraintsTracker4.listen(systemForegroundDispatcher.mConstraintsTracker, runningWorkSpec, systemForegroundDispatcher.mTaskExecutor.getTaskCoroutineDispatcher(), SystemForegroundDispatcher.this));
                }
            }
        });
    }
    ...
    public void onConstraintsStateChanged(WorkSpec workSpec, WorkConstraintsTracker2 state) {
        if (state instanceof WorkConstraintsTracker2.ConstraintsNotMet) {
            ...
            this.mWorkManagerImpl.stopForegroundWork(WorkSpec3.generationalId(workSpec));
        }
    }

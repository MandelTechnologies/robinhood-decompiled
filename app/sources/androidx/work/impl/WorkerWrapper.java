...
public class WorkerWrapper implements Runnable {
    ...
    private volatile int mInterrupted = AssetHomeEducationTourScreen.SortButtonOffset;
    ...
    public WorkGenerationalId getWorkGenerationalId() {
        return WorkSpec3.generationalId(this.mWorkSpec);
    }
        ...
        try {
            ...
            this.mWorkerResultFuture.addListener(new Runnable() { // from class: androidx.work.impl.WorkerWrapper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    WorkerWrapper.m8362$r8$lambda$EZJOifd5Nt7S_Z6NFLZG0ICBm4(this.f$0, future);
                }
    ...
    /* renamed from: $r8$lambda$EZJOifd5Nt7S_Z6-NFLZG0ICBm4, reason: not valid java name */
    public static /* synthetic */ void m8362$r8$lambda$EZJOifd5Nt7S_Z6NFLZG0ICBm4(WorkerWrapper workerWrapper, ListenableFuture listenableFuture) {
    ...
    private boolean trySetRunning() {
        ...
        try {
            if (this.mWorkSpecDao.getState(this.mWorkSpecId) == WorkInfo.State.ENQUEUED) {
                ...
                this.mWorkSpecDao.setStopReason(this.mWorkSpecId, AssetHomeEducationTourScreen.SortButtonOffset);
                z = true;
            } else {
                z = false;
            }

...
public class SystemAlarmDispatcher implements ExecutionListener {
    ...
    private StartStopToken2 mStartStopTokens;
    ...
    SystemAlarmDispatcher(Context context, Processor processor, WorkManagerImpl workManager, WorkLauncher launcher) {
        ...
        this.mStartStopTokens = new StartStopToken2();
        ...
        this.mWorkLauncher = launcher == null ? new WorkLauncher2(processor, workTaskExecutor) : launcher;

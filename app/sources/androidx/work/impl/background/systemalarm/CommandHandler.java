...
public class CommandHandler implements ExecutionListener {
    ...
    private final StartStopToken2 mStartStopTokens;
    ...
    CommandHandler(Context context, Clock clock, StartStopToken2 startStopTokens) {
    ...
    private void handleStopWork(Intent intent, SystemAlarmDispatcher dispatcher) {
        ...
        if (extras.containsKey("KEY_WORKSPEC_GENERATION")) {
            ...
            StartStopToken startStopTokenRemove = this.mStartStopTokens.remove(new WorkGenerationalId(string2, i));
            if (startStopTokenRemove != null) {
                listRemove.add(startStopTokenRemove);
            }
        } else {
            listRemove = this.mStartStopTokens.remove(string2);
        }

...
class Alarms {
    ...
    public static void setAlarm(Context context, WorkDatabase workDatabase, WorkGenerationalId id, long triggerAtMillis) {
        ...
        if (systemIdInfo != null) {
            ...
            systemIdInfoDao.insertSystemIdInfo(SystemIdInfo2.systemIdInfo(id, iNextAlarmManagerId));
    ...
    static class Api19Impl {
        static void setExact(AlarmManager alarmManager, int type2, long triggerAtMillis, PendingIntent operation2) {
            alarmManager.setExact(type2, triggerAtMillis, operation2);
        }
    }
}

...
import androidx.work.impl.WorkLauncher2;
...
public class SystemJobService extends JobService implements ExecutionListener {
    ...
    public void onCreate() {
        ...
        try {
            ...
            this.mWorkLauncher = new WorkLauncher2(processor, this.mWorkManagerImpl.getWorkTaskExecutor());
    ...
    public boolean onStopJob(JobParameters params) {
        ...
        if (startStopTokenRemove != null) {
            this.mWorkLauncher.stopWorkWithReason(startStopTokenRemove, Build.VERSION.SDK_INT >= 31 ? Api31Impl.getStopReason(params) : -512);
        }

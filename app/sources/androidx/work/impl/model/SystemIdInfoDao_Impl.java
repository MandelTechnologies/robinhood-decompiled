        ...
        try {
            ...
            if (cursorQuery.moveToFirst()) {
                if (!cursorQuery.isNull(columnIndexOrThrow)) {
                    string2 = cursorQuery.getString(columnIndexOrThrow);
                }
                systemIdInfo = new SystemIdInfo(string2, cursorQuery.getInt(columnIndexOrThrow2), cursorQuery.getInt(columnIndexOrThrow3));
            }
            return systemIdInfo;
        } finally {
            cursorQuery.close();

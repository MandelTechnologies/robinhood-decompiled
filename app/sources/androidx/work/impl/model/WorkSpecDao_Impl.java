...
public final class WorkSpecDao_Impl implements WorkSpecDao {
    ...
    private final SharedSQLiteStatement f291xd91a9514;
    ...
    public WorkSpecDao_Impl(RoomDatabase __db) {
        ...
        this.f291xd91a9514 = new SharedSQLiteStatement(__db) { // from class: androidx.work.impl.model.WorkSpecDao_Impl.15
            @Override // androidx.room.SharedSQLiteStatement
            public String createQuery() {
                ...
                try {
                    ...
                    try {
                        ...
                        while (cursorQuery.moveToNext()) {
                            ...
                            if (((ArrayList) map2.get(string3)) == null) {
                        ...
                        ArrayList arrayList = new ArrayList(cursorQuery.getCount());
                        while (cursorQuery.moveToNext()) {
                            String string4 = cursorQuery.isNull(0) ? null : cursorQuery.getString(0);
                            ...
                            arrayList.add(new WorkSpec.WorkInfoPojo(string4, stateIntToState, dataFromByteArray, j, j2, j3, constraints, i2, backoffPolicyIntToBackoffPolicy, j4, j5, i4, i3, j6, i5, arrayList2, arrayList3));
                        }
        ...
        try {
            ...
            try {
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    arrayList.add(new WorkSpec.WorkInfoPojo(string4, stateIntToState, dataFromByteArray, j, j2, j3, constraints, i, backoffPolicyIntToBackoffPolicy, j4, j5, i3, i2, j6, i4, arrayList2, arrayList3));
                }
                this.__db.setTransactionSuccessful();
                cursorQuery.close();
                roomSQLiteQueryAcquire.release();

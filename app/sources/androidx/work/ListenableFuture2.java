...
public final class ListenableFuture2<R> implements ListenableFuture<R> {
    ...
    public ListenableFuture2(Job job, SettableFuture<R> underlying) {
        ...
        job.invokeOnCompletion(new Function1<Throwable, Unit>(this) { // from class: androidx.work.JobListenableFuture.1
            final /* synthetic */ ListenableFuture2<R> this$0;
            ...
            public final void invoke2(Throwable th) {
                if (th == null) {
                    if (!((ListenableFuture2) this.this$0).underlying.isDone()) {
                        throw new IllegalArgumentException("Failed requirement.");
                    }
                } else {
                    if (th instanceof CancellationException) {
                        ((ListenableFuture2) this.this$0).underlying.cancel(true);
                        return;
                    }
                    SettableFuture settableFuture = ((ListenableFuture2) this.this$0).underlying;
    ...
    public /* synthetic */ ListenableFuture2(Job job, SettableFuture settableFuture, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 2) != 0) {

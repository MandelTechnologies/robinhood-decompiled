...
@Metadata(m3635d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u001d\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\b\u0010\u0011\u001a\u00020\fH\u0016J\b\u0010\u0012\u001a\u00020\fH\u0016J\u0016\u0010\u0013\u001a\u00020\f2\u0006\u0010\u0014\u001a\u00020\u0015H\u0096@¢\u0006\u0002\u0010\u0016R\u0014\u0010\u0004\u001a\u00020\u0003X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0004\u0010\bR\u0014\u0010\t\u001a\u00020\u00038VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\t\u0010\bR\u0016\u0010\n\u001a\n\u0012\u0004\u0012\u00020\f\u0018\u00010\u000bX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\r\u001a\b\u0012\u0004\u0012\u00020\u00030\u000eX\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u000f\u0010\u0010¨\u0006\u0017"}, m3636d2 = {"Landroidx/compose/material3/TooltipStateImpl;", "Landroidx/compose/material3/TooltipState;", "initialIsVisible", "", "isPersistent", "mutatorMutex", "Landroidx/compose/foundation/MutatorMutex;", "(ZZLandroidx/compose/foundation/MutatorMutex;)V", "()Z", "isVisible", "job", "Lkotlinx/coroutines/CancellableContinuation;", "", NavTransition2.KEY_TRANSITION, "Landroidx/compose/animation/core/MutableTransitionState;", "getTransition", "()Landroidx/compose/animation/core/MutableTransitionState;", "dismiss", "onDispose", "show", "mutatePriority", "Landroidx/compose/foundation/MutatePriority;", "(Landroidx/compose/foundation/MutatePriority;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "material3_release"}, m3637k = 1, m3638mv = {1, 8, 0}, m3640xi = 48)
...
final class TooltipStateImpl implements TooltipState {
    ...
    @Override // androidx.compose.material3.TooltipState
    public Object show(MutatorMutex2 mutatorMutex2, Continuation<? super Unit> continuation) {
        Object objMutate = this.mutatorMutex.mutate(mutatorMutex2, new C17132(new TooltipStateImpl$show$cancellableShow$1(this, null), mutatorMutex2, null), continuation);
    ...
    @DebugMetadata(m3644c = "androidx.compose.material3.TooltipStateImpl$show$2", m3645f = "Tooltip.kt", m3646l = {504, 506}, m3647m = "invokeSuspend")
    /* renamed from: androidx.compose.material3.TooltipStateImpl$show$2 */
    static final class C17132 extends ContinuationImpl7 implements Function1<Continuation<? super Unit>, Object> {
        final /* synthetic */ Function1<Continuation<? super Unit>, Object> $cancellableShow;
        final /* synthetic */ MutatorMutex2 $mutatePriority;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C17132(Function1<? super Continuation<? super Unit>, ? extends Object> function1, MutatorMutex2 mutatorMutex2, Continuation<? super C17132> continuation) {
            super(1, continuation);
            this.$cancellableShow = function1;
            this.$mutatePriority = mutatorMutex2;
        }

        @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return TooltipStateImpl.this.new C17132(this.$cancellableShow, this.$mutatePriority, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C17132) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }

        /* JADX WARN: Code restructure failed: missing block: B:19:0x0042, code lost:
        
            if (kotlinx.coroutines.Timeout6.withTimeout(1500, r5, r4) == r0) goto L20;
         */
        @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
        /*
        ...
        */
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                ...
                if (this.$mutatePriority != MutatorMutex2.PreventUserInput) {
        ...
        @DebugMetadata(m3644c = "androidx.compose.material3.TooltipStateImpl$show$2$1", m3645f = "Tooltip.kt", m3646l = {506}, m3647m = "invokeSuspend")

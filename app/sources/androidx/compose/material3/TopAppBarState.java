...
public final class TopAppBarState {
    ...
    private static final Saver<TopAppBarState, ?> Saver = ListSaver.listSaver(new Function2<Saver5, TopAppBarState, List<? extends Float>>() { // from class: androidx.compose.material3.TopAppBarState$Companion$Saver$1
        @Override // kotlin.jvm.functions.Function2
        public final List<Float> invoke(Saver5 saver5, TopAppBarState topAppBarState) {
    ...
    private SnapshotFloatState2 _heightOffset;

    /* renamed from: contentOffset$delegate, reason: from kotlin metadata */
    private final SnapshotFloatState2 contentOffset;

    /* renamed from: heightOffsetLimit$delegate, reason: from kotlin metadata */
    private final SnapshotFloatState2 heightOffsetLimit;

    public TopAppBarState(float f, float f2, float f3) {
        this.heightOffsetLimit = SnapshotFloatState3.mutableFloatStateOf(f);
        this.contentOffset = SnapshotFloatState3.mutableFloatStateOf(f3);
        this._heightOffset = SnapshotFloatState3.mutableFloatStateOf(f2);
    }
    ...
    /* compiled from: AppBar.kt */
    @Metadata(m3635d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001b\u0010\u0003\u001a\f\u0012\u0004\u0012\u00020\u0005\u0012\u0002\b\u00030\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, m3636d2 = {"Landroidx/compose/material3/TopAppBarState$Companion;", "", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/material3/TopAppBarState;", "getSaver", "()Landroidx/compose/runtime/saveable/Saver;", "material3_release"}, m3637k = 1, m3638mv = {1, 8, 0}, m3640xi = 48)

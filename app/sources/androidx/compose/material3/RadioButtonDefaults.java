...
public final class RadioButtonDefaults {
    ...
    public final RadioButtonColors m5934colorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        if ((i2 & 1) != 0) {
        ...
        long j5 = j;
        RadioButtonColors radioButtonColorsM5933copyjRlVdoo = getDefaultRadioButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m5933copyjRlVdoo(j5, j2, j3, j4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return radioButtonColorsM5933copyjRlVdoo;
    }
    ...
    public final RadioButtonColors getDefaultRadioButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        RadioButtonColors radioButtonColors = new RadioButtonColors(ColorScheme2.fromToken(colorScheme, radioButtonTokens.getSelectedIconColor()), ColorScheme2.fromToken(colorScheme, radioButtonTokens.getUnselectedIconColor()), Color.m6705copywmQWz5c$default(ColorScheme2.fromToken(colorScheme, radioButtonTokens.getDisabledSelectedIconColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), Color.m6705copywmQWz5c$default(ColorScheme2.fromToken(colorScheme, radioButtonTokens.getDisabledUnselectedIconColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);

...
public abstract class BaseDatePickerStateImpl {
    ...
    public BaseDatePickerStateImpl(Long l, PrimitiveRanges2 primitiveRanges2, SelectableDates selectableDates, Locale locale) {
        ...
        this.selectableDates = SnapshotState3.mutableStateOf$default(selectableDates, null, 2, null);
        if (l != null) {
            month = calendarModelCreateCalendarModel.getMonth(l.longValue());
            if (!primitiveRanges2.contains(month.getYear())) {
                throw new IllegalArgumentException(("The initial display month's year (" + month.getYear() + ") is out of the years range of " + primitiveRanges2 + '.').toString());
            }
        } else {
            month = calendarModelCreateCalendarModel.getMonth(calendarModelCreateCalendarModel.getToday());
        }
        this._displayedMonth = SnapshotState3.mutableStateOf$default(month, null, 2, null);
    }

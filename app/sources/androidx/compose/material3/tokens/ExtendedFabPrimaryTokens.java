...
public final class ExtendedFabPrimaryTokens {
    ...
    static {
        ...
        ContainerElevation = elevationTokens.m6191getLevel3D9Ej5fM();
        ContainerHeight = C2002Dp.m7995constructorimpl((float) 56.0d);
        ContainerShape = ShapeKeyTokens.CornerLarge;
        FocusContainerElevation = elevationTokens.m6191getLevel3D9Ej5fM();
        ColorSchemeKeyTokens colorSchemeKeyTokens = ColorSchemeKeyTokens.OnPrimaryContainer;
        FocusIconColor = colorSchemeKeyTokens;
        FocusLabelTextColor = colorSchemeKeyTokens;
        HoverContainerElevation = elevationTokens.m6192getLevel4D9Ej5fM();
        HoverIconColor = colorSchemeKeyTokens;
        HoverLabelTextColor = colorSchemeKeyTokens;
        IconColor = colorSchemeKeyTokens;
        IconSize = C2002Dp.m7995constructorimpl((float) 24.0d);
        LabelTextColor = colorSchemeKeyTokens;
        LabelTextFont = TypographyKeyTokens.LabelLarge;
        LoweredContainerElevation = elevationTokens.m6189getLevel1D9Ej5fM();
        LoweredFocusContainerElevation = elevationTokens.m6189getLevel1D9Ej5fM();
        LoweredHoverContainerElevation = elevationTokens.m6190getLevel2D9Ej5fM();
        LoweredPressedContainerElevation = elevationTokens.m6189getLevel1D9Ej5fM();
        PressedContainerElevation = elevationTokens.m6191getLevel3D9Ej5fM();

...
@DebugMetadata(m3644c = "androidx.compose.material3.SliderDefaults$Thumb$1$1", m3645f = "Slider.kt", m3646l = {954}, m3647m = "invokeSuspend")
/* loaded from: classes4.dex */
final class SliderDefaults$Thumb$1$1 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ InteractionSource3 $interactionSource;
    final /* synthetic */ SnapshotStateList<Interaction> $interactions;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    SliderDefaults$Thumb$1$1(InteractionSource3 interactionSource3, SnapshotStateList<Interaction> snapshotStateList, Continuation<? super SliderDefaults$Thumb$1$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            FlowCollector<? super Interaction> flowCollector = new FlowCollector() { // from class: androidx.compose.material3.SliderDefaults$Thumb$1$1.1

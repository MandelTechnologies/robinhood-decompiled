...
final class DelegatingThemeAwareRippleNode extends DelegatingNode implements CompositionLocalConsumerModifierNode, ObserverModifierNode {
    ...
    private final void updateConfiguration() {
        ObserverModifierNode2.observeReads(this, new Function0<Unit>() { // from class: androidx.compose.material3.DelegatingThemeAwareRippleNode.updateConfiguration.1
            {
                super(0);
            }
    ...
    public final void attachNewRipple() {
        this.rippleNode = delegate(androidx.compose.material.ripple.RippleKt.m5684createRippleModifierNodeTDGSqEk(this.interactionSource, this.bounded, this.radius, new Color3() { // from class: androidx.compose.material3.DelegatingThemeAwareRippleNode$attachNewRipple$calculateColor$1
            ...
            public final long mo5580invoke0d7_KjU() {
                ...
                return ((Color) CompositionLocalConsumerModifierNode2.currentValueOf(this.this$0, ContentColor3.getLocalContentColor())).getValue();
            }

...
public final class TopAppBarColors {
    ...
    public static /* synthetic */ TopAppBarColors m6077copyt635Npw$default(TopAppBarColors topAppBarColors, long j, long j2, long j3, long j4, long j5, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return topAppBarColors.m6079copyt635Npw(j6, j2, (i & 4) != 0 ? topAppBarColors.navigationIconContentColor : j3, (i & 8) != 0 ? topAppBarColors.titleContentColor : j4, (i & 16) != 0 ? topAppBarColors.actionIconContentColor : j5);
    }

    /* renamed from: copy-t635Npw, reason: not valid java name */
    public final TopAppBarColors m6079copyt635Npw(long containerColor, long scrolledContainerColor, long navigationIconContentColor, long titleContentColor, long actionIconContentColor) {
    ...
    public final long m6078containerColorvNxB06k$material3_release(float colorTransitionFraction) {
        return Color2.m6733lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, Easing3.getFastOutLinearInEasing().transform(colorTransitionFraction));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m6707equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m6707equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m6707equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m6707equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m6707equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor);
    }

    public int hashCode() {
        return (((((((Color.m6713hashCodeimpl(this.containerColor) * 31) + Color.m6713hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m6713hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m6713hashCodeimpl(this.titleContentColor)) * 31) + Color.m6713hashCodeimpl(this.actionIconContentColor);
    }
}

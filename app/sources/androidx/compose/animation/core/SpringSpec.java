...
public final class SpringSpec<T> implements FiniteAnimationSpec<T> {
    ...
    public <V extends AnimationVectors> VectorizedSpringSpec<V> vectorize(TwoWayConverter<T, V> converter) {

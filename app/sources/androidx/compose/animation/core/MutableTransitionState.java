...
public final class MutableTransitionState<S> extends TransitionState<S> {
    ...
    public MutableTransitionState(S s) {
        super(null);
        this.currentState = SnapshotState3.mutableStateOf$default(s, null, 2, null);
        this.targetState = SnapshotState3.mutableStateOf$default(s, null, 2, null);
    }

...
public final class FloatAnimationSpec2 implements FloatAnimationSpec {
    ...
    public FloatAnimationSpec2(float f, float f2, float f3) {
        this.dampingRatio = f;
        this.stiffness = f2;
    ...
    public /* synthetic */ FloatAnimationSpec2(float f, float f2, float f3, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public float getValueFromNanos(long playTimeNanos, float initialValue, float targetValue, float initialVelocity) {
        ...
        return Float.intBitsToFloat((int) (this.spring.m4826updateValuesIJZedt4$animation_core_release(initialValue, initialVelocity, playTimeNanos / 1000000) >> 32));
    }

    @Override // androidx.compose.animation.core.FloatAnimationSpec
    public float getVelocityFromNanos(long playTimeNanos, float initialValue, float targetValue, float initialVelocity) {
        this.spring.setFinalPosition(targetValue);
        return Float.intBitsToFloat((int) (this.spring.m4826updateValuesIJZedt4$animation_core_release(initialValue, initialVelocity, playTimeNanos / 1000000) & 4294967295L));
    }
    ...
    public long getDurationNanos(float initialValue, float targetValue, float initialVelocity) {
        ...
        return SpringEstimation.estimateAnimationDurationMillis(stiffness, dampingRatio, initialVelocity / f2, f / f2, 1.0f) * 1000000;
    }
}

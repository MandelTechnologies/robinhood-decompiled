...
final class DecayAnimationSpec4<V extends AnimationVectors> implements VectorizedDecayAnimationSpec<V> {
    ...
    public DecayAnimationSpec4(FloatDecayAnimationSpec floatDecayAnimationSpec) {
    ...
    public long getDurationNanos(V initialValue, V initialVelocity) {
        if (this.velocityVector == null) {
            this.velocityVector = (V) AnimationVectors6.newInstance(initialValue);
        }
    ...
    public V getTargetValue(V initialValue, V initialVelocity) {
        if (this.targetVector == null) {
            this.targetVector = (V) AnimationVectors6.newInstance(initialValue);
        }

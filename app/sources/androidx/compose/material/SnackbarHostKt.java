...
public final class SnackbarHostKt {
    ...
    public static final void SnackbarHost(final SnackbarHostState snackbarHostState, Modifier modifier, Function3<? super SnackbarData, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i, final int i2) {
        ...
        if (composerStartRestartGroup.shouldExecute((i3 & 147) != 146, i3 & 1)) {
            ...
            if (i5 != 0) {
                function3 = ComposableSingletons$SnackbarHostKt.INSTANCE.m5576getLambda1$material_release();
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(431012348, i3, -1, "androidx.compose.material.SnackbarHost (SnackbarHost.kt:155)");
            }
    ...
    public static final void FadeInFadeOutWithScale(final SnackbarData snackbarData, Modifier modifier, final Function3<? super SnackbarData, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i, final int i2) {
        ...
        if (i5 == 0) {
            ...
            if (!composerStartRestartGroup.shouldExecute((i3 & 147) == 146, i3 & 1)) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(2036134589, i3, -1, "androidx.compose.material.FadeInFadeOutWithScale (SnackbarHost.kt:245)");
                }
                Object objRememberedValue = composerStartRestartGroup.rememberedValue();
                ...
                int i6 = 6;
                final String strM5642getString4foXLRw = Strings_androidKt.m5642getString4foXLRw(Strings.INSTANCE.m5641getSnackbarPaneTitleUdPEhr4(), composerStartRestartGroup, 6);
                if (!Intrinsics.areEqual(snackbarData2, fadeInFadeOutState.getCurrent())) {
                    composerStartRestartGroup.startReplaceGroup(1522020731);
                    ...
                    int i8 = 0;
                    for (int size2 = listFastFilterNotNull.size(); i8 < size2; size2 = size2) {
                        final SnackbarData snackbarData3 = (SnackbarData) listFastFilterNotNull.get(i8);
                        int i9 = i8;
                        final SnackbarData snackbarData4 = snackbarData2;
                        items2.add(new FadeInFadeOutAnimationItem(snackbarData3, ComposableLambda3.rememberComposableLambda(1471040642, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarHostKt$FadeInFadeOutWithScale$1$1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(3);
                            }
                            ...
                            public final void invoke(Function2<? super Composer, ? super Integer, Unit> function2, Composer composer2, int i10) {
                                int i11;
                                if ((i10 & 6) == 0) {
                                    i11 = i10 | (composer2.changedInstance(function2) ? 4 : 2);
                                } else {
                                    i11 = i10;
                                }
                                if (composer2.shouldExecute((i11 & 19) != 18, i11 & 1)) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(1471040642, i11, -1, "androidx.compose.material.FadeInFadeOutWithScale.<anonymous>.<anonymous> (SnackbarHost.kt:257)");
                                    }
                                    final boolean zAreEqual = Intrinsics.areEqual(snackbarData3, snackbarData4);
                                    int i12 = zAreEqual ? 150 : 75;
                                    int i13 = (!zAreEqual || ListUtils2.fastFilterNotNull(mutableList).size() == 1) ? 0 : 75;
                                    TweenSpec tweenSpecTween = AnimationSpecKt.tween(i12, i13, Easing3.getLinearEasing());
                                    ...
                                    if (zChangedInstance || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                                        objRememberedValue2 = new Function0<Unit>() { // from class: androidx.compose.material.SnackbarHostKt$FadeInFadeOutWithScale$1$1$opacity$1$1
                                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                            {
                                                super(0);
                                            }
                                            ...
                                            public final void invoke2() {
                                                ...
                                                CollectionsKt.removeAll((List) items3, (Function1) new Function1<FadeInFadeOutAnimationItem<SnackbarData>, Boolean>() { // from class: androidx.compose.material.SnackbarHostKt$FadeInFadeOutWithScale$1$1$opacity$1$1.1
                                                    ...
                                                    public final Boolean invoke(FadeInFadeOutAnimationItem<SnackbarData> fadeInFadeOutAnimationItem) {
                                                        return Boolean.valueOf(Intrinsics.areEqual(fadeInFadeOutAnimationItem.getKey(), snackbarData6));
                                                    }
                                                });
                                    ...
                                    SnapshotState4 snapshotState4AnimatedScale = SnackbarHostKt.animatedScale(AnimationSpecKt.tween(i12, i13, Easing3.getFastOutSlowInEasing()), zAreEqual, composer2, 0);
                                    ...
                                    boolean zChanged = composer2.changed(zAreEqual) | composer2.changed(strM5642getString4foXLRw) | composer2.changedInstance(snackbarData3);
                                    final String str = strM5642getString4foXLRw;
                                    final SnackbarData snackbarData6 = snackbarData3;
                                    Object objRememberedValue3 = composer2.rememberedValue();
                                    if (zChanged || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                                        objRememberedValue3 = new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material.SnackbarHostKt$FadeInFadeOutWithScale$1$1$1$1
                                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                            {
                                                super(1);
                                            }
                    ...
                    i4 = 6;
                    composerStartRestartGroup.startReplaceGroup(1524617353);
                    composerStartRestartGroup.endReplaceGroup();
                }
                MeasurePolicy measurePolicyMaybeCachedBoxMeasurePolicy = BoxKt.maybeCachedBoxMeasurePolicy(Alignment.INSTANCE.getTopStart(), false);
                ...
                composerStartRestartGroup.startReplaceGroup(1801449988);
                List items3 = fadeInFadeOutState.getItems();
                int size3 = items3.size();
                for (int i10 = 0; i10 < size3; i10++) {
                    FadeInFadeOutAnimationItem fadeInFadeOutAnimationItem = (FadeInFadeOutAnimationItem) items3.get(i10);
                    ...
                    composerStartRestartGroup.startMovableGroup(2123994112, snackbarData5);
                    function3Component2.invoke(ComposableLambda3.rememberComposableLambda(2041982076, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarHostKt$FadeInFadeOutWithScale$2$1$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        /* JADX WARN: Multi-variable type inference failed */
                        {
                            super(2);
                        ...
                        public final void invoke(Composer composer2, int i11) {
                            ...
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventStart(2041982076, i11, -1, "androidx.compose.material.FadeInFadeOutWithScale.<anonymous>.<anonymous>.<anonymous>.<anonymous> (SnackbarHost.kt:317)");
                            }
                    ...
                    }, composerStartRestartGroup, 54), composerStartRestartGroup, Integer.valueOf(i4));
            ...
            if (scopeUpdateScopeEndRestartGroup == null) {
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.SnackbarHostKt.FadeInFadeOutWithScale.3
                    ...
                    public final void invoke(Composer composer2, int i11) {
                        SnackbarHostKt.FadeInFadeOutWithScale(snackbarData, modifier3, function3, composer2, RecomposeScopeImpl4.updateChangedFlags(i | 1), i2);
                    }
                });
                return;
            }

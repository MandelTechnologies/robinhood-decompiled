...
@DebugMetadata(m3644c = "androidx.compose.foundation.CombinedClickableNode$onClickKeyDownEvent$1", m3645f = "Clickable.kt", m3646l = {852}, m3647m = "invokeSuspend")
/* loaded from: classes4.dex */
final class CombinedClickableNode$onClickKeyDownEvent$1 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            long longPressTimeoutMillis = ((ViewConfiguration) CompositionLocalConsumerModifierNode2.currentValueOf(this.this$0, CompositionLocalsKt.getLocalViewConfiguration())).getLongPressTimeoutMillis();
            this.label = 1;

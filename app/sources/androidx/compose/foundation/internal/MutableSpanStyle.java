...
final class MutableSpanStyle {
    ...
    public /* synthetic */ MutableSpanStyle(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        String str3 = str2;
        long j5 = jM8080getUnspecifiedXSAIIZE2;
        ...
        long j6 = jM6726getUnspecified0d7_KjU2;
        this(jM6726getUnspecified0d7_KjU, jM8080getUnspecifiedXSAIIZE, fontWeight2, fontStyle3, fontSynthesis3, fontFamily3, str3, j5, baselineShift3, textGeometricTransform3, localeList3, j6, (i & 4096) != 0 ? null : textDecoration, (i & 8192) != 0 ? null : shadow, null);
    }

    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m5077setColor8_81llA(long j) {
        this.color = j;
    }

    /* renamed from: setFontSize--R2X_6o, reason: not valid java name */
    public final void m5078setFontSizeR2X_6o(long j) {
        this.fontSize = j;
    }
    ...
    public final void m5079setFontStylemLjRB2g(FontStyle fontStyle) {
        this.fontStyle = fontStyle;
    }

    /* renamed from: setFontSynthesis-tDdu0R4, reason: not valid java name */
    public final void m5080setFontSynthesistDdu0R4(FontSynthesis fontSynthesis) {
        this.fontSynthesis = fontSynthesis;
    }
    ...
    public final void m5081setLetterSpacingR2X_6o(long j) {
        this.letterSpacing = j;
    }

    /* renamed from: setBaselineShift-_isdbwI, reason: not valid java name */
    public final void m5076setBaselineShift_isdbwI(BaselineShift baselineShift) {
        this.baselineShift = baselineShift;
    }
    ...
    public final void m5075setBackground8_81llA(long j) {
        this.background = j;
    }
    ...
    public final SpanStyle toSpanStyle() {
        return new SpanStyle(this.color, this.fontSize, this.fontWeight, this.fontStyle, this.fontSynthesis, this.fontFamily, this.fontFeatureSettings, this.letterSpacing, this.baselineShift, this.textGeometricTransform, this.localeList, this.background, this.textDecoration, this.shadow, (PlatformSpanStyle) null, (DrawScope2) null, 49152, (DefaultConstructorMarker) null);
    }
}

...
public final class LegacyTextFieldState {
    ...
    private final RecomposeScopeImpl2 recomposeScope;
    private long selectionBackgroundColor;

    /* renamed from: selectionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final SnapshotState selectionPreviewHighlightRange;

    /* renamed from: showCursorHandle$delegate, reason: from kotlin metadata */
    private final SnapshotState showCursorHandle;

    /* renamed from: showFloatingToolbar$delegate, reason: from kotlin metadata */
    private final SnapshotState showFloatingToolbar;

    /* renamed from: showSelectionHandleEnd$delegate, reason: from kotlin metadata */
    private final SnapshotState showSelectionHandleEnd;

    /* renamed from: showSelectionHandleStart$delegate, reason: from kotlin metadata */
    private final SnapshotState showSelectionHandleStart;
    private TextDelegate textDelegate;
    private AnnotatedString untransformedText;

    public LegacyTextFieldState(TextDelegate textDelegate, RecomposeScopeImpl2 recomposeScopeImpl2, SoftwareKeyboardController softwareKeyboardController) {
        this.textDelegate = textDelegate;
        this.recomposeScope = recomposeScopeImpl2;
        this.keyboardController = softwareKeyboardController;
        Boolean bool = Boolean.FALSE;
        this.hasFocus = SnapshotState3.mutableStateOf$default(bool, null, 2, null);
        this.minHeightForSingleLineField = SnapshotState3.mutableStateOf$default(C2002Dp.m7993boximpl(C2002Dp.m7995constructorimpl(0)), null, 2, null);
        this.layoutResultState = SnapshotState3.mutableStateOf$default(null, null, 2, null);
        this.handleState = SnapshotState3.mutableStateOf$default(HandleState.None, null, 2, null);
        this.showFloatingToolbar = SnapshotState3.mutableStateOf$default(bool, null, 2, null);
        this.showSelectionHandleStart = SnapshotState3.mutableStateOf$default(bool, null, 2, null);
        this.showSelectionHandleEnd = SnapshotState3.mutableStateOf$default(bool, null, 2, null);
        this.showCursorHandle = SnapshotState3.mutableStateOf$default(bool, null, 2, null);
        this.isLayoutResultStale = true;
        this.isInTouchMode = SnapshotState3.mutableStateOf$default(Boolean.TRUE, null, 2, null);
        this.keyboardActionRunner = new KeyboardActionRunner(softwareKeyboardController);
        this.autofillHighlightOn = SnapshotState3.mutableStateOf$default(bool, null, 2, null);
        this.justAutofilled = SnapshotState3.mutableStateOf$default(bool, null, 2, null);
        ...
        this.onValueChange = new Function1<TextFieldValue, Unit>() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$onValueChange$1
            ...
            public final void invoke2(TextFieldValue textFieldValue) {
                ...
                legacyTextFieldState.m5366setSelectionPreviewHighlightRange5zctL8(companion.m7651getZerod9O1mEE());
                this.this$0.m5364setDeletionPreviewHighlightRange5zctL8(companion.m7651getZerod9O1mEE());
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$onImeActionPerformed$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m5368invokeKlQnJC8(imeAction.getValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-KlQnJC8, reason: not valid java name */
            public final void m5368invokeKlQnJC8(int i) {
                this.this$0.keyboardActionRunner.m5352runActionKlQnJC8(i);
            }
        };
        this.highlightPaint = AndroidPaint_androidKt.Paint();
        this.selectionBackgroundColor = Color.INSTANCE.m6726getUnspecified0d7_KjU();
        TextRange.Companion companion = TextRange.INSTANCE;
        this.selectionPreviewHighlightRange = SnapshotState3.mutableStateOf$default(TextRange.m7634boximpl(companion.m7651getZerod9O1mEE()), null, 2, null);
        this.deletionPreviewHighlightRange = SnapshotState3.mutableStateOf$default(TextRange.m7634boximpl(companion.m7651getZerod9O1mEE()), null, 2, null);
    }
    ...
    public final RecomposeScopeImpl2 getRecomposeScope() {
    ...
    public final TextInputService3 getInputSession() {
        return this.inputSession;
    }

    public final void setInputSession(TextInputService3 textInputService3) {
        this.inputSession = textInputService3;
    }
    ...
    public final float m5361getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((C2002Dp) this.minHeightForSingleLineField.getValue()).getValue();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4, reason: not valid java name */
    public final void m5365setMinHeightForSingleLineField0680j_4(float f) {
        this.minHeightForSingleLineField.setValue(C2002Dp.m7993boximpl(f));
    }
    ...
    public final long m5363getSelectionPreviewHighlightRanged9O1mEE() {
    ...
    public final void m5366setSelectionPreviewHighlightRange5zctL8(long j) {
        this.selectionPreviewHighlightRange.setValue(TextRange.m7634boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDeletionPreviewHighlightRange-d9O1mEE, reason: not valid java name */
    public final long m5360getDeletionPreviewHighlightRanged9O1mEE() {
    ...
    public final void m5364setDeletionPreviewHighlightRange5zctL8(long j) {
        this.deletionPreviewHighlightRange.setValue(TextRange.m7634boximpl(j));
    }

    public final boolean hasHighlight() {
        return (TextRange.m7640getCollapsedimpl(m5363getSelectionPreviewHighlightRanged9O1mEE()) && TextRange.m7640getCollapsedimpl(m5360getDeletionPreviewHighlightRanged9O1mEE())) ? false : true;
    }

    /* renamed from: update-fnh65Uc, reason: not valid java name */
    public final void m5367updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean softWrap, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long selectionBackgroundColor) {
        ...
        TextDelegate textDelegateM5412updateTextDelegaterm0N8CA$default = TextDelegate2.m5412updateTextDelegaterm0N8CA$default(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, softWrap, 0, 0, 0, CollectionsKt.emptyList(), 448, null);
        if (this.textDelegate != textDelegateM5412updateTextDelegaterm0N8CA$default) {
            this.isLayoutResultStale = true;
        }
        this.textDelegate = textDelegateM5412updateTextDelegaterm0N8CA$default;
    }
}

...
public final class KeyboardActionRunner implements KeyboardActions2 {
    ...
    public final void m5352runActionKlQnJC8(int imeAction) {
        Function1<KeyboardActions2, Unit> onSend;
        ImeAction.Companion companion = ImeAction.INSTANCE;
        Unit unit = null;
        if (ImeAction.m7742equalsimpl0(imeAction, companion.m7747getDoneeUduSuo())) {
            ...
            if (!(ImeAction.m7742equalsimpl0(imeAction, companion.m7746getDefaulteUduSuo()) ? true : ImeAction.m7742equalsimpl0(imeAction, companion.m7750getNoneeUduSuo()))) {
        ...
        if (unit == null) {
            m5351defaultKeyboardActionKlQnJC8(imeAction);
        }
    }

    /* renamed from: defaultKeyboardAction-KlQnJC8, reason: not valid java name */
    public void m5351defaultKeyboardActionKlQnJC8(int imeAction) {
        ImeAction.Companion companion = ImeAction.INSTANCE;
        if (ImeAction.m7742equalsimpl0(imeAction, companion.m7749getNexteUduSuo())) {
            getFocusManager().mo6487moveFocus3ESFkO8(FocusDirection.INSTANCE.m6482getNextdhqQ8s());
            return;
        }
        if (ImeAction.m7742equalsimpl0(imeAction, companion.m7751getPreviouseUduSuo())) {
            getFocusManager().mo6487moveFocus3ESFkO8(FocusDirection.INSTANCE.m6483getPreviousdhqQ8s());
            return;
        }
        if (!ImeAction.m7742equalsimpl0(imeAction, companion.m7747getDoneeUduSuo())) {
            if (ImeAction.m7742equalsimpl0(imeAction, companion.m7748getGoeUduSuo()) ? true : ImeAction.m7742equalsimpl0(imeAction, companion.m7752getSearcheUduSuo()) ? true : ImeAction.m7742equalsimpl0(imeAction, companion.m7753getSendeUduSuo()) ? true : ImeAction.m7742equalsimpl0(imeAction, companion.m7746getDefaulteUduSuo())) {
                return;
            }
            ImeAction.m7742equalsimpl0(imeAction, companion.m7750getNoneeUduSuo());
        } else {

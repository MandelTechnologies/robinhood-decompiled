...
final class EmptyMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo4748measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m7975getMaxWidthimpl(j), Constraints.m7974getMaxHeightimpl(j), null, placementBlock, 4, null);
    }
}

...
public final class TextLayoutResultProxy {
    ...
    public static /* synthetic */ int m5439getOffsetForPosition3MmeM6k$default(TextLayoutResultProxy textLayoutResultProxy, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutResultProxy.m5440getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m5440getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        if (coerceInVisibleBounds) {
            position = m5438coercedInVisibleBoundsOfInputTextMKHz9U(position);
        }
        return this.value.m7620getOffsetForPositionk4lQ0M(m5442translateDecorationToInnerCoordinatesMKHz9U$foundation_release(position));
    }

    /* renamed from: isPositionOnText-k-4lQ0M, reason: not valid java name */
    public final boolean m5441isPositionOnTextk4lQ0M(long offset) {
        long jM5442translateDecorationToInnerCoordinatesMKHz9U$foundation_release = m5442translateDecorationToInnerCoordinatesMKHz9U$foundation_release(m5438coercedInVisibleBoundsOfInputTextMKHz9U(offset));
        int lineForVerticalPosition = this.value.getLineForVerticalPosition(Float.intBitsToFloat((int) (4294967295L & jM5442translateDecorationToInnerCoordinatesMKHz9U$foundation_release)));
        int i = (int) (jM5442translateDecorationToInnerCoordinatesMKHz9U$foundation_release >> 32);
    ...
    public final long m5442translateDecorationToInnerCoordinatesMKHz9U$foundation_release(long offset) {
        ...
        return layoutCoordinates3 == null ? offset : layoutCoordinates2.mo7242localPositionOfR5De75A(layoutCoordinates3, offset);
    }

    /* renamed from: translateInnerToDecorationCoordinates-MK-Hz9U$foundation_release, reason: not valid java name */
    public final long m5443translateInnerToDecorationCoordinatesMKHz9U$foundation_release(long offset) {
        LayoutCoordinates layoutCoordinates;
        LayoutCoordinates layoutCoordinates2 = this.innerTextFieldCoordinates;
        if (layoutCoordinates2 == null) {
            return offset;
        ...
        LayoutCoordinates layoutCoordinates3 = layoutCoordinates.isAttached() ? layoutCoordinates : null;
        return layoutCoordinates3 == null ? offset : layoutCoordinates3.mo7242localPositionOfR5De75A(layoutCoordinates2, offset);
    }
    ...
    */
    private final long m5438coercedInVisibleBoundsOfInputTextMKHz9U(long j) {
        Rect zero;
        ...
        return TextLayoutResultProxy2.m5445coerceIn3MmeM6k(j, zero);
    }
}

...
public final class LegacyTextInputMethodRequest implements PlatformTextInputMethodRequest {
    ...
    private TextFieldValue state = new TextFieldValue("", TextRange.INSTANCE.m7651getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
    ...
    @Override // androidx.compose.p011ui.platform.PlatformTextInputMethodRequest
    public RecordingInputConnection createInputConnection(EditorInfo outAttributes) {
        EditorInfo_androidKt.m5453updatepLxbY9I$default(outAttributes, this.state.getText(), this.state.getSelection(), this.imeOptions, null, 8, null);
        ...
        RecordingInputConnection recordingInputConnection = new RecordingInputConnection(this.state, new InputEventCallback2() { // from class: androidx.compose.foundation.text.input.internal.LegacyTextInputMethodRequest.createInputConnection.1
            ...
            public void mo5472onImeActionKlQnJC8(int imeAction) {
                LegacyTextInputMethodRequest.this.onImeActionPerformed.invoke(ImeAction.m7739boximpl(imeAction));
            }
    ...
    public final void notifyFocusedRect(androidx.compose.p011ui.geometry.Rect rect) {
        Rect rect2;
    ...
    public final void updateTextLayoutResult(TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, androidx.compose.p011ui.geometry.Rect innerTextFieldBounds, androidx.compose.p011ui.geometry.Rect decorationBoxBounds) {

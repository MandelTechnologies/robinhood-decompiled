...
public abstract class LegacyPlatformTextInputServiceAdapter implements TextInputService2 {
    ...
    public final void registerModifier(LegacyPlatformTextInputNode node) {
        if (!(this.textInputModifierNode == null)) {
            InlineClassHelper.throwIllegalStateException("Expected textInputModifierNode to be null");
        }
    ...
    public final void unregisterModifier(LegacyPlatformTextInputNode node) {
        if (!(this.textInputModifierNode == node)) {
            InlineClassHelper.throwIllegalStateException("Expected textInputModifierNode to be " + node + " but was " + this.textInputModifierNode);
        }

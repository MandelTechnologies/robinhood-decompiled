...
import androidx.compose.p011ui.platform.PlatformTextInputModifierNode;
...
public final class LegacyAdaptingPlatformTextInputModifierNode extends Modifier.Node implements PlatformTextInputModifierNode, CompositionLocalConsumerModifierNode, GlobalPositionAwareModifierNode, LegacyPlatformTextInputServiceAdapter.LegacyPlatformTextInputNode {
    ...
    private final SnapshotState layoutCoordinates = SnapshotState3.mutableStateOf$default(null, null, 2, null);
    ...
    public SoftwareKeyboardController getSoftwareKeyboardController() {
        return (SoftwareKeyboardController) CompositionLocalConsumerModifierNode2.currentValueOf(this, CompositionLocalsKt.getLocalSoftwareKeyboardController());
    }
    ...
    public ViewConfiguration getViewConfiguration() {
        return (ViewConfiguration) CompositionLocalConsumerModifierNode2.currentValueOf(this, CompositionLocalsKt.getLocalViewConfiguration());
    }
    ...
    @DebugMetadata(m3644c = "androidx.compose.foundation.text.input.internal.LegacyAdaptingPlatformTextInputModifierNode$launchTextInputSession$1", m3645f = "LegacyAdaptingPlatformTextInputModifierNode.kt", m3646l = {EnumC7081g.SDK_ASSET_ILLUSTRATION_INSTITUTION_CIRCLE_VALUE}, m3647m = "invokeSuspend")
    ...
    static final class C14061 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ Function2<PlatformTextInputSession, Continuation<?>, Object> $block;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C14061(Function2<? super PlatformTextInputSession, ? super Continuation<?>, ? extends Object> function2, Continuation<? super C14061> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LegacyAdaptingPlatformTextInputModifierNode.this.new C14061(this.$block, continuation);
        }
    ...
    public Job launchTextInputSession(Function2<? super PlatformTextInputSession, ? super Continuation<?>, ? extends Object> block) {
        if (getIsAttached()) {
            return BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, CoroutineStart.UNDISPATCHED, new C14061(block, null), 1, null);
        }
        return null;
    }
}

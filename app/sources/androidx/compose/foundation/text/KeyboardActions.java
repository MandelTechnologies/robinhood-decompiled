...
public final class KeyboardActions {
    ...
    private final Function1<KeyboardActions2, Unit> onDone;
    private final Function1<KeyboardActions2, Unit> onGo;
    private final Function1<KeyboardActions2, Unit> onNext;
    private final Function1<KeyboardActions2, Unit> onPrevious;
    private final Function1<KeyboardActions2, Unit> onSearch;
    private final Function1<KeyboardActions2, Unit> onSend;
    ...
    public KeyboardActions(Function1<? super KeyboardActions2, Unit> function1, Function1<? super KeyboardActions2, Unit> function12, Function1<? super KeyboardActions2, Unit> function13, Function1<? super KeyboardActions2, Unit> function14, Function1<? super KeyboardActions2, Unit> function15, Function1<? super KeyboardActions2, Unit> function16) {
    ...
    public final Function1<KeyboardActions2, Unit> getOnDone() {
        return this.onDone;
    }

    public final Function1<KeyboardActions2, Unit> getOnGo() {
        return this.onGo;
    }

    public final Function1<KeyboardActions2, Unit> getOnNext() {
        return this.onNext;
    }

    public final Function1<KeyboardActions2, Unit> getOnPrevious() {
        return this.onPrevious;
    }

    public final Function1<KeyboardActions2, Unit> getOnSearch() {
        return this.onSearch;
    }

    public final Function1<KeyboardActions2, Unit> getOnSend() {
        return this.onSend;
    }
    ...
    public int hashCode() {
        Function1<KeyboardActions2, Unit> function1 = this.onDone;
        int iHashCode = (function1 != null ? function1.hashCode() : 0) * 31;
        Function1<KeyboardActions2, Unit> function12 = this.onGo;
        int iHashCode2 = (iHashCode + (function12 != null ? function12.hashCode() : 0)) * 31;
        Function1<KeyboardActions2, Unit> function13 = this.onNext;
        int iHashCode3 = (iHashCode2 + (function13 != null ? function13.hashCode() : 0)) * 31;
        Function1<KeyboardActions2, Unit> function14 = this.onPrevious;
        int iHashCode4 = (iHashCode3 + (function14 != null ? function14.hashCode() : 0)) * 31;
        Function1<KeyboardActions2, Unit> function15 = this.onSearch;
        int iHashCode5 = (iHashCode4 + (function15 != null ? function15.hashCode() : 0)) * 31;
        Function1<KeyboardActions2, Unit> function16 = this.onSend;
        return iHashCode5 + (function16 != null ? function16.hashCode() : 0);
    }

    /* compiled from: KeyboardActions.kt */
    @Metadata(m3635d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R \u0010\u0005\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\u0012\n\u0004\b\u0005\u0010\u0006\u0012\u0004\b\t\u0010\u0003\u001a\u0004\b\u0007\u0010\b¨\u0006\n"}, m3636d2 = {"Landroidx/compose/foundation/text/KeyboardActions$Companion;", "", "<init>", "()V", "Landroidx/compose/foundation/text/KeyboardActions;", "Default", "Landroidx/compose/foundation/text/KeyboardActions;", "getDefault", "()Landroidx/compose/foundation/text/KeyboardActions;", "getDefault$annotations", "foundation_release"}, m3637k = 1, m3638mv = {1, 9, 0}, m3640xi = 48)

...
public final class SelectionController implements RememberObserver {
    ...
    public /* synthetic */ SelectionController(long j, SelectionRegistrar selectionRegistrar, long j2, SelectionController6 selectionController6, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, selectionRegistrar, j2, (i & 8) != 0 ? SelectionController6.INSTANCE.getEmpty() : selectionController6, null);
    }
    ...
    public final void updateTextLayout(TextLayoutResult textLayoutResult) {
        ...
        this.params = SelectionController6.copy$default(this.params, null, textLayoutResult, 1, null);
    }

    public final void updateGlobalPosition(LayoutCoordinates coordinates) {
        this.params = SelectionController6.copy$default(this.params, coordinates, null, 2, null);
    ...
    public final void draw(DrawScope drawScope) {
        ...
        if (this.params.getShouldClip()) {
            ...
            float fIntBitsToFloat2 = Float.intBitsToFloat((int) (drawScope.mo6963getSizeNHjbRc() & 4294967295L));
            ...
            try {
                ...
                DrawScope.m6955drawPathLG529CI$default(drawScope, pathForRange, this.backgroundSelectionColor, 0.0f, null, null, 0, 60, null);
                return;
            } finally {

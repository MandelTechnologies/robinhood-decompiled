...
@DebugMetadata(m3644c = "androidx.compose.foundation.DefaultDebugIndication$DefaultDebugIndicationInstance$onAttach$1", m3645f = "Indication.kt", m3646l = {EnumC7081g.SDK_ASSET_ILLUSTRATION_BUBBLES_QUESTION_VALUE}, m3647m = "invokeSuspend")
/* loaded from: classes4.dex */
final class DefaultDebugIndication$DefaultDebugIndicationInstance$onAttach$1 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
        ...
        if (i == 0) {
            ...
            FlowCollector<? super Interaction> flowCollector = new FlowCollector() { // from class: androidx.compose.foundation.DefaultDebugIndication$DefaultDebugIndicationInstance$onAttach$1.1
                ...
                public final Object emit(Interaction interaction, Continuation<? super Unit> continuation) {
                    ...
                    if (z) {
                        DrawModifierNode2.invalidateDraw(defaultDebugIndicationInstance);
                    }

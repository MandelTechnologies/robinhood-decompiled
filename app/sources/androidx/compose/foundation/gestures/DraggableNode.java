...
public final class DraggableNode extends DragGestureNode {
    ...
    /* compiled from: Draggable.kt */
    @Metadata(m3635d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m3636d2 = {"<anonymous>", "", "Landroidx/compose/foundation/gestures/DragScope;"}, m3637k = 3, m3638mv = {1, 9, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "androidx.compose.foundation.gestures.DraggableNode$drag$2", m3645f = "Draggable.kt", m3646l = {300}, m3647m = "invokeSuspend")
    /* renamed from: androidx.compose.foundation.gestures.DraggableNode$drag$2 */
    /* loaded from: classes4.dex */
    static final class C11082 extends ContinuationImpl7 implements Function2<DragScope, Continuation<? super Unit>, Object> {
        ...
        C11082(Function2<? super Function1<? super DragEvent.DragDelta, Unit>, ? super Continuation<? super Unit>, ? extends Object> function2, DraggableNode draggableNode, Continuation<? super C11082> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C11082 c11082 = new C11082(this.$forEachDelta, this.this$0, continuation);
            c11082.L$0 = obj;
            return c11082;
        }
        ...
        public final Object invoke(DragScope dragScope, Continuation<? super Unit> continuation) {
            return ((C11082) create(dragScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
            ...
            if (i == 0) {
                ...
                Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.DraggableNode.drag.2.1
                    ...
                    public final void invoke2(DragEvent.DragDelta dragDelta) {
                        dragScope.dragBy(DraggableKt.m4991toFloat3MmeM6k(draggableNode.m4998reverseIfNeededMKHz9U(dragDelta.getDelta()), draggableNode.orientation));
                    }
                };
                this.label = 1;
    ...
    public Object drag(Function2<? super Function1<? super DragEvent.DragDelta, Unit>, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        Object objDrag = this.state.drag(MutatorMutex2.UserInput, new C11082(function2, this, null), continuation);
    ...
    public final long m4997reverseIfNeededAH228Gc(long j) {
        return Velocity.m8106timesadjELrA(j, this.reverseDirection ? -1.0f : 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: reverseIfNeeded-MK-Hz9U, reason: not valid java name */
    public final long m4998reverseIfNeededMKHz9U(long j) {
        return Offset.m6548timestuRUvjQ(j, this.reverseDirection ? -1.0f : 1.0f);
    }
}

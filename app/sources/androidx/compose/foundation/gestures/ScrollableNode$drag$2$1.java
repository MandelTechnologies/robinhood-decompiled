...
@DebugMetadata(m3644c = "androidx.compose.foundation.gestures.ScrollableNode$drag$2$1", m3645f = "Scrollable.kt", m3646l = {330}, m3647m = "invokeSuspend")
/* loaded from: classes4.dex */
final class ScrollableNode$drag$2$1 extends ContinuationImpl7 implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
        ...
        if (i == 0) {
            ...
            Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.ScrollableNode$drag$2$1.1
                ...
                public final void invoke2(DragEvent.DragDelta dragDelta) {
                    nestedScrollScope.mo5008scrollByWithOverscrollOzD1aCk(scrollingLogic.m5040singleAxisOffsetMKHz9U(dragDelta.getDelta()), NestedScrollModifier8.INSTANCE.m7136getUserInputWNlRxjI());
                }
            };
            this.label = 1;

...
final class DefaultDraggableState implements DraggableState {
    ...
    @DebugMetadata(m3644c = "androidx.compose.foundation.gestures.DefaultDraggableState$drag$2", m3645f = "Draggable.kt", m3646l = {612}, m3647m = "invokeSuspend")
    /* renamed from: androidx.compose.foundation.gestures.DefaultDraggableState$drag$2 */
    static final class C10862 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C10862(MutatorMutex2 mutatorMutex2, Function2<? super DragScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C10862> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return DefaultDraggableState.this.new C10862(this.$dragPriority, this.$block, continuation);
        }
    ...
    public Object drag(MutatorMutex2 mutatorMutex2, Function2<? super DragScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScope2.coroutineScope(new C10862(mutatorMutex2, function2, null), continuation);

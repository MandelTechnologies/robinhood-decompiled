...
final class ScrollableElement extends ModifierNodeElement<ScrollableNode> {
    ...
    public ScrollableElement(ScrollableState scrollableState, Orientation orientation, Overscroll overscroll, boolean z, boolean z2, FlingBehavior flingBehavior, InteractionSource3 interactionSource3, BringIntoViewSpec bringIntoViewSpec) {
    ...
    public int hashCode() {
        ...
        int iHashCode2 = (((((iHashCode + (overscroll != null ? overscroll.hashCode() : 0)) * 31) + Boolean.hashCode(this.enabled)) * 31) + Boolean.hashCode(this.reverseDirection)) * 31;
        ...
        int iHashCode4 = (iHashCode3 + (interactionSource3 != null ? interactionSource3.hashCode() : 0)) * 31;

...
public final class DraggableKt {
    ...
    public static final DraggableState rememberDraggableState(Function1<? super Float, Unit> function1, Composer composer, int i) {
        ...
        final SnapshotState4 snapshotState4RememberUpdatedState = SnapshotStateKt.rememberUpdatedState(function1, composer, i & 14);
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = DraggableState(new Function1<Float, Unit>() { // from class: androidx.compose.foundation.gestures.DraggableKt$rememberDraggableState$1$1
                ...
                public final void invoke(float f) {
                    snapshotState4RememberUpdatedState.getValue().invoke(Float.valueOf(f));
                }
            });
    ...
    public static /* synthetic */ Modifier draggable$default(Modifier modifier, DraggableState draggableState, Orientation orientation, boolean z, InteractionSource3 interactionSource3, boolean z2, Function3 function3, Function3 function32, boolean z3, int i, Object obj) {
        if ((i & 4) != 0) {
            z = true;
        }
        boolean z4 = z;
        ...
        return draggable(modifier, draggableState, orientation, z4, interactionSource3, (i & 16) != 0 ? false : z2, (i & 32) != 0 ? NoOpOnDragStarted : function3, (i & 64) != 0 ? NoOpOnDragStopped : function32, (i & 128) != 0 ? false : z3);
    }

    public static final Modifier draggable(Modifier modifier, DraggableState draggableState, Orientation orientation, boolean z, InteractionSource3 interactionSource3, boolean z2, Function3<? super CoroutineScope, ? super Offset, ? super Continuation<? super Unit>, ? extends Object> function3, Function3<? super CoroutineScope, ? super Float, ? super Continuation<? super Unit>, ? extends Object> function32, boolean z3) {
        return modifier.then(new DraggableElement(draggableState, orientation, z, interactionSource3, z2, function3, function32, z3));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-3MmeM6k, reason: not valid java name */
    public static final float m4991toFloat3MmeM6k(long j, Orientation orientation) {
    ...
    public static final float m4992toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m8102getYimpl(j) : Velocity.m8101getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toValidVelocity-TH1AsA0, reason: not valid java name */
    public static final long m4993toValidVelocityTH1AsA0(long j) {
        return Velocity2.Velocity(Float.isNaN(Velocity.m8101getXimpl(j)) ? 0.0f : Velocity.m8101getXimpl(j), Float.isNaN(Velocity.m8102getYimpl(j)) ? 0.0f : Velocity.m8102getYimpl(j));
    }
}

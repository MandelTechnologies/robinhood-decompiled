...
public final class BringIntoViewRequestPriorityQueue {
    ...
    public final boolean enqueue(final ContentInViewNode.Request request) {
        ...
        PrimitiveRanges2 primitiveRanges2Until = RangesKt.until(0, this.requests.getSize());
    ...
    public final void resumeAndRemoveAll() {
        ...
        if (first <= last) {
            while (true) {
                this.requests.content[first].getContinuation().resumeWith(Result.m28550constructorimpl(Unit.INSTANCE));
                if (first == last) {
                    break;
                } else {
                    first++;
    ...
    public final void cancelAndRemoveAll(Throwable cause) {
        ...
        InlineClassHelper.throwIllegalStateException("uncancelled requests present");
    }
}

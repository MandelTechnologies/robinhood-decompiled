...
public interface FlowLineMeasurePolicy extends RowColumnMeasurePolicy {
    ...
    default long mo5105createConstraintsxF2OJ5Q(int mainAxisMin, int crossAxisMin, int mainAxisMax, int crossAxisMax, boolean isPrioritizing) {
        if (isHorizontal()) {
        ...
        return MeasureScope.layout$default(measureScope, i2, i, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.FlowLineMeasurePolicy$placeHelper$1$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                while (i4 < endIndex) {
                    ...
                    int crossAxisPosition = this.getCrossAxisPosition(placeable, crossAxisLayoutSize, layoutDirection2, beforeCrossAxisAlignmentLine) + i3;
    ...
    default int getCrossAxisPosition(Placeable placeable, int crossAxisLayoutSize, LayoutDirection layoutDirection, int beforeCrossAxisAlignmentLine) {
        ...
        return crossAxisAlignment.align$foundation_layout_release(crossAxisLayoutSize - crossAxisSize(placeable), layoutDirection, placeable, beforeCrossAxisAlignmentLine);
    }

...
public final class WindowInsetsPadding3 implements LayoutModifier, ModifierLocalConsumer, ModifierLocalProvider<WindowInsets> {
    ...
    private final SnapshotState unconsumedInsets;

    public WindowInsetsPadding3(WindowInsets windowInsets) {
        this.insets = windowInsets;
        this.unconsumedInsets = SnapshotState3.mutableStateOf$default(windowInsets, null, 2, null);
        this.consumedInsets = SnapshotState3.mutableStateOf$default(windowInsets, null, 2, null);
    }
    ...
    public MeasureResult mo5106measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable placeableMo7239measureBRTryo0 = measurable.mo7239measureBRTryo0(Constraints2.m7991offsetNN6EwU(j, -right, -bottom));
        return MeasureScope.layout$default(measureScope, Constraints2.m7990constrainWidthK40F9xA(j, placeableMo7239measureBRTryo0.getWidth() + right), Constraints2.m7989constrainHeightK40F9xA(j, placeableMo7239measureBRTryo0.getHeight() + bottom), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.InsetsPaddingModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo7239measureBRTryo0, left, top, 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public void onModifierLocalsUpdated(ModifierLocal3 scope) {
        WindowInsets windowInsets = (WindowInsets) scope.getCurrent(WindowInsetsPadding6.getModifierLocalConsumedWindowInsets());
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof WindowInsetsPadding3) {
            return Intrinsics.areEqual(((WindowInsetsPadding3) other).insets, this.insets);
        }
        return false;
    }

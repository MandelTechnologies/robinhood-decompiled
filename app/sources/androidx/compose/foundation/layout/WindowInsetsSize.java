...
final class WindowInsetsSize extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public WindowInsetsSize(WindowInsets windowInsets, Function1<? super InspectorInfo, Unit> function1, Function2<? super WindowInsets, ? super Density, Integer> function2) {
        super(function1);
    ...
    public MeasureResult mo5106measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable placeableMo7239measureBRTryo0 = measurable.mo7239measureBRTryo0(Constraints.m7967copyZbe2FdA$default(j, 0, 0, iIntValue, iIntValue, 3, null));
        return MeasureScope.layout$default(measureScope, placeableMo7239measureBRTryo0.getWidth(), iIntValue, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedHeightModifier$measure$2
            {
                super(1);
            }
    ...
    public void onModifierLocalsUpdated(ModifierLocal3 scope) {
        setUnconsumedInsets(WindowInsetsKt.exclude(this.insets, (WindowInsets) scope.getCurrent(WindowInsetsPadding6.getModifierLocalConsumedWindowInsets())));
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof WindowInsetsSize)) {
            return false;
        }
        WindowInsetsSize windowInsetsSize = (WindowInsetsSize) other;
        return Intrinsics.areEqual(this.insets, windowInsetsSize.insets) && this.heightCalc == windowInsetsSize.heightCalc;
    }

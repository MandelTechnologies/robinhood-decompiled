...
public final class Row2 {
    ...
    public static final long createRowConstraints(boolean z, int i, int i2, int i3, int i4) {
        if (!z) {
            return Constraints2.Constraints(i, i3, i2, i4);
        }
        return Constraints.INSTANCE.m7983fitPrioritizingWidthZbe2FdA(i, i3, i2, i4);
    }
}

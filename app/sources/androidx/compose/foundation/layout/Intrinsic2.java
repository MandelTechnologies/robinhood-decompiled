...
final class Intrinsic2 extends Intrinsic5 {
    ...
    public Intrinsic2(Intrinsic4 intrinsic4, boolean z) {
        this.height = intrinsic4;
        this.enforceIncoming = z;
    }
    ...
    public long mo5121calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (this.height == Intrinsic4.Min) {
            iMaxIntrinsicHeight = measurable.minIntrinsicHeight(Constraints.m7975getMaxWidthimpl(j));
        } else {
            iMaxIntrinsicHeight = measurable.maxIntrinsicHeight(Constraints.m7975getMaxWidthimpl(j));
        }
        if (iMaxIntrinsicHeight < 0) {
            iMaxIntrinsicHeight = 0;
        }
        return Constraints.INSTANCE.m7985fixedHeightOenEA2s(iMaxIntrinsicHeight);
    }
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        return this.height == Intrinsic4.Min ? intrinsicMeasurable.minIntrinsicHeight(i) : intrinsicMeasurable.maxIntrinsicHeight(i);
    }

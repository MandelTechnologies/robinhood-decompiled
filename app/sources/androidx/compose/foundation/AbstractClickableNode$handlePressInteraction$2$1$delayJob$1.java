...
@DebugMetadata(m3644c = "androidx.compose.foundation.AbstractClickableNode$handlePressInteraction$2$1$delayJob$1", m3645f = "Clickable.kt", m3646l = {1257, 1260}, m3647m = "invokeSuspend")
/* loaded from: classes4.dex */
final class AbstractClickableNode$handlePressInteraction$2$1$delayJob$1 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    AbstractClickableNode$handlePressInteraction$2$1$delayJob$1(AbstractClickableNode abstractClickableNode, long j, InteractionSource3 interactionSource3, Continuation<? super AbstractClickableNode$handlePressInteraction$2$1$delayJob$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        this.L$0 = press2;
        this.label = 2;
        if (interactionSource3.emit(press2, this) != coroutine_suspended) {
            press = press2;
            this.this$0.pressInteraction = press;
            return Unit.INSTANCE;
        }

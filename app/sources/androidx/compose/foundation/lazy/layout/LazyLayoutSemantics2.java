...
public final class LazyLayoutSemantics2 {
    ...
    public static final Modifier lazyLayoutSemantics(Modifier modifier, Function0<? extends LazyLayoutItemProvider> function0, LazyLayoutSemantics lazyLayoutSemantics, Orientation orientation, boolean z, boolean z2, Composer composer, int i) {
        ...
        Modifier modifierThen = modifier.then(new LazyLayoutSemantics3(function0, lazyLayoutSemantics, orientation, z, z2));
        if (ComposerKt.isTraceInProgress()) {

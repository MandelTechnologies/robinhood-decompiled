...
public final class LazyGridItemProvider3 {
    public static final Function0<LazyGridItemProvider> rememberLazyGridItemProviderLambda(final LazyGridState lazyGridState, Function1<? super LazyGridScope, Unit> function1, Composer composer, int i) {
        ...
        if (z || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            final SnapshotState4 snapshotState4DerivedStateOf = SnapshotStateKt.derivedStateOf(SnapshotStateKt.referentialEqualityPolicy(), new Function0<LazyGridIntervalContent>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridItemProviderKt$rememberLazyGridItemProviderLambda$1$intervalContentState$1
                ...
                public final LazyGridIntervalContent invoke() {
                    return new LazyGridIntervalContent(snapshotState4RememberUpdatedState.getValue());
                }
            });
            final SnapshotState4 snapshotState4DerivedStateOf2 = SnapshotStateKt.derivedStateOf(SnapshotStateKt.referentialEqualityPolicy(), new Function0<LazyGridItemProvider2>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridItemProviderKt$rememberLazyGridItemProviderLambda$1$itemProviderState$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
                ...
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // kotlin.jvm.functions.Function0
                public final LazyGridItemProvider2 invoke() {
                    LazyGridIntervalContent value = snapshotState4DerivedStateOf.getValue();
                    return new LazyGridItemProvider2(lazyGridState, value, new LazyLayoutKeyIndexMap2(lazyGridState.getNearestRange$foundation_release(), value));
                }
            });
            objRememberedValue = new PropertyReference0Impl(snapshotState4DerivedStateOf2) { // from class: androidx.compose.foundation.lazy.grid.LazyGridItemProviderKt$rememberLazyGridItemProviderLambda$1$1

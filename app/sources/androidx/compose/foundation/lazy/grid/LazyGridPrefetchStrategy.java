...
public interface LazyGridPrefetchStrategy {
    ...
    void onScroll(LazyGridPrefetchStrategy3 lazyGridPrefetchStrategy3, float f, LazyGridLayoutInfo lazyGridLayoutInfo);

    void onVisibleItemsUpdated(LazyGridPrefetchStrategy3 lazyGridPrefetchStrategy3, LazyGridLayoutInfo lazyGridLayoutInfo);
}

...
public final class PagerScrollPosition {
    ...
    public PagerScrollPosition(int i, float f, PagerState pagerState) {
        ...
        this.currentPage = SnapshotIntState3.mutableIntStateOf(i);
        this.currentPageOffsetFraction = SnapshotFloatState3.mutableFloatStateOf(f);
    ...
    public final int matchPageWithKey(PagerLazyLayoutItemProvider itemProvider, int index) {
        int iFindIndexByKey = LazyLayoutItemProvider2.findIndexByKey(itemProvider, this.lastKnownCurrentPageKey, index);

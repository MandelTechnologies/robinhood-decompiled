...
public final class PagerBeyondBoundsModifier2 implements LazyLayoutBeyondBoundsState {
    ...
    public int itemsPerViewport() {
        ...
        int mainAxisViewportSize = PagerLayoutInfo2.getMainAxisViewportSize(this.state.getLayoutInfo());

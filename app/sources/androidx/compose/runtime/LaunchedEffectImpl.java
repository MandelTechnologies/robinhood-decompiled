...
public final class LaunchedEffectImpl implements RememberObserver {
    ...
    public LaunchedEffectImpl(CoroutineContext coroutineContext, Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> function2) {
        this.task = function2;
        this.scope = CoroutineScope2.CoroutineScope(coroutineContext);
    }
    ...
    public void onRemembered() {
        Job job = this.job;
        if (job != null) {
            Job6.cancel$default(job, "Old job was still running!", null, 2, null);
        }

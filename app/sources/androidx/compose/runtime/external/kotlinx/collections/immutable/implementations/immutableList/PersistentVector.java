...
public final class PersistentVector<E> extends AbstractPersistentList<E> implements ImmutableList2<E> {
    ...
    public PersistentVector(Object[] objArr, Object[] objArr2, int i, int i2) {
        ...
        this.rootShift = i2;
        if (!(size() > 32)) {
            Preconditions3.throwIllegalArgumentException("Trie-based persistent vector should have at least 33 elements, got " + size());
        }
        commonFunctions.m6425assert(size() - UtilsKt.rootSize(size()) <= RangesKt.coerceAtMost(objArr2.length, 32));
    }
    ...
    @Override // java.util.Collection, java.util.List, androidx.compose.runtime.external.kotlinx.collections.immutable.ImmutableList2
    public ImmutableList2<E> add(E element) {
    ...
    */
    ...
    @Override // java.util.List, androidx.compose.runtime.external.kotlinx.collections.immutable.ImmutableList2
    public ImmutableList2<E> add(int index, E element) {
    ...
    @Override // androidx.compose.runtime.external.kotlinx.collections.immutable.ImmutableList2
    public ImmutableList2<E> removeAt(int index) {
    ...
    private final ImmutableList2<E> removeFromTailAt(Object[] root, int rootSize, int shift, int index) {
        int size = size() - rootSize;
    ...
    private final ImmutableList2<E> pullLastBufferFromRoot(Object[] root, int rootSize, int shift) {
        if (shift == 0) {
            if (root.length == 33) {
    ...
    @Override // androidx.compose.runtime.external.kotlinx.collections.immutable.ImmutableList2
    public ImmutableList2<E> removeAll(Function1<? super E, Boolean> predicate) {
    ...
    @Override // kotlin.collections.AbstractList, java.util.List, androidx.compose.runtime.external.kotlinx.collections.immutable.ImmutableList2
    public ImmutableList2<E> set(int index, E element) {
        ListImplementation.checkElementIndex$runtime_release(index, size());
        if (rootSize() <= index) {
            Object[] objArrCopyOf = Arrays.copyOf(this.tail, 32);
            Intrinsics.checkNotNullExpressionValue(objArrCopyOf, "copyOf(...)");

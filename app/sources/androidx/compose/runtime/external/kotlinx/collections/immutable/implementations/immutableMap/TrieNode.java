...
public final class TrieNode<K, V> {
    ...
    private final TrieNode<K, V> insertEntryAt(int positionMask, K key, V value) {
        return new TrieNode<>(positionMask | this.dataMap, this.nodeMap, TrieNode2.insertEntryAtIndex(this.buffer, entryKeyIndex$runtime_release(positionMask), key, value));
    }
    ...
    private final TrieNode<K, V> mutableInsertEntryAt(int positionMask, K key, V value, MutabilityOwnership owner) {
        ...
        if (this.ownedBy == owner) {
            this.buffer = TrieNode2.insertEntryAtIndex(this.buffer, iEntryKeyIndex$runtime_release, key, value);
            this.dataMap = positionMask | this.dataMap;
            return this;
        }
        return new TrieNode<>(positionMask | this.dataMap, this.nodeMap, TrieNode2.insertEntryAtIndex(this.buffer, iEntryKeyIndex$runtime_release, key, value), owner);
    }
    ...
    private final TrieNode<K, V> updateNodeAtIndex(int nodeIndex, int positionMask, TrieNode<K, V> newNode) {
        ...
        if (objArr.length == 2 && newNode.nodeMap == 0) {
            ...
            return new TrieNode<>(this.dataMap ^ positionMask, positionMask ^ this.nodeMap, TrieNode2.replaceNodeWithEntry(this.buffer, nodeIndex, entryKeyIndex$runtime_release(positionMask), objArr[0], objArr[1]));
        }
    ...
    private final TrieNode<K, V> removeNodeAtIndex(int nodeIndex, int positionMask) {
        ...
        return new TrieNode<>(this.dataMap, positionMask ^ this.nodeMap, TrieNode2.removeNodeAtIndex(objArr, nodeIndex));
    }
    ...
    private final TrieNode<K, V> mutableRemoveNodeAtIndex(int nodeIndex, int positionMask, MutabilityOwnership owner) {
        ...
        if (this.ownedBy == owner) {
            this.buffer = TrieNode2.removeNodeAtIndex(objArr, nodeIndex);
            this.nodeMap ^= positionMask;
            return this;
        }
        return new TrieNode<>(this.dataMap, positionMask ^ this.nodeMap, TrieNode2.removeNodeAtIndex(objArr, nodeIndex), owner);
    }
    ...
    private final Object[] bufferMoveEntryToNode(int keyIndex, int positionMask, int newKeyHash, K newKey, V newValue, int shift, MutabilityOwnership owner) {
        ...
        return TrieNode2.replaceEntryWithNode(this.buffer, keyIndex, nodeIndex$runtime_release(positionMask) + 1, makeNode(kKeyAtIndex != null ? kKeyAtIndex.hashCode() : 0, kKeyAtIndex, valueAtKeyIndex(keyIndex), newKeyHash, newKey, newValue, shift + 5, owner));
    }
    ...
    private final TrieNode<K, V> makeNode(int keyHash1, K key1, V value1, int keyHash2, K key2, V value2, int shift, MutabilityOwnership owner) {
        ...
        int iIndexSegment = TrieNode2.indexSegment(keyHash1, shift);
        int iIndexSegment2 = TrieNode2.indexSegment(keyHash2, shift);
    ...
    private final TrieNode<K, V> removeEntryAtIndex(int keyIndex, int positionMask) {
        ...
        return new TrieNode<>(positionMask ^ this.dataMap, this.nodeMap, TrieNode2.removeEntryAtIndex(objArr, keyIndex));
    }
    ...
    private final TrieNode<K, V> mutableRemoveEntryAtIndex(int keyIndex, int positionMask, PersistentHashMapBuilder<K, V> mutator) {
        ...
        if (this.ownedBy == mutator.getOwnership()) {
            this.buffer = TrieNode2.removeEntryAtIndex(this.buffer, keyIndex);
            this.dataMap ^= positionMask;
            return this;
        }
        return new TrieNode<>(positionMask ^ this.dataMap, this.nodeMap, TrieNode2.removeEntryAtIndex(this.buffer, keyIndex), mutator.getOwnership());
    }
    ...
    private final TrieNode<K, V> collisionRemoveEntryAtIndex(int i) {
        ...
        return new TrieNode<>(0, 0, TrieNode2.removeEntryAtIndex(objArr, i));
    }
    ...
    private final TrieNode<K, V> mutableCollisionRemoveEntryAtIndex(int i, PersistentHashMapBuilder<K, V> mutator) {
        ...
        if (this.ownedBy == mutator.getOwnership()) {
            this.buffer = TrieNode2.removeEntryAtIndex(this.buffer, i);
            return this;
        }
        return new TrieNode<>(0, 0, TrieNode2.removeEntryAtIndex(this.buffer, i), mutator.getOwnership());
    }
    ...
    private final ModificationResult<K, V> collisionPut(K key, V value) {
        ...
        return new TrieNode(0, 0, TrieNode2.insertEntryAtIndex(this.buffer, 0, key, value)).asInsertResult();
    }
    ...
    private final TrieNode<K, V> mutableCollisionPut(K key, V value, PersistentHashMapBuilder<K, V> mutator) {
        ...
        mutator.setSize(mutator.size() + 1);
        return new TrieNode<>(0, 0, TrieNode2.insertEntryAtIndex(this.buffer, 0, key, value), mutator.getOwnership());
    }
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> otherNode, DeltaCounter intersectionCounter, MutabilityOwnership owner) {
        commonFunctions.m6425assert(this.nodeMap == 0);
        commonFunctions.m6425assert(this.dataMap == 0);
        commonFunctions.m6425assert(otherNode.nodeMap == 0);
        commonFunctions.m6425assert(otherNode.dataMap == 0);
        Object[] objArr = this.buffer;
    ...
    public final boolean containsKey(int keyHash, K key, int shift) {
        int iIndexSegment = 1 << TrieNode2.indexSegment(keyHash, shift);
    ...
    public final TrieNode<K, V> mutablePutAll(TrieNode<K, V> otherNode, int shift, DeltaCounter intersectionCounter, PersistentHashMapBuilder<K, V> mutator) {
        ...
        int i7 = 0;
        if (!((i2 & i5) == 0)) {
            Preconditions3.throwIllegalStateException("Check failed.");
        }

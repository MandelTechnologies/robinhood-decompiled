...
public class PersistentHashMapBuilder<K, V> extends AbstractMutableMap<K, V> implements ImmutableMap2.Builder<K, V> {
    ...
    public Set<Map.Entry<K, V>> getEntries() {
        return new PersistentHashMapBuilderContentViews2(this);
    }

    @Override // kotlin.collections.AbstractMutableMap
    public Set<K> getKeys() {
        return new PersistentHashMapBuilderContentViews3(this);
    }

    @Override // kotlin.collections.AbstractMutableMap
    public Collection<V> getValues() {
        return new PersistentHashMapBuilderContentViews4(this);
    }

...
public abstract class AbstractPersistentList<E> extends AbstractList<E> implements ImmutableList2<E> {
    ...
    public ImmutableList2<E> remove(E element) {
        int iIndexOf = indexOf(element);
        return iIndexOf != -1 ? removeAt(iIndexOf) : this;
    }

    @Override // java.util.Collection, java.util.List, androidx.compose.runtime.external.kotlinx.collections.immutable.ImmutableList2
    public ImmutableList2<E> removeAll(final Collection<? extends E> elements) {

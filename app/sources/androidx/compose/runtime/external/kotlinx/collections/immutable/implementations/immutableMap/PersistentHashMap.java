...
public class PersistentHashMap<K, V> extends AbstractMap<K, V> implements ImmutableMap2<K, V> {
    ...
    public ImmutableSet<K> getKeys() {
        return new PersistentHashMapContentViews2(this);
    }

    @Override // kotlin.collections.AbstractMap
    public ImmutableCollection<V> getValues() {
        return new PersistentHashMapContentViews3(this);
    }

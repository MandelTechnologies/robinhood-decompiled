...
public final class PersistentVectorBuilder<E> extends AbstractMutableList<E> implements ImmutableList2.Builder<E> {
    ...
    @Override // androidx.compose.runtime.external.kotlinx.collections.immutable.ImmutableList2.Builder
    public ImmutableList2<E> build() {
        ...
        return (ImmutableList2<E>) persistentVector;
    }
    ...
    private final Object[] pushBuffers(Object[] root, int rootSize, int shift, Iterator<Object[]> buffersIterator) {
        if (!buffersIterator.hasNext()) {
            Preconditions3.throwIllegalArgumentException("invalid buffersIterator");
        }
        if (!(shift >= 0)) {
            Preconditions3.throwIllegalArgumentException("negative shift");
        }
        if (shift == 0) {
    ...
    public boolean addAll(int index, Collection<? extends E> elements) {
        ...
        if (size == 0) {
            commonFunctions.m6425assert(index >= rootSize());
            int i2 = index & 31;
    ...
    private final void splitToBuffers(Collection<? extends E> elements, int index, Object[] startBuffer, int startBufferSize, Object[][] buffers, int nullBuffers, Object[] nextBuffer) {
        ...
        if (!(nullBuffers >= 1)) {
            Preconditions3.throwIllegalArgumentException("requires at least one nullBuffer");
        }
    ...
    private final Object removeFromTailAt(Object[] root, int rootSize, int shift, int index) {
        ...
        commonFunctions.m6425assert(index < size);
        if (size == 1) {
    ...
    private final boolean removeAll(Function1<? super E, Boolean> predicate) {
        ...
        if (iRemoveAll == 32) {
            commonFunctions.m6425assert(!listIteratorLeafBufferIterator.hasNext());
    ...
    private final Object[] retainFirst(Object[] root, int size) {
        if (!((size & 31) == 0)) {
            Preconditions3.throwIllegalArgumentException("invalid size");
        }
        if (size == 0) {
            this.rootShift = 0;
            return null;
    ...
    private final Object[] nullifyAfter(Object[] root, int index, int shift) {
        if (!(shift >= 0)) {
            Preconditions3.throwIllegalArgumentException("shift should be positive");
        }
        if (shift == 0) {
            return root;
        }
    ...
    private final int removeAllFromTail(Function1<? super E, Boolean> predicate, int tailSize, ObjectRef bufferRef) {
        ...
        if (iRemoveAll == tailSize) {
            commonFunctions.m6425assert(bufferRef.getValue() == this.tail);
            return tailSize;
        }
    ...
    private final ListIterator<Object[]> leafBufferIterator(int index) {
        ...
        int i = this.rootShift;
        if (i == 0) {
            return new AbstractListIterator2(objArr, index);
        }

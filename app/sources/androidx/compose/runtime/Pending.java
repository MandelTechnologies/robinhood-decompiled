...
final class Pending {
    ...
    public Pending(List<KeyInfo> list, int i) {
        ...
        this.startIndex = i;
        if (!(i >= 0)) {
            Preconditions3.throwIllegalArgumentException("Invalid start index");
        }
        this.usedKeys = new ArrayList();
        IntObjectMap3<GroupInfo> intObjectMap3 = new IntObjectMap3<>(0, 1, null);
        int size = list.size();
        int nodes = 0;
        for (int i2 = 0; i2 < size; i2++) {
            KeyInfo keyInfo = this.keyInfos.get(i2);
            intObjectMap3.set(keyInfo.getLocation(), new GroupInfo(i2, nodes, keyInfo.getNodes()));
            nodes += keyInfo.getNodes();
        }
        this.groupInfos = intObjectMap3;
        this.keyMap = LazyKt.lazy(new Function0<MultiValueMap<Object, KeyInfo>>() { // from class: androidx.compose.runtime.Pending$keyMap$2
            ...
            public /* bridge */ /* synthetic */ MultiValueMap<Object, KeyInfo> invoke() {
                return MultiValueMap.m6400boximpl(m6363invokefVlnmYg());
            }

            /* renamed from: invoke-fVlnmYg, reason: not valid java name */
            public final ScatterMap6<Object, Object> m6363invokefVlnmYg() {
                ScatterMap6<Object, Object> scatterMap6MultiMap = ComposerKt.multiMap(this.this$0.getKeyInfos().size());
                Pending pending = this.this$0;
                int size2 = pending.getKeyInfos().size();
                for (int i3 = 0; i3 < size2; i3++) {
                    KeyInfo keyInfo2 = pending.getKeyInfos().get(i3);
                    MultiValueMap.m6399addimpl(scatterMap6MultiMap, ComposerKt.getJoinedKey(keyInfo2), keyInfo2);
                }
                return scatterMap6MultiMap;
            }
        });
    }
    ...
    public final ScatterMap6<Object, Object> m6362getKeyMapfVlnmYg() {
        return ((MultiValueMap) this.keyMap.getValue()).getMap();
    }

    public final KeyInfo getNext(int key, Object dataKey) {
        return (KeyInfo) MultiValueMap.m6410removeFirstimpl(m6362getKeyMapfVlnmYg(), dataKey != null ? new JoinedKey(Integer.valueOf(key), dataKey) : Integer.valueOf(key));
    }
    ...
    public final void registerMoveSlot(int from, int to) {
        ...
        if (from > to) {
            IntObjectMap3<GroupInfo> intObjectMap3 = this.groupInfos;
            ...
            IntObjectMap3<GroupInfo> intObjectMap32 = this.groupInfos;
            Object[] objArr2 = intObjectMap32.values;
            long[] jArr2 = intObjectMap32.metadata;

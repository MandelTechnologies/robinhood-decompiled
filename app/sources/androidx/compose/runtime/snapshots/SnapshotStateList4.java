...
final class SnapshotStateList4<T> implements List<T>, KMarkers5 {
    ...
    public SnapshotStateList4(SnapshotStateList<T> snapshotStateList, int i, int i2) {
    ...
    public T get(int index) {
        ...
        SnapshotStateList2.validateRange(index, size());
    ...
    public ListIterator<T> listIterator(int index) {
        ...
        return new C17941(intRef, this);
    }

    /* compiled from: SnapshotStateList.kt */
    @Metadata(m3635d1 = {"\u0000#\n\u0000\n\u0002\u0010+\n\u0000\n\u0002\u0010\u0001\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\b\n\u0002\b\u0005*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u0015\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00028\u0000H\u0016¢\u0006\u0002\u0010\u0005J\t\u0010\u0006\u001a\u00020\u0007H\u0096\u0002J\b\u0010\b\u001a\u00020\u0007H\u0016J\u000e\u0010\t\u001a\u00028\u0000H\u0096\u0002¢\u0006\u0002\u0010\nJ\b\u0010\u000b\u001a\u00020\fH\u0016J\r\u0010\r\u001a\u00028\u0000H\u0016¢\u0006\u0002\u0010\nJ\b\u0010\u000e\u001a\u00020\fH\u0016J\b\u0010\u000f\u001a\u00020\u0003H\u0016J\u0015\u0010\u0010\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00028\u0000H\u0016¢\u0006\u0002\u0010\u0005¨\u0006\u0011"}, m3636d2 = {"androidx/compose/runtime/snapshots/SubList$listIterator$1", "", "add", "", "element", "(Ljava/lang/Object;)Ljava/lang/Void;", "hasNext", "", "hasPrevious", "next", "()Ljava/lang/Object;", "nextIndex", "", "previous", "previousIndex", "remove", "set", "runtime_release"}, m3637k = 1, m3638mv = {1, 9, 0}, m3640xi = 48)
    /* renamed from: androidx.compose.runtime.snapshots.SubList$listIterator$1 */
    public static final class C17941 implements ListIterator<T>, KMarkers6 {
        final /* synthetic */ Ref.IntRef $current;
        final /* synthetic */ SnapshotStateList4<T> this$0;

        C17941(Ref.IntRef intRef, SnapshotStateList4<T> snapshotStateList4) {
            this.$current = intRef;
            this.this$0 = snapshotStateList4;
        }
        ...
        public T previous() {
            ...
            SnapshotStateList2.validateRange(i, this.this$0.size());
        ...
        public Void add(T element) {
            SnapshotStateList2.modificationError();
    ...
    public List<T> subList(int fromIndex, int toIndex) {
        ...
        SnapshotStateList<T> snapshotStateList = this.parentList;
        int i = this.offset;
        return new SnapshotStateList4(snapshotStateList, fromIndex + i, toIndex + i);
    }

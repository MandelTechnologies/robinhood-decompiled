...
public final class SlotReader {
    ...
    private final Stack2 currentSlotStack;
    ...
    public SlotReader(SlotTable slotTable) {
        ...
        this.end = groupsSize;
        this.parent = -1;
        this.currentSlotStack = new Stack2();
    }
    ...
    public final void endEmpty() {
        if (!(this.emptyCount > 0)) {
            Preconditions3.throwIllegalArgumentException("Unbalanced begin/end empty");
        }
        this.emptyCount--;
    }
    ...
    public final void startGroup() {
        ...
        if (this.emptyCount <= 0) {
            ...
            if (!(this.groups[(i2 * 5) + 2] == i)) {
                Preconditions3.throwIllegalArgumentException("Invalid slot table detected");
            }
            ...
            Stack2 stack2 = this.currentSlotStack;
    ...
    public final void startNode() {
        if (this.emptyCount <= 0) {
            if (!((this.groups[(this.current * 5) + 1] & 1073741824) != 0)) {
                Preconditions3.throwIllegalArgumentException("Expected a node group");
            }
            startGroup();
        }
    }
    ...
    public final int skipGroup() {
        ...
        this.current = i + SlotTableKt.groupSize(iArr, i);
        return i2;
    }
    ...
    public final void reposition(int index) {
        ...
        this.parent = i2;
        if (i2 >= 0) {
            this.end = i2 + SlotTableKt.groupSize(this.groups, i2);
        } else {
            this.end = i;
        }
        this.currentSlot = 0;

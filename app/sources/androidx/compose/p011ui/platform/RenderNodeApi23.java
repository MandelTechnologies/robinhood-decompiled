...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView androidComposeView) {
        ...
        this.internalCompositingStrategy = GraphicsLayerModifier4.INSTANCE.m6748getAutoNrFUSI();
    ...
    @Override // androidx.compose.p011ui.platform.DeviceRenderNode
    public int getLeft() {
        return this.left;
    }
    ...
    public void mo7440setCompositingStrategyaDBOjCE(int i) {
        GraphicsLayerModifier4.Companion companion = GraphicsLayerModifier4.INSTANCE;
        if (GraphicsLayerModifier4.m6745equalsimpl0(i, companion.m6750getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (GraphicsLayerModifier4.m6745equalsimpl0(i, companion.m6749getModulateAlphaNrFUSI())) {
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.m6693clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }

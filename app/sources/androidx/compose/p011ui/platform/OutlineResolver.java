...
public final class OutlineResolver {
    ...
    private androidx.compose.p011ui.graphics.Outline outline;
    ...
    public OutlineResolver() {
        ...
        this.rectTopLeft = Offset.INSTANCE.m6553getZeroF1C5BW0();
        this.rectSize = Size.INSTANCE.m6589getZeroNHjbRc();
    }
    ...
    public final boolean m7459updateS_szKao(androidx.compose.p011ui.graphics.Outline outline, float alpha, boolean clipToOutline, float elevation, long size) {
    ...
    public final boolean m7458isInOutlinek4lQ0M(long position) {
        androidx.compose.p011ui.graphics.Outline outline;
        if (this.outlineNeeded && (outline = this.outline) != null) {
            return ShapeContainingUtil.isInOutline(outline, Float.intBitsToFloat((int) (position >> 32)), Float.intBitsToFloat((int) (position & 4294967295L)), this.tmpTouchPointPath, this.tmpOpPath);
        }
        return true;
    }
    ...
    public final void clipToOutline(Canvas canvas) {
        ...
        if (clipPath != null) {
            Canvas.m6693clipPathmtrdDE$default(canvas, clipPath, 0, 2, null);
            return;
        }
        float f = this.roundedCornerRadius;
        if (f <= 0.0f) {
            Canvas.m6694clipRectN_I0leg$default(canvas, Float.intBitsToFloat((int) (this.rectTopLeft >> 32)), Float.intBitsToFloat((int) (this.rectTopLeft & 4294967295L)), Float.intBitsToFloat((int) (this.rectSize >> 32)) + Float.intBitsToFloat((int) (this.rectTopLeft >> 32)), Float.intBitsToFloat((int) (this.rectSize & 4294967295L)) + Float.intBitsToFloat((int) (this.rectTopLeft & 4294967295L)), 0, 16, null);
            return;
        }
        ...
        if (Path != null) {
            ...
            if (!m7457isSameBounds4L21HEs(roundRect, this.rectTopLeft, this.rectSize, f)) {
            }
            Canvas.m6693clipPathmtrdDE$default(canvas, Path, 0, 2, null);
        }
        outlineResolver = this;
        ...
        RoundRect roundRectM6572RoundRectgG7oq9Y = RoundRect2.m6572RoundRectgG7oq9Y(fIntBitsToFloat, fIntBitsToFloat2, fIntBitsToFloat3, fIntBitsToFloat4, CornerRadius.m6528constructorimpl((Float.floatToRawIntBits(f2) << 32) | (Float.floatToRawIntBits(f2) & 4294967295L)));
        if (Path == null) {
            Path = AndroidPath_androidKt.Path();
        } else {
            Path.reset();
        }
        Path.addRoundRect$default(Path, roundRectM6572RoundRectgG7oq9Y, null, 2, null);
        outlineResolver.tmpRoundRect = roundRectM6572RoundRectgG7oq9Y;
    ...
    private final void updateCache() {
        if (this.cacheIsDirty) {
            ...
            androidx.compose.p011ui.graphics.Outline outline = this.outline;
    ...
    private final void updateCacheWithRect(Rect rect) {
        ...
        this.rectTopLeft = Offset.m6535constructorimpl((Float.floatToRawIntBits(top) & 4294967295L) | (Float.floatToRawIntBits(left) << 32));
        float right = rect.getRight() - rect.getLeft();
        float bottom = rect.getBottom() - rect.getTop();
        this.rectSize = Size.m6575constructorimpl((Float.floatToRawIntBits(bottom) & 4294967295L) | (Float.floatToRawIntBits(right) << 32));
    ...
    private final void updateCacheWithRoundRect(RoundRect roundRect) {
        ...
        this.rectSize = Size.m6575constructorimpl((Float.floatToRawIntBits(height) & 4294967295L) | (Float.floatToRawIntBits(width) << 32));
        if (RoundRect2.isSimple(roundRect)) {
    ...
    private final boolean m7457isSameBounds4L21HEs(RoundRect roundRect, long j, long j2, float f) {
        if (roundRect != null && RoundRect2.isSimple(roundRect)) {
            int i = (int) (j >> 32);
            if (roundRect.getLeft() == Float.intBitsToFloat(i)) {
                int i2 = (int) (j & 4294967295L);
                if (roundRect.getTop() == Float.intBitsToFloat(i2) && roundRect.getRight() == Float.intBitsToFloat(i) + Float.intBitsToFloat((int) (j2 >> 32)) && roundRect.getBottom() == Float.intBitsToFloat(i2) + Float.intBitsToFloat((int) (j2 & 4294967295L)) && Float.intBitsToFloat((int) (roundRect.getTopLeftCornerRadius() >> 32)) == f) {
                    return true;
                }
            }
        }

...
public interface DeviceRenderNode {
    ...
    void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super androidx.compose.p011ui.graphics.Canvas, Unit> drawBlock);
    ...
    void mo7440setCompositingStrategyaDBOjCE(int i);

...
public final class WindowRecomposerPolicy {
    ...
    public final Recomposer createAndInstallWindowRecomposer$ui_release(View rootView) {
        ...
        final Job jobLaunch$default = BuildersKt__Builders_commonKt.launch$default(CoroutineScope3.INSTANCE, HandlerDispatcher4.from(rootView.getHandler(), "windowRecomposer cleanup").getImmediate(), null, new C1957xbfd085b3(recomposerCreateRecomposer, rootView, null), 2, null);

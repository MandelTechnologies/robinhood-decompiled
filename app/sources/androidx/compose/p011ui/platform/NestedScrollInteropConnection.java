...
public final class NestedScrollInteropConnection implements NestedScrollModifier {
    ...
    public long mo5298onPreScrollOzD1aCk(long available, int source) {
        if (this.nestedScrollChildHelper.startNestedScroll(NestedScrollInteropConnectionKt.m7454getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m7456toViewTypeGyEprt8(source))) {
            ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
            this.nestedScrollChildHelper.dispatchNestedPreScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (available >> 32))), NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (4294967295L & available))), this.consumedScrollCache, null, NestedScrollInteropConnectionKt.m7456toViewTypeGyEprt8(source));
            return NestedScrollInteropConnectionKt.m7455toOffsetUv8p0NA(this.consumedScrollCache, available);
        }
    ...
    public long mo5024onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
        this.nestedScrollChildHelper.dispatchNestedScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (consumed >> 32))), NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (consumed & 4294967295L))), NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (available >> 32))), NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (available & 4294967295L))), null, NestedScrollInteropConnectionKt.m7456toViewTypeGyEprt8(source), this.consumedScrollCache);
        return NestedScrollInteropConnectionKt.m7455toOffsetUv8p0NA(this.consumedScrollCache, available);
    }
    ...
    public Object mo5609onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        if (!this.nestedScrollChildHelper.dispatchNestedPreFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m8101getXimpl(j)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m8102getYimpl(j)))) {
    ...
    public Object mo5023onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        if (!this.nestedScrollChildHelper.dispatchNestedFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m8101getXimpl(j2)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m8102getYimpl(j2)), true)) {

...
final class SimpleGraphicsLayerModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m6842setTransformOrigin__ExYCQ(long j) {
    ...
    public final void m6839setAmbientShadowColor8_81llA(long j) {
    ...
    public final void m6841setSpotShadowColor8_81llA(long j) {
    ...
    public final void m6840setCompositingStrategyaDBOjCE(int i) {
    ...
    private SimpleGraphicsLayerModifier(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i) {
        ...
        this.layerBlock = new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$layerBlock$1
            ...
            public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                ...
                graphicsLayerScope.mo6764setTransformOrigin__ExYCQ(this.this$0.getTransformOrigin());
                ...
                graphicsLayerScope.mo6761setAmbientShadowColor8_81llA(this.this$0.getAmbientShadowColor());
                graphicsLayerScope.mo6763setSpotShadowColor8_81llA(this.this$0.getSpotShadowColor());
                graphicsLayerScope.mo6762setCompositingStrategyaDBOjCE(this.this$0.getCompositingStrategy());
            }
        };
    }
    ...
    public MeasureResult mo4771measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo7239measureBRTryo0.getWidth(), placeableMo7239measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.placeWithLayer$default(placementScope, placeableMo7239measureBRTryo0, 0, 0, 0.0f, this.layerBlock, 4, null);
            }
        }, 4, null);
    }

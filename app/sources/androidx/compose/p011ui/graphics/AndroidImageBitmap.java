...
public final class AndroidImageBitmap implements ImageBitmap {
    ...
    @Override // androidx.compose.p011ui.graphics.ImageBitmap
    public int getWidth() {
    ...
    public int mo6606getConfig_sVssgQ() {

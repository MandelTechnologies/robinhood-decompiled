...
public final class RecordingInputConnection implements InputConnection {
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        this.eventCallback.mo7758onImeActionKlQnJC8(iM7746getDefaulteUduSuo);
        return true;
    }
    ...
    public CharSequence getTextBeforeCursor(int maxChars, int flags) {
        return TextFieldValue4.getTextBeforeSelection(this.mTextFieldValue, maxChars).toString();
    }

    @Override // android.view.inputmethod.InputConnection
    public CharSequence getTextAfterCursor(int maxChars, int flags) {
        return TextFieldValue4.getTextAfterSelection(this.mTextFieldValue, maxChars).toString();
    }

    @Override // android.view.inputmethod.InputConnection
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m7640getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
        return TextFieldValue4.getSelectedText(this.mTextFieldValue).toString();
    }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m7644getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
}

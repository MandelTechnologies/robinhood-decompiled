...
public final class TextInputServiceAndroid implements TextInputService2 {
    ...
    public TextInputServiceAndroid(View view, PointerInputEventProcessor2 pointerInputEventProcessor2, InputMethodManager inputMethodManager, Executor executor) {
        this.view = view;
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$onImeActionPerformed$1
            ...
            public final void m7795invokeKlQnJC8(int i) {
            }

            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m7795invokeKlQnJC8(imeAction.getValue());
                return Unit.INSTANCE;
            }
        };
        this.state = new TextFieldValue("", TextRange.INSTANCE.m7651getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
        ...
        this.cursorAnchorInfoController = new CursorAnchorInfoController(pointerInputEventProcessor2, inputMethodManager);
    ...
    public /* synthetic */ TextInputServiceAndroid(View view, PointerInputEventProcessor2 pointerInputEventProcessor2, InputMethodManager inputMethodManager, Executor executor, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(view, pointerInputEventProcessor2, inputMethodManager, (i & 8) != 0 ? TextInputServiceAndroid_androidKt.asExecutor(Choreographer.getInstance()) : executor);
    }

    /* JADX WARN: Failed to restore enum class, 'enum' modifier and super class removed */
    /* JADX WARN: Unknown enum class pattern. Please report as an issue! */
    /* compiled from: TextInputServiceAndroid.android.kt */
    @Metadata(m3635d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0006\b\u0082\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006¨\u0006\u0007"}, m3636d2 = {"Landroidx/compose/ui/text/input/TextInputServiceAndroid$TextInputCommand;", "", "(Ljava/lang/String;I)V", "StartInput", "StopInput", "ShowKeyboard", "HideKeyboard", "ui_release"}, m3637k = 1, m3638mv = {1, 9, 0}, m3640xi = 48)
    private static final class TextInputCommand {
        ...
        static {
            ...
            $ENTRIES = EnumEntries2.enumEntries(textInputCommandArr$values);
        }
    }
    ...
    public TextInputServiceAndroid(View view, PointerInputEventProcessor2 pointerInputEventProcessor2) {
        this(view, pointerInputEventProcessor2, new InputMethodManagerImpl(view), null, 8, null);
    }
    ...
    public final InputConnection createInputConnection(EditorInfo outAttrs) {
        ...
        RecordingInputConnection recordingInputConnection = new RecordingInputConnection(this.state, new InputEventCallback2() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid.createInputConnection.1
            @Override // androidx.compose.p011ui.text.input.InputEventCallback2
            ...
            public void mo7758onImeActionKlQnJC8(int imeAction) {
                TextInputServiceAndroid.this.onImeActionPerformed.invoke(ImeAction.m7739boximpl(imeAction));
            }
    ...
    public void stopInput() {
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid.stopInput.2
            /* renamed from: invoke-KlQnJC8, reason: not valid java name */
            public final void m7796invokeKlQnJC8(int i) {
            }

            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m7796invokeKlQnJC8(imeAction.getValue());
                return Unit.INSTANCE;
            }
        };
    ...
    public void updateState(TextFieldValue oldValue, TextFieldValue newValue) {
        boolean z = (TextRange.m7639equalsimpl0(this.state.getSelection(), newValue.getSelection()) && Intrinsics.areEqual(this.state.getComposition(), newValue.getComposition())) ? false : true;
        this.state = newValue;
        ...
        if (Intrinsics.areEqual(oldValue, newValue)) {
            if (z) {
                ...
                int iM7644getMinimpl = TextRange.m7644getMinimpl(newValue.getSelection());
                int iM7643getMaximpl = TextRange.m7643getMaximpl(newValue.getSelection());
                ...
                inputMethodManager.updateSelection(iM7644getMinimpl, iM7643getMaximpl, iM7644getMinimpl2, composition2 != null ? TextRange.m7643getMaximpl(composition2.getPackedValue()) : -1);
                return;
            }
            return;
        }
        if (oldValue != null && (!Intrinsics.areEqual(oldValue.getText(), newValue.getText()) || (TextRange.m7639equalsimpl0(oldValue.getSelection(), newValue.getSelection()) && !Intrinsics.areEqual(oldValue.getComposition(), newValue.getComposition())))) {
            restartInputImmediately();
            return;
        }
    ...
    @Override // androidx.compose.p011ui.text.input.TextInputService2
    @Deprecated
    public void notifyFocusedRect(androidx.compose.p011ui.geometry.Rect rect) {
        Rect rect2;
    ...
    @Override // androidx.compose.p011ui.text.input.TextInputService2
    public void updateTextLayoutResult(TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Function1<? super Matrix, Unit> textFieldToRootTransform, androidx.compose.p011ui.geometry.Rect innerTextFieldBounds, androidx.compose.p011ui.geometry.Rect decorationBoxBounds) {

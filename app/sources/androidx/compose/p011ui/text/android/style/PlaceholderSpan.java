...
public final class PlaceholderSpan extends ReplacementSpan {
    ...
    public final int getWidthPx() {
        if (!this.isLaidOut) {
            InlineClassHelper5.throwIllegalStateException("PlaceholderSpan is not laid out yet.");
        }
        return this.widthPx;
    }
    ...
    public int getSize(Paint paint, CharSequence text, int start, int end, Paint.FontMetricsInt fm) {
        ...
        if (!(getFontMetrics().descent > getFontMetrics().ascent)) {
            InlineClassHelper5.throwIllegalArgumentException("Invalid fontMetrics: line height can not be negative.");
        }
        ...
        if (i == 0) {
            ...
            InlineClassHelper5.throwIllegalArgumentExceptionForNullCheck("Unsupported unit.");
        ...
        if (fm != null) {
            ...
            switch (this.verticalAlign) {
                ...
                case 6:
                    ...
                    break;
                default:
                    InlineClassHelper5.throwIllegalArgumentException("Unknown verticalAlign.");
                    break;
            }

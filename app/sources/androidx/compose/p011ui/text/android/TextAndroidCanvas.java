...
public final class TextAndroidCanvas extends Canvas {
    ...
    @Override // android.graphics.Canvas
    @Deprecated
    public boolean quickReject(RectF rect, Canvas.EdgeType type2) {
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.throwUninitializedPropertyAccessException("nativeCanvas");
            canvas = null;
        }
        return canvas.quickReject(rect, type2);
    }
    ...
    @Override // android.graphics.Canvas
    @Deprecated
    public boolean quickReject(Path path, Canvas.EdgeType type2) {
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.throwUninitializedPropertyAccessException("nativeCanvas");
            canvas = null;
        }
        return canvas.quickReject(path, type2);
    }
    ...
    @Override // android.graphics.Canvas
    @Deprecated
    public boolean quickReject(float left, float top, float right, float bottom, Canvas.EdgeType type2) {
        Canvas canvas = this.nativeCanvas;
        if (canvas == null) {
            Intrinsics.throwUninitializedPropertyAccessException("nativeCanvas");
            canvas = null;
        }
        return canvas.quickReject(left, top, right, bottom, type2);
    }

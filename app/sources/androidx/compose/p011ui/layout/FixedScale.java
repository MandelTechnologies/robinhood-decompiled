...
public final /* data */ class FixedScale implements ContentScale {
    ...
    public long mo7234computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
        float f = this.value;
        return ScaleFactor.m7276constructorimpl((Float.floatToRawIntBits(f) << 32) | (4294967295L & Float.floatToRawIntBits(f)));
    }
}

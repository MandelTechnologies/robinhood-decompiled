...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo7239measureBRTryo0(long constraints) {
        ...
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            ...
            return new FixedSizeIntrinsicsPlaceable(iMinIntrinsicWidth, Constraints.m7970getHasBoundedHeightimpl(constraints) ? Constraints.m7974getMaxHeightimpl(constraints) : 32767);
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(Constraints.m7971getHasBoundedWidthimpl(constraints) ? Constraints.m7975getMaxWidthimpl(constraints) : 32767, iMinIntrinsicHeight);
    }

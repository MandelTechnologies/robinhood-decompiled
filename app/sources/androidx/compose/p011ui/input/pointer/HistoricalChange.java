...
public final class HistoricalChange {
    ...
    public String toString() {
        return "HistoricalChange(uptimeMillis=" + this.uptimeMillis + ", position=" + ((Object) Offset.m6549toStringimpl(this.position)) + ')';
    }
}

...
import androidx.compose.p011ui.input.pointer.PointerInteropFilter;
...
public final class PointerInteropFilter$pointerInputFilter$1 extends PointerInputFilter {
    ...
    @Override // androidx.compose.p011ui.input.pointer.PointerInputFilter
    ...
    public void mo7191onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        boolean z;
    ...
    private final void dispatchToView(PointerEvent pointerEvent) {
            ...
            if (changes.get(i).isConsumed()) {
                if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
                    ...
                    if (layoutCoordinates != null) {
                        long jMo7244localToRootMKHz9U = layoutCoordinates.mo7244localToRootMKHz9U(Offset.INSTANCE.m6553getZeroF1C5BW0());
                        final PointerInteropFilter pointerInteropFilter = this.this$0;
                        PointerInteropUtils_androidKt.m7193toCancelMotionEventScoped4ec7I(pointerEvent, jMo7244localToRootMKHz9U, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$2
                            {
                                super(1);
                            }
        ...
        if (layoutCoordinates2 != null) {
            long jMo7244localToRootMKHz9U2 = layoutCoordinates2.mo7244localToRootMKHz9U(Offset.INSTANCE.m6553getZeroF1C5BW0());
            final PointerInteropFilter pointerInteropFilter2 = this.this$0;
            PointerInteropUtils_androidKt.m7194toMotionEventScoped4ec7I(pointerEvent, jMo7244localToRootMKHz9U2, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$3

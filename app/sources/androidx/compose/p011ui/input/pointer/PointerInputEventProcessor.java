...
public final class PointerInputEventProcessor {
    ...
    public final int m7190processBIzXfog(PointerInputEvent pointerEvent, PointerInputEventProcessor5 positionCalculator, boolean isInBounds) {
        boolean z;
        if (this.isProcessing) {
            return PointerInputEventProcessor4.ProcessResult(false, false);
        }
        boolean z2 = true;
        try {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (z || PointerEventKt.changedToDownIgnoreConsumed(pointerInputChangeValueAt2)) {
                    LayoutNode.m7299hitTest6fMxITs$ui_release$default(this.root, pointerInputChangeValueAt2.getPosition(), this.hitResult, pointerInputChangeValueAt2.getType(), false, 8, null);
                    if (!this.hitResult.isEmpty()) {
                        this.hitPathTracker.m7141addHitPathQJqDSyo(pointerInputChangeValueAt2.getId(), this.hitResult, PointerEventKt.changedToDownIgnoreConsumed(pointerInputChangeValueAt2));
            ...
            int iProcessResult = PointerInputEventProcessor4.ProcessResult(zDispatchChanges, z2);

...
public final class InternalPointerEvent {
    ...
    public final boolean m7143activeHoverEvent0FcD4WY(long pointerId) {
        ...
        while (true) {
            ...
            if (PointerId.m7170equalsimpl0(pointerInputEventData.getId(), pointerId)) {
                break;
            }
            i++;
        }

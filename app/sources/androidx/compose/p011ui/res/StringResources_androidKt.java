...
public final class StringResources_androidKt {
    public static final String stringResource(int i, Composer composer, int i2) {
        ...
        String string2 = Resources_androidKt.resources(composer, 0).getString(i);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final String stringResource(int i, Object[] objArr, Composer composer, int i2) throws Resources.NotFoundException {
        ...
        String string2 = Resources_androidKt.resources(composer, 0).getString(i, Arrays.copyOf(objArr, objArr.length));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        return string2;

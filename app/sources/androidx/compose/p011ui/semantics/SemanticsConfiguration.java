...
public final class SemanticsConfiguration implements SemanticsPropertyReceiver, Iterable<Map.Entry<? extends SemanticsPropertyKey<?>, ? extends Object>>, KMarkers {
    ...
    private final ScatterMap6<SemanticsPropertyKey<?>, Object> props = ScatterMap7.mutableScatterMapOf();

    public final ScatterMap6<SemanticsPropertyKey<?>, Object> getProps$ui_release() {
        return this.props;
    }
    ...
    @Override // androidx.compose.p011ui.semantics.SemanticsPropertyReceiver
    public <T> void set(SemanticsPropertyKey<T> key, T value) {
        if ((value instanceof AccessibilityAction) && contains(key)) {
            ...
            ScatterMap6<SemanticsPropertyKey<?>, Object> scatterMap6 = this.props;
            ...
            scatterMap6.set(key, new AccessibilityAction(label, action));
            return;
        }
    ...
    */
    ...
    public final void mergeChild$ui_release(SemanticsConfiguration child) {
        ScatterMap6<SemanticsPropertyKey<?>, Object> scatterMap6 = child.props;
        Object[] objArr = scatterMap6.keys;
        Object[] objArr2 = scatterMap6.values;
        long[] jArr = scatterMap6.metadata;
        int length = jArr.length - 2;
    ...
    public final void collapsePeer$ui_release(SemanticsConfiguration peer) {
        ...
        ScatterMap6<SemanticsPropertyKey<?>, Object> scatterMap6 = peer.props;
        Object[] objArr = scatterMap6.keys;
        Object[] objArr2 = scatterMap6.values;
        long[] jArr = scatterMap6.metadata;
        int length = jArr.length - 2;
                ...
                while (i5 < i4) {
                    if ((255 & j) < 128) {
                        ...
                        if (!this.props.contains(semanticsPropertyKey)) {
                            ...
                            ScatterMap6<SemanticsPropertyKey<?>, Object> scatterMap62 = this.props;
                            ...
                            scatterMap62.set(semanticsPropertyKey, new AccessibilityAction(str, action));
                        }
                        i = i3;
                    } else {
                        i = i3;

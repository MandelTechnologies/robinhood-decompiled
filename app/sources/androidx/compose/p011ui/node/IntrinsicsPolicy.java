...
public final class IntrinsicsPolicy {
    ...
    private final SnapshotState measurePolicyState;

    public IntrinsicsPolicy(LayoutNode layoutNode, MeasurePolicy measurePolicy) {
        this.layoutNode = layoutNode;
        this.measurePolicyState = SnapshotState3.mutableStateOf$default(measurePolicy, null, 2, null);
    }

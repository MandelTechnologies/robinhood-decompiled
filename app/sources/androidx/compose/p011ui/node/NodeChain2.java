...
import androidx.compose.p011ui.Modifier2;
...
public final class NodeChain2 {
    ...
    public static final MutableVector<Modifier.Element> fillVector(Modifier modifier, final MutableVector<Modifier.Element> mutableVector) {
        ...
        while (mutableVector2.getSize() != 0) {
            ...
            if (modifier2 instanceof Modifier2) {
                Modifier2 modifier22 = (Modifier2) modifier2;
                mutableVector2.add(modifier22.getInner());
                mutableVector2.add(modifier22.getOuter());

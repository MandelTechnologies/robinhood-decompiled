...
@Metadata(m3635d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bÀ\u0002\u0018\u00002\u00020\u0001:\u0001\rB\u0007\b\u0002¢\u0006\u0002\u0010\u0002J8\u0010\u0003\u001a\u00020\u0004\"\u0004\b\u0000\u0010\u00052\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u0002H\u00050\u00072\f\u0010\b\u001a\b\u0012\u0004\u0012\u0002H\u00050\u00072\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\f¨\u0006\u000e"}, m3636d2 = {"Landroidx/paging/OverlappingListsDiffDispatcher;", "", "()V", "dispatchDiff", "", "T", "oldList", "Landroidx/paging/PlaceholderPaddedList;", "newList", "callback", "Landroidx/recyclerview/widget/ListUpdateCallback;", "diffResult", "Landroidx/paging/PlaceholderPaddedDiffResult;", "PlaceholderUsingUpdateCallback", "paging-runtime_release"}, m3637k = 1, m3638mv = {1, 8, 0}, m3640xi = 48)
/* renamed from: androidx.paging.OverlappingListsDiffDispatcher, reason: use source file name */
/* loaded from: classes4.dex */
public final class PlaceholderPaddedListDiffHelper2 {
    public static final PlaceholderPaddedListDiffHelper2 INSTANCE = new PlaceholderPaddedListDiffHelper2();

    private PlaceholderPaddedListDiffHelper2() {
    }

    public final <T> void dispatchDiff(PlaceholderPaddedList<T> oldList, PlaceholderPaddedList<T> newList, ListUpdateCallback callback, PlaceholderPaddedListDiffHelper3 diffResult) {
    ...
    private static final class PlaceholderUsingUpdateCallback<T> implements ListUpdateCallback {
        ...
        private final void fixTrailingPlaceholders() {
            ...
            if (iMin > 0 && z) {
                this.callback.onChanged(i4, iMin, PagingDataPresenter2.PLACEHOLDER_POSITION_CHANGE);
            }
        ...
        private final void fixLeadingPlaceholders() {
            ...
            if (placeholdersBefore > 0) {
                if (iMin > 0) {
                    this.callback.onChanged(0, iMin, PagingDataPresenter2.PLACEHOLDER_POSITION_CHANGE);
                }
                ...
                if (i > 0) {
                    this.callback.onChanged(0, i, PagingDataPresenter2.PLACEHOLDER_POSITION_CHANGE);
                }
            }
        ...
        private final boolean dispatchInsertAsPlaceholderBefore(int position, int count) {
            ...
            if (iMin > 0) {
                ...
                this.callback.onChanged((0 - iMin) + this.placeholdersBefore, iMin, PagingDataPresenter2.PLACEHOLDER_TO_ITEM);
        ...
        private final boolean dispatchInsertAsPlaceholderAfter(int position, int count) {
            ...
            if (iMin > 0) {
                ...
                this.callback.onChanged(this.placeholdersBefore + position, iMin, PagingDataPresenter2.PLACEHOLDER_TO_ITEM);
        ...
        private final boolean dispatchRemovalAsPlaceholdersBefore(int position, int count) {
            ...
            this.callback.onChanged(this.placeholdersBefore, iCoerceAtLeast, PagingDataPresenter2.ITEM_TO_PLACEHOLDER);
        ...
        private final boolean dispatchRemovalAsPlaceholdersAfter(int position, int count) {
            ...
            if (iCoerceAtLeast > 0) {
                ...
                this.callback.onChanged(this.placeholdersBefore + position, iCoerceAtLeast, PagingDataPresenter2.ITEM_TO_PLACEHOLDER);

...
public class WrapperDataSource<Key, ValueFrom, ValueTo> extends DataSource<Key, ValueTo> {
    ...
    */
    static /* synthetic */ <Key, ValueFrom, ValueTo> Object load$suspendImpl(WrapperDataSource<Key, ValueFrom, ValueTo> wrapperDataSource, DataSource.Params<Key> params, Continuation<? super DataSource.BaseResult<ValueTo>> continuation) {
        ...
        Object objLoad$paging_common_release = wrapperDataSource$load$1.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = wrapperDataSource$load$1.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(objLoad$paging_common_release);
            ...
            objLoad$paging_common_release = dataSource.load$paging_common_release(params, wrapperDataSource$load$1);
        ...
        DataSource.BaseResult baseResult = (DataSource.BaseResult) objLoad$paging_common_release;
        DataSource.BaseResult baseResultConvert$paging_common_release = DataSource.BaseResult.INSTANCE.convert$paging_common_release(baseResult, wrapperDataSource2.listFunction);
        wrapperDataSource2.stashKeysIfNeeded(baseResult.data, baseResultConvert$paging_common_release.data);
        return baseResultConvert$paging_common_release;
    }
}

...
public final class PageFetcherSnapshotState<Key, Value> {
    ...
    private PageFetcherSnapshotState(PagingConfig pagingConfig) {
        ...
        this.prependGenerationIdCh = Channel4.Channel$default(-1, null, null, 6, null);
        this.appendGenerationIdCh = Channel4.Channel$default(-1, null, null, 6, null);
    ...
    /* compiled from: PageFetcherSnapshotState.kt */
    @Metadata(m3635d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\b\u0010\u0000\u001a\u00020\u0001\"\b\b\u0000\u0010\u0002*\u00020\u0003\"\b\b\u0001\u0010\u0004*\u00020\u0003*\b\u0012\u0004\u0012\u00020\u00060\u0005H\u008a@"}, m3636d2 = {"<anonymous>", "", "Key", "", "Value", "Lkotlinx/coroutines/flow/FlowCollector;", ""}, m3637k = 3, m3638mv = {1, 8, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "androidx.paging.PageFetcherSnapshotState$consumePrependGenerationIdAsFlow$1", m3645f = "PageFetcherSnapshotState.kt", m3646l = {}, m3647m = "invokeSuspend")
    /* renamed from: androidx.paging.PageFetcherSnapshotState$consumePrependGenerationIdAsFlow$1 */
    static final class C27641 extends ContinuationImpl7 implements Function2<FlowCollector<? super Integer>, Continuation<? super Unit>, Object> {
        int label;
        final /* synthetic */ PageFetcherSnapshotState<Key, Value> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C27641(PageFetcherSnapshotState<Key, Value> pageFetcherSnapshotState, Continuation<? super C27641> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C27641(this.this$0, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(FlowCollector<? super Integer> flowCollector, Continuation<? super Unit> continuation) {
            return ((C27641) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ((PageFetcherSnapshotState) this.this$0).prependGenerationIdCh.mo8337trySendJP2dKIU(boxing.boxInt(((PageFetcherSnapshotState) this.this$0).prependGenerationId));
            return Unit.INSTANCE;
        }
    }

    public final Flow<Integer> consumePrependGenerationIdAsFlow() {
        return FlowKt.onStart(FlowKt.consumeAsFlow(this.prependGenerationIdCh), new C27641(this, null));
    }

    /* compiled from: PageFetcherSnapshotState.kt */
    @Metadata(m3635d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\b\u0010\u0000\u001a\u00020\u0001\"\b\b\u0000\u0010\u0002*\u00020\u0003\"\b\b\u0001\u0010\u0004*\u00020\u0003*\b\u0012\u0004\u0012\u00020\u00060\u0005H\u008a@"}, m3636d2 = {"<anonymous>", "", "Key", "", "Value", "Lkotlinx/coroutines/flow/FlowCollector;", ""}, m3637k = 3, m3638mv = {1, 8, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "androidx.paging.PageFetcherSnapshotState$consumeAppendGenerationIdAsFlow$1", m3645f = "PageFetcherSnapshotState.kt", m3646l = {}, m3647m = "invokeSuspend")
    /* renamed from: androidx.paging.PageFetcherSnapshotState$consumeAppendGenerationIdAsFlow$1 */
    static final class C27631 extends ContinuationImpl7 implements Function2<FlowCollector<? super Integer>, Continuation<? super Unit>, Object> {
        int label;
        final /* synthetic */ PageFetcherSnapshotState<Key, Value> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C27631(PageFetcherSnapshotState<Key, Value> pageFetcherSnapshotState, Continuation<? super C27631> continuation) {
            super(2, continuation);
            this.this$0 = pageFetcherSnapshotState;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C27631(this.this$0, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(FlowCollector<? super Integer> flowCollector, Continuation<? super Unit> continuation) {
            return ((C27631) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            ((PageFetcherSnapshotState) this.this$0).appendGenerationIdCh.mo8337trySendJP2dKIU(boxing.boxInt(((PageFetcherSnapshotState) this.this$0).appendGenerationId));
            return Unit.INSTANCE;
        }
    }

    public final Flow<Integer> consumeAppendGenerationIdAsFlow() {
        return FlowKt.onStart(FlowKt.consumeAsFlow(this.appendGenerationIdCh), new C27631(this, null));
    }
    ...
    public final void drop(PageEvent.Drop<Value> event) {
        ...
        if (i == 2) {
            ...
            this.prependGenerationIdCh.mo8337trySendJP2dKIU(Integer.valueOf(i3));
            return;
        }
        if (i == 3) {
            ...
            this.appendGenerationIdCh.mo8337trySendJP2dKIU(Integer.valueOf(i5));
            return;
        }
    ...
    public final PageEvent.Drop<Value> dropEventOrNull(LoadType loadType, ViewportHint hint) {
        ...
        return new PageEvent.Drop<>(loadType, lastIndex, lastIndex2, placeholdersBefore$paging_common_release);
    }
    ...
    /* compiled from: PageFetcherSnapshotState.kt */
    @Metadata(m3635d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0000\u0018\u0000*\b\b\u0002\u0010\u0002*\u00020\u0001*\b\b\u0003\u0010\u0003*\u00020\u00012\u00020\u0001B\u000f\u0012\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0006\u0010\u0007R\u0014\u0010\u0005\u001a\u00020\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0005\u0010\bR\u0014\u0010\n\u001a\u00020\t8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\n\u0010\u000bR \u0010\r\u001a\u000e\u0012\u0004\u0012\u00028\u0002\u0012\u0004\u0012\u00028\u00030\f8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\r\u0010\u000e¨\u0006\u000f"}, m3636d2 = {"Landroidx/paging/PageFetcherSnapshotState$Holder;", "", "Key", "Value", "Landroidx/paging/PagingConfig;", "config", "<init>", "(Landroidx/paging/PagingConfig;)V", "Landroidx/paging/PagingConfig;", "Lkotlinx/coroutines/sync/Mutex;", "lock", "Lkotlinx/coroutines/sync/Mutex;", "Landroidx/paging/PageFetcherSnapshotState;", "state", "Landroidx/paging/PageFetcherSnapshotState;", "paging-common_release"}, m3637k = 1, m3638mv = {1, 8, 0}, m3640xi = 48)
    @SourceDebugExtension

                ...
                if (!layoutParams.mFullSpan && (i = i2 + i3) != childCount) {
                    ...
                    if (!this.mShouldReverseLayout) {
                        ...
                        if (decoratedEnd >= decoratedEnd2) {
                            if (decoratedEnd == decoratedEnd2) {
                                if ((layoutParams.mSpan.mIndex - ((LayoutParams) childAt22.getLayoutParams()).mSpan.mIndex < 0) != (c < 0)) {
                                }
                            } else {
                                continue;
                            }
    ...
    private boolean checkSpanForGap(Span span) {
        ...
        if (this.mShouldReverseLayout) {
            if (span.getEndLine() < this.mPrimaryOrientation.getEndAfterPadding()) {
                z = span.getLayoutParams(span.mViews.get(r0.size() - 1)).mFullSpan;
                return !z;
            }
            return false;
        }
    ...
    */
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && (staggeredGridLayoutManager3.mLayoutState.mInfinite || !staggeredGridLayoutManager3.mRemainingSpans.isEmpty())) {
            ...
            if (layoutState.mLayoutDirection == 1) {
                decoratedMeasurement = layoutParams.mFullSpan ? staggeredGridLayoutManager3.getMaxEnd(i3) : span2.getEndLine(i3);
                ...
                minStart = layoutParams.mFullSpan ? staggeredGridLayoutManager3.getMinStart(i3) : span2.getStartLine(i3);
            ...
            if (layoutParams.mFullSpan && layoutState.mItemDirection == -1) {
                if (z2) {
                    ...
                    if (layoutState.mLayoutDirection == 1) {
                        zAreAllStartsEqual = staggeredGridLayoutManager3.areAllEndsEqual();
                    } else {
                        zAreAllStartsEqual = staggeredGridLayoutManager3.areAllStartsEqual();
                    }
            ...
            if (staggeredGridLayoutManager3.isLayoutRTL() && staggeredGridLayoutManager3.mOrientation == 1) {
                decoratedMeasurement2 = layoutParams.mFullSpan ? staggeredGridLayoutManager3.mSecondaryOrientation.getEndAfterPadding() : staggeredGridLayoutManager3.mSecondaryOrientation.getEndAfterPadding() - (((staggeredGridLayoutManager3.mSpanCount - 1) - span2.mIndex) * staggeredGridLayoutManager3.mSizePerSpan);
                startAfterPadding2 = decoratedMeasurement2 - staggeredGridLayoutManager3.mSecondaryOrientation.getDecoratedMeasurement(next);
            } else {
                startAfterPadding2 = layoutParams.mFullSpan ? staggeredGridLayoutManager3.mSecondaryOrientation.getStartAfterPadding() : (span2.mIndex * staggeredGridLayoutManager3.mSizePerSpan) + staggeredGridLayoutManager3.mSecondaryOrientation.getStartAfterPadding();
            ...
            if (layoutParams.mFullSpan) {
                ...
                staggeredGridLayoutManager.updateRemainingSpans(span2, staggeredGridLayoutManager.mLayoutState.mLayoutDirection, i2);
            }
            ...
            if (staggeredGridLayoutManager.mLayoutState.mStopInFocusable && next.hasFocusable()) {
                if (layoutParams.mFullSpan) {
                    ...
                    staggeredGridLayoutManager.mRemainingSpans.set(span2.mIndex, false);
                }
            }
            z = true;
            r8 = 0;

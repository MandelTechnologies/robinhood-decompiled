...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) throws NoSuchMethodException, SecurityException {
        ...
        String string2 = typedArrayObtainStyledAttributes.getString(R$styleable.RecyclerView_layoutManager);
        ...
        boolean z = typedArrayObtainStyledAttributes.getBoolean(R$styleable.RecyclerView_fastScrollEnabled, false);
        ...
        createLayoutManager(context, string2, attributeSet, i, 0);
    ...
    String exceptionLabel() {
        return PlaceholderUtils.XXShortPlaceholderText + super.toString() + ", adapter:" + this.mAdapter + ", layout:" + this.mLayout + ", context:" + getContext();
    }
    ...
    */
    ...
    public View focusSearch(View view, int i) {
        ...
        if (z2 && (i == 2 || i == 1)) {
            if (this.mLayout.canScrollVertically()) {
                int i2 = i == 2 ? EnumC7081g.SDK_ASSET_ILLUSTRATION_CONSUMER_VALUE : 33;
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked == 2) {
                ...
                if (this.mScrollState == 1) {
                    ...
                    if (scrollByInternal(zCanScrollHorizontally != 0 ? i2 : 0, zCanScrollVertically ? i3 : 0, motionEvent, 0)) {
                        getParent().requestDisallowInterceptTouchEvent(true);
                    }
                    GapWorker gapWorker = this.mGapWorker;
    ...
    */
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        boolean canRestoreState() {
            int i = C28687.f274x3d106619[this.mStateRestorationPolicy.ordinal()];
    ...
    static /* synthetic */ class C28687 {
        ...
        static {
            ...
            try {
                f274x3d106619[Adapter.StateRestorationPolicy.PREVENT_WHEN_EMPTY.ordinal()] = 2;

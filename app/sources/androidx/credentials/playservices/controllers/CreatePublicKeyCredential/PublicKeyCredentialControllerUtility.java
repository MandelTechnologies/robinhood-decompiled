...
@Metadata(m3635d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\b\u0000\u0018\u0000 \u00032\u00020\u0001:\u0001\u0003B\u0005¢\u0006\u0002\u0010\u0002¨\u0006\u0004"}, m3636d2 = {"Landroidx/credentials/playservices/controllers/CreatePublicKeyCredential/PublicKeyCredentialControllerUtility;", "", "()V", "Companion", "credentials-play-services-auth_release"}, m3637k = 1, m3638mv = {1, 8, 0}, m3640xi = 48)
...
public final class PublicKeyCredentialControllerUtility {
    ...
    private static final String JSON_KEY_CHALLENGE = ErrorResponse.CHALLENGE;
    ...
    private static final LinkedHashMap<ErrorCode, DomError> orderedErrorCodeToExceptions = MapsKt.linkedMapOf(Tuples4.m3642to(ErrorCode.UNKNOWN_ERR, new UnknownError()), Tuples4.m3642to(ErrorCode.ABORT_ERR, new AbortError()), Tuples4.m3642to(ErrorCode.ATTESTATION_NOT_PRIVATE_ERR, new NotReadableError()), Tuples4.m3642to(ErrorCode.CONSTRAINT_ERR, new ConstraintError()), Tuples4.m3642to(ErrorCode.DATA_ERR, new DataError()), Tuples4.m3642to(ErrorCode.INVALID_STATE_ERR, new InvalidStateError()), Tuples4.m3642to(ErrorCode.ENCODING_ERR, new EncodingError()), Tuples4.m3642to(ErrorCode.NETWORK_ERR, new NetworkError()), Tuples4.m3642to(ErrorCode.NOT_ALLOWED_ERR, new NotAllowedError()), Tuples4.m3642to(ErrorCode.NOT_SUPPORTED_ERR, new NotSupportedError()), Tuples4.m3642to(ErrorCode.SECURITY_ERR, new SecurityError()), Tuples4.m3642to(ErrorCode.TIMEOUT_ERR, new TimeoutError()));
    ...
    public static final class Companion {
        ...
        public final String m505x54c9ae06() {
        ...
        public final String m506x4cbca474() {
        ...
        public final String m509x174cd597() {
        ...
        public final void m503x55ac6fce(byte[] clientDataJSON, byte[] attestationObject, String[] transportArray, JSONObject json) throws JSONException {
            ...
            jSONObject.put(m505x54c9ae06(), b64Encode(attestationObject));
        ...
        public final String toAssertPasskeyResponse(SignInCredential cred) throws GetCredentialException {
            ...
            if (response instanceof AuthenticatorErrorResponse) {
                ...
                throw m504x9b91fc47(errorCode, authenticatorErrorResponse.getErrorMessage());
            }
        ...
        public final CreateCredentialException publicKeyCredentialResponseContainsError(PublicKeyCredential cred) {
            ...
            ErrorCode errorCode = authenticatorErrorResponse.getErrorCode();
            Intrinsics.checkNotNullExpressionValue(errorCode, "authenticatorResponse.errorCode");
            DomError domError = m516x717581f0().get(errorCode);
            String errorMessage = authenticatorErrorResponse.getErrorMessage();
            if (domError == null) {
                return new CreatePublicKeyCredentialDomException(new UnknownError(), "unknown fido gms exception - " + errorMessage);
            }
            if (errorCode == ErrorCode.CONSTRAINT_ERR && errorMessage != null && StringsKt.contains$default((CharSequence) errorMessage, (CharSequence) "Unable to get sync account", false, 2, (Object) null)) {
        ...
        public final GetCredentialException m504x9b91fc47(ErrorCode code, String msg) {
            Intrinsics.checkNotNullParameter(code, "code");
            DomError domError = m516x717581f0().get(code);
            if (domError == null) {
                return new GetPublicKeyCredentialDomException(new UnknownError(), "unknown fido gms exception - " + msg);
            }
            if (code == ErrorCode.CONSTRAINT_ERR && msg != null && StringsKt.contains$default((CharSequence) msg, (CharSequence) "Unable to get sync account", false, 2, (Object) null)) {
        ...
        public final void parseOptionalExtensions$credentials_play_services_auth_release(JSONObject json, PublicKeyCredentialCreationOptions.Builder builder) throws JSONException {
            ...
            if (json.has(getJSON_KEY_EXTENSTIONS$credentials_play_services_auth_release())) {
                ...
                if (jSONObject.optBoolean(m514x55d9bf39(), false)) {
        ...
        public final void m517x4e596641(JSONObject json, PublicKeyCredentialCreationOptions.Builder builder) throws JSONException {
            Intrinsics.checkNotNullParameter(json, "json");
            Intrinsics.checkNotNullParameter(builder, "builder");
            if (json.has(m507xf055c137())) {
                JSONObject jSONObject = json.getJSONObject(m507xf055c137());
                AuthenticatorSelectionCriteria.Builder builder2 = new AuthenticatorSelectionCriteria.Builder();
                boolean zOptBoolean = jSONObject.optBoolean(m513xe9a27208(), false);
                ...
                String authenticatorAttachmentString = jSONObject.optString(m506x4cbca474(), "");
        ...
        public final void m518x81bb96da(JSONObject json, PublicKeyCredentialCreationOptions.Builder builder) throws JSONException, CreatePublicKeyCredentialDomException {
            ArrayList arrayList;
            Intrinsics.checkNotNullParameter(json, "json");
            Intrinsics.checkNotNullParameter(builder, "builder");
            ArrayList arrayList2 = new ArrayList();
            if (json.has(m509x174cd597())) {
                JSONArray jSONArray = json.getJSONArray(m509x174cd597());
                int length = jSONArray.length();
                for (int i = 0; i < length; i++) {
                    JSONObject jSONObject = jSONArray.getJSONObject(i);
                    String string2 = jSONObject.getString(getJSON_KEY_ID$credentials_play_services_auth_release());
                    Intrinsics.checkNotNullExpressionValue(string2, "descriptorJSON.getString(JSON_KEY_ID)");
                    byte[] bArrB64Decode = b64Decode(string2);
            ...
            String attestationString = json.optString(jSON_KEY_ATTESTATION$credentials_play_services_auth_release, ApiRenderablePlatforms.VERSIONS_NONE);
        ...
        public final void parseRequiredRpAndParams$credentials_play_services_auth_release(JSONObject json, PublicKeyCredentialCreationOptions.Builder builder) throws JSONException {
            ...
            JSONArray jSONArray = json.getJSONArray(m512x11a7ad79());
        ...
        public final void m519x2d055f1c(JSONObject json, PublicKeyCredentialCreationOptions.Builder builder) throws JSONException {
            Intrinsics.checkNotNullParameter(json, "json");
            Intrinsics.checkNotNullParameter(builder, "builder");
            ...
            String string2 = jSONObject.getString(getJSON_KEY_ID$credentials_play_services_auth_release());
            Intrinsics.checkNotNullExpressionValue(string2, "user.getString(JSON_KEY_ID)");
            byte[] bArrB64Decode = b64Decode(string2);
        ...
        public final LinkedHashMap<ErrorCode, DomError> m516x717581f0() {

...
public final class CredentialProviderBeginSignInController extends CredentialProviderController<GetCredentialRequest, BeginSignInRequest, SignInCredential, GetCredentialResponse, GetCredentialException> {
    ...
    private final CredentialProviderBeginSignInController8 resultReceiver;
    ...
    public CredentialProviderBeginSignInController(Context context) {
        ...
        this.resultReceiver = new ResultReceiver(handler) { // from class: androidx.credentials.playservices.controllers.BeginSignIn.CredentialProviderBeginSignInController$resultReceiver$1
            ...
            public void onReceiveResult(int resultCode, Bundle resultData) {
                ...
                if (this.this$0.maybeReportErrorFromResultReceiver(resultData, new CredentialProviderBeginSignInController9(CredentialProviderBaseController.INSTANCE), this.this$0.getExecutor(), this.this$0.getCallback(), this.this$0.cancellationSignal)) {
                    return;
                }
    ...
    public void invokePlayServices(GetCredentialRequest request, CredentialManagerCallback<GetCredentialResponse, GetCredentialException> callback, Executor executor, CancellationSignal cancellationSignal) {
        ...
        try {
            ...
            CredentialProviderController.cancelOrCallbackExceptionOrResult(cancellationSignal, new C22061());
        }
    }
    ...
    static final class C22061 extends Lambda implements Function0<Unit> {
        C22061() {
            super(0);
        }
        ...
        public final void invoke2() {
            ...
            executor.execute(new Runnable() { // from class: androidx.credentials.playservices.controllers.BeginSignIn.CredentialProviderBeginSignInController$invokePlayServices$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    CredentialProviderBeginSignInController.C22061.invoke$lambda$0(credentialProviderBeginSignInController);
                }
            });
        }
    ...
    public final void handleResponse$credentials_play_services_auth_release(int uniqueRequestCode, int resultCode, Intent data) {
        ...
        }, new CredentialProviderBeginSignInController3(this), this.cancellationSignal)) {
            return;
        }
        try {
            ...
            CredentialProviderController.cancelOrCallbackExceptionOrResult(this.cancellationSignal, new CredentialProviderBeginSignInController4(this, convertResponseToCredentialManager(signInCredentialFromIntent)));
        } catch (GetCredentialException e) {
            CredentialProviderController.cancelOrCallbackExceptionOrResult(this.cancellationSignal, new CredentialProviderBeginSignInController6(this, e));
            ...
            CredentialProviderController.cancelOrCallbackExceptionOrResult(this.cancellationSignal, new CredentialProviderBeginSignInController5(this, objectRef));
        } catch (Throwable th) {
            CredentialProviderController.cancelOrCallbackExceptionOrResult(this.cancellationSignal, new CredentialProviderBeginSignInController7(this, new GetCredentialUnknownException(th.getMessage())));
        }
    }
    ...
    public BeginSignInRequest convertRequestToPlayServices(GetCredentialRequest request) {
        Intrinsics.checkNotNullParameter(request, "request");
        return BeginSignInControllerUtility.INSTANCE.m502x545fe152(request, this.context);
    }

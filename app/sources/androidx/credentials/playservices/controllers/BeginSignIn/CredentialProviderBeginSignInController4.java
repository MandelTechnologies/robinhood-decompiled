...
/* renamed from: androidx.credentials.playservices.controllers.BeginSignIn.CredentialProviderBeginSignInController$handleResponse$3, reason: use source file name */
/* loaded from: classes4.dex */
final class CredentialProviderBeginSignInController4 extends Lambda implements Function0<Unit> {
    final /* synthetic */ GetCredentialResponse $response;
    final /* synthetic */ CredentialProviderBeginSignInController this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CredentialProviderBeginSignInController4(CredentialProviderBeginSignInController credentialProviderBeginSignInController, GetCredentialResponse getCredentialResponse) {
        super(0);
    ...
    public final void invoke2() {
        ...
        executor.execute(new Runnable() { // from class: androidx.credentials.playservices.controllers.BeginSignIn.CredentialProviderBeginSignInController$handleResponse$3$$ExternalSyntheticLambda0
            ...
            public final void run() {
                CredentialProviderBeginSignInController4.invoke$lambda$0(credentialProviderBeginSignInController, getCredentialResponse);
            }
        });
    }

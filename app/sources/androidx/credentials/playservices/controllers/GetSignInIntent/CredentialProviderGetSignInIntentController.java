...
public final class CredentialProviderGetSignInIntentController extends CredentialProviderController<GetCredentialRequest, GetSignInIntentRequest, SignInCredential, GetCredentialResponse, GetCredentialException> {
    ...
    private final CredentialProviderGetSignInIntentController8 resultReceiver;
    ...
    public CredentialProviderGetSignInIntentController(Context context) {
        ...
        this.resultReceiver = new ResultReceiver(handler) { // from class: androidx.credentials.playservices.controllers.GetSignInIntent.CredentialProviderGetSignInIntentController$resultReceiver$1
            ...
            public void onReceiveResult(int resultCode, Bundle resultData) {
                ...
                if (this.this$0.maybeReportErrorFromResultReceiver(resultData, new CredentialProviderGetSignInIntentController9(CredentialProviderBaseController.INSTANCE), this.this$0.getExecutor(), this.this$0.getCallback(), this.this$0.cancellationSignal)) {
                    return;
                }
    ...
    public void invokePlayServices(GetCredentialRequest request, CredentialManagerCallback<GetCredentialResponse, GetCredentialException> callback, Executor executor, CancellationSignal cancellationSignal) {
        ...
        try {
            ...
            if (e instanceof GetCredentialUnsupportedException) {
                CredentialProviderController.cancelOrCallbackExceptionOrResult(cancellationSignal, new C22441(e));
            } else {
                CredentialProviderController.cancelOrCallbackExceptionOrResult(cancellationSignal, new C22452());
            }
        }
    }
    ...
    static final class C22441 extends Lambda implements Function0<Unit> {

        /* renamed from: $e */
        final /* synthetic */ Exception f234$e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C22441(Exception exc) {
            super(0);
            this.f234$e = exc;
        }
        ...
        public final void invoke2() {
            ...
            final Exception exc = this.f234$e;
            executor.execute(new Runnable() { // from class: androidx.credentials.playservices.controllers.GetSignInIntent.CredentialProviderGetSignInIntentController$invokePlayServices$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    CredentialProviderGetSignInIntentController.C22441.invoke$lambda$0(credentialProviderGetSignInIntentController, exc);
                }
            });
        }
    ...
    static final class C22452 extends Lambda implements Function0<Unit> {
        C22452() {
            super(0);
        }
        ...
        public final void invoke2() {
            ...
            executor.execute(new Runnable() { // from class: androidx.credentials.playservices.controllers.GetSignInIntent.CredentialProviderGetSignInIntentController$invokePlayServices$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    CredentialProviderGetSignInIntentController.C22452.invoke$lambda$0(credentialProviderGetSignInIntentController);
                }
            });
        }
    ...
    public GetSignInIntentRequest convertRequestToPlayServices(GetCredentialRequest request) throws GetCredentialUnsupportedException {
        ...
        Intrinsics.checkNotNullExpressionValue(getSignInIntentRequestBuild, "builder()\n            .s…nce)\n            .build()");
    ...
    public final void handleResponse$credentials_play_services_auth_release(int uniqueRequestCode, int resultCode, Intent data) {
        ...
        }, new CredentialProviderGetSignInIntentController3(this), this.cancellationSignal)) {
            return;
        }
        try {
            ...
            CredentialProviderController.cancelOrCallbackExceptionOrResult(this.cancellationSignal, new CredentialProviderGetSignInIntentController4(this, convertResponseToCredentialManager(signInCredentialFromIntent)));
        } catch (GetCredentialException e) {
            CredentialProviderController.cancelOrCallbackExceptionOrResult(this.cancellationSignal, new CredentialProviderGetSignInIntentController6(this, e));
            ...
            CredentialProviderController.cancelOrCallbackExceptionOrResult(this.cancellationSignal, new CredentialProviderGetSignInIntentController5(this, objectRef));
        } catch (Throwable th) {
            CredentialProviderController.cancelOrCallbackExceptionOrResult(this.cancellationSignal, new CredentialProviderGetSignInIntentController7(this, new GetCredentialUnknownException(th.getMessage())));
        }
    }

    /* compiled from: CredentialProviderGetSignInIntentController.kt */
    @Metadata(m3635d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0007R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\t"}, m3636d2 = {"Landroidx/credentials/playservices/controllers/GetSignInIntent/CredentialProviderGetSignInIntentController$Companion;", "", "()V", "TAG", "", "getInstance", "Landroidx/credentials/playservices/controllers/GetSignInIntent/CredentialProviderGetSignInIntentController;", "context", "Landroid/content/Context;", "credentials-play-services-auth_release"}, m3637k = 1, m3638mv = {1, 8, 0}, m3640xi = 48)

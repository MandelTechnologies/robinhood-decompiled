...
final class DefaultOggSeeker implements OggSeeker {
    ...
    long readGranuleOfLastPage(ExtractorInput extractorInput) throws IOException {
        ...
        while (true) {
            ...
            if ((oggPageHeader2.f9743type & 4) == 4 || !oggPageHeader2.skipToNextPage(extractorInput) || extractorInput.getPosition() >= this.payloadEndPosition || !this.pageHeader.populate(extractorInput, true)) {
                break;
            }

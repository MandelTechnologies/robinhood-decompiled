...
abstract class StreamReader {
    ...
    private int readHeadersAndUpdateState(ExtractorInput extractorInput) throws IOException {
        ...
        Format format2 = this.setupData.f9744format;
        ...
        if (oggSeeker != null) {
            ...
            this.oggSeeker = new DefaultOggSeeker(this, this.payloadStartPosition, extractorInput.getLength(), pageHeader.headerSize + pageHeader.bodySize, pageHeader.granulePosition, (pageHeader.f9743type & 4) != 0);
        }
        this.state = 2;

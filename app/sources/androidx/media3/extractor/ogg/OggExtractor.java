...
public class OggExtractor implements Extractor {
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: androidx.media3.extractor.ogg.OggExtractor$$ExternalSyntheticLambda0
        ...
        public final Extractor[] createExtractors() {
            return OggExtractor.m8307$r8$lambda$7kLxSBr0Vl2284opdcoBYMGG9o();
        }
    };
    ...
    /* renamed from: $r8$lambda$7kLxSBr0Vl2284opd-coBYMGG9o, reason: not valid java name */
    public static /* synthetic */ Extractor[] m8307$r8$lambda$7kLxSBr0Vl2284opdcoBYMGG9o() {
    ...
    private boolean sniffInternal(ExtractorInput extractorInput) throws IOException {
        ...
        if (oggPageHeader.populate(extractorInput, true) && (oggPageHeader.f9743type & 2) == 2) {

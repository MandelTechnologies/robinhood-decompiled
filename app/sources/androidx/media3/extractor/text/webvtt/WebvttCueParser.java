...
public final class WebvttCueParser {
    ...
    static {
        ...
        map.put(StatusBannerStyle.NATIVE_STATUS_WHITE, Integer.valueOf(Color.rgb(255, 255, 255)));
        ...
        map.put(StatusBannerStyle.NATIVE_STATUS_BLACK, Integer.valueOf(Color.rgb(0, 0, 0)));
    ...
    private static WebvttCueInfo parseCue(String str, Matcher matcher, ParsableByteArray parsableByteArray, List<WebvttCssStyle> list) {
        ...
        try {
            ...
            Log.m538w("WebvttCueParser", "Skipping cue with bad header: " + matcher.group());
            return null;
        }
    }
        ...
        while (matcher.find()) {
            ...
            try {
                if ("line".equals(str2)) {
                    ...
                    Log.m538w("WebvttCueParser", "Unknown cue setting " + str2 + ":" + str3);
                }
            } catch (NumberFormatException unused) {
                Log.m538w("WebvttCueParser", "Skipping bad cue setting: " + matcher.group());
            }
        }
    }
    ...
    private static int parseLineAnchor(String str) {
        ...
        switch (str) {
            ...
            case "start":
                return 0;
            default:
                Log.m538w("WebvttCueParser", "Invalid anchor value: " + str);
    ...
    private static int parseVerticalAttribute(String str) {
        ...
        Log.m538w("WebvttCueParser", "Invalid 'vertical' value: " + str);
        return Integer.MIN_VALUE;
    }
    ...
    private static int parseTextAlignment(String str) {
        ...
        switch (str) {
            ...
            case "start":
                return 1;
            default:
                Log.m538w("WebvttCueParser", "Invalid alignment value: " + str);
                return 2;
        }
    }
    ...
    private static void applyEntity(String str, SpannableStringBuilder spannableStringBuilder) {
        ...
        switch (str) {
            ...
            case "nbsp":
                ...
                break;
            default:
                Log.m538w("WebvttCueParser", "ignoring unsupported entity: '&" + str + ";'");
                break;
        }
    }
        ...
        private static Layout.Alignment convertTextAlignment(int i) {
            if (i != 1) {
                ...
                if (i != 3) {
                    if (i != 4) {
                        if (i != 5) {
                            Log.m538w("WebvttCueParser", "Unknown textAlignment: " + i);
                            return null;
                        }
                    }
                }
    ...
    static final class StartTag {
        ...
        public static StartTag buildStartTag(String str, int i) {
            ...
            String strTrim = str.trim();
            Assertions.checkArgument(!strTrim.isEmpty());
            int iIndexOf = strTrim.indexOf(PlaceholderUtils.XXShortPlaceholderText);
            if (iIndexOf == -1) {
                str2 = "";
            } else {

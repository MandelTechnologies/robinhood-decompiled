...
public class SubtitleExtractor implements Extractor {
    ...
    private final Format f9745format;
    ...
    public SubtitleExtractor(SubtitleParser subtitleParser, Format format2) {
        this.subtitleParser = subtitleParser;
        this.f9745format = format2.buildUpon().setSampleMimeType("application/x-media3-cues").setCodecs(format2.sampleMimeType).setCueReplacementBehavior(subtitleParser.getCueReplacementBehavior()).build();
    }
    ...
    public void init(ExtractorOutput extractorOutput) {
        ...
        trackOutputTrack.format(this.f9745format);

...
public final class DvbParser implements SubtitleParser {
    ...
    public DvbParser(List<byte[]> list) {
        ...
        this.defaultDisplayDefinition = new DisplayDefinition(719, CompanyFinancialsSection.LINE_REVEAL_ANIMATION_DURATION, 0, 719, 0, CompanyFinancialsSection.LINE_REVEAL_ANIMATION_DURATION);
    ...
    private CuesWithTiming parse(ParsableBitArray parsableBitArray) {
        ...
        if (pageComposition == null) {
            return new CuesWithTiming(ImmutableList.m999of(), -9223372036854775807L, -9223372036854775807L);
        }
    ...
    private static void parseSubtitlingSegment(ParsableBitArray parsableBitArray, SubtitleService subtitleService) {
        ...
        if (bits3 * 8 > parsableBitArray.bitsLeft()) {
            Log.m538w("DvbParser", "Data field length exceeds limit");
        ...
        switch (bits) {
            ...
            case 17:
                ...
                if (bits2 == subtitleService.subtitlePageId && pageComposition3 != null) {
                    ...
                    if (pageComposition3.state == 0 && (regionComposition = subtitleService.regions.get(regionComposition2.f261id)) != null) {
                        regionComposition2.mergeFrom(regionComposition);
                    }
                    subtitleService.regions.put(regionComposition2.f261id, regionComposition2);
                    break;
                }
                break;
            case 18:
                if (bits2 == subtitleService.subtitlePageId) {
                    ...
                    subtitleService.cluts.put(clutDefinition.f259id, clutDefinition);
                    break;
                } else if (bits2 == subtitleService.ancillaryPageId) {
                    ClutDefinition clutDefinition2 = parseClutDefinition(parsableBitArray, bits3);
                    subtitleService.ancillaryCluts.put(clutDefinition2.f259id, clutDefinition2);
                    break;
                }
                break;
            case 19:
                if (bits2 == subtitleService.subtitlePageId) {
                    ...
                    subtitleService.objects.put(objectData.f260id, objectData);
                    break;
                } else if (bits2 == subtitleService.ancillaryPageId) {
                    ObjectData objectData2 = parseObjectData(parsableBitArray);
                    subtitleService.ancillaryObjects.put(objectData2.f260id, objectData2);
                    break;
                }
                break;
            case 20:
    ...
    private static int[] generateDefault4BitClutEntries() {
        ...
        for (int i = 1; i < 16; i++) {
            if (i < 8) {
                ...
                int i2 = i & 1;
                int i3 = EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE;
                int i4 = i2 != 0 ? 127 : 0;
                int i5 = (i & 2) != 0 ? 127 : 0;
                if ((i & 4) == 0) {
                    i3 = 0;
    ...
    private static int[] generateDefault8BitClutEntries() {
        ...
        for (int i2 = 0; i2 < 256; i2++) {
            if (i2 < 8) {
                ...
                int i3 = i2 & 136;
                int i4 = EnumC7081g.SDK_ASSET_ILLUSTRATION_INCOME_PAYROLL_URL_VALUE;
                if (i3 == 0) {
                    ...
                    iArr[i2] = getColor(EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE, i7, i8, i + i4);
                } else if (i3 == 128) {
                    iArr[i2] = getColor(255, ((i2 & 1) != 0 ? 43 : 0) + EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE + ((i2 & 16) != 0 ? 85 : 0), ((i2 & 2) != 0 ? 43 : 0) + EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE + ((i2 & 32) != 0 ? 85 : 0), ((i2 & 4) == 0 ? 0 : 43) + EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE + ((i2 & 64) == 0 ? 0 : 85));
                } else if (i3 == 136) {

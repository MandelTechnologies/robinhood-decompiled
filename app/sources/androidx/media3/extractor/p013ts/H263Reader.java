...
public final class H263Reader implements ElementaryStreamReader {
    ...
    H263Reader(UserDataReader userDataReader) {
        ...
        if (userDataReader != null) {
            this.userData = new NalUnitTargetBuffer(EnumC7081g.f2773x8d9721ad, 128);
    ...
    private static Format parseCsdBuffer(CsdBuffer csdBuffer, int i, String str) {
        ...
        if (bits == 15) {
            ...
            if (bits3 == 0) {
                Log.m538w("H263Reader", "Invalid aspect ratio");
            } else {
                f = bits2 / bits3;
            }
        } else {
        ...
        if (parsableBitArray.readBits(2) != 0) {
            Log.m538w("H263Reader", "Unhandled video object layer shape");
        }
        parsableBitArray.skipBit();
        ...
        if (parsableBitArray.readBit()) {
            if (bits4 == 0) {
                Log.m538w("H263Reader", "Invalid vop_increment_time_resolution");
            } else {
                int i2 = 0;
            ...
            if (i3 != 0) {
                if (i3 != 1) {
                    if (i3 != 2) {
                        ...
                        } else if ((i & EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_CIRCLE_VALUE) != 32) {
                            Log.m538w("H263Reader", "Unexpected start code value");
                            reset();
                        } else {

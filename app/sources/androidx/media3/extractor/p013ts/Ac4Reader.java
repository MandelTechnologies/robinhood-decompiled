...
public final class Ac4Reader implements ElementaryStreamReader {
    ...
    private void parseHeader() {
        ...
        Format format2 = this.f9748format;
        if (format2 == null || ac4SyncframeInfo.channelCount != format2.channelCount || ac4SyncframeInfo.sampleRate != format2.sampleRate || !"audio/ac4".equals(format2.sampleMimeType)) {
            ...
            this.f9748format = formatBuild;
            this.output.format(formatBuild);
        }
        this.sampleSize = ac4SyncframeInfo.frameSize;
        this.sampleDurationUs = (ac4SyncframeInfo.sampleCount * 1000000) / this.f9748format.sampleRate;
    }
}

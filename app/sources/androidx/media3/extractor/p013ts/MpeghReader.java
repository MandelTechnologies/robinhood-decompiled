...
import androidx.media3.extractor.p013ts.MpeghUtil;
...
public final class MpeghReader implements ElementaryStreamReader {
    ...
    private void parseConfig(ParsableBitArray parsableBitArray) throws ParserException {
        ...
        if (j != j2) {
            ...
            this.output.format(new Format.Builder().setId(this.formatId).setSampleMimeType("audio/mhm1").setSampleRate(this.samplingRate).setCodecs(str).setInitializationData((bArr == null || bArr.length <= 0) ? null : ImmutableList.m1001of(Util.EMPTY_BYTE_ARRAY, bArr)).build());
        }

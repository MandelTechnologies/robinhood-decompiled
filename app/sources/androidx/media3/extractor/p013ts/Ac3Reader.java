...
public final class Ac3Reader implements ElementaryStreamReader {
    ...
    private void parseHeader() {
        ...
        Format format2 = this.f9747format;
        if (format2 == null || ac3SyncframeInfo.channelCount != format2.channelCount || ac3SyncframeInfo.sampleRate != format2.sampleRate || !Util.areEqual(ac3SyncframeInfo.mimeType, format2.sampleMimeType)) {
            ...
            this.f9747format = formatBuild;
            this.output.format(formatBuild);
        }
        this.sampleSize = ac3SyncframeInfo.frameSize;
        this.sampleDurationUs = (ac3SyncframeInfo.sampleCount * 1000000) / this.f9747format.sampleRate;
    }
}

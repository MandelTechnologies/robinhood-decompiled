...
public final class PsExtractor implements Extractor {
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: androidx.media3.extractor.ts.PsExtractor$$ExternalSyntheticLambda0
        ...
        public final Extractor[] createExtractors() {
            return PsExtractor.m8311$r8$lambda$14uALHsTnXYpDeGysDLBWdrlxM();
        }
    };
    ...
    /* renamed from: $r8$lambda$14u-ALHsTnXYpDeGysDLBWdrlxM, reason: not valid java name */
    public static /* synthetic */ Extractor[] m8311$r8$lambda$14uALHsTnXYpDeGysDLBWdrlxM() {
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        if (((i & AssetHomeEducationTourScreen.SortButtonOffset) >> 8) != 1) {
        ...
        if (!this.foundAllTracks) {
            if (pesReader == null) {
                if (i2 == 189) {
                    ...
                    this.foundAudioTrack = true;
                    this.lastTrackPosition = extractorInput.getPosition();
                } else if ((i & EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_CIRCLE_VALUE) == 224) {

...
public final class FlacMetadataReader {
    ...
    public static boolean readMetadataBlock(ExtractorInput extractorInput, FlacStreamMetadataHolder flacStreamMetadataHolder) throws IOException {
        ...
        if (bits == 6) {
            ...
            flacStreamMetadataHolder.flacStreamMetadata = flacStreamMetadata.copyWithPictureFrames(ImmutableList.m1000of(PictureFrame.fromPictureBlock(parsableByteArray)));
            return bit;
        }

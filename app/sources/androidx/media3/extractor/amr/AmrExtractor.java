...
public final class AmrExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: androidx.media3.extractor.amr.AmrExtractor$$ExternalSyntheticLambda0
        ...
        public final Extractor[] createExtractors() {
            return AmrExtractor.m8304$r8$lambda$SJh1mMR68eVuGS4irR_1BeE4();
        }
    };
    ...
    /* renamed from: $r8$lambda$SJh1mMR68eVuGS4--i-rR_1BeE4, reason: not valid java name */
    public static /* synthetic */ Extractor[] m8304$r8$lambda$SJh1mMR68eVuGS4irR_1BeE4() {
    ...
    private int readSample(ExtractorInput extractorInput) throws IOException {
        ...
        this.currentSampleTimeUs += WebsocketGatewayConstants.CLIENT_IDLE_TIMEOUT_MS;
        return 0;
    }
    ...
    private SeekMap getConstantBitrateSeekMap(long j, boolean z) {
        return new ConstantBitrateSeekMap(j, this.firstSamplePosition, getBitrateFromFrameSize(this.firstSampleSize, WebsocketGatewayConstants.CLIENT_IDLE_TIMEOUT_MS), this.firstSampleSize, z);
    }

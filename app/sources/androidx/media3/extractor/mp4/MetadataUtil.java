...
final class MetadataUtil {
    ...
    public static Metadata.Entry parseIlstElement(ParsableByteArray parsableByteArray) {
        ...
        try {
            ...
            Log.m534d("MetadataUtil", "Skipped unknown metadata entry: " + Atom.getAtomTypeString(i));
    ...
    private static TextInformationFrame parseTextAttribute(int i, String str, ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == 1684108385) {
            ...
            return new TextInformationFrame(str, null, ImmutableList.m1000of(parsableByteArray.readNullTerminatedString(i2 - 16)));
        }
        Log.m538w("MetadataUtil", "Failed to parse text attribute: " + Atom.getAtomTypeString(i));
        return null;
    }
    ...
    private static CommentFrame parseCommentAttribute(int i, ParsableByteArray parsableByteArray) {
        ...
        Log.m538w("MetadataUtil", "Failed to parse comment attribute: " + Atom.getAtomTypeString(i));
        return null;
    }
    ...
    private static Id3Frame parseIntegerAttribute(int i, String str, ParsableByteArray parsableByteArray, boolean z, boolean z2) {
        ...
        if (integerAttribute >= 0) {
            if (z) {
                return new TextInformationFrame(str, null, ImmutableList.m1000of(Integer.toString(integerAttribute)));
            }
            return new CommentFrame("und", str, Integer.toString(integerAttribute));
        }
        Log.m538w("MetadataUtil", "Failed to parse uint8 attribute: " + Atom.getAtomTypeString(i));
        return null;
    }
    ...
    private static int parseIntegerAttribute(ParsableByteArray parsableByteArray) {
        ...
        Log.m538w("MetadataUtil", "Failed to parse data atom to int");
        return -1;
    }
    ...
    private static TextInformationFrame parseIndexAndCountAttribute(int i, String str, ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == 1684108385 && i2 >= 22) {
            ...
            if (unsignedShort > 0) {
                ...
                return new TextInformationFrame(str, null, ImmutableList.m1000of(str2));
            }
        }
        Log.m538w("MetadataUtil", "Failed to parse index/count attribute: " + Atom.getAtomTypeString(i));
        return null;
    }
    ...
    private static TextInformationFrame parseStandardGenreAttribute(ParsableByteArray parsableByteArray) {
        ...
        if (strResolveV1Genre != null) {
            return new TextInformationFrame("TCON", null, ImmutableList.m1000of(strResolveV1Genre));
        }
        Log.m538w("MetadataUtil", "Failed to parse standard genre code");
        return null;
    }
    ...
    private static ApicFrame parseCoverArt(ParsableByteArray parsableByteArray) {
        ...
        int i = parsableByteArray.readInt();
        if (parsableByteArray.readInt() != 1684108385) {
            Log.m538w("MetadataUtil", "Failed to parse cover art attribute");
            return null;
        }
        ...
        if (str == null) {
            Log.m538w("MetadataUtil", "Unrecognized cover art flags: " + fullAtomFlags);
            return null;
        }

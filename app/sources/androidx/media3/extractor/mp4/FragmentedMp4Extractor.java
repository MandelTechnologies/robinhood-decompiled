...
public class FragmentedMp4Extractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: androidx.media3.extractor.mp4.FragmentedMp4Extractor$$ExternalSyntheticLambda0
        ...
        public final Extractor[] createExtractors() {
            return FragmentedMp4Extractor.m8306$r8$lambda$mshaahP_GfzlKXpoPIIJ17EX54();
        }
    };
    ...
    /* renamed from: $r8$lambda$mshaahP_GfzlK-XpoPIIJ17EX54, reason: not valid java name */
    public static /* synthetic */ Extractor[] m8306$r8$lambda$mshaahP_GfzlKXpoPIIJ17EX54() {
    ...
    public FragmentedMp4Extractor(SubtitleParser.Factory factory, int i) {
        this(factory, i, null, null, ImmutableList.m999of(), null);
    }
    ...
    public boolean sniff(ExtractorInput extractorInput) throws IOException {
        ...
        this.lastSniffFailures = sniffFailureSniffFragmented != null ? ImmutableList.m1000of(sniffFailureSniffFragmented) : ImmutableList.m999of();
    ...
    public void init(ExtractorOutput extractorOutput) {
        ...
        if (track != null) {
            this.trackBundles.put(0, new TrackBundle(extractorOutput.track(0, track.f9742type), new TrackSampleTable(this.sideloadedTrack, new long[0], new int[0], 0, new long[0], new int[0], 0L), new DefaultSampleValues(0, 0, 0, 0)));
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        if (this.trackBundles.size() == 0) {
            while (i < size2) {
                ...
                this.trackBundles.put(track.f258id, new TrackBundle(this.extractorOutput.track(i, track.f9742type), trackSampleTable, getDefaultSampleValues(sparseArray, track.f258id)));
        ...
        while (i < size2) {
            ...
            this.trackBundles.get(track2.f258id).reset(trackSampleTable2, getDefaultSampleValues(sparseArray, track2.f258id));
            i++;
        }
    }
    ...
    private void onEmsgLeafAtomRead(ParsableByteArray parsableByteArray) {
        ...
        if (fullAtomVersion == 0) {
            ...
            if (fullAtomVersion != 1) {
                Log.m538w("FragmentedMp4Extractor", "Skipping unsupported emsg version: " + fullAtomVersion);
                return;
            }
    ...
    private static void parseMoof(Atom.ContainerAtom containerAtom, SparseArray<TrackBundle> sparseArray, boolean z, int i, byte[] bArr) throws ParserException {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (containerAtom2.f9739type == 1953653094) {
    ...
    private static void parseTraf(Atom.ContainerAtom containerAtom, SparseArray<TrackBundle> sparseArray, boolean z, int i, byte[] bArr) throws ParserException {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (leafAtom.f9739type == 1970628964) {
    ...
    private static void parseTruns(Atom.ContainerAtom containerAtom, TrackBundle trackBundle, int i) throws ParserException {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            ...
            if (leafAtom.f9739type == 1953658222) {
        ...
        for (int i6 = 0; i6 < size; i6++) {
            ...
            if (leafAtom2.f9739type == 1953658222) {
    ...
    private static int parseTrun(TrackBundle trackBundle, int i, int i2, ParsableByteArray parsableByteArray, int i3) throws ParserException {
        ...
        boolean z7 = z6;
        boolean z8 = track.f9742type == 2 && (i2 & 1) != 0;
        ...
        while (i13 < i12) {
            ...
            int i14 = i13;
            long jScaleLargeTimestamp = Util.scaleLargeTimestamp((i10 + j4) - j2, 1000000L, j3);
            jArr2[i14] = jScaleLargeTimestamp;
            if (!trackFragment.nextFragmentDecodeTimeIncludesMoov) {
                jArr2[i14] = jScaleLargeTimestamp + trackBundle.moovSampleTable.durationUs;
            }
            iArr[i14] = i7;
    ...
    private static void parseSampleGroups(Atom.ContainerAtom containerAtom, String str, TrackFragment trackFragment) throws ParserException {
        ...
        int i3 = (unsignedByte & EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_CIRCLE_VALUE) >> 4;
    ...
    private boolean readSample(ExtractorInput extractorInput) throws IOException {
        ...
        if (nextTrackBundle == null) {
            ...
            if (currentSampleOffset < 0) {
                Log.m538w("FragmentedMp4Extractor", "Ignoring negative offset to sample data.");
        ...
        if (this.parserState == 3) {
            ...
            if ("audio/ac4".equals(nextTrackBundle.moovSampleTable.track.f9741format.sampleMimeType)) {
        ...
        if (track.nalUnitLengthFieldLength == 0) {
            ...
            while (this.sampleBytesWritten < this.sampleSize) {
                ...
                if (i9 == 0) {
                    ...
                    this.processSeiNalUnitPayload = (this.ceaTrackOutputs.length <= 0 || !NalUnitUtil.isNalUnitSei(track.f9741format.sampleMimeType, data[i2])) ? 0 : i3;
                    ...
                    if (this.processSeiNalUnitPayload) {
                        ...
                        i = i3;
                        this.nalBuffer.setPosition("video/hevc".equals(track.f9741format.sampleMimeType) ? 1 : 0);
    ...
    private static DrmInitData getDrmInitDataFromAtoms(List<Atom.LeafAtom> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (leafAtom.f9739type == 1886614376) {
                if (arrayList == null) {
                ...
                if (uuid == null) {
                    Log.m538w("FragmentedMp4Extractor", "Skipped pssh atom (failed to extract uuid)");
                } else {
    ...
    private static final class TrackBundle {
        ...
        public void reset(TrackSampleTable trackSampleTable, DefaultSampleValues defaultSampleValues) {
            this.moovSampleTable = trackSampleTable;
            this.defaultSampleValues = defaultSampleValues;
            this.output.format(trackSampleTable.track.f9741format);
            resetFragmentInfo();
        }
        ...
        public void updateDrmInitData(DrmInitData drmInitData) {
            ...
            this.output.format(this.moovSampleTable.track.f9741format.buildUpon().setDrmInitData(drmInitData.copyWithSchemeType(sampleDescriptionEncryptionBox != null ? sampleDescriptionEncryptionBox.schemeType : null)).build());
        }

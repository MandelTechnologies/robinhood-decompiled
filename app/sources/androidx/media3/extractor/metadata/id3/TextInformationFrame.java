...
public final class TextInformationFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && TextInformationFrame.class == obj.getClass()) {
            ...
            if (Util.areEqual(this.f256id, textInformationFrame.f256id) && Util.areEqual(this.description, textInformationFrame.description) && this.values.equals(textInformationFrame.values)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        int iHashCode = (527 + this.f256id.hashCode()) * 31;
    ...
    public String toString() {
        return this.f256id + ": description=" + this.description + ": values=" + this.values;
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f256id);

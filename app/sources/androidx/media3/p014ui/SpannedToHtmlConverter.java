...
final class SpannedToHtmlConverter {
    ...
    public static HtmlAndCss convert(CharSequence charSequence, float f) {
        if (charSequence == null) {
            return new HtmlAndCss("", ImmutableMap.m1006of());
        }
        if (!(charSequence instanceof Spanned)) {
            return new HtmlAndCss(escapeHtml(charSequence), ImmutableMap.m1006of());
        }
    ...
    private static String getTextEmphasisStyle(int i, int i2) {
        ...
        if (i == 0) {
            sb.append(ApiRenderablePlatforms.VERSIONS_NONE);
        } else if (i == 1) {
            sb.append("circle");
        } else if (i == 2) {
            sb.append("dot");
    ...
    static final class SpanInfo {
        ...
        private static final Comparator<SpanInfo> FOR_OPENING_TAGS = new Comparator() { // from class: androidx.media3.ui.SpannedToHtmlConverter$SpanInfo$$ExternalSyntheticLambda0
            ...
            public final int compare(Object obj, Object obj2) {
                return SpannedToHtmlConverter.SpanInfo.$r8$lambda$bEMOkNLDS_kpQ47JJ2bxNhjDo4Y((SpannedToHtmlConverter.SpanInfo) obj, (SpannedToHtmlConverter.SpanInfo) obj2);
            }
        };
        private static final Comparator<SpanInfo> FOR_CLOSING_TAGS = new Comparator() { // from class: androidx.media3.ui.SpannedToHtmlConverter$SpanInfo$$ExternalSyntheticLambda1
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return SpannedToHtmlConverter.SpanInfo.$r8$lambda$UqIK9EDTKJFYzY0TZycfsj4x9Aw((SpannedToHtmlConverter.SpanInfo) obj, (SpannedToHtmlConverter.SpanInfo) obj2);
            }
        };

        public static /* synthetic */ int $r8$lambda$bEMOkNLDS_kpQ47JJ2bxNhjDo4Y(SpanInfo spanInfo, SpanInfo spanInfo2) {
        ...
        public static /* synthetic */ int $r8$lambda$UqIK9EDTKJFYzY0TZycfsj4x9Aw(SpanInfo spanInfo, SpanInfo spanInfo2) {

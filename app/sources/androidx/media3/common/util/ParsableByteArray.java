...
public final class ParsableByteArray {
    ...
    /* renamed from: LF */
    private static final char[] f247LF = {'\n'};
    private static final ImmutableSet<Charset> SUPPORTED_CHARSETS_FOR_READLINE = ImmutableSet.m1016of(Charsets.US_ASCII, Charsets.UTF_8, Charsets.UTF_16, Charsets.UTF_16BE, Charsets.UTF_16LE);
    private byte[] data;
    private int limit;
    ...
    public String readLine(Charset charset) {
        ...
        String string2 = readString(findNextLineTerminator(charset) - this.position, charset);
    ...
    */
    ...
    private void skipLineTerminator(Charset charset) {
        if (readCharacterIfInList(charset, CR_AND_LF) == '\r') {
            readCharacterIfInList(charset, f247LF);
        }
    }
    ...
    private char readCharacterIfInList(Charset charset, char[] cArr) {
        ...
        this.position += iPeekCharacterAndSize & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH;
        return c;
    }

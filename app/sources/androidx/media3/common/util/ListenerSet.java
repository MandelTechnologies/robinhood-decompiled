    ...
    public void queueEvent(final int i, final Event<T> event) {
        ...
        this.queuedEvents.add(new Runnable() { // from class: androidx.media3.common.util.ListenerSet$$ExternalSyntheticLambda1
            ...
            public final void run() {
                ListenerSet.m8230$r8$lambda$MawsDUsVhcg5uFQgolq5mcQJiM(copyOnWriteArraySet, i, event);
            }
        });
    }

    /* renamed from: $r8$lambda$Maws-DUsVhcg5uFQgolq5mcQJiM, reason: not valid java name */
    public static /* synthetic */ void m8230$r8$lambda$MawsDUsVhcg5uFQgolq5mcQJiM(CopyOnWriteArraySet copyOnWriteArraySet, int i, Event event) {

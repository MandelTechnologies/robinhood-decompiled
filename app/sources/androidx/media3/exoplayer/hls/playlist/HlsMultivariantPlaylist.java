...
public final class HlsMultivariantPlaylist extends HlsPlaylist {
    ...
    public static final class Variant {
        ...
        public final Format f9719format;
    ...
    public static final class Rendition {
        ...
        /* renamed from: format, reason: collision with root package name */
        public final Format f9718format;
        ...
        public Rendition(Uri uri, Format format2, String str, String str2) {
            this.url = uri;
            this.f9718format = format2;
            this.groupId = str;
            this.name = str2;
        }
    }

    public HlsMultivariantPlaylist(String str, List<String> list, List<Variant> list2, List<Rendition> list3, List<Rendition> list4, List<Rendition> list5, List<Rendition> list6, Format format2, List<Format> list7, boolean z, Map<String, String> map, List<DrmInitData> list8) {
        super(str, list, z);

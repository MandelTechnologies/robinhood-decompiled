...
public final class BundledHlsMediaChunkExtractor implements HlsMediaChunkExtractor {
    ...
    BundledHlsMediaChunkExtractor(Extractor extractor, Format format2, TimestampAdjuster timestampAdjuster, SubtitleParser.Factory factory, boolean z) {
        this.extractor = extractor;
        this.multivariantPlaylistFormat = format2;

...
public interface AnalyticsCollector extends Player.Listener, MediaSourceEventListener, BandwidthMeter.EventListener, DrmSessionEventListener {
    ...
    void onAudioInputFormatChanged(Format format2, DecoderReuseEvaluation decoderReuseEvaluation);
    ...
    void onVideoInputFormatChanged(Format format2, DecoderReuseEvaluation decoderReuseEvaluation);

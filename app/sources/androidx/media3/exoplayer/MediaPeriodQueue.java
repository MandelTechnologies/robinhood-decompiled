...
final class MediaPeriodQueue {
    ...
    public void invalidatePreloadPool(Timeline timeline) {
        ...
        Pair<Object, Long> defaultPeriodPositionOfNextWindow = getDefaultPeriodPositionOfNextWindow(timeline, mediaPeriodHolder.info.f249id.periodUid, 0L);
    ...
    public MediaPeriodHolder advancePlayingPeriod() {
        ...
        if (i == 0) {
            ...
            this.oldFrontPeriodWindowSequenceNumber = mediaPeriodHolder2.info.f249id.windowSequenceNumber;
        }
    ...
    public void clear() {
        ...
        this.oldFrontPeriodWindowSequenceNumber = next.info.f249id.windowSequenceNumber;
        while (next != null) {
            next.release();
            next = next.getNext();
        }
    ...
    public boolean updateQueuedPeriods(Timeline timeline, long j, long j2) {
        ...
        while (next != null) {
            ...
            if (!areDurationsCompatible(mediaPeriodInfo.durationUs, updatedMediaPeriodInfo.durationUs)) {
                ...
                return (removeAfter(next) || (next == this.reading && !next.info.isFollowedByTransitionToSameStream && ((j2 > Long.MIN_VALUE ? 1 : (j2 == Long.MIN_VALUE ? 0 : -1)) == 0 || (j2 > ((j3 > (-9223372036854775807L) ? 1 : (j3 == (-9223372036854775807L) ? 0 : -1)) == 0 ? Long.MAX_VALUE : next.toRendererTime(j3)) ? 1 : (j2 == ((j3 > (-9223372036854775807L) ? 1 : (j3 == (-9223372036854775807L) ? 0 : -1)) == 0 ? Long.MAX_VALUE : next.toRendererTime(j3)) ? 0 : -1)) >= 0))) ? false : true;
            }
    ...
    */
    public MediaPeriodInfo getUpdatedMediaPeriodInfo(Timeline timeline, MediaPeriodInfo mediaPeriodInfo) {
        ...
        timeline.getPeriodByUid(mediaPeriodInfo.f249id.periodUid, this.period);
    ...
    private void notifyQueueUpdate() {
        ...
        for (MediaPeriodHolder next = this.playing; next != null; next = next.getNext()) {
            builder.add((ImmutableList.Builder) next.info.f249id);
        }
        MediaPeriodHolder mediaPeriodHolder = this.reading;
        final MediaSource.MediaPeriodId mediaPeriodId = mediaPeriodHolder == null ? null : mediaPeriodHolder.info.f249id;
    ...
    private long resolvePeriodUidToWindowSequenceNumber(Timeline timeline, Object obj) {
        ...
        for (MediaPeriodHolder next = this.playing; next != null; next = next.getNext()) {
            if (next.uid.equals(obj)) {
                return next.info.f249id.windowSequenceNumber;
            }
        }
        for (MediaPeriodHolder next2 = this.playing; next2 != null; next2 = next2.getNext()) {
            ...
            if (indexOfPeriod2 != -1 && timeline.getPeriod(indexOfPeriod2, this.period).windowIndex == i) {
                return next2.info.f249id.windowSequenceNumber;
            }
        }
    ...
    private long resolvePeriodUidToWindowSequenceNumberInPreloadPeriods(Object obj) {
        for (int i = 0; i < this.preloadPriorityList.size(); i++) {
            ...
            if (mediaPeriodHolder.uid.equals(obj)) {
                return mediaPeriodHolder.info.f249id.windowSequenceNumber;
            }
        }
        return -1L;
    }
    ...
    private boolean canKeepMediaPeriodHolder(MediaPeriodInfo mediaPeriodInfo, MediaPeriodInfo mediaPeriodInfo2) {
        return mediaPeriodInfo.startPositionUs == mediaPeriodInfo2.startPositionUs && mediaPeriodInfo.f249id.equals(mediaPeriodInfo2.f249id);
    }
    ...
    private MediaPeriodInfo getFirstMediaPeriodInfoOfNextPeriod(Timeline timeline, MediaPeriodHolder mediaPeriodHolder, long j) {
        ...
        long j2;
        MediaPeriodInfo mediaPeriodInfo = mediaPeriodHolder.info;
        int nextPeriodIndex = timeline.getNextPeriodIndex(timeline.getIndexOfPeriod(mediaPeriodInfo.f249id.periodUid), this.period, this.window, this.repeatMode, this.shuffleModeEnabled);
        ...
        long j3 = mediaPeriodInfo.f249id.windowSequenceNumber;
        long j4 = 0;
        if (timeline.getWindow(i, this.window).firstPeriodIndex == nextPeriodIndex) {
            ...
            if (next != null && next.uid.equals(obj2)) {
                j3 = next.info.f249id.windowSequenceNumber;
            } else {
        ...
        if (j4 != -9223372036854775807L && mediaPeriodInfo.requestedContentPositionUs != -9223372036854775807L) {
            boolean zHasServerSideInsertedAds = hasServerSideInsertedAds(mediaPeriodInfo.f249id.periodUid, timeline);

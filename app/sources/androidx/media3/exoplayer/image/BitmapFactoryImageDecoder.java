...
public final class BitmapFactoryImageDecoder extends SimpleDecoder<DecoderInputBuffer, ImageOutputBuffer, ImageDecoderException> implements ImageDecoder {
    ...
    public static final class Factory implements ImageDecoder.Factory {
        private final BitmapDecoder bitmapDecoder = new BitmapDecoder() { // from class: androidx.media3.exoplayer.image.BitmapFactoryImageDecoder$Factory$$ExternalSyntheticLambda0
        ...
        public int supportsFormat(Format format2) {
            ...
            if (Util.isBitmapFactorySupportedMimeType(format2.sampleMimeType)) {

...
final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    private void maybeNotifyDownstreamFormat(int i) {
        ...
        Format format2 = trackState.tracks.get(i).getFormat(0);
        this.mediaSourceEventDispatcher.downstreamFormatChanged(MimeTypes.getTrackType(format2.sampleMimeType), format2, 0, null, this.lastSeekPositionUs);
        zArr[i] = true;
    }
    ...
    private TrackOutput prepareTrackOutput(TrackId trackId) {
        ...
        if (this.sampleQueuesBuilt) {
            Log.m538w("ProgressiveMediaPeriod", "Extractor added new track (id=" + trackId.f253id + ") after finishing tracks.");
    ...
    private static final class TrackId {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && TrackId.class == obj.getClass()) {
                ...
                if (this.f253id == trackId.f253id && this.isIcyTrack == trackId.isIcyTrack) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            return (this.f253id * 31) + (this.isIcyTrack ? 1 : 0);
        }
    }

    private static Map<String, String> createIcyMetadataHeaders() {
        HashMap map = new HashMap();
        map.put("Icy-MetaData", Constants.SdidMigrationStatusCodes.ALREADY_SDID);

...
final class SingleSampleMediaPeriod implements MediaPeriod, Loader.Callback<SourceLoadable> {
    ...
    public SingleSampleMediaPeriod(DataSpec dataSpec, DataSource.Factory factory, TransferListener transferListener, Format format2, long j, LoadErrorHandlingPolicy loadErrorHandlingPolicy, MediaSourceEventListener.EventDispatcher eventDispatcher, boolean z) {
        this.dataSpec = dataSpec;
        this.dataSourceFactory = factory;
        this.transferListener = transferListener;
        this.f9724format = format2;
        this.durationUs = j;
    ...
    public boolean continueLoading(LoadingInfo loadingInfo) {
        ...
        this.eventDispatcher.loadStarted(new LoadEventInfo(sourceLoadable.loadTaskId, this.dataSpec, this.loader.startLoading(sourceLoadable, this, this.loadErrorHandlingPolicy.getMinimumLoadableRetryCount(1))), 1, -1, this.f9724format, 0, null, 0L, this.durationUs);
        return true;
    }
    ...
    public void onLoadCompleted(SourceLoadable sourceLoadable, long j, long j2) {
        ...
        this.eventDispatcher.loadCompleted(loadEventInfo, 1, -1, this.f9724format, 0, null, 0L, this.durationUs);
    }
    ...
    public Loader.LoadErrorAction onLoadError(SourceLoadable sourceLoadable, long j, long j2, IOException iOException, int i) {
        ...
        StatsDataSource statsDataSource = sourceLoadable.dataSource;
        LoadEventInfo loadEventInfo = new LoadEventInfo(sourceLoadable.loadTaskId, sourceLoadable.dataSpec, statsDataSource.getLastOpenedUri(), statsDataSource.getLastResponseHeaders(), j, j2, statsDataSource.getBytesRead());
        long retryDelayMsFor = this.loadErrorHandlingPolicy.getRetryDelayMsFor(new LoadErrorHandlingPolicy.LoadErrorInfo(loadEventInfo, new MediaLoadData(1, -1, this.f9724format, 0, null, 0L, Util.usToMs(this.durationUs)), iOException, i));
        ...
        if (this.treatLoadErrorsAsEndOfStream && z) {
            Log.m539w("SingleSampleMediaPeriod", "Loading failed, treating as end-of-stream.", iOException);
            this.loadingFinished = true;
        ...
        this.eventDispatcher.loadError(loadEventInfo, 1, -1, this.f9724format, 0, null, 0L, this.durationUs, iOException, !zIsRetry);
        if (!zIsRetry) {
            this.loadErrorHandlingPolicy.onLoadTaskConcluded(sourceLoadable.loadTaskId);
        }
    ...
    private final class SampleStreamImpl implements SampleStream {
        ...
        public int readData(FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer, int i) {
            ...
            if ((i & 2) != 0 || i2 == 0) {
                formatHolder.f9709format = singleSampleMediaPeriod.f9724format;
                this.streamState = 1;
                return -5;
            }
            if (!z) {
        ...
        private void maybeNotifyDownstreamFormat() {
            ...
            SingleSampleMediaPeriod.this.eventDispatcher.downstreamFormatChanged(MimeTypes.getTrackType(SingleSampleMediaPeriod.this.f9724format.sampleMimeType), SingleSampleMediaPeriod.this.f9724format, 0, null, 0L);

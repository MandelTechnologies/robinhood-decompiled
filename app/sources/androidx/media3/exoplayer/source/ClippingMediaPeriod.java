    ...
    private final class ClippingSampleStream implements SampleStream {
        ...
        public int readData(FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer, int i) {
            ...
            if (data == -5) {
                ...
                int i2 = format2.encoderDelay;
                if (i2 != 0 || format2.encoderPadding != 0) {
                    ClippingMediaPeriod clippingMediaPeriod = ClippingMediaPeriod.this;
                    if (clippingMediaPeriod.startUs != 0) {
                        i2 = 0;
                    }
                    formatHolder.f9709format = format2.buildUpon().setEncoderDelay(i2).setEncoderPadding(clippingMediaPeriod.endUs == Long.MIN_VALUE ? format2.encoderPadding : 0).build();
                }
                return -5;
            }

...
public abstract class BaseTrackSelection implements ExoTrackSelection {
    ...
    public BaseTrackSelection(TrackGroup trackGroup, int[] iArr, int i) {
        ...
        Arrays.sort(this.formats, new Comparator() { // from class: androidx.media3.exoplayer.trackselection.BaseTrackSelection$$ExternalSyntheticLambda0
            ...
            public final int compare(Object obj, Object obj2) {
                return BaseTrackSelection.$r8$lambda$_Nx2IO7J9FRVwHR6yPRlPDHVDT4((Format) obj, (Format) obj2);
            }
        });
    ...
    public static /* synthetic */ int $r8$lambda$_Nx2IO7J9FRVwHR6yPRlPDHVDT4(Format format2, Format format3) {
        return format3.bitrate - format2.bitrate;
    }
    ...
    public final int indexOf(Format format2) {
        for (int i = 0; i < this.length; i++) {
            if (this.formats[i] == format2) {
                return i;
            }
        }
        return -1;

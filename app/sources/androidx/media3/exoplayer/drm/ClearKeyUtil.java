    ...
    public static byte[] adjustResponseData(byte[] bArr) {
        ...
        try {
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                ...
                sb.append("{\"k\":\"");
                sb.append(base64UrlToBase64(jSONObject2.getString(Constants.RequestParamsKeys.IDENTIFIER_KEYSPACE_KEY)));
                sb.append("\",\"kid\":\"");
            ...
            Log.m536e("ClearKeyUtil", "Failed to adjust response data: " + Util.fromUtf8Bytes(bArr), e);
            return bArr;
        }
    }

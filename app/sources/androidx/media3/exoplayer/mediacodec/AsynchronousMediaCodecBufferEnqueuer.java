    ...
    */
        ...
        if (i == 1) {
            ...
            if (i != 2) {
                ...
                if (i == 3) {
                    ...
                    PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(this.pendingRuntimeException, null, new IllegalStateException(String.valueOf(message.what)));
                }
    ...
    private void doQueueInputBuffer(int i, int i2, int i3, long j, int i4) throws MediaCodec.CryptoException {
        try {
            ...
            PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(this.pendingRuntimeException, null, e);
        }
    }
    ...
    private static void copy(CryptoInfo cryptoInfo, MediaCodec.CryptoInfo cryptoInfo2) {
        ...
        cryptoInfo2.iv = (byte[]) Assertions.checkNotNull(copy(cryptoInfo.f248iv, cryptoInfo2.iv));

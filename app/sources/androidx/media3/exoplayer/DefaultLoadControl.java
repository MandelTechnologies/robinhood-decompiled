...
public class DefaultLoadControl implements LoadControl {
    ...
    public static final class Builder {
        ...
        private int minBufferMs = AchTransfer.MAX_DEPOSIT_LIMIT;
        private int maxBufferMs = AchTransfer.MAX_DEPOSIT_LIMIT;
        private int bufferForPlaybackMs = 2500;
        private int bufferForPlaybackAfterRebufferMs = OptionChainListView9.SELLOUT_SNACKBAR_DISPLAY_DURATION_MS;
    ...
    public DefaultLoadControl() {
        this(new DefaultAllocator(true, 65536), AchTransfer.MAX_DEPOSIT_LIMIT, AchTransfer.MAX_DEPOSIT_LIMIT, 2500, OptionChainListView9.SELLOUT_SNACKBAR_DISPLAY_DURATION_MS, -1, false, 0, false);
    }
    ...
    public boolean shouldContinueLoading(LoadControl.Parameters parameters) {
        ...
        if (j < jMax) {
            ...
            if (!z && j < 500000) {
                Log.m538w("DefaultLoadControl", "Target buffer size reached with less than 500ms of buffered media data.");
            }

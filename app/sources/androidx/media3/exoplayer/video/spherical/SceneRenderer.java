...
final class SceneRenderer implements VideoFrameMetadataListener, CameraMotionListener {
    ...
    public SurfaceTexture init() {
        try {
            ...
            Log.m536e("SceneRenderer", "Failed to initialize the renderer", e);
        }
    ...
    public void drawFrame(float[] fArr, boolean z) {
        ...
        try {
            ...
            Log.m536e("SceneRenderer", "Failed to draw a frame", e);
        }
        if (this.frameAvailable.compareAndSet(true, false)) {
            ...
            try {
                ...
                Log.m536e("SceneRenderer", "Failed to draw a frame", e2);
            }
    ...
    public void onVideoFrameAboutToBeRendered(long j, long j2, Format format2, MediaFormat mediaFormat) {
        ...
        setProjection(format2.projectionData, format2.stereoMode, j2);
    }

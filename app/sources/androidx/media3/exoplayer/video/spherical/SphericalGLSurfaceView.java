    ...
    protected void onDetachedFromWindow() {
        ...
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.video.spherical.SphericalGLSurfaceView$$ExternalSyntheticLambda0
            ...
            public final void run() {
                SphericalGLSurfaceView.m8302$r8$lambda$2h4bGm0n_IoJDjdsXrnNLhYgyM(this.f$0);
            }
        });
    }

    /* renamed from: $r8$lambda$2h4bGm0n_IoJDjdsX-rnNLhYgyM, reason: not valid java name */
    public static /* synthetic */ void m8302$r8$lambda$2h4bGm0n_IoJDjdsXrnNLhYgyM(SphericalGLSurfaceView sphericalGLSurfaceView) {

...
public class CLContainer extends CLElement {
    ...
    public CLContainer mo8187clone() throws CloneNotSupportedException {
        CLContainer cLContainer = (CLContainer) super.mo8187clone();
        ArrayList<CLElement> arrayList = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement cLElementMo8187clone = it.next().mo8187clone();
            cLElementMo8187clone.setContainer(cLContainer);
            arrayList.add(cLElementMo8187clone);
        }

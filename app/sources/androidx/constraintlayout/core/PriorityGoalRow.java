...
public class PriorityGoalRow extends ArrayRow {
    ...
    class GoalVariableAccessor {
        ...
        public String toString() {
            ...
            if (this.mVariable != null) {
                for (int i = 0; i < 9; i++) {
                    str = str + this.mVariable.mGoalStrengthVector[i] + PlaceholderUtils.XXShortPlaceholderText;
                }
            }
    ...
    */
    ...
    private void addToGoal(SolverVariable solverVariable) {
        ...
        int i4 = i3 + 1;
        this.mNumGoals = i4;
        if (i4 > 1 && solverVariableArr3[i3].f187id > solverVariable.f187id) {
            int i5 = 0;
            while (true) {
                i = this.mNumGoals;
                if (i5 >= i) {
            ...
            Arrays.sort(this.mSortArray, 0, i, new Comparator<SolverVariable>() { // from class: androidx.constraintlayout.core.PriorityGoalRow.1
                ...
                public int compare(SolverVariable solverVariable2, SolverVariable solverVariable3) {
                    return solverVariable2.f187id - solverVariable3.f187id;
                }
            });
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.mNumGoals; i++) {
            ...
            str = str + this.mAccessor + PlaceholderUtils.XXShortPlaceholderText;
        }
        return str;
    }
}

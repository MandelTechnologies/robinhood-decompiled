...
public class ConstraintWidget {
    ...
    /* renamed from: mX */
    protected int f202mX;

    /* renamed from: mY */
    protected int f203mY;
    ...
    public void connectCircularConstraint(ConstraintWidget constraintWidget, float f, int i) {
        ...
        immediateConnect(type2, constraintWidget, type2, i, 0);
    ...
    public String toString() {
        ...
        String str2 = "";
        if (this.mType != null) {
            str = "type: " + this.mType + PlaceholderUtils.XXShortPlaceholderText;
        } else {
            str = "";
        }
        sb.append(str);
        if (this.mDebugName != null) {
            str2 = "id: " + this.mDebugName + PlaceholderUtils.XXShortPlaceholderText;
        }
        sb.append(str2);
        sb.append("(");
        sb.append(this.f202mX);
        sb.append(", ");
        sb.append(this.f203mY);
        sb.append(") - (");
    ...
    public int getX() {
        ...
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingLeft + this.f202mX;
        }
        return this.f202mX;
    }
    ...
    public int getY() {
        ConstraintWidget constraintWidget = this.mParent;
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingTop + this.f203mY;
        }
        return this.f203mY;
    }
    ...
    static /* synthetic */ class C20621 {
        ...
        static final /* synthetic */ int[] f204x6930e354;
        ...
        static {
            ...
            try {
                f204x6930e354[ConstraintAnchor.Type.TOP.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f204x6930e354[ConstraintAnchor.Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f204x6930e354[ConstraintAnchor.Type.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f204x6930e354[ConstraintAnchor.Type.BASELINE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f204x6930e354[ConstraintAnchor.Type.CENTER.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f204x6930e354[ConstraintAnchor.Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f204x6930e354[ConstraintAnchor.Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f204x6930e354[ConstraintAnchor.Type.NONE.ordinal()] = 9;
    ...
    */
    ...
    public void immediateConnect(ConstraintAnchor.Type type2, ConstraintWidget constraintWidget, ConstraintAnchor.Type type3, int i, int i2) {
        getAnchor(type2).connect(constraintWidget.getAnchor(type3), i, i2, true);
    }
    ...
    public void connect(ConstraintAnchor.Type type2, ConstraintWidget constraintWidget, ConstraintAnchor.Type type3) {
        connect(type2, constraintWidget, type3, 0);
    }

    public void connect(ConstraintAnchor.Type type2, ConstraintWidget constraintWidget, ConstraintAnchor.Type type3, int i) {
        ...
        if (type2 == type6) {
            ...
            if (type3 == type13 || type3 == ConstraintAnchor.Type.RIGHT) {
                connect(type13, constraintWidget, type3, 0);
                connect(ConstraintAnchor.Type.RIGHT, constraintWidget, type3, 0);
                getAnchor(type6).connect(constraintWidget.getAnchor(type3), 0);
                return;
            }
            ConstraintAnchor.Type type14 = ConstraintAnchor.Type.TOP;
            if (type3 == type14 || type3 == ConstraintAnchor.Type.BOTTOM) {
                connect(type14, constraintWidget, type3, 0);
                connect(ConstraintAnchor.Type.BOTTOM, constraintWidget, type3, 0);
                getAnchor(type6).connect(constraintWidget.getAnchor(type3), 0);
                return;
            }
            return;
        ...
        if (type2 == type15 && (type3 == (type5 = ConstraintAnchor.Type.LEFT) || type3 == ConstraintAnchor.Type.RIGHT)) {
            ...
            ConstraintAnchor anchor6 = constraintWidget.getAnchor(type3);
            ConstraintAnchor anchor7 = getAnchor(ConstraintAnchor.Type.RIGHT);
            anchor5.connect(anchor6, 0);
            anchor7.connect(anchor6, 0);
            getAnchor(type15).connect(anchor6, 0);
            return;
        }
        ...
        if (type2 == type16 && (type3 == (type4 = ConstraintAnchor.Type.TOP) || type3 == ConstraintAnchor.Type.BOTTOM)) {
            ConstraintAnchor anchor8 = constraintWidget.getAnchor(type3);
            getAnchor(type4).connect(anchor8, 0);
            getAnchor(ConstraintAnchor.Type.BOTTOM).connect(anchor8, 0);
            getAnchor(type16).connect(anchor8, 0);
            return;
        }
        if (type2 == type15 && type3 == type15) {
            ...
            getAnchor(type15).connect(constraintWidget.getAnchor(type3), 0);
            return;
        }
        if (type2 == type16 && type3 == type16) {
            ...
            getAnchor(type20).connect(constraintWidget.getAnchor(type20), 0);
            getAnchor(type16).connect(constraintWidget.getAnchor(type3), 0);
            return;
        }
        ConstraintAnchor anchor9 = getAnchor(type2);
        ConstraintAnchor anchor10 = constraintWidget.getAnchor(type3);
        if (anchor9.isValidConnection(anchor10)) {
            ...
            if (type2 == type21) {
                ...
                ConstraintAnchor opposite = getAnchor(type2).getOpposite();
                ...
                ConstraintAnchor opposite2 = getAnchor(type2).getOpposite();
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type type2) {
        switch (C20621.f204x6930e354[type2.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    */
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        if (z11 || this.mResolvedVertical) {
            if (z11) {
                linearSystem3.addEquality(solverVariableCreateObjectVariable, this.f202mX);
                linearSystem3.addEquality(solverVariableCreateObjectVariable2, this.f202mX + this.mWidth);
            ...
            if (this.mResolvedVertical) {
                linearSystem3.addEquality(solverVariableCreateObjectVariable3, this.f203mY);
                linearSystem3.addEquality(solverVariableCreateObjectVariable4, this.f203mY + this.mHeight);
                if (this.mBaseline.hasDependents()) {
                    linearSystem3.addEquality(solverVariableCreateObjectVariable5, this.f203mY + this.mBaselineDistance);
                }
        ...
        boolean z13 = dimensionBehaviour4 != dimensionBehaviour5;
        DimensionBehaviour dimensionBehaviour6 = dimensionBehaviourArr[1];
        boolean z14 = dimensionBehaviour6 != dimensionBehaviour5;
            ...
            if (this.mVisibility != 8) {
                ...
                if (dimensionBehaviour4 == dimensionBehaviour5 && dimensionBehaviour6 == dimensionBehaviour5) {
                    ...
                    if (z6) {
                        ...
                        boolean z16 = !z6 && ((i9 = this.mResolvedDimensionRatioSide) == 1 || i9 == i4);
                        DimensionBehaviour dimensionBehaviour7 = this.mListDimensionBehaviors[0];
                        dimensionBehaviour = DimensionBehaviour.WRAP_CONTENT;
                        boolean z17 = dimensionBehaviour7 != dimensionBehaviour && (this instanceof ConstraintWidgetContainer);
                        int i22 = !z17 ? 0 : i17;
                        ...
                        if (this.mHorizontalResolution != 2 || this.mResolvedHorizontal) {
                            ...
                            boolean z22 = dimensionBehaviourArr2[1] == dimensionBehaviour5;
                            solverVariable2 = solverVariableCreateObjectVariable;
                            boolean z23 = z2;
                            ...
                            applyConstraints(linearSystem3, true, z9, z8, z21, solverVariable13, solverVariable14, dimensionBehaviour8, z17, constraintAnchor, constraintAnchor2, i23, i22, i24, i25, f2, z15, z22, z4, z5, z19, i5, i3, this.mMatchConstraintMinWidth, this.mMatchConstraintMaxWidth, this.mMatchConstraintPercentWidth, z18);
                        }
                        ...
                        if ((this.mVerticalResolution != 2 ? i6 : i8) != 0 || this.mResolvedVertical) {
                            ...
                            boolean z24 = (this.mListDimensionBehaviors[r21] == dimensionBehaviour2 && (this instanceof ConstraintWidgetContainer)) ? r21 : i6;
                            int i27 = z24 ? i6 : i;
                            ...
                            boolean z25 = this.isTerminalWidget[r21];
                            DimensionBehaviour[] dimensionBehaviourArr3 = this.mListDimensionBehaviors;
                            int i28 = i6;
                            solverVariable9 = solverVariable6;
                            solverVariable10 = solverVariable7;
                            applyConstraints(linearSystem, false, z8, z9, z25, solverVariableCreateObjectVariable9, solverVariableCreateObjectVariable8, dimensionBehaviourArr3[r21], z24, this.mTop, this.mBottom, this.f203mY, i27, this.mMinHeight, this.mMaxDimension[r21], this.mVerticalBiasPercent, z16, dimensionBehaviourArr3[i28] == dimensionBehaviour3 ? r21 : i28, z5, z4, z20, i3, i5, this.mMatchConstraintMinHeight, this.mMatchConstraintMaxHeight, this.mMatchConstraintPercentHeight, z18);
                            constraintWidget3 = this;
                        }
                        if (!z7) {
                            linearSystem2 = linearSystem;
                        } else if (constraintWidget3.mResolvedDimensionRatioSide == 1) {
                            linearSystem.addRatio(solverVariable10, solverVariable9, solverVariable, solverVariable2, constraintWidget3.mResolvedDimensionRatio, 8);
                            linearSystem2 = linearSystem;
                        } else {
                            linearSystem.addRatio(solverVariable, solverVariable2, solverVariable10, solverVariable9, constraintWidget3.mResolvedDimensionRatio, 8);
                            linearSystem2 = linearSystem;
                        }
        ...
        boolean z1822222 = !this.mCenter.isConnected();
    ...
    */
    private void applyConstraints(LinearSystem linearSystem, boolean z, boolean z2, boolean z3, boolean z4, SolverVariable solverVariable, SolverVariable solverVariable2, DimensionBehaviour dimensionBehaviour, boolean z5, ConstraintAnchor constraintAnchor, ConstraintAnchor constraintAnchor2, int i, int i2, int i3, int i4, float f, boolean z6, boolean z7, boolean z8, boolean z9, boolean z10, int i5, int i6, int i7, int i8, float f2, boolean z11) {
        ...
        boolean z25 = (iOrdinal == 0 || iOrdinal == 1 || iOrdinal != 2 || i29 == 4) ? false : true;
        int i30 = this.mWidthOverride;
        if (i30 != -1 && z) {
            this.mWidthOverride = -1;
            i2 = i30;
            z25 = false;
        }
        int i31 = this.mHeightOverride;
        if (i31 == -1 || z) {
            i31 = i2;
        } else {
            this.mHeightOverride = -1;
        ...
        if (!z13) {
            ...
            z15 = z4;
            i12 = i7;
        } else if (i28 == 2 || z6 || !(i29 == 1 || i29 == 0)) {
            int i33 = i7 == -2 ? iMin : i7;
            int i34 = i8 == -2 ? iMin : i8;
            if (iMin > 0 && i29 != 1) {
                iMin = 0;
            }
            if (i33 > 0) {
                linearSystem2.addGreaterThan(solverVariableCreateObjectVariable4, solverVariableCreateObjectVariable3, i33, 8);
                iMin = Math.max(iMin, i33);
            }
            if (i34 > 0) {
                if (!z2 || i29 != 1) {
                    linearSystem2.addLowerThan(solverVariableCreateObjectVariable4, solverVariableCreateObjectVariable3, i34, 8);
                }
            ...
            if (i29 == 1) {
                ...
                if (i29 == 2) {
                    ...
                    if (type2 == type3 || constraintAnchor.getType() == ConstraintAnchor.Type.BOTTOM) {
                        solverVariableCreateObjectVariable = linearSystem2.createObjectVariable(this.mParent.getAnchor(type3));
                ...
                if (!zIsConnected && !zIsConnected2 && !zIsConnected3) {
                    ...
                    if (!zIsConnected && zIsConnected2) {
                        ...
                        if (z18) {
                            ...
                            linearSystem2.addCentering(solverVariable28, solverVariable8, constraintAnchor.getMargin(), f, solverVariable7, solverVariable29, constraintAnchor2.getMargin(), i22);
                        ...
                        if (z17) {
                            int i36 = (!z22 || solverVariable8 == solverVariable10 || z14 || !((constraintWidget instanceof Barrier) || (constraintWidget2 instanceof Barrier))) ? i17 : 6;
                            linearSystem2.addGreaterThan(solverVariable11, solverVariable8, constraintAnchor.getMargin(), i36);
                            linearSystem2.addLowerThan(solverVariable3, solverVariable10, -constraintAnchor2.getMargin(), i36);
                            i17 = i36;
                        }
                        ...
                        if (!z22 || !z14 || i3 != 0 || i12 != 0) {
                            ...
                            linearSystem2.addGreaterThan(solverVariable3, solverVariable11, 0, i19);
                            i21 = 5;
                            i27 = i21;
                        } else {
                            i21 = 5;
                    ...
                    i27 = (z2 && (constraintAnchor.mTarget.mOwner instanceof Barrier)) ? 8 : 5;
                    z22 = z2;
                    solverVariable10 = solverVariable4;
                }
                if (z22 && z15) {
                    ...
                    if (solverVariable10 != solverVariable2) {
                        ...
                        linearSystem2.addGreaterThan(solverVariable2, solverVariable3, margin3, i27);
                        return;
                    }
                    return;
                }
        ...
        if (i11 < i15 && z2 && z15) {
            ...
            if (!z && (constraintAnchor3 = this.mBaseline.mTarget) != null) {
                ...
                if (constraintWidget8.mDimensionRatio != 0.0f) {
                    ...
                    c2 = (dimensionBehaviour2 == dimensionBehaviour3 && dimensionBehaviourArr[c] == dimensionBehaviour3) ? c : (char) 0;
                }
            }
            if (c2 != 0) {
    ...
    public void copy(ConstraintWidget constraintWidget, HashMap<ConstraintWidget, ConstraintWidget> map) {
        ...
        this.f202mX = constraintWidget.f202mX;
        this.f203mY = constraintWidget.f203mY;
    ...
    public void getSceneString(StringBuilder sb) {
        ...
        sb.append("\n");
        sb.append("    actualLeft:" + this.f202mX);
        sb.append("\n");
        sb.append("    actualTop:" + this.f203mY);
        sb.append("\n");

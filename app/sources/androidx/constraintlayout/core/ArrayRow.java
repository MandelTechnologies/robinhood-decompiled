    ...
    */
            ...
            if (variable != null) {
                ...
                if (variableValue != 0.0f) {
                    ...
                    if (!z) {
                        ...
                        str = variableValue == 1.0f ? str + string2 : str + variableValue + PlaceholderUtils.XXShortPlaceholderText + string2;
                        z = true;
    ...
    private SolverVariable pickPivotInVariables(boolean[] zArr, SolverVariable solverVariable) {
        ...
        for (int i = 0; i < currentSize; i++) {
            ...
            if (variableValue < 0.0f) {
                SolverVariable variable = this.variables.getVariable(i);
                if ((zArr == null || !zArr[variable.f187id]) && variable != solverVariable && (((type2 = variable.mType) == SolverVariable.Type.SLACK || type2 == SolverVariable.Type.ERROR) && variableValue < f)) {
                    f = variableValue;
                    solverVariable2 = variable;
                }
            }

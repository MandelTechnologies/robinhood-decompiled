...
public abstract class SplineSet {
    ...
    */
    ...
    public static SplineSet makeCustomSplineSet(String str, KeyFrameArray$CustomVar keyFrameArray$CustomVar) {
        return new CustomSpline(str, keyFrameArray$CustomVar);
    }
    ...
    public static class CustomSpline extends SplineSet {
        ...
        public CustomSpline(String str, KeyFrameArray$CustomVar keyFrameArray$CustomVar) {

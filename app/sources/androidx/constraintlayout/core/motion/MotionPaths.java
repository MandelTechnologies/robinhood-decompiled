...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f191mX;
        float f9 = motionPaths.f192mY;
        float f10 = f;
        float f11 = (motionPaths2.f191mX + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f12 = (motionPaths2.f192mY + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f13 = ((f4 - f5) * f2) / 2.0f;
        this.f191mX = (int) ((f8 + (f11 * f10)) - f13);
        float f14 = ((f6 - f7) * f3) / 2.0f;
        this.f192mY = (int) ((f9 + (f12 * f10)) - f14);
        ...
        this.mMode = 0;
        this.f191mX = (int) (((motionPaths.f191mX + (f15 * f11)) + (f17 * f12)) - f13);
        this.f192mY = (int) (((motionPaths.f192mY + (f11 * f16)) + (f12 * f10)) - f14);
    ...
    void initPolar(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (i3 == 1) {
            ...
            float f10 = motionPaths2.f191mX;
            float f11 = motionPaths.f191mX;
            this.f191mX = (f9 * (f10 - f11)) + f11;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f2 = motionKeyPosition.mPercentY;
            }
            float f12 = motionPaths2.f192mY;
            float f13 = motionPaths.f192mY;
            this.f192mY = (f2 * (f12 - f13)) + f13;
        } else if (i3 == 2) {
            if (Float.isNaN(motionKeyPosition.mPercentX)) {
                float f14 = motionPaths2.f191mX;
                float f15 = motionPaths.f191mX;
                fMin = ((f14 - f15) * f2) + f15;
            } else {
            ...
            this.f191mX = fMin;
            if (Float.isNaN(motionKeyPosition.mPercentY)) {
                float f16 = motionPaths2.f192mY;
                float f17 = motionPaths.f192mY;
                f = (f2 * (f16 - f17)) + f17;
            } else {
            ...
            float f19 = motionPaths2.f191mX;
            float f20 = motionPaths.f191mX;
            this.f191mX = (f18 * (f19 - f20)) + f20;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f2 = motionKeyPosition.mPercentY;
            }
            float f21 = motionPaths2.f192mY;
            float f22 = motionPaths.f192mY;
            this.f192mY = (f2 * (f21 - f22)) + f22;
        }
    ...
    public void setupRelative(Motion motion, MotionPaths motionPaths) {
        double d = ((this.f191mX + (this.mWidth / 2.0f)) - motionPaths.f191mX) - (motionPaths.mWidth / 2.0f);
        double d2 = ((this.f192mY + (this.mHeight / 2.0f)) - motionPaths.f192mY) - (motionPaths.mHeight / 2.0f);
        this.mRelativeToController = motion;
        this.f191mX = (float) Math.hypot(d2, d);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f192mY = (float) (Math.atan2(d2, d) + 1.5707963267948966d);
        } else {
            this.f192mY = (float) Math.toRadians(this.mRelativeAngle);
        }
    }
    ...
    void initScreen(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f191mX;
        float f9 = motionPaths.f192mY;
        float f10 = motionPaths2.f191mX + (f4 / 2.0f);
        float f11 = motionPaths2.f192mY + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f191mX = (int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f));
        float f13 = (f6 - f7) * f3;
        this.f192mY = (int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f));
        this.mWidth = (int) (f5 + f12);
        this.mHeight = (int) (f7 + f13);
        this.mMode = 2;
        if (!Float.isNaN(motionKeyPosition.mPercentX)) {
            this.f191mX = (int) (motionKeyPosition.mPercentX * (i - ((int) this.mWidth)));
        }
        if (!Float.isNaN(motionKeyPosition.mPercentY)) {
            this.f192mY = (int) (motionKeyPosition.mPercentY * (i2 - ((int) this.mHeight)));
        }
    ...
    void initPath(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f6 = motionPaths.f191mX;
        float f7 = motionPaths.mWidth;
        float f8 = motionPaths.f192mY;
        float f9 = motionPaths.mHeight;
        float f10 = f;
        float f11 = (motionPaths2.f191mX + (motionPaths2.mWidth / 2.0f)) - ((f7 / 2.0f) + f6);
        float f12 = (motionPaths2.f192mY + (motionPaths2.mHeight / 2.0f)) - ((f9 / 2.0f) + f8);
        float f13 = f11 * f10;
        float f14 = (f4 * f2) / 2.0f;
        this.f191mX = (int) ((f6 + f13) - f14);
        float f15 = f12 * f10;
        float f16 = (f5 * f3) / 2.0f;
        this.f192mY = (int) ((f8 + f15) - f16);
        ...
        this.mMode = 1;
        float f18 = (int) ((motionPaths.f191mX + f13) - f14);
        float f19 = (int) ((motionPaths.f192mY + f15) - f16);
        this.f191mX = f18 + ((-f12) * f17);
        this.f192mY = f19 + (f11 * f17);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(motionKeyPosition.mTransitionEasing);
        this.mPathMotionArc = motionKeyPosition.mPathMotionArc;
    }
    ...
    void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        boolean zDiff = diff(this.f191mX, motionPaths.f191mX);
        boolean zDiff2 = diff(this.f192mY, motionPaths.f192mY);
    ...
    void getCenter(double d, int[] iArr, double[] dArr, float[] fArr, int i) {
        float fSin = this.f191mX;
        float fCos = this.f192mY;
        float f = this.mWidth;
    ...
    void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.mPosition, this.f191mX, this.f192mY, this.mWidth, this.mHeight, this.mPathRotate};
        int i = 0;
        for (int i2 : iArr) {
            if (i2 < 6) {
                dArr[i] = fArr[r1];

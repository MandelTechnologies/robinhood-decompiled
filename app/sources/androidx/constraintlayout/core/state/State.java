...
public class State {
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Can't remove SSA var: r0v0 androidx.constraintlayout.core.state.State$Chain, still in use, count: 1, list:
      (r0v0 androidx.constraintlayout.core.state.State$Chain) from 0x0047: INVOKE 
      (wrap:java.util.Map<java.lang.String, androidx.constraintlayout.core.state.State$Chain>:0x0042: SGET  A[WRAPPED] (LINE:116) androidx.constraintlayout.core.state.State.Chain.chainMap java.util.Map)
      ("spread")
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Can't remove SSA var: r0v0 androidx.constraintlayout.core.state.State$Wrap, still in use, count: 1, list:
      (r0v0 androidx.constraintlayout.core.state.State$Wrap) from 0x0037: INVOKE 
      ...
      (wrap:java.lang.String:SGET  A[WRAPPED] com.robinhood.models.api.pathfinder.userview.ApiRenderablePlatforms.VERSIONS_NONE java.lang.String)
    ...
    public static final class Wrap {
        ...
        static {
            wrapMap.put(ApiRenderablePlatforms.VERSIONS_NONE, new Wrap());
            wrapMap.put(TransitionReason.OPTION_TRADE_CHAIN, new Wrap());
            wrapMap.put("aligned", new Wrap());
            valueMap.put(ApiRenderablePlatforms.VERSIONS_NONE, 0);
            valueMap.put(TransitionReason.OPTION_TRADE_CHAIN, 3);

...
public class ConstraintReference implements Reference {
    ...
    public ConstraintReference margin(int i) {
        ...
        if (constraint != null) {
            switch (C20581.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()]) {
                case 1:
                case 2:
                    this.mMarginLeft = i;
                    break;
    ...
    private void applyConnection(ConstraintWidget constraintWidget, Object obj, State.Constraint constraint) {
        ...
        int[] iArr = C20581.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint;
        int i = iArr[constraint.ordinal()];
        switch (iArr[constraint.ordinal()]) {
            case 1:
                ConstraintAnchor.Type type2 = ConstraintAnchor.Type.LEFT;
                constraintWidget.getAnchor(type2).connect(target.getAnchor(type2), this.mMarginLeft, this.mMarginLeftGone, false);
                break;
            case 2:
            ...
            case 4:
                ...
                constraintWidget.getAnchor(type3).connect(target.getAnchor(type3), this.mMarginRight, this.mMarginRightGone, false);
                break;
            case 5:
                ConstraintAnchor.Type type4 = ConstraintAnchor.Type.LEFT;
                constraintWidget.getAnchor(type4).connect(target.getAnchor(type4), this.mMarginStart, this.mMarginStartGone, false);
                break;
            case 6:
            ...
            case 8:
                ...
                constraintWidget.getAnchor(type5).connect(target.getAnchor(type5), this.mMarginEnd, this.mMarginEndGone, false);
                break;
            case 9:
                ConstraintAnchor.Type type6 = ConstraintAnchor.Type.TOP;
                constraintWidget.getAnchor(type6).connect(target.getAnchor(type6), this.mMarginTop, this.mMarginTopGone, false);
                break;
            case 10:
            ...
            case 13:
                ...
                constraintWidget.getAnchor(type7).connect(target.getAnchor(type7), this.mMarginBottom, this.mMarginBottomGone, false);
                break;
            case 14:
            ...
            case 17:
                ...
                constraintWidget.immediateConnect(type8, target, type8, this.mMarginBaseline, this.mMarginBaselineGone);
                break;
            case 18:

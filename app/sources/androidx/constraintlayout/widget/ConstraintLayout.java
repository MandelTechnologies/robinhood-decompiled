...
public class ConstraintLayout extends ViewGroup {
    ...
    static /* synthetic */ class C20771 {
        ...
        static final /* synthetic */ int[] f214x6d00e4a2;
        ...
        static {
            ...
            try {
                f214x6d00e4a2[ConstraintWidget.DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f214x6d00e4a2[ConstraintWidget.DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f214x6d00e4a2[ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
    ...
    */
        ...
        if (i10 != -1) {
            ...
            if (i4 != -1) {
                ...
                if (constraintWidget8 != null) {
                    ...
                    constraintWidget.immediateConnect(type2, constraintWidget8, type2, ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i8);
                }
            ...
            if (i6 != -1) {
                ...
                if (constraintWidget9 != null) {
                    constraintWidget.immediateConnect(ConstraintAnchor.Type.RIGHT, constraintWidget9, ConstraintAnchor.Type.LEFT, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin, i9);
                }
            } else if (i7 != -1 && (constraintWidget3 = sparseArray.get(i7)) != null) {
                ConstraintAnchor.Type type3 = ConstraintAnchor.Type.RIGHT;
                constraintWidget.immediateConnect(type3, constraintWidget3, type3, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin, i9);
            }
            ...
            if (i11 != -1) {
                ...
                if (constraintWidget10 != null) {
                    ...
                    constraintWidget.immediateConnect(type4, constraintWidget10, type4, ((ViewGroup.MarginLayoutParams) layoutParams).topMargin, layoutParams.goneTopMargin);
                }
            } else {
            ...
            if (i15 != -1) {
                layoutParams2 = layoutParams;
                setWidgetBaseline(constraintWidget, layoutParams2, sparseArray, i15, ConstraintAnchor.Type.BASELINE);
            } else {
                layoutParams2 = layoutParams;
                int i16 = layoutParams2.baselineToTop;
                if (i16 != -1) {
                    setWidgetBaseline(constraintWidget, layoutParams2, sparseArray, i16, ConstraintAnchor.Type.TOP);
                } else {
                    int i17 = layoutParams2.baselineToBottom;
                    if (i17 != -1) {
                        setWidgetBaseline(constraintWidget, layoutParams2, sparseArray, i17, ConstraintAnchor.Type.BOTTOM);
                        constraintWidget6 = constraintWidget;
                    }
                    if (f3 >= 0.0f) {
    ...
    private void setWidgetBaseline(ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray<ConstraintWidget> sparseArray, int i, ConstraintAnchor.Type type2) {
        ...
        constraintWidget.getAnchor(type3).connect(constraintWidget2.getAnchor(type2), layoutParams.baselineMargin, layoutParams.goneBaselineMargin, true);

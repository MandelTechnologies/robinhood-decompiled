...
public class ViewTransition {
    ...
    */
    ViewTransition(Context context, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        char c;
    ...
    void applyTransition(ViewTransitionController viewTransitionController, MotionLayout motionLayout, int i, ConstraintSet constraintSet, final View... viewArr) {
        ...
        motionLayout.transitionToEnd(new Runnable() { // from class: androidx.constraintlayout.motion.widget.ViewTransition$$ExternalSyntheticLambda0
            ...
            public final void run() {
                ViewTransition.m8189$r8$lambda$aXGomewiX7JIjj_DElChS7vUic(this.f$0, viewArr);
            }
        });
    }

    /* renamed from: $r8$lambda$a-XGomewiX7JIjj_DElChS7vUic, reason: not valid java name */
    public static /* synthetic */ void m8189$r8$lambda$aXGomewiX7JIjj_DElChS7vUic(ViewTransition viewTransition, View[] viewArr) {
    ...
    private void updateTransition(MotionScene.Transition transition, View view) {
        ...
        if (keyFrames != null) {
            ...
            while (it.hasNext()) {
                keyFrames2.addKey(it.next().mo8188clone().setViewId(id));
            }

...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f9 = motionPaths.f213mY;
        float f10 = f;
        float f11 = (motionPaths2.f212mX + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f12 = (motionPaths2.f213mY + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f13 = ((f4 - f5) * f2) / 2.0f;
        this.f212mX = (int) ((f8 + (f11 * f10)) - f13);
        float f14 = ((f6 - f7) * f3) / 2.0f;
        this.f213mY = (int) ((f9 + (f12 * f10)) - f14);
        ...
        this.mMode = 0;
        this.f212mX = (int) (((motionPaths.f212mX + (f15 * f11)) + (f17 * f12)) - f13);
        this.f213mY = (int) (((motionPaths.f213mY + (f11 * f16)) + (f12 * f10)) - f14);
    ...
    void initAxis(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f9 = f7 - f8;
        this.mPosition = this.mTime;
        float f10 = (f5 / 2.0f) + motionPaths.f212mX;
        float f11 = motionPaths.f213mY + (f8 / 2.0f);
        float f12 = f;
        float f13 = motionPaths2.f212mX + (f4 / 2.0f);
        float f14 = motionPaths2.f213mY + (f7 / 2.0f);
        if (f10 > f13) {
            f10 = f13;
            f13 = f10;
        }
        ...
        this.f212mX = (int) ((r13 + (f15 * f12)) - f17);
        float f18 = (f9 * f3) / 2.0f;
        this.f213mY = (int) ((r14 + (f16 * f12)) - f18);
        this.mWidth = (int) (f5 + r9);
        ...
        this.mMode = 0;
        this.f212mX = (int) (((motionPaths.f212mX + (f19 * f15)) + (f21 * f16)) - f17);
        this.f213mY = (int) (((motionPaths.f213mY + (f15 * f20)) + (f16 * f12)) - f18);
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    }
    ...
    void initPolar(int i, int i2, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (keyPosition.mPositionType == 2) {
            if (Float.isNaN(keyPosition.mPercentX)) {
                float f9 = motionPaths2.f212mX;
                float f10 = motionPaths.f212mX;
                fMin = ((f9 - f10) * f2) + f10;
            } else {
            ...
            this.f212mX = fMin;
            if (Float.isNaN(keyPosition.mPercentY)) {
                float f11 = motionPaths2.f213mY;
                float f12 = motionPaths.f213mY;
                f = (f2 * (f11 - f12)) + f12;
            } else {
            ...
            float f14 = motionPaths2.f212mX;
            float f15 = motionPaths.f212mX;
            this.f212mX = (f13 * (f14 - f15)) + f15;
            if (!Float.isNaN(keyPosition.mPercentY)) {
                f2 = keyPosition.mPercentY;
            }
            float f16 = motionPaths2.f213mY;
            float f17 = motionPaths.f213mY;
            this.f213mY = (f2 * (f16 - f17)) + f17;
        }
    ...
    public void setupRelative(MotionController motionController, MotionPaths motionPaths) {
        double d = ((this.f212mX + (this.mWidth / 2.0f)) - motionPaths.f212mX) - (motionPaths.mWidth / 2.0f);
        double d2 = ((this.f213mY + (this.mHeight / 2.0f)) - motionPaths.f213mY) - (motionPaths.mHeight / 2.0f);
        this.mRelativeToController = motionController;
        this.f212mX = (float) Math.hypot(d2, d);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f213mY = (float) (Math.atan2(d2, d) + 1.5707963267948966d);
        } else {
            this.f213mY = (float) Math.toRadians(this.mRelativeAngle);
        }
    }
    ...
    void initScreen(int i, int i2, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f212mX;
        float f9 = motionPaths.f213mY;
        float f10 = motionPaths2.f212mX + (f4 / 2.0f);
        float f11 = motionPaths2.f213mY + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f212mX = (int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f));
        float f13 = (f6 - f7) * f3;
        this.f213mY = (int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f));
        this.mWidth = (int) (f5 + f12);
        this.mHeight = (int) (f7 + f13);
        this.mMode = 2;
        if (!Float.isNaN(keyPosition.mPercentX)) {
            this.f212mX = (int) (keyPosition.mPercentX * (i - ((int) this.mWidth)));
        }
        if (!Float.isNaN(keyPosition.mPercentY)) {
            this.f213mY = (int) (keyPosition.mPercentY * (i2 - ((int) this.mHeight)));
        }
    ...
    void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f6 = motionPaths.f212mX;
        float f7 = motionPaths.mWidth;
        float f8 = motionPaths.f213mY;
        float f9 = motionPaths.mHeight;
        float f10 = f;
        float f11 = (motionPaths2.f212mX + (motionPaths2.mWidth / 2.0f)) - ((f7 / 2.0f) + f6);
        float f12 = (motionPaths2.f213mY + (motionPaths2.mHeight / 2.0f)) - ((f9 / 2.0f) + f8);
        float f13 = f11 * f10;
        float f14 = (f4 * f2) / 2.0f;
        this.f212mX = (int) ((f6 + f13) - f14);
        float f15 = f12 * f10;
        float f16 = (f5 * f3) / 2.0f;
        this.f213mY = (int) ((f8 + f15) - f16);
        this.mWidth = (int) (f7 + r7);
        this.mHeight = (int) (f9 + r8);
        float f17 = Float.isNaN(keyPosition.mPercentY) ? 0.0f : keyPosition.mPercentY;
        this.mMode = 1;
        float f18 = (int) ((motionPaths.f212mX + f13) - f14);
        float f19 = (int) ((motionPaths.f213mY + f15) - f16);
        this.f212mX = f18 + ((-f12) * f17);
        this.f213mY = f19 + (f11 * f17);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    }
    ...
    void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        boolean zDiff = diff(this.f212mX, motionPaths.f212mX);
        boolean zDiff2 = diff(this.f213mY, motionPaths.f213mY);
    ...
    void getCenter(double d, int[] iArr, double[] dArr, float[] fArr, int i) {
        float fSin = this.f212mX;
        float fCos = this.f213mY;
        float f = this.mWidth;
    ...
    void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.mPosition, this.f212mX, this.f213mY, this.mWidth, this.mHeight, this.mPathRotate};
        int i = 0;
        for (int i2 : iArr) {
            if (i2 < 6) {
                dArr[i] = fArr[r1];

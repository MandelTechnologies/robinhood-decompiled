...
public final class ScatterSet2<E> extends ScatterSet<E> {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128) {
                        plusAssign((ScatterSet2<E>) objArr[(i << 3) + i3]);
                    }
                    j >>= 8;
                }
                if (i2 != 8) {
    ...
    public /* synthetic */ ScatterSet2(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? 6 : i);
    }
        ...
        while (i6 != i) {
            ...
            if (j4 != 128 && j4 == 254) {
                ...
                if (((iFindFirstAvailableSlot - i10) & i) / 8 == ((i6 - i10) & i) / 8) {
                    jArr[i7] = ((r7 & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) << i8) | ((~(255 << i8)) & jArr[i7]);
                    ...
                    if (((j5 >> i13) & 255) == 128) {
                        j = j3;
                        jArr[i12] = ((r7 & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) << i13) | (j5 & (~(255 << i13)));
    ...
    */
    ...
    public final void minusAssign(Iterable<? extends E> elements) {
        ...
        while (it.hasNext()) {
            minusAssign((ScatterSet2<E>) it.next());
        }
    }
    ...
    public final void plusAssign(Iterable<? extends E> elements) {
        ...
        Iterator<? extends E> it = elements.iterator();
        while (it.hasNext()) {
            plusAssign((ScatterSet2<E>) it.next());
        }
    }
}

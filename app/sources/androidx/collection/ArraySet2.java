...
public final class ArraySet2 {
    public static final <E> int binarySearchInternal(ArraySet<E> arraySet, int i) {
        ...
        try {
            return ContainerHelpers.binarySearch(arraySet.getHashes(), arraySet.get_size$collection(), i);

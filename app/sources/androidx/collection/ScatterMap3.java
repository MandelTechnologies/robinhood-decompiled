...
@Metadata(m3635d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\"\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\u001e\n\u0002\b\u0002\n\u0002\u0010(\n\u0000\b\u0002\u0018\u0000*\u0004\b\u0000\u0010\u0001*\u0004\b\u0001\u0010\u00022\b\u0012\u0004\u0012\u0002H\u00010\u0003B\u0019\u0012\u0012\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00028\u00010\u0005¢\u0006\u0002\u0010\u0006J\u0016\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00028\u0000H\u0096\u0002¢\u0006\u0002\u0010\u000eJ\u0016\u0010\u000f\u001a\u00020\f2\f\u0010\u0010\u001a\b\u0012\u0004\u0012\u00028\u00000\u0011H\u0016J\b\u0010\u0012\u001a\u00020\fH\u0016J\u000f\u0010\u0013\u001a\b\u0012\u0004\u0012\u00028\u00000\u0014H\u0096\u0002R\u001a\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00028\u0000\u0012\u0004\u0012\u00028\u00010\u0005X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0007\u001a\u00020\b8VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\t\u0010\n¨\u0006\u0015"}, m3636d2 = {"Landroidx/collection/Keys;", "K", "V", "", "parent", "Landroidx/collection/ScatterMap;", "(Landroidx/collection/ScatterMap;)V", "size", "", "getSize", "()I", "contains", "", "element", "(Ljava/lang/Object;)Z", "containsAll", "elements", "", "isEmpty", "iterator", "", "collection"}, m3637k = 1, m3638mv = {1, 9, 0}, m3640xi = 48)
@SourceDebugExtension
/* renamed from: androidx.collection.Keys, reason: use source file name */
/* loaded from: classes4.dex */
final class ScatterMap3<K, V> implements Set<K>, KMarkers {
    ...
    public ScatterMap3(ScatterMap<K, V> parent) {
    ...
    @DebugMetadata(m3644c = "androidx.collection.Keys$iterator$1", m3645f = "ScatterMap.kt", m3646l = {1431}, m3647m = "invokeSuspend")
    @SourceDebugExtension
    /* renamed from: androidx.collection.Keys$iterator$1 */
    static final class C09241 extends ContinuationImpl5 implements Function2<SequenceBuilder2<? super K>, Continuation<? super Unit>, Object> {
        int I$0;
        int I$1;
        int I$2;
        int I$3;
        ...
        Object L$2;
        int label;
        final /* synthetic */ ScatterMap3<K, V> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C09241(ScatterMap3<K, V> scatterMap3, Continuation<? super C09241> continuation) {
            super(2, continuation);
            this.this$0 = scatterMap3;
        }
        ...
        public final Object invoke(SequenceBuilder2<? super K> sequenceBuilder2, Continuation<? super Unit> continuation) {
            return ((C09241) create(sequenceBuilder2, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final Object invokeSuspend(Object obj) {
            ...
            if (i2 == 0) {
                ...
                ScatterMap scatterMap = ((ScatterMap3) this.this$0).parent;
    ...
    public Iterator<K> iterator() {
        return SequencesKt.iterator(new C09241(this, null));
    }

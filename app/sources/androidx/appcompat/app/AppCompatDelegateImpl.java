    ...
    */
    ...
    public View createView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (this.mAppCompatViewInflater == null) {
            TypedArray typedArrayObtainStyledAttributes = this.mContext.obtainStyledAttributes(R$styleable.AppCompatTheme);
            String string2 = typedArrayObtainStyledAttributes.getString(R$styleable.AppCompatTheme_viewInflaterClass);
            typedArrayObtainStyledAttributes.recycle();
            if (string2 == null) {
                this.mAppCompatViewInflater = new AppCompatViewInflater();
            } else {
                try {
                    this.mAppCompatViewInflater = (AppCompatViewInflater) this.mContext.getClassLoader().loadClass(string2).getDeclaredConstructor(null).newInstance(null);
                } catch (Throwable th) {
    ...
    */
    ...
    static class Api33Impl {
        static OnBackInvokedCallback registerOnBackPressedCallback(Object obj, final AppCompatDelegateImpl appCompatDelegateImpl) {
            ...
            C0670xf5eeb9ba.m16m(obj).registerOnBackInvokedCallback(InvestFlowConstants.MAX_ONE_TIME_AMOUNT, onBackInvokedCallback);
            return onBackInvokedCallback;
        }

        static void unregisterOnBackInvokedCallback(Object obj, Object obj2) {
            C0670xf5eeb9ba.m16m(obj).unregisterOnBackInvokedCallback(C0669xf5eeb9b9.m15m(obj2));
        }

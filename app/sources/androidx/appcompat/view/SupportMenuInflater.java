...
public class SupportMenuInflater extends MenuInflater {
            ...
            if (eventType != 2) {
                if (eventType == 3) {
                    ...
                    if (z2 && name2.equals(str)) {
                        z2 = false;
                        str = null;
                    } else if (name2.equals(MobileLinkingDeeplinkConstants.group_id_param)) {
                        menuState.resetGroup();
                    } else if (name2.equals(OptionsPortfolioRiskAnalyzerTopNavRowComposable.TEST_TAG_NAV_ROW_ITEM)) {
                ...
                if (name3.equals(MobileLinkingDeeplinkConstants.group_id_param)) {
                    menuState.readGroup(attributeSet);
                } else if (name3.equals(OptionsPortfolioRiskAnalyzerTopNavRowComposable.TEST_TAG_NAV_ROW_ITEM)) {
    ...
    private class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            this.itemCategoryOrder = (tintTypedArrayObtainStyledAttributes.getInt(R$styleable.MenuItem_android_menuCategory, this.groupCategory) & (-65536)) | (tintTypedArrayObtainStyledAttributes.getInt(R$styleable.MenuItem_android_orderInCategory, this.groupOrder) & Blake2xsDigest.UNKNOWN_DIGEST_LENGTH);
            ...
            String string2 = tintTypedArrayObtainStyledAttributes.getString(R$styleable.MenuItem_actionProviderClass);
            this.itemActionProviderClassName = string2;
            boolean z = string2 != null;
            if (z && this.itemActionViewLayout == 0 && this.itemActionViewClassName == null) {
                this.itemActionProvider = (ActionProvider) newInstance(string2, SupportMenuInflater.ACTION_PROVIDER_CONSTRUCTOR_SIGNATURE, SupportMenuInflater.this.mActionProviderConstructorArguments);
            } else {
                if (z) {

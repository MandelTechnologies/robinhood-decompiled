    ...
    */
        ...
        if (!shouldLayout(this.mNavButtonView)) {
            ...
            if (z3) {
                ...
                if (zShouldLayout) {
                    ...
                    z2 = z3;
                    measuredHeight = ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + this.mTitleTextView.getMeasuredHeight();
                }
                if (!zShouldLayout2) {
                ...
                if (!zShouldLayout || zShouldLayout2) {
                    ...
                    if (z2) {
                        ...
                        if (zShouldLayout2) {
                            ...
                            this.mSubtitleTextView.layout(iMin2 - this.mSubtitleTextView.getMeasuredWidth(), i23, iMin2, this.mSubtitleTextView.getMeasuredHeight() + i23);
                ...
                if (i13 >= iLayoutChildLeft2) {
                    iLayoutChildLeft2 = i26 > iMin2 ? i13 - (i26 - iMin2) : i13;
                }
    ...
    static class Api33Impl {
        static void tryRegisterOnBackInvokedCallback(Object obj, Object obj2) {
            ((OnBackInvokedDispatcher) obj).registerOnBackInvokedCallback(InvestFlowConstants.MAX_ONE_TIME_AMOUNT, (OnBackInvokedCallback) obj2);
        }

...
class AppCompatTextHelper {
    ...
    void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        if (resourceId != -1) {
            ...
            string3 = tintTypedArrayObtainStyledAttributes2.hasValue(R$styleable.TextAppearance_textLocale) ? tintTypedArrayObtainStyledAttributes2.getString(R$styleable.TextAppearance_textLocale) : null;
            string2 = (i2 < 26 || !tintTypedArrayObtainStyledAttributes2.hasValue(R$styleable.TextAppearance_fontVariationSettings)) ? null : tintTypedArrayObtainStyledAttributes2.getString(R$styleable.TextAppearance_fontVariationSettings);
        ...
        if (tintTypedArrayObtainStyledAttributes3.hasValue(R$styleable.TextAppearance_textLocale)) {
            string3 = tintTypedArrayObtainStyledAttributes3.getString(R$styleable.TextAppearance_textLocale);
        }
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray tintTypedArray) {
        ...
        if (tintTypedArray.hasValue(R$styleable.TextAppearance_android_fontFamily) || tintTypedArray.hasValue(R$styleable.TextAppearance_fontFamily)) {
            ...
            if (this.mFontTypeface != null || (string2 = tintTypedArray.getString(i)) == null) {
                return;
            }
    ...
    void onSetTextAppearance(Context context, int i) {
        ...
        if (i2 >= 26 && tintTypedArrayObtainStyledAttributes.hasValue(R$styleable.TextAppearance_fontVariationSettings) && (string2 = tintTypedArrayObtainStyledAttributes.getString(R$styleable.TextAppearance_fontVariationSettings)) != null) {
            Api26Impl.setFontVariationSettings(this.mView, string2);
        }
        tintTypedArrayObtainStyledAttributes.recycle();
        Typeface typeface = this.mFontTypeface;

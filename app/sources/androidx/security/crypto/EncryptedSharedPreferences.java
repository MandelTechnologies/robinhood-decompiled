...
public final class EncryptedSharedPreferences implements SharedPreferences {
    ...
    public static SharedPreferences create(String str, String str2, Context context, PrefKeyEncryptionScheme prefKeyEncryptionScheme, PrefValueEncryptionScheme prefValueEncryptionScheme) throws GeneralSecurityException, IOException {
        ...
        AeadConfig.register();
        KeysetHandle keysetHandle = new AndroidKeysetManager.Builder().withKeyTemplate(prefKeyEncryptionScheme.getKeyTemplate()).withSharedPref(context, "__androidx_security_crypto_encrypted_prefs_key_keyset__", str).withMasterKeyUri("android-keystore://" + str2).build().getKeysetHandle();
        KeysetHandle keysetHandle2 = new AndroidKeysetManager.Builder().withKeyTemplate(prefValueEncryptionScheme.getKeyTemplate()).withSharedPref(context, "__androidx_security_crypto_encrypted_prefs_value_keyset__", str).withMasterKeyUri("android-keystore://" + str2).build().getKeysetHandle();
    ...
    private Object getDecryptedObject(String str) {
        ...
        try {
            ...
            String string2 = this.mSharedPreferences.getString(strEncryptKey, null);
            if (string2 != null) {
                ...
                switch (C29481.f282xe137dbc3[EncryptedType.fromId(byteBufferWrap.getInt()).ordinal()]) {
                    case 1:
                        int i = byteBufferWrap.getInt();
                        ByteBuffer byteBufferSlice = byteBufferWrap.slice();
                        byteBufferWrap.limit(i);
                        String string3 = charset.decode(byteBufferSlice).toString();
                        if (string3.equals("__NULL__")) {
                            return null;
                        }
                        return string3;
                    case 2:
    ...
    static /* synthetic */ class C29481 {
        ...
        static final /* synthetic */ int[] f282xe137dbc3;
        ...
        static {
            ...
            try {
                f282xe137dbc3[EncryptedType.INT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f282xe137dbc3[EncryptedType.LONG.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f282xe137dbc3[EncryptedType.FLOAT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f282xe137dbc3[EncryptedType.BOOLEAN.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f282xe137dbc3[EncryptedType.STRING_SET.ordinal()] = 6;

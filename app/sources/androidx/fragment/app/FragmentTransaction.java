...
public abstract class FragmentTransaction {
    ...
    static final class C2365Op {
        ...
        C2365Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C2365Op(int i, Fragment fragment, boolean z) {
            this.mCmd = i;
            this.mFragment = fragment;
        ...
        C2365Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
            this.mFromExpandedOp = false;
        ...
        C2365Op(C2365Op c2365Op) {
            this.mCmd = c2365Op.mCmd;
            this.mFragment = c2365Op.mFragment;
            this.mFromExpandedOp = c2365Op.mFromExpandedOp;
            this.mEnterAnim = c2365Op.mEnterAnim;
            this.mExitAnim = c2365Op.mExitAnim;
            this.mPopEnterAnim = c2365Op.mPopEnterAnim;
            this.mPopExitAnim = c2365Op.mPopExitAnim;
            this.mOldMaxState = c2365Op.mOldMaxState;
            this.mCurrentMaxState = c2365Op.mCurrentMaxState;
        }
    }
    ...
    FragmentTransaction(FragmentFactory fragmentFactory, ClassLoader classLoader, FragmentTransaction fragmentTransaction) {
        ...
        Iterator<C2365Op> it = fragmentTransaction.mOps.iterator();
        while (it.hasNext()) {
            this.mOps.add(new C2365Op(it.next()));
        }
    ...
    void addOp(C2365Op c2365Op) {
        this.mOps.add(c2365Op);
        c2365Op.mEnterAnim = this.mEnterAnim;
        c2365Op.mExitAnim = this.mExitAnim;
        c2365Op.mPopEnterAnim = this.mPopEnterAnim;
        c2365Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C2365Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C2365Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C2365Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C2365Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C2365Op(7, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C2365Op(10, fragment, state));
        return this;
    }

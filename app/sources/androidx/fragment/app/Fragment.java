...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public CreationExtras getDefaultViewModelCreationExtras() {
        ...
        CreationExtras2 creationExtras2 = new CreationExtras2();
        if (application != null) {
        ...
        if (getArguments() != null) {
            creationExtras2.set(SavedStateHandleSupport.DEFAULT_ARGS_KEY, getArguments());
        }
    ...
    void performCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mViewLifecycleOwner = new FragmentViewLifecycleOwner(this, getViewModelStore(), new Runnable() { // from class: androidx.fragment.app.Fragment$$ExternalSyntheticLambda0
            ...
            public final void run() {
                Fragment.m8215$r8$lambda$fb2iz_9i0AeQEy2DZBRxlwOv0g(this.f$0);
            }
        });
    ...
    /* renamed from: $r8$lambda$fb2iz_9i-0AeQEy2DZBRxlwOv0g, reason: not valid java name */
    public static /* synthetic */ void m8215$r8$lambda$fb2iz_9i0AeQEy2DZBRxlwOv0g(Fragment fragment) {

...
class NotificationCompatJellybean {
    ...
    private static Bundle toBundle(RemoteInput remoteInput) {
        ...
        bundle.putCharSequence(AnnotatedPrivateKey.LABEL, remoteInput.getLabel());
        bundle.putCharSequenceArray(InquiryField.ChoicesField.TYPE, remoteInput.getChoices());

...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = EnumC7081g.SDK_ASSET_ILLUSTRATION_CONSUMER_VALUE;
        if (!zCanScroll) {
            if (isFocused() && keyEvent.getKeyCode() != 4) {
                ...
                View viewFindNextFocus = FocusFinder.getInstance().findNextFocus(this, viewFindFocus, EnumC7081g.SDK_ASSET_ILLUSTRATION_CONSUMER_VALUE);
                if (viewFindNextFocus != null && viewFindNextFocus != this && viewFindNextFocus.requestFocus(EnumC7081g.SDK_ASSET_ILLUSTRATION_CONSUMER_VALUE)) {
                    return true;
                }
            }
            return false;
        ...
        if (keyEvent.getAction() == 0) {
            ...
            if (keyCode == 20) {
                if (keyEvent.isAltPressed()) {
                    return fullScroll(EnumC7081g.SDK_ASSET_ILLUSTRATION_CONSUMER_VALUE);
                }
                return arrowScroll(EnumC7081g.SDK_ASSET_ILLUSTRATION_CONSUMER_VALUE);
            }
            if (keyCode == 62) {
            ...
            if (keyCode == 123) {
                pageScroll(EnumC7081g.SDK_ASSET_ILLUSTRATION_CONSUMER_VALUE);
                return false;
            }
        }
        return false;
    ...
    */
    ...
    private float getSplineFlingDistance(int i) {
        ...
        return (float) (this.mPhysicalCoeff * 0.015f * Math.exp((f / (f - 1.0d)) * dLog));
    }
    ...
    */
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        if (i == 2) {
            i = EnumC7081g.SDK_ASSET_ILLUSTRATION_CONSUMER_VALUE;
        } else if (i == 1) {
            i = 33;
        }
        if (rect == null) {

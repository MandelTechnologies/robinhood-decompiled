...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mWrapped = PrecomputedTextCompat$Params$$ExternalSyntheticApiModelOutline9.m386m(textPaint).setBreakStrategy(i).setHyphenationFrequency(i2).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.mWrapped = null;
            }
            this.mPaint = textPaint;
    ...
    public PrecomputedText getPrecomputedText() {
        if (PrecomputedTextCompat$$ExternalSyntheticApiModelOutline1.m372m(this.mText)) {
            return PrecomputedTextCompat$$ExternalSyntheticApiModelOutline2.m373m(this.mText);
        }
        return null;
    }

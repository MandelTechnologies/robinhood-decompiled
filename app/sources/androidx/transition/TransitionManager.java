...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo8354clone = transition.mo8354clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo8354clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo8354clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo8354clone);
    }
    ...
    /* renamed from: go */
    public static void m672go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo8354clone = transition.mo8354clone();
        sceneChangeSetup(viewGroup, transitionMo8354clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo8354clone);
    }
    ...
    public static TransitionSeekController controlDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        transitionSet.addTransition(transitionMo8354clone);

        ...
        private void ensureAnimation() {
            ...
            this.mSpringAnimation.addEndListener(new DynamicAnimation.OnAnimationEndListener() { // from class: androidx.transition.Transition$SeekController$$ExternalSyntheticLambda0
                ...
                public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
                    Transition.SeekController.m8355$r8$lambda$nZMnxj1GJ10geefUwzLdAYk8oI(this.f$0, dynamicAnimation, z, f, f2);
                }
            });
        }

        /* renamed from: $r8$lambda$nZMnxj1GJ10-geefUwzLdAYk8oI, reason: not valid java name */
        public static /* synthetic */ void m8355$r8$lambda$nZMnxj1GJ10geefUwzLdAYk8oI(SeekController seekController, DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
            if (z) {

...
public final class BlockRunner<T> {
    ...
    public final void maybeRun() {
        ...
        this.runningJob = BuildersKt__Builders_commonKt.launch$default(this.scope, null, null, new C23821(this, null), 3, null);
    }

    /* compiled from: CoroutineLiveData.kt */
    @Metadata(m3635d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m3636d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m3637k = 3, m3638mv = {1, 8, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "androidx.lifecycle.BlockRunner$maybeRun$1", m3645f = "CoroutineLiveData.kt", m3646l = {EnumC7081g.SDK_ASSET_HEADER_FINAL_SUCCESS_DARK_APPEARANCE_VALUE}, m3647m = "invokeSuspend")
    /* renamed from: androidx.lifecycle.BlockRunner$maybeRun$1 */
    static final class C23821 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        int label;
        final /* synthetic */ BlockRunner<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C23821(BlockRunner<T> blockRunner, Continuation<? super C23821> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C23821 c23821 = new C23821(this.this$0, continuation);
            c23821.L$0 = obj;
            return c23821;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C23821) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final void cancel() {
        if (this.cancellationJob == null) {
            this.cancellationJob = BuildersKt__Builders_commonKt.launch$default(this.scope, Dispatchers.getMain().getImmediate(), null, new C23811(this, null), 2, null);
            return;
        }
    ...
    /* compiled from: CoroutineLiveData.kt */
    @Metadata(m3635d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m3636d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m3637k = 3, m3638mv = {1, 8, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "androidx.lifecycle.BlockRunner$cancel$1", m3645f = "CoroutineLiveData.kt", m3646l = {188}, m3647m = "invokeSuspend")
    /* renamed from: androidx.lifecycle.BlockRunner$cancel$1 */
    static final class C23811 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        int label;
        final /* synthetic */ BlockRunner<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C23811(BlockRunner<T> blockRunner, Continuation<? super C23811> continuation) {
            super(2, continuation);
            this.this$0 = blockRunner;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C23811(this.this$0, continuation);
        }

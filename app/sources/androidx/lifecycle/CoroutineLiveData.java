...
public final class CoroutineLiveData<T> extends MediatorLiveData<T> {
    ...
    public /* synthetic */ CoroutineLiveData(CoroutineContext coroutineContext, long j, Function2 function2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? CoroutineContextImpl6.INSTANCE : coroutineContext, (i & 2) != 0 ? 5000L : j, function2);
    }
    ...
    public CoroutineLiveData(CoroutineContext context, long j, Function2<? super LiveDataScope<T>, ? super Continuation<? super Unit>, ? extends Object> block) {
        ...
        this.blockRunner = new BlockRunner<>(this, block, j, CoroutineScope2.CoroutineScope(Dispatchers.getMain().getImmediate().plus(context).plus(Supervisor3.SupervisorJob((Job) context.get(Job.INSTANCE)))), new Function0<Unit>(this) { // from class: androidx.lifecycle.CoroutineLiveData.1
    ...
    */
    public final Object emitSource$lifecycle_livedata_release(LiveData<T> liveData, Continuation<? super Job4> continuation) {

...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable {
    ...
    public static AnimatedVectorDrawableCompat create(Context context, int i) throws Resources.NotFoundException {
            ...
            if (eventType == 2) {
                ...
                if ("animated-vector".equals(name)) {
                    ...
                    if (resourceId2 != 0) {
                        ...
                        if (context != null) {
                            setupAnimatorsForTarget(string2, AnimatorInflaterCompat.loadAnimator(context, resourceId2));
                        } else {

    ...
    public DropDownPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mItemSelectedListener = new AdapterView.OnItemSelectedListener() { // from class: androidx.preference.DropDownPreference.1
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i3, long j) {
                if (i3 >= 0) {
                    String string2 = DropDownPreference.this.getEntryValues()[i3].toString();
                    if (string2.equals(DropDownPreference.this.getValue()) || !DropDownPreference.this.callChangeListener(string2)) {
                        return;
                    }
                    DropDownPreference.this.setValue(string2);
                }
            }
        };

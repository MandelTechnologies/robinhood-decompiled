...
public abstract class DialogPreference extends Preference {
    ...
    public DialogPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        String string2 = TypedArrayUtils.getString(typedArrayObtainStyledAttributes, R$styleable.DialogPreference_dialogTitle, R$styleable.DialogPreference_android_dialogTitle);

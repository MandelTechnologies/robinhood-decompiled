...
import androidx.core.util.Pools3;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    private static final Pools<Rect> sRectPool;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i19 < size3) {
            ...
            if (view2.getVisibility() == 8) {
                ...
                int i21 = layoutParams.keyline;
                if (i21 < 0 || mode == 0) {
                    i3 = suggestedMinimumHeight;
                } else {
                    int keyline = coordinatorLayout.getKeyline(i21);
                    ...
                    if (behavior == null) {
                        ...
                        boolean zOnMeasureChild = behavior.onMeasureChild(this, view, i23, i5, i25, 0);
                        i14 = i23;
                        i10 = i5;
                        i13 = i25;
                        if (zOnMeasureChild) {
                        ...
                        suggestedMinimumWidth = Math.max(i12, i17 + view.getMeasuredWidth() + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin);
                        int iMax2 = Math.max(i8, i18 + view.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin);
                    ...
                    View view3 = view;
                    coordinatorLayout = this;
                    coordinatorLayout.onMeasureChild(view3, i14, i10, i13, 0);
                    view = view3;
                    suggestedMinimumWidth = Math.max(i12, i17 + view.getMeasuredWidth() + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin);
                    int iMax22 = Math.max(i8, i18 + view.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin);
                    iCombineMeasuredStates = View.combineMeasuredStates(i16, view.getMeasuredState());
                ...
                if (z2) {
                    ...
                    View view32 = view;
                    coordinatorLayout = this;
                    coordinatorLayout.onMeasureChild(view32, i14, i10, i13, 0);
                    view = view32;
                    suggestedMinimumWidth = Math.max(i12, i17 + view.getMeasuredWidth() + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin);
                    int iMax222 = Math.max(i8, i18 + view.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin);
                    iCombineMeasuredStates = View.combineMeasuredStates(i16, view.getMeasuredState());

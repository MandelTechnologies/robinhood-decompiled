...
class MeteringRepeatingSession {
    ...
    MeteringRepeatingSession(CameraCharacteristicsCompat cameraCharacteristicsCompat, DisplayInfoManager displayInfoManager, SurfaceResetCallback surfaceResetCallback) {
        ...
        Logger.m45d("MeteringRepeating", "MeteringSession SurfaceTexture size: " + properPreviewSize);
    ...
    SessionConfig createSessionConfig() {
        ...
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.camera2.internal.MeteringRepeatingSession$$ExternalSyntheticLambda0
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                MeteringRepeatingSession.m4621$r8$lambda$Nwtqt4p7yiGcU_qDVTPLkN9ni8(this.f$0, sessionConfig, sessionError);
            }
        });
    ...
    /* renamed from: $r8$lambda$Nwtqt4p7y-iGcU_qDVTPLkN9ni8, reason: not valid java name */
    public static /* synthetic */ void m4621$r8$lambda$Nwtqt4p7yiGcU_qDVTPLkN9ni8(MeteringRepeatingSession meteringRepeatingSession, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
    ...
    void clear() {
        Logger.m45d("MeteringRepeating", "MeteringRepeating clear!");
    ...
    private Size getProperPreviewSize(CameraCharacteristicsCompat cameraCharacteristicsCompat, DisplayInfoManager displayInfoManager) {
        ...
        if (outputSizes == null) {
            Logger.m47e("MeteringRepeating", "Can not get output size list.");
            return new Size(0, 0);
        }

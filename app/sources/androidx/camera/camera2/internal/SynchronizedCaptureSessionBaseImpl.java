...
class SynchronizedCaptureSessionBaseImpl extends SynchronizedCaptureSession.StateCallback implements SynchronizedCaptureSession, SynchronizedCaptureSession.Opener {
    ...
    public ListenableFuture<Void> openCaptureSession(CameraDevice cameraDevice, final SessionConfigurationCompat sessionConfigurationCompat, final List<DeferrableSurface> list) {
        synchronized (this.mLock) {
            try {
                ...
                ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda4
            ...
            try {
                ...
                FutureChain futureChainTransformAsync = FutureChain.from(DeferrableSurfaces.surfaceListWithTimeout(list, false, j, getExecutor(), this.mScheduledExecutorService)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda1
                    ...
                    public final ListenableFuture apply(Object obj) {
                        return SynchronizedCaptureSessionBaseImpl.m4627$r8$lambda$aopvf1kQ2K0e9IHBo0tv6mKpkk(this.f$0, list, (List) obj);
                    }
                }, getExecutor());
    ...
    public static /* synthetic */ ListenableFuture m4627$r8$lambda$aopvf1kQ2K0e9IHBo0tv6mKpkk(SynchronizedCaptureSessionBaseImpl synchronizedCaptureSessionBaseImpl, List list, List list2) {
        synchronizedCaptureSessionBaseImpl.getClass();
        Logger.m45d("SyncCaptureSessionBase", "[" + synchronizedCaptureSessionBaseImpl + "] getSurface done with results: " + list2);
        if (list2.isEmpty()) {
    ...
    public void close() {
        ...
        getExecutor().execute(new Runnable() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda3
            ...
            public final void run() {
                ...
                synchronizedCaptureSessionBaseImpl.m4628$r8$lambda$dP3DguhPXTXPVRCgeBvlk8lcbs(synchronizedCaptureSessionBaseImpl);
            }
        });
    }
    ...
    public static /* synthetic */ void $r8$lambda$AW8dnIDzjDAI10RRH0EHT52a0kI(SynchronizedCaptureSessionBaseImpl synchronizedCaptureSessionBaseImpl, SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        synchronizedCaptureSessionBaseImpl.m4628$r8$lambda$dP3DguhPXTXPVRCgeBvlk8lcbs(synchronizedCaptureSession);
        ...
        Logger.m50w("SyncCaptureSessionBase", "[" + synchronizedCaptureSessionBaseImpl + "] Cannot call onClosed() when the CameraCaptureSession is not correctly configured.");
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // androidx.camera.camera2.internal.SynchronizedCaptureSession.StateCallback
    /* renamed from: onSessionFinished, reason: merged with bridge method [inline-methods] */
    public void m4628$r8$lambda$dP3DguhPXTXPVRCgeBvlk8lcbs(final SynchronizedCaptureSession synchronizedCaptureSession) {
        ListenableFuture<Void> listenableFuture;
        synchronized (this.mLock) {
            try {
        ...
        if (listenableFuture != null) {
            listenableFuture.addListener(new Runnable() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    SynchronizedCaptureSessionBaseImpl.m4626$r8$lambda$ZNWc4mXlAbAd0_P_G2IriBPS9w(this.f$0, synchronizedCaptureSession);
                }
            }, CameraXExecutors.directExecutor());
        }
    }
    ...
    public static /* synthetic */ void m4626$r8$lambda$ZNWc4mXlAbAd0_P_G2IriBPS9w(SynchronizedCaptureSessionBaseImpl synchronizedCaptureSessionBaseImpl, SynchronizedCaptureSession synchronizedCaptureSession) {
        Objects.requireNonNull(synchronizedCaptureSessionBaseImpl.mCaptureSessionStateCallback);
        synchronizedCaptureSessionBaseImpl.mCaptureSessionStateCallback.m4628$r8$lambda$dP3DguhPXTXPVRCgeBvlk8lcbs(synchronizedCaptureSession);
    }

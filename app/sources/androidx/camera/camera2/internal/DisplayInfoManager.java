...
public class DisplayInfoManager {
    ...
    private static final Size ABNORMAL_DISPLAY_SIZE_THRESHOLD = new Size(EnumC7081g.SDK_ASSET_ILLUSTRATION_ALERT_WARNING_YELLOW_VALUE, EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_CIRCLE_VALUE);
    private static final Size FALLBACK_DISPLAY_SIZE = new Size(OptionsSimulatedReturnUtils.SMALL_DEVICE_HEIGHT_FOR_OPTIONS_SIMULATED_RETURNS, 480);

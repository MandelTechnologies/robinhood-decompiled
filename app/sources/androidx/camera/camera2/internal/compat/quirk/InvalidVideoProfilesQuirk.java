...
public class InvalidVideoProfilesQuirk implements Quirk {
    ...
    private static boolean isAffectedSamsungDevices() {
        return Constants.REFERRER_API_SAMSUNG.equalsIgnoreCase(Build.BRAND) && isTp1aBuild();
    }
    ...
    private static boolean isAffectedXiaomiDevices() {
        ...
        if ("redmi".equalsIgnoreCase(str) || Constants.REFERRER_API_XIAOMI.equalsIgnoreCase(str)) {

...
final class ZslControlImpl implements ZslControl {
    ...
    public void addZslConfig(SessionConfig.Builder builder) {
        ...
        metadataImageReader.setOnImageAvailableListener(new ImageReaderProxy.OnImageAvailableListener() { // from class: androidx.camera.camera2.internal.ZslControlImpl$$ExternalSyntheticLambda1
            @Override // androidx.camera.core.impl.ImageReaderProxy.OnImageAvailableListener
            public final void onImageAvailable(ImageReaderProxy imageReaderProxy) {
                ZslControlImpl.m4632$r8$lambda$DWtbvQJcPnwukrjJURUrZE16Y0(this.f$0, imageReaderProxy);
            }
    ...
    /* renamed from: $r8$lambda$DWtbvQJ-cPnwukrjJURUrZE16Y0, reason: not valid java name */
    public static /* synthetic */ void m4632$r8$lambda$DWtbvQJcPnwukrjJURUrZE16Y0(ZslControlImpl zslControlImpl, ImageReaderProxy imageReaderProxy) {
        ...
        try {
            ...
            Logger.m47e("ZslControlImpl", "Failed to acquire latest image IllegalStateException = " + e.getMessage());
        }
    }
    ...
    public ImageProxy dequeueImageFromBuffer() {
        try {
            ...
            Logger.m47e("ZslControlImpl", "dequeueImageFromBuffer no such element");
            return null;
        }
    }
    ...
    public boolean enqueueImageToImageWriter(ImageProxy imageProxy) {
        ...
        if (imageWriter != null && image != null) {
            try {
                ...
                Logger.m47e("ZslControlImpl", "enqueueImageToImageWriter throws IllegalStateException = " + e.getMessage());
            }
        }
        return false;
    }
    ...
    private void cleanup() {
        ...
        if (deferrableSurface != null) {
            ...
            if (safeCloseImageReaderProxy != null) {
                deferrableSurface.getTerminationFuture().addListener(new ZslControlImpl$$ExternalSyntheticLambda2(safeCloseImageReaderProxy), CameraXExecutors.mainThreadExecutor());
    ...
    private Map<Integer, Size> createReprocessingInputSizeMap(CameraCharacteristicsCompat cameraCharacteristicsCompat) {
        ...
        try {
            ...
            Logger.m47e("ZslControlImpl", "Failed to retrieve StreamConfigurationMap, error = " + e.getMessage());

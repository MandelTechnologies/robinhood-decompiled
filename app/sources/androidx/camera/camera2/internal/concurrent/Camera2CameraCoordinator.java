...
public class Camera2CameraCoordinator implements CameraCoordinator {
    ...
    private void retrieveConcurrentCameraIds() {
        ...
        try {
            ...
            Logger.m47e("Camera2CameraCoordinator", "Failed to get concurrent camera ids");
        }
        ...
        while (it.hasNext()) {
            ...
            if (arrayList.size() >= 2) {
                ...
                try {
                    ...
                    Logger.m45d("Camera2CameraCoordinator", "Concurrent camera id pair: (" + str + ", " + str2 + ") is not backward compatible");
                }
            }
        }
    }

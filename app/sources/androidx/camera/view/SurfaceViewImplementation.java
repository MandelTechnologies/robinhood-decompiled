...
final class SurfaceViewImplementation extends PreviewViewImplementation {
    ...
    void onSurfaceRequested(final SurfaceRequest surfaceRequest, final PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
        ...
        this.mSurfaceView.post(new Runnable() { // from class: androidx.camera.view.SurfaceViewImplementation$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.mSurfaceRequestCallback.setSurfaceRequest(surfaceRequest, onSurfaceNotInUseListener);
            }
        });
    }
    ...
    Bitmap getPreviewBitmap() {
        ...
        Api24Impl.pixelCopyRequest(this.mSurfaceView, bitmapCreateBitmap, new PixelCopy.OnPixelCopyFinishedListener() { // from class: androidx.camera.view.SurfaceViewImplementation$$ExternalSyntheticLambda2
            ...
            public final void onPixelCopyFinished(int i) {
                SurfaceViewImplementation.$r8$lambda$mYU6bWN5vd8zZ0WkrbcW8AqJhSM(semaphore, i);
            }
        }, new Handler(handlerThread.getLooper()));
        try {
            if (!semaphore.tryAcquire(1, 100L, TimeUnit.MILLISECONDS)) {
                Logger.m47e("SurfaceViewImpl", "Timed out while trying to acquire screenshot.");
            }
            return bitmapCreateBitmap;
        } catch (InterruptedException e) {
            Logger.m48e("SurfaceViewImpl", "Interrupted while trying to acquire screenshot.", e);
            return bitmapCreateBitmap;
        } finally {
    ...
    public static /* synthetic */ void $r8$lambda$mYU6bWN5vd8zZ0WkrbcW8AqJhSM(Semaphore semaphore, int i) {
        if (i == 0) {
            Logger.m45d("SurfaceViewImpl", "PreviewView.SurfaceViewImplementation.getBitmap() succeeded");
        } else {
            Logger.m47e("SurfaceViewImpl", "PreviewView.SurfaceViewImplementation.getBitmap() failed with error " + i);
        }
        semaphore.release();
    }
    ...
    class SurfaceRequestCallback implements SurfaceHolder.Callback {
        ...
        public void setSurfaceRequest(SurfaceRequest surfaceRequest, PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
            ...
            Logger.m45d("SurfaceViewImpl", "Wait for new Surface creation.");
        ...
        private boolean tryToComplete() throws ExecutionException, InterruptedException {
            ...
            Logger.m45d("SurfaceViewImpl", "Surface set on Preview.");
            ...
            surfaceRequest.provideSurface(surface, ContextCompat.getMainExecutor(SurfaceViewImplementation.this.mSurfaceView.getContext()), new Consumer() { // from class: androidx.camera.view.SurfaceViewImplementation$SurfaceRequestCallback$$ExternalSyntheticLambda0
                @Override // androidx.core.util.Consumer
                public final void accept(Object obj) {
                    SurfaceViewImplementation.SurfaceRequestCallback.$r8$lambda$qY0Ap9oRtzQ8nnf13K7KZG2k3gw(onSurfaceNotInUseListener, (SurfaceRequest.Result) obj);
                }
            });
        ...
        public static /* synthetic */ void $r8$lambda$qY0Ap9oRtzQ8nnf13K7KZG2k3gw(PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener, SurfaceRequest.Result result) {
            Logger.m45d("SurfaceViewImpl", "Safe to release surface.");
            if (onSurfaceNotInUseListener != null) {
                onSurfaceNotInUseListener.onSurfaceNotInUse();
            }
        }
        ...
        private void cancelPreviousRequest() {
            if (this.mSurfaceRequest != null) {
                Logger.m45d("SurfaceViewImpl", "Request canceled: " + this.mSurfaceRequest);
        ...
        private void closeSurface() {
            if (this.mSurfaceRequest != null) {
                Logger.m45d("SurfaceViewImpl", "Surface closed " + this.mSurfaceRequest);
        ...
        public void surfaceCreated(SurfaceHolder surfaceHolder) {
            ...
            Logger.m45d("SurfaceViewImpl", "Surface created.");
        ...
        public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) throws ExecutionException, InterruptedException {
            Logger.m45d("SurfaceViewImpl", "Surface changed. Size: " + i2 + "x" + i3);
        ...
        public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
            Logger.m45d("SurfaceViewImpl", "Surface destroyed.");

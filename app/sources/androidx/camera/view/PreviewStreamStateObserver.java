...
final class PreviewStreamStateObserver implements Observable.Observer<CameraInternal.State> {
    ...
    private void startPreviewStreamStateFlow(final CameraInfo cameraInfo) {
        ...
        FutureChain futureChainTransform = FutureChain.from(waitForCaptureResult(cameraInfo, arrayList)).transformAsync(new AsyncFunction() { // from class: androidx.camera.view.PreviewStreamStateObserver$$ExternalSyntheticLambda0
            ...
            public final Object apply(Object obj) {
                return PreviewStreamStateObserver.$r8$lambda$mRCR3n9n6NCShC3l_tM_tx5ZigI(this.f$0, (Void) obj);
            }
    ...
    public static /* synthetic */ Void $r8$lambda$mRCR3n9n6NCShC3l_tM_tx5ZigI(PreviewStreamStateObserver previewStreamStateObserver, Void r1) {
    ...
    void updatePreviewStreamState(PreviewView.StreamState streamState) {
        synchronized (this) {
            try {
                ...
                Logger.m45d("StreamStateObserver", "Update Preview stream state to " + streamState);
    ...
    private ListenableFuture<Void> waitForCaptureResult(final CameraInfo cameraInfo, final List<CameraCaptureCallback> list) {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.PreviewStreamStateObserver$$ExternalSyntheticLambda2
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return PreviewStreamStateObserver.m4730$r8$lambda$4rYVnyOebtA2qaN65AI53oRkdY(this.f$0, cameraInfo, list, completer);
            }
        });
    }

    /* renamed from: $r8$lambda$4rYVnyOebtA-2qaN65AI53oRkdY, reason: not valid java name */
    public static /* synthetic */ Object m4730$r8$lambda$4rYVnyOebtA2qaN65AI53oRkdY(PreviewStreamStateObserver previewStreamStateObserver, final CameraInfo cameraInfo, List list, final CallbackToFutureAdapter.Completer completer) {
        previewStreamStateObserver.getClass();

...
class InputBufferImpl implements InputBuffer {
    ...
    InputBufferImpl(MediaCodec mediaCodec, int i) throws MediaCodec.CodecException {
        ...
        this.mTerminationFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.internal.encoder.InputBufferImpl$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return InputBufferImpl.m4729$r8$lambda$eInTYqtZ8fzSXhIp4uswMKYH0w(atomicReference, completer);
            }
        });
    ...
    /* renamed from: $r8$lambda$eInTY-qtZ8fzSXhIp4uswMKYH0w, reason: not valid java name */
    public static /* synthetic */ Object m4729$r8$lambda$eInTYqtZ8fzSXhIp4uswMKYH0w(AtomicReference atomicReference, CallbackToFutureAdapter.Completer completer) {
    ...
    @Override // androidx.camera.video.internal.encoder.InputBuffer
    public boolean submit() throws MediaCodec.CryptoException {
    ...
    @Override // androidx.camera.video.internal.encoder.InputBuffer
    public boolean cancel() throws MediaCodec.CryptoException {
        if (this.mTerminated.getAndSet(true)) {
            return false;
        }
        try {

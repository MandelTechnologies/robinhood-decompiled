...
abstract class ImageAnalysisAbstractAnalyzer implements ImageReaderProxy.OnImageAvailableListener {
    ...
    public void onImageAvailable(ImageReaderProxy imageReaderProxy) {
        try {
            ...
            Logger.m48e("ImageAnalysisAnalyzer", "Failed to acquire image.", e);
        }
    }
        ...
        if (analyzer != null && executor != null && this.mIsAttached) {
            ...
            return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.ImageAnalysisAbstractAnalyzer$$ExternalSyntheticLambda0
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return ImageAnalysisAbstractAnalyzer.m4645$r8$lambda$s0c1uFXInd1pEix49icy8s9LKs(this.f$0, executor, imageProxy, matrix, imageProxy3, rect, analyzer, completer);
                }
            });
        }
    ...
    /* renamed from: $r8$lambda$s0c1uFXInd1pEix49icy8s9-LKs, reason: not valid java name */
    public static /* synthetic */ Object m4645$r8$lambda$s0c1uFXInd1pEix49icy8s9LKs(final ImageAnalysisAbstractAnalyzer imageAnalysisAbstractAnalyzer, Executor executor, final ImageProxy imageProxy, final Matrix matrix, final ImageProxy imageProxy2, final Rect rect, final ImageAnalysis.Analyzer analyzer, final CallbackToFutureAdapter.Completer completer) {
        ...
        executor.execute(new Runnable() { // from class: androidx.camera.core.ImageAnalysisAbstractAnalyzer$$ExternalSyntheticLambda1
            ...
            public final void run() {
                ImageAnalysisAbstractAnalyzer.$r8$lambda$hKxGgEqBDenifPrymc_vpduQY18(this.f$0, imageProxy, matrix, imageProxy2, rect, analyzer, completer);
            }
        });
        return "analyzeImage";
    }

    public static /* synthetic */ void $r8$lambda$hKxGgEqBDenifPrymc_vpduQY18(ImageAnalysisAbstractAnalyzer imageAnalysisAbstractAnalyzer, ImageProxy imageProxy, Matrix matrix, ImageProxy imageProxy2, Rect rect, ImageAnalysis.Analyzer analyzer, CallbackToFutureAdapter.Completer completer) {

...
public final class GLUtils {
    ...
    static {
        ...
        NO_OUTPUT_SURFACE = OutputSurface.m76of(EGL14.EGL_NO_SURFACE, 0, 0);
    }
    ...
    public static int loadShader(int i, String str) {
        ...
        Logger.m50w("GLUtils", "Could not compile shader: " + str);
    ...
    public static void checkEglErrorOrLog(String str) {
        try {
            ...
            Logger.m48e("GLUtils", e.toString(), e);
        }
    }
    ...
    public static int[] chooseSurfaceAttrib(String str, DynamicRange dynamicRange) {
        ...
        if (dynamicRange.getEncoding() == 3) {
            ...
            Logger.m50w("GLUtils", "Dynamic range uses HLG encoding, but device does not support EGL_EXT_gl_colorspace_bt2020_hlg.Fallback to default colorspace.");
        }
        return iArr;
    }

...
public class SurfaceEdge {
    ...
    public SurfaceRequest createSurfaceRequest(CameraInternal cameraInternal, boolean z) {
        Threads.checkMainThread();
        checkNotClosed();
        SurfaceRequest surfaceRequest = new SurfaceRequest(this.mStreamSpec.getResolution(), cameraInternal, z, this.mStreamSpec.getDynamicRange(), this.mStreamSpec.getExpectedFrameRateRange(), new Runnable() { // from class: androidx.camera.core.processing.SurfaceEdge$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceEdge.m4676$r8$lambda$OUGeMRYPeF_WOgV3sPeeq2_z7c(this.f$0);
            }
        });
        try {
    ...
    /* renamed from: $r8$lambda$OUGeMRYPeF_WOgV3sPe-eq2_z7c, reason: not valid java name */
    public static /* synthetic */ void m4676$r8$lambda$OUGeMRYPeF_WOgV3sPeeq2_z7c(final SurfaceEdge surfaceEdge) {
        ...
        CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.processing.SurfaceEdge$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceEdge.m4677$r8$lambda$QHdR7T3HmMsEDLpEkRmCFFpf4(this.f$0);
            }
        });
    }

    /* renamed from: $r8$lambda$QHdR7T3HmMsEDLpE-k-RmCFFpf4, reason: not valid java name */
    public static /* synthetic */ void m4677$r8$lambda$QHdR7T3HmMsEDLpEkRmCFFpf4(SurfaceEdge surfaceEdge) {
    ...
    private void notifyTransformationInfoUpdate() {
        Threads.checkMainThread();
        SurfaceRequest.TransformationInfo transformationInfoM55of = SurfaceRequest.TransformationInfo.m55of(this.mCropRect, this.mRotationDegrees, this.mTargetRotation, hasCameraTransform(), this.mSensorToBufferTransform, this.mMirroring);
        SurfaceRequest surfaceRequest = this.mProviderSurfaceRequest;
        if (surfaceRequest != null) {
            surfaceRequest.updateTransformationInfo(transformationInfoM55of);
        }
        Iterator<Consumer<SurfaceRequest.TransformationInfo>> it = this.mTransformationUpdatesListeners.iterator();
        while (it.hasNext()) {
            it.next().accept(transformationInfoM55of);
        }
    }
    ...
    static class SettableSurface extends DeferrableSurface {
        ...
        /* renamed from: $r8$lambda$VdiGildDqQ-QQLDZiSabHKVcb7o, reason: not valid java name */
        public static /* synthetic */ Object m4679$r8$lambda$VdiGildDqQQQLDZiSabHKVcb7o(SettableSurface settableSurface, CallbackToFutureAdapter.Completer completer) {
        ...
        SettableSurface(Size size, int i) {
            ...
            this.mSurfaceFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.processing.SurfaceEdge$SettableSurface$$ExternalSyntheticLambda1
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return SurfaceEdge.SettableSurface.m4679$r8$lambda$VdiGildDqQQQLDZiSabHKVcb7o(this.f$0, completer);
                }
            });
        }
        ...
        public void close() {
            ...
            Threads.runOnMain(new Runnable() { // from class: androidx.camera.core.processing.SurfaceEdge$SettableSurface$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    SurfaceEdge.SettableSurface.m4678$r8$lambda$MbwWKPmNYVcJmML8QCwwbJ_Io(this.f$0);
                }
            });
        }

        /* renamed from: $r8$lambda$MbwWKPmNY-V-cJmML8QCwwbJ_Io, reason: not valid java name */
        public static /* synthetic */ void m4678$r8$lambda$MbwWKPmNYVcJmML8QCwwbJ_Io(SettableSurface settableSurface) {

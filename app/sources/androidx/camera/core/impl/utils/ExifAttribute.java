...
final class ExifAttribute {
    ...
    public String toString() {
        return "(" + IFD_FORMAT_NAMES[this.f9661format] + ", data length:" + this.bytes.length + ")";
    }

    public int size() {
        return IFD_FORMAT_BYTES_PER_FORMAT[this.f9661format] * this.numberOfComponents;
    }
}

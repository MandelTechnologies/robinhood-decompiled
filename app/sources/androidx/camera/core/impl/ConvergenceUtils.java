...
public class ConvergenceUtils {
    ...
    public static boolean is3AConverged(CameraCaptureResult cameraCaptureResult, boolean z) {
        ...
        Logger.m45d("ConvergenceUtils", "checkCaptureResult, AE=" + cameraCaptureResult.getAeState() + " AF =" + cameraCaptureResult.getAfState() + " AWB=" + cameraCaptureResult.getAwbState());
        return z2 && z4 && z5;
    }
}

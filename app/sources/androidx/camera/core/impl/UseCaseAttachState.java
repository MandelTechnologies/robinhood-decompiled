...
public final class UseCaseAttachState {
    ...
    public Collection<UseCaseAttachInfo> getAttachedUseCaseInfo() {
        return Collections.unmodifiableCollection(getUseCaseInfo(new AttachStateFilter() { // from class: androidx.camera.core.impl.UseCaseAttachState$$ExternalSyntheticLambda3
            @Override // androidx.camera.core.impl.UseCaseAttachState.AttachStateFilter
            public final boolean filter(UseCaseAttachState.UseCaseAttachInfo useCaseAttachInfo) {
                return useCaseAttachInfo.getAttached();
            }
    ...
    public Collection<SessionConfig> getActiveAndAttachedSessionConfigs() {
        return Collections.unmodifiableCollection(getSessionConfigs(new AttachStateFilter() { // from class: androidx.camera.core.impl.UseCaseAttachState$$ExternalSyntheticLambda2
            @Override // androidx.camera.core.impl.UseCaseAttachState.AttachStateFilter
            public final boolean filter(UseCaseAttachState.UseCaseAttachInfo useCaseAttachInfo) {
                return UseCaseAttachState.m4665$r8$lambda$4jGfHbZR7YTG7MHmNnt3WMkoZI(useCaseAttachInfo);
            }
        }));
    }

    /* renamed from: $r8$lambda$4jGfHbZR7YTG7MHmNnt-3WMkoZI, reason: not valid java name */
    public static /* synthetic */ boolean m4665$r8$lambda$4jGfHbZR7YTG7MHmNnt3WMkoZI(UseCaseAttachInfo useCaseAttachInfo) {
    ...
    public SessionConfig.ValidatingBuilder getActiveAndAttachedBuilder() {
        ...
        Logger.m45d("UseCaseAttachState", "Active and attached use case: " + arrayList + " for camera: " + this.mCameraId);
    ...
    public SessionConfig.ValidatingBuilder getAttachedBuilder() {
        ...
        Logger.m45d("UseCaseAttachState", "All use case: " + arrayList + " for camera: " + this.mCameraId);
        return validatingBuilder;
    }

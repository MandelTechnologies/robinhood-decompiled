        ...
        synchronized (this.mLock) {
            try {
                ...
                if (Logger.isDebugEnabled("CameraStateRegistry")) {
                    ...
                    Logger.m45d("CameraStateRegistry", this.mDebugString.toString());
                }
                if (z) {
    ...
    private static class CameraRegistration {
        ...
        void notifyOnConfigureAvailableListener() {
            try {
                ...
                Logger.m48e("CameraStateRegistry", "Unable to notify camera to configure.", e);
            }
        }
        ...
        void notifyOnOpenAvailableListener() {
            try {
                ...
                Logger.m48e("CameraStateRegistry", "Unable to notify camera to open.", e);
            }
        }
    }

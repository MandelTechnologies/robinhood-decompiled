...
public class StreamSharing extends UseCase {
    ...
    public StreamSharing(CameraInternal cameraInternal, CameraInternal cameraInternal2, LayoutSettings layoutSettings, LayoutSettings layoutSettings2, Set<UseCase> set, UseCaseConfigFactory useCaseConfigFactory) {
        ...
        this.mVirtualCameraAdapter = new VirtualCameraAdapter(cameraInternal, cameraInternal2, set, useCaseConfigFactory, new Control() { // from class: androidx.camera.core.streamsharing.StreamSharing$$ExternalSyntheticLambda1
            ...
            public final ListenableFuture jpegSnapshot(int i, int i2) {
                return StreamSharing.$r8$lambda$s1iXWYUIexs0Oc3PYKafXTQ0Sfs(this.f$0, i, i2);
            }
        });
    }

    public static /* synthetic */ ListenableFuture $r8$lambda$s1iXWYUIexs0Oc3PYKafXTQ0Sfs(StreamSharing streamSharing, int i, int i2) {
    ...
    private List<SessionConfig> createPipelineAndUpdateChildrenSpecs(String str, String str2, UseCaseConfig<?> useCaseConfig, StreamSpec streamSpec, StreamSpec streamSpec2) {
        ...
        if (streamSpec2 == null) {
            ...
            SurfaceProcessorNode.Out outTransform = this.mSharingNode.transform(SurfaceProcessorNode.AbstractC0873In.m70of(this.mSharingInputEdge, new ArrayList(childrenOutConfigs.values())));
            ...
            return ImageAnalysis$$ExternalSyntheticBackport1.m44m(new Object[]{this.mSessionConfigBuilder.build()});
        }
        ...
        DualSurfaceProcessorNode.Out outTransform2 = this.mDualSharingNode.transform(DualSurfaceProcessorNode.AbstractC0875In.m72of(this.mSharingInputEdge, this.mSecondarySharingInputEdge, new ArrayList(childrenOutConfigs2.values())));
        ...
        return ImageAnalysis$$ExternalSyntheticBackport1.m44m(new Object[]{this.mSessionConfigBuilder.build(), this.mSecondarySessionConfigBuilder.build()});
    }
    ...
    private SurfaceEdge getSharingInputEdge(SurfaceEdge surfaceEdge, CameraInternal cameraInternal) {
        ...
        OutConfig outConfigM74of = OutConfig.m74of(surfaceEdge.getTargets(), surfaceEdge.getFormat(), cropRectAppliedByEffect, TransformUtils.getRotatedSize(cropRectAppliedByEffect, rotationAppliedByEffect), rotationAppliedByEffect, getMirroringAppliedByEffect(), true);
        SurfaceEdge surfaceEdge2 = this.mEffectNode.transform(SurfaceProcessorNode.AbstractC0873In.m70of(surfaceEdge, Collections.singletonList(outConfigM74of))).get(outConfigM74of);

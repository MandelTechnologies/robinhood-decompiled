...
public class SupportedOutputSizesSorter {
    ...
    private List<Size> getResolutionCandidateList(List<Pair<Integer, Size[]>> list, int i) {
        ...
        if (arrayList.isEmpty()) {
            Logger.m50w("SupportedOutputSizesCollector", "The retrieved supported resolutions from camera info internal is empty. Format is " + i + ".");
        }
        return arrayList;
    }
    ...
    static Rational getTargetAspectRatioRationalValue(int i, boolean z) {
        ...
        Logger.m47e("SupportedOutputSizesCollector", "Undefined target aspect ratio: " + i);
        return null;
    }

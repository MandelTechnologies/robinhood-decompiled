...
public class JpegBytes2Image implements Operation<Packet<byte[]>, Packet<ImageProxy>> {
    ...
    public Packet<ImageProxy> apply(Packet<byte[]> packet) throws ImageCaptureException {
        ...
        return Packet.m67of(imageProxyConvertJpegBytesToImage, exif, packet.getCropRect(), packet.getRotationDegrees(), packet.getSensorToBufferTransform(), packet.getCameraCaptureResult());
    }
}

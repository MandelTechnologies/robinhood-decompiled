...
public class BitmapEffect implements Operation<Packet<Bitmap>, Packet<Bitmap>> {
    ...
    public Packet<Bitmap> apply(Packet<Bitmap> packet) throws ImageCaptureException {
        ...
        return Packet.m66of(bitmapCreateBitmapFromPlane, exif, packet.getCropRect(), packet.getRotationDegrees(), packet.getSensorToBufferTransform(), packet.getCameraCaptureResult());
    }
}

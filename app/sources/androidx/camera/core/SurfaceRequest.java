...
public final class SurfaceRequest {
    ...
    public SurfaceRequest(Size size, CameraInternal cameraInternal, boolean z, DynamicRange dynamicRange, Range<Integer> range, Runnable runnable) {
        ...
        final ListenableFuture future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.SurfaceRequest$$ExternalSyntheticLambda1
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return SurfaceRequest.m4652$r8$lambda$KNGGnEiW12GWMzWpgmzm9z6pio(atomicReference, str, completer);
            }
        });
    ...
    public static /* synthetic */ Object m4652$r8$lambda$KNGGnEiW12GWMzWpgmzm9z6pio(AtomicReference atomicReference, String str, CallbackToFutureAdapter.Completer completer) {
    ...
    public void provideSurface(final Surface surface, Executor executor, final Consumer<Result> consumer) throws ExecutionException, InterruptedException {
        if (this.mSurfaceCompleter.set(surface) || this.mSurfaceFuture.isCancelled()) {
            Futures.addCallback(this.mSessionStatusFuture, new FutureCallback<Void>() { // from class: androidx.camera.core.SurfaceRequest.4
                ...
                public void onSuccess(Void r3) {
                    consumer.accept(Result.m54of(0, surface));
                }
                ...
                public void onFailure(Throwable th) {
                    ...
                    consumer.accept(Result.m54of(1, surface));
                }
            }, executor);
            return;
        }
        ...
        try {
            ...
            executor.execute(new Runnable() { // from class: androidx.camera.core.SurfaceRequest$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    consumer.accept(SurfaceRequest.Result.m54of(3, surface));
                }
            });
            ...
            executor.execute(new Runnable() { // from class: androidx.camera.core.SurfaceRequest$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                    consumer.accept(SurfaceRequest.Result.m54of(4, surface));
                }
            });
        }
    }
    ...
    private CallbackToFutureAdapter.Completer<Void> initialSurfaceRecreationCompleter(Executor executor, final Runnable runnable) {
        final AtomicReference atomicReference = new AtomicReference(null);
        Futures.addCallback(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.SurfaceRequest$$ExternalSyntheticLambda6
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return SurfaceRequest.$r8$lambda$t3tb3FLU67HMbIyz4ohui7IQ5jw(this.f$0, atomicReference, completer);
            }
    ...
    public static /* synthetic */ Object $r8$lambda$t3tb3FLU67HMbIyz4ohui7IQ5jw(SurfaceRequest surfaceRequest, AtomicReference atomicReference, CallbackToFutureAdapter.Completer completer) {
    ...
    public static abstract class Result {
        ...
        /* renamed from: of */
        static Result m54of(int i, Surface surface) {
    ...
    public static abstract class TransformationInfo {
        ...
        /* renamed from: of */
        public static TransformationInfo m55of(Rect rect, int i, int i2, boolean z, Matrix matrix, boolean z2) {

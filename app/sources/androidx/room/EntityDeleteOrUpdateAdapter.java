...
public abstract class EntityDeleteOrUpdateAdapter<T> {
    ...
    public final int handle(SQLiteConnection connection, T entity) {
        ...
        try {
            ...
            return ConnectionUtil.getTotalChangedRows(connection);
        } finally {
        }
    }
        ...
        try {
            for (T t : entities) {
                if (t != null) {
                    ...
                    totalChangedRows += ConnectionUtil.getTotalChangedRows(connection);
                }
            }

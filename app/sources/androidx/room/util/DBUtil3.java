...
@DebugMetadata(m3644c = "androidx.room.util.DBUtil__DBUtil_androidKt$performBlocking$1$invokeSuspend$$inlined$internalPerform$1", m3645f = "DBUtil.android.kt", m3646l = {56, 57, 59, 60}, m3647m = "invokeSuspend")
@SourceDebugExtension
/* renamed from: androidx.room.util.DBUtil__DBUtil_androidKt$performBlocking$1$invokeSuspend$$inlined$internalPerform$1, reason: use source file name */
/* loaded from: classes4.dex */
public final class DBUtil3<R> extends ContinuationImpl7 implements Function2<Transactor, Continuation<? super R>, Object> {
    ...
    public DBUtil3(boolean z, boolean z2, RoomDatabase roomDatabase, Continuation continuation, Function1 function1) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        DBUtil3 dBUtil3 = new DBUtil3(this.$inTransaction, this.$isReadOnly, this.$this_internalPerform, continuation, this.$block$inlined);
        dBUtil3.L$0 = obj;
        return dBUtil3;
    }
    ...
    public final Object invoke(Transactor transactor, Continuation<? super R> continuation) {
        return ((DBUtil3) create(transactor, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    ...
    @DebugMetadata(m3644c = "androidx.room.util.DBUtil__DBUtil_androidKt$performBlocking$1$invokeSuspend$$inlined$internalPerform$1$1", m3645f = "DBUtil.android.kt", m3646l = {}, m3647m = "invokeSuspend")
    @SourceDebugExtension

...
final class BooleanArrayList extends AbstractProtobufList<Boolean> implements Internal.BooleanList, RandomAccess, PrimitiveNonBoxingCollection {
    ...
    public boolean equals(Object obj) {
        ...
        boolean[] zArr = booleanArrayList.f9693array;
        for (int i = 0; i < this.size; i++) {
            if (this.f9693array[i] != zArr[i]) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode() {
        int iHashBoolean = 1;
        for (int i = 0; i < this.size; i++) {
            iHashBoolean = (iHashBoolean * 31) + Internal.hashBoolean(this.f9693array[i]);
        }
        return iHashBoolean;
    }
    ...
    public Internal.ProtobufList<Boolean> mutableCopyWithCapacity2(int i) {
        ...
        return new BooleanArrayList(Arrays.copyOf(this.f9693array, i), this.size);
    }
    ...
    public void addBoolean(boolean z) {
        ...
        if (i == zArr.length) {
            ...
            this.f9693array = zArr2;
        }
        boolean[] zArr3 = this.f9693array;
        int i2 = this.size;
        this.size = i2 + 1;
        zArr3[i2] = z;
    }
    ...
    private void addBoolean(int i, boolean z) {
        ...
        if (i2 < zArr.length) {
            ...
            System.arraycopy(zArr, 0, zArr2, 0, i);
            System.arraycopy(this.f9693array, i, zArr2, i + 1, this.size - i);
            this.f9693array = zArr2;
        }
        this.f9693array[i] = z;
        this.size++;
    ...
    public boolean addAll(Collection<? extends Boolean> collection) {
        ...
        boolean[] zArr = this.f9693array;
        if (i3 > zArr.length) {
            this.f9693array = Arrays.copyOf(zArr, i3);
        }
        System.arraycopy(booleanArrayList.f9693array, 0, this.f9693array, this.size, booleanArrayList.size);
        this.size = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public boolean remove(Object obj) {
        ensureIsMutable();
        for (int i = 0; i < this.size; i++) {
            if (obj.equals(Boolean.valueOf(this.f9693array[i]))) {
                boolean[] zArr = this.f9693array;

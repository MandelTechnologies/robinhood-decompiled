...
final class IntArrayList extends AbstractProtobufList<Integer> implements Internal.IntList, RandomAccess, PrimitiveNonBoxingCollection {
    ...
    public boolean equals(Object obj) {
        ...
        int[] iArr = intArrayList.f9697array;
        for (int i = 0; i < this.size; i++) {
            if (this.f9697array[i] != iArr[i]) {
                return false;
            }
        }
        return true;
    ...
    public Internal.ProtobufList<Integer> mutableCopyWithCapacity2(int i) {
        ...
        return new IntArrayList(Arrays.copyOf(this.f9697array, i), this.size);
    }
    ...
    public void addInt(int i) {
        ...
        if (i2 == iArr.length) {
            ...
            this.f9697array = iArr2;
        }
        int[] iArr3 = this.f9697array;
        int i3 = this.size;
        this.size = i3 + 1;
        iArr3[i3] = i;
    }
    ...
    private void addInt(int i, int i2) {
        ...
        if (i3 < iArr.length) {
            ...
            System.arraycopy(this.f9697array, i, iArr2, i + 1, this.size - i);
            this.f9697array = iArr2;
        }
        this.f9697array[i] = i2;
        this.size++;
        ((AbstractList) this).modCount++;
    }
    ...
    public boolean addAll(Collection<? extends Integer> collection) {
        ...
        int[] iArr = this.f9697array;
        if (i3 > iArr.length) {
            this.f9697array = Arrays.copyOf(iArr, i3);
        }
        System.arraycopy(intArrayList.f9697array, 0, this.f9697array, this.size, intArrayList.size);
        this.size = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public boolean remove(Object obj) {
        ensureIsMutable();
        for (int i = 0; i < this.size; i++) {
            if (obj.equals(Integer.valueOf(this.f9697array[i]))) {
                int[] iArr = this.f9697array;

...
final class ProtobufArrayList<E> extends AbstractProtobufList<E> implements RandomAccess {
    ...
    public ProtobufArrayList<E> mutableCopyWithCapacity(int i) {
        ...
        return new ProtobufArrayList<>(Arrays.copyOf(this.f9700array, i), this.size);
    }
    ...
    public boolean add(E e) {
        ensureIsMutable();
        int i = this.size;
        E[] eArr = this.f9700array;
        if (i == eArr.length) {
            this.f9700array = (E[]) Arrays.copyOf(eArr, ((i * 3) / 2) + 1);
        }
        E[] eArr2 = this.f9700array;
        int i2 = this.size;
        this.size = i2 + 1;
        eArr2[i2] = e;
    ...
    public void add(int i, E e) {
        ...
        if (i2 < eArr.length) {
            ...
            System.arraycopy(this.f9700array, 0, eArr2, 0, i);
            System.arraycopy(this.f9700array, i, eArr2, i + 1, this.size - i);
            this.f9700array = eArr2;
        }
        this.f9700array[i] = e;
        this.size++;
        ((AbstractList) this).modCount++;

...
public abstract class AbstractResolvableFuture<V> implements ListenableFuture<V> {
    ...
    public final V get(long j, TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        String str = "Waited " + j + PlaceholderUtils.XXShortPlaceholderText + timeUnit.toString().toLowerCase(locale);
        if (nanos + 1000 < 0) {
            ...
            if (jConvert > 0) {
                String str3 = str2 + jConvert + PlaceholderUtils.XXShortPlaceholderText + lowerCase;
                if (z) {
                    str3 = str3 + ",";
                }
                str2 = str3 + PlaceholderUtils.XXShortPlaceholderText;
            }
            if (z) {
        ...
        throw new TimeoutException(str + " for " + string2);
    }
    ...
    private static final class SafeAtomicHelper extends AtomicHelper {
        ...
        boolean casWaiters(AbstractResolvableFuture<?> abstractResolvableFuture, Waiter waiter, Waiter waiter2) {
            return C2031xc40028dd.m363m(this.waitersUpdater, abstractResolvableFuture, waiter, waiter2);
        }

        @Override // androidx.concurrent.futures.AbstractResolvableFuture.AtomicHelper
        boolean casListeners(AbstractResolvableFuture<?> abstractResolvableFuture, Listener listener, Listener listener2) {
            return C2031xc40028dd.m363m(this.listenersUpdater, abstractResolvableFuture, listener, listener2);
        }

        @Override // androidx.concurrent.futures.AbstractResolvableFuture.AtomicHelper
        boolean casValue(AbstractResolvableFuture<?> abstractResolvableFuture, Object obj, Object obj2) {
            return C2031xc40028dd.m363m(this.valueUpdater, abstractResolvableFuture, obj, obj2);
        }
    }

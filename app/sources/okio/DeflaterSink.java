    ...
    private final void deflate(boolean syncFlush) throws IOException {
        ...
        while (true) {
            ...
            if (iDeflate > 0) {
                ...
                bufferField.setSize$okio(bufferField.getSize() + iDeflate);

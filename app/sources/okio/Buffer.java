...
public final class buffer implements BufferedSource {
    ...
    public int select(Options options) throws EOFException {
        ...
        do {
            int iSelectPrefix = Buffer4.selectPrefix(this.bufferField, options, true);
            if (iSelectPrefix != -2) {
                if (iSelectPrefix == -1) {
                    return -1;
                }
    ...
    public long indexOf(ByteString bytes, long fromIndex, long toIndex) {
        Intrinsics.checkNotNullParameter(bytes, "bytes");
        return RealBufferedSource2.commonIndexOf$default(this, bytes, 0, 0, fromIndex, toIndex, 6, null);
    }
        ...
        return new InputStream() { // from class: okio.RealBufferedSource.inputStream.1
            ...
            public long transferTo(OutputStream out) throws IOException {
                ...
                while (true) {
                    ...
                    Buffer.writeTo$default(buffer.this.bufferField, out, 0L, 2, null);
                }
            }
        };
    }
    ...
    public long readDecimalLong() {
        ...
        if (j == 0) {
            ...
            String string2 = Integer.toString(b, CharsKt.checkRadix(16));
    ...
    public boolean rangeEquals(long offset, ByteString bytes, int bytesOffset, int byteCount) {
        ...
        return byteCount >= 0 && offset >= 0 && bytesOffset >= 0 && bytesOffset + byteCount <= bytes.size() && (byteCount == 0 || RealBufferedSource2.commonIndexOf(this, bytes, bytesOffset, byteCount, offset, offset + 1) != -1);
    }

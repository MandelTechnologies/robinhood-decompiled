...
public abstract class FileSystem implements Closeable {
    ...
    public abstract Sink mo11317appendingSink(Path file, boolean mustExist) throws IOException;

    /* renamed from: atomicMove */
    public abstract void mo11318atomicMove(Path source, Path target) throws IOException;
    ...
    public abstract void mo11319createDirectory(Path dir, boolean mustCreate) throws IOException;

    /* renamed from: createSymlink */
    public abstract void mo11320createSymlink(Path source, Path target) throws IOException;

    /* renamed from: delete */
    public abstract void mo11321delete(Path path, boolean mustExist) throws IOException;
    ...
    public abstract FileHandle mo11322openReadWrite(Path file, boolean mustCreate, boolean mustExist) throws IOException;

    /* renamed from: sink */
    public abstract Sink mo11323sink(Path file, boolean mustCreate) throws IOException;
    ...
    public final FileMetadata metadata(Path path) throws IOException {
        ...
        return FileSystem2.commonMetadata(this, path);
    }

    public final boolean exists(Path path) throws IOException {
        Intrinsics.checkNotNullParameter(path, "path");
        return FileSystem2.commonExists(this, path);
    }
    ...
    public Sequence<Path> listRecursively(Path dir, boolean followSymlinks) {
        ...
        return FileSystem2.commonListRecursively(this, dir, followSymlinks);
    }
    ...
    public static /* synthetic */ FileHandle openReadWrite$default(FileSystem fileSystem, Path path, boolean z, boolean z2, int i, Object obj) throws IOException {
        ...
        return fileSystem.mo11322openReadWrite(path, z, z2);
    }

    public final FileHandle openReadWrite(Path file) throws IOException {
        Intrinsics.checkNotNullParameter(file, "file");
        return mo11322openReadWrite(file, false, false);
    }
    ...
    public final <T> T m29453read(Path file, Function1<? super BufferedSource, ? extends T> readerAction) throws IOException {
        ?? r5;
        Intrinsics.checkNotNullParameter(file, "file");
    ...
    public final <T> T m29454write(Path file, boolean mustCreate, Function1<? super BufferedSink, ? extends T> writerAction) throws IOException {
        ?? r5;
        Intrinsics.checkNotNullParameter(file, "file");
        Intrinsics.checkNotNullParameter(writerAction, "writerAction");
        BufferedSink bufferedSinkBuffer = Okio.buffer(mo11323sink(file, mustCreate));
        T th = null;
        try {
    ...
    public static /* synthetic */ Sink sink$default(FileSystem fileSystem, Path path, boolean z, int i, Object obj) throws IOException {
        ...
        return fileSystem.mo11323sink(path, z);
    }

    public final Sink sink(Path file) throws IOException {
        Intrinsics.checkNotNullParameter(file, "file");
        return mo11323sink(file, false);
    }
    ...
    public static /* synthetic */ Object m29452write$default(FileSystem fileSystem, Path file, boolean z, Function1 writerAction, int i, Object obj) throws IOException {
        ?? r4;
        if (obj == null) {
            if ((i & 2) != 0) {
                z = false;
            ...
            Intrinsics.checkNotNullParameter(file, "file");
            Intrinsics.checkNotNullParameter(writerAction, "writerAction");
            BufferedSink bufferedSinkBuffer = Okio.buffer(fileSystem.mo11323sink(file, z));
            Object th = null;
            try {
    ...
    public static /* synthetic */ Sink appendingSink$default(FileSystem fileSystem, Path path, boolean z, int i, Object obj) throws IOException {
        ...
        return fileSystem.mo11317appendingSink(path, z);
    }

    public final Sink appendingSink(Path file) throws IOException {
        Intrinsics.checkNotNullParameter(file, "file");
        return mo11317appendingSink(file, false);
    }
    ...
    public static /* synthetic */ void createDirectory$default(FileSystem fileSystem, Path path, boolean z, int i, Object obj) throws IOException {
        ...
        fileSystem.mo11319createDirectory(path, z);
    }

    public final void createDirectory(Path dir) throws IOException {
        Intrinsics.checkNotNullParameter(dir, "dir");
        mo11319createDirectory(dir, false);
    }
    ...
    public final void createDirectories(Path dir, boolean mustCreate) throws IOException {
        Intrinsics.checkNotNullParameter(dir, "dir");
        FileSystem2.commonCreateDirectories(this, dir, mustCreate);
    }
    ...
    public void copy(Path source, Path target) throws IOException {
        ...
        FileSystem2.commonCopy(this, source, target);
    }
    ...
    public static /* synthetic */ void delete$default(FileSystem fileSystem, Path path, boolean z, int i, Object obj) throws IOException {
        ...
        fileSystem.mo11321delete(path, z);
    }

    public final void delete(Path path) throws IOException {
        Intrinsics.checkNotNullParameter(path, "path");
        mo11321delete(path, false);
    }
    ...
    public void deleteRecursively(Path fileOrDirectory, boolean mustExist) throws IOException {
        ...
        FileSystem2.commonDeleteRecursively(this, fileOrDirectory, mustExist);
    }
    ...
    /* compiled from: FileSystem.kt */
    @Metadata(m3635d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0011\u0010\t\u001a\u00020\u0005*\u00020\nH\u0007¢\u0006\u0002\b\u000bR\u0010\u0010\u0004\u001a\u00020\u00058\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0006\u001a\u00020\u00078\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\b\u001a\u00020\u00058\u0006X\u0087\u0004¢\u0006\u0002\n\u0000¨\u0006\f"}, m3636d2 = {"Lokio/FileSystem$Companion;", "", "<init>", "()V", "SYSTEM", "Lokio/FileSystem;", "SYSTEM_TEMPORARY_DIRECTORY", "Lokio/Path;", "RESOURCES", "asOkioFileSystem", "Ljava/nio/file/FileSystem;", "get", "okio"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)

...
@Metadata(m3635d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0012\n\u0002\b\u0006\b\u0000\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0004\b\u0006\u0010\u0007J\u0010\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0014J\b\u0010\f\u001a\u00020\u000bH\u0014J(\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u000b2\u0006\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u0012\u001a\u00020\u000e2\u0006\u0010\u0013\u001a\u00020\u000eH\u0014J(\u0010\u0014\u001a\u00020\t2\u0006\u0010\u000f\u001a\u00020\u000b2\u0006\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u0012\u001a\u00020\u000e2\u0006\u0010\u0013\u001a\u00020\u000eH\u0014J\b\u0010\u0015\u001a\u00020\tH\u0014J\b\u0010\u0016\u001a\u00020\tH\u0014R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0017"}, m3636d2 = {"Lokio/JvmFileHandle;", "Lokio/FileHandle;", "readWrite", "", "randomAccessFile", "Ljava/io/RandomAccessFile;", "<init>", "(ZLjava/io/RandomAccessFile;)V", "protectedResize", "", "size", "", "protectedSize", "protectedRead", "", "fileOffset", ResourceTypes.ARRAY, "", "arrayOffset", "byteCount", "protectedWrite", "protectedFlush", "protectedClose", "okio"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
...
public final class JvmFileHandle extends FileHandle {
    ...
    protected synchronized int protectedRead(long fileOffset, byte[] array2, int arrayOffset, int byteCount) {
        ...
        while (true) {
            ...
            int i2 = this.randomAccessFile.read(array2, arrayOffset, byteCount - i);
            if (i2 != -1) {
                i += i2;
            } else if (i == 0) {
                return -1;
    ...
    protected synchronized void mo11316protectedWrite(long fileOffset, byte[] array2, int arrayOffset, int byteCount) {
        Intrinsics.checkNotNullParameter(array2, "array");
        this.randomAccessFile.seek(fileOffset);
        this.randomAccessFile.write(array2, arrayOffset, byteCount);
    }

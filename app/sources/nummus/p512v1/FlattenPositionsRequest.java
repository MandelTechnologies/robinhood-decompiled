...
@Metadata(m3635d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0001\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\u0018\u0000 \u00182\u000e\u0012\u0004\u0012\u00020\u0000\u0012\u0004\u0012\u00020\u00020\u0001:\u0001\u0018B/\u0012\b\b\u0002\u0010\u0003\u001a\u00020\u0004\u0012\b\b\u0002\u0010\u0005\u001a\u00020\u0004\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0004\u0012\b\b\u0002\u0010\u0007\u001a\u00020\b¢\u0006\u0004\b\t\u0010\nJ\b\u0010\u000f\u001a\u00020\u0002H\u0017J\u0013\u0010\u0010\u001a\u00020\u00112\b\u0010\u0012\u001a\u0004\u0018\u00010\u0013H\u0096\u0002J\b\u0010\u0014\u001a\u00020\u0015H\u0016J\b\u0010\u0016\u001a\u00020\u0004H\u0016J.\u0010\u0017\u001a\u00020\u00002\b\b\u0002\u0010\u0003\u001a\u00020\u00042\b\b\u0002\u0010\u0005\u001a\u00020\u00042\b\b\u0002\u0010\u0006\u001a\u00020\u00042\b\b\u0002\u0010\u0007\u001a\u00020\bR\u0016\u0010\u0003\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0016\u0010\u0005\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\fR\u0016\u0010\u0006\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u000e\u0010\f¨\u0006\u0019"}, m3636d2 = {"Lnummus/v1/FlattenPositionsRequest;", "Lcom/squareup/wire/Message;", "", "account_id", "", "currency_pair_id", "ref_id", "unknownFields", "Lokio/ByteString;", "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lokio/ByteString;)V", "getAccount_id", "()Ljava/lang/String;", "getCurrency_pair_id", "getRef_id", "newBuilder", "equals", "", "other", "", "hashCode", "", "toString", "copy", "Companion", "nummus.v1_externalRelease"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
...
public final class FlattenPositionsRequest extends Message {
    ...
    public /* bridge */ /* synthetic */ Message.Builder newBuilder() {
        return (Message.Builder) m29421newBuilder();
    }
    ...
    public FlattenPositionsRequest(String account_id, String currency_pair_id, String ref_id, ByteString unknownFields) {
    ...
    public /* synthetic */ Void m29421newBuilder() {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(unknownFields(), flattenPositionsRequest.unknownFields()) && Intrinsics.areEqual(this.account_id, flattenPositionsRequest.account_id) && Intrinsics.areEqual(this.currency_pair_id, flattenPositionsRequest.currency_pair_id) && Intrinsics.areEqual(this.ref_id, flattenPositionsRequest.ref_id);
    }
    ...
    public int hashCode() {
        ...
        int iHashCode = (((((unknownFields().hashCode() * 37) + this.account_id.hashCode()) * 37) + this.currency_pair_id.hashCode()) * 37) + this.ref_id.hashCode();
    ...
    public static /* synthetic */ FlattenPositionsRequest copy$default(FlattenPositionsRequest flattenPositionsRequest, String str, String str2, String str3, ByteString byteString, int i, Object obj) {
        ...
        if ((i & 2) != 0) {
            str2 = flattenPositionsRequest.currency_pair_id;
        }
        if ((i & 4) != 0) {
    ...
    public final FlattenPositionsRequest copy(String account_id, String currency_pair_id, String ref_id, ByteString unknownFields) {
        Intrinsics.checkNotNullParameter(account_id, "account_id");
        Intrinsics.checkNotNullParameter(currency_pair_id, "currency_pair_id");
        Intrinsics.checkNotNullParameter(ref_id, "ref_id");
        Intrinsics.checkNotNullParameter(unknownFields, "unknownFields");
        return new FlattenPositionsRequest(account_id, currency_pair_id, ref_id, unknownFields);
    }
    ...
    static {
        ...
        ADAPTER = new ProtoAdapter<FlattenPositionsRequest>(fieldEncoding, orCreateKotlinClass, syntax) { // from class: nummus.v1.FlattenPositionsRequest$Companion$ADAPTER$1
            ...
            public int encodedSize(FlattenPositionsRequest value) {
                ...
                if (!Intrinsics.areEqual(value.getCurrency_pair_id(), "")) {
                    size += ProtoAdapter.STRING.encodedSizeWithTag(2, value.getCurrency_pair_id());
                }

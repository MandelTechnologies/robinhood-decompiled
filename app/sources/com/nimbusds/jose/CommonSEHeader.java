...
abstract class CommonSEHeader extends Header {
    ...
    public Map<String, Object> toJSONObject() {
        ...
        URI uri = this.jku;
        if (uri != null) {
            jSONObject.put(JwsHeader.JWK_SET_URL, uri.toString());
        }
        JWK jwk = this.jwk;
        if (jwk != null) {
            jSONObject.put(JwsHeader.JSON_WEB_KEY, jwk.toJSONObject());
        }
        URI uri2 = this.x5u;
        if (uri2 != null) {
            jSONObject.put(JwsHeader.X509_URL, uri2.toString());
        }
        Base64URL base64URL = this.x5t;
        if (base64URL != null) {
            jSONObject.put(JwsHeader.X509_CERT_SHA1_THUMBPRINT, base64URL.toString());
        }
        Base64URL base64URL2 = this.x5t256;
        if (base64URL2 != null) {
            jSONObject.put(JwsHeader.X509_CERT_SHA256_THUMBPRINT, base64URL2.toString());
        }
        ...
        if (list != null && !list.isEmpty()) {
            ...
            jSONObject.put(JwsHeader.X509_CERT_CHAIN, arrayList);
        }
        String str = this.kid;
        if (str != null) {

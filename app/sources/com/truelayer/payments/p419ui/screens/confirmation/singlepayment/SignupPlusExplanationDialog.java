...
/* compiled from: SignupPlusExplanationDialog.kt */
@Metadata(m3635d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a%\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u000e\b\u0002\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00010\u0005H\u0001¢\u0006\u0002\u0010\u0006¨\u0006\u0007"}, m3636d2 = {"SignupPlusExplanationDialog", "", "text", "", "onDismissRequest", "Lkotlin/Function0;", "(Ljava/lang/String;Lkotlin/jvm/functions/Function0;Landroidx/compose/runtime/Composer;II)V", "payments-ui_release"}, m3637k = 2, m3638mv = {1, 9, 0}, m3640xi = 48)
/* renamed from: com.truelayer.payments.ui.screens.confirmation.singlepayment.SignupPlusExplanationDialogKt, reason: use source file name */
/* loaded from: classes12.dex */
public final class SignupPlusExplanationDialog {
    public static final void SignupPlusExplanationDialog(final String text, final Function0<Unit> function0, Composer composer, final int i, final int i2) {
        int i3;
        Intrinsics.checkNotNullParameter(text, "text");
        Composer composerStartRestartGroup = composer.startRestartGroup(466050158);
        if ((i2 & 1) != 0) {
            i3 = i | 6;
        } else if ((i & 14) == 0) {
        ...
        if ((i3 & 91) != 18 || !composerStartRestartGroup.getSkipping()) {
            if (i4 != 0) {
                function0 = new Function0<Unit>() { // from class: com.truelayer.payments.ui.screens.confirmation.singlepayment.SignupPlusExplanationDialogKt.SignupPlusExplanationDialog.1
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(466050158, i3, -1, "com.truelayer.payments.ui.screens.confirmation.singlepayment.SignupPlusExplanationDialog (SignupPlusExplanationDialog.kt:29)");
            }
            ModalBottomSheetKt.ModalBottomSheet(null, function02, ModalBottomSheet_androidKt.rememberModalBottomSheetState(true, null, composerStartRestartGroup, 6, 2), ComposableLambda3.composableLambda(composerStartRestartGroup, -1046200905, true, new Function2<Composer, Integer, Unit>() { // from class: com.truelayer.payments.ui.screens.confirmation.singlepayment.SignupPlusExplanationDialogKt.SignupPlusExplanationDialog.2
                ...
                public final void invoke(Composer composer2, int i5) {
                    if ((i5 & 11) != 2 || !composer2.getSkipping()) {
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(-1046200905, i5, -1, "com.truelayer.payments.ui.screens.confirmation.singlepayment.SignupPlusExplanationDialog.<anonymous> (SignupPlusExplanationDialog.kt:35)");
                        }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: com.truelayer.payments.ui.screens.confirmation.singlepayment.SignupPlusExplanationDialogKt.SignupPlusExplanationDialog.3
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
                ...
                public final void invoke(Composer composer2, int i5) {
                    SignupPlusExplanationDialog.SignupPlusExplanationDialog(text, function0, composer2, RecomposeScopeImpl4.updateChangedFlags(i | 1), i2);
                }
            });
        }
    }

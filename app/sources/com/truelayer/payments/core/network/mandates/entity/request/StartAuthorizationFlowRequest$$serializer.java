...
@Metadata(m3635d1 = {"\u00006\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0003J\u0018\u0010\b\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\n0\tHÖ\u0001¢\u0006\u0002\u0010\u000bJ\u0011\u0010\f\u001a\u00020\u00022\u0006\u0010\r\u001a\u00020\u000eHÖ\u0001J\u0019\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\u0002HÖ\u0001R\u0014\u0010\u0004\u001a\u00020\u00058VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u0014"}, m3636d2 = {"com/truelayer/payments/core/network/mandates/entity/request/StartAuthorizationFlowRequest.$serializer", "Lkotlinx/serialization/internal/GeneratedSerializer;", "Lcom/truelayer/payments/core/network/mandates/entity/request/StartAuthorizationFlowRequest;", "()V", "descriptor", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "childSerializers", "", "Lkotlinx/serialization/KSerializer;", "()[Lkotlinx/serialization/KSerializer;", "deserialize", "decoder", "Lkotlinx/serialization/encoding/Decoder;", "serialize", "", "encoder", "Lkotlinx/serialization/encoding/Encoder;", "value", "payments-core_release"}, m3637k = 1, m3638mv = {1, 9, 0}, m3640xi = 48)
@Deprecated
...
public final class StartAuthorizationFlowRequest$$serializer implements PluginHelperInterfaces<StartAuthorizationFlowRequest> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.truelayer.payments.core.network.mandates.entity.request.StartAuthorizationFlowRequest", startAuthorizationFlowRequest$$serializer, 3);
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{BuiltinSerializers.getNullable(kSerializerArr[0]), BuiltinSerializers.getNullable(RedirectPayload$$serializer.INSTANCE), BuiltinSerializers.getNullable(kSerializerArr[2])};
    }
    ...
    public StartAuthorizationFlowRequest deserialize(Decoding2 decoder) {
        ...
        if (decodingBeginStructure.decodeSequentially()) {
            ...
            consentPayload = (ConsentPayload) decodingBeginStructure.decodeNullableSerializableElement(descriptor2, 2, kSerializerArr[2], null);
            ...
            ConsentPayload consentPayload2 = null;
            while (z) {
                int iDecodeElementIndex = decodingBeginStructure.decodeElementIndex(descriptor2);
                if (iDecodeElementIndex == -1) {
                    z = false;
                } else if (iDecodeElementIndex == 0) {
                    providerSelectionPayload2 = (ProviderSelectionPayload) decodingBeginStructure.decodeNullableSerializableElement(descriptor2, 0, kSerializerArr[0], providerSelectionPayload2);
                    i2 |= 1;
                    ...
                    consentPayload2 = (ConsentPayload) decodingBeginStructure.decodeNullableSerializableElement(descriptor2, 2, kSerializerArr[2], consentPayload2);
                    i2 |= 4;
                }
            }
            i = i2;
        ...
        return new StartAuthorizationFlowRequest(i, providerSelectionPayload, redirectPayload, consentPayload, null);
    }

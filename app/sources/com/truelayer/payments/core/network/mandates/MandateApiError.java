...
public final /* data */ class MandateApiError implements IntoCoreError.IntoHttpError {
    ...
    public static /* synthetic */ MandateApiError copy$default(MandateApiError mandateApiError, String str, String str2, int i, String str3, String str4, Map map, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = mandateApiError.type;
        }
        if ((i2 & 2) != 0) {
            str2 = mandateApiError.title;
        }
        if ((i2 & 4) != 0) {
            i = mandateApiError.status;
        }
        if ((i2 & 8) != 0) {
            str3 = mandateApiError.traceId;
        }
        if ((i2 & 16) != 0) {
            str4 = mandateApiError.detail;
        }
        if ((i2 & 32) != 0) {
            map = mandateApiError.errors;
        }
        String str5 = str4;
        Map map2 = map;
        return mandateApiError.copy(str, str2, i, str3, str5, map2);
    }
    ...
    public final MandateApiError copy(String type2, String title, int status, String traceId, String detail, Map<String, ? extends List<String>> errors) {
        Intrinsics.checkNotNullParameter(type2, "type");
        Intrinsics.checkNotNullParameter(title, "title");
        Intrinsics.checkNotNullParameter(traceId, "traceId");
        Intrinsics.checkNotNullParameter(detail, "detail");
        return new MandateApiError(type2, title, status, traceId, detail, errors);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MandateApiError)) {
            return false;
        }
        MandateApiError mandateApiError = (MandateApiError) other;
        return Intrinsics.areEqual(this.type, mandateApiError.type) && Intrinsics.areEqual(this.title, mandateApiError.title) && this.status == mandateApiError.status && Intrinsics.areEqual(this.traceId, mandateApiError.traceId) && Intrinsics.areEqual(this.detail, mandateApiError.detail) && Intrinsics.areEqual(this.errors, mandateApiError.errors);
    }
    ...
    public String toString() {
        return "MandateApiError(type=" + this.type + ", title=" + this.title + ", status=" + this.status + ", traceId=" + this.traceId + ", detail=" + this.detail + ", errors=" + this.errors + ")";
    }

    /* compiled from: MandateApiError.kt */
    @Metadata(m3635d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m3636d2 = {"Lcom/truelayer/payments/core/network/mandates/MandateApiError$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/truelayer/payments/core/network/mandates/MandateApiError;", "payments-core_release"}, m3637k = 1, m3638mv = {1, 9, 0}, m3640xi = 48)
    public static final class Companion {
        ...
        public final KSerializer<MandateApiError> serializer() {
            return MandateApiError2.INSTANCE;
        }
    }
    ...
    @Deprecated
    public /* synthetic */ MandateApiError(int i, @SerialName("type") String str, @SerialName("title") String str2, @SerialName("status") int i2, @SerialName("trace_id") String str3, @SerialName(ErrorResponse.DETAIL) String str4, @SerialName("errors") Map map, SerializationConstructorMarker serializationConstructorMarker) {
        if (31 != (i & 31)) {
            PluginExceptions.throwMissingFieldException(i, 31, MandateApiError2.INSTANCE.getDescriptor());
        }
        this.type = str;
        this.title = str2;
        this.status = i2;
    ...
    public MandateApiError(String type2, String title, int i, String traceId, String detail, Map<String, ? extends List<String>> map) {
        Intrinsics.checkNotNullParameter(type2, "type");
        Intrinsics.checkNotNullParameter(title, "title");
        Intrinsics.checkNotNullParameter(traceId, "traceId");
        Intrinsics.checkNotNullParameter(detail, "detail");
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$payments_core_release(MandateApiError self, Encoding3 output, SerialDescriptor serialDesc) {
    ...
    public /* synthetic */ MandateApiError(String str, String str2, int i, String str3, String str4, Map map, int i2, DefaultConstructorMarker defaultConstructorMarker) {

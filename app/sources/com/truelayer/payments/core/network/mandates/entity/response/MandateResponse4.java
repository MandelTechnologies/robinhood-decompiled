...
@Metadata(m3635d1 = {"\u00006\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0003J\u0018\u0010\b\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\n0\tHÖ\u0001¢\u0006\u0002\u0010\u000bJ\u0011\u0010\f\u001a\u00020\u00022\u0006\u0010\r\u001a\u00020\u000eHÖ\u0001J\u0019\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\u0002HÖ\u0001R\u0014\u0010\u0004\u001a\u00020\u00058VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u0014"}, m3636d2 = {"com/truelayer/payments/core/network/mandates/entity/response/MandateResponse.Authorizing.$serializer", "Lkotlinx/serialization/internal/GeneratedSerializer;", "Lcom/truelayer/payments/core/network/mandates/entity/response/MandateResponse$Authorizing;", "()V", "descriptor", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "childSerializers", "", "Lkotlinx/serialization/KSerializer;", "()[Lkotlinx/serialization/KSerializer;", "deserialize", "decoder", "Lkotlinx/serialization/encoding/Decoder;", "serialize", "", "encoder", "Lkotlinx/serialization/encoding/Encoder;", "value", "payments-core_release"}, m3637k = 1, m3638mv = {1, 9, 0}, m3640xi = 48)
@Deprecated
/* renamed from: com.truelayer.payments.core.network.mandates.entity.response.MandateResponse$Authorizing$$serializer, reason: use source file name */
/* loaded from: classes6.dex */
public final class MandateResponse4 implements PluginHelperInterfaces<MandateResponse.Authorizing> {
    public static final MandateResponse4 INSTANCE;
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        MandateResponse4 mandateResponse4 = new MandateResponse4();
        INSTANCE = mandateResponse4;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("authorizing", mandateResponse4, 9);
    ...
    private MandateResponse4() {
    }

    @Override // kotlinx.serialization.internal.PluginHelperInterfaces
    public KSerializer<?>[] childSerializers() {
        KSerializer<?>[] kSerializerArr = MandateResponse.Authorizing.$childSerializers;
        StringSerializer stringSerializer = StringSerializer.INSTANCE;
        return new KSerializer[]{stringSerializer, stringSerializer, kSerializerArr[2], MandateConstraints3.INSTANCE, kSerializerArr[4], BuiltinSerializers.getNullable(stringSerializer), BuiltinSerializers.getNullable(User4.INSTANCE), BuiltinSerializers.getNullable(RelatedProducts2.INSTANCE), AuthorizationFlow3.INSTANCE};
    }

    @Override // kotlinx.serialization.KSerializer2
    public MandateResponse.Authorizing deserialize(Decoding2 decoder) {
        int i;
        ...
        if (decodingBeginStructure.decodeSequentially()) {
            ...
            authorizationFlow = (AuthorizationFlow) decodingBeginStructure.decodeSerializableElement(descriptor2, 8, AuthorizationFlow3.INSTANCE, null);
            i = 511;
            ...
            while (z) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 7:
                        ...
                        i4 |= 128;
                    case 8:
                        authorizationFlow2 = (AuthorizationFlow) decodingBeginStructure.decodeSerializableElement(descriptor2, 8, AuthorizationFlow3.INSTANCE, authorizationFlow2);
                        i4 |= 256;
                    default:
        ...
        return new MandateResponse.Authorizing(i, str2, str3, providerSelection, mandateConstraints, beneficiary, str, user, relatedProducts, authorizationFlow, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoding4 encoder, MandateResponse.Authorizing value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        Encoding3 encoding3BeginStructure = encoder.beginStructure(descriptor2);
        MandateResponse.Authorizing.write$Self$payments_core_release(value, encoding3BeginStructure, descriptor2);

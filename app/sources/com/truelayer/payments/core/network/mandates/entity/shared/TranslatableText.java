...
public final /* data */ class TranslatableText implements IntoDomain<com.truelayer.payments.core.domain.payments.TranslatableText> {
    ...
    /* compiled from: TranslatableText.kt */
    @Metadata(m3635d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m3636d2 = {"Lcom/truelayer/payments/core/network/mandates/entity/shared/TranslatableText$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/truelayer/payments/core/network/mandates/entity/shared/TranslatableText;", "payments-core_release"}, m3637k = 1, m3638mv = {1, 9, 0}, m3640xi = 48)
    public static final class Companion {
        ...
        public final KSerializer<TranslatableText> serializer() {
            return TranslatableText3.INSTANCE;
        }
    }
    ...
    public /* synthetic */ TranslatableText(int i, @SerialName(AnalyticsStrings.BUTTON_ACCESSIBLE_COLORS_DEFAULT) String str, @SerialName("key") String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i & 1)) {
            PluginExceptions.throwMissingFieldException(i, 1, TranslatableText3.INSTANCE.getDescriptor());
        }
        this.default = str;
        if ((i & 2) == 0) {
            this.key = null;

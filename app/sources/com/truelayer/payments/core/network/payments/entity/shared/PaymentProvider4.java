...
@Metadata(m3635d1 = {"\u00006\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0003J\u0018\u0010\b\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\n0\tHÖ\u0001¢\u0006\u0002\u0010\u000bJ\u0011\u0010\f\u001a\u00020\u00022\u0006\u0010\r\u001a\u00020\u000eHÖ\u0001J\u0019\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\u0002HÖ\u0001R\u0014\u0010\u0004\u001a\u00020\u00058VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u0014"}, m3636d2 = {"com/truelayer/payments/core/network/payments/entity/shared/PaymentProvider.$serializer", "Lkotlinx/serialization/internal/GeneratedSerializer;", "Lcom/truelayer/payments/core/network/payments/entity/shared/PaymentProvider;", "()V", "descriptor", "Lkotlinx/serialization/descriptors/SerialDescriptor;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "childSerializers", "", "Lkotlinx/serialization/KSerializer;", "()[Lkotlinx/serialization/KSerializer;", "deserialize", "decoder", "Lkotlinx/serialization/encoding/Decoder;", "serialize", "", "encoder", "Lkotlinx/serialization/encoding/Encoder;", "value", "payments-core_release"}, m3637k = 1, m3638mv = {1, 9, 0}, m3640xi = 48)
@Deprecated
/* renamed from: com.truelayer.payments.core.network.payments.entity.shared.PaymentProvider$$serializer, reason: use source file name */
/* loaded from: classes6.dex */
public final class PaymentProvider4 implements PluginHelperInterfaces<PaymentProvider> {
    public static final PaymentProvider4 INSTANCE;
    private static final /* synthetic */ PluginGeneratedSerialDescriptor descriptor;

    static {
        PaymentProvider4 paymentProvider4 = new PaymentProvider4();
        INSTANCE = paymentProvider4;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.truelayer.payments.core.network.payments.entity.shared.PaymentProvider", paymentProvider4, 8);
    ...
    public KSerializer<?>[] childSerializers() {
        ...
        KSerializer<?> nullable = BuiltinSerializers.getNullable(ProviderAvailability4.INSTANCE);
        KSerializer<?> nullable2 = BuiltinSerializers.getNullable(kSerializerArr[7]);
        StringSerializer stringSerializer = StringSerializer.INSTANCE;
        return new KSerializer[]{stringSerializer, stringSerializer, stringSerializer, stringSerializer, stringSerializer, kSerializer, nullable, nullable2};
    }
    ...
    public PaymentProvider deserialize(Decoding2 decoder) {
        ...
        if (decodingBeginStructure.decodeSequentially()) {
            ...
            List list3 = (List) decodingBeginStructure.decodeSerializableElement(descriptor2, 5, kSerializerArr[5], null);
            ProviderAvailability providerAvailability2 = (ProviderAvailability) decodingBeginStructure.decodeNullableSerializableElement(descriptor2, 6, ProviderAvailability4.INSTANCE, null);
            list = (List) decodingBeginStructure.decodeNullableSerializableElement(descriptor2, 7, kSerializerArr[7], null);
            ...
            while (z) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        list5 = (List) decodingBeginStructure.decodeSerializableElement(descriptor2, 5, kSerializerArr[5], list5);
                        i2 |= 32;
                        break;
                    case 6:
                        providerAvailability3 = (ProviderAvailability) decodingBeginStructure.decodeNullableSerializableElement(descriptor2, 6, ProviderAvailability4.INSTANCE, providerAvailability3);
                        i2 |= 64;
                        break;
                    case 7:
                        list4 = (List) decodingBeginStructure.decodeNullableSerializableElement(descriptor2, 7, kSerializerArr[7], list4);
                        i2 |= 128;
                        break;
                    default:
        ...
        return new PaymentProvider(i, str, str2, str3, str4, str5, list2, providerAvailability, list, (SerializationConstructorMarker) null);
    }

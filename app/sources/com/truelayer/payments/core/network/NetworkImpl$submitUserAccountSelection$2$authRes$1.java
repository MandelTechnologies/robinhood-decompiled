...
@DebugMetadata(m3644c = "com.truelayer.payments.core.network.NetworkImpl$submitUserAccountSelection$2$authRes$1", m3645f = "NetworkImpl.kt", m3646l = {300}, m3647m = "invokeSuspend")
/* loaded from: classes6.dex */
final class NetworkImpl$submitUserAccountSelection$2$authRes$1 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Outcome<? extends AuthorizationFlowResponse, ? extends CoreError>>, Object> {
    ...
    NetworkImpl$submitUserAccountSelection$2$authRes$1(NetworkImpl networkImpl, PaymentContext paymentContext, String str, Continuation<? super NetworkImpl$submitUserAccountSelection$2$authRes$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new NetworkImpl$submitUserAccountSelection$2$authRes$1(this.this$0, this.$paymentContext, this.$userAccountId, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Outcome<? extends AuthorizationFlowResponse, ? extends CoreError>> continuation) {
        return ((NetworkImpl$submitUserAccountSelection$2$authRes$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        this.label = 1;
        Object objSubmitUserAccountSelection = paymentApi.submitUserAccountSelection(resourceToken, idempotencyKey, paymentId, str, this);
        return objSubmitUserAccountSelection == coroutine_suspended ? coroutine_suspended : objSubmitUserAccountSelection;
    }
}

...
public final /* data */ class HttpHeader {
    ...
    /* compiled from: HttpHeader.kt */
    @Metadata(m3635d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m3636d2 = {"Lcom/truelayer/payments/analytics/configuration/HttpHeader$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/truelayer/payments/analytics/configuration/HttpHeader;", "payments-analytics_release"}, m3637k = 1, m3638mv = {1, 9, 0}, m3640xi = 48)
    public static final class Companion {
        ...
        public final KSerializer<HttpHeader> serializer() {
            return HttpHeader2.INSTANCE;
        }
    }

    @Deprecated
    public /* synthetic */ HttpHeader(int i, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i & 3)) {
            PluginExceptions.throwMissingFieldException(i, 3, HttpHeader2.INSTANCE.getDescriptor());
        }
        this.name = str;
        this.value = str2;
    }
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$payments_analytics_release(HttpHeader self, Encoding3 output, SerialDescriptor serialDesc) {

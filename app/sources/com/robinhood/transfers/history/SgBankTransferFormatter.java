...
/* compiled from: SgBankTransferFormatter.kt */
@Metadata(m3635d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\r\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0011\b\u0007\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\u0010\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\u0002H\u0016J\u0010\u0010\n\u001a\u00020\u000b2\u0006\u0010\t\u001a\u00020\u0002H\u0016J\u0012\u0010\f\u001a\u0004\u0018\u00010\r2\u0006\u0010\t\u001a\u00020\u0002H\u0016J\u0016\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u00100\u000f2\u0006\u0010\t\u001a\u00020\u0002H\u0016¨\u0006\u0011"}, m3636d2 = {"Lcom/robinhood/transfers/history/SgBankTransferFormatter;", "Lcom/robinhood/android/common/history/ui/format/AbstractMinervaTransactionFormatter;", "Lcom/robinhood/shared/models/history/SgBankTransferTransaction;", "resources", "Landroid/content/res/Resources;", "<init>", "(Landroid/content/res/Resources;)V", "getPrimaryText", "", "transaction", "getAmountText", "", "getSummaryBadge", "Lcom/robinhood/android/common/history/ui/format/TransactionSummary$Badge;", "getLineItems", "", "Lcom/robinhood/android/common/history/ui/format/TransactionLineItem;", "lib-history_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
/* loaded from: classes12.dex */
public final class SgBankTransferFormatter extends AbstractMinervaTransactionFormatter<SgBankTransferTransaction> {
    ...
    public SgBankTransferFormatter(Resources resources) {
        super(resources);
        Intrinsics.checkNotNullParameter(resources, "resources");
    }

    @Override // com.robinhood.android.common.history.p082ui.format.HistoryTransactionFormatter
    public String getPrimaryText(SgBankTransferTransaction transaction) {
        int i;
        int i2;
        ...
        if (bankName == null || bankName.length() == 0) {
            ...
            if (i3 == 1) {
                i = C41787R.string.fast_deposit_title;
            } else {
                if (i3 != 2) {
                    throw new NoWhenBranchMatchedException();
                }
                i = C41787R.string.fast_withdrawal_title;
            }
            return getString(i);
        }
        int i4 = WhenMappings.$EnumSwitchMapping$0[transaction.getEvent().getDirection().ordinal()];
        if (i4 == 1) {
            i2 = C41787R.string.fast_deposit_from_title;
        } else {
            if (i4 != 2) {
                throw new NoWhenBranchMatchedException();
            }
            i2 = C41787R.string.fast_withdrawal_to_title;
        }
    ...
    public CharSequence getAmountText(SgBankTransferTransaction transaction) {
        Intrinsics.checkNotNullParameter(transaction, "transaction");
        return Money.Adjustment.format$default(transaction.getEvent().getAdjustment(), false, null, 3, null);
    }

    @Override // com.robinhood.android.common.history.p082ui.format.AbstractMinervaTransactionFormatter, com.robinhood.android.common.history.p082ui.format.HistoryTransactionFormatter
    public TransactionSummary.Badge getSummaryBadge(SgBankTransferTransaction transaction) {
        Intrinsics.checkNotNullParameter(transaction, "transaction");
    ...
    public List<TransactionLineItem> mo25632getLineItems(SgBankTransferTransaction transaction) {
        Intrinsics.checkNotNullParameter(transaction, "transaction");

...
final class ComposableSingletons$TargetedScrollKt$lambda$746506159$1 implements Function3<TargetedScrollRowScope<Integer>, Composer, Integer, Unit> {
    public static final ComposableSingletons$TargetedScrollKt$lambda$746506159$1 INSTANCE = new ComposableSingletons$TargetedScrollKt$lambda$746506159$1();

    ComposableSingletons$TargetedScrollKt$lambda$746506159$1() {
    }
    ...
    public final void invoke(final TargetedScrollRowScope<Integer> TargetedScrollRow, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(746506159, i2, -1, "com.robinhood.utils.compose.ComposableSingletons$TargetedScrollKt.lambda$746506159.<anonymous> (TargetedScroll.kt:296)");
        }
        final int i3 = 1;
        while (i3 < 26) {
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new Function0() { // from class: com.robinhood.utils.compose.ComposableSingletons$TargetedScrollKt$lambda$746506159$1$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        return ComposableSingletons$TargetedScrollKt$lambda$746506159$1.invoke$lambda$1$lambda$0(TargetedScrollRow, i3);
                    }
                };
    ...
    public static final Unit invoke$lambda$1$lambda$0(TargetedScrollRowScope targetedScrollRowScope, int i) {
        targetedScrollRowScope.centerOn(Integer.valueOf(i));
        return Unit.INSTANCE;
    }
}

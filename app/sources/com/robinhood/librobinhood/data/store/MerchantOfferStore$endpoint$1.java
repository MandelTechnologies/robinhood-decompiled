...
@DebugMetadata(m3644c = "com.robinhood.librobinhood.data.store.MerchantOfferStore$endpoint$1", m3645f = "MerchantOfferStore.kt", m3646l = {35}, m3647m = "invokeSuspend")
/* loaded from: classes13.dex */
final class MerchantOfferStore$endpoint$1 extends ContinuationImpl7 implements Function2<Tuples2<? extends Unit, ? extends PaginationCursor>, Continuation<? super PaginatedResult<? extends ApiMerchantOfferV2>>, Object> {
    int label;
    final /* synthetic */ MerchantOfferStore this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    MerchantOfferStore$endpoint$1(MerchantOfferStore merchantOfferStore, Continuation<? super MerchantOfferStore$endpoint$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MerchantOfferStore$endpoint$1(this.this$0, continuation);
    }
    ...
    public final Object invoke2(Tuples2<Unit, PaginationCursor> tuples2, Continuation<? super PaginatedResult<ApiMerchantOfferV2>> continuation) {
        return ((MerchantOfferStore$endpoint$1) create(tuples2, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        this.label = 1;
        Object merchantOffersV2 = plutoApi.getMerchantOffersV2(null, this);

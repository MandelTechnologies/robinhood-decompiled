...
@DebugMetadata(m3644c = "com.robinhood.librobinhood.data.store.TraderInvestmentScheduleEventStore$getInvestmentScheduleEventsByAchTransfer$1", m3645f = "TraderInvestmentScheduleEventStore.kt", m3646l = {108}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.librobinhood.data.store.TraderInvestmentScheduleEventStore$getInvestmentScheduleEventsByAchTransfer$1, reason: use source file name */
/* loaded from: classes13.dex */
final class TraderInvestmentScheduleEventStore4 extends ContinuationImpl7 implements Function2<Tuples2<? extends UUID, ? extends PaginationCursor>, Continuation<? super PaginatedResult<? extends ApiInvestmentScheduleEvent>>, Object> {
    /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ TraderInvestmentScheduleEventStore this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TraderInvestmentScheduleEventStore4(TraderInvestmentScheduleEventStore traderInvestmentScheduleEventStore, Continuation<? super TraderInvestmentScheduleEventStore4> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        TraderInvestmentScheduleEventStore4 traderInvestmentScheduleEventStore4 = new TraderInvestmentScheduleEventStore4(this.this$0, continuation);
        traderInvestmentScheduleEventStore4.L$0 = obj;
        return traderInvestmentScheduleEventStore4;
    }
    ...
    public final Object invoke2(Tuples2<UUID, PaginationCursor> tuples2, Continuation<? super PaginatedResult<ApiInvestmentScheduleEvent>> continuation) {
        return ((TraderInvestmentScheduleEventStore4) create(tuples2, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        this.label = 1;
        Object filteredInvestmentScheduleEvents$default = RecurringApi.DefaultImpls.getFilteredInvestmentScheduleEvents$default(recurringApi, null, uuid, null, value, null, null, this, 48, null);

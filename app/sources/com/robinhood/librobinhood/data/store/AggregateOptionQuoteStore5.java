...
@DebugMetadata(m3644c = "com.robinhood.librobinhood.data.store.AggregateOptionQuoteStore$extendedHoursEndpoint$3", m3645f = "AggregateOptionQuoteStore.kt", m3646l = {}, m3647m = "invokeSuspend")
@SourceDebugExtension
/* renamed from: com.robinhood.librobinhood.data.store.AggregateOptionQuoteStore$extendedHoursEndpoint$3, reason: use source file name */
/* loaded from: classes13.dex */
final class AggregateOptionQuoteStore5 extends ContinuationImpl7 implements Function2<PaginatedResult<? extends ApiAggregateOptionQuote>, Continuation<? super Unit>, Object> {
    ...
    AggregateOptionQuoteStore5(AggregateOptionQuoteStore aggregateOptionQuoteStore, Clock clock, Continuation<? super AggregateOptionQuoteStore5> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        AggregateOptionQuoteStore5 aggregateOptionQuoteStore5 = new AggregateOptionQuoteStore5(this.this$0, this.$clock, continuation);
        aggregateOptionQuoteStore5.L$0 = obj;
        return aggregateOptionQuoteStore5;
    }
    ...
    public final Object invoke2(PaginatedResult<ApiAggregateOptionQuote> paginatedResult, Continuation<? super Unit> continuation) {
        return ((AggregateOptionQuoteStore5) create(paginatedResult, continuation)).invokeSuspend(Unit.INSTANCE);
    }

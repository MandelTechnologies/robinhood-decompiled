...
/* synthetic */ class OrderStore$postOrder$2 extends AdaptedFunctionReference implements Function2<ApiOrder, Continuation<? super Unit>, Object>, ContinuationImpl6 {
    OrderStore$postOrder$2(Object obj) {
    ...
    public final Object invoke(ApiOrder apiOrder, Continuation<? super Unit> continuation) {
        return OrderStore.postOrder$insert((OrderDao) this.receiver, apiOrder, continuation);
    }
}

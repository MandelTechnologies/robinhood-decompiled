...
@DebugMetadata(m3644c = "com.robinhood.librobinhood.data.store.OneDayChartStore$tokenizedStockOneDayChartBatchedEndpoint$1", m3645f = "OneDayChartStore.kt", m3646l = {EnumC7081g.SDK_ASSET_ILLUSTRATION_DEPOSIT_SWITCH_VALUE}, m3647m = "invokeSuspend")
@SourceDebugExtension
/* loaded from: classes13.dex */
final class OneDayChartStore$tokenizedStockOneDayChartBatchedEndpoint$1 extends ContinuationImpl7 implements Function2<Tuples2<? extends Iterable<? extends OneDayChartStore.InstrumentOneDayChartRequest>, ? extends PaginationCursor>, Continuation<? super PaginatedResult<? extends ApiInstrumentOneDayChart>>, Object> {
    /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ OneDayChartStore this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    OneDayChartStore$tokenizedStockOneDayChartBatchedEndpoint$1(OneDayChartStore oneDayChartStore, Continuation<? super OneDayChartStore$tokenizedStockOneDayChartBatchedEndpoint$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        OneDayChartStore$tokenizedStockOneDayChartBatchedEndpoint$1 oneDayChartStore$tokenizedStockOneDayChartBatchedEndpoint$1 = new OneDayChartStore$tokenizedStockOneDayChartBatchedEndpoint$1(this.this$0, continuation);
        oneDayChartStore$tokenizedStockOneDayChartBatchedEndpoint$1.L$0 = obj;
        return oneDayChartStore$tokenizedStockOneDayChartBatchedEndpoint$1;
    }
    ...
    public final Object invoke2(Tuples2<? extends Iterable<OneDayChartStore.InstrumentOneDayChartRequest>, PaginationCursor> tuples2, Continuation<? super PaginatedResult<ApiInstrumentOneDayChart>> continuation) {
        return ((OneDayChartStore$tokenizedStockOneDayChartBatchedEndpoint$1) create(tuples2, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        InstrumentType instrumentType = InstrumentType.CRYPTO_TOKENIZED_STOCKS;

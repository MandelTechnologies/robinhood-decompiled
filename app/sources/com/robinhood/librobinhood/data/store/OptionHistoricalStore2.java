...
@DebugMetadata(m3644c = "com.robinhood.librobinhood.data.store.OptionHistoricalStore$endpoint$1", m3645f = "OptionHistoricalStore.kt", m3646l = {47}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.librobinhood.data.store.OptionHistoricalStore$endpoint$1, reason: use source file name */
/* loaded from: classes13.dex */
final class OptionHistoricalStore2 extends ContinuationImpl7 implements Function2<OptionHistoricalStore.QueryParams, Continuation<? super ApiOptionHistorical>, Object> {
    /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ OptionHistoricalStore this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    OptionHistoricalStore2(OptionHistoricalStore optionHistoricalStore, Continuation<? super OptionHistoricalStore2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        OptionHistoricalStore2 optionHistoricalStore2 = new OptionHistoricalStore2(this.this$0, continuation);
        optionHistoricalStore2.L$0 = obj;
        return optionHistoricalStore2;
    }
    ...
    public final Object invoke(OptionHistoricalStore.QueryParams queryParams, Continuation<? super ApiOptionHistorical> continuation) {
        return ((OptionHistoricalStore2) create(queryParams, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        OptionChain optionChain = queryParams.getOptionChain();
        ...
        String serverValue3 = GraphSelection.INSTANCE.getBoundsForOption(optionChain.getLateCloseState().getIsLateClosing()).getServerValue();

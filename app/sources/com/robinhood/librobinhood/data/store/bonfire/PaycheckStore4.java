...
@DebugMetadata(m3644c = "com.robinhood.librobinhood.data.store.bonfire.PaycheckStore$rhyPaycheckEndpointV2$1", m3645f = "PaycheckStore.kt", m3646l = {EnumC7081g.SDK_ASSET_ILLUSTRATION_INSTITUTION_CIRCLE_VALUE, 74}, m3647m = "invokeSuspend")
@SourceDebugExtension
/* renamed from: com.robinhood.librobinhood.data.store.bonfire.PaycheckStore$rhyPaycheckEndpointV2$1, reason: use source file name */
/* loaded from: classes13.dex */
final class PaycheckStore4 extends ContinuationImpl7 implements Function2<Tuples2<? extends Unit, ? extends PaginationCursor>, Continuation<? super PaginatedResult<? extends ApiPaycheckV2>>, Object> {
    int label;
    final /* synthetic */ PaycheckStore this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    PaycheckStore4(PaycheckStore paycheckStore, Continuation<? super PaycheckStore4> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new PaycheckStore4(this.this$0, continuation);
    }
    ...
    public final Object invoke2(Tuples2<Unit, PaginationCursor> tuples2, Continuation<? super PaginatedResult<ApiPaycheckV2>> continuation) {
        return ((PaycheckStore4) create(tuples2, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Observable observableCombineLatest = Observables.INSTANCE.combineLatest(this.this$0.accountProvider.streamIndividualAccount(), ObservablesKt.filterIsPresent(this.this$0.rhyAccountStore.streamSpendingAccount()));
            this.label = 1;
            obj = RxAwait3.awaitFirst(observableCombineLatest, this);
        ...
        RhyAccount rhyAccount = (RhyAccount) tuples2.component2();
        RhyBonfireApi rhyBonfireApi = this.this$0.bonfireApi;
        String string2 = rhyAccount.getId().toString();
        Intrinsics.checkNotNullExpressionValue(string2, "toString(...)");
        String accountNumber = account.getAccountNumber();
        this.label = 2;
        Object directDepositPaychecksV2 = rhyBonfireApi.getDirectDepositPaychecksV2(string2, "rhy", accountNumber, this);

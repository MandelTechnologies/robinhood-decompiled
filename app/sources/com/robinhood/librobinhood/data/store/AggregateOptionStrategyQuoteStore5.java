...
@DebugMetadata(m3644c = "com.robinhood.librobinhood.data.store.AggregateOptionStrategyQuoteStore$extendedHoursEndpoint$3", m3645f = "AggregateOptionStrategyQuoteStore.kt", m3646l = {}, m3647m = "invokeSuspend")
@SourceDebugExtension
/* renamed from: com.robinhood.librobinhood.data.store.AggregateOptionStrategyQuoteStore$extendedHoursEndpoint$3, reason: use source file name */
/* loaded from: classes13.dex */
final class AggregateOptionStrategyQuoteStore5 extends ContinuationImpl7 implements Function2<PaginatedResult<? extends ApiAggregateOptionQuote>, Continuation<? super Unit>, Object> {
    ...
    AggregateOptionStrategyQuoteStore5(AggregateOptionStrategyQuoteStore aggregateOptionStrategyQuoteStore, Clock clock, Continuation<? super AggregateOptionStrategyQuoteStore5> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        AggregateOptionStrategyQuoteStore5 aggregateOptionStrategyQuoteStore5 = new AggregateOptionStrategyQuoteStore5(this.this$0, this.$clock, continuation);
        aggregateOptionStrategyQuoteStore5.L$0 = obj;
        return aggregateOptionStrategyQuoteStore5;
    }
    ...
    public final Object invoke2(PaginatedResult<ApiAggregateOptionQuote> paginatedResult, Continuation<? super Unit> continuation) {
        return ((AggregateOptionStrategyQuoteStore5) create(paginatedResult, continuation)).invokeSuspend(Unit.INSTANCE);
    }

...
@Metadata(m3635d1 = {"\u0000T\n\u0000\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\u001a \u0010\u0000\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001*\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007\u001a'\u0010\u0007\u001a\u00020\u0004*\b\u0012\u0004\u0012\u00020\u00040\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u0005\u001a\u00020\u0006H\u0007¢\u0006\u0002\b\u000b\u001aA\u0010\u0007\u001a\u00020\u0004*\b\u0012\u0004\u0012\u00020\u00040\b2\u0006\u0010\f\u001a\u00020\r2\u0010\u0010\u000e\u001a\f\u0012\b\u0012\u00060\u0010j\u0002`\u00110\u000f2\u0006\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0005\u001a\u00020\u0006H\u0007¢\u0006\u0002\b\u000b\u001a0\u0010\u0014\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00160\u0015*\u00020\u00042\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0005\u001a\u00020\u0006H\u0007\"$\u0010\u0017\u001a\u00020\u0018*\b\u0012\u0004\u0012\u00020\u00040\b8GX\u0087\u0004¢\u0006\f\u0012\u0004\b\u0019\u0010\u001a\u001a\u0004\b\u001b\u0010\u001c¨\u0006\u001d"}, m3636d2 = {"endpoints", "", "", "Lmicrogram/service/protocol/ServiceCallable;", "Lcom/robinhood/equity/ordersummary/contracts/EquityOrderSummaryService;", "json", "Lkotlinx/serialization/json/Json;", "createClient", "Lkotlin/reflect/KClass;", "bridge", "Lmicrogram/service/bridge/ClientBridge;", "createClient_EquityOrderSummaryService", "coroutineScope", "Lkotlinx/coroutines/CoroutineScope;", "uuidGenerator", "Lmicrogram/generator/IdGenerator;", "Ljava/util/UUID;", "Lcom/benasher44/uuid/Uuid;", "messageDispatcher", "Lmicrogram/MessageDispatcher;", "createMessageHandler", "Lkotlin/Pair;", "Lmicrogram/MessageHandler;", "contractAnnotation", "Lmicrogram/annotation/Contract;", "getContractAnnotation_EquityOrderSummaryService$annotations", "(Lkotlin/reflect/KClass;)V", "getContractAnnotation_EquityOrderSummaryService", "(Lkotlin/reflect/KClass;)Lmicrogram/annotation/Contract;", "contracts"}, m3637k = 2, m3638mv = {2, 0, 0}, m3640xi = 48)
...
public final class EquityOrderSummaryService_AdapterKt {
    ...
    public static final Map<String, ServiceCallable> endpoints(EquityOrderSummaryService equityOrderSummaryService, Json json) {
        ...
        return MapsKt.mapOf(Tuples4.m3642to("getOrderSummary", new EquityOrderSummaryService_Adapter.Endpoint_getOrderSummary(equityOrderSummaryService, json)), Tuples4.m3642to("streamOrderConfirmation", new EquityOrderSummaryService_Adapter.Endpoint_streamOrderConfirmation(equityOrderSummaryService, json)), Tuples4.m3642to("getOrderConfirmation", new EquityOrderSummaryService_Adapter.Endpoint_getOrderConfirmation(equityOrderSummaryService, json)));
    }
    ...
    public static final EquityOrderSummaryService createClient_EquityOrderSummaryService(KClass<EquityOrderSummaryService> kClass, CoroutineScope coroutineScope, IdGenerator<UUID> uuidGenerator, MessageDispatcher messageDispatcher, Json json) {
        ...
        Intrinsics.checkNotNullParameter(json, "json");
        PeerClientBridge peerClientBridge = new PeerClientBridge(Peer5.peer(messageDispatcher, "EquityOrderSummary#implementation", json), uuidGenerator);
        messageDispatcher.registerMessageHandler("EquityOrderSummary#client", ProtocolMessageSubscriber4.createMessageHandler(peerClientBridge, coroutineScope, json));
    ...
    public static final Tuples2<String, MessageDispatcher2> createMessageHandler(EquityOrderSummaryService equityOrderSummaryService, CoroutineScope coroutineScope, MessageDispatcher messageDispatcher, Json json) {
        ...
        Intrinsics.checkNotNullParameter(messageDispatcher, "messageDispatcher");
        Intrinsics.checkNotNullParameter(json, "json");
        return new Tuples2<>("EquityOrderSummary#implementation", ProtocolMessageSubscriber4.createMessageHandler(new ImplementationBridge(coroutineScope, new Endpoints3(json, endpoints(equityOrderSummaryService, json)), Peer5.peer(messageDispatcher, "EquityOrderSummary#client", json)), coroutineScope, json));
    }
    ...
    public static final ManagedServices getContractAnnotation_EquityOrderSummaryService(KClass<EquityOrderSummaryService> kClass) {
        Intrinsics.checkNotNullParameter(kClass, "<this>");
        final String str = "EquityOrderSummary";
        return new ManagedServices(str) { // from class: com.robinhood.equity.ordersummary.contracts.EquityOrderSummaryService_AdapterKt$annotationImpl$microgram_annotation_Contract$0

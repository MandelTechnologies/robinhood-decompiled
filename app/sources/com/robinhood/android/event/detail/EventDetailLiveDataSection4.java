...
/* renamed from: com.robinhood.android.event.detail.EventDetailLiveDataSectionKt$EventDetailLiveDataSection$2$3$1, reason: use source file name */
/* loaded from: classes3.dex */
final class EventDetailLiveDataSection4 implements Function1<ConstrainScope, Unit> {
    final /* synthetic */ ConstraintLayoutBaseScope.VerticalAnchor $endGuideline;
    final /* synthetic */ ConstraintLayoutBaseScope4 $secondaryText;
    final /* synthetic */ ConstraintLayoutBaseScope.VerticalAnchor $startGuideline;

    EventDetailLiveDataSection4(ConstraintLayoutBaseScope4 constraintLayoutBaseScope4, ConstraintLayoutBaseScope.VerticalAnchor verticalAnchor, ConstraintLayoutBaseScope.VerticalAnchor verticalAnchor2) {
        this.$secondaryText = constraintLayoutBaseScope4;
    ...
    public final void invoke2(ConstrainScope constrainAs) {
        ...
        ConstraintScopeCommon5.m8162linkToVpY3zN4$default(constrainAs.getBottom(), this.$secondaryText.getTop(), 0.0f, 0.0f, 6, null);

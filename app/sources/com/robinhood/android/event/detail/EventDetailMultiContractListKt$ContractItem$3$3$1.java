...
final class EventDetailMultiContractListKt$ContractItem$3$3$1 implements Function1<ConstrainScope, Unit> {
    final /* synthetic */ ConstraintLayoutBaseScope4 $name;

    EventDetailMultiContractListKt$ContractItem$3$3$1(ConstraintLayoutBaseScope4 constraintLayoutBaseScope4) {
    ...
    public final void invoke2(ConstrainScope constrainAs) {
        ...
        ConstraintScopeCommon6.m8185linkToVpY3zN4$default(constrainAs.getStart(), this.$name.getEnd(), 0.0f, 0.0f, 6, null);

...
public final class GameDetailFragment_MembersInjector implements MembersInjector<GameDetailFragment> {
    ...
    @JvmStatic
    public static final MembersInjector<GameDetailFragment> create(Provider<BaseFragmentSingletons> provider, Provider<GenericComposeSingletons> provider2, Provider<CrossSellLaunchManager> provider3, Provider<PictureInPictureStore> provider4) {
        return INSTANCE.create(provider, provider2, provider3, provider4);
    }

    @JvmStatic
    public static final void injectCrossSellLaunchManager(GameDetailFragment gameDetailFragment, CrossSellLaunchManager crossSellLaunchManager) {
        INSTANCE.injectCrossSellLaunchManager(gameDetailFragment, crossSellLaunchManager);
    }

    @JvmStatic
    public static final void injectPipSupportStore(GameDetailFragment gameDetailFragment, PictureInPictureStore pictureInPictureStore) {
        INSTANCE.injectPipSupportStore(gameDetailFragment, pictureInPictureStore);
    }

    public GameDetailFragment_MembersInjector(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<CrossSellLaunchManager> crossSellLaunchManager, Provider<PictureInPictureStore> pipSupportStore) {
    ...
    public void injectMembers(GameDetailFragment instance) {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final MembersInjector<GameDetailFragment> create(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<CrossSellLaunchManager> crossSellLaunchManager, Provider<PictureInPictureStore> pipSupportStore) {
            Intrinsics.checkNotNullParameter(singletons, "singletons");
            Intrinsics.checkNotNullParameter(genericComposeSingletons, "genericComposeSingletons");
            Intrinsics.checkNotNullParameter(crossSellLaunchManager, "crossSellLaunchManager");
            Intrinsics.checkNotNullParameter(pipSupportStore, "pipSupportStore");
            return new GameDetailFragment_MembersInjector(singletons, genericComposeSingletons, crossSellLaunchManager, pipSupportStore);
        }

        @JvmStatic
        public final void injectCrossSellLaunchManager(GameDetailFragment instance, CrossSellLaunchManager crossSellLaunchManager) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(crossSellLaunchManager, "crossSellLaunchManager");
        ...
        @JvmStatic
        public final void injectPipSupportStore(GameDetailFragment instance, PictureInPictureStore pipSupportStore) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(pipSupportStore, "pipSupportStore");

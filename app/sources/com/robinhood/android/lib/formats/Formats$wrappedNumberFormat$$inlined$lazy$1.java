...
public final class Formats$wrappedNumberFormat$$inlined$lazy$1 extends ThreadLocal<DefaultNumberFormatter> {
    ...
    public Formats$wrappedNumberFormat$$inlined$lazy$1(Function1 function1, Function1 function12, boolean z, boolean z2) {
    ...
    protected DefaultNumberFormatter initialValue() {
        ...
        Function1 function1 = this.$create$inlined;
        Locale US = Locale.US;
        Intrinsics.checkNotNullExpressionValue(US, "US");
        Object objInvoke = function1.invoke(US);
        this.$init$inlined.invoke(objInvoke);
        return formats.wrapNumberFormatForDecimalPlaces((NumberFormat) objInvoke, this.$enableSubPennyFormatting$inlined, this.$forceSubPennyTrailingZeros$inlined);
    }
}

...
public final class MergeNewsFeedArticleBinding implements ViewBinding {
    ...
    public static MergeNewsFeedArticleBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static MergeNewsFeedArticleBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C20334R.layout.merge_news_feed_article, viewGroup, false);
        if (z) {
    ...
    public static MergeNewsFeedArticleBinding bind(View view) {
                            ...
                            if (newsFeedRelatedInstrumentsView != null) {
                                ...
                                if (rhTextView != null) {
                                    ...
                                    if (rhTextView2 != null) {
                                        ...
                                        if (rhTextView3 != null) {
                                            return new MergeNewsFeedArticleBinding(constraintLayout, barrier, viewFindChildViewById, space, imageView, imageView2, imageView3, newsFeedRelatedInstrumentsView, constraintLayout, rhTextView, rhTextView2, rhTextView3);
                                        }
                                    }
                                }
                            }

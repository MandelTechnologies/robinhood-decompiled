...
public abstract class Hammer_EquityEventUpdatesView extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_EquityEventUpdatesView(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_EquityEventUpdatesView2 hammer_EquityEventUpdatesView2 = (Hammer_EquityEventUpdatesView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.equityeventupdates.EquityEventUpdatesView");
        hammer_EquityEventUpdatesView2.inject((EquityEventUpdatesView) this);
        this.injected = true;
    }
}

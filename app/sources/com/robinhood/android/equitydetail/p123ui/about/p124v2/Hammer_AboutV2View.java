...
public abstract class Hammer_AboutV2View extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_AboutV2View(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_AboutV2View2 hammer_AboutV2View2 = (Hammer_AboutV2View2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.about.v2.AboutV2View");
        hammer_AboutV2View2.inject((AboutV2View) this);
        this.injected = true;
    }
}

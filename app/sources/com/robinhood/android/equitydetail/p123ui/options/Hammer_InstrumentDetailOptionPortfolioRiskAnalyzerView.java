...
public abstract class Hammer_InstrumentDetailOptionPortfolioRiskAnalyzerView extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_InstrumentDetailOptionPortfolioRiskAnalyzerView(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_InstrumentDetailOptionPortfolioRiskAnalyzerView2 hammer_InstrumentDetailOptionPortfolioRiskAnalyzerView2 = (Hammer_InstrumentDetailOptionPortfolioRiskAnalyzerView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.options.InstrumentDetailOptionPortfolioRiskAnalyzerView");
        hammer_InstrumentDetailOptionPortfolioRiskAnalyzerView2.inject((InstrumentDetailOptionPortfolioRiskAnalyzerView) this);
        this.injected = true;
    }
}

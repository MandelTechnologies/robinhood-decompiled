...
public abstract class Hammer_RecurringInvestmentsEquityNuxComposableView extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_RecurringInvestmentsEquityNuxComposableView(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_RecurringInvestmentsEquityNuxComposableView2 hammer_RecurringInvestmentsEquityNuxComposableView2 = (Hammer_RecurringInvestmentsEquityNuxComposableView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.recurringinvestmentnux.RecurringInvestmentsEquityNuxComposableView");
        hammer_RecurringInvestmentsEquityNuxComposableView2.inject((RecurringInvestmentsEquityNuxComposableView) this);
        this.injected = true;
    }
}

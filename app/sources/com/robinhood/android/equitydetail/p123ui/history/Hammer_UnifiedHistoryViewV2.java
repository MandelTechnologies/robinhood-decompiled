...
public abstract class Hammer_UnifiedHistoryViewV2 extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_UnifiedHistoryViewV2(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_UnifiedHistoryViewV22 hammer_UnifiedHistoryViewV22 = (Hammer_UnifiedHistoryViewV22) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.history.UnifiedHistoryViewV2");
        hammer_UnifiedHistoryViewV22.inject((UnifiedHistoryViewV2) this);
        this.injected = true;
    }
}

...
public final /* data */ class PreIpoHeaderDataV2 extends DetailData {
    public static final int $stable = 8;
    private final StockDetailHeader ipoHeader;

    public static /* synthetic */ PreIpoHeaderDataV2 copy$default(PreIpoHeaderDataV2 preIpoHeaderDataV2, StockDetailHeader stockDetailHeader, int i, Object obj) {
        if ((i & 1) != 0) {
            stockDetailHeader = preIpoHeaderDataV2.ipoHeader;
        }
        return preIpoHeaderDataV2.copy(stockDetailHeader);
    }
    ...
    public final PreIpoHeaderDataV2 copy(StockDetailHeader ipoHeader) {
        Intrinsics.checkNotNullParameter(ipoHeader, "ipoHeader");
        return new PreIpoHeaderDataV2(ipoHeader);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof PreIpoHeaderDataV2) && Intrinsics.areEqual(this.ipoHeader, ((PreIpoHeaderDataV2) other).ipoHeader);
    }
    ...
    public String toString() {
        return "PreIpoHeaderDataV2(ipoHeader=" + this.ipoHeader + ")";
    }
    ...
    public PreIpoHeaderDataV2(StockDetailHeader ipoHeader) {
        super(null);
        Intrinsics.checkNotNullParameter(ipoHeader, "ipoHeader");

...
public abstract class Hammer_FaqView extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_FaqView(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_FaqView2 hammer_FaqView2 = (Hammer_FaqView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.faq.FaqView");
        hammer_FaqView2.inject((FaqView) this);
        this.injected = true;
    }
}

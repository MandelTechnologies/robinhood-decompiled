...
public abstract class Hammer_AssetDigestPreviewView extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_AssetDigestPreviewView(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_AssetDigestPreviewView2 hammer_AssetDigestPreviewView2 = (Hammer_AssetDigestPreviewView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.copilot.AssetDigestPreviewView");
        hammer_AssetDigestPreviewView2.inject((CopilotDigestPreviewView) this);
        this.injected = true;
    }
}

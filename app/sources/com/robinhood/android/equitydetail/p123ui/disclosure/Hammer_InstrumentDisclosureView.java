...
public abstract class Hammer_InstrumentDisclosureView extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_InstrumentDisclosureView(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_InstrumentDisclosureView2 hammer_InstrumentDisclosureView2 = (Hammer_InstrumentDisclosureView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.disclosure.InstrumentDisclosureView");
        hammer_InstrumentDisclosureView2.inject((InstrumentDisclosureView) this);
        this.injected = true;
    }
}

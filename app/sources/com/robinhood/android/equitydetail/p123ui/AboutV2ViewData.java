...
public final /* data */ class AboutV2ViewData extends DetailData implements EducationTourViewData {
    ...
    public static /* synthetic */ AboutV2ViewData copy$default(AboutV2ViewData aboutV2ViewData, Instrument instrument, int i, Object obj) {
        if ((i & 1) != 0) {
            instrument = aboutV2ViewData.instrument;
        }
        return aboutV2ViewData.copy(instrument);
    }
    ...
    public final AboutV2ViewData copy(Instrument instrument) {
        Intrinsics.checkNotNullParameter(instrument, "instrument");
        return new AboutV2ViewData(instrument);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof AboutV2ViewData) && Intrinsics.areEqual(this.instrument, ((AboutV2ViewData) other).instrument);
    }
    ...
    public String toString() {
        return "AboutV2ViewData(instrument=" + this.instrument + ")";
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AboutV2ViewData(Instrument instrument) {
        super(null);
        Intrinsics.checkNotNullParameter(instrument, "instrument");
        this.instrument = instrument;
        this.section = ApiStockDetail.Section.ABOUT;
        int i = C15314R.string.instrument_detail_about_label;
        String simpleName = instrument.getSimpleName();
        this.headerData = new HeaderData.FromResource(i, CollectionsKt.listOf(simpleName == null ? "" : simpleName), getSection(), EducationTourElementIds.ABOUT_HEADER_ELEMENT_ID);
        this.elementIds = CollectionsKt.mutableListOf(EducationTourElementIds.ABOUT_DESCRIPTION_ELEMENT_ID, EducationTourElementIds.ABOUT_FUND_MANAGEMENT_ELEMENT_ID, EducationTourElementIds.ABOUT_INDEX_TRACKED_ELEMENT_ID, EducationTourElementIds.ABOUT_CATEGORY_ELEMENT_ID, EducationTourElementIds.ABOUT_NUM_HOLDINGS_ELEMENT_ID, EducationTourElementIds.ABOUT_INCEPTION_DATE_ELEMENT_ID, EducationTourElementIds.ABOUT_CEO_ELEMENT_ID, EducationTourElementIds.ABOUT_EMPLOYEE_COUNT_ELEMENT_ID, EducationTourElementIds.ABOUT_HEADQUARTERS_ELEMENT_ID, EducationTourElementIds.ABOUT_FOUNDED_YEAR_ELEMENT_ID);
    }

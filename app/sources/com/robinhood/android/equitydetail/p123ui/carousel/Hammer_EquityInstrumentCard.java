...
public abstract class Hammer_EquityInstrumentCard<T> extends InstrumentCard<T> implements ViewComponentManagerHolder {
    ...
    private Hammer_EquityInstrumentCard(Context context) {
        super(context);
        ...
        Hammer_EquityInstrumentCard2 hammer_EquityInstrumentCard2 = (Hammer_EquityInstrumentCard2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.carousel.EquityInstrumentCard");
        hammer_EquityInstrumentCard2.inject((EquityInstrumentCard) this);
        this.injected = true;
    }

    private Hammer_EquityInstrumentCard(Context context, String str, String str2) {
    ...
    private Hammer_EquityInstrumentCard(Context context, String str, String str2, int i) {

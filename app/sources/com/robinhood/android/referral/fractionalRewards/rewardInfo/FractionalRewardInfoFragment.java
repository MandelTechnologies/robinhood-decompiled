...
/* compiled from: FractionalRewardInfoFragment.kt */
@Metadata(m3635d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0002\b\u0004\b\u0007\u0018\u0000 \u00132\u00020\u00012\u00020\u0002:\u0002\u0012\u0013B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\r\u0010\u000f\u001a\u00020\u0010H\u0017¢\u0006\u0002\u0010\u0011R\u0014\u0010\u0005\u001a\u00020\u0006X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u001b\u0010\t\u001a\u00020\n8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\r\u0010\u000e\u001a\u0004\b\u000b\u0010\f¨\u0006\u0014"}, m3636d2 = {"Lcom/robinhood/android/referral/fractionalRewards/rewardInfo/FractionalRewardInfoFragment;", "Lcom/robinhood/compose/app/GenericComposeFragment;", "Lcom/robinhood/android/autoeventlogging/AutoLoggableFragment;", "<init>", "()V", "eventScreen", "Lcom/robinhood/rosetta/eventlogging/Screen;", "getEventScreen", "()Lcom/robinhood/rosetta/eventlogging/Screen;", "callbacks", "Lcom/robinhood/android/referral/fractionalRewards/rewardInfo/FractionalRewardInfoFragment$Callbacks;", "getCallbacks", "()Lcom/robinhood/android/referral/fractionalRewards/rewardInfo/FractionalRewardInfoFragment$Callbacks;", "callbacks$delegate", "Lkotlin/properties/ReadOnlyProperty;", "ComposeContent", "", "(Landroidx/compose/runtime/Composer;I)V", "Callbacks", "Companion", "feature-referral_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
@SourceDebugExtension
/* loaded from: classes5.dex */
public final class FractionalRewardInfoFragment extends GenericComposeFragment implements AutoLoggableFragment {
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(FractionalRewardInfoFragment.class, "callbacks", "getCallbacks()Lcom/robinhood/android/referral/fractionalRewards/rewardInfo/FractionalRewardInfoFragment$Callbacks;", 0))};

    /* renamed from: Companion, reason: from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);
    public static final int $stable = 8;
    private final Screen eventScreen = new Screen(Screen.Name.EDUCATIONAL_PROPS_EXPLAIN, null, null, null, 14, null);

    /* renamed from: callbacks$delegate, reason: from kotlin metadata */
    private final Interfaces2 callbacks = new CallbacksProperty(Reflection.getOrCreateKotlinClass(Callbacks.class), new Function1<Fragment, Object>() { // from class: com.robinhood.android.referral.fractionalRewards.rewardInfo.FractionalRewardInfoFragment$special$$inlined$hostActivityCallbacks$1
        ...
        public final Object invoke(Fragment CallbacksProperty) {
            ...
            for (Context context : BaseContexts.baseContexts(fragmentActivityRequireActivity)) {
                if (context instanceof FractionalRewardInfoFragment.Callbacks) {
                    return context;
                }
            }
    ...
    /* compiled from: FractionalRewardInfoFragment.kt */
    @Metadata(m3635d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, m3636d2 = {"Lcom/robinhood/android/referral/fractionalRewards/rewardInfo/FractionalRewardInfoFragment$Callbacks;", "", "onActionButtonClicked", "", "viewState", "Lcom/robinhood/android/referral/fractionalRewards/loading/FractionalRewardLoadedState;", "feature-referral_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    public interface Callbacks {
        void onActionButtonClicked(FractionalRewardLoadedState viewState);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit ComposeContent$lambda$0(FractionalRewardInfoFragment fractionalRewardInfoFragment, int i, Composer composer, int i2) {
        fractionalRewardInfoFragment.ComposeContent(composer, RecomposeScopeImpl4.updateChangedFlags(i | 1));
    ...
    public void ComposeContent(Composer composer, final int i) {
        int i2;
        Composer composerStartRestartGroup = composer.startRestartGroup(-654839178);
        if ((i & 6) == 0) {
        ...
        if ((i2 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-654839178, i2, -1, "com.robinhood.android.referral.fractionalRewards.rewardInfo.FractionalRewardInfoFragment.ComposeContent (FractionalRewardInfoFragment.kt:34)");
            }
            BentoTheme2.BentoTheme(ScarletComposeInterop.themeChangesForCompose(getScarletManager()), null, ComposableLambda3.rememberComposableLambda(-519003388, true, new Function2<Composer, Integer, Unit>() { // from class: com.robinhood.android.referral.fractionalRewards.rewardInfo.FractionalRewardInfoFragment.ComposeContent.1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-519003388, i3, -1, "com.robinhood.android.referral.fractionalRewards.rewardInfo.FractionalRewardInfoFragment.ComposeContent.<anonymous> (FractionalRewardInfoFragment.kt:36)");
                    }
                    Component component = new Component(Component.ComponentType.BUTTON, null, null, 6, null);
                    UserInteractionEventData.Action action = UserInteractionEventData.Action.CLAIM_STOCK_BEGIN;
                    Companion companion = FractionalRewardInfoFragment.INSTANCE;
                    String infoCta = ((FractionalRewardLoadedState) companion.getArgs((Fragment) FractionalRewardInfoFragment.this)).getRewardInfo().getInfoCta();
                    String string2 = ((FractionalRewardLoadedState) companion.getArgs((Fragment) FractionalRewardInfoFragment.this)).getRewardInfo().getRewardId().toString();
                ...
                @SourceDebugExtension
                /* renamed from: com.robinhood.android.referral.fractionalRewards.rewardInfo.FractionalRewardInfoFragment$ComposeContent$1$1, reason: invalid class name */
                static final class AnonymousClass1 implements Function2<Composer, Integer, Unit> {
                    final /* synthetic */ FractionalRewardInfoFragment this$0;

                    AnonymousClass1(FractionalRewardInfoFragment fractionalRewardInfoFragment) {
                        this.this$0 = fractionalRewardInfoFragment;
                    }
                    ...
                    public final void invoke(Composer composer, int i) {
                        ...
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(73222777, i, -1, "com.robinhood.android.referral.fractionalRewards.rewardInfo.FractionalRewardInfoFragment.ComposeContent.<anonymous>.<anonymous> (FractionalRewardInfoFragment.kt:49)");
                        }
                        FractionalRewardInfo rewardInfo = ((FractionalRewardLoadedState) FractionalRewardInfoFragment.INSTANCE.getArgs((Fragment) this.this$0)).getRewardInfo();
                        composer.startReplaceGroup(5004770);
                        boolean zChangedInstance = composer.changedInstance(this.this$0);
                        final FractionalRewardInfoFragment fractionalRewardInfoFragment = this.this$0;
                        Object objRememberedValue = composer.rememberedValue();
                        if (zChangedInstance || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue = new Function0() { // from class: com.robinhood.android.referral.fractionalRewards.rewardInfo.FractionalRewardInfoFragment$ComposeContent$1$1$$ExternalSyntheticLambda0
                                @Override // kotlin.jvm.functions.Function0
                                public final Object invoke() {
                                    return FractionalRewardInfoFragment.C267081.AnonymousClass1.invoke$lambda$1$lambda$0(fractionalRewardInfoFragment);
                                }
                            };
                        ...
                        final FractionalRewardInfoFragment fractionalRewardInfoFragment2 = this.this$0;
                        Object objRememberedValue2 = composer.rememberedValue();
                        if (zChangedInstance2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                            objRememberedValue2 = new Function1() { // from class: com.robinhood.android.referral.fractionalRewards.rewardInfo.FractionalRewardInfoFragment$ComposeContent$1$1$$ExternalSyntheticLambda1
                                @Override // kotlin.jvm.functions.Function1
                                public final Object invoke(Object obj) {
                                    return FractionalRewardInfoFragment.C267081.AnonymousClass1.invoke$lambda$3$lambda$2(fractionalRewardInfoFragment2, (Uri) obj);
                                }
                            };
                            composer.updateRememberedValue(objRememberedValue2);
                        }
                        composer.endReplaceGroup();
                        FractionalRewardInfoComposable.FractionalRewardInfoComposable(rewardInfo, function0, (Function1) objRememberedValue2, composer, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                        }
                    }
                    ...
                    /* JADX INFO: Access modifiers changed from: private */
                    public static final Unit invoke$lambda$1$lambda$0(FractionalRewardInfoFragment fractionalRewardInfoFragment) {
                        fractionalRewardInfoFragment.getCallbacks().onActionButtonClicked((FractionalRewardLoadedState) FractionalRewardInfoFragment.INSTANCE.getArgs((Fragment) fractionalRewardInfoFragment));
                        return Unit.INSTANCE;
                    }

                    /* JADX INFO: Access modifiers changed from: private */
                    public static final Unit invoke$lambda$3$lambda$2(FractionalRewardInfoFragment fractionalRewardInfoFragment, Uri uri) {
                        Intrinsics.checkNotNullParameter(uri, "uri");
                        if (fractionalRewardInfoFragment.getNavigator().isDeepLinkSupported(uri)) {
                            Navigator navigator = fractionalRewardInfoFragment.getNavigator();
                            Context contextRequireContext = fractionalRewardInfoFragment.requireContext();
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: com.robinhood.android.referral.fractionalRewards.rewardInfo.FractionalRewardInfoFragment$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return FractionalRewardInfoFragment.ComposeContent$lambda$0(this.f$0, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    /* compiled from: FractionalRewardInfoFragment.kt */
    @Metadata(m3635d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\t\b\u0002¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, m3636d2 = {"Lcom/robinhood/android/referral/fractionalRewards/rewardInfo/FractionalRewardInfoFragment$Companion;", "Lcom/robinhood/utils/ui/fragment/FragmentWithArgsCompanion;", "Lcom/robinhood/android/referral/fractionalRewards/rewardInfo/FractionalRewardInfoFragment;", "Lcom/robinhood/android/referral/fractionalRewards/loading/FractionalRewardLoadedState;", "<init>", "()V", "feature-referral_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    public static final class Companion implements FragmentWithArgsCompanion<FractionalRewardInfoFragment, FractionalRewardLoadedState> {
        ...
        public FractionalRewardLoadedState getArgs(FractionalRewardInfoFragment fractionalRewardInfoFragment) {
            return (FractionalRewardLoadedState) FragmentWithArgsCompanion.DefaultImpls.getArgs(this, fractionalRewardInfoFragment);
        }

        @Override // com.robinhood.utils.p409ui.fragment.FragmentWithArgsCreator
        public FractionalRewardInfoFragment newInstance(FractionalRewardLoadedState fractionalRewardLoadedState) {
            return (FractionalRewardInfoFragment) FragmentWithArgsCompanion.DefaultImpls.newInstance(this, fractionalRewardLoadedState);
        }

        @Override // com.robinhood.utils.p409ui.fragment.FragmentWithArgsCompanion
        public void setArgs(FractionalRewardInfoFragment fractionalRewardInfoFragment, FractionalRewardLoadedState fractionalRewardLoadedState) {
            FragmentWithArgsCompanion.DefaultImpls.setArgs(this, fractionalRewardInfoFragment, fractionalRewardLoadedState);
        }
    }
}

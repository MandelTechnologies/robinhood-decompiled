...
/* renamed from: com.robinhood.android.rhyrewards.ui.MerchantRewardsOfferDetailsBottomSheet$MerchantRewardsOfferDetailGaugeInnerContentMainValue$$inlined$ConstraintLayout$6 */
/* loaded from: classes5.dex */
public final class C27668xdc5514b1 extends Lambda implements Function2<Composer, Integer, Unit> {
    final /* synthetic */ Channel $channel;
    final /* synthetic */ Ref $compositionSource;
    final /* synthetic */ SnapshotState $contentTracker;
    final /* synthetic */ SnapshotState $end;
    final /* synthetic */ MerchantOfferV2.DetailAsset.GaugeV2.GaugePercent $gauge$inlined;
    final /* synthetic */ ConstraintLayoutScope $scope;
    final /* synthetic */ SnapshotState $start;
    final /* synthetic */ MerchantRewardsOfferDetailsBottomSheet this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C27668xdc5514b1(SnapshotState snapshotState, Ref ref, ConstraintLayoutScope constraintLayoutScope, Channel channel, SnapshotState snapshotState2, SnapshotState snapshotState3, MerchantRewardsOfferDetailsBottomSheet merchantRewardsOfferDetailsBottomSheet, MerchantOfferV2.DetailAsset.GaugeV2.GaugePercent gaugePercent) {
        super(2);
        ...
        this.$gauge$inlined = gaugePercent;
    }
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 3) != 2 || !composer.getSkipping()) {
            ...
            composer.startReplaceGroup(1009188647);
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new MerchantRewardsOfferDetailsBottomSheet4(constraintLayoutBaseScope4Component2);
            ...
            String strStringResource = StringResources_androidKt.stringResource(C27650R.string.cash_merchant_rewards_offer_gauge_content_percent_sign, composer, 0);
            ...
            if (zChangedInstance || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue2 = new Function0<Unit>() { // from class: com.robinhood.android.rhyrewards.ui.MerchantRewardsOfferDetailsBottomSheet$MerchantRewardsOfferDetailGaugeInnerContentMainValue$$inlined$ConstraintLayout$6.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }

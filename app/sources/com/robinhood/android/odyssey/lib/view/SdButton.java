...
import com.robinhood.android.serverclientcomponents.actionbutton.GenericButtonTypes;
...
public final class SdButton extends RdsButton implements SdBaseButtonView {
    ...
    @Override // com.robinhood.android.odyssey.lib.view.SdBaseView
    public void onDataUpdated(final ApiSdButtonComponent.ApiSdButtonComponentData newData, SdBaseView.UpdateSource updateSource) {
        ...
        if (newData.getStyle() != null) {
            OneShotPreDrawListener.add(this, new Runnable() { // from class: com.robinhood.android.odyssey.lib.view.SdButton$onDataUpdated$lambda$3$$inlined$doOnPreDraw$1
                @Override // java.lang.Runnable
                public final void run() {
                    if (newData.getStyle() == GenericButtonType.TERTIARY) {
                        Preconditions.INSTANCE.failUnexpectedItemKotlin("Tertiary button needs to be SdTextButton");
                        throw new ExceptionsH();
                    }
                    SdButton sdButton = this;
                    ResourceType.STYLE style = ResourceType.STYLE.INSTANCE;
                    GenericButtonType style2 = newData.getStyle();
                    Intrinsics.checkNotNull(style2);
                    ScarletManager2.overrideStyle$default(sdButton, new ThemedResourceReference(style, GenericButtonTypes.getStyleAttr(style2)), false, 2, null);
                }
            });
            invalidate();
        }
    ...
    /* compiled from: SdButton.kt */
    @Metadata(m3635d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004J\u0011\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0007H\u0096\u0001¨\u0006\b"}, m3636d2 = {"Lcom/robinhood/android/odyssey/lib/view/SdButton$Companion;", "Lcom/robinhood/utils/ui/view/Inflater;", "Lcom/robinhood/android/odyssey/lib/view/SdButton;", "<init>", "()V", "inflate", "parent", "Landroid/view/ViewGroup;", "feature-lib-odyssey_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    public static final class Companion implements Inflater<SdButton> {
        private final /* synthetic */ Inflater<SdButton> $$delegate_0;
        ...
        public SdButton inflate(ViewGroup parent) {
            Intrinsics.checkNotNullParameter(parent, "parent");
            return (SdButton) this.$$delegate_0.inflate(parent);
        }

        private Companion() {
            this.$$delegate_0 = Inflater.INSTANCE.include(C20335R.layout.include_sd_button);
        }
    }
}

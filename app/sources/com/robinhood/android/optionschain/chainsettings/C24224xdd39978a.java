...
/* renamed from: com.robinhood.android.optionschain.chainsettings.OptionChainCustomizationComposableKt$MetricTypeSelectionSection$lambda$18$lambda$17$$inlined$items$default$3 */
/* loaded from: classes11.dex */
public final class C24224xdd39978a extends Lambda implements Function2<LazyGridSpan2, Integer, LazyGridSpan> {
    final /* synthetic */ List $items;
    final /* synthetic */ Function2 $span;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C24224xdd39978a(Function2 function2, List list) {
        super(2);
        this.$span = function2;
        this.$items = list;
    }
    ...
    public /* bridge */ /* synthetic */ LazyGridSpan invoke(LazyGridSpan2 lazyGridSpan2, Integer num) {
        return LazyGridSpan.m5218boximpl(m17176invoke_orMbw(lazyGridSpan2, num.intValue()));
    }

    /* renamed from: invoke-_-orMbw, reason: not valid java name */
    public final long m17176invoke_orMbw(LazyGridSpan2 lazyGridSpan2, int i) {

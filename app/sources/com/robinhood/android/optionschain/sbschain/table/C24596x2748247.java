...
@DebugMetadata(m3644c = "com.robinhood.android.optionschain.sbschain.table.OptionSideBySideChainTableKt$OptionSideBySideChainTable$16$1$2$2$10$2$1", m3645f = "OptionSideBySideChainTable.kt", m3646l = {561}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.android.optionschain.sbschain.table.OptionSideBySideChainTableKt$OptionSideBySideChainTable$16$1$2$2$10$2$1 */
/* loaded from: classes11.dex */
final class C24596x2748247 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    C24596x2748247(LazyListState lazyListState, OptionSideBySideChainTableEvent optionSideBySideChainTableEvent, SnapshotState4<Integer> snapshotState4, SnapshotState4<OptionSideBySideChainTableViewState> snapshotState42, SnapshotLongState2 snapshotLongState2, SnapshotState<Boolean> snapshotState, Continuation<? super C24596x2748247> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new C24596x2748247(this.$lazyListState, this.$localEvent, this.$scrollQuoteToScreenCenterOffset$delegate, this.$viewState$delegate, this.$startTableLoading$delegate, this.$isTableReady$delegate, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((C24596x2748247) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            int quoteIndex = ((OptionSideBySideChainTableEvent.NuxScrollToQuotePosition) this.$localEvent).getQuoteIndex();

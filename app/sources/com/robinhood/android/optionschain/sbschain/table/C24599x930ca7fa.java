...
@DebugMetadata(m3644c = "com.robinhood.android.optionschain.sbschain.table.OptionSideBySideChainTableKt$OptionSideBySideChainTable$16$1$2$2$11$1", m3645f = "OptionSideBySideChainTable.kt", m3646l = {603}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.android.optionschain.sbschain.table.OptionSideBySideChainTableKt$OptionSideBySideChainTable$16$1$2$2$11$1 */
/* loaded from: classes11.dex */
final class C24599x930ca7fa extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ OptionSideBySideChainTableEvent.ScrollToQuotePosition $event;
    ...
    C24599x930ca7fa(LazyListState lazyListState, OptionSideBySideChainTableEvent.ScrollToQuotePosition scrollToQuotePosition, SnapshotState4<Integer> snapshotState4, SnapshotState4<OptionSideBySideChainTableViewState> snapshotState42, SnapshotLongState2 snapshotLongState2, SnapshotState<Boolean> snapshotState, Continuation<? super C24599x930ca7fa> continuation) {
        super(2, continuation);
        this.$lazyListState = lazyListState;
        this.$event = scrollToQuotePosition;
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new C24599x930ca7fa(this.$lazyListState, this.$event, this.$scrollQuoteToTableCenterOffset$delegate, this.$viewState$delegate, this.$startTableLoading$delegate, this.$isTableReady$delegate, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((C24599x930ca7fa) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

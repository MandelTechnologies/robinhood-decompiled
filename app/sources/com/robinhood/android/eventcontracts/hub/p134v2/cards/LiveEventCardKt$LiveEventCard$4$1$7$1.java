...
final class LiveEventCardKt$LiveEventCard$4$1$7$1 implements Function1<ConstrainScope, Unit> {
    ...
    LiveEventCardKt$LiveEventCard$4$1$7$1(ConstraintLayoutBaseScope4 constraintLayoutBaseScope4, ConstraintLayoutBaseScope4 constraintLayoutBaseScope42, float f) {
    ...
    public final void invoke2(ConstrainScope constrainAs) {
        ...
        ConstraintScopeCommon6.m8185linkToVpY3zN4$default(constrainAs.getStart(), this.$hyphen.getEnd(), this.$smallBentoSpacing, 0.0f, 4, null);
    }
}

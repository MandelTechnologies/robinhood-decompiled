...
final class LiveEventCardKt$LiveEventCard$4$1$15$1 implements Function0<Unit> {
    final /* synthetic */ HubNavigationCallbacks $callbacks;
    final /* synthetic */ LiveEventCardViewState $state;

    LiveEventCardKt$LiveEventCard$4$1$15$1(HubNavigationCallbacks hubNavigationCallbacks, LiveEventCardViewState liveEventCardViewState) {
    ...
    public final void invoke2() {
        this.$callbacks.quotePillClicked(this.$state.getEventId(), this.$state.getRightContractViewState().getContractId());
    }
}

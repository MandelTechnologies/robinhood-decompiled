...
/* compiled from: NbboAnalytics.kt */
@Metadata(m3635d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bÆ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0018\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\b\u0010\b\u001a\u0004\u0018\u00010\tJ\u0018\u0010\n\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\b\u0010\b\u001a\u0004\u0018\u00010\tJ\u0016\u0010\u000b\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\f\u001a\u00020\rJ\u0018\u0010\u000e\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\b\u0010\b\u001a\u0004\u0018\u00010\tJ\u0012\u0010\u000f\u001a\u00020\u00102\b\u0010\f\u001a\u0004\u0018\u00010\rH\u0002J\u0014\u0010\u0011\u001a\u0004\u0018\u00010\u00122\b\u0010\b\u001a\u0004\u0018\u00010\tH\u0002¨\u0006\u0013"}, m3636d2 = {"Lcom/robinhood/android/nbbo/NbboAnalytics;", "", "<init>", "()V", "logNbboIconTap", "", "eventLogger", "Lcom/robinhood/analytics/EventLogger;", "nbboSummary", "Lcom/robinhood/nbbo/models/db/NbboSummary;", "logNbboAppear", "logNbboExplanationDialogLinkTap", "instrumentId", "Ljava/util/UUID;", "logNbboRefreshTap", "orderReviewScreen", "Lcom/robinhood/rosetta/eventlogging/Screen;", "nbboContext", "Lcom/robinhood/rosetta/eventlogging/Context;", "feature-lib-nbbo_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
...
public final class NbboAnalytics {
    ...
    public final void logNbboIconTap(EventLogger eventLogger, NbboSummary nbboSummary) {
        ...
        EventLogger.DefaultImpls.logTap$default(eventLogger, UserInteractionEventData.Action.LEARN_MORE, orderReviewScreen(nbboSummary != null ? nbboSummary.getInstrumentId() : null), new Component(Component.ComponentType.BUTTON, "order-summary-learn-more", null, 4, null), null, nbboContext(nbboSummary), false, 40, null);
    }

    public final void logNbboAppear(EventLogger eventLogger, NbboSummary nbboSummary) {
        Intrinsics.checkNotNullParameter(eventLogger, "eventLogger");
        EventLogger.DefaultImpls.logAppear$default(eventLogger, null, orderReviewScreen(nbboSummary != null ? nbboSummary.getInstrumentId() : null), new Component(Component.ComponentType.TEXT_FIELD, "order-summary-nbbo-text", null, 4, null), null, nbboContext(nbboSummary), 9, null);
    }

    public final void logNbboExplanationDialogLinkTap(EventLogger eventLogger, UUID instrumentId) {
        Intrinsics.checkNotNullParameter(eventLogger, "eventLogger");
        Intrinsics.checkNotNullParameter(instrumentId, "instrumentId");
        EventLogger.DefaultImpls.logTap$default(eventLogger, UserInteractionEventData.Action.LEARN_MORE, orderReviewScreen(instrumentId), new Component(Component.ComponentType.LINK_BUTTON, "nbbo-modal-see-market-symbols", null, 4, null), null, null, false, 56, null);
    }

    public final void logNbboRefreshTap(EventLogger eventLogger, NbboSummary nbboSummary) {
        Intrinsics.checkNotNullParameter(eventLogger, "eventLogger");
        EventLogger.DefaultImpls.logTap$default(eventLogger, UserInteractionEventData.Action.REFRESH, orderReviewScreen(nbboSummary != null ? nbboSummary.getInstrumentId() : null), new Component(Component.ComponentType.BUTTON, "order-summary-nbbo-refresh", null, 4, null), null, nbboContext(nbboSummary), false, 40, null);
    }

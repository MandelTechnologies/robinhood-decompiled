...
final class OptionHistoricalChartKt$OptionHistoricalChart$1$9$1 implements Function1<List<? extends Point>, Unit> {
    final /* synthetic */ SnapshotState<Point> $selectedPoint$delegate;

    OptionHistoricalChartKt$OptionHistoricalChart$1$9$1(SnapshotState<Point> snapshotState) {

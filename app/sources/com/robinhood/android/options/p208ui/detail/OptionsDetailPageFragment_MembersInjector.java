...
public final class OptionsDetailPageFragment_MembersInjector implements MembersInjector<OptionsDetailPageFragment> {
    ...
    @JvmStatic
    public static final MembersInjector<OptionsDetailPageFragment> create(Provider<BaseFragmentSingletons> provider, Provider<GenericComposeSingletons> provider2, Provider<CrossSellLaunchManager> provider3) {
        return INSTANCE.create(provider, provider2, provider3);
    }

    @JvmStatic
    public static final void injectCrossSellLaunchManager(OptionsDetailPageFragment optionsDetailPageFragment, CrossSellLaunchManager crossSellLaunchManager) {
        INSTANCE.injectCrossSellLaunchManager(optionsDetailPageFragment, crossSellLaunchManager);
    }

    public OptionsDetailPageFragment_MembersInjector(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<CrossSellLaunchManager> crossSellLaunchManager) {
    ...
    public void injectMembers(OptionsDetailPageFragment instance) {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final MembersInjector<OptionsDetailPageFragment> create(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<CrossSellLaunchManager> crossSellLaunchManager) {
            Intrinsics.checkNotNullParameter(singletons, "singletons");
            Intrinsics.checkNotNullParameter(genericComposeSingletons, "genericComposeSingletons");
            Intrinsics.checkNotNullParameter(crossSellLaunchManager, "crossSellLaunchManager");
            return new OptionsDetailPageFragment_MembersInjector(singletons, genericComposeSingletons, crossSellLaunchManager);
        }

        @JvmStatic
        public final void injectCrossSellLaunchManager(OptionsDetailPageFragment instance, CrossSellLaunchManager crossSellLaunchManager) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(crossSellLaunchManager, "crossSellLaunchManager");

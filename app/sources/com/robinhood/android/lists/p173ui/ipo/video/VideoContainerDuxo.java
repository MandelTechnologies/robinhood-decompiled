...
/* compiled from: VideoContainerDuxo.kt */
@Metadata(m3635d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\t\n\u0002\b\u0003\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0019\b\u0007\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0004\b\u0007\u0010\bJ\u000e\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\fJ\u0006\u0010\r\u001a\u00020\nJ\u0006\u0010\u000e\u001a\u00020\nJ!\u0010\u000f\u001a\u00020\n2\b\u0010\u0010\u001a\u0004\u0018\u00010\u00112\b\u0010\u0012\u001a\u0004\u0018\u00010\u0011H\u0007¢\u0006\u0002\u0010\u0013R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0014"}, m3636d2 = {"Lcom/robinhood/android/lists/ui/ipo/video/VideoContainerDuxo;", "Lcom/robinhood/android/common/udf/ViewDuxo;", "Lcom/robinhood/android/lists/ui/ipo/video/VideoContainerViewState;", "hostView", "Landroid/view/View;", "eventLogger", "Lcom/robinhood/analytics/EventLogger;", "<init>", "(Landroid/view/View;Lcom/robinhood/analytics/EventLogger;)V", "initialize", "", "videoViewState", "Lcom/robinhood/android/lists/ui/ipo/video/VideoContainerViewState$VideoViewState;", "enableAudio", "disableAudio", "logPause", "currentPosition", "", "duration", "(Ljava/lang/Long;Ljava/lang/Long;)V", "feature-lists_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
/* loaded from: classes8.dex */
public final class VideoContainerDuxo extends ViewDuxo<VideoContainerViewState> {
    public static final int $stable = 8;
    private final EventLogger eventLogger;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VideoContainerDuxo(View hostView, EventLogger eventLogger) {
        super(hostView, new VideoContainerViewState(null, false, 3, null), null, 4, null);
        Intrinsics.checkNotNullParameter(hostView, "hostView");
        Intrinsics.checkNotNullParameter(eventLogger, "eventLogger");
        this.eventLogger = eventLogger;
    }

    public final void initialize(final VideoContainerViewState.VideoViewState videoViewState) {
        Intrinsics.checkNotNullParameter(videoViewState, "videoViewState");
        applyMutation(new Function1() { // from class: com.robinhood.android.lists.ui.ipo.video.VideoContainerDuxo$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return VideoContainerDuxo.initialize$lambda$0(videoViewState, (VideoContainerViewState) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final VideoContainerViewState initialize$lambda$0(VideoContainerViewState.VideoViewState videoViewState, VideoContainerViewState applyMutation) {
        Intrinsics.checkNotNullParameter(applyMutation, "$this$applyMutation");
        return VideoContainerViewState.copy$default(applyMutation, videoViewState, false, 2, null);
    }

    public final void enableAudio() {
        applyMutation(new Function1() { // from class: com.robinhood.android.lists.ui.ipo.video.VideoContainerDuxo$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return VideoContainerDuxo.enableAudio$lambda$1((VideoContainerViewState) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final VideoContainerViewState enableAudio$lambda$1(VideoContainerViewState applyMutation) {
        Intrinsics.checkNotNullParameter(applyMutation, "$this$applyMutation");
        return VideoContainerViewState.copy$default(applyMutation, null, true, 1, null);
    }

    public final void disableAudio() {
        applyMutation(new Function1() { // from class: com.robinhood.android.lists.ui.ipo.video.VideoContainerDuxo$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return VideoContainerDuxo.disableAudio$lambda$2((VideoContainerViewState) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final VideoContainerViewState disableAudio$lambda$2(VideoContainerViewState applyMutation) {
        Intrinsics.checkNotNullParameter(applyMutation, "$this$applyMutation");
        return VideoContainerViewState.copy$default(applyMutation, null, false, 1, null);
    }

    @SuppressLint({"CheckResult"})
    public final void logPause(final Long currentPosition, final Long duration) {
        if (currentPosition == null || duration == null) {
            return;
        }
        getStates().map(new Function() { // from class: com.robinhood.android.lists.ui.ipo.video.VideoContainerDuxo.logPause.1
            @Override // io.reactivex.functions.Function
            public final Uri apply(VideoContainerViewState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return it.getVideoUri();
            }
        }).take(1L).subscribe(new Consumer() { // from class: com.robinhood.android.lists.ui.ipo.video.VideoContainerDuxo.logPause.2
            /* JADX WARN: Multi-variable type inference failed */
            @Override // io.reactivex.functions.Consumer
            public final void accept(Uri uri) {
                EventLogger eventLogger = VideoContainerDuxo.this.eventLogger;
                Screen screen = new Screen(Screen.Name.LIST_DETAIL_PAGE, null, String.valueOf(uri), null, 10, null);
                Component component = new Component(Component.ComponentType.LIST_VIDEO, null, null, 6, null);
                int i = 0;
                int i2 = 0;
                int i3 = 0;
                String str = null;

...
@DebugMetadata(m3644c = "com.robinhood.android.acatsin.submit.AcatsInSubmitDuxo$submit$acatsTransferSingle$1$1", m3645f = "AcatsInSubmitDuxo.kt", m3646l = {103}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.android.acatsin.submit.AcatsInSubmitDuxo$submit$acatsTransferSingle$1$1, reason: use source file name */
/* loaded from: classes24.dex */
final class AcatsInSubmitDuxo6 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super AcatsTransfer>, Object> {
    final /* synthetic */ UUID $conflictingResourceId;
    int label;
    final /* synthetic */ AcatsInSubmitDuxo this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    AcatsInSubmitDuxo6(AcatsInSubmitDuxo acatsInSubmitDuxo, UUID uuid, Continuation<? super AcatsInSubmitDuxo6> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AcatsInSubmitDuxo6(this.this$0, this.$conflictingResourceId, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super AcatsTransfer> continuation) {
        return ((AcatsInSubmitDuxo6) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

...
@DebugMetadata(m3644c = "com.robinhood.android.acatsin.submit.AcatsInSubmitDuxo$onStart$3$1", m3645f = "AcatsInSubmitDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.android.acatsin.submit.AcatsInSubmitDuxo$onStart$3$1, reason: use source file name */
/* loaded from: classes24.dex */
final class AcatsInSubmitDuxo3 extends ContinuationImpl7 implements Function2<AcatsInSubmitDataState, Continuation<? super AcatsInSubmitDataState>, Object> {
    final /* synthetic */ Account $account;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    AcatsInSubmitDuxo3(Account account, Continuation<? super AcatsInSubmitDuxo3> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        AcatsInSubmitDuxo3 acatsInSubmitDuxo3 = new AcatsInSubmitDuxo3(this.$account, continuation);
        acatsInSubmitDuxo3.L$0 = obj;
        return acatsInSubmitDuxo3;
    }
    ...
    public final Object invoke(AcatsInSubmitDataState acatsInSubmitDataState, Continuation<? super AcatsInSubmitDataState> continuation) {
        return ((AcatsInSubmitDuxo3) create(acatsInSubmitDataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

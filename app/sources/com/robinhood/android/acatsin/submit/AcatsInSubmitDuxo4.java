...
@DebugMetadata(m3644c = "com.robinhood.android.acatsin.submit.AcatsInSubmitDuxo$submit$2$1", m3645f = "AcatsInSubmitDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.android.acatsin.submit.AcatsInSubmitDuxo$submit$2$1, reason: use source file name */
/* loaded from: classes24.dex */
final class AcatsInSubmitDuxo4 extends ContinuationImpl7 implements Function2<AcatsInSubmitDataState, Continuation<? super AcatsInSubmitDataState>, Object> {
    final /* synthetic */ AcatsTransfer $acatsTransfer;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    AcatsInSubmitDuxo4(AcatsTransfer acatsTransfer, Continuation<? super AcatsInSubmitDuxo4> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        AcatsInSubmitDuxo4 acatsInSubmitDuxo4 = new AcatsInSubmitDuxo4(this.$acatsTransfer, continuation);
        acatsInSubmitDuxo4.L$0 = obj;
        return acatsInSubmitDuxo4;
    }
    ...
    public final Object invoke(AcatsInSubmitDataState acatsInSubmitDataState, Continuation<? super AcatsInSubmitDataState> continuation) {
        return ((AcatsInSubmitDuxo4) create(acatsInSubmitDataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

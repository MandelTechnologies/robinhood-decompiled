...
public final /* data */ class AcatsInPartialOptionAssetDataState {
    ...
    public static /* synthetic */ AcatsInPartialOptionAssetDataState copy$default(AcatsInPartialOptionAssetDataState acatsInPartialOptionAssetDataState, UUID uuid, String str, UiAcatsAsset.OptionAsset optionAsset, ApiAcatsTransfer.Asset.Direction direction, Boolean bool, Integer num, OptionContractType optionContractType, LocalDate localDate, Money money, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            uuid = acatsInPartialOptionAssetDataState.instrumentId;
        }
        if ((i & 2) != 0) {
            str = acatsInPartialOptionAssetDataState.symbol;
        }
        if ((i & 4) != 0) {
            optionAsset = acatsInPartialOptionAssetDataState.assetToModify;
        }
        if ((i & 8) != 0) {
            direction = acatsInPartialOptionAssetDataState.direction;
        }
        if ((i & 16) != 0) {
            bool = acatsInPartialOptionAssetDataState.isAllContracts;
        }
        if ((i & 32) != 0) {
            num = acatsInPartialOptionAssetDataState.numContracts;
        }
        if ((i & 64) != 0) {
            optionContractType = acatsInPartialOptionAssetDataState.optionType;
        }
        if ((i & 128) != 0) {
            localDate = acatsInPartialOptionAssetDataState.expirationDate;
        }
        if ((i & 256) != 0) {
            money = acatsInPartialOptionAssetDataState.strikePrice;
        }
        if ((i & 512) != 0) {
            z = acatsInPartialOptionAssetDataState.isButtonLoading;
        }
        Money money2 = money;
        boolean z2 = z;
        ...
        Boolean bool2 = bool;
        Integer num2 = num;
        return acatsInPartialOptionAssetDataState.copy(uuid, str, optionAsset, direction, bool2, num2, optionContractType2, localDate2, money2, z2);
    }
    ...
    public final AcatsInPartialOptionAssetDataState copy(UUID instrumentId, String symbol, UiAcatsAsset.OptionAsset assetToModify, ApiAcatsTransfer.Asset.Direction direction, Boolean isAllContracts, Integer numContracts, OptionContractType optionType, LocalDate expirationDate, Money strikePrice, boolean isButtonLoading) {
        Intrinsics.checkNotNullParameter(instrumentId, "instrumentId");
        Intrinsics.checkNotNullParameter(symbol, "symbol");
        return new AcatsInPartialOptionAssetDataState(instrumentId, symbol, assetToModify, direction, isAllContracts, numContracts, optionType, expirationDate, strikePrice, isButtonLoading);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof AcatsInPartialOptionAssetDataState)) {
            return false;
        }
        AcatsInPartialOptionAssetDataState acatsInPartialOptionAssetDataState = (AcatsInPartialOptionAssetDataState) other;
        return Intrinsics.areEqual(this.instrumentId, acatsInPartialOptionAssetDataState.instrumentId) && Intrinsics.areEqual(this.symbol, acatsInPartialOptionAssetDataState.symbol) && Intrinsics.areEqual(this.assetToModify, acatsInPartialOptionAssetDataState.assetToModify) && this.direction == acatsInPartialOptionAssetDataState.direction && Intrinsics.areEqual(this.isAllContracts, acatsInPartialOptionAssetDataState.isAllContracts) && Intrinsics.areEqual(this.numContracts, acatsInPartialOptionAssetDataState.numContracts) && this.optionType == acatsInPartialOptionAssetDataState.optionType && Intrinsics.areEqual(this.expirationDate, acatsInPartialOptionAssetDataState.expirationDate) && Intrinsics.areEqual(this.strikePrice, acatsInPartialOptionAssetDataState.strikePrice) && this.isButtonLoading == acatsInPartialOptionAssetDataState.isButtonLoading;
    }
    ...
    public String toString() {
        return "AcatsInPartialOptionAssetDataState(instrumentId=" + this.instrumentId + ", symbol=" + this.symbol + ", assetToModify=" + this.assetToModify + ", direction=" + this.direction + ", isAllContracts=" + this.isAllContracts + ", numContracts=" + this.numContracts + ", optionType=" + this.optionType + ", expirationDate=" + this.expirationDate + ", strikePrice=" + this.strikePrice + ", isButtonLoading=" + this.isButtonLoading + ")";
    }

    public AcatsInPartialOptionAssetDataState(UUID instrumentId, String symbol, UiAcatsAsset.OptionAsset optionAsset, ApiAcatsTransfer.Asset.Direction direction, Boolean bool, Integer num, OptionContractType optionContractType, LocalDate localDate, Money money, boolean z) {
        Intrinsics.checkNotNullParameter(instrumentId, "instrumentId");
        Intrinsics.checkNotNullParameter(symbol, "symbol");
    ...
    public /* synthetic */ AcatsInPartialOptionAssetDataState(UUID uuid, String str, UiAcatsAsset.OptionAsset optionAsset, ApiAcatsTransfer.Asset.Direction direction, Boolean bool, Integer num, OptionContractType optionContractType, LocalDate localDate, Money money, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(uuid, str, optionAsset, (i & 8) != 0 ? null : direction, (i & 16) != 0 ? null : bool, (i & 32) != 0 ? null : num, (i & 64) != 0 ? null : optionContractType, (i & 128) != 0 ? null : localDate, (i & 256) != 0 ? null : money, (i & 512) != 0 ? false : z);
    }

package com.robinhood.android.funding.logging;
...
@Metadata(m3635d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\u001a\u000e\u0010\u0000\u001a\u00060\u0001j\u0002`\u0002*\u00020\u0003¨\u0006\u0004"}, m3636d2 = {"toFundingEventContext", "Lcom/robinhood/rosetta/eventlogging/Context;", "Lcom/robinhood/rosetta/eventlogging/EventContext;", "Lcom/robinhood/transfers/models/db/AchTransfer;", "lib-funding-logging_externalDebug"}, m3637k = 2, m3638mv = {2, 1, 0}, m3640xi = 48)
/* renamed from: com.robinhood.android.funding.logging.AchTransfersKt, reason: use source file name */
/* loaded from: classes3.dex */
public final class AchTransfers2 {

    /* compiled from: AchTransfers.kt */
    @Metadata(m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    /* renamed from: com.robinhood.android.funding.logging.AchTransfersKt$WhenMappings */
    ...
    public static final Context toFundingEventContext(AchTransfer achTransfer) {
        FundingContext.TransferType transferType;
        FundingContext.TransferState transferState;
        Intrinsics.checkNotNullParameter(achTransfer, "<this>");
        int i = WhenMappings.$EnumSwitchMapping$0[achTransfer.getDirection().ordinal()];
        if (i == 1) {
            transferType = FundingContext.TransferType.DEPOSIT;
        } else {
            if (i != 2) {
                throw new NoWhenBranchMatchedException();
            }
            transferType = FundingContext.TransferType.WITHDRAWAL;
        }
        FundingContext.TransferType transferType2 = transferType;
        if (achTransfer.getIsPending()) {
            transferState = FundingContext.TransferState.PENDING;
        } else {
            transferState = FundingContext.TransferState.COMPLETED;
        }
        FundingContext.TransferState transferState2 = transferState;
        String string2 = achTransfer.getId().toString();
        Intrinsics.checkNotNullExpressionValue(string2, "toString(...)");
        FundingContext fundingContext = new FundingContext(transferType2, transferState2, string2, achTransfer.getAmount().getDecimalValue().doubleValue(), null, 16, null);
        String str = null;
        int i2 = 0;
        String str2 = null;
        String str3 = null;

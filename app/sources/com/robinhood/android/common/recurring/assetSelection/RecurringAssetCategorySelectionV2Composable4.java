...
/* renamed from: com.robinhood.android.common.recurring.assetSelection.ComposableSingletons$RecurringAssetCategorySelectionV2ComposableKt$lambda$-625531293$1, reason: use source file name */
/* loaded from: classes2.dex */
final class RecurringAssetCategorySelectionV2Composable4 implements Function2<Composer, Integer, Unit> {
    public static final RecurringAssetCategorySelectionV2Composable4 INSTANCE = new RecurringAssetCategorySelectionV2Composable4();

    RecurringAssetCategorySelectionV2Composable4() {
    }
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-625531293, i, -1, "com.robinhood.android.common.recurring.assetSelection.ComposableSingletons$RecurringAssetCategorySelectionV2ComposableKt.lambda$-625531293.<anonymous> (RecurringAssetCategorySelectionV2Composable.kt:446)");
        }
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new Function1() { // from class: com.robinhood.android.common.recurring.assetSelection.ComposableSingletons$RecurringAssetCategorySelectionV2ComposableKt$lambda$-625531293$1$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return RecurringAssetCategorySelectionV2Composable4.invoke$lambda$1$lambda$0((RecurringInvestmentCategory2) obj);
                }
            };

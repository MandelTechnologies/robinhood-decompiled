...
public final class MergeMarginChecklistRowGoldBinding implements ViewBinding {
    ...
    private MergeMarginChecklistRowGoldBinding(View view, RdsButton rdsButton, RdsButton rdsButton2, ImageView imageView, RhTextView rhTextView, RdsProgressBar rdsProgressBar, RhTextView rhTextView2) {
        this.rootView = view;
    ...
    public static MergeMarginChecklistRowGoldBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        ...
        layoutInflater.inflate(C11223R.layout.merge_margin_checklist_row_gold, viewGroup);
                ...
                if (imageView != null) {
                    ...
                    if (rhTextView != null) {
                        ...
                        if (rdsProgressBar != null) {
                            ...
                            if (rhTextView2 != null) {
                                return new MergeMarginChecklistRowGoldBinding(view, rdsButton, rdsButton2, imageView, rhTextView, rdsProgressBar, rhTextView2);
                            }
                        }
                    }
                }

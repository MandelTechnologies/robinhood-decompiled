...
public final class SimpleSlide5 extends SimpleSlide.CalculateSlideHorizontal {
    ...
    public float getGoneX(ViewGroup sceneRoot, View view) {
        ...
        return translationX + (sceneRoot.getWidth() - view.getLeft());
    }
}

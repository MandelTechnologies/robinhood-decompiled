...
/* renamed from: com.robinhood.android.common.detail.component.relatedlist.DetailPageRelatedListComposableKt$RelatedListChipGrid$lambda$6$lambda$5$$inlined$items$default$3 */
/* loaded from: classes2.dex */
final class C11127x55f1005e extends Lambda implements Function1<Integer, LazyStaggeredGridSpan2> {
    final /* synthetic */ List $items;
    final /* synthetic */ Function1 $span;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C11127x55f1005e(Function1 function1, List list) {
        super(1);
        this.$span = function1;
        this.$items = list;
    }

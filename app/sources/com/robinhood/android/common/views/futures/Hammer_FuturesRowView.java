...
public abstract class Hammer_FuturesRowView extends BaseInstrumentRowView implements ViewComponentManagerHolder {
    ...
    private Hammer_FuturesRowView(Context context, AttributeSet attributeSet) {
        ...
        Hammer_FuturesRowView2 hammer_FuturesRowView2 = (Hammer_FuturesRowView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.common.views.futures.FuturesRowView");
        hammer_FuturesRowView2.inject((FuturesRowView) this);
        this.injected = true;
    }
}

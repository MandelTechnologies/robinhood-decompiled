...
public abstract class Hammer_PositionListItemView extends GenericComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_PositionListItemView(Context context, AttributeSet attributeSet) {
        ...
        Hammer_PositionListItemView2 hammer_PositionListItemView2 = (Hammer_PositionListItemView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.common.views.PositionListItemView");
        hammer_PositionListItemView2.inject((PositionListItemView) this);
        this.injected = true;
    }
}

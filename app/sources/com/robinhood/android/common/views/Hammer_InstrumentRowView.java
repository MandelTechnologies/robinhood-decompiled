...
public abstract class Hammer_InstrumentRowView extends BaseInstrumentRowView implements ViewComponentManagerHolder {
    ...
    private Hammer_InstrumentRowView(Context context, AttributeSet attributeSet) {
        ...
        Hammer_InstrumentRowView2 hammer_InstrumentRowView2 = (Hammer_InstrumentRowView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.common.views.InstrumentRowView");
        hammer_InstrumentRowView2.inject((InstrumentRowView) this);
        this.injected = true;
    }
}

...
/* renamed from: com.robinhood.android.chart.blackwidowadvancedchart.composables.indicators.settings.ColorPickerKt$ColorPicker_euL9pac$lambda$6$lambda$3$lambda$2$$inlined$items$default$3 */
/* loaded from: classes7.dex */
public final class C10806xe54040d4 extends Lambda implements Function2<LazyGridSpan2, Integer, LazyGridSpan> {
    final /* synthetic */ List $items;
    final /* synthetic */ Function2 $span;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C10806xe54040d4(Function2 function2, List list) {
        super(2);
        this.$span = function2;
        this.$items = list;
    }
    ...
    public /* bridge */ /* synthetic */ LazyGridSpan invoke(LazyGridSpan2 lazyGridSpan2, Integer num) {
        return LazyGridSpan.m5218boximpl(m11913invoke_orMbw(lazyGridSpan2, num.intValue()));
    }

    /* renamed from: invoke-_-orMbw, reason: not valid java name */
    public final long m11913invoke_orMbw(LazyGridSpan2 lazyGridSpan2, int i) {

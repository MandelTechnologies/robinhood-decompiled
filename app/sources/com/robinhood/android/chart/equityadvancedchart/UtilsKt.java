...
@Metadata(m3635d1 = {"\u0000\u0012\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u001a\u0016\u0010\u0000\u001a\u0004\u0018\u00010\u0001*\u00020\u00022\b\u0010\u0003\u001a\u0004\u0018\u00010\u0004¨\u0006\u0005"}, m3636d2 = {"extendWithDraft", "Lcom/robinhood/android/trading/contracts/configuration/ShareBasedOrderConfiguration;", "Lcom/robinhood/models/db/Order;", "newPrice", "Ljava/math/BigDecimal;", "lib-equity-advanced-chart_externalDebug"}, m3637k = 2, m3638mv = {2, 1, 0}, m3640xi = 48)
...
public final class UtilsKt {
    public static final ShareBasedOrderConfiguration extendWithDraft(Order order, BigDecimal bigDecimal) {
        ...
        if (configuration == configuration2 && bigDecimal != null) {
            ...
            return new AdvancedOrder.LimitDraft(accountNumber, quantity, bigDecimal, timeInForce, marketHours, false, false).completedDraft();
        }

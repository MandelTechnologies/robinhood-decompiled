...
@DebugMetadata(m3644c = "com.robinhood.android.transfers.ui.v2.CreateTransferV2Duxo$onContributionQuestionnaireFinished$1$2", m3645f = "CreateTransferV2Duxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes9.dex */
final class CreateTransferV2Duxo$onContributionQuestionnaireFinished$1$2 extends ContinuationImpl7 implements Function2<CreateTransferV2DataState, Continuation<? super CreateTransferV2DataState>, Object> {
    final /* synthetic */ IraContributionQuestionnaireResult.IraContribution $result;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CreateTransferV2Duxo$onContributionQuestionnaireFinished$1$2(IraContributionQuestionnaireResult.IraContribution iraContribution, Continuation<? super CreateTransferV2Duxo$onContributionQuestionnaireFinished$1$2> continuation) {
        super(2, continuation);
        this.$result = iraContribution;
    }

    @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        CreateTransferV2Duxo$onContributionQuestionnaireFinished$1$2 createTransferV2Duxo$onContributionQuestionnaireFinished$1$2 = new CreateTransferV2Duxo$onContributionQuestionnaireFinished$1$2(this.$result, continuation);
        createTransferV2Duxo$onContributionQuestionnaireFinished$1$2.L$0 = obj;
        return createTransferV2Duxo$onContributionQuestionnaireFinished$1$2;
    }
    ...
    public final Object invoke(CreateTransferV2DataState createTransferV2DataState, Continuation<? super CreateTransferV2DataState> continuation) {
        return ((CreateTransferV2Duxo$onContributionQuestionnaireFinished$1$2) create(createTransferV2DataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

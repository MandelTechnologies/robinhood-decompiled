...
@DebugMetadata(m3644c = "com.robinhood.android.transfers.ui.retirement.contributions.matchselection.agreements.ContributionAndAgreementDuxo$onGoldRejoinFlowCompleted$1$transferRequestResponse$1", m3645f = "ContributionAndAgreementDuxo.kt", m3646l = {167}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.android.transfers.ui.retirement.contributions.matchselection.agreements.ContributionAndAgreementDuxo$onGoldRejoinFlowCompleted$1$transferRequestResponse$1, reason: use source file name */
/* loaded from: classes9.dex */
final class ContributionAndAgreementDuxo4 extends ContinuationImpl7 implements Function1<Continuation<? super Response<ApiCreateTransferResponse>>, Object> {
    int label;
    final /* synthetic */ ContributionAndAgreementDuxo this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ContributionAndAgreementDuxo4(ContributionAndAgreementDuxo contributionAndAgreementDuxo, Continuation<? super ContributionAndAgreementDuxo4> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new ContributionAndAgreementDuxo4(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Continuation<? super Response<ApiCreateTransferResponse>> continuation) {
        return ((ContributionAndAgreementDuxo4) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }

...
public final class RecurringDepositHubFragment_MembersInjector implements MembersInjector<RecurringDepositHubFragment> {
    ...
    @JvmStatic
    public static final MembersInjector<RecurringDepositHubFragment> create(Provider<BaseFragmentSingletons> provider, Provider<GenericComposeSingletons> provider2, Provider<Set<Function2<NavGraphBuilder, NavHostController, Unit>>> provider3, Provider<SurveyManager3> provider4) {
        return INSTANCE.create(provider, provider2, provider3, provider4);
    }

    @JvmStatic
    public static final void injectUserLeapManager(RecurringDepositHubFragment recurringDepositHubFragment, SurveyManager3 surveyManager3) {
        INSTANCE.injectUserLeapManager(recurringDepositHubFragment, surveyManager3);
    }

    public RecurringDepositHubFragment_MembersInjector(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<Set<Function2<NavGraphBuilder, NavHostController, Unit>>> navGraphs, Provider<SurveyManager3> userLeapManager) {
    ...
    public void injectMembers(RecurringDepositHubFragment instance) {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final MembersInjector<RecurringDepositHubFragment> create(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<Set<Function2<NavGraphBuilder, NavHostController, Unit>>> navGraphs, Provider<SurveyManager3> userLeapManager) {
            Intrinsics.checkNotNullParameter(singletons, "singletons");
            Intrinsics.checkNotNullParameter(genericComposeSingletons, "genericComposeSingletons");
            Intrinsics.checkNotNullParameter(navGraphs, "navGraphs");
            Intrinsics.checkNotNullParameter(userLeapManager, "userLeapManager");
            return new RecurringDepositHubFragment_MembersInjector(singletons, genericComposeSingletons, navGraphs, userLeapManager);
        }

        @JvmStatic
        public final void injectUserLeapManager(RecurringDepositHubFragment instance, SurveyManager3 userLeapManager) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(userLeapManager, "userLeapManager");

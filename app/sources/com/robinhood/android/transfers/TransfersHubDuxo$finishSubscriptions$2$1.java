...
@DebugMetadata(m3644c = "com.robinhood.android.transfers.TransfersHubDuxo$finishSubscriptions$2$1", m3645f = "TransfersHubDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes9.dex */
final class TransfersHubDuxo$finishSubscriptions$2$1 extends ContinuationImpl7 implements Function2<TransfersHubViewState, Continuation<? super TransfersHubViewState>, Object> {
    final /* synthetic */ List<ApiPaymentInstrument> $activeDebitCardInstruments;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TransfersHubDuxo$finishSubscriptions$2$1(List<ApiPaymentInstrument> list, Continuation<? super TransfersHubDuxo$finishSubscriptions$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        TransfersHubDuxo$finishSubscriptions$2$1 transfersHubDuxo$finishSubscriptions$2$1 = new TransfersHubDuxo$finishSubscriptions$2$1(this.$activeDebitCardInstruments, continuation);
        transfersHubDuxo$finishSubscriptions$2$1.L$0 = obj;
        return transfersHubDuxo$finishSubscriptions$2$1;
    }
    ...
    public final Object invoke(TransfersHubViewState transfersHubViewState, Continuation<? super TransfersHubViewState> continuation) {
        return ((TransfersHubDuxo$finishSubscriptions$2$1) create(transfersHubViewState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

...
@DebugMetadata(m3644c = "com.robinhood.android.transfers.TransfersHubDuxo$finishSubscriptions$1$1", m3645f = "TransfersHubDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes9.dex */
final class TransfersHubDuxo$finishSubscriptions$1$1 extends ContinuationImpl7 implements Function2<TransfersHubViewState, Continuation<? super TransfersHubViewState>, Object> {
    final /* synthetic */ List<AchRelationship> $relationships;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TransfersHubDuxo$finishSubscriptions$1$1(List<AchRelationship> list, Continuation<? super TransfersHubDuxo$finishSubscriptions$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        TransfersHubDuxo$finishSubscriptions$1$1 transfersHubDuxo$finishSubscriptions$1$1 = new TransfersHubDuxo$finishSubscriptions$1$1(this.$relationships, continuation);
        transfersHubDuxo$finishSubscriptions$1$1.L$0 = obj;
        return transfersHubDuxo$finishSubscriptions$1$1;
    }
    ...
    public final Object invoke(TransfersHubViewState transfersHubViewState, Continuation<? super TransfersHubViewState> continuation) {
        return ((TransfersHubDuxo$finishSubscriptions$1$1) create(transfersHubViewState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

...
public abstract class Hammer_CryptoTransfersActionsView extends GenericComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_CryptoTransfersActionsView(Context context, AttributeSet attributeSet) {
        ...
        Hammer_CryptoTransfersActionsView2 hammer_CryptoTransfersActionsView2 = (Hammer_CryptoTransfersActionsView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.crypto.ui.view.CryptoTransfersActionsView");
        hammer_CryptoTransfersActionsView2.inject((CryptoTransfersActionsView) this);
        this.injected = true;
    }
}

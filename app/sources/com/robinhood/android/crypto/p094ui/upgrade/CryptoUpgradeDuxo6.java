...
@DebugMetadata(m3644c = "com.robinhood.android.crypto.ui.upgrade.CryptoUpgradeDuxo$onStart$residencyDocumentObservable$1", m3645f = "CryptoUpgradeDuxo.kt", m3646l = {56}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.android.crypto.ui.upgrade.CryptoUpgradeDuxo$onStart$residencyDocumentObservable$1, reason: use source file name */
/* loaded from: classes2.dex */
final class CryptoUpgradeDuxo6 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super PaginatedResult<? extends ApiResidencyDocument>>, Object> {
    int label;
    final /* synthetic */ CryptoUpgradeDuxo this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CryptoUpgradeDuxo6(CryptoUpgradeDuxo cryptoUpgradeDuxo, Continuation<? super CryptoUpgradeDuxo6> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CryptoUpgradeDuxo6(this.this$0, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super PaginatedResult<ApiResidencyDocument>> continuation) {
        return ((CryptoUpgradeDuxo6) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

...
@DebugMetadata(m3644c = "com.robinhood.android.notification.data.ProductUpsellDuxo$fetchUpsellDetails$2$primaryCtaResource$1", m3645f = "ProductUpsellDuxo.kt", m3646l = {99}, m3647m = "invokeSuspend")
/* loaded from: classes8.dex */
final class ProductUpsellDuxo$fetchUpsellDetails$2$primaryCtaResource$1 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super ProductUpsellResource.CtaButton>, Object> {
    final /* synthetic */ ProductUpsellResource $resource;
    int label;
    final /* synthetic */ ProductUpsellDuxo this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    ProductUpsellDuxo$fetchUpsellDetails$2$primaryCtaResource$1(ProductUpsellDuxo productUpsellDuxo, ProductUpsellResource productUpsellResource, Continuation<? super ProductUpsellDuxo$fetchUpsellDetails$2$primaryCtaResource$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ProductUpsellDuxo$fetchUpsellDetails$2$primaryCtaResource$1(this.this$0, this.$resource, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ProductUpsellResource.CtaButton> continuation) {
        return ((ProductUpsellDuxo$fetchUpsellDetails$2$primaryCtaResource$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

...
@DebugMetadata(m3644c = "com.robinhood.android.equitytradeladder.EquityTradeLadderDuxo$cancelOrder$3$1$2$1", m3645f = "EquityTradeLadderDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes3.dex */
final class EquityTradeLadderDuxo$cancelOrder$3$1$2$1 extends ContinuationImpl7 implements Function2<EquityTradeLadderDataState, Continuation<? super EquityTradeLadderDataState>, Object> {
    final /* synthetic */ Order $order;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    EquityTradeLadderDuxo$cancelOrder$3$1$2$1(Order order, Continuation<? super EquityTradeLadderDuxo$cancelOrder$3$1$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        EquityTradeLadderDuxo$cancelOrder$3$1$2$1 equityTradeLadderDuxo$cancelOrder$3$1$2$1 = new EquityTradeLadderDuxo$cancelOrder$3$1$2$1(this.$order, continuation);
        equityTradeLadderDuxo$cancelOrder$3$1$2$1.L$0 = obj;
        return equityTradeLadderDuxo$cancelOrder$3$1$2$1;
    }
    ...
    public final Object invoke(EquityTradeLadderDataState equityTradeLadderDataState, Continuation<? super EquityTradeLadderDataState> continuation) {
        return ((EquityTradeLadderDuxo$cancelOrder$3$1$2$1) create(equityTradeLadderDataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        uiPendingOrdersMap.remove(this.$order.getId());

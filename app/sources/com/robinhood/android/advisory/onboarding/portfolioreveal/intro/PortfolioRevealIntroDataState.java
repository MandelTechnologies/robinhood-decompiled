...
import com.robinhood.models.advisory.p304db.onboarding.PortfolioRevealResponse2;
...
/* compiled from: PortfolioRevealIntroDataState.kt */
@Metadata(m3635d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u000b\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\n\n\u0002\u0010\b\n\u0002\b\u0003\b\u0087\b\u0018\u00002\u00020\u0001:\u0001'B-\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\n\b\u0002\u0010\u0006\u001a\u0004\u0018\u00010\u0007\u0012\b\b\u0002\u0010\b\u001a\u00020\t¢\u0006\u0004\b\n\u0010\u000bJ\t\u0010\u001d\u001a\u00020\u0003HÆ\u0003J\t\u0010\u001e\u001a\u00020\u0005HÆ\u0003J\u000b\u0010\u001f\u001a\u0004\u0018\u00010\u0007HÆ\u0003J\t\u0010 \u001a\u00020\tHÆ\u0003J3\u0010!\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00052\n\b\u0002\u0010\u0006\u001a\u0004\u0018\u00010\u00072\b\b\u0002\u0010\b\u001a\u00020\tHÆ\u0001J\u0013\u0010\"\u001a\u00020\t2\b\u0010#\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010$\u001a\u00020%HÖ\u0001J\t\u0010&\u001a\u00020\u0005HÖ\u0001R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\rR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u000e\u0010\u000fR\u0013\u0010\u0006\u001a\u0004\u0018\u00010\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u0010\u0010\u0011R\u0011\u0010\b\u001a\u00020\t¢\u0006\b\n\u0000\u001a\u0004\b\u0012\u0010\u0013R\u0015\u0010\u0014\u001a\u00060\u0015j\u0002`\u00168F¢\u0006\u0006\u001a\u0004\b\u0017\u0010\u0018R\u0011\u0010\u0019\u001a\u00020\u001a8F¢\u0006\u0006\u001a\u0004\b\u001b\u0010\u001c¨\u0006("}, m3636d2 = {"Lcom/robinhood/android/advisory/onboarding/portfolioreveal/intro/PortfolioRevealIntroDataState;", "", "brokerageAccountType", "Lcom/robinhood/models/api/BrokerageAccountType;", "source", "", "portfolioReveal", "Ladvisory/portfolio_reveal/proto/v1/GetPortfolioRevealResponseDto;", "loadingAnimationHasCompleted", "", "<init>", "(Lcom/robinhood/models/api/BrokerageAccountType;Ljava/lang/String;Ladvisory/portfolio_reveal/proto/v1/GetPortfolioRevealResponseDto;Z)V", "getBrokerageAccountType", "()Lcom/robinhood/models/api/BrokerageAccountType;", "getSource", "()Ljava/lang/String;", "getPortfolioReveal", "()Ladvisory/portfolio_reveal/proto/v1/GetPortfolioRevealResponseDto;", "getLoadingAnimationHasCompleted", "()Z", "context", "Lcom/robinhood/rosetta/eventlogging/Context;", "Lcom/robinhood/rosetta/eventlogging/EventContext;", "getContext", "()Lcom/robinhood/rosetta/eventlogging/Context;", "viewState", "Lcom/robinhood/android/advisory/onboarding/portfolioreveal/intro/PortfolioRevealIntroDataState$ViewState;", "getViewState", "()Lcom/robinhood/android/advisory/onboarding/portfolioreveal/intro/PortfolioRevealIntroDataState$ViewState;", "component1", "component2", "component3", "component4", "copy", "equals", "other", "hashCode", "", "toString", "ViewState", "feature-advisory-onboarding_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
/* loaded from: classes7.dex */
public final /* data */ class PortfolioRevealIntroDataState {
    public static final int $stable = 8;
    private final BrokerageAccountType brokerageAccountType;
    private final boolean loadingAnimationHasCompleted;
    private final GetPortfolioRevealResponseDto portfolioReveal;
    private final String source;

    public static /* synthetic */ PortfolioRevealIntroDataState copy$default(PortfolioRevealIntroDataState portfolioRevealIntroDataState, BrokerageAccountType brokerageAccountType, String str, GetPortfolioRevealResponseDto getPortfolioRevealResponseDto, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            brokerageAccountType = portfolioRevealIntroDataState.brokerageAccountType;
        }
        if ((i & 2) != 0) {
            str = portfolioRevealIntroDataState.source;
        }
        if ((i & 4) != 0) {
            getPortfolioRevealResponseDto = portfolioRevealIntroDataState.portfolioReveal;
        }
        if ((i & 8) != 0) {
            z = portfolioRevealIntroDataState.loadingAnimationHasCompleted;
        }
        return portfolioRevealIntroDataState.copy(brokerageAccountType, str, getPortfolioRevealResponseDto, z);
    }
    ...
    public final boolean getLoadingAnimationHasCompleted() {
        return this.loadingAnimationHasCompleted;
    }

    public final PortfolioRevealIntroDataState copy(BrokerageAccountType brokerageAccountType, String source, GetPortfolioRevealResponseDto portfolioReveal, boolean loadingAnimationHasCompleted) {
        Intrinsics.checkNotNullParameter(brokerageAccountType, "brokerageAccountType");
        Intrinsics.checkNotNullParameter(source, "source");
        return new PortfolioRevealIntroDataState(brokerageAccountType, source, portfolioReveal, loadingAnimationHasCompleted);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PortfolioRevealIntroDataState)) {
            return false;
        }
        PortfolioRevealIntroDataState portfolioRevealIntroDataState = (PortfolioRevealIntroDataState) other;
        return this.brokerageAccountType == portfolioRevealIntroDataState.brokerageAccountType && Intrinsics.areEqual(this.source, portfolioRevealIntroDataState.source) && Intrinsics.areEqual(this.portfolioReveal, portfolioRevealIntroDataState.portfolioReveal) && this.loadingAnimationHasCompleted == portfolioRevealIntroDataState.loadingAnimationHasCompleted;
    }

    public int hashCode() {
        int iHashCode = ((this.brokerageAccountType.hashCode() * 31) + this.source.hashCode()) * 31;
        GetPortfolioRevealResponseDto getPortfolioRevealResponseDto = this.portfolioReveal;
        return ((iHashCode + (getPortfolioRevealResponseDto == null ? 0 : getPortfolioRevealResponseDto.hashCode())) * 31) + Boolean.hashCode(this.loadingAnimationHasCompleted);
    }

    public String toString() {
        return "PortfolioRevealIntroDataState(brokerageAccountType=" + this.brokerageAccountType + ", source=" + this.source + ", portfolioReveal=" + this.portfolioReveal + ", loadingAnimationHasCompleted=" + this.loadingAnimationHasCompleted + ")";
    }

    public PortfolioRevealIntroDataState(BrokerageAccountType brokerageAccountType, String source, GetPortfolioRevealResponseDto getPortfolioRevealResponseDto, boolean z) {
        Intrinsics.checkNotNullParameter(brokerageAccountType, "brokerageAccountType");
        Intrinsics.checkNotNullParameter(source, "source");
        this.brokerageAccountType = brokerageAccountType;
        this.source = source;
        this.portfolioReveal = getPortfolioRevealResponseDto;
        this.loadingAnimationHasCompleted = z;
    }

    public /* synthetic */ PortfolioRevealIntroDataState(BrokerageAccountType brokerageAccountType, String str, GetPortfolioRevealResponseDto getPortfolioRevealResponseDto, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(brokerageAccountType, str, (i & 4) != 0 ? null : getPortfolioRevealResponseDto, (i & 8) != 0 ? false : z);
    }
    ...
    public interface ViewState {
        ...
        public static final /* data */ class Loading implements ViewState {
            ...
            public final Loading copy(ImmutableList<Integer> messages) {
                Intrinsics.checkNotNullParameter(messages, "messages");
                return new Loading(messages);
            }
            ...
            public boolean equals(Object other) {
                ...
                return (other instanceof Loading) && Intrinsics.areEqual(this.messages, ((Loading) other).messages);
            }
            ...
            public String toString() {
                return "Loading(messages=" + this.messages + ")";
            }

            public Loading(ImmutableList<Integer> messages) {
                Intrinsics.checkNotNullParameter(messages, "messages");
                this.messages = messages;
            }

            public final ImmutableList<Integer> getMessages() {
                return this.messages;
            }
        }

        /* compiled from: PortfolioRevealIntroDataState.kt */
        @Metadata(m3635d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\n\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0087\b\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0004\b\u0006\u0010\u0007J\t\u0010\f\u001a\u00020\u0003HÆ\u0003J\t\u0010\r\u001a\u00020\u0005HÆ\u0003J\u001d\u0010\u000e\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u0005HÆ\u0001J\u0013\u0010\u000f\u001a\u00020\u00102\b\u0010\u0011\u001a\u0004\u0018\u00010\u0012HÖ\u0003J\t\u0010\u0013\u001a\u00020\u0014HÖ\u0001J\t\u0010\u0015\u001a\u00020\u0016HÖ\u0001R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\tR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000b¨\u0006\u0017"}, m3636d2 = {"Lcom/robinhood/android/advisory/onboarding/portfolioreveal/intro/PortfolioRevealIntroDataState$ViewState$Loaded;", "Lcom/robinhood/android/advisory/onboarding/portfolioreveal/intro/PortfolioRevealIntroDataState$ViewState;", "intro", "Lcom/robinhood/models/advisory/db/onboarding/PortfolioRevealResponse$Intro;", "response", "Ladvisory/portfolio_reveal/proto/v1/GetPortfolioRevealResponseDto;", "<init>", "(Lcom/robinhood/models/advisory/db/onboarding/PortfolioRevealResponse$Intro;Ladvisory/portfolio_reveal/proto/v1/GetPortfolioRevealResponseDto;)V", "getIntro", "()Lcom/robinhood/models/advisory/db/onboarding/PortfolioRevealResponse$Intro;", "getResponse", "()Ladvisory/portfolio_reveal/proto/v1/GetPortfolioRevealResponseDto;", "component1", "component2", "copy", "equals", "", "other", "", "hashCode", "", "toString", "", "feature-advisory-onboarding_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
        public static final /* data */ class Loaded implements ViewState {
            public static final int $stable = 8;
            private final PortfolioRevealResponse.Intro intro;
            private final GetPortfolioRevealResponseDto response;

            public static /* synthetic */ Loaded copy$default(Loaded loaded, PortfolioRevealResponse.Intro intro, GetPortfolioRevealResponseDto getPortfolioRevealResponseDto, int i, Object obj) {
                if ((i & 1) != 0) {
                    intro = loaded.intro;
                }
                if ((i & 2) != 0) {
                    getPortfolioRevealResponseDto = loaded.response;
                }
                return loaded.copy(intro, getPortfolioRevealResponseDto);
            }

            /* renamed from: component1, reason: from getter */
            public final PortfolioRevealResponse.Intro getIntro() {
                return this.intro;
            }

            /* renamed from: component2, reason: from getter */
            public final GetPortfolioRevealResponseDto getResponse() {
                return this.response;
            }

            public final Loaded copy(PortfolioRevealResponse.Intro intro, GetPortfolioRevealResponseDto response) {
                Intrinsics.checkNotNullParameter(intro, "intro");
                Intrinsics.checkNotNullParameter(response, "response");
                return new Loaded(intro, response);
            }
            ...
            public boolean equals(Object other) {
                ...
                return Intrinsics.areEqual(this.intro, loaded.intro) && Intrinsics.areEqual(this.response, loaded.response);
            }

            public int hashCode() {
                return (this.intro.hashCode() * 31) + this.response.hashCode();
            }

            public String toString() {
                return "Loaded(intro=" + this.intro + ", response=" + this.response + ")";
            }

            public Loaded(PortfolioRevealResponse.Intro intro, GetPortfolioRevealResponseDto response) {
                Intrinsics.checkNotNullParameter(intro, "intro");
                Intrinsics.checkNotNullParameter(response, "response");
                this.intro = intro;

...
/* renamed from: com.robinhood.android.advisory.tlh.summary.TaxLossHarvestingSummaryScreenKt$TaxLossHarvestingTimeline$2$2, reason: use source file name */
/* loaded from: classes7.dex */
final class TaxLossHarvestingSummaryScreen4 implements Function3<RhModalBottomSheet5, Composer, Integer, Unit> {
    final /* synthetic */ SnapshotState<TaxLossHarvestDashboard.BottomSheet> $bottomSheet$delegate;
    final /* synthetic */ TaxLossHarvestDashboard.BottomSheet $bottomSheetData;

    TaxLossHarvestingSummaryScreen4(TaxLossHarvestDashboard.BottomSheet bottomSheet, SnapshotState<TaxLossHarvestDashboard.BottomSheet> snapshotState) {
        this.$bottomSheetData = bottomSheet;
        this.$bottomSheet$delegate = snapshotState;
    }
    ...
    public final void invoke(RhModalBottomSheet5 RhModalBottomSheet, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1449005868, i, -1, "com.robinhood.android.advisory.tlh.summary.TaxLossHarvestingTimeline.<anonymous>.<anonymous> (TaxLossHarvestingSummaryScreen.kt:164)");
        }
        ...
        TaxLossHarvestDashboard.BottomSheet bottomSheet = this.$bottomSheetData;
        final SnapshotState<TaxLossHarvestDashboard.BottomSheet> snapshotState = this.$bottomSheet$delegate;
        ...
        composer.startReplaceGroup(1349808683);
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new Function0() { // from class: com.robinhood.android.advisory.tlh.summary.TaxLossHarvestingSummaryScreenKt$TaxLossHarvestingTimeline$2$2$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return TaxLossHarvestingSummaryScreen4.invoke$lambda$2$lambda$1$lambda$0(snapshotState);
                }
            };

...
public final class PromptsVerificationFragment extends GenericComposeFragment implements AutoLoggableFragment {
    ...
    private final Interfaces2 callbacks = new CallbacksProperty(Reflection.getOrCreateKotlinClass(ChallengeVerificationCallbacks.class), new Function1<Fragment, Object>() { // from class: com.robinhood.android.challenge.verification.prompts.PromptsVerificationFragment$special$$inlined$hostActivityCallbacks$1
    ...
    public static final Unit ComposeContent$lambda$2(PromptsVerificationFragment promptsVerificationFragment, int i, Composer composer, int i2) {
        promptsVerificationFragment.ComposeContent(composer, RecomposeScopeImpl4.updateChangedFlags(i | 1));
    ...
    private final void handleEvent(final Event<PromptsVerificationEvent> event) {
        EventConsumer<PromptsVerificationEvent> eventConsumerInvoke;
        if (!(event.getData() instanceof PromptsVerificationEvent) || (eventConsumerInvoke = event.getGetEventConsumer().invoke()) == null) {
            return;
        }
        eventConsumerInvoke.consume(event, new Function1() { // from class: com.robinhood.android.challenge.verification.prompts.PromptsVerificationFragment$handleEvent$$inlined$consumeIfType$1
            @Override // kotlin.jvm.functions.Function1
            ...
            public final void m11799invoke(Object it) {
                Intrinsics.checkNotNullParameter(it, "it");
                PromptsVerificationEvent promptsVerificationEvent = (PromptsVerificationEvent) event.getData();
                ...
                if (promptsVerificationEvent instanceof PromptsVerificationEvent.RecreateLoginChallenge) {
                    this.getCallbacks().onChallengeCompleted(null);
                    return;
                }
                ...
                if (promptsVerificationEvent instanceof PromptsVerificationEvent.Success) {
                    this.getCallbacks().onChallengeCompleted(((PromptsVerificationEvent.Success) promptsVerificationEvent).getChallengeId());
                } else if (promptsVerificationEvent instanceof PromptsVerificationEvent.Timeout) {
                    this.getCallbacks().onChallengeCompleted(((PromptsVerificationEvent.Timeout) promptsVerificationEvent).getChallengeId());
                } else {
                    if (promptsVerificationEvent instanceof PromptsVerificationEvent.UseFallback) {
                        this.getCallbacks().onUseFallbackMfa(((PromptsVerificationEvent.UseFallback) promptsVerificationEvent).getChallengeId());
                        return;
                    }
    ...
    public com.robinhood.rosetta.eventlogging.Context getScreenEventContext() {
        ...
        UUID id = challenge != null ? challenge.getId() : null;
    ...
    public void ComposeContent(Composer composer, final int i) {
        ...
        if ((i2 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-988870950, i2, -1, "com.robinhood.android.challenge.verification.prompts.PromptsVerificationFragment.ComposeContent (PromptsVerificationFragment.kt:54)");
            }
            ...
            Flow<Event<?>> flow = new Flow<Event<?>>() { // from class: com.robinhood.android.challenge.verification.prompts.PromptsVerificationFragment$ComposeContent$$inlined$collectEventAsStateWithLifecycle$1
                ...
                public static final class AnonymousClass2<T> implements FlowCollector {
                    ...
                    @Metadata(m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
                    @DebugMetadata(m3644c = "com.robinhood.android.challenge.verification.prompts.PromptsVerificationFragment$ComposeContent$$inlined$collectEventAsStateWithLifecycle$1$2", m3645f = "PromptsVerificationFragment.kt", m3646l = {50}, m3647m = "emit")
            ...
            Event<PromptsVerificationEvent> eventComposeContent$lambda$1 = ComposeContent$lambda$1(snapshotState4CollectAsStateWithLifecycle2);
            if (eventComposeContent$lambda$1 != null) {
                handleEvent(eventComposeContent$lambda$1);
            }
            BentoThemeOverlays.AchromaticThemeOverlay(ComposableLambda3.rememberComposableLambda(1157348197, true, new C105362(snapshotState4CollectAsStateWithLifecycle), composerStartRestartGroup, 54), composerStartRestartGroup, 6);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: com.robinhood.android.challenge.verification.prompts.PromptsVerificationFragment$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return PromptsVerificationFragment.ComposeContent$lambda$2(this.f$0, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    @Metadata(m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    @SourceDebugExtension
    /* renamed from: com.robinhood.android.challenge.verification.prompts.PromptsVerificationFragment$ComposeContent$2 */
    static final class C105362 implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ SnapshotState4<DeviceApprovalChallengeViewState> $viewState$delegate;

        C105362(SnapshotState4<DeviceApprovalChallengeViewState> snapshotState4) {
        ...
        public final void invoke(Composer composer, int i) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1157348197, i, -1, "com.robinhood.android.challenge.verification.prompts.PromptsVerificationFragment.ComposeContent.<anonymous> (PromptsVerificationFragment.kt:60)");
            }
            DeviceApprovalChallengeViewState deviceApprovalChallengeViewStateComposeContent$lambda$0 = PromptsVerificationFragment.ComposeContent$lambda$0(this.$viewState$delegate);
            PromptsVerificationDuxo duxo = PromptsVerificationFragment.this.getDuxo();
            composer.startReplaceGroup(5004770);
            boolean zChangedInstance = composer.changedInstance(duxo);
            Object objRememberedValue = composer.rememberedValue();
            if (zChangedInstance || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new PromptsVerificationFragment2(duxo);
                composer.updateRememberedValue(objRememberedValue);
            }
            composer.endReplaceGroup();
            Function0 function0 = (Function0) ((KFunction) objRememberedValue);
            composer.startReplaceGroup(-1633490746);
            boolean zChanged = composer.changed(this.$viewState$delegate) | composer.changedInstance(PromptsVerificationFragment.this);
            final PromptsVerificationFragment promptsVerificationFragment = PromptsVerificationFragment.this;
            final SnapshotState4<DeviceApprovalChallengeViewState> snapshotState4 = this.$viewState$delegate;
            Object objRememberedValue2 = composer.rememberedValue();
            if (zChanged || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue2 = new Function0() { // from class: com.robinhood.android.challenge.verification.prompts.PromptsVerificationFragment$ComposeContent$2$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        return PromptsVerificationFragment.C105362.invoke$lambda$2$lambda$1(promptsVerificationFragment, snapshotState4);
                    }
                };
            ...
            composer.endReplaceGroup();
            PromptsVerificationDuxo duxo2 = PromptsVerificationFragment.this.getDuxo();
            composer.startReplaceGroup(5004770);
            boolean zChangedInstance2 = composer.changedInstance(duxo2);
            Object objRememberedValue3 = composer.rememberedValue();
            if (zChangedInstance2 || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue3 = new PromptsVerificationFragment3(duxo2);
                composer.updateRememberedValue(objRememberedValue3);
            }
            composer.endReplaceGroup();
            DeviceApprovalChallengeComposable.DeviceApprovalChallengeComposable(deviceApprovalChallengeViewStateComposeContent$lambda$0, function0, function02, (Function0) ((KFunction) objRememberedValue3), null, composer, DeviceApprovalChallengeViewState.$stable, 16);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit invoke$lambda$2$lambda$1(PromptsVerificationFragment promptsVerificationFragment, SnapshotState4 snapshotState4) {
            if (PromptsVerificationFragment.ComposeContent$lambda$0(snapshotState4).getShowLoadingLottie()) {
                promptsVerificationFragment.logMissingNotification();
            }
            promptsVerificationFragment.getDuxo().onSecondaryCtaClicked();
            return Unit.INSTANCE;
        }
    }
    ...
    private static final Event<PromptsVerificationEvent> ComposeContent$lambda$1(SnapshotState4<Event<PromptsVerificationEvent>> snapshotState4) {
        return snapshotState4.getValue();
    }
    ...
    public final void logMissingNotification() {
        ...
        EventLogger.DefaultImpls.logTap$default(eventLogger, action, screen, null, null, new com.robinhood.rosetta.eventlogging.Context(0, 0, 0, objArr2, str, null, objArr3, objArr4, 0, str2, str3, objArr5, null, objArr, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, new ChallengeContext(null, String.valueOf(id), null, null, str, String.valueOf(((ChallengeVerificationInput) companion.getArgs((Fragment) this)).getVerificationWorkflowId()), null, null, null, str2, str3, null, 4061, null), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, -1, -1, -4097, -1, -1, -1, 16383, null), false, 44, null);
    }

    /* compiled from: PromptsVerificationFragment.kt */
    @Metadata(m3635d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\t\b\u0002¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, m3636d2 = {"Lcom/robinhood/android/challenge/verification/prompts/PromptsVerificationFragment$Companion;", "Lcom/robinhood/utils/ui/fragment/FragmentWithArgsCompanion;", "Lcom/robinhood/android/challenge/verification/prompts/PromptsVerificationFragment;", "Lcom/robinhood/shared/security/contracts/ChallengeVerificationInput;", "<init>", "()V", "feature-challenge_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)

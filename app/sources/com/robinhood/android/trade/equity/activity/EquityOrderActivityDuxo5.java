...
@DebugMetadata(m3644c = "com.robinhood.android.trade.equity.activity.EquityOrderActivityDuxo$startStores$10$1", m3645f = "EquityOrderActivityDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.android.trade.equity.activity.EquityOrderActivityDuxo$startStores$10$1, reason: use source file name */
/* loaded from: classes9.dex */
final class EquityOrderActivityDuxo5 extends ContinuationImpl7 implements Function2<EquityOrderActivityViewState, Continuation<? super EquityOrderActivityViewState>, Object> {
    final /* synthetic */ boolean $inRegionAndExperiment;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    EquityOrderActivityDuxo5(boolean z, Continuation<? super EquityOrderActivityDuxo5> continuation) {
        super(2, continuation);
        this.$inRegionAndExperiment = z;
    }

    @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        EquityOrderActivityDuxo5 equityOrderActivityDuxo5 = new EquityOrderActivityDuxo5(this.$inRegionAndExperiment, continuation);
        equityOrderActivityDuxo5.L$0 = obj;
        return equityOrderActivityDuxo5;
    }
    ...
    public final Object invoke(EquityOrderActivityViewState equityOrderActivityViewState, Continuation<? super EquityOrderActivityViewState> continuation) {
        return ((EquityOrderActivityDuxo5) create(equityOrderActivityViewState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

...
@DebugMetadata(m3644c = "com.robinhood.android.trade.equity.ui.share.EquityShareOrderDuxo$cancelPendingCryptoOrders$1$1$1", m3645f = "EquityShareOrderDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes9.dex */
final class EquityShareOrderDuxo$cancelPendingCryptoOrders$1$1$1 extends ContinuationImpl7 implements Function2<EquityShareOrderDataState, Continuation<? super EquityShareOrderDataState>, Object> {
    final /* synthetic */ boolean $it;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    EquityShareOrderDuxo$cancelPendingCryptoOrders$1$1$1(boolean z, Continuation<? super EquityShareOrderDuxo$cancelPendingCryptoOrders$1$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        EquityShareOrderDuxo$cancelPendingCryptoOrders$1$1$1 equityShareOrderDuxo$cancelPendingCryptoOrders$1$1$1 = new EquityShareOrderDuxo$cancelPendingCryptoOrders$1$1$1(this.$it, continuation);
        equityShareOrderDuxo$cancelPendingCryptoOrders$1$1$1.L$0 = obj;
        return equityShareOrderDuxo$cancelPendingCryptoOrders$1$1$1;
    }
    ...
    public final Object invoke(EquityShareOrderDataState equityShareOrderDataState, Continuation<? super EquityShareOrderDataState> continuation) {
        return ((EquityShareOrderDuxo$cancelPendingCryptoOrders$1$1$1) create(equityShareOrderDataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

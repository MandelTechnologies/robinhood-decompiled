...
@DebugMetadata(m3644c = "com.robinhood.android.trade.equity.ui.share.EquityShareOrderDuxo$appendOverridesAndValidate$2$1", m3645f = "EquityShareOrderDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes9.dex */
final class EquityShareOrderDuxo$appendOverridesAndValidate$2$1 extends ContinuationImpl7 implements Function2<EquityShareOrderDataState, Continuation<? super EquityShareOrderDataState>, Object> {
    final /* synthetic */ List<String> $newCheckOverrides;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    EquityShareOrderDuxo$appendOverridesAndValidate$2$1(List<String> list, Continuation<? super EquityShareOrderDuxo$appendOverridesAndValidate$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        EquityShareOrderDuxo$appendOverridesAndValidate$2$1 equityShareOrderDuxo$appendOverridesAndValidate$2$1 = new EquityShareOrderDuxo$appendOverridesAndValidate$2$1(this.$newCheckOverrides, continuation);
        equityShareOrderDuxo$appendOverridesAndValidate$2$1.L$0 = obj;
        return equityShareOrderDuxo$appendOverridesAndValidate$2$1;
    }
    ...
    public final Object invoke(EquityShareOrderDataState equityShareOrderDataState, Continuation<? super EquityShareOrderDataState> continuation) {
        return ((EquityShareOrderDuxo$appendOverridesAndValidate$2$1) create(equityShareOrderDataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

...
/* renamed from: com.robinhood.android.cortex.digest.portfolio.splash.PortfolioDigestSplashComposableKt$PortfolioDigestSplashLoaded$$inlined$ConstraintLayout$2 */
/* loaded from: classes2.dex */
public final class C12164x1cbdf98b extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public C12164x1cbdf98b(Channel channel, SnapshotIntState2 snapshotIntState2, Animatable animatable, AnimationSpec animationSpec, Function0 function0, SnapshotState snapshotState, SnapshotState snapshotState2, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new C12164x1cbdf98b(this.$channel, this.$direction, this.$progress, this.$animateChangesSpec, this.$finishedAnimationListener, this.$startConstraint$delegate, this.$endConstraint$delegate, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((C12164x1cbdf98b) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            channel3 = (Channel3) this.L$0;
            ResultKt.throwOnFailure(obj);
            C12164x1cbdf98b c12164x1cbdf98b = this;
            it = channel3;
            SnapshotIntState2 snapshotIntState2 = c12164x1cbdf98b.$direction;
            snapshotIntState2.setIntValue(snapshotIntState2.getIntValue() == 1 ? 0 : 1);
            Function0 function0 = c12164x1cbdf98b.$finishedAnimationListener;
            if (function0 != null) {
                function0.invoke();
            }
            this.L$0 = it;

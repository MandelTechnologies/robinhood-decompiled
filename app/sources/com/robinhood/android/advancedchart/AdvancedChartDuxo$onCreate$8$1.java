...
@DebugMetadata(m3644c = "com.robinhood.android.advancedchart.AdvancedChartDuxo$onCreate$8$1", m3645f = "AdvancedChartDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes24.dex */
final class AdvancedChartDuxo$onCreate$8$1 extends ContinuationImpl7 implements Function2<AdvancedChartViewState, Continuation<? super AdvancedChartViewState>, Object> {
    final /* synthetic */ TechnicalIndicatorConfigList $configList;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    AdvancedChartDuxo$onCreate$8$1(TechnicalIndicatorConfigList technicalIndicatorConfigList, Continuation<? super AdvancedChartDuxo$onCreate$8$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        AdvancedChartDuxo$onCreate$8$1 advancedChartDuxo$onCreate$8$1 = new AdvancedChartDuxo$onCreate$8$1(this.$configList, continuation);
        advancedChartDuxo$onCreate$8$1.L$0 = obj;
        return advancedChartDuxo$onCreate$8$1;
    }
    ...
    public final Object invoke(AdvancedChartViewState advancedChartViewState, Continuation<? super AdvancedChartViewState> continuation) {
        return ((AdvancedChartDuxo$onCreate$8$1) create(advancedChartViewState, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        IndicatorStateList indicatorList = advancedChartViewState.getIndicatorList();

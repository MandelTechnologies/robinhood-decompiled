...
@DebugMetadata(m3644c = "com.robinhood.android.advancedchart.AdvancedChartDuxo$onCreate$4$1", m3645f = "AdvancedChartDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes24.dex */
final class AdvancedChartDuxo$onCreate$4$1 extends ContinuationImpl7 implements Function2<AdvancedChartViewState, Continuation<? super AdvancedChartViewState>, Object> {
    final /* synthetic */ boolean $showExtendedHour;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    AdvancedChartDuxo$onCreate$4$1(boolean z, Continuation<? super AdvancedChartDuxo$onCreate$4$1> continuation) {
        super(2, continuation);
        this.$showExtendedHour = z;
    }

    @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        AdvancedChartDuxo$onCreate$4$1 advancedChartDuxo$onCreate$4$1 = new AdvancedChartDuxo$onCreate$4$1(this.$showExtendedHour, continuation);
        advancedChartDuxo$onCreate$4$1.L$0 = obj;
        return advancedChartDuxo$onCreate$4$1;
    }
    ...
    public final Object invoke(AdvancedChartViewState advancedChartViewState, Continuation<? super AdvancedChartViewState> continuation) {
        return ((AdvancedChartDuxo$onCreate$4$1) create(advancedChartViewState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

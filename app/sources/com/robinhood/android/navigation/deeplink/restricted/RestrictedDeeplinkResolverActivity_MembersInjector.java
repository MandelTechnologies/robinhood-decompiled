...
public final class RestrictedDeeplinkResolverActivity_MembersInjector implements MembersInjector<RestrictedDeeplinkResolverActivity> {
    ...
    @JvmStatic
    public static final MembersInjector<RestrictedDeeplinkResolverActivity> create(Provider<BaseActivitySingletons> provider, Provider<AuthManager> provider2, Provider<DeepLinkResolver> provider3) {
        return INSTANCE.create(provider, provider2, provider3);
    }

    @JvmStatic
    @SupportsRestrictedDeepLinks
    public static final void injectInjectedDeepLinkResolver(RestrictedDeeplinkResolverActivity restrictedDeeplinkResolverActivity, DeepLinkResolver deepLinkResolver) {
        INSTANCE.injectInjectedDeepLinkResolver(restrictedDeeplinkResolverActivity, deepLinkResolver);
    }

    public RestrictedDeeplinkResolverActivity_MembersInjector(Provider<BaseActivitySingletons> singletons, Provider<AuthManager> authManager, Provider<DeepLinkResolver> injectedDeepLinkResolver) {
    ...
    public void injectMembers(RestrictedDeeplinkResolverActivity instance) {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final MembersInjector<RestrictedDeeplinkResolverActivity> create(Provider<BaseActivitySingletons> singletons, Provider<AuthManager> authManager, Provider<DeepLinkResolver> injectedDeepLinkResolver) {
            Intrinsics.checkNotNullParameter(singletons, "singletons");
            Intrinsics.checkNotNullParameter(authManager, "authManager");
            Intrinsics.checkNotNullParameter(injectedDeepLinkResolver, "injectedDeepLinkResolver");
            return new RestrictedDeeplinkResolverActivity_MembersInjector(singletons, authManager, injectedDeepLinkResolver);
        }

        @JvmStatic
        @SupportsRestrictedDeepLinks
        public final void injectInjectedDeepLinkResolver(RestrictedDeeplinkResolverActivity instance, DeepLinkResolver injectedDeepLinkResolver) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(injectedDeepLinkResolver, "injectedDeepLinkResolver");

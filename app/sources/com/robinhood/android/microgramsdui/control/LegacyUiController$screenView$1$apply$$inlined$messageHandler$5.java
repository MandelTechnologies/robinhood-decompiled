...
public final class LegacyUiController$screenView$1$apply$$inlined$messageHandler$5 implements MessageHandler {
    final /* synthetic */ JsonAdapter $adapter$inlined;
    final /* synthetic */ SharedFlow2 $this_messageHandler;

    @Metadata(m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "com.robinhood.android.microgramsdui.control.LegacyUiController$screenView$1$apply$$inlined$messageHandler$5", m3645f = "LegacyUiController.kt", m3646l = {16}, m3647m = "handle")
    /* renamed from: com.robinhood.android.microgramsdui.control.LegacyUiController$screenView$1$apply$$inlined$messageHandler$5$1 */
    public static final class C219261 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        public C219261(Continuation continuation) {
            super(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return LegacyUiController$screenView$1$apply$$inlined$messageHandler$5.this.handle(null, this);
        }
    }

    public LegacyUiController$screenView$1$apply$$inlined$messageHandler$5(SharedFlow2 sharedFlow2, JsonAdapter jsonAdapter) {
    ...
    */
    public Object handle(Message message, Continuation continuation) throws IOException {
        C219261 c219261;
        if (continuation instanceof C219261) {
            c219261 = (C219261) continuation;
            int i = c219261.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c219261.label = i - Integer.MIN_VALUE;
            } else {
                c219261 = new C219261(continuation);
            }
        }
        Object obj = c219261.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c219261.label;
        if (i2 == 0) {
            ...
            if (objFromJson != null) {
                UiObject.Legacy legacy = new UiObject.Legacy((InvokeJavascriptRequest) objFromJson);
                c219261.label = 1;
                if (sharedFlow2.emit(legacy, c219261) == coroutine_suspended) {

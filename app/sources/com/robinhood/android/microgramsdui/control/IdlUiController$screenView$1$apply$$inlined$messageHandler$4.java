...
public final class IdlUiController$screenView$1$apply$$inlined$messageHandler$4 implements MessageHandler {
    final /* synthetic */ JsonAdapter $adapter$inlined;
    final /* synthetic */ SharedFlow2 $this_messageHandler;

    @Metadata(m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "com.robinhood.android.microgramsdui.control.IdlUiController$screenView$1$apply$$inlined$messageHandler$4", m3645f = "IdlUiController.kt", m3646l = {16}, m3647m = "handle")
    /* renamed from: com.robinhood.android.microgramsdui.control.IdlUiController$screenView$1$apply$$inlined$messageHandler$4$1 */
    public static final class C218941 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        public C218941(Continuation continuation) {
            super(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return IdlUiController$screenView$1$apply$$inlined$messageHandler$4.this.handle(null, this);
        }
    }

    public IdlUiController$screenView$1$apply$$inlined$messageHandler$4(SharedFlow2 sharedFlow2, JsonAdapter jsonAdapter) {
    ...
    */
    public Object handle(Message message, Continuation continuation) throws IOException {
        C218941 c218941;
        if (continuation instanceof C218941) {
            c218941 = (C218941) continuation;
            int i = c218941.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c218941.label = i - Integer.MIN_VALUE;
            } else {
                c218941 = new C218941(continuation);
            }
        }
        Object obj = c218941.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c218941.label;
        if (i2 == 0) {
            ...
            if (objFromJson != null) {
                c218941.label = 1;
                if (sharedFlow2.emit((ShareScreenshotRequestDto) objFromJson, c218941) == coroutine_suspended) {

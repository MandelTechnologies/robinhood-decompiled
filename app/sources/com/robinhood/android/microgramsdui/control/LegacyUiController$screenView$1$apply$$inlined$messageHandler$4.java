...
public final class LegacyUiController$screenView$1$apply$$inlined$messageHandler$4 implements MessageHandler {
    final /* synthetic */ JsonAdapter $adapter$inlined;
    final /* synthetic */ SharedFlow2 $this_messageHandler;

    @Metadata(m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "com.robinhood.android.microgramsdui.control.LegacyUiController$screenView$1$apply$$inlined$messageHandler$4", m3645f = "LegacyUiController.kt", m3646l = {16}, m3647m = "handle")
    /* renamed from: com.robinhood.android.microgramsdui.control.LegacyUiController$screenView$1$apply$$inlined$messageHandler$4$1 */
    public static final class C219251 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        public C219251(Continuation continuation) {
            super(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return LegacyUiController$screenView$1$apply$$inlined$messageHandler$4.this.handle(null, this);
        }
    }

    public LegacyUiController$screenView$1$apply$$inlined$messageHandler$4(SharedFlow2 sharedFlow2, JsonAdapter jsonAdapter) {
    ...
    */
    public Object handle(Message message, Continuation continuation) throws IOException {
        C219251 c219251;
        if (continuation instanceof C219251) {
            c219251 = (C219251) continuation;
            int i = c219251.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c219251.label = i - Integer.MIN_VALUE;
            } else {
                c219251 = new C219251(continuation);
            }
        }
        Object obj = c219251.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c219251.label;
        if (i2 == 0) {
            ...
            if (objFromJson != null) {
                c219251.label = 1;
                if (sharedFlow2.emit((ShareScreenshotRequestDto) objFromJson, c219251) == coroutine_suspended) {

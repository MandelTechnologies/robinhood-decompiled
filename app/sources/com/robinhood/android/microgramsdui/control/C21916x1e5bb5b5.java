...
/* renamed from: com.robinhood.android.microgramsdui.control.LegacyUiController$embeddedSectionView$1$apply$$inlined$messageHandler$1 */
/* loaded from: classes8.dex */
public final class C21916x1e5bb5b5 implements MessageHandler {
    final /* synthetic */ JsonAdapter $adapter$inlined;
    final /* synthetic */ SharedFlow2 $this_messageHandler;

    @Metadata(m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "com.robinhood.android.microgramsdui.control.LegacyUiController$embeddedSectionView$1$apply$$inlined$messageHandler$1", m3645f = "LegacyUiController.kt", m3646l = {16}, m3647m = "handle")
    /* renamed from: com.robinhood.android.microgramsdui.control.LegacyUiController$embeddedSectionView$1$apply$$inlined$messageHandler$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return C21916x1e5bb5b5.this.handle(null, this);
        }
    }

    public C21916x1e5bb5b5(SharedFlow2 sharedFlow2, JsonAdapter jsonAdapter) {
    ...
    */
    public Object handle(Message message, Continuation continuation) throws IOException {
        ...
        if (i2 == 0) {
            ...
            UiObject.Legacy legacy = new UiObject.Legacy((EmbeddedSectionContent) objFromJson);
            anonymousClass1.label = 1;
            if (sharedFlow2.emit(legacy, anonymousClass1) == coroutine_suspended) {

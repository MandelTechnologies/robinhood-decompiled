...
public final class IdlUiController$screenView$1$apply$$inlined$messageHandler$5 implements MessageHandler {
    final /* synthetic */ JsonAdapter $adapter$inlined;
    final /* synthetic */ SharedFlow2 $this_messageHandler;

    @Metadata(m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "com.robinhood.android.microgramsdui.control.IdlUiController$screenView$1$apply$$inlined$messageHandler$5", m3645f = "IdlUiController.kt", m3646l = {16}, m3647m = "handle")
    /* renamed from: com.robinhood.android.microgramsdui.control.IdlUiController$screenView$1$apply$$inlined$messageHandler$5$1 */
    public static final class C218951 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        public C218951(Continuation continuation) {
            super(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return IdlUiController$screenView$1$apply$$inlined$messageHandler$5.this.handle(null, this);
        }
    }

    public IdlUiController$screenView$1$apply$$inlined$messageHandler$5(SharedFlow2 sharedFlow2, JsonAdapter jsonAdapter) {
    ...
    */
    public Object handle(Message message, Continuation continuation) throws IOException {
        C218951 c218951;
        if (continuation instanceof C218951) {
            c218951 = (C218951) continuation;
            int i = c218951.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c218951.label = i - Integer.MIN_VALUE;
            } else {
                c218951 = new C218951(continuation);
            }
        }
        Object obj = c218951.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c218951.label;
        if (i2 == 0) {
            ...
            UiObject.Idl idl2 = new UiObject.Idl((InvokeJavascriptRequestDto) objFromJson);
            c218951.label = 1;
            if (sharedFlow2.emit(idl2, c218951) == coroutine_suspended) {

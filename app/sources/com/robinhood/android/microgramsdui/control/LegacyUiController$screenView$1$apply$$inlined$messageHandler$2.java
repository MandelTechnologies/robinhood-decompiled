...
public final class LegacyUiController$screenView$1$apply$$inlined$messageHandler$2 implements MessageHandler {
    final /* synthetic */ JsonAdapter $adapter$inlined;
    final /* synthetic */ SharedFlow2 $this_messageHandler;

    @Metadata(m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "com.robinhood.android.microgramsdui.control.LegacyUiController$screenView$1$apply$$inlined$messageHandler$2", m3645f = "LegacyUiController.kt", m3646l = {16}, m3647m = "handle")
    /* renamed from: com.robinhood.android.microgramsdui.control.LegacyUiController$screenView$1$apply$$inlined$messageHandler$2$1 */
    public static final class C219231 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        public C219231(Continuation continuation) {
            super(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return LegacyUiController$screenView$1$apply$$inlined$messageHandler$2.this.handle(null, this);
        }
    }

    public LegacyUiController$screenView$1$apply$$inlined$messageHandler$2(SharedFlow2 sharedFlow2, JsonAdapter jsonAdapter) {
    ...
    */
    public Object handle(Message message, Continuation continuation) throws IOException {
        C219231 c219231;
        if (continuation instanceof C219231) {
            c219231 = (C219231) continuation;
            int i = c219231.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c219231.label = i - Integer.MIN_VALUE;
            } else {
                c219231 = new C219231(continuation);
            }
        }
        Object obj = c219231.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c219231.label;
        if (i2 == 0) {
            ...
            UiObject.Legacy legacy = new UiObject.Legacy((ScreenScrollRequest) objFromJson);
            c219231.label = 1;
            if (sharedFlow2.emit(legacy, c219231) == coroutine_suspended) {

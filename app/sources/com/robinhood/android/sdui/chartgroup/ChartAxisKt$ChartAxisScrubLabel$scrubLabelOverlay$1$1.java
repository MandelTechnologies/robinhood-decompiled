...
final class ChartAxisKt$ChartAxisScrubLabel$scrubLabelOverlay$1$1 implements Function2<Composer, Integer, Unit> {
    final /* synthetic */ Axis $axis;
    ...
    ChartAxisKt$ChartAxisScrubLabel$scrubLabelOverlay$1$1(boolean z, Color color, String str, Axis axis, SnapshotIntState2 snapshotIntState2, SnapshotIntState2 snapshotIntState22) {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(392110344, i, -1, "com.robinhood.android.sdui.chartgroup.ChartAxisScrubLabel.<anonymous>.<anonymous> (ChartAxis.kt:180)");
        }
        composer.startReplaceGroup(-1139077867);
        ...
        composer.startReplaceGroup(-1139076959);
        if (axis.getType() == AxisType.f3954Y) {
            ...
            if (objRememberedValue == companion.getEmpty()) {
                objRememberedValue = new Function1() { // from class: com.robinhood.android.sdui.chartgroup.ChartAxisKt$ChartAxisScrubLabel$scrubLabelOverlay$1$1$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        return ChartAxisKt$ChartAxisScrubLabel$scrubLabelOverlay$1$1.invoke$lambda$4$lambda$1$lambda$0(snapshotIntState2, (IntSize) obj);
                    }
                };
            ...
            if (objRememberedValue2 == companion.getEmpty()) {
                objRememberedValue2 = new Function1() { // from class: com.robinhood.android.sdui.chartgroup.ChartAxisKt$ChartAxisScrubLabel$scrubLabelOverlay$1$1$$ExternalSyntheticLambda1
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        return ChartAxisKt$ChartAxisScrubLabel$scrubLabelOverlay$1$1.invoke$lambda$4$lambda$3$lambda$2(snapshotIntState2, snapshotIntState22, (Density) obj);
                    }
                };
        ...
        composer.startReplaceGroup(-1139030459);

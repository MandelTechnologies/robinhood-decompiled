...
final class SduiAdvancedChartKt$ProtoSduiAdvancedChartGroup$6$4$2$1 implements PointerInputEventHandler {
    ...
    SduiAdvancedChartKt$ProtoSduiAdvancedChartGroup$6$4$2$1(ProtoAdvancedChartGroupState protoAdvancedChartGroupState, Function1<? super Ranges3<Float>, Unit> function1, SnapshotState<Offset> snapshotState, SnapshotState<AdvancedChartGroupState2> snapshotState2, SnapshotState4<Rect> snapshotState4, SnapshotState<Ranges3<Float>> snapshotState3, SnapshotFloatState2 snapshotFloatState2, Function0<Unit> function0) {
    ...
    public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
        final ProtoAdvancedChartGroupState protoAdvancedChartGroupState = this.$state;
        ...
        Function4 function4 = new Function4() { // from class: com.robinhood.android.sdui.chartgroup.SduiAdvancedChartKt$ProtoSduiAdvancedChartGroup$6$4$2$1$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function4
            public final Object invoke(Object obj, Object obj2, Object obj3, Object obj4) {
                return SduiAdvancedChartKt$ProtoSduiAdvancedChartGroup$6$4$2$1.invoke$lambda$0(protoAdvancedChartGroupState, function1, snapshotState, snapshotState2, snapshotState4, snapshotState3, snapshotFloatState2, (Offset) obj, (Offset) obj2, ((Float) obj3).floatValue(), ((Float) obj4).floatValue());
            }
        };
        ...
        Object objDetectChartZoomGestures$default = SduiChartZoomGestureDetector.detectChartZoomGestures$default(pointerInputScope, false, function4, new Function0() { // from class: com.robinhood.android.sdui.chartgroup.SduiAdvancedChartKt$ProtoSduiAdvancedChartGroup$6$4$2$1$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return SduiAdvancedChartKt$ProtoSduiAdvancedChartGroup$6$4$2$1.invoke$lambda$1(function0, snapshotState5, snapshotFloatState22);
            }
        }, continuation, 1, null);
    ...
    public static final Unit invoke$lambda$0(ProtoAdvancedChartGroupState protoAdvancedChartGroupState, Function1 function1, SnapshotState snapshotState, SnapshotState snapshotState2, SnapshotState4 snapshotState4, SnapshotState snapshotState3, SnapshotFloatState2 snapshotFloatState2, Offset offset, Offset offset2, float f, float f2) {
        if (SduiAdvancedChartKt.ProtoSduiAdvancedChartGroup$lambda$184$lambda$114(snapshotState) == null) {
            snapshotState2.setValue(AdvancedChartGroupState2.ZOOMING);
            Rect rectProtoSduiAdvancedChartGroup$lambda$184$lambda$128 = SduiAdvancedChartKt.ProtoSduiAdvancedChartGroup$lambda$184$lambda$128(snapshotState4);
            if (rectProtoSduiAdvancedChartGroup$lambda$184$lambda$128 != null) {
                XAxisZoomState xAxisZoomStateM18611mapGestureToXAxisZoomRangeAndBounceOffsetxrVmA = SduiChartZoomTransformer.m18611mapGestureToXAxisZoomRangeAndBounceOffsetxrVmA(offset.getPackedValue(), offset2.getPackedValue(), f, rectProtoSduiAdvancedChartGroup$lambda$184$lambda$128.getRight() - rectProtoSduiAdvancedChartGroup$lambda$184$lambda$128.getLeft(), SduiAdvancedChartKt.ProtoSduiAdvancedChartGroup$lambda$184$lambda$99(snapshotState3), snapshotFloatState2.getFloatValue(), protoAdvancedChartGroupState.getAxisConfig().getPrimaryChartMaxX(), protoAdvancedChartGroupState.getAxisConfig().getGapBetweenScrubbingLabels());
                snapshotState3.setValue(xAxisZoomStateM18611mapGestureToXAxisZoomRangeAndBounceOffsetxrVmA.getZoomRange());
                function1.invoke(SduiAdvancedChartKt.ProtoSduiAdvancedChartGroup$lambda$184$lambda$99(snapshotState3));
    ...
    public static final Unit invoke$lambda$1(Function0 function0, SnapshotState snapshotState, SnapshotFloatState2 snapshotFloatState2) {
        if (SduiAdvancedChartKt.ProtoSduiAdvancedChartGroup$lambda$184$lambda$106(snapshotState) == AdvancedChartGroupState2.ZOOMING) {

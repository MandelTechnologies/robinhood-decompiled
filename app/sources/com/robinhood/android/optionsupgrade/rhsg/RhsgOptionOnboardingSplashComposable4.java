...
/* renamed from: com.robinhood.android.optionsupgrade.rhsg.RhsgOptionOnboardingSplashComposableKt$ApacOptionOnboardingSplashComposable$2$1$1, reason: use source file name */
/* loaded from: classes11.dex */
final class RhsgOptionOnboardingSplashComposable4 implements Function4<PagerScope, Integer, Composer, Integer, Unit> {
    final /* synthetic */ Function1<OptionPage, Unit> $onPageLearnMore;
    final /* synthetic */ ImmutableList<SplashPage> $pages;

    /* JADX WARN: Multi-variable type inference failed */
    RhsgOptionOnboardingSplashComposable4(ImmutableList<SplashPage> immutableList, Function1<? super OptionPage, Unit> function1) {
    ...
    public final void invoke(PagerScope HorizontalPager, int i, Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-820815028, i2, -1, "com.robinhood.android.optionsupgrade.rhsg.ApacOptionOnboardingSplashComposable.<anonymous>.<anonymous>.<anonymous> (RhsgOptionOnboardingSplashComposable.kt:74)");
        }
        ...
        TextStyle textL = bentoTheme.getTypography(composer, i3).getTextL();
        FontWeight bold = FontWeight.INSTANCE.getBold();
        TextAlign.Companion companion4 = TextAlign.INSTANCE;
        BentoText2.m20747BentoText38GnDrw(title, SizeKt.fillMaxWidth$default(companion, 0.0f, 1, null), null, null, bold, null, TextAlign.m7912boximpl(companion4.m7919getCentere0LSkKk()), 0, false, 0, 0, null, 0, textL, composer, 24624, 0, 8108);
        final OptionPage optionPage = immutableList.get(i).getOptionPage();
        if (optionPage != null) {
            composer.startReplaceGroup(262686732);
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new Function0() { // from class: com.robinhood.android.optionsupgrade.rhsg.RhsgOptionOnboardingSplashComposableKt$ApacOptionOnboardingSplashComposable$2$1$1$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        return RhsgOptionOnboardingSplashComposable4.invoke$lambda$2$lambda$1$lambda$0(function1, optionPage);
                    }
                };
            ...
            composer.startReplaceGroup(263430639);

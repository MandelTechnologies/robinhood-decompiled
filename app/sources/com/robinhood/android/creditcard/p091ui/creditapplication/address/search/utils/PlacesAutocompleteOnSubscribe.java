...
public final class PlacesAutocompleteOnSubscribe implements SingleOnSubscribe<FindAutocompletePredictionsResponse> {
    ...
    public void subscribe(final SingleEmitter<FindAutocompletePredictionsResponse> emitter) {
        ...
        if (!Places.isInitialized()) {
            Places.initialize(applicationContext, applicationContext.getString(C18328R.string.maps_sdk_api_key), Locale.US);
        }
        ...
        taskFindAutocompletePredictions.addOnCompleteListener(new OnCompleteListener() { // from class: com.robinhood.android.creditcard.ui.creditapplication.address.search.utils.PlacesAutocompleteOnSubscribe.subscribe.1
        ...
        taskFindAutocompletePredictions.addOnSuccessListener(new OnSuccessListener() { // from class: com.robinhood.android.creditcard.ui.creditapplication.address.search.utils.PlacesAutocompleteOnSubscribe.subscribe.2
        ...
        taskFindAutocompletePredictions.addOnFailureListener(new OnFailureListener() { // from class: com.robinhood.android.creditcard.ui.creditapplication.address.search.utils.PlacesAutocompleteOnSubscribe.subscribe.3

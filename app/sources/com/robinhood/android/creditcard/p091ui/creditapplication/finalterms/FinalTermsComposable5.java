...
/* renamed from: com.robinhood.android.creditcard.ui.creditapplication.finalterms.FinalTermsComposableKt$FinalTerms$4$1$4$6$3, reason: use source file name */
/* loaded from: classes2.dex */
final class FinalTermsComposable5 implements Function2<Composer, Integer, Unit> {
    ...
    FinalTermsComposable5(EventLogger eventLogger, boolean z, Function0<Unit> function0, SnapshotState<Boolean> snapshotState, boolean z2, SnapshotState<SelectedPlan> snapshotState2) {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-283534449, i, -1, "com.robinhood.android.creditcard.ui.creditapplication.finalterms.FinalTerms.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous> (FinalTermsComposable.kt:358)");
        }
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new Function0() { // from class: com.robinhood.android.creditcard.ui.creditapplication.finalterms.FinalTermsComposableKt$FinalTerms$4$1$4$6$3$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return FinalTermsComposable5.invoke$lambda$1$lambda$0(snapshotState);
                }
            };

...
public final class AccountListDuxo_Factory implements Factory<AccountListDuxo> {
    ...
    @JvmStatic
    public static final AccountListDuxo_Factory create(Provider<CreditCardStore> provider, Provider<DuxoBundle> provider2, Provider<CoroutineDispatcher> provider3) {
        return INSTANCE.create(provider, provider2, provider3);
    }

    @JvmStatic
    public static final AccountListDuxo newInstance(CreditCardStore creditCardStore, DuxoBundle duxoBundle, CoroutineDispatcher coroutineDispatcher) {
        return INSTANCE.newInstance(creditCardStore, duxoBundle, coroutineDispatcher);
    }

    public AccountListDuxo_Factory(Provider<CreditCardStore> creditCardStore, Provider<DuxoBundle> duxoBundle, Provider<CoroutineDispatcher> defaultDispatcher) {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final AccountListDuxo_Factory create(Provider<CreditCardStore> creditCardStore, Provider<DuxoBundle> duxoBundle, Provider<CoroutineDispatcher> defaultDispatcher) {
            Intrinsics.checkNotNullParameter(creditCardStore, "creditCardStore");
            Intrinsics.checkNotNullParameter(duxoBundle, "duxoBundle");
            Intrinsics.checkNotNullParameter(defaultDispatcher, "defaultDispatcher");
            return new AccountListDuxo_Factory(creditCardStore, duxoBundle, defaultDispatcher);
        }

        @JvmStatic
        public final AccountListDuxo newInstance(CreditCardStore creditCardStore, DuxoBundle duxoBundle, CoroutineDispatcher defaultDispatcher) {
            Intrinsics.checkNotNullParameter(creditCardStore, "creditCardStore");
            Intrinsics.checkNotNullParameter(duxoBundle, "duxoBundle");
            Intrinsics.checkNotNullParameter(defaultDispatcher, "defaultDispatcher");
            return new AccountListDuxo(creditCardStore, duxoBundle, defaultDispatcher);
        }
    }
}

...
public final class FragmentOptionExerciseBinding implements ViewBinding {
    ...
    private FragmentOptionExerciseBinding(ConstraintLayout constraintLayout, CardView cardView, ConstraintLayout constraintLayout2, ConstraintLayout constraintLayout3, BlockableNestedScrollView blockableNestedScrollView, LinearLayout linearLayout, RdsNumpadView rdsNumpadView, RdsButton rdsButton, CoordinatorLayout coordinatorLayout, RhTextView rhTextView) {
    ...
    public static FragmentOptionExerciseBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentOptionExerciseBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C24704R.layout.fragment_option_exercise, viewGroup, false);
        if (z) {
    ...
    public static FragmentOptionExerciseBinding bind(View view) {
        int i = C24704R.id.cardview;
        CardView cardView = (CardView) ViewBindings.findChildViewById(view, i);
        if (cardView != null) {
            ConstraintLayout constraintLayout = (ConstraintLayout) view;
            i = C24704R.id.content;
            ConstraintLayout constraintLayout2 = (ConstraintLayout) ViewBindings.findChildViewById(view, i);
            if (constraintLayout2 != null) {
                i = C24704R.id.content_scrollview;
                ...
                if (blockableNestedScrollView != null) {
                    ...
                    if (linearLayout != null) {
                        ...
                        if (rdsNumpadView != null) {
                            i = C24704R.id.review_btn;
                            RdsButton rdsButton = (RdsButton) ViewBindings.findChildViewById(view, i);
                            if (rdsButton != null) {
                                i = C24704R.id.snackbar_shim;
                                CoordinatorLayout coordinatorLayout = (CoordinatorLayout) ViewBindings.findChildViewById(view, i);
                                if (coordinatorLayout != null) {
                                    i = C24704R.id.swipe_hint;
                                    RhTextView rhTextView = (RhTextView) ViewBindings.findChildViewById(view, i);
                                    if (rhTextView != null) {
                                        return new FragmentOptionExerciseBinding(constraintLayout, cardView, constraintLayout, constraintLayout2, blockableNestedScrollView, linearLayout, rdsNumpadView, rdsButton, coordinatorLayout, rhTextView);
                                    }
                                }
                            }
                        }

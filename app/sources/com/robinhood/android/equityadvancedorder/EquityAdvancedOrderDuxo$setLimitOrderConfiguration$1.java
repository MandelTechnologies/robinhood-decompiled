...
@DebugMetadata(m3644c = "com.robinhood.android.equityadvancedorder.EquityAdvancedOrderDuxo$setLimitOrderConfiguration$1", m3645f = "EquityAdvancedOrderDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
@SourceDebugExtension
/* loaded from: classes3.dex */
final class EquityAdvancedOrderDuxo$setLimitOrderConfiguration$1 extends ContinuationImpl7 implements Function2<EquityAdvancedOrderDataState, Continuation<? super EquityAdvancedOrderDataState>, Object> {
    ...
    EquityAdvancedOrderDuxo$setLimitOrderConfiguration$1(EquityAdvancedOrderDuxo equityAdvancedOrderDuxo, BigDecimal bigDecimal, String str, Continuation<? super EquityAdvancedOrderDuxo$setLimitOrderConfiguration$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        EquityAdvancedOrderDuxo$setLimitOrderConfiguration$1 equityAdvancedOrderDuxo$setLimitOrderConfiguration$1 = new EquityAdvancedOrderDuxo$setLimitOrderConfiguration$1(this.this$0, this.$amount, this.$accountNumber, continuation);
        equityAdvancedOrderDuxo$setLimitOrderConfiguration$1.L$0 = obj;
        return equityAdvancedOrderDuxo$setLimitOrderConfiguration$1;
    }
    ...
    public final Object invoke(EquityAdvancedOrderDataState equityAdvancedOrderDataState, Continuation<? super EquityAdvancedOrderDataState> continuation) {
        return ((EquityAdvancedOrderDuxo$setLimitOrderConfiguration$1) create(equityAdvancedOrderDataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (iLimit instanceof LimitStandard) {
            ...
            equityAdvancedOrderDataStateCopy$default = LimitStandard.copy$default(limitStandard, null, ILimit.LimitState.copy$default(limitStandard.getLimitState(), bigDecimal.toString(), OrderTimeInForce.GTC, null, null, null, null, false, false, null, false, 1020, null), 1, null);
        } else {
            if (!(iLimit instanceof LimitTaxLots)) {
                throw new NoWhenBranchMatchedException();
            }
            LimitTaxLots limitTaxLots = (LimitTaxLots) iLimit;
            equityAdvancedOrderDataStateCopy$default = LimitTaxLots.copy$default(limitTaxLots, LimitStandard.copy$default(limitTaxLots.getLimitStandard(), null, ILimit.LimitState.copy$default(limitTaxLots.getLimitState(), bigDecimal.toString(), OrderTimeInForce.GTC, null, null, null, null, false, false, null, false, 1020, null), 1, null), null, 2, null);
        }

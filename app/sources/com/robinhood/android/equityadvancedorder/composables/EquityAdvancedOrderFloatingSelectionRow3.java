...
/* renamed from: com.robinhood.android.equityadvancedorder.composables.ComposableSingletons$EquityAdvancedOrderFloatingSelectionRowKt$lambda$-704022765$1, reason: use source file name */
/* loaded from: classes3.dex */
final class EquityAdvancedOrderFloatingSelectionRow3 implements Function2<Composer, Integer, Unit> {
    public static final EquityAdvancedOrderFloatingSelectionRow3 INSTANCE = new EquityAdvancedOrderFloatingSelectionRow3();

    EquityAdvancedOrderFloatingSelectionRow3() {
    }
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-704022765, i, -1, "com.robinhood.android.equityadvancedorder.composables.ComposableSingletons$EquityAdvancedOrderFloatingSelectionRowKt.lambda$-704022765.<anonymous> (EquityAdvancedOrderFloatingSelectionRow.kt:333)");
        }
        ...
        StringResource stringResourceInvoke = companion2.invoke("Lot selection strategy");
        StringResource stringResourceInvoke2 = companion2.invoke("First in");
        OrderForm6 orderForm6 = OrderForm6.EDITING;
        StringResource stringResourceInvoke3 = companion2.invoke("First in");
        composer.startReplaceGroup(1849434622);
        Object objRememberedValue = composer.rememberedValue();
        Composer.Companion companion3 = Composer.INSTANCE;
        if (objRememberedValue == companion3.getEmpty()) {
            objRememberedValue = new Function0() { // from class: com.robinhood.android.equityadvancedorder.composables.ComposableSingletons$EquityAdvancedOrderFloatingSelectionRowKt$lambda$-704022765$1$$ExternalSyntheticLambda0
        ...
        StringResource stringResourceInvoke4 = companion2.invoke("Last in");
        composer.startReplaceGroup(1849434622);
        Object objRememberedValue2 = composer.rememberedValue();
        if (objRememberedValue2 == companion3.getEmpty()) {
            objRememberedValue2 = new Function0() { // from class: com.robinhood.android.equityadvancedorder.composables.ComposableSingletons$EquityAdvancedOrderFloatingSelectionRowKt$lambda$-704022765$1$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return Unit.INSTANCE;
                }
        ...
        if (objRememberedValue3 == companion3.getEmpty()) {
            objRememberedValue3 = new Function0() { // from class: com.robinhood.android.equityadvancedorder.composables.ComposableSingletons$EquityAdvancedOrderFloatingSelectionRowKt$lambda$-704022765$1$$ExternalSyntheticLambda2
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return Unit.INSTANCE;
                }

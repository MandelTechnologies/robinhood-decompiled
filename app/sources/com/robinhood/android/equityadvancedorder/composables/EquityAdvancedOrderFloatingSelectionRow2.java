...
/* renamed from: com.robinhood.android.equityadvancedorder.composables.ComposableSingletons$EquityAdvancedOrderFloatingSelectionRowKt$lambda$-144184652$1, reason: use source file name */
/* loaded from: classes3.dex */
final class EquityAdvancedOrderFloatingSelectionRow2 implements Function2<Composer, Integer, Unit> {
    public static final EquityAdvancedOrderFloatingSelectionRow2 INSTANCE = new EquityAdvancedOrderFloatingSelectionRow2();

    EquityAdvancedOrderFloatingSelectionRow2() {
    }
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-144184652, i, -1, "com.robinhood.android.equityadvancedorder.composables.ComposableSingletons$EquityAdvancedOrderFloatingSelectionRowKt.lambda$-144184652.<anonymous> (EquityAdvancedOrderFloatingSelectionRow.kt:297)");
        }
        ...
        if (objRememberedValue == companion3.getEmpty()) {
            objRememberedValue = new Function0() { // from class: com.robinhood.android.equityadvancedorder.composables.ComposableSingletons$EquityAdvancedOrderFloatingSelectionRowKt$lambda$-144184652$1$$ExternalSyntheticLambda0
        ...
        if (objRememberedValue2 == companion3.getEmpty()) {
            objRememberedValue2 = new Function0() { // from class: com.robinhood.android.equityadvancedorder.composables.ComposableSingletons$EquityAdvancedOrderFloatingSelectionRowKt$lambda$-144184652$1$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return Unit.INSTANCE;
                }
        ...
        if (objRememberedValue3 == companion3.getEmpty()) {
            objRememberedValue3 = new Function0() { // from class: com.robinhood.android.equityadvancedorder.composables.ComposableSingletons$EquityAdvancedOrderFloatingSelectionRowKt$lambda$-144184652$1$$ExternalSyntheticLambda2
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return Unit.INSTANCE;
                }

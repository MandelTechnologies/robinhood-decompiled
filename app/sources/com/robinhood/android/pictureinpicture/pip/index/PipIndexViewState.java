...
/* compiled from: PipIndexViewState.kt */
@Metadata(m3635d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0000\b7\u0018\u0000 \t2\u00020\u0001:\u0002\b\tB\u0011\b\u0004\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005R\u0014\u0010\u0002\u001a\u00020\u0003X\u0096\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007\u0082\u0001\u0001\n¨\u0006\u000b"}, m3636d2 = {"Lcom/robinhood/android/pictureinpicture/pip/index/PipIndexViewState;", "", "loading", "", "<init>", "(Z)V", "getLoading", "()Z", "IndexViewState", "Companion", "Lcom/robinhood/android/pictureinpicture/pip/index/PipIndexViewState$IndexViewState;", "feature-pip_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
/* loaded from: classes11.dex */
public abstract class PipIndexViewState {
    public static final int $stable = 0;

    /* renamed from: Companion, reason: from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);
    private static final IndexViewState EmptyViewState = new IndexViewState(null, null, null, null, null, null, null, null, true, 255, null);
    private final boolean loading;

    public /* synthetic */ PipIndexViewState(boolean z, DefaultConstructorMarker defaultConstructorMarker) {
        this(z);
    }

    private PipIndexViewState(boolean z) {
        this.loading = z;
    }
    ...
    public static final /* data */ class IndexViewState extends PipIndexViewState {
        ...
        public static /* synthetic */ IndexViewState copy$default(IndexViewState indexViewState, String str, Chart chart, CursorData cursorData, BentoTheme4 bentoTheme4, ImmutableList immutableList, ImmutableList immutableList2, ImmutableList immutableList3, ImmutableList immutableList4, boolean z, int i, Object obj) {
            if ((i & 1) != 0) {
                str = indexViewState.displayName;
            }
            if ((i & 2) != 0) {
                chart = indexViewState.chart;
            }
            if ((i & 4) != 0) {
                cursorData = indexViewState.displayData;
            }
            if ((i & 8) != 0) {
                bentoTheme4 = indexViewState.colorDirection;
            }
            if ((i & 16) != 0) {
                immutableList = indexViewState.lines;
            }
            if ((i & 32) != 0) {
                immutableList2 = indexViewState.fills;
            }
            if ((i & 64) != 0) {
                immutableList3 = indexViewState.overlays;
            }
            if ((i & 128) != 0) {
                immutableList4 = indexViewState.legendList;
            }
            if ((i & 256) != 0) {
                z = indexViewState.loading;
            }
            ...
            return indexViewState.copy(str, chart, cursorData2, bentoTheme4, immutableList8, immutableList6, immutableList7, immutableList5, z2);
        }
        ...
        public boolean equals(Object other) {
            ...
            if (!(other instanceof IndexViewState)) {
                return false;
            }
            IndexViewState indexViewState = (IndexViewState) other;
            return Intrinsics.areEqual(this.displayName, indexViewState.displayName) && Intrinsics.areEqual(this.chart, indexViewState.chart) && Intrinsics.areEqual(this.displayData, indexViewState.displayData) && this.colorDirection == indexViewState.colorDirection && Intrinsics.areEqual(this.lines, indexViewState.lines) && Intrinsics.areEqual(this.fills, indexViewState.fills) && Intrinsics.areEqual(this.overlays, indexViewState.overlays) && Intrinsics.areEqual(this.legendList, indexViewState.legendList) && this.loading == indexViewState.loading;
        }
        ...
        public String toString() {
            return "IndexViewState(displayName=" + this.displayName + ", chart=" + this.chart + ", displayData=" + this.displayData + ", colorDirection=" + this.colorDirection + ", lines=" + this.lines + ", fills=" + this.fills + ", overlays=" + this.overlays + ", legendList=" + this.legendList + ", loading=" + this.loading + ")";
        }
        ...
        public /* synthetic */ IndexViewState(String str, Chart chart, CursorData cursorData, BentoTheme4 bentoTheme4, ImmutableList immutableList, ImmutableList immutableList2, ImmutableList immutableList3, ImmutableList immutableList4, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        @Override // com.robinhood.android.pictureinpicture.pip.index.PipIndexViewState
        public boolean getLoading() {
            return this.loading;
        }
        ...
        public IndexViewState(String str, Chart<? extends Parcelable> chart, CursorData cursorData, BentoTheme4 colorDirection, ImmutableList<Line> lines, ImmutableList<ChartFill> fills, ImmutableList<? extends UIComponent<? extends GenericAction>> overlays, ImmutableList<ChartLegendItem> immutableList, boolean z) {
            super(z, null);
            Intrinsics.checkNotNullParameter(colorDirection, "colorDirection");
            Intrinsics.checkNotNullParameter(lines, "lines");
            Intrinsics.checkNotNullParameter(fills, "fills");
    ...
    /* compiled from: PipIndexViewState.kt */
    @Metadata(m3635d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u0014\u0010\u0004\u001a\u00020\u0005X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, m3636d2 = {"Lcom/robinhood/android/pictureinpicture/pip/index/PipIndexViewState$Companion;", "", "<init>", "()V", "EmptyViewState", "Lcom/robinhood/android/pictureinpicture/pip/index/PipIndexViewState$IndexViewState;", "getEmptyViewState$feature_pip_externalDebug", "()Lcom/robinhood/android/pictureinpicture/pip/index/PipIndexViewState$IndexViewState;", "feature-pip_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    public static final class Companion {
        ...
        public final IndexViewState getEmptyViewState$feature_pip_externalDebug() {
            return PipIndexViewState.EmptyViewState;
        }
    }
}

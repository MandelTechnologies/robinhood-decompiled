...
final class ConciergeOnboardingComposableKt$ConciergeWelcomeVideo$2$1$1$1 implements Function1<ConstrainScope, Unit> {
    public static final ConciergeOnboardingComposableKt$ConciergeWelcomeVideo$2$1$1$1 INSTANCE = new ConciergeOnboardingComposableKt$ConciergeWelcomeVideo$2$1$1$1();

    ConciergeOnboardingComposableKt$ConciergeWelcomeVideo$2$1$1$1() {
    }
    ...
    public final void invoke2(ConstrainScope constrainAs) {
        ...
        constrainAs.setHeight(Dimension.INSTANCE.percent(0.9f));
    }
}

...
@DebugMetadata(m3644c = "com.robinhood.android.futures.trade.ui.ladder.gestures.LongPressFastTrackGestureDetectorKt$processEvents$change$1", m3645f = "LongPressFastTrackGestureDetector.kt", m3646l = {EnumC7081g.SDK_ASSET_ILLUSTRATION_SIGNATURE_VALUE}, m3647m = "invokeSuspend")
@SourceDebugExtension
/* renamed from: com.robinhood.android.futures.trade.ui.ladder.gestures.LongPressFastTrackGestureDetectorKt$processEvents$change$1, reason: use source file name */
/* loaded from: classes10.dex */
final class LongPressFastTrackGestureDetector3 extends ContinuationImpl5 implements Function2<AwaitPointerEventScope, Continuation<? super PointerInputChange>, Object> {
    ...
    LongPressFastTrackGestureDetector3(Ref.LongRef longRef, Continuation<? super LongPressFastTrackGestureDetector3> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        LongPressFastTrackGestureDetector3 longPressFastTrackGestureDetector3 = new LongPressFastTrackGestureDetector3(this.$pointer, continuation);
        longPressFastTrackGestureDetector3.L$0 = obj;
        return longPressFastTrackGestureDetector3;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super PointerInputChange> continuation) {
        return ((LongPressFastTrackGestureDetector3) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

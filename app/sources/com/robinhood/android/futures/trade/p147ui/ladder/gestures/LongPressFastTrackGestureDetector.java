...
public final class LongPressFastTrackGestureDetector {
    ...
    public static final Modifier longPressWithFastTrack(Modifier modifier, final InteractionSource3 interactionSource, Indication indication, final long j, final Function0<Unit> onEvent) {
        ...
        return SuspendingPointerInputFilterKt.pointerInput(IndicationKt.indication(modifier, interactionSource, indication), Unit.INSTANCE, new PointerInputEventHandler() { // from class: com.robinhood.android.futures.trade.ui.ladder.gestures.LongPressFastTrackGestureDetectorKt.longPressWithFastTrack.1
            @Override // androidx.compose.p011ui.input.pointer.PointerInputEventHandler
            public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
                Object objLongPressWithFastTrack = LongPressFastTrackGestureDetector.longPressWithFastTrack(pointerInputScope, interactionSource, j, onEvent, continuation);
    ...
    @DebugMetadata(m3644c = "com.robinhood.android.futures.trade.ui.ladder.gestures.LongPressFastTrackGestureDetectorKt$longPressWithFastTrack$3", m3645f = "LongPressFastTrackGestureDetector.kt", m3646l = {42, 48, 51}, m3647m = "invokeSuspend")
    @SourceDebugExtension
    /* renamed from: com.robinhood.android.futures.trade.ui.ladder.gestures.LongPressFastTrackGestureDetectorKt$longPressWithFastTrack$3 */
    static final class C175893 extends ContinuationImpl5 implements Function2<AwaitPointerEventScope, Continuation<? super Unit>, Object> {
        ...
        C175893(Function0<Unit> function0, InteractionSource3 interactionSource3, long j, Continuation<? super C175893> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C175893 c175893 = new C175893(this.$onEvent, this.$interactionSource, this.$debounceTimeInMs, continuation);
            c175893.L$0 = obj;
            return c175893;
        }
        ...
        public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super Unit> continuation) {
            return ((C175893) create(awaitPointerEventScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                c175893 = this;
                obj = TapGestureDetector4.awaitFirstDown$default(awaitPointerEventScope4, false, null, c175893, 2, null);
            ...
            if (i != 1) {
                if (i != 2) {
                    ...
                    press = press2;
                    c175893.$interactionSource.tryEmit(new PressInteraction.Release(press));
                ...
                if (pointerInputChange != null) {
                    ...
                    final long j = c175893.$debounceTimeInMs;
                    final Function0<Unit> function0 = c175893.$onEvent;
                    Function1 function1 = new Function1() { // from class: com.robinhood.android.futures.trade.ui.ladder.gestures.LongPressFastTrackGestureDetectorKt$longPressWithFastTrack$3$$ExternalSyntheticLambda0
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj2) {
                            return LongPressFastTrackGestureDetector.C175893.invokeSuspend$lambda$0(longRef, j, function0, (PointerInputChange) obj2);
                        }
                    };
                    c175893.L$0 = awaitPointerEventScope2;
                    c175893.L$1 = press;
                    c175893.label = 3;
                    C175893 c1758932 = c175893;
                    obj = LongPressFastTrackGestureDetector.m14905processEventsTUCjRT4(awaitPointerEventScope2, id, j, function1, c1758932);
                    c175893 = c1758932;
                    if (obj != coroutine_suspended) {
                        press2 = press;
    ...
    public static final Object longPressWithFastTrack(PointerInputScope pointerInputScope, InteractionSource3 interactionSource3, long j, Function0<Unit> function0, Continuation<? super Unit> continuation) {
        Object objAwaitEachGesture = ForEachGesture.awaitEachGesture(pointerInputScope, new C175893(function0, interactionSource3, j, null), continuation);
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final Object m14905processEventsTUCjRT4(AwaitPointerEventScope awaitPointerEventScope, long j, long j2, Function1<? super PointerInputChange, Unit> function1, Continuation<? super Boolean> continuation) {
        LongPressFastTrackGestureDetector2 longPressFastTrackGestureDetector2;
        Ref.LongRef longRef;
        PointerInputChange pointerInputChange;
        if (continuation instanceof LongPressFastTrackGestureDetector2) {
            longPressFastTrackGestureDetector2 = (LongPressFastTrackGestureDetector2) continuation;
            int i = longPressFastTrackGestureDetector2.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                longPressFastTrackGestureDetector2.label = i - Integer.MIN_VALUE;
            } else {
                longPressFastTrackGestureDetector2 = new LongPressFastTrackGestureDetector2(continuation);
            }
        }
        Object objWithTimeout = longPressFastTrackGestureDetector2.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = longPressFastTrackGestureDetector2.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(objWithTimeout);
            Ref.LongRef longRef2 = new Ref.LongRef();
            longRef2.element = j;
            longRef = longRef2;
            LongPressFastTrackGestureDetector3 longPressFastTrackGestureDetector3 = new LongPressFastTrackGestureDetector3(longRef, null);
            longPressFastTrackGestureDetector2.L$0 = awaitPointerEventScope;
            longPressFastTrackGestureDetector2.L$1 = function1;
            longPressFastTrackGestureDetector2.L$2 = longRef;
            longPressFastTrackGestureDetector2.J$0 = j2;
            longPressFastTrackGestureDetector2.label = 1;
            objWithTimeout = awaitPointerEventScope.withTimeout(j2, longPressFastTrackGestureDetector3, longPressFastTrackGestureDetector2);
            ...
            long j3 = longPressFastTrackGestureDetector2.J$0;
            longRef = (Ref.LongRef) longPressFastTrackGestureDetector2.L$2;
            Function1<? super PointerInputChange, Unit> function12 = (Function1) longPressFastTrackGestureDetector2.L$1;
            AwaitPointerEventScope awaitPointerEventScope2 = (AwaitPointerEventScope) longPressFastTrackGestureDetector2.L$0;
            try {
                ResultKt.throwOnFailure(objWithTimeout);
                ...
                LongPressFastTrackGestureDetector3 longPressFastTrackGestureDetector32 = new LongPressFastTrackGestureDetector3(longRef, null);
                longPressFastTrackGestureDetector2.L$0 = awaitPointerEventScope;
                longPressFastTrackGestureDetector2.L$1 = function1;
                longPressFastTrackGestureDetector2.L$2 = longRef;
                longPressFastTrackGestureDetector2.J$0 = j2;
                longPressFastTrackGestureDetector2.label = 1;
                objWithTimeout = awaitPointerEventScope.withTimeout(j2, longPressFastTrackGestureDetector32, longPressFastTrackGestureDetector2);
                if (objWithTimeout == coroutine_suspended) {
                }
                pointerInputChange = (PointerInputChange) objWithTimeout;
                if (pointerInputChange == null) {
            ...
            if (pointerInputChange == null) {
                ...
                LongPressFastTrackGestureDetector3 longPressFastTrackGestureDetector322 = new LongPressFastTrackGestureDetector3(longRef, null);
                longPressFastTrackGestureDetector2.L$0 = awaitPointerEventScope;
                longPressFastTrackGestureDetector2.L$1 = function1;
                longPressFastTrackGestureDetector2.L$2 = longRef;
                longPressFastTrackGestureDetector2.J$0 = j2;
                longPressFastTrackGestureDetector2.label = 1;
                objWithTimeout = awaitPointerEventScope.withTimeout(j2, longPressFastTrackGestureDetector322, longPressFastTrackGestureDetector2);
                if (objWithTimeout == coroutine_suspended) {
                    return coroutine_suspended;
                }
                pointerInputChange = (PointerInputChange) objWithTimeout;
    ...
    private static final Object m14904awaitNextEventOrUprnUCldI(AwaitPointerEventScope awaitPointerEventScope, long j, Continuation<? super PointerInputChange> continuation) {
        PointerInputChange pointerInputChange;

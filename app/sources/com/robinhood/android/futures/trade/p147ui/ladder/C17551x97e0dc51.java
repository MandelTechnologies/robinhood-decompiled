...
@DebugMetadata(m3644c = "com.robinhood.android.futures.trade.ui.ladder.LadderGestureAwareLazyColumnKt$LadderGestureAwareLazyColumn$1$1$3$1", m3645f = "LadderGestureAwareLazyColumn.kt", m3646l = {EnumC7081g.SDK_ASSET_ICON_CANCEL_VALUE, EnumC7081g.SDK_ASSET_ICON_CHEVRON_RIGHT_DOUBLE_S2_VALUE, EnumC7081g.SDK_ASSET_ICON_CLIPBOARD_VALUE}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.android.futures.trade.ui.ladder.LadderGestureAwareLazyColumnKt$LadderGestureAwareLazyColumn$1$1$3$1 */
/* loaded from: classes10.dex */
final class C17551x97e0dc51 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    C17551x97e0dc51(float f, LazyListState lazyListState, Animatable<Float, AnimationVectors2> animatable, Animatable<Float, AnimationVectors2> animatable2, float f2, Continuation<? super C17551x97e0dc51> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new C17551x97e0dc51(this.$pendingScrollAmount, this.$lazyListState, this.$selectedPendingOrderXOffset, this.$selectedPendingOrderYOffset, this.$boundedOffset, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((C17551x97e0dc51) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

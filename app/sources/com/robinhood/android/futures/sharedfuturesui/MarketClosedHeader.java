...
/* compiled from: MarketClosedHeader.kt */
@Metadata(m3635d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\u001f\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u0005H\u0007¢\u0006\u0002\u0010\u0006¨\u0006\u0007"}, m3636d2 = {"MarketClosedHeader", "", "headerString", "Lcom/robinhood/utils/resource/StringResource;", "modifier", "Landroidx/compose/ui/Modifier;", "(Lcom/robinhood/utils/resource/StringResource;Landroidx/compose/ui/Modifier;Landroidx/compose/runtime/Composer;II)V", "lib-shared-futures-ui_externalDebug"}, m3637k = 2, m3638mv = {2, 1, 0}, m3640xi = 48)
@SourceDebugExtension
/* renamed from: com.robinhood.android.futures.sharedfuturesui.MarketClosedHeaderKt, reason: use source file name */
/* loaded from: classes3.dex */
public final class MarketClosedHeader {
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit MarketClosedHeader$lambda$4(StringResource stringResource, Modifier modifier, int i, int i2, Composer composer, int i3) {
        MarketClosedHeader(stringResource, modifier, composer, RecomposeScopeImpl4.updateChangedFlags(i | 1), i2);
    ...
    */
    public static final void MarketClosedHeader(final StringResource headerString, Modifier modifier, Composer composer, final int i, final int i2) {
        int i3;
        Modifier modifier2;
        int i4;
        ...
        Composer composerStartRestartGroup = composer.startRestartGroup(-631579467);
        if ((i2 & 1) != 0) {
            i3 = i | 6;
        } else if ((i & 6) == 0) {
            i3 = ((i & 8) == 0 ? composerStartRestartGroup.changed(headerString) : composerStartRestartGroup.changedInstance(headerString) ? 4 : 2) | i;
        } else {
            i3 = i;
        }
        int i5 = i2 & 2;
        if (i5 == 0) {
            ...
            if ((i4 & 19) == 18 || !composerStartRestartGroup.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-631579467, i4, -1, "com.robinhood.android.futures.sharedfuturesui.MarketClosedHeader (MarketClosedHeader.kt:20)");
                }
                ...
                if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = new Function0() { // from class: com.robinhood.android.futures.sharedfuturesui.MarketClosedHeaderKt$$ExternalSyntheticLambda0
                ...
                BentoIcon2.m20644BentoIconFU0evQE(new BentoIcon4.Size16(ServerToBentoAssetMapper2.CLOCK_16), null, bentoTheme.getColors(composerStartRestartGroup, i6).m21425getFg0d7_KjU(), PaddingKt.m5144paddingVpY3zN4$default(companion3, bentoTheme.getSpacing(composerStartRestartGroup, i6).m21593getSmallD9Ej5fM(), 0.0f, 2, null), null, false, composerStartRestartGroup, BentoIcon4.Size16.$stable | 48, 48);
                modifier3 = modifier4;
                BentoText2.m20747BentoText38GnDrw(StringResources6.getText(headerString, composerStartRestartGroup, StringResource.$stable | (i4 & 14)).toString(), null, null, null, null, null, null, 0, false, 0, 0, null, 0, bentoTheme.getTypography(composerStartRestartGroup, i6).getTextS(), composerStartRestartGroup, 0, 0, 8190);
            ...
            if (scopeUpdateScopeEndRestartGroup == null) {
                scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: com.robinhood.android.futures.sharedfuturesui.MarketClosedHeaderKt$$ExternalSyntheticLambda1
                    @Override // kotlin.jvm.functions.Function2
                    public final Object invoke(Object obj, Object obj2) {
                        return MarketClosedHeader.MarketClosedHeader$lambda$4(headerString, modifier3, i, i2, (Composer) obj, ((Integer) obj2).intValue());
                    }
                });
                return;
            }
        ...
        if ((i4 & 19) == 18) {
            ...
            if (!composerM6388constructorimpl.getInserting()) {
                ...
                if (!composerM6388constructorimpl2.getInserting()) {
                    ...
                    BentoIcon2.m20644BentoIconFU0evQE(new BentoIcon4.Size16(ServerToBentoAssetMapper2.CLOCK_16), null, bentoTheme2.getColors(composerStartRestartGroup, i62).m21425getFg0d7_KjU(), PaddingKt.m5144paddingVpY3zN4$default(companion32, bentoTheme2.getSpacing(composerStartRestartGroup, i62).m21593getSmallD9Ej5fM(), 0.0f, 2, null), null, false, composerStartRestartGroup, BentoIcon4.Size16.$stable | 48, 48);
                    modifier3 = modifier4;
                    BentoText2.m20747BentoText38GnDrw(StringResources6.getText(headerString, composerStartRestartGroup, StringResource.$stable | (i4 & 14)).toString(), null, null, null, null, null, null, 0, false, 0, 0, null, 0, bentoTheme2.getTypography(composerStartRestartGroup, i62).getTextS(), composerStartRestartGroup, 0, 0, 8190);
                    composerStartRestartGroup = composerStartRestartGroup;
                    composerStartRestartGroup.endNode();
                    composerStartRestartGroup.endNode();
                    if (ComposerKt.isTraceInProgress()) {

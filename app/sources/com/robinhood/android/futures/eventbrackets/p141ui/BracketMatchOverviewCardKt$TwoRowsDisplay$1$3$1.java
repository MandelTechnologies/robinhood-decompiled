...
final class BracketMatchOverviewCardKt$TwoRowsDisplay$1$3$1 implements Function1<ConstrainScope, Unit> {
    ...
    BracketMatchOverviewCardKt$TwoRowsDisplay$1$3$1(ConstraintLayoutBaseScope.VerticalAnchor verticalAnchor, ConstraintLayoutBaseScope.VerticalAnchor verticalAnchor2, ConstraintLayoutBaseScope.HorizontalAnchor horizontalAnchor) {
    ...
    public final void invoke2(ConstrainScope constrainAs) {
        ...
        ConstrainScope.m8129linkTo8ZKsbrE$default(constrainAs, constrainAs.getParent().getTop(), this.$horizontalGuideline, 0.0f, C2002Dp.m7995constructorimpl(4), 0.0f, 0.0f, 0.0f, 116, (Object) null);

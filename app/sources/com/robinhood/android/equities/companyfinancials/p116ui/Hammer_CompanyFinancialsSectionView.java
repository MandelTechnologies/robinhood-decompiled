...
public abstract class Hammer_CompanyFinancialsSectionView extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_CompanyFinancialsSectionView(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_CompanyFinancialsSectionView2 hammer_CompanyFinancialsSectionView2 = (Hammer_CompanyFinancialsSectionView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equities.companyfinancials.ui.CompanyFinancialsSectionView");
        hammer_CompanyFinancialsSectionView2.inject((CompanyFinancialsSectionView) this);
        this.injected = true;
    }
}

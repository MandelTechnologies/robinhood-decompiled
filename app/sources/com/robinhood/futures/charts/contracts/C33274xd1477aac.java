...
@Deprecated
/* renamed from: com.robinhood.futures.charts.contracts.FuturesChartsService_Adapter$Endpoint_streamEagleChartJson$Arguments$$serializer */
/* loaded from: classes15.dex */
public /* synthetic */ class C33274xd1477aac implements PluginHelperInterfaces<FuturesChartsService_Adapter.Endpoint_streamEagleChartJson.Arguments> {
    public static final C33274xd1477aac INSTANCE;
    private static final SerialDescriptor descriptor;

    private C33274xd1477aac() {
    }
    ...
    static {
        C33274xd1477aac c33274xd1477aac = new C33274xd1477aac();
        INSTANCE = c33274xd1477aac;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.robinhood.futures.charts.contracts.FuturesChartsService_Adapter.Endpoint_streamEagleChartJson.Arguments", c33274xd1477aac, 3);
    ...
    public final KSerializer<?>[] childSerializers() {
        Lazy[] lazyArr = FuturesChartsService_Adapter.Endpoint_streamEagleChartJson.Arguments.$childSerializers;
    ...
    public final FuturesChartsService_Adapter.Endpoint_streamEagleChartJson.Arguments deserialize(Decoding2 decoder) {
        int i;
        List list;
        ...
        return new FuturesChartsService_Adapter.Endpoint_streamEagleChartJson.Arguments(i, list, sduiDisplaySpan, bool, null);
    }

    @Override // kotlinx.serialization.KSerializer3
    public final void serialize(Encoding4 encoder, FuturesChartsService_Adapter.Endpoint_streamEagleChartJson.Arguments value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        Encoding3 encoding3BeginStructure = encoder.beginStructure(serialDescriptor);
        FuturesChartsService_Adapter.Endpoint_streamEagleChartJson.Arguments.write$Self$contracts(value, encoding3BeginStructure, serialDescriptor);

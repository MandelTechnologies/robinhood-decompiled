...
/* compiled from: CheckTransferFormatter.kt */
@Metadata(m3635d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\r\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0007\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0011\b\u0007\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\u0012\u0010\u0007\u001a\u0004\u0018\u00010\b2\u0006\u0010\t\u001a\u00020\u0002H\u0016J\u0010\u0010\n\u001a\u00020\u000b2\u0006\u0010\t\u001a\u00020\u0002H\u0016J\u0016\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u000e0\r2\u0006\u0010\t\u001a\u00020\u0002H\u0016J\u0012\u0010\u000f\u001a\u0004\u0018\u00010\u000b2\u0006\u0010\t\u001a\u00020\u0002H\u0016J\u0012\u0010\u0010\u001a\u0004\u0018\u00010\u00112\u0006\u0010\t\u001a\u00020\u0002H\u0016¨\u0006\u0012"}, m3636d2 = {"Lcom/robinhood/shared/history/formatters/legacy/rhy/CheckTransferFormatter;", "Lcom/robinhood/android/common/history/ui/format/AbstractMinervaTransactionFormatter;", "Lcom/robinhood/shared/models/history/CheckTransferTransaction;", "resources", "Landroid/content/res/Resources;", "<init>", "(Landroid/content/res/Resources;)V", "getSummaryBadge", "Lcom/robinhood/android/common/history/ui/format/TransactionSummary$Badge;", "transaction", "getPrimaryText", "", "getLineItems", "", "Lcom/robinhood/android/common/history/ui/format/TransactionLineItem;", "getMetadataSecondaryText", "getMetadataSecondaryTextIcon", "Lcom/robinhood/android/common/history/ui/format/TransactionSummary$Icon;", "lib-history-formatters-legacy_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
@SourceDebugExtension
/* loaded from: classes6.dex */
public final class CheckTransferFormatter extends AbstractMinervaTransactionFormatter<CheckTransferTransaction> {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CheckTransferFormatter(Resources resources) {
        super(resources);
    ...
    public TransactionSummary.Badge getSummaryBadge(CheckTransferTransaction transaction) {
    ...
    public CharSequence getPrimaryText(CheckTransferTransaction transaction) throws Resources.NotFoundException {
        Intrinsics.checkNotNullParameter(transaction, "transaction");
    ...
    public List<TransactionLineItem> mo25632getLineItems(CheckTransferTransaction transaction) throws Resources.NotFoundException {
        ...
        Intrinsics.checkNotNull(details, "null cannot be cast to non-null type com.robinhood.transfers.api.ApiPaymentTransferDetails.ApiCheckTransfer");
        ApiPaymentTransferDetails.ApiCheckTransfer apiCheckTransfer = (ApiPaymentTransferDetails.ApiCheckTransfer) details;
        ...
        LocalDate limitation_release_date = apiCheckTransfer.getLimitation_release_date();
        ...
        BigDecimal return_fees = apiCheckTransfer.getReturn_fees();
        if (return_fees != null && event.getState() == TransferState.REVERSED && BigDecimals7.m2978gt(return_fees, BigDecimal.ZERO)) {
            arrayList.add(new TransactionLineItem(getString(C39006R.string.check_transfer_return_fees_title), Money.format$default(Money3.toMoney(return_fees, Currencies.USD), null, false, null, false, 0, null, false, null, false, false, 1023, null), null, null, false, null, null, null, EnumC7081g.SDK_ASSET_ILLUSTRATION_ROUTING_NUMBER_CONFIRMED_CIRCLE_VALUE, null));
        }
        return arrayList;
    }

    @Override // com.robinhood.android.common.history.p082ui.format.AbstractMinervaTransactionFormatter, com.robinhood.android.common.history.p082ui.format.HistoryTransactionFormatter
    public CharSequence getMetadataSecondaryText(CheckTransferTransaction transaction) {
        Money enoki_amount;
        Money.Adjustment creditAdjustment;
        Intrinsics.checkNotNullParameter(transaction, "transaction");
        ApiPaymentTransferDetails details = transaction.getEvent().getDetails();
        ApiPaymentTransferDetails.ApiCheckTransfer apiCheckTransfer = details instanceof ApiPaymentTransferDetails.ApiCheckTransfer ? (ApiPaymentTransferDetails.ApiCheckTransfer) details : null;
        if (apiCheckTransfer == null || (enoki_amount = apiCheckTransfer.getEnoki_amount()) == null || (creditAdjustment = enoki_amount.toCreditAdjustment()) == null) {
            return null;
        }
    ...
    @Override // com.robinhood.android.common.history.p082ui.format.AbstractMinervaTransactionFormatter, com.robinhood.android.common.history.p082ui.format.HistoryTransactionFormatter
    public TransactionSummary.Icon getMetadataSecondaryTextIcon(CheckTransferTransaction transaction) {
        Intrinsics.checkNotNullParameter(transaction, "transaction");
        ApiPaymentTransferDetails details = transaction.getEvent().getDetails();
        ApiPaymentTransferDetails.ApiCheckTransfer apiCheckTransfer = details instanceof ApiPaymentTransferDetails.ApiCheckTransfer ? (ApiPaymentTransferDetails.ApiCheckTransfer) details : null;
        if ((apiCheckTransfer != null ? apiCheckTransfer.getEnoki_amount() : null) != null) {

...
final class PillLoadingPlaceholderModifierKt$pillLoadingPlaceholder$2 implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i) {
        ...
        composer.startReplaceGroup(-1363639145);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1363639145, i, -1, "com.robinhood.shared.trading.tradecomponentscompose.traderow.pillLoadingPlaceholder.<anonymous> (PillLoadingPlaceholderModifier.kt:72)");
        }
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            Object obj = new Function1() { // from class: com.robinhood.shared.trading.tradecomponentscompose.traderow.PillLoadingPlaceholderModifierKt$pillLoadingPlaceholder$2$$ExternalSyntheticLambda1
    ...
    public static final DrawResult invoke$lambda$5$lambda$4(float f, Shape shape, final float f2, final long j, final SnapshotState4 snapshotState4, final Brush brush, CacheDrawScope drawWithCache) {
        ...
        final PathMeasure pathMeasure = PathMeasures3.toPathMeasure(outlineMo4911createOutlinePq9zytI);
        ...
        return drawWithCache.onDrawBehind(new Function1() { // from class: com.robinhood.shared.trading.tradecomponentscompose.traderow.PillLoadingPlaceholderModifierKt$pillLoadingPlaceholder$2$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
    ...
    public static final Unit invoke$lambda$5$lambda$4$lambda$3(float f, float f2, float f3, PathMeasure pathMeasure, float f4, long j, float f5, SnapshotState4 snapshotState4, Outline outline, Brush brush, Stroke stroke, DrawScope onDrawBehind) {
        ...
        long offsetAtCurrentProgress = PathMeasures3.getOffsetAtCurrentProgress(pathMeasure, invoke$lambda$0(snapshotState4));
        ...
        try {
            ...
            DrawScope.m6946drawCircleV9BoPsw$default(onDrawBehind, PillLoadingPlaceholderModifierKt.m26316dotRadialGradientqcb84PM(j, j2, f6), f5, j2, 0.0f, null, null, BlendMode.INSTANCE.m6667getSrcAtop0nO6VwU(), 56, null);
            return Unit.INSTANCE;
        } catch (Throwable th) {
            float f8 = -f4;

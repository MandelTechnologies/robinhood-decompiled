...
/* renamed from: com.robinhood.shared.tradeladder.ui.ladder.ftux.FtuxContextualBarKt$FtuxContextualBar$2$invoke$lambda$7$$inlined$ConstraintLayout$1 */
/* loaded from: classes12.dex */
public final class C40937x41087c24 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public C40937x41087c24(SnapshotState snapshotState, Ref ref, ConstraintLayoutScope constraintLayoutScope, Channel channel, SnapshotState snapshotState2, SnapshotState snapshotState3, FtuxContextualBarData ftuxContextualBarData, Function0 function0, Function0 function02) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        if ((i & 3) != 2 || !composer.getSkipping()) {
            ...
            composer.startReplaceGroup(-27307772);
            ...
            composer.startReplaceGroup(-1109255053);
            if (secondaryButton != null) {
                composer.startReplaceGroup(-1109250683);
                Function0 function0 = this.$onSecondaryClick$inlined;
                if (function0 == null) {
                    composer.startReplaceGroup(1849434622);
                    Object objRememberedValue = composer.rememberedValue();
                    if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                        objRememberedValue = FtuxContextualBar4.INSTANCE;
                ...
                if (zChanged || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue2 = new FtuxContextualBar5(constraintLayoutBaseScope4Component2);
                    composer.updateRememberedValue(objRememberedValue2);
                }
                composer.endReplaceGroup();
                FtuxContextualBar3.ContextualBarButton(secondaryButton, function0, constraintLayoutScope.constrainAs(companion, constraintLayoutBaseScope4Component1, (Function1) objRememberedValue2), composer, 0, 0);
            }
            composer.endReplaceGroup();
            ...
            if (zChanged2 || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue3 = new FtuxContextualBar6(constraintLayoutBaseScope4Component1);
                composer.updateRememberedValue(objRememberedValue3);
            }
            composer.endReplaceGroup();
            FtuxContextualBar3.ContextualBarButton(primaryButton, function02, constraintLayoutScope.constrainAs(companion2, constraintLayoutBaseScope4Component2, (Function1) objRememberedValue3), composer, 0, 0);
            composer.endReplaceGroup();
            ...
            if (zChangedInstance || objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue4 = new Function0<Unit>() { // from class: com.robinhood.shared.tradeladder.ui.ladder.ftux.FtuxContextualBarKt$FtuxContextualBar$2$invoke$lambda$7$$inlined$ConstraintLayout$1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }

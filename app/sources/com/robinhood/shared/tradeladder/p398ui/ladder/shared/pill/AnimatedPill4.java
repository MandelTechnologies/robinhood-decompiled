...
public final class AnimatedPill4 {
    ...
    public static final Unit AnimatedPill_T042LqI$lambda$6(boolean z, Shape shape, long j, Function3 function3, Modifier modifier, int i, int i2, Composer composer, int i3) {
        m26149AnimatedPillT042LqI(z, shape, j, function3, modifier, composer, RecomposeScopeImpl4.updateChangedFlags(i | 1), i2);
    ...
    public static final TweenSpec<Float> loadingShimmerTweenSpec(Composer composer, int i) {
        composer.startReplaceGroup(-795220633);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-795220633, i, -1, "com.robinhood.shared.tradeladder.ui.ladder.shared.pill.loadingShimmerTweenSpec (AnimatedPill.kt:65)");
        }
    ...
    */
    public static final void m26149AnimatedPillT042LqI(boolean z, final Shape shape, final long j, final Function3<? super Float, ? super Composer, ? super Integer, Unit> pillContent, Modifier modifier, Composer composer, final int i, final int i2) {
        boolean z2;
        int i3;
        int i4;
        ...
        Composer composer2;
        Modifier modifier3;
        Modifier modifierM26166pillLoadingPlaceholderdDIYWSk$default;
        Composer composer3;
        ...
        Composer composerStartRestartGroup = composer.startRestartGroup(598761621);
        if ((i2 & 1) != 0) {
            i3 = i | 6;
            z2 = z;
        } else {
        ...
        if ((i2 & 4) != 0) {
            ...
            if (i4 != 0) {
                ...
                if ((i5 & 9363) == 9362 && composerStartRestartGroup.getSkipping()) {
                    ...
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(598761621, i5, -1, "com.robinhood.shared.tradeladder.ui.ladder.shared.pill.AnimatedPill (AnimatedPill.kt:27)");
                    }
                    ...
                    AnimatedPill6 animatedPill6 = new Function3<Transition.Segment<Boolean>, Composer, Integer, FiniteAnimationSpec<Float>>() { // from class: com.robinhood.shared.tradeladder.ui.ladder.shared.pill.AnimatedPillKt$AnimatedPill$animateLoadingAlpha$2
                        ...
                        public final FiniteAnimationSpec<Float> invoke(Transition.Segment<Boolean> animateFloat, Composer composer5, int i7) {
                            Intrinsics.checkNotNullParameter(animateFloat, "$this$animateFloat");
                            composer5.startReplaceGroup(1686965381);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventStart(1686965381, i7, -1, "com.robinhood.shared.tradeladder.ui.ladder.shared.pill.AnimatedPill.<anonymous> (AnimatedPill.kt:30)");
                            }
                            TweenSpec tweenSpecLoadingShimmerTweenSpec = AnimatedPill4.loadingShimmerTweenSpec(composer5, 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                            }
                    ...
                    composerStartRestartGroup.startReplaceGroup(-266692502);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-266692502, 0, -1, "com.robinhood.shared.tradeladder.ui.ladder.shared.pill.AnimatedPill.<anonymous> (AnimatedPill.kt:33)");
                    }
                    ...
                    composerStartRestartGroup.endReplaceGroup();
                    snapshotState4CreateTransitionAnimation = TransitionKt.createTransitionAnimation(transitionUpdateTransition, fValueOf, Float.valueOf(f2), animatedPill6.invoke((AnimatedPill6) transitionUpdateTransition.getSegment(), (Transition.Segment) composerStartRestartGroup, (Composer) 0), vectorConverter, "AnimatedLoadingAlpha", composerStartRestartGroup, 196608);
                    composerStartRestartGroup.startReplaceGroup(-115679299);
                    if (AnimatedPill_T042LqI$lambda$1(snapshotState4CreateTransitionAnimation) <= 0.1f) {
                        composer2 = composerStartRestartGroup;
                        modifier3 = modifier4;
                        modifierM26166pillLoadingPlaceholderdDIYWSk$default = modifier3;
                    } else {
                        composer2 = composerStartRestartGroup;
                        modifier3 = modifier4;
                        modifierM26166pillLoadingPlaceholderdDIYWSk$default = PillLoadingPlaceholderModifierKt.m26166pillLoadingPlaceholderdDIYWSk$default(modifier3, shape, j, ((LadderStyle) composerStartRestartGroup.consume(LadderStyleKt.getLocalLadderStyle())).getPillOutlineGradiantBrush(), AnimatedPill_T042LqI$lambda$1(snapshotState4CreateTransitionAnimation), 0.0f, 0, 48, null);
                    }
                    ...
                    Modifier modifierMaterializeModifier = ComposedModifier2.materializeModifier(composer3, modifierM26166pillLoadingPlaceholderdDIYWSk$default);
                    ...
                    AnimatedPill5 animatedPill5 = new Function3<Transition.Segment<Boolean>, Composer, Integer, FiniteAnimationSpec<Float>>() { // from class: com.robinhood.shared.tradeladder.ui.ladder.shared.pill.AnimatedPillKt$AnimatedPill$2$textPillAlpha$2
                        @Override // kotlin.jvm.functions.Function3
                        public /* bridge */ /* synthetic */ FiniteAnimationSpec<Float> invoke(Transition.Segment<Boolean> segment, Composer composer5, Integer num) {
                            return invoke(segment, composer5, num.intValue());
                        }
                        ...
                        public final FiniteAnimationSpec<Float> invoke(Transition.Segment<Boolean> animateFloat, Composer composer5, int i7) {
                            Intrinsics.checkNotNullParameter(animateFloat, "$this$animateFloat");
                            composer5.startReplaceGroup(-595212364);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventStart(-595212364, i7, -1, "com.robinhood.shared.tradeladder.ui.ladder.shared.pill.AnimatedPill.<anonymous>.<anonymous> (AnimatedPill.kt:48)");
                            }
                            TweenSpec tweenSpecLoadingShimmerTweenSpec = AnimatedPill4.loadingShimmerTweenSpec(composer5, 0);
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventEnd();
                    ...
                    composer3.startReplaceGroup(-642594151);
                    if (ComposerKt.isTraceInProgress()) {
                        i6 = -1;
                    } else {
                        i6 = -1;
                        ComposerKt.traceEventStart(-642594151, 0, -1, "com.robinhood.shared.tradeladder.ui.ladder.shared.pill.AnimatedPill.<anonymous>.<anonymous> (AnimatedPill.kt:51)");
                    }
                    ...
                    composer3.startReplaceGroup(-642594151);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-642594151, 0, i6, "com.robinhood.shared.tradeladder.ui.ladder.shared.pill.AnimatedPill.<anonymous>.<anonymous> (AnimatedPill.kt:51)");
                    }
                    ...
                    composer3.endReplaceGroup();
                    SnapshotState4 snapshotState4CreateTransitionAnimation2 = TransitionKt.createTransitionAnimation(transitionUpdateTransition, fValueOf2, Float.valueOf(f4), animatedPill5.invoke((AnimatedPill5) transitionUpdateTransition.getSegment(), (Transition.Segment) composer3, (Composer) 0), vectorConverter2, "AnimatedTextPillAlpha", composer3, 196608);
                    composer4 = composer3;
                    pillContent.invoke(Float.valueOf(AnimatedPill_T042LqI$lambda$5$lambda$4(snapshotState4CreateTransitionAnimation2)), composer4, Integer.valueOf((i5 >> 6) & 112));
                    composer4.endNode();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                ...
                if (scopeUpdateScopeEndRestartGroup != null) {
                    final boolean z3 = z2;
                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: com.robinhood.shared.tradeladder.ui.ladder.shared.pill.AnimatedPillKt$$ExternalSyntheticLambda0
                        @Override // kotlin.jvm.functions.Function2
                        public final Object invoke(Object obj, Object obj2) {
                            return AnimatedPill4.AnimatedPill_T042LqI$lambda$6(z3, shape, j, pillContent, modifier2, i, i2, (Composer) obj, ((Integer) obj2).intValue());
                        }
                    });
                    return;
                }
            ...
            if ((i5 & 9363) == 9362) {
                ...
                AnimatedPill6 animatedPill62 = new Function3<Transition.Segment<Boolean>, Composer, Integer, FiniteAnimationSpec<Float>>() { // from class: com.robinhood.shared.tradeladder.ui.ladder.shared.pill.AnimatedPillKt$AnimatedPill$animateLoadingAlpha$2
                    @Override // kotlin.jvm.functions.Function3
                    public /* bridge */ /* synthetic */ FiniteAnimationSpec<Float> invoke(Transition.Segment<Boolean> segment, Composer composer5, Integer num) {
                        return invoke(segment, composer5, num.intValue());
                    }
                ...
                composerStartRestartGroup.endReplaceGroup();
                snapshotState4CreateTransitionAnimation = TransitionKt.createTransitionAnimation(transitionUpdateTransition2, fValueOf3, Float.valueOf(f2), animatedPill62.invoke((AnimatedPill6) transitionUpdateTransition2.getSegment(), (Transition.Segment) composerStartRestartGroup, (Composer) 0), vectorConverter3, "AnimatedLoadingAlpha", composerStartRestartGroup, 196608);
                composerStartRestartGroup.startReplaceGroup(-115679299);
                if (AnimatedPill_T042LqI$lambda$1(snapshotState4CreateTransitionAnimation) <= 0.1f) {
                }
                composer2.endReplaceGroup();
                ...
                Modifier modifierMaterializeModifier2 = ComposedModifier2.materializeModifier(composer3, modifierM26166pillLoadingPlaceholderdDIYWSk$default);
                ...
                if (!composerM6388constructorimpl.getInserting()) {
                    ...
                    AnimatedPill5 animatedPill52 = new Function3<Transition.Segment<Boolean>, Composer, Integer, FiniteAnimationSpec<Float>>() { // from class: com.robinhood.shared.tradeladder.ui.ladder.shared.pill.AnimatedPillKt$AnimatedPill$2$textPillAlpha$2
                        @Override // kotlin.jvm.functions.Function3
                        public /* bridge */ /* synthetic */ FiniteAnimationSpec<Float> invoke(Transition.Segment<Boolean> segment, Composer composer5, Integer num) {
                            return invoke(segment, composer5, num.intValue());
                        }
                    ...
                    composer3.endReplaceGroup();
                    SnapshotState4 snapshotState4CreateTransitionAnimation22 = TransitionKt.createTransitionAnimation(transitionUpdateTransition2, fValueOf22, Float.valueOf(f4), animatedPill52.invoke((AnimatedPill5) transitionUpdateTransition2.getSegment(), (Transition.Segment) composer3, (Composer) 0), vectorConverter22, "AnimatedTextPillAlpha", composer3, 196608);
                    composer4 = composer3;
                    pillContent.invoke(Float.valueOf(AnimatedPill_T042LqI$lambda$5$lambda$4(snapshotState4CreateTransitionAnimation22)), composer4, Integer.valueOf((i5 >> 6) & 112));
                    composer4.endNode();
                    if (ComposerKt.isTraceInProgress()) {
                    }
                    modifier2 = modifier3;

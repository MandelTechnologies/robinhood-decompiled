...
@DebugMetadata(m3644c = "com.robinhood.shared.tradeladder.ui.ladder.shared.floating.FloatingLadderItemsKt$FloatingLadderItems$3$1$1$1", m3645f = "FloatingLadderItems.kt", m3646l = {90, 95}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.shared.tradeladder.ui.ladder.shared.floating.FloatingLadderItemsKt$FloatingLadderItems$3$1$1$1, reason: use source file name */
/* loaded from: classes12.dex */
final class FloatingLadderItems3 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ LazyListState $ladderLazyListState;
    final /* synthetic */ OrderPillData $orderPillData;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    FloatingLadderItems3(OrderPillData orderPillData, LazyListState lazyListState, Continuation<? super FloatingLadderItems3> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new FloatingLadderItems3(this.$orderPillData, this.$ladderLazyListState, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((FloatingLadderItems3) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

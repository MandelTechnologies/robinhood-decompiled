...
/* renamed from: com.robinhood.shared.discovery.sdui.SduiFeatureDiscoveryKt$SduiFeatureDiscovery$1$4$2, reason: use source file name */
/* loaded from: classes6.dex */
final class SduiFeatureDiscovery7 implements Function2<Composer, Integer, Unit> {
    final /* synthetic */ SduiFeatureDiscovery2 $callback;
    final /* synthetic */ SnapshotState<Boolean> $showMore$delegate;

    SduiFeatureDiscovery7(SduiFeatureDiscovery2 sduiFeatureDiscovery2, SnapshotState<Boolean> snapshotState) {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(772450545, i, -1, "com.robinhood.shared.discovery.sdui.SduiFeatureDiscovery.<anonymous>.<anonymous>.<anonymous> (SduiFeatureDiscovery.kt:172)");
        }
        String strStringResource = StringResources_androidKt.stringResource(C20692R.string.feature_discovery_show_more, composer, 0);
        ...
        Modifier modifierTestTag = TestTag3.testTag(ModifiersKt.autoLogEvents$default(Modifier.INSTANCE, UserInteractionEventDescriptor.copy$default((UserInteractionEventDescriptor) composer.consume(AutoLoggingCompositionLocals.getLocalUserInteractionEventDescriptor()), "feature_discovery-show_more", null, null, null, null, null, 62, null), true, false, false, true, false, null, 108, null), SduiFeatureDiscovery3.SHOW_MORE_TAG);
        ...
        if (zChangedInstance || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new Function0() { // from class: com.robinhood.shared.discovery.sdui.SduiFeatureDiscoveryKt$SduiFeatureDiscovery$1$4$2$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return SduiFeatureDiscovery7.invoke$lambda$1$lambda$0(sduiFeatureDiscovery2, snapshotState);
                }
            };
    ...
    public static final Unit invoke$lambda$1$lambda$0(SduiFeatureDiscovery2 sduiFeatureDiscovery2, SnapshotState snapshotState) {
        SduiFeatureDiscovery3.SduiFeatureDiscovery$lambda$2(snapshotState, false);
        if (sduiFeatureDiscovery2 != null) {
            sduiFeatureDiscovery2.onExpanded(true);
        }
        return Unit.INSTANCE;
    }
}

...
/* renamed from: com.robinhood.shared.crypto.acats.submitassets.MigrationSubmitAssetsComposableKt$MigrationSubmitAssetsComposable$1$1$2$1$1$4$1, reason: use source file name */
/* loaded from: classes6.dex */
final class MigrationSubmitAssetsComposable9 implements Function3<LazyItemScope, Composer, Integer, Unit> {
    final /* synthetic */ BentoBaseRowState $cryptoRow;
    final /* synthetic */ ImmutableList<AssetRowText> $detailRows;
    final /* synthetic */ LifecycleAwareNavigator $navigator;

    MigrationSubmitAssetsComposable9(BentoBaseRowState bentoBaseRowState, LifecycleAwareNavigator lifecycleAwareNavigator, ImmutableList<AssetRowText> immutableList) {
        this.$cryptoRow = bentoBaseRowState;
    ...
    public final void invoke(LazyItemScope item, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-825503068, i, -1, "com.robinhood.shared.crypto.acats.submitassets.MigrationSubmitAssetsComposable.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous> (MigrationSubmitAssetsComposable.kt:225)");
        }
        ...
        composer.startReplaceGroup(1260511115);
        if (this.$cryptoRow.getMeta() instanceof BentoBaseRowState.Meta.SingleLineAndIcon) {
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new Function0() { // from class: com.robinhood.shared.crypto.acats.submitassets.MigrationSubmitAssetsComposableKt$MigrationSubmitAssetsComposable$1$1$2$1$1$4$1$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        return MigrationSubmitAssetsComposable9.invoke$lambda$1$lambda$0(lifecycleAwareNavigator, immutableList);
                    }
                };
        ...
        composer.endReplaceGroup();
        BentoBaseRowKt.m20915BentoBaseRowcd68TDI(modifierFillMaxWidth$default.then(modifierM4893clickableXHw0xAI$default), this.$cryptoRow, false, false, false, 0L, null, composer, BentoBaseRowState.$stable << 3, EnumC7081g.SDK_ASSET_ILLUSTRATION_SIGNATURE_VALUE);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final Unit invoke$lambda$1$lambda$0(LifecycleAwareNavigator lifecycleAwareNavigator, ImmutableList immutableList) throws Resources.NotFoundException {
        ...
        AssetListType assetListType = AssetListType.NON_TRANSFERABLE_CRYPTO;

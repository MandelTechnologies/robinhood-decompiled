...
@DebugMetadata(m3644c = "com.robinhood.store.futures.FuturesAccountStore$allAccountsEndpoint$4", m3645f = "FuturesAccountStore.kt", m3646l = {}, m3647m = "invokeSuspend")
@SourceDebugExtension
/* loaded from: classes12.dex */
final class FuturesAccountStore$allAccountsEndpoint$4 extends ContinuationImpl7 implements Function2<GetAccountsResponseDto, Continuation<? super Unit>, Object> {
    /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ FuturesAccountStore this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    FuturesAccountStore$allAccountsEndpoint$4(FuturesAccountStore futuresAccountStore, Continuation<? super FuturesAccountStore$allAccountsEndpoint$4> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        FuturesAccountStore$allAccountsEndpoint$4 futuresAccountStore$allAccountsEndpoint$4 = new FuturesAccountStore$allAccountsEndpoint$4(this.this$0, continuation);
        futuresAccountStore$allAccountsEndpoint$4.L$0 = obj;
        return futuresAccountStore$allAccountsEndpoint$4;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(GetAccountsResponseDto getAccountsResponseDto, Continuation<? super Unit> continuation) {
        return ((FuturesAccountStore$allAccountsEndpoint$4) create(getAccountsResponseDto, continuation)).invokeSuspend(Unit.INSTANCE);
    }

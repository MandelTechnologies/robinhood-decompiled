...
@DebugMetadata(m3644c = "com.robinhood.store.event.EventStore$special$$inlined$createExperimentBasedEndpoint$default$8", m3645f = "EventStore.kt", m3646l = {}, m3647m = "invokeSuspend")
@SourceDebugExtension
/* renamed from: com.robinhood.store.event.EventStore$special$$inlined$createExperimentBasedEndpoint$default$8 */
/* loaded from: classes12.dex */
public final class C41404xc410f9ab extends ContinuationImpl7 implements Function2<Response<? extends Dto3<?>>, Continuation<? super Unit>, Object> {
    /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ EventStore this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C41404xc410f9ab(Continuation continuation, EventStore eventStore) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        C41404xc410f9ab c41404xc410f9ab = new C41404xc410f9ab(continuation, this.this$0);
        c41404xc410f9ab.L$0 = obj;
        return c41404xc410f9ab;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(Response<? extends Dto3<?>> response, Continuation<? super Unit> continuation) {
        return ((C41404xc410f9ab) create(response, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (!(dto3 instanceof GetEventResponseDto)) {
            if (dto3 instanceof ListEventsResponseDto) {
                fullEventInfoWrapperFromArsenalEvent = EventStore.FullEventInfoWrapper.INSTANCE.fromArsenalEvent(((ListEventsResponseDto) dto3).getResults());
            }
        } else {
            EventDto event = ((GetEventResponseDto) dto3).getEvent();
            if (event != null) {

...
public class SLReflectionInstallReferrer implements InvocationHandler {
    ...
    private static final SingularLog logger = SingularLog.getLogger(SLReflectionInstallReferrer.class.getSimpleName());
    ...
    private void handleOnInstallReferrerSetupFinished(int i) {
        int i2 = C423651.f6393x4bf9d7f7[InstallReferrerCodes.values()[i].ordinal()];
        if (i2 == 1) {
            try {
    ...
    static /* synthetic */ class C423651 {
        ...
        static {
            ...
            try {
                f6393x4bf9d7f7[InstallReferrerCodes.STATUS_FEATURE_NOT_SUPPORTED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f6393x4bf9d7f7[InstallReferrerCodes.STATUS_SERVICE_UNAVAILABLE.ordinal()] = 3;

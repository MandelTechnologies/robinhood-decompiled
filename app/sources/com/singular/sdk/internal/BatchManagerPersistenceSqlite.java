...
public class BatchManagerPersistenceSqlite implements BatchManagerPersistence {
    ...
    private static class BatchManagerSQLiteHelper extends SQLiteOpenHelper {
        ...
        /* renamed from: db */
        private SQLiteDatabase f6392db;
            ...
            try {
                try {
                    ...
                    if (cursorRawQuery == null || cursorRawQuery.getCount() == 0) {
                        ...
                        SQLiteDatabase sQLiteDatabase = this.f6392db;
                    ...
                    cursorRawQuery.close();
                    cursorRawQuery.close();
                    SQLiteDatabase sQLiteDatabase2 = this.f6392db;
                ...
                SQLiteDatabase sQLiteDatabase3 = this.f6392db;
        ...
        public synchronized boolean update(String str, String str2) throws IOException {
            ...
            try {
                ...
                try {
                    this.f6392db = getWritableDatabase();
                    ContentValues contentValues = new ContentValues();
                    contentValues.put(COLUMN_NAME_KEY, str);
                    contentValues.put(COLUMN_NAME_VALUE, str2);
                    if (this.f6392db.replace(TABLE_NAME, null, contentValues) != -1) {
        ...
        public synchronized Set<Map.Entry<String, String>> getAll() {
            ...
            try {
                ...
                try {
                    ...
                    this.f6392db = readableDatabase;
                    cursorRawQuery = readableDatabase.rawQuery("SELECT * FROM events", null);
                    if (cursorRawQuery != null && cursorRawQuery.getCount() != 0) {
                        cursorRawQuery.moveToFirst();
                        do {
                            hashSet.add(new AbstractMap.SimpleEntry(cursorRawQuery.getString(cursorRawQuery.getColumnIndex(COLUMN_NAME_KEY)), cursorRawQuery.getString(cursorRawQuery.getColumnIndex(COLUMN_NAME_VALUE))));
                        } while (cursorRawQuery.moveToNext());
                    }
                    if (cursorRawQuery != null) {
                        cursorRawQuery.close();
                    }
                    sQLiteDatabase = this.f6392db;
                } catch (Throwable th) {
                    try {

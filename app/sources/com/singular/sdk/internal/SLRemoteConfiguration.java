...
public class SLRemoteConfiguration implements SLRemoteConfiguration2 {
    ...
    SLRemoteConfiguration(JSONObject jSONObject) {
    ...
    @Override // com.singular.sdk.internal.SLRemoteConfiguration2
    ...
    private static class AdmonBatching implements SLRemoteConfiguration2 {
    ...
    private static class Resolve implements SLRemoteConfiguration2 {
        private String sdid;

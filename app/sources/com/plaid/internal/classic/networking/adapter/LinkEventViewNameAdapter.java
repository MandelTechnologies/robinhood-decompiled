...
public final class LinkEventViewNameAdapter implements JsonSerializer<LinkEventViewName>, JsonDeserializer<LinkEventViewName> {
    ...
    public LinkEventViewName deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) {
        ...
        LinkEventViewName linkEventViewNameFromString$link_sdk_release = LinkEventViewName.INSTANCE.fromString$link_sdk_release(string2);
        if (linkEventViewNameFromString$link_sdk_release != null) {
            return linkEventViewNameFromString$link_sdk_release;
        }

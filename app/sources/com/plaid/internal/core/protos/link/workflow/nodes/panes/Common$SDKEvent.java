...
public final class Common$SDKEvent extends GeneratedMessageLite<Common$SDKEvent, C6479a> implements InterfaceC6691M {
    ...
    public static final class Metadata extends GeneratedMessageLite<Metadata, C6478a> implements MessageLiteOrBuilder {
        ...
        /* renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.Common$SDKEvent$Metadata$a */
        public static final class C6478a extends GeneratedMessageLite.Builder<Metadata, C6478a> implements MessageLiteOrBuilder {
            public C6478a() {
        ...
        public static C6478a newBuilder() {
        ...
        private void setIssueDescriptionBytes(ByteString byteString) throws IllegalArgumentException {
            AbstractMessageLite.checkByteStringIsUtf8(byteString);
        ...
        private void setIssueDetectedAtBytes(ByteString byteString) throws IllegalArgumentException {
            AbstractMessageLite.checkByteStringIsUtf8(byteString);
        ...
        private void setIssueIdBytes(ByteString byteString) throws IllegalArgumentException {
            AbstractMessageLite.checkByteStringIsUtf8(byteString);
        ...
        public static C6478a newBuilder(Metadata metadata) {
    ...
    /* renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.Common$SDKEvent$a */
    public static final class C6479a extends GeneratedMessageLite.Builder<Common$SDKEvent, C6479a> implements InterfaceC6691M {
        public C6479a() {
            super(Common$SDKEvent.DEFAULT_INSTANCE);
        }
    }

    /* renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.Common$SDKEvent$b */
    public enum EnumC6480b implements Internal.EnumLite {
        ...
        /* renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.Common$SDKEvent$b$a */
        public class a implements Internal.EnumLiteMap<EnumC6480b> {
            @Override // com.google.protobuf.Internal.EnumLiteMap
            public final Internal.EnumLite findValueByNumber(int i) {
                return EnumC6480b.forNumber(i);
            }
        }

        /* renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.Common$SDKEvent$b$b */
        public static final class b implements Internal.EnumVerifier {
            ...
            public final boolean isInRange(int i) {
                return EnumC6480b.forNumber(i) != null;
            }
        }
        ...
        public static EnumC6480b forNumber(int i) {
            if (i == 0) {
        ...
        public static Internal.EnumLiteMap<EnumC6480b> internalGetValueMap() {
            return f2268b;
        }
        ...
        @Deprecated
        public static EnumC6480b valueOf(int i) {
            return forNumber(i);
        }
    }

    /* renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.Common$SDKEvent$c */
    public enum EnumC6481c {
        DELAY_MS(4),
        QUEUE_BEHAVIOR(5),
        ...
        public static EnumC6481c forNumber(int i) {
            if (i == 0) {
        ...
        @Deprecated
        public static EnumC6481c valueOf(int i) {
            return forNumber(i);
        }
    }
    ...
    private void mergeMetadata(Metadata metadata) {
        ...
        if (metadata2 == null || metadata2 == Metadata.getDefaultInstance()) {
            ...
            this.metadata_ = Metadata.newBuilder(this.metadata_).mergeFrom((Metadata.C6478a) metadata).buildPartial();
        }
        this.bitField0_ |= 1;
    }

    public static C6479a newBuilder() {
        return DEFAULT_INSTANCE.createBuilder();
    }
    ...
    private void setQueueBehavior(EnumC6480b enumC6480b) {
    ...
    public EnumC6480b getQueueBehavior() {
        if (this.triggerBehaviorCase_ != 5) {
            return EnumC6480b.QUEUE_BEHAVIOR_UNKNOWN;
        }
        EnumC6480b enumC6480bForNumber = EnumC6480b.forNumber(((Integer) this.triggerBehavior_).intValue());
        return enumC6480bForNumber == null ? EnumC6480b.UNRECOGNIZED : enumC6480bForNumber;
    }
    ...
    public EnumC6481c getTriggerBehaviorCase() {
        return EnumC6481c.forNumber(this.triggerBehaviorCase_);
    }
    ...
    public static C6479a newBuilder(Common$SDKEvent common$SDKEvent) {

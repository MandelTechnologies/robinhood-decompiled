...
public final class ButtonWithCardsPaneOuterClass$ButtonWithCardsPane extends GeneratedMessageLite<ButtonWithCardsPaneOuterClass$ButtonWithCardsPane, C6339a> implements MessageLiteOrBuilder {
    ...
    public static final class Actions extends GeneratedMessageLite<Actions, C6334b> implements MessageLiteOrBuilder {
        ...
        public static final class ButtonTapAction extends GeneratedMessageLite<ButtonTapAction, C6330a> implements MessageLiteOrBuilder {
            private static final ButtonTapAction DEFAULT_INSTANCE;
            private static volatile Parser<ButtonTapAction> PARSER;

            /* renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.ButtonWithCardsPaneOuterClass$ButtonWithCardsPane$Actions$ButtonTapAction$a */
            public static final class C6330a extends GeneratedMessageLite.Builder<ButtonTapAction, C6330a> implements MessageLiteOrBuilder {
                public C6330a() {
            ...
            public static C6330a newBuilder() {
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                ...
                switch (C6907e.f2552a[methodToInvoke.ordinal()]) {
                    case 1:
            ...
            public static C6330a newBuilder(ButtonTapAction buttonTapAction) {
        ...
        public static final class ExitAction extends GeneratedMessageLite<ExitAction, C6331a> implements MessageLiteOrBuilder {
            private static final ExitAction DEFAULT_INSTANCE;
            private static volatile Parser<ExitAction> PARSER;

            /* renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.ButtonWithCardsPaneOuterClass$ButtonWithCardsPane$Actions$ExitAction$a */
            public static final class C6331a extends GeneratedMessageLite.Builder<ExitAction, C6331a> implements MessageLiteOrBuilder {
                public C6331a() {
            ...
            public static C6331a newBuilder() {
                return DEFAULT_INSTANCE.createBuilder();
            }
            ...
            public static C6331a newBuilder(ExitAction exitAction) {
        ...
        public static final class SecondaryButtonTapAction extends GeneratedMessageLite<SecondaryButtonTapAction, C6332a> implements MessageLiteOrBuilder {
            ...
            /* renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.ButtonWithCardsPaneOuterClass$ButtonWithCardsPane$Actions$SecondaryButtonTapAction$a */
            public static final class C6332a extends GeneratedMessageLite.Builder<SecondaryButtonTapAction, C6332a> implements MessageLiteOrBuilder {
                public C6332a() {
            ...
            public static C6332a newBuilder() {
                return DEFAULT_INSTANCE.createBuilder();
            }
            ...
            public static C6332a newBuilder(SecondaryButtonTapAction secondaryButtonTapAction) {
        ...
        /* renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.ButtonWithCardsPaneOuterClass$ButtonWithCardsPane$Actions$a */
        public enum EnumC6333a {
            BUTTON_TAP(1),
            ...
            public static EnumC6333a forNumber(int i) {
                if (i == 0) {
            ...
            @Deprecated
            public static EnumC6333a valueOf(int i) {
                return forNumber(i);
            }
        }

        /* renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.ButtonWithCardsPaneOuterClass$ButtonWithCardsPane$Actions$b */
        public static final class C6334b extends GeneratedMessageLite.Builder<Actions, C6334b> implements MessageLiteOrBuilder {
            public C6334b() {
        ...
        private void mergeButtonTap(ButtonTapAction buttonTapAction) {
            ...
            if (this.actionCase_ != 1 || this.action_ == ButtonTapAction.getDefaultInstance()) {
                ...
                this.action_ = ButtonTapAction.newBuilder((ButtonTapAction) this.action_).mergeFrom((ButtonTapAction.C6330a) buttonTapAction).buildPartial();
            }
            this.actionCase_ = 1;
        }
        ...
        private void mergeExit(ExitAction exitAction) {
            ...
            if (this.actionCase_ != 3 || this.action_ == ExitAction.getDefaultInstance()) {
                ...
                this.action_ = ExitAction.newBuilder((ExitAction) this.action_).mergeFrom((ExitAction.C6331a) exitAction).buildPartial();
            }
            this.actionCase_ = 3;
        }
        ...
        private void mergeSecondaryButtonTap(SecondaryButtonTapAction secondaryButtonTapAction) {
            ...
            if (this.actionCase_ != 2 || this.action_ == SecondaryButtonTapAction.getDefaultInstance()) {
                ...
                this.action_ = SecondaryButtonTapAction.newBuilder((SecondaryButtonTapAction) this.action_).mergeFrom((SecondaryButtonTapAction.C6332a) secondaryButtonTapAction).buildPartial();
            }
            this.actionCase_ = 2;
        }

        public static C6334b newBuilder() {
            return DEFAULT_INSTANCE.createBuilder();
        }
        ...
        public EnumC6333a getActionCase() {
            return EnumC6333a.forNumber(this.actionCase_);
        }
        ...
        public static C6334b newBuilder(Actions actions) {
    ...
    public static final class Rendering extends GeneratedMessageLite<Rendering, C6337a> implements MessageLiteOrBuilder {
        ...
        public static final class Card extends GeneratedMessageLite<Card, C6335a> implements InterfaceC6338b {
            ...
            /* renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.ButtonWithCardsPaneOuterClass$ButtonWithCardsPane$Rendering$Card$a */
            public static final class C6335a extends GeneratedMessageLite.Builder<Card, C6335a> implements InterfaceC6338b {
                public C6335a() {
            ...
            private void mergeAttributedDetail(Common$AttributedLocalizedString common$AttributedLocalizedString) {
                ...
                if (common$AttributedLocalizedString2 == null || common$AttributedLocalizedString2 == Common$AttributedLocalizedString.getDefaultInstance()) {
                    ...
                    this.attributedDetail_ = Common$AttributedLocalizedString.newBuilder(this.attributedDetail_).mergeFrom((Common$AttributedLocalizedString.C6390c) common$AttributedLocalizedString).buildPartial();
                }
                this.bitField0_ |= 8;
            }
            ...
            public static C6335a newBuilder() {
                return DEFAULT_INSTANCE.createBuilder();
            }
            ...
            public static C6335a newBuilder(Card card) {
        ...
        public static final class Events extends GeneratedMessageLite<Events, C6336a> implements MessageLiteOrBuilder {
            ...
            /* renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.ButtonWithCardsPaneOuterClass$ButtonWithCardsPane$Rendering$Events$a */
            public static final class C6336a extends GeneratedMessageLite.Builder<Events, C6336a> implements MessageLiteOrBuilder {
                public C6336a() {
            ...
            public static C6336a newBuilder() {
                return DEFAULT_INSTANCE.createBuilder();
            }
            ...
            public static C6336a newBuilder(Events events) {
        ...
        /* renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.ButtonWithCardsPaneOuterClass$ButtonWithCardsPane$Rendering$a */
        public static final class C6337a extends GeneratedMessageLite.Builder<Rendering, C6337a> implements MessageLiteOrBuilder {
            public C6337a() {
                super(Rendering.DEFAULT_INSTANCE);
            }
        }

        /* renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.ButtonWithCardsPaneOuterClass$ButtonWithCardsPane$Rendering$b */
        public interface InterfaceC6338b extends MessageLiteOrBuilder {
        }
        ...
        private void mergeEvents(Events events) {
            ...
            if (events2 == null || events2 == Events.getDefaultInstance()) {
                ...
                this.events_ = Events.newBuilder(this.events_).mergeFrom((Events.C6336a) events).buildPartial();
            }
            this.bitField0_ |= 128;
        }
        ...
        public static C6337a newBuilder() {
            return DEFAULT_INSTANCE.createBuilder();
        }
        ...
        public InterfaceC6338b getCardsOrBuilder(int i) {
            return this.cards_.get(i);
        }

        public List<? extends InterfaceC6338b> getCardsOrBuilderList() {
            return this.cards_;
        }
        ...
        public static C6337a newBuilder(Rendering rendering) {
    ...
    /* renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.ButtonWithCardsPaneOuterClass$ButtonWithCardsPane$a */
    public static final class C6339a extends GeneratedMessageLite.Builder<ButtonWithCardsPaneOuterClass$ButtonWithCardsPane, C6339a> implements MessageLiteOrBuilder {
        public C6339a() {
    ...
    public static C6339a newBuilder() {
        return DEFAULT_INSTANCE.createBuilder();
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (C6907e.f2552a[methodToInvoke.ordinal()]) {
            ...
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                Parser<ButtonWithCardsPaneOuterClass$ButtonWithCardsPane> parser = PARSER;
                if (parser != null) {
                    return parser;
                }
    ...
    public static C6339a newBuilder(ButtonWithCardsPaneOuterClass$ButtonWithCardsPane buttonWithCardsPaneOuterClass$ButtonWithCardsPane) {

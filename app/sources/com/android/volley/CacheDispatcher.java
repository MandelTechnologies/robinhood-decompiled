...
public class CacheDispatcher extends Thread {
    ...
    public CacheDispatcher(BlockingQueue<Request<?>> blockingQueue, BlockingQueue<Request<?>> blockingQueue2, Cache cache2, ResponseDelivery responseDelivery) {
    ...
    public void run() throws SecurityException, IllegalArgumentException {
        if (DEBUG) {
            VolleyLog.m774v("start new dispatcher", new Object[0]);
        }
        ...
        while (true) {
            try {
                ...
                VolleyLog.m772e("Ignoring spurious interrupt of CacheDispatcher thread; use quit() to terminate it", new Object[0]);
            }
        }
    }

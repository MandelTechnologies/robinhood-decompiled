...
public class NetworkDispatcher extends Thread {
    ...
    public NetworkDispatcher(BlockingQueue<Request<?>> blockingQueue, Network network, Cache cache2, ResponseDelivery responseDelivery) {
    ...
    public void run() throws SecurityException, IllegalArgumentException {
        ...
        while (true) {
            try {
                ...
                VolleyLog.m772e("Ignoring spurious interrupt of NetworkDispatcher thread; use quit() to terminate it", new Object[0]);
            }
        }
    }
    ...
    void processRequest(Request<?> request) {
        ...
        try {
            try {
                ...
                VolleyLog.m773e(e2, "Unhandled exception %s", e2.toString());

...
abstract class ClassFactory<T> {
    ...
    public static <T> ClassFactory<T> get(final Class<?> cls) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, SecurityException, ClassNotFoundException, IllegalArgumentException {
        try {
            try {
                try {
                    try {

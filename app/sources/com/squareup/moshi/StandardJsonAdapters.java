...
final class StandardJsonAdapters {
    public static final JsonAdapter.Factory FACTORY = new JsonAdapter.Factory() { // from class: com.squareup.moshi.StandardJsonAdapters.1
        ...
        public JsonAdapter<?> create(Type type2, Set<? extends Annotation> set, Moshi moshi) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
            if (!set.isEmpty()) {
                return null;
            }
    ...
    static final JsonAdapter<Character> CHARACTER_JSON_ADAPTER = new JsonAdapter<Character>() { // from class: com.squareup.moshi.StandardJsonAdapters.4
        ...
        public Character fromJson(JsonReader jsonReader) throws IOException {
            ...
            if (strNextString.length() > 1) {
                throw new JsonDataException(String.format("Expected %s but was %s at path %s", "a char", '\"' + strNextString + '\"', jsonReader.getPath()));
            }
    ...
    static int rangeCheckNextInt(JsonReader jsonReader, String str, int i, int i2) throws IOException {
        ...
        if (iNextInt < i || iNextInt > i2) {
            throw new JsonDataException(String.format("Expected %s but was %s at path %s", str, Integer.valueOf(iNextInt), jsonReader.getPath()));
        }
        return iNextInt;
    }
            ...
            try {
                ...
                while (true) {
                    ...
                    if (i < tArr.length) {
                        ...
                        this.options = JsonReader.Options.m3152of(this.nameStrings);
                        return;
                    }
                }
    ...
    static final class ObjectJsonAdapter extends JsonAdapter<Object> {
        ...
        public Object fromJson(JsonReader jsonReader) throws IOException {
            switch (C4242211.$SwitchMap$com$squareup$moshi$JsonReader$Token[jsonReader.peek().ordinal()]) {
                case 1:
    ...
    /* loaded from: classes12.dex */
    static /* synthetic */ class C4242211 {

...
final class JsonUtf8Reader extends JsonReader {
    ...
    JsonUtf8Reader(JsonUtf8Reader jsonUtf8Reader) {
        ...
        this.buffer = bufferedSourcePeek.getBufferField();
        ...
        try {
            bufferedSourcePeek.require(jsonUtf8Reader.buffer.getSize());
    ...
    public BufferedSource nextSource() throws IOException {
        ...
        if (iDoPeek == 3) {
            ...
            if (iDoPeek == 9) {
                ...
                try {
                    jsonWriterM3153of.value(strNextString);
    ...
    */
    ...
    private boolean skipToEndOfBlockComment() throws IOException {
        ...
        Buffer buffer = this.buffer;
        buffer.skip(z ? jIndexOf + r1.size() : buffer.getSize());
        return z;
    }

...
final class JsonValueReader extends JsonReader {
    ...
    JsonValueReader(JsonValueReader jsonValueReader) {
        ...
        for (int i = 0; i < this.stackSize; i++) {
            ...
            if (obj instanceof JsonIterator) {
                objArr[i] = ((JsonIterator) obj).m26815clone();
            }
        }
    }
    ...
    public BufferedSource nextSource() throws IOException {
        ...
        JsonWriter jsonWriterM3153of = JsonWriter.m3153of(buffer);
        try {
            jsonWriterM3153of.jsonValue(jsonValue);
            jsonWriterM3153of.close();
            return buffer;
        } catch (Throwable th) {
            if (jsonWriterM3153of != null) {
                try {
                    jsonWriterM3153of.close();
                } catch (Throwable th2) {
    ...
    static final class JsonIterator implements Iterator<Object>, Cloneable {
        ...
        final Object[] f10549array;
        final JsonReader.Token endToken;
        int next;

        JsonIterator(JsonReader.Token token, Object[] objArr, int i) {
            this.endToken = token;
            this.f10549array = objArr;
            this.next = i;
        }

        @Override // java.util.Iterator
        public boolean hasNext() {
            return this.next < this.f10549array.length;
        }

        @Override // java.util.Iterator
        public Object next() {
            Object[] objArr = this.f10549array;
            int i = this.next;
            this.next = i + 1;
            return objArr[i];
        }
        ...
        public JsonIterator m26815clone() {
            return new JsonIterator(this.endToken, this.f10549array, this.next);
        }
    }
}

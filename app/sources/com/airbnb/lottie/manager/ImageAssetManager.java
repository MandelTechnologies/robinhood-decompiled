    ...
    public Bitmap bitmapForId(String str) {
        ...
        if (fileName.startsWith("data:") && fileName.indexOf("base64,") > 0) {
            try {
                ...
                return putBitmap(str, Utils.resizeBitmapIfNeeded(BitmapFactory.decodeByteArray(bArrDecode, 0, bArrDecode.length, options), lottieImageAsset.getWidth(), lottieImageAsset.getHeight()));

...
public class CompositionLayer extends BaseLayer {
        ...
        while (true) {
            ...
            if (baseLayerForModel != null) {
                ...
                if (baseLayer2 != null) {
                    ...
                    int i2 = C47871.$SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[layer2.getMatteType().ordinal()];
                    if (i2 == 1 || i2 == 2) {
    ...
    void drawLayer(Canvas canvas, Matrix matrix, int i) {
        if (C4754L.isTraceEnabled()) {
            C4754L.beginSection("CompositionLayer#draw");
        }
        ...
        canvas.restore();
        if (C4754L.isTraceEnabled()) {
            C4754L.endSection("CompositionLayer#draw");
        }
    }
    ...
    public void setProgress(float f) {
        if (C4754L.isTraceEnabled()) {
            C4754L.beginSection("CompositionLayer#setProgress");
        }
        this.progress = f;
        super.setProgress(f);
        ...
        if (C4754L.isTraceEnabled()) {
            C4754L.endSection("CompositionLayer#setProgress");
        }
    }

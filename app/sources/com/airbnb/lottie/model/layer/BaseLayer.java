...
public abstract class BaseLayer implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElement {
    ...
    static BaseLayer forModel(CompositionLayer compositionLayer, Layer layer, LottieDrawable lottieDrawable, LottieComposition lottieComposition) {
        switch (C47861.$SwitchMap$com$airbnb$lottie$model$layer$Layer$LayerType[layer.getLayerType().ordinal()]) {
            case 1:
    ...
    public void draw(Canvas canvas, Matrix matrix, int i) {
        ...
        Paint paint;
        Integer value;
        C4754L.beginSection(this.drawTraceName);
        if (!this.visible || this.layerModel.isHidden()) {
            C4754L.endSection(this.drawTraceName);
            return;
        }
        buildParentLayerListIfNeeded();
        if (C4754L.isTraceEnabled()) {
            C4754L.beginSection("Layer#parentMatrix");
        }
        this.matrix.reset();
        ...
        if (C4754L.isTraceEnabled()) {
            C4754L.endSection("Layer#parentMatrix");
        }
        ...
        if (!hasMatteOnThisLayer() && !hasMasksOnThisLayer() && getBlendMode() == LBlendMode.NORMAL) {
            ...
            if (C4754L.isTraceEnabled()) {
                C4754L.beginSection("Layer#drawLayer");
            }
            drawLayer(canvas, this.matrix, iIntValue);
            if (C4754L.isTraceEnabled()) {
                C4754L.endSection("Layer#drawLayer");
            }
            recordRenderTime(C4754L.endSection(this.drawTraceName));
            return;
        }
        if (C4754L.isTraceEnabled()) {
            C4754L.beginSection("Layer#computeBounds");
        }
        ...
        if (C4754L.isTraceEnabled()) {
            C4754L.endSection("Layer#computeBounds");
        }
        if (this.rect.width() < 1.0f || this.rect.height() < 1.0f) {
            canvas2 = canvas;
        } else {
            if (C4754L.isTraceEnabled()) {
                C4754L.beginSection("Layer#saveLayer");
            }
            ...
            if (C4754L.isTraceEnabled()) {
                C4754L.endSection("Layer#saveLayer");
            }
            ...
            if (hasMatteOnThisLayer()) {
                if (C4754L.isTraceEnabled()) {
                    C4754L.beginSection("Layer#drawMatte");
                    C4754L.beginSection("Layer#saveLayer");
                }
                ...
                if (C4754L.isTraceEnabled()) {
                    C4754L.beginSection("Layer#restoreLayer");
                }
                canvas2.restore();
                if (C4754L.isTraceEnabled()) {
                    C4754L.endSection("Layer#restoreLayer");
                    C4754L.endSection("Layer#drawMatte");
                }
            }
            if (C4754L.isTraceEnabled()) {
                C4754L.beginSection("Layer#restoreLayer");
    ...
    private void clearCanvas(Canvas canvas) {
        if (C4754L.isTraceEnabled()) {
            C4754L.beginSection("Layer#clearLayer");
        }
        RectF rectF = this.rect;
        canvas.drawRect(rectF.left - 1.0f, rectF.top - 1.0f, rectF.right + 1.0f, rectF.bottom + 1.0f, this.clearPaint);
        if (C4754L.isTraceEnabled()) {
            C4754L.endSection("Layer#clearLayer");
        }
    }
        ...
        if (hasMasksOnThisLayer()) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (value != null) {
                    ...
                    int i2 = C47861.$SwitchMap$com$airbnb$lottie$model$content$Mask$MaskMode[mask.getMaskMode().ordinal()];
                    if (i2 == 1 || i2 == 2) {
                        return;
                    }
    ...
    void setProgress(float f) {
        if (C4754L.isTraceEnabled()) {
            C4754L.beginSection("BaseLayer#setProgress");
            C4754L.beginSection("BaseLayer#setProgress.transform");
        }
        this.transform.setProgress(f);
        if (C4754L.isTraceEnabled()) {
            C4754L.endSection("BaseLayer#setProgress.transform");
        }
        if (this.mask != null) {
            if (C4754L.isTraceEnabled()) {
                C4754L.beginSection("BaseLayer#setProgress.mask");
            }
            for (int i = 0; i < this.mask.getMaskAnimations().size(); i++) {
                this.mask.getMaskAnimations().get(i).setProgress(f);
            }
            if (C4754L.isTraceEnabled()) {
                C4754L.endSection("BaseLayer#setProgress.mask");
            }
        }
        if (this.inOutAnimation != null) {
            if (C4754L.isTraceEnabled()) {
                C4754L.beginSection("BaseLayer#setProgress.inout");
            }
            this.inOutAnimation.setProgress(f);
            if (C4754L.isTraceEnabled()) {
                C4754L.endSection("BaseLayer#setProgress.inout");
            }
        }
        if (this.matteLayer != null) {
            if (C4754L.isTraceEnabled()) {
                C4754L.beginSection("BaseLayer#setProgress.matte");
            }
            this.matteLayer.setProgress(f);
            if (C4754L.isTraceEnabled()) {
                C4754L.endSection("BaseLayer#setProgress.matte");
            }
        }
        if (C4754L.isTraceEnabled()) {
            C4754L.beginSection("BaseLayer#setProgress.animations." + this.animations.size());
        }
        for (int i2 = 0; i2 < this.animations.size(); i2++) {
            this.animations.get(i2).setProgress(f);
        }
        if (C4754L.isTraceEnabled()) {
            C4754L.endSection("BaseLayer#setProgress.animations." + this.animations.size());
            C4754L.endSection("BaseLayer#setProgress");
        }
    }

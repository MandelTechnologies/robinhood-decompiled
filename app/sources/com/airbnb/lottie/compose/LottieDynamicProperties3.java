...
public final class LottieDynamicProperties3<T> {
    ...
    public LottieDynamicProperties3(T t, KeyPath keyPath, Function1<? super LottieFrameInfo<T>, ? extends T> callback) {
    ...
    public LottieDynamicProperties3(T t, KeyPath keyPath, final T t2) {

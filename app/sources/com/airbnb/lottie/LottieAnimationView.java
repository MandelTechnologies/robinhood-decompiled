...
public class LottieAnimationView extends AppCompatImageView {
    ...
    private void init(AttributeSet attributeSet, int i) {
        ...
        if (zHasValue) {
            ...
            String string3 = typedArrayObtainStyledAttributes.getString(R$styleable.LottieAnimationView_lottie_fileName);
            if (string3 != null) {
                setAnimation(string3);
            }
        } else if (zHasValue3 && (string2 = typedArrayObtainStyledAttributes.getString(R$styleable.LottieAnimationView_lottie_url)) != null) {
    ...
    public <T> void clearValueCallback(KeyPath keyPath, T t) {
        this.lottieDrawable.addValueCallback(keyPath, t, null);
    }
    ...
    public <T> void addValueCallback(KeyPath keyPath, T t, final SimpleLottieValueCallback<T> simpleLottieValueCallback) {
        this.lottieDrawable.addValueCallback(keyPath, t, new LottieValueCallback<T>() { // from class: com.airbnb.lottie.LottieAnimationView.1

...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public static /* synthetic */ void $r8$lambda$FrCfuTMBgjEG3fdle3MNkWCjUJw(LottieDrawable lottieDrawable, ValueAnimator valueAnimator) {
    ...
    public static /* synthetic */ void $r8$lambda$NiXdHPAU3gNSG_tlfqpm8p8_o1M(final LottieDrawable lottieDrawable) {
        CompositionLayer compositionLayer = lottieDrawable.compositionLayer;
        if (compositionLayer == null) {
            return;
        }
        try {
            ...
            if (invalidateSelfOnMainThread && lottieDrawable.isDirty) {
                if (lottieDrawable.mainThreadHandler == null) {
                    ...
                    lottieDrawable.invalidateSelfRunnable = new Runnable() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda17
                        @Override // java.lang.Runnable
                        public final void run() {
                            LottieDrawable.m9144$r8$lambda$qVOJAuCYN_sh5dMlsJC4mC_iE(this.f$0);
                        }
                    };
                }
    ...
    /* renamed from: $r8$lambda$qVOJAuCYN-_sh5dM-lsJC4mC_iE, reason: not valid java name */
    public static /* synthetic */ void m9144$r8$lambda$qVOJAuCYN_sh5dMlsJC4mC_iE(LottieDrawable lottieDrawable) {
    ...
    public LottieDrawable() {
        ...
        ValueAnimator.AnimatorUpdateListener animatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda5
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                LottieDrawable.$r8$lambda$FrCfuTMBgjEG3fdle3MNkWCjUJw(this.f$0, valueAnimator);
            }
        };
        ...
        this.updateProgressRunnable = new Runnable() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                LottieDrawable.$r8$lambda$NiXdHPAU3gNSG_tlfqpm8p8_o1M(this.f$0);
            }
        };
    ...
    public AsyncUpdates getAsyncUpdates() {
        ...
        return asyncUpdates != null ? asyncUpdates : C4754L.getDefaultAsyncUpdates();
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (asyncUpdatesEnabled) {
            try {
                ...
                if (C4754L.isTraceEnabled()) {
                    C4754L.endSection("Drawable#draw");
                }
                if (!asyncUpdatesEnabled) {
                    return;
                }
        ...
        if (C4754L.isTraceEnabled()) {
            C4754L.beginSection("Drawable#draw");
        }
    ...
    public void setMinAndMaxFrame(final String str) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda0
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    this.f$0.setMinAndMaxFrame(str);
                }
            });
            return;
        }
    ...
    public void setProgress(final float f) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda9
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    this.f$0.setProgress(f);
                }
            });
            return;
        }
        if (C4754L.isTraceEnabled()) {
            C4754L.beginSection("Drawable#setProgress");
        }
        this.animator.setFrame(this.composition.getFrameForProgress(f));
        if (C4754L.isTraceEnabled()) {
            C4754L.endSection("Drawable#setProgress");
        }
    }
    ...
    private boolean animationsEnabled() {
        ...
        return this.systemAnimationsEnabled && C4754L.getReducedMotionOption().getCurrentReducedMotionMode(getContext()) == ReducedMotionMode.STANDARD_MOTION;
    }
    ...
    public <T> void addValueCallback(final KeyPath keyPath, final T t, final LottieValueCallback<T> lottieValueCallback) {
        ...
        if (compositionLayer == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda15
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    this.f$0.addValueCallback(keyPath, t, lottieValueCallback);
                }
            });
            return;
        }

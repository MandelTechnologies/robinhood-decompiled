...
public class AnimatableTransformParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m768of(Constants.RequestParamsKeys.DEVELOPER_API_KEY, Constants.RequestParamsKeys.PLATFORM_KEY, Constants.RequestParamsKeys.SESSION_ID_KEY, "rz", Constants.REVENUE_AMOUNT_KEY, "o", "so", "eo", "sk", "sa");
    private static final JsonReader.Options ANIMATABLE_NAMES = JsonReader.Options.m768of(Constants.RequestParamsKeys.IDENTIFIER_KEYSPACE_KEY);
            ...
            switch (jsonReader.selectName(NAMES)) {
                ...
                case 3:
                    ...
                    if (!animatableFloatValue.getKeyframes().isEmpty()) {
                        animatableFloatValue.getKeyframes().add(new Keyframe(lottieComposition2, fValueOf, fValueOf, null, 0.0f, Float.valueOf(lottieComposition2.getEndFrame())));

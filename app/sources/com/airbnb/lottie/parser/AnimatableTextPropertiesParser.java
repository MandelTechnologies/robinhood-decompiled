...
public class AnimatableTextPropertiesParser {
    private static final JsonReader.Options PROPERTIES_NAMES = JsonReader.Options.m768of(Constants.RequestParamsKeys.SESSION_ID_KEY, Constants.RequestParamsKeys.DEVELOPER_API_KEY);
    private static final JsonReader.Options ANIMATABLE_RANGE_PROPERTIES_NAMES = JsonReader.Options.m768of(Constants.RequestParamsKeys.SESSION_ID_KEY, Constants.RequestBody.EXTRA_ATTRIBUTES_KEY, "o", Constants.REVENUE_AMOUNT_KEY);
    private static final JsonReader.Options ANIMATABLE_PROPERTIES_NAMES = JsonReader.Options.m768of("fc", "sc", "sw", "t", "o");

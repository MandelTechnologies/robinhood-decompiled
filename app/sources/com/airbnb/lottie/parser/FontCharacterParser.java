...
class FontCharacterParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m768of("ch", "size", "w", ResourceTypes.STYLE, "fFamily", WebsocketGatewayConstants.DATA_KEY);
    private static final JsonReader.Options DATA_NAMES = JsonReader.Options.m768of("shapes");

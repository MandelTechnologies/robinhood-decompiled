...
public class WebSocketFrame {
    ...
    public int getCloseCode() {
        ...
        if (bArr == null || bArr.length < 2) {
            return ErrorCodes.SOCKET_TIMEOUT_EXCEPTION;
        }
    ...
    public String toString() {
        ...
        sb.append(this.mFin ? Constants.SdidMigrationStatusCodes.ALREADY_SDID : "0");
        sb.append(",RSV1=");
        sb.append(this.mRsv1 ? Constants.SdidMigrationStatusCodes.ALREADY_SDID : "0");
        sb.append(",RSV2=");
        sb.append(this.mRsv2 ? Constants.SdidMigrationStatusCodes.ALREADY_SDID : "0");
        sb.append(",RSV3=");
        sb.append(this.mRsv3 ? Constants.SdidMigrationStatusCodes.ALREADY_SDID : "0");
        sb.append(",Opcode=");

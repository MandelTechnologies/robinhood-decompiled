...
class SocketConnector {
    ...
    private void connectSocket() throws WebSocketException {
        try {
            ...
            throw new WebSocketException(WebSocketError.SOCKET_CONNECT_ERROR, String.format("Failed to connect to %s'%s': %s", this.mProxyHandshaker != null ? "the proxy " : "", this.mAddress, e.getMessage()), e);
        }
    }
    ...
    private InetAddress[] resolveHostname() throws WebSocketException, UnknownHostException {
        ...
        try {
            ...
            try {
                Arrays.sort(allByName, new Comparator<InetAddress>() { // from class: com.neovisionaries.ws.client.SocketConnector.1

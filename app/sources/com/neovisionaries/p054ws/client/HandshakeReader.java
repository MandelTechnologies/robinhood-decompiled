...
class HandshakeReader {
        ...
        while (true) {
            try {
                ...
                if (cCharAt != ' ' && cCharAt != '\t') {
                    ...
                    sb.append(line.replaceAll("^[ \t]+", PlaceholderUtils.XXShortPlaceholderText));
                }
            } catch (IOException e) {
    ...
    private void validateAccept(StatusLine statusLine, Map<String, List<String>> map, String str) throws WebSocketException {
        ...
        try {
            if (!Base64.encode(MessageDigest.getInstance(McElieceCCA2KeyGenParameterSpec.SHA1).digest(Misc.getBytesUTF8(str + "258EAFA5-E914-47DA-95CA-C5AB0DC85B11"))).equals(list.get(0))) {

...
public final class ShippingMethodView extends RelativeLayout {
    ...
    public final void setShippingMethod(ShippingMethod shippingMethod) {
        ...
        String string2 = getContext().getString(R$string.stripe_price_free);
        Intrinsics.checkNotNullExpressionValue(string2, "getString(...)");
        textView.setText(PaymentUtils.formatPriceStringUsingFree(amount, currency, string2));
    }
}

...
public final class GooglePayJsonFactory_Factory implements Factory<GooglePayJsonFactory> {
    ...
    public GooglePayJsonFactory_Factory(Provider<Function0<String>> provider, Provider<Function0<String>> provider2, Provider<Config> provider3) {
    ...
    public static GooglePayJsonFactory_Factory create(Provider<Function0<String>> provider, Provider<Function0<String>> provider2, Provider<Config> provider3) {
        return new GooglePayJsonFactory_Factory(provider, provider2, provider3);
    }

    public static GooglePayJsonFactory newInstance(Function0<String> function0, Function0<String> function02, Config config) {

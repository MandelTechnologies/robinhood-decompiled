...
public final /* data */ class ActionButtonComponent implements UiComponent2 {
    ...
    public static final class Creator implements Parcelable.Creator<ActionButtonComponent> {
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final ActionButtonComponent createFromParcel(Parcel parcel) {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final ActionButtonComponent[] newArray(int i) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ActionButtonComponent)) {
            return false;
        }
        ActionButtonComponent actionButtonComponent = (ActionButtonComponent) other;
    ...
    public String toString() {
        return "ActionButtonComponent(name=" + this.name + ", hidden=" + this.hidden + ", disabled=" + this.disabled + ", autoSubmitCountdownText=" + this.autoSubmitCountdownText + ", autoSubmitIntervalSeconds=" + this.autoSubmitIntervalSeconds + ")";
    }
    ...
    public ActionButtonComponent(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str, Integer num) {
    ...
    public ActionButtonComponent(ActionButton config) {

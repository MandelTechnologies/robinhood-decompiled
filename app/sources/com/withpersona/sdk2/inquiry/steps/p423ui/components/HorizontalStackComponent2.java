...
import com.withpersona.sdk2.inquiry.steps.p423ui.databinding.Pi2UiHorizontalStackBinding;
...
@Metadata(m3635d1 = {"\u0000(\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u001a6\u0010\u0000\u001a\u00020\u0001*\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u00062\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\t0\u00062\u0006\u0010\n\u001a\u00020\u000b¨\u0006\f"}, m3636d2 = {"makeView", "Landroidx/constraintlayout/widget/ConstraintLayout;", "Lcom/withpersona/sdk2/inquiry/steps/ui/components/HorizontalStackComponent;", "uiComponentHelper", "Lcom/withpersona/sdk2/inquiry/steps/ui/components/UiComponentHelper;", "componentViews", "", "Lcom/withpersona/sdk2/inquiry/steps/ui/ComponentView;", "children", "Landroid/view/View;", "config", "Lcom/withpersona/sdk2/inquiry/network/dto/ui/components/HorizontalStack;", "ui-step-renderer_release"}, m3637k = 2, m3638mv = {2, 0, 0}, m3640xi = 48)
@SourceDebugExtension
/* renamed from: com.withpersona.sdk2.inquiry.steps.ui.components.HorizontalStackComponentKt, reason: use source file name */
/* loaded from: classes18.dex */
public final class HorizontalStackComponent2 {
    public static final ConstraintLayout makeView(HorizontalStackComponent horizontalStackComponent, UiComponentHelper uiComponentHelper, List<ComponentView> componentViews, List<? extends View> children, HorizontalStack config) {
        ...
        final Pi2UiHorizontalStackBinding pi2UiHorizontalStackBindingInflate = Pi2UiHorizontalStackBinding.inflate(uiComponentHelper.getLayoutInflater());
        ConstraintSet constraintSet = new ConstraintSet();
        constraintSet.clone(pi2UiHorizontalStackBindingInflate.getRoot());
        List<? extends View> list = children;
        ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(list, 10));
        for (View view : list) {
            view.setId(View.generateViewId());
            view.setSaveEnabled(false);
            pi2UiHorizontalStackBindingInflate.getRoot().addView(view);
        ...
        if (axisValue == StyleElements.Axis.HORIZONTAL) {
            ConstraintLayout root = pi2UiHorizontalStackBindingInflate.getRoot();
            ...
            ConstraintLayout root2 = pi2UiHorizontalStackBindingInflate.getRoot();
        ...
        if (styles != null) {
            uiComponentHelper.registerOnLayoutListener(new Function0() { // from class: com.withpersona.sdk2.inquiry.steps.ui.components.HorizontalStackComponentKt$$ExternalSyntheticLambda0
                ...
                public final Object invoke() {
                    return HorizontalStackComponent2.makeView$lambda$3$lambda$2(pi2UiHorizontalStackBindingInflate, styles);
                }
            });
        }
        constraintSet.applyTo(pi2UiHorizontalStackBindingInflate.getRoot());
        ConstraintLayout root3 = pi2UiHorizontalStackBindingInflate.getRoot();
    ...
    public static final Unit makeView$lambda$3$lambda$2(Pi2UiHorizontalStackBinding pi2UiHorizontalStackBinding, HorizontalStack.HorizontalStackComponentStyle horizontalStackComponentStyle) {
        ...
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        StackStyling2.applyBaseStackStyles(root, horizontalStackComponentStyle);

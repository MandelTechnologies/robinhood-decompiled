...
public final /* data */ class InputMultiSelectComponent implements UiComponent, MultiTextValueComponent<InputMultiSelectComponent>, InputSelectBoxComponent, UiComponentAttributes2, UiComponentAttributes3 {
    ...
    public static final class Creator implements Parcelable.Creator<InputMultiSelectComponent> {
        ...
        public final InputMultiSelectComponent createFromParcel(Parcel parcel) {
            ...
            return new InputMultiSelectComponent(string2, inputSelectComponentStyle, arrayList, jsonLogicBoolean, jsonLogicBoolean2, string3, string4, arrayList2);
        }
    ...
    public static /* synthetic */ InputMultiSelectComponent copy$default(InputMultiSelectComponent inputMultiSelectComponent, String str, InputSelectComponentStyle inputSelectComponentStyle, List list, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str2, String str3, List list2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        String str5 = str2;
        return inputMultiSelectComponent.copy(str, inputSelectComponentStyle, list, jsonLogicBoolean, jsonLogicBoolean3, str5, str4, list3);
    }

    public final InputMultiSelectComponent copy(String name, InputSelectComponentStyle styles, List<Option> selectedOptions, JsonLogicBoolean hidden, JsonLogicBoolean disabled, String label, String placeholder, List<Option> options) {
    ...
    /* compiled from: InputMultiSelectComponent.kt */
    @Metadata(m3635d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007¨\u0006\b"}, m3636d2 = {"Lcom/withpersona/sdk2/inquiry/steps/ui/components/InputMultiSelectComponent$Companion;", "", "<init>", "()V", "from", "Lcom/withpersona/sdk2/inquiry/steps/ui/components/InputMultiSelectComponent;", "config", "Lcom/withpersona/sdk2/inquiry/network/dto/ui/components/InputMultiSelect;", "ui-step-renderer_release"}, m3637k = 1, m3638mv = {2, 0, 0}, m3640xi = 48)
    ...
    public static final class Companion {
        ...
        public final InputMultiSelectComponent from(InputMultiSelect config) {
            Set setEmptySet;
            List listEmptyList;
            List listEmptyList2;
            ...
            if (attributes2 == null || (prefill = attributes2.getPrefill()) == null || (setEmptySet = CollectionsKt.toSet(prefill)) == null) {
            ...
            if (options2 == null) {
                ...
                for (Object obj : options2) {
                    if (setEmptySet.contains(((InputGroup3) obj).getValue())) {
                        arrayList.add(obj);
                    }
                }
            ...
            return new InputMultiSelectComponent(name, styles, list, hidden, disabled, label, placeholder, listEmptyList2);
        }
    }
    ...
    @Override // com.withpersona.sdk2.inquiry.steps.p423ui.components.MultiTextValueComponent
    public InputMultiSelectComponent update(List<Option> selectedOptions) {
        Intrinsics.checkNotNullParameter(selectedOptions, "selectedOptions");
        InputMultiSelectComponent inputMultiSelectComponentCopy$default = copy$default(this, null, null, selectedOptions, null, null, null, null, null, EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_OVERLAY_SECOND_DEPOSIT_VALUE, null);
        inputMultiSelectComponentCopy$default.setSelectedOptionsController(getSelectedOptionsController());
        return inputMultiSelectComponentCopy$default;
    }
}

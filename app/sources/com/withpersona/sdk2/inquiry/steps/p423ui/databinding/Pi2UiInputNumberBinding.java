...
public final class Pi2UiInputNumberBinding implements ViewBinding {
    ...
    private Pi2UiInputNumberBinding(TextInputLayout textInputLayout, TextInputEditText textInputEditText, TextInputLayout textInputLayout2) {
    ...
    public static Pi2UiInputNumberBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R$layout.pi2_ui_input_number, viewGroup, false);
        if (z) {
    ...
    public static Pi2UiInputNumberBinding bind(View view) {

...
public final /* data */ class CombinedStepButtonComponent implements UiComponent2 {
    ...
    public static final class Creator implements Parcelable.Creator<CombinedStepButtonComponent> {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final CombinedStepButtonComponent[] newArray(int i) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CombinedStepButtonComponent)) {
            return false;
        }
        CombinedStepButtonComponent combinedStepButtonComponent = (CombinedStepButtonComponent) other;
    ...
    public String toString() {
        return "CombinedStepButtonComponent(name=" + this.name + ", hidden=" + this.hidden + ", disabled=" + this.disabled + ", autoSubmitCountdownText=" + this.autoSubmitCountdownText + ", autoSubmitIntervalSeconds=" + this.autoSubmitIntervalSeconds + ")";
    }
    ...
    public CombinedStepButtonComponent(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str, Integer num) {
    ...
    public CombinedStepButtonComponent(CombinedStepButton config) {

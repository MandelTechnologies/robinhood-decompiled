...
public final /* data */ class RemoteImageComponent implements UiComponent, UiComponentAttributes3 {
    ...
    public static final class Creator implements Parcelable.Creator<RemoteImageComponent> {
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final RemoteImageComponent createFromParcel(Parcel parcel) {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final RemoteImageComponent[] newArray(int i) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof RemoteImageComponent)) {
            return false;
        }
        RemoteImageComponent remoteImageComponent = (RemoteImageComponent) other;
    ...
    public RemoteImageComponent(String name, JsonLogicBoolean jsonLogicBoolean) {
    ...
    public RemoteImageComponent(RemoteImage config) {
        Intrinsics.checkNotNullParameter(config, "config");
        String name = config.getName();
        RemoteImage.Attributes attributes = config.getAttributes();

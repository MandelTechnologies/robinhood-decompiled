...
public final /* data */ class CompleteButtonComponent implements UiComponent2 {
    ...
    public static final class Creator implements Parcelable.Creator<CompleteButtonComponent> {
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final CompleteButtonComponent createFromParcel(Parcel parcel) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CompleteButtonComponent)) {
            return false;
        }
        CompleteButtonComponent completeButtonComponent = (CompleteButtonComponent) other;
    ...
    public String toString() {
        return "CompleteButtonComponent(name=" + this.name + ", hidden=" + this.hidden + ", disabled=" + this.disabled + ", autoSubmitCountdownText=" + this.autoSubmitCountdownText + ", autoSubmitIntervalSeconds=" + this.autoSubmitIntervalSeconds + ")";
    }
    ...
    public CompleteButtonComponent(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str, Integer num) {
    ...
    public CompleteButtonComponent(CompleteButton config) {

...
public final /* data */ class InputTextAreaComponent implements UiComponent, SingleTextValueComponent<InputTextAreaComponent>, UiComponentAttributes2, UiComponentAttributes3 {
    ...
    public static /* synthetic */ InputTextAreaComponent copy$default(InputTextAreaComponent inputTextAreaComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return inputTextAreaComponent.copy(str, str2, jsonLogicBoolean3, jsonLogicBoolean2, textBasedComponentStyle2);
    }
    ...
    public final InputTextAreaComponent copy(String name, String value, JsonLogicBoolean hidden, JsonLogicBoolean disabled, TextBasedComponentStyle errorTextStyle) {
    ...
    public InputTextAreaComponent update(String newString) {
        ...
        InputTextAreaComponent inputTextAreaComponentCopy$default = copy$default(this, null, newString, null, null, null, 29, null);
        inputTextAreaComponentCopy$default.setTextController(getTextController());
        return inputTextAreaComponentCopy$default;
    }
}

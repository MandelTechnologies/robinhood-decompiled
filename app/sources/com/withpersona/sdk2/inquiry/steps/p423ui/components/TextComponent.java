...
public final /* data */ class TextComponent implements UiComponent, UiComponentAttributes2, UiComponentAttributes3 {
    ...
    public TextComponent(String name, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2) {
    ...
    public TextComponent(Text config) {
        ...
        Text.Attributes attributes2 = config.getAttributes();

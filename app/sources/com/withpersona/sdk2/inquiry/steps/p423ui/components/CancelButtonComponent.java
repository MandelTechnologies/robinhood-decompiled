...
public final /* data */ class CancelButtonComponent implements UiComponent2 {
    ...
    public static final class Creator implements Parcelable.Creator<CancelButtonComponent> {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final CancelButtonComponent[] newArray(int i) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.name, cancelButtonComponent.name) && Intrinsics.areEqual(this.hidden, cancelButtonComponent.hidden) && Intrinsics.areEqual(this.disabled, cancelButtonComponent.disabled) && Intrinsics.areEqual(this.autoSubmitCountdownText, cancelButtonComponent.autoSubmitCountdownText) && Intrinsics.areEqual(this.autoSubmitIntervalSeconds, cancelButtonComponent.autoSubmitIntervalSeconds);
    }

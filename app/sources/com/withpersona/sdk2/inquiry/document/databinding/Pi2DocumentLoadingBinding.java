...
public final class Pi2DocumentLoadingBinding implements ViewBinding {
    ...
    private Pi2DocumentLoadingBinding(ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, TextView textView, ConstraintLayout constraintLayout3, Pi2NavigationBar pi2NavigationBar, ThemeableLottieAnimationView themeableLottieAnimationView, TextView textView2) {
    ...
    public static Pi2DocumentLoadingBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R$layout.pi2_document_loading, viewGroup, false);
        if (z) {
    ...
    public static Pi2DocumentLoadingBinding bind(View view) {
                ...
                if (constraintLayout2 != null) {
                    ...
                    if (pi2NavigationBar != null) {
                        ...
                        if (themeableLottieAnimationView != null) {
                            ...
                            if (textView2 != null) {
                                return new Pi2DocumentLoadingBinding((ConstraintLayout) view, constraintLayout, textView, constraintLayout2, pi2NavigationBar, themeableLottieAnimationView, textView2);
                            }
                        }
                    }
                }

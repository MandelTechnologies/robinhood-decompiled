...
@Metadata(m3635d1 = {"\u0000R\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\b\u0000\u0018\u0000 \u001b2\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0001\u001bB\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\u0018\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\u00022\u0006\u0010\f\u001a\u00020\rH\u0016J \u0010\u000e\u001a\u00020\n2\u0006\u0010\u000f\u001a\u00020\u00102\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u0011\u001a\u00020\u0012H\u0002J*\u0010\u0013\u001a\u00020\u0014*\u00020\u00152\b\b\u0001\u0010\u0016\u001a\u00020\u00142\b\b\u0002\u0010\u0017\u001a\u00020\u00182\b\b\u0002\u0010\u0019\u001a\u00020\u001aH\u0003R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0007\u001a\u0004\u0018\u00010\bX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u001c"}, m3636d2 = {"Lcom/withpersona/sdk2/inquiry/governmentid/GovernmentIdSubmittingRunner;", "Lcom/squareup/workflow1/ui/LayoutRunner;", "Lcom/withpersona/sdk2/inquiry/governmentid/Screen$SubmittingScreen;", "binding", "Lcom/withpersona/sdk2/inquiry/governmentid/databinding/Pi2GovernmentidSubmittingScreenBinding;", "<init>", "(Lcom/withpersona/sdk2/inquiry/governmentid/databinding/Pi2GovernmentidSubmittingScreenBinding;)V", "currentLoadingAssetView", "Landroid/view/View;", "showRendering", "", "rendering", "viewEnvironment", "Lcom/squareup/workflow1/ui/ViewEnvironment;", "applyStyles", "styles", "Lcom/withpersona/sdk2/inquiry/network/dto/ui/styling/StepStyles$GovernmentIdStepStyle;", "textPosition", "Lcom/withpersona/sdk2/inquiry/network/dto/PendingPageTextPosition;", "getColorFromAttr", "", "Landroid/content/Context;", "attrColor", "typedValue", "Landroid/util/TypedValue;", "resolveRefs", "", "Companion", "government-id_release"}, m3637k = 1, m3638mv = {2, 0, 0}, m3640xi = 48)
/* loaded from: classes18.dex */
public final class GovernmentIdSubmittingRunner implements LayoutRunner<GovernmentIdScreen2.SubmittingScreen> {

    /* renamed from: Companion, reason: from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);
    private final Pi2GovernmentidSubmittingScreenBinding binding;
    ...
    public GovernmentIdSubmittingRunner(final Pi2GovernmentidSubmittingScreenBinding binding) {
        ...
        if (numResourceIdFromAttr$default != null) {
            ...
            binding.pendingAnimation.addValueCallback(new KeyPath("scanner", "**"), (KeyPath) LottieProperty.COLOR, (SimpleLottieValueCallback<KeyPath>) new SimpleLottieValueCallback() { // from class: com.withpersona.sdk2.inquiry.governmentid.GovernmentIdSubmittingRunner$$ExternalSyntheticLambda2
                @Override // com.airbnb.lottie.value.SimpleLottieValueCallback
                public final Object getValue(LottieFrameInfo lottieFrameInfo) {
                    return GovernmentIdSubmittingRunner.$r8$lambda$QUhXxdAghrzkU0MJ_kl_3aUubrc(this.f$0, binding, lottieFrameInfo);
                }
            });
        }
    ...
    public static Integer $r8$lambda$QUhXxdAghrzkU0MJ_kl_3aUubrc(GovernmentIdSubmittingRunner governmentIdSubmittingRunner, Pi2GovernmentidSubmittingScreenBinding pi2GovernmentidSubmittingScreenBinding, LottieFrameInfo lottieFrameInfo) {
        Context context = pi2GovernmentidSubmittingScreenBinding.getRoot().getContext();
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        return Integer.valueOf(getColorFromAttr$default(governmentIdSubmittingRunner, context, androidx.appcompat.R$attr.colorPrimary, null, false, 6, null));
    }

    @Override // com.squareup.workflow1.p415ui.LayoutRunner
    public void showRendering(final GovernmentIdScreen2.SubmittingScreen rendering, ViewEnvironment viewEnvironment) throws IllegalArgumentException {
        ...
        Function0 function0 = new Function0() { // from class: com.withpersona.sdk2.inquiry.governmentid.GovernmentIdSubmittingRunner$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return GovernmentIdSubmittingRunner.showRendering$lambda$5$lambda$2(rendering);
            }
        };
        Function0 function02 = new Function0() { // from class: com.withpersona.sdk2.inquiry.governmentid.GovernmentIdSubmittingRunner$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return GovernmentIdSubmittingRunner.showRendering$lambda$5$lambda$3(rendering);
            }
        };
        Pi2NavigationBar navigationBar = pi2GovernmentidSubmittingScreenBinding.navigationBar;
        Intrinsics.checkNotNullExpressionValue(navigationBar, "navigationBar");
        ConstraintLayout root = pi2GovernmentidSubmittingScreenBinding.getRoot();
        Intrinsics.checkNotNullExpressionValue(root, "getRoot(...)");
        ...
        if (rendering.getTitle().length() == 0) {
            pi2GovernmentidSubmittingScreenBinding.title.setVisibility(8);
        } else {
            pi2GovernmentidSubmittingScreenBinding.title.setText(rendering.getTitle());
            TextView title = pi2GovernmentidSubmittingScreenBinding.title;
            Intrinsics.checkNotNullExpressionValue(title, "title");
            ViewUtils3.setAccessibilityFocus(title);
        }
        if (rendering.getDescription().length() == 0) {
            pi2GovernmentidSubmittingScreenBinding.body.setVisibility(8);
        } else {
            pi2GovernmentidSubmittingScreenBinding.body.setText(rendering.getDescription());
        }
        ...
        if (loadingPictograph != null && this.currentLoadingAssetView == null) {
            ConstraintLayout animationContainer = this.binding.animationContainer;
            ...
            pi2GovernmentidSubmittingScreenBinding.pendingAnimation.setVisibility(8);
        }
    ...
    public static final Unit showRendering$lambda$5$lambda$2(GovernmentIdScreen2.SubmittingScreen submittingScreen) {
        submittingScreen.getOnBack().invoke();
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit showRendering$lambda$5$lambda$3(GovernmentIdScreen2.SubmittingScreen submittingScreen) {
        submittingScreen.getOnCancel().invoke();
        return Unit.INSTANCE;
    }

    private final void applyStyles(StepStyles.GovernmentIdStepStyle styles, ViewEnvironment viewEnvironment, PendingPageTextPosition textPosition) throws IllegalArgumentException {
        int[] iArr;
        float f;
    ...
    public static final class Companion implements ViewFactory<GovernmentIdScreen2.SubmittingScreen> {
        ...
        public View buildView(GovernmentIdScreen2.SubmittingScreen initialRendering, ViewEnvironment initialViewEnvironment, Context contextForNewView, ViewGroup container) {
        ...
        @Override // com.squareup.workflow1.p415ui.ViewFactory
        public KClass<? super GovernmentIdScreen2.SubmittingScreen> getType() {
            return this.$$delegate_0.getType();
        }

        /* compiled from: GovernmentIdSubmittingRunner.kt */
        @Metadata(m3637k = 3, m3638mv = {2, 0, 0}, m3640xi = 48)
        /* renamed from: com.withpersona.sdk2.inquiry.governmentid.GovernmentIdSubmittingRunner$Companion$1 */
        /* synthetic */ class C435891 extends FunctionReferenceImpl implements Function3<LayoutInflater, ViewGroup, Boolean, Pi2GovernmentidSubmittingScreenBinding> {
            public static final C435891 INSTANCE = new C435891();
            ...
            public final Pi2GovernmentidSubmittingScreenBinding invoke(LayoutInflater p0, ViewGroup viewGroup, boolean z) {
                Intrinsics.checkNotNullParameter(p0, "p0");
                return Pi2GovernmentidSubmittingScreenBinding.inflate(p0, viewGroup, z);
            }

            @Override // kotlin.jvm.functions.Function3
            public /* bridge */ /* synthetic */ Pi2GovernmentidSubmittingScreenBinding invoke(LayoutInflater layoutInflater, ViewGroup viewGroup, Boolean bool) {
        ...
        private Companion() {
            ...
            this.$$delegate_0 = new ViewBindingViewFactory(Reflection.getOrCreateKotlinClass(GovernmentIdScreen2.SubmittingScreen.class), C435891.INSTANCE, C435902.INSTANCE);
        }

        /* compiled from: GovernmentIdSubmittingRunner.kt */
        @Metadata(m3637k = 3, m3638mv = {2, 0, 0}, m3640xi = 48)
        /* renamed from: com.withpersona.sdk2.inquiry.governmentid.GovernmentIdSubmittingRunner$Companion$2 */
        /* synthetic */ class C435902 extends FunctionReferenceImpl implements Function1<Pi2GovernmentidSubmittingScreenBinding, GovernmentIdSubmittingRunner> {
            public static final C435902 INSTANCE = new C435902();
            ...
            public final GovernmentIdSubmittingRunner invoke(Pi2GovernmentidSubmittingScreenBinding p0) {
                Intrinsics.checkNotNullParameter(p0, "p0");

...
public final class Pi2SelfieSubmittingScreenBinding implements ViewBinding {
    ...
    private Pi2SelfieSubmittingScreenBinding(ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, TextView textView, ConstraintLayout constraintLayout3, Pi2NavigationBar pi2NavigationBar, ThemeableLottieAnimationView themeableLottieAnimationView, TextView textView2) {
    ...
    public static Pi2SelfieSubmittingScreenBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R$layout.pi2_selfie_submitting_screen, viewGroup, false);
        if (z) {
    ...
    public static Pi2SelfieSubmittingScreenBinding bind(View view) {
                ...
                if (constraintLayout2 != null) {
                    ...
                    if (pi2NavigationBar != null) {
                        ...
                        if (themeableLottieAnimationView != null) {
                            ...
                            if (textView2 != null) {
                                return new Pi2SelfieSubmittingScreenBinding((ConstraintLayout) view, constraintLayout, textView, constraintLayout2, pi2NavigationBar, themeableLottieAnimationView, textView2);
                            }
                        }
                    }
                }

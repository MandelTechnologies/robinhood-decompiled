...
import com.withpersona.sdk2.inquiry.network.dto.p421ui.styling.ButtonComponentStyling2;
...
public final class ActionButton implements Button {
    ...
    public static final String f10629type = "button_action";
    private final BaseButtonAttributes2 attributes;
    private final String name;
    private final ButtonComponentStyling2 styles;
    ...
    public static final class Creator implements Parcelable.Creator<ActionButton> {
        ...
        public final ActionButton createFromParcel(Parcel parcel) {
            ...
            return new ActionButton(parcel.readString(), parcel.readInt() == 0 ? null : BaseButtonAttributes2.CREATOR.createFromParcel(parcel), parcel.readInt() != 0 ? ButtonComponentStyling2.CREATOR.createFromParcel(parcel) : null);
        }
    ...
    public final void writeToParcel(Parcel dest, int flags) {
        ...
        ButtonComponentStyling2 buttonComponentStyling2 = this.styles;
        if (buttonComponentStyling2 == null) {
            dest.writeInt(0);
        } else {
            dest.writeInt(1);
            buttonComponentStyling2.writeToParcel(dest, flags);
        }
    }

    public ActionButton(String name, BaseButtonAttributes2 baseButtonAttributes2, ButtonComponentStyling2 buttonComponentStyling2) {
        Intrinsics.checkNotNullParameter(name, "name");
        this.name = name;
        this.attributes = baseButtonAttributes2;
        this.styles = buttonComponentStyling2;
    }
    ...
    public ButtonComponentStyling2 getStyles() {
        return this.styles;
    }
}

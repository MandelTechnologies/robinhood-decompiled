...
public final class CombinedStepButton implements Button {
    ...
    public static final String f10632type = "combined_step/button";
    private final BaseButtonAttributes2 attributes;
    private final String name;
    private final ButtonComponentStyling4 styles;
    ...
    public static final class Creator implements Parcelable.Creator<CombinedStepButton> {
        ...
        public final CombinedStepButton createFromParcel(Parcel parcel) {
            ...
            return new CombinedStepButton(parcel.readString(), parcel.readInt() == 0 ? null : BaseButtonAttributes2.CREATOR.createFromParcel(parcel), parcel.readInt() != 0 ? ButtonComponentStyling4.CREATOR.createFromParcel(parcel) : null);
        }
    ...
    public final void writeToParcel(Parcel dest, int flags) {
        ...
        ButtonComponentStyling4 buttonComponentStyling4 = this.styles;
        if (buttonComponentStyling4 == null) {
            dest.writeInt(0);
        } else {
            dest.writeInt(1);
            buttonComponentStyling4.writeToParcel(dest, flags);
        }
    }

    public CombinedStepButton(String name, BaseButtonAttributes2 baseButtonAttributes2, ButtonComponentStyling4 buttonComponentStyling4) {
        Intrinsics.checkNotNullParameter(name, "name");
        this.name = name;
        this.attributes = baseButtonAttributes2;
        this.styles = buttonComponentStyling4;
    }

    public /* synthetic */ CombinedStepButton(String str, BaseButtonAttributes2 baseButtonAttributes2, ButtonComponentStyling4 buttonComponentStyling4, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, baseButtonAttributes2, (i & 4) != 0 ? null : buttonComponentStyling4);
    }
    ...
    public ButtonComponentStyling4 getStyles() {
        return this.styles;
    }
}

...
/* compiled from: InputMultiSelect.kt */
...
public final class InputMultiSelect implements UiComponentConfig {
    ...
    public static final String f10648type = "input_multi_select";
    ...
    public static final class Attributes implements UiComponentAttributes {
        ...
        private final List<InputGroup3> options;
        ...
        public static final class Creator implements Parcelable.Creator<Attributes> {
            ...
            public final Attributes createFromParcel(Parcel parcel) {
                ...
                for (int i2 = 0; i2 != i; i2++) {
                    arrayList.add(InputGroup3.CREATOR.createFromParcel(parcel));
                }
                return new Attributes(arrayListCreateStringArrayList, string2, string3, arrayList, parcel.readInt() == 0 ? null : JsonLogicBoolean.CREATOR.createFromParcel(parcel), parcel.readInt() != 0 ? JsonLogicBoolean.CREATOR.createFromParcel(parcel) : null);
            }
        ...
        public final void writeToParcel(Parcel dest, int flags) {
            ...
            List<InputGroup3> list = this.options;
            dest.writeInt(list.size());
            Iterator<InputGroup3> it = list.iterator();
            while (it.hasNext()) {
        ...
        public Attributes(List<String> list, String str, String str2, List<InputGroup3> options, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2) {
        ...
        public final List<InputGroup3> getOptions() {
            return this.options;
        }

...
public final class ButtonComponentStyling8 implements Parcelable, ButtonComponentStyling {
    ...
    public ButtonComponentStyling8(AttributeStyles.ButtonBasedPaddingStyle buttonBasedPaddingStyle, AttributeStyles.ButtonBasedMarginStyle buttonBasedMarginStyle, AttributeStyles.ButtonBasedJustifyStyle buttonBasedJustifyStyle, AttributeStyles.ButtonBasedFontFamilyStyle buttonBasedFontFamilyStyle, AttributeStyles.ButtonBasedFontSizeStyle buttonBasedFontSizeStyle, AttributeStyles.ButtonBasedFontWeightStyle buttonBasedFontWeightStyle, AttributeStyles.ButtonBasedLetterSpacingStyle buttonBasedLetterSpacingStyle, AttributeStyles.ButtonBasedLineHeightStyle buttonBasedLineHeightStyle, AttributeStyles.ButtonBasedTextColorStyle buttonBasedTextColorStyle, AttributeStyles.ButtonBasedHeightStyle buttonBasedHeightStyle, AttributeStyles.ButtonBasedWidthStyle buttonBasedWidthStyle, AttributeStyles.ButtonBasedBackgroundColorStyle buttonBasedBackgroundColorStyle, AttributeStyles.ButtonBasedBorderColorStyle buttonBasedBorderColorStyle, AttributeStyles.ButtonBasedBorderRadiusStyle buttonBasedBorderRadiusStyle, AttributeStyles.ButtonBasedBorderWidthStyle buttonBasedBorderWidthStyle) {
    ...
    @Override // com.withpersona.sdk2.inquiry.network.dto.p421ui.styling.ButtonComponentStyling
    ...
    public Integer getActiveBackgroundColorValue() {
        ...
        Integer active;
        AttributeStyles.ButtonBasedBackgroundColorStyle buttonBasedBackgroundColorStyle = this.backgroundColor;
        return Integer.valueOf((buttonBasedBackgroundColorStyle == null || (base = buttonBasedBackgroundColorStyle.getBase()) == null || (active = base.getActive()) == null) ? ButtonComponentStyling6.defaultLoadingColor : active.intValue());
    }

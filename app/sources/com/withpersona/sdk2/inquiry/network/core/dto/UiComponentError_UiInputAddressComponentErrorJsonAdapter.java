...
public final class UiComponentError_UiInputAddressComponentErrorJsonAdapter extends JsonAdapter<UiComponentError.UiInputAddressComponentError> {
    ...
    public UiComponentError.UiInputAddressComponentError fromJson(JsonReader jsonReader) throws IOException {
        ...
        if (mapFromJson != null) {
            return new UiComponentError.UiInputAddressComponentError(strFromJson, strFromJson2, mapFromJson);
        }
        throw Util.missingProperty("message", "message", jsonReader);
    }

    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(JsonWriter jsonWriter, UiComponentError.UiInputAddressComponentError uiInputAddressComponentError) throws IOException {
        if (uiInputAddressComponentError == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        jsonWriter.beginObject();
        jsonWriter.name("name");
        this.stringAdapter.toJson(jsonWriter, (JsonWriter) uiInputAddressComponentError.getName());
        jsonWriter.name("type");
        this.stringAdapter.toJson(jsonWriter, (JsonWriter) uiInputAddressComponentError.getType());
        jsonWriter.name("message");
        this.mapOfStringStringAdapter.toJson(jsonWriter, (JsonWriter) uiInputAddressComponentError.getMessage());

...
public class SVG {
    ...
    static class Box {
        ...
        public String toString() {
            return "[" + this.minX + PlaceholderUtils.XXShortPlaceholderText + this.minY + PlaceholderUtils.XXShortPlaceholderText + this.width + PlaceholderUtils.XXShortPlaceholderText + this.height + "]";
        }
    }
    ...
    static class PaintReference extends SvgPaint {
        ...
        public String toString() {
            return this.href + PlaceholderUtils.XXShortPlaceholderText + this.fallback;
        }
    }
    ...
    static class Length implements Cloneable {
        ...
        float floatValueX(SVGAndroidRenderer sVGAndroidRenderer) {
            switch (C48141.$SwitchMap$com$caverock$androidsvg$SVG$Unit[this.unit.ordinal()]) {
                case 9:
        ...
        float floatValue(float f) {
            int i = C48141.$SwitchMap$com$caverock$androidsvg$SVG$Unit[this.unit.ordinal()];
            if (i == 1) {
                return this.value;
            }
            switch (i) {
    ...
    static class Group extends SvgConditionalContainer implements HasTransform {
        ...
        @Override // com.caverock.androidsvg.SVG.SvgObject
        String getNodeName() {
            return MobileLinkingDeeplinkConstants.group_id_param;
        }
    }
    ...
    SvgElementBase getElementById(String str) {
        ...
        if (str.equals(this.rootElement.f612id)) {
            return this.rootElement;
        }
    ...
    private SvgElementBase getElementById(SvgContainer svgContainer, String str) {
        ...
        if (str.equals(svgElementBase.f612id)) {
            return svgElementBase;
        }
        for (Object obj : svgContainer.getChildren()) {
            if (obj instanceof SvgElementBase) {
                SvgElementBase svgElementBase2 = (SvgElementBase) obj;
                if (str.equals(svgElementBase2.f612id)) {

...
class CSSParser {
    ...
    private enum PseudoClassIdents {
        ...
        private static final Map<String, PseudoClassIdents> f9806cache = new HashMap();

        static {
            for (PseudoClassIdents pseudoClassIdents : values()) {
                if (pseudoClassIdents != UNSUPPORTED) {
                    f9806cache.put(pseudoClassIdents.name().replace('_', '-'), pseudoClassIdents);
                }
            }
        }

        public static PseudoClassIdents fromString(String str) {
            PseudoClassIdents pseudoClassIdents = f9806cache.get(str);
    ...
    private static class Attrib {
        ...
        final AttribOp f9805operation;
        public final String value;

        Attrib(String str, AttribOp attribOp, String str2) {
            this.name = str;
            this.f9805operation = attribOp;
            this.value = str2;
        }
    }
        ...
        public String toString() {
            ...
            if (list != null) {
                for (Attrib attrib : list) {
                    ...
                    int i = C48131.$SwitchMap$com$caverock$androidsvg$CSSParser$AttribOp[attrib.f9805operation.ordinal()];
                    if (i == 1) {
                        sb.append('=');
    ...
    static class Selector {
        ...
        /* synthetic */ Selector(C48131 c48131) {
            this();
        }
        ...
        void addedIdAttribute() {
            this.specificity += InvestFlowConstants.MAX_ONE_TIME_AMOUNT;
        }
    ...
    private static class CSSTextScanner extends SVGParser.TextScanner {
        ...
        public List<Selector> nextSelectorGroup() throws CSSParseException {
            ...
            Selector selector = new Selector(c48131);
            while (!empty() && nextSimpleSelector(selector)) {
                if (skipCommaWhitespace()) {
                    arrayList.add(selector);
                    selector = new Selector(c48131);
                }
            }
            if (!selector.isEmpty()) {
                arrayList.add(selector);
        ...
        */
        ...
        private void parsePseudoClass(Selector selector, SimpleSelector simpleSelector) throws CSSParseException {
            ...
            C48131 c48131 = null;
            switch (C48131.$SwitchMap$com$caverock$androidsvg$CSSParser$PseudoClassIdents[pseudoClassIdentsFromString.ordinal()]) {
                case 1:
                    PseudoClassAnPlusB pseudoClassAnPlusB3 = new PseudoClassAnPlusB(0, 1, true, false, null);
                    selector.addedAttributeOrPseudo();
                    pseudoClassAnPlusB2 = pseudoClassAnPlusB3;
                    pseudoClassOnlyChild = pseudoClassAnPlusB2;
                    simpleSelector.addPseudo(pseudoClassOnlyChild);
                    return;
                case 2:
                    PseudoClassAnPlusB pseudoClassAnPlusB4 = new PseudoClassAnPlusB(0, 1, false, false, null);
                    selector.addedAttributeOrPseudo();
                    pseudoClassOnlyChild = pseudoClassAnPlusB4;
                    simpleSelector.addPseudo(pseudoClassOnlyChild);
                    return;
                case 3:
                ...
                case 5:
                    ...
                    selector.addedAttributeOrPseudo();
                    pseudoClassOnlyChild = pseudoClassAnPlusB5;
                    simpleSelector.addPseudo(pseudoClassOnlyChild);
                    return;
                case 6:
                    pseudoClassOnlyChild = new PseudoClassOnlyChild(true, simpleSelector.tag);
                    selector.addedAttributeOrPseudo();
                    simpleSelector.addPseudo(pseudoClassOnlyChild);
                    return;
                case 7:
                    pseudoClassOnlyChild = new PseudoClassRoot(c48131);
                    selector.addedAttributeOrPseudo();
                    simpleSelector.addPseudo(pseudoClassOnlyChild);
                    return;
                case 8:
                    pseudoClassOnlyChild = new PseudoClassEmpty(c48131);
                    selector.addedAttributeOrPseudo();
                    simpleSelector.addPseudo(pseudoClassOnlyChild);
                    return;
                case 9:
                ...
                case 12:
                    ...
                    pseudoClassAnPlusB = new PseudoClassAnPlusB(anPlusBNextAnPlusB.f583a, anPlusBNextAnPlusB.f584b, z, z2, simpleSelector.tag);
                    selector.addedAttributeOrPseudo();
                    pseudoClassOnlyChild = pseudoClassAnPlusB;
                    simpleSelector.addPseudo(pseudoClassOnlyChild);
                    return;
                case 13:
                    ...
                    return;
                case 14:
                    pseudoClassOnlyChild = new PseudoClassTarget(c48131);
                    selector.addedAttributeOrPseudo();
                    simpleSelector.addPseudo(pseudoClassOnlyChild);
                    return;
                case 15:
                    nextIdentListParam();
                    pseudoClassOnlyChild = new PseudoClassNotSupported(strNextIdentifier);
                    selector.addedAttributeOrPseudo();
                    simpleSelector.addPseudo(pseudoClassOnlyChild);
                    return;
                case 16:
    ...
    static class RuleMatchContext {
        ...
        public String toString() {
            ...
            if (svgElementBase != null) {
                return String.format("<%s id=\"%s\">", svgElementBase.getNodeName(), this.targetElement.f612id);
            }
            return "";
        }
    }
    ...
    private static boolean selectorMatch(RuleMatchContext ruleMatchContext, SimpleSelector simpleSelector, List<SVG.SvgContainer> list, int i, SVG.SvgElementBase svgElementBase) {
        ...
        if (list3 != null) {
            for (Attrib attrib : list3) {
                ...
                str2.getClass();
                if (str2.equals("id")) {
                    if (!attrib.value.equals(svgElementBase.f612id)) {
                        return false;
                    }
    ...
    private static class PseudoClassAnPlusB implements PseudoClass {
        ...
        public boolean matches(RuleMatchContext ruleMatchContext, SVG.SvgElementBase svgElementBase) {
            ...
            int i4 = this.f586a;
            if (i4 == 0) {
                return i3 == this.f587b;
            }
            int i5 = this.f587b;
            return (i3 - i5) % i4 == 0 && (Integer.signum(i3 - i5) == 0 || Integer.signum(i3 - this.f587b) == Integer.signum(this.f586a));
        }

        public String toString() {
            String str = this.isFromStart ? "" : "last-";
            return this.isOfType ? String.format("nth-%schild(%dn%+d of type <%s>)", str, Integer.valueOf(this.f586a), Integer.valueOf(this.f587b), this.nodeName) : String.format("nth-%schild(%dn%+d)", str, Integer.valueOf(this.f586a), Integer.valueOf(this.f587b));
        }
    }
    ...
    private static class PseudoClassRoot implements PseudoClass {
        ...
        /* synthetic */ PseudoClassRoot(C48131 c48131) {
            this();
        }
        ...
        public String toString() {
            return BentoCurrencyPicker.ROOT_TEST_TAG;
        }
    }
    ...
    private static class PseudoClassEmpty implements PseudoClass {
        ...
        /* synthetic */ PseudoClassEmpty(C48131 c48131) {
            this();
        }
    ...
    private static class PseudoClassTarget implements PseudoClass {
        ...
        /* synthetic */ PseudoClassTarget(C48131 c48131) {
            this();
        }

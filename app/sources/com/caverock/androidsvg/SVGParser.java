...
class SVGParser {
    ...
    private enum SVGElem {
        ...
        private static final Map<String, SVGElem> f9809cache = new HashMap();

        static {
            for (SVGElem sVGElem : values()) {
                if (sVGElem == SWITCH) {
                    f9809cache.put("switch", sVGElem);
                } else if (sVGElem != UNSUPPORTED) {
                    f9809cache.put(sVGElem.name(), sVGElem);
                }
            }
        }

        public static SVGElem fromString(String str) {
            SVGElem sVGElem = f9809cache.get(str);
    ...
    private enum SVGAttr {
        ...
        /* renamed from: cache, reason: collision with root package name */
        private static final Map<String, SVGAttr> f9807cache = new HashMap();

        static {
            for (SVGAttr sVGAttr : values()) {
                if (sVGAttr == CLASS) {
                    f9807cache.put("class", sVGAttr);
                } else if (sVGAttr != UNSUPPORTED) {
                    f9807cache.put(sVGAttr.name().replace('_', '-'), sVGAttr);
                }
            }
        }

        public static SVGAttr fromString(String str) {
            SVGAttr sVGAttr = f9807cache.get(str);
    ...
    private static class ColourKeywords {
        ...
        static {
            ...
            map.put("bisque", -6972);
            map.put(StatusBannerStyle.NATIVE_STATUS_BLACK, -16777216);
            ...
            map.put(AnalyticsStrings.TAB_NAV_TAB_BAR_GOLD_UPGRADE, -10496);
            ...
            map.put(StatusBannerStyle.NATIVE_STATUS_WHITE, -1);
            map.put("whitesmoke", -657931);
            map.put("yellow", Integer.valueOf(AssetHomeEducationTourScreen.SortButtonOffset));
    ...
    private static class FontWeightKeywords {
        ...
        static {
            ...
            map.put("normal", 400);
            Integer numValueOf = Integer.valueOf(Timeline.MIDDLE_META_OFFSET_ANIMATION_DURATION);
    ...
    private static class AspectRatioKeywords {
        ...
        static {
            ...
            map.put(ApiRenderablePlatforms.VERSIONS_NONE, PreserveAspectRatio.Alignment.none);
    ...
    private class SAXHandler extends DefaultHandler2 {
        ...
        /* synthetic */ SAXHandler(SVGParser sVGParser, C48161 c48161) {
            this();
        }
    ...
    public void startElement(String str, String str2, String str3, Attributes attributes) throws SVGParseException {
        ...
        if ("http://www.w3.org/2000/svg".equals(str) || "".equals(str)) {
            ...
            switch (C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGElem[sVGElemFromString.ordinal()]) {
                case 1:
                    svg(attributes);
                    break;
                case 2:
    ...
    public void endElement(String str, String str2, String str3) throws SVGParseException {
        ...
        if ("http://www.w3.org/2000/svg".equals(str) || "".equals(str)) {
            ...
            int i2 = C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGElem[SVGElem.fromString(str2).ordinal()];
    ...
    private void parseAttributesSVG(SVG.Svg svg, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                svg.f610x = parseLength(strTrim);
            } else if (i2 == 2) {
                svg.f611y = parseLength(strTrim);
            } else if (i2 == 3) {
    ...
    /* renamed from: g */
    private void m785g(Attributes attributes) throws SVGParseException {
    ...
    private void parseAttributesUse(SVG.Use use, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                use.f634x = parseLength(strTrim);
            } else if (i2 == 2) {
                use.f635y = parseLength(strTrim);
            } else if (i2 == 3) {
                SVG.Length length = parseLength(strTrim);
                use.width = length;
                if (length.isNegative()) {
    ...
    private void parseAttributesImage(SVG.Image image, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                image.f595x = parseLength(strTrim);
            } else if (i2 == 2) {
                image.f596y = parseLength(strTrim);
            } else if (i2 == 3) {
                SVG.Length length = parseLength(strTrim);
                image.width = length;
                if (length.isNegative()) {
    ...
    private void parseAttributesRect(SVG.Rect rect, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                rect.f608x = parseLength(strTrim);
            } else if (i2 == 2) {
                rect.f609y = parseLength(strTrim);
            } else if (i2 == 3) {
                SVG.Length length = parseLength(strTrim);
                rect.width = length;
                if (length.isNegative()) {
    ...
    private void parseAttributesCircle(SVG.Circle circle, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String strTrim = attributes.getValue(i).trim();
            switch (C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()]) {
                case 12:
                    circle.f588cx = parseLength(strTrim);
                    break;
                case 13:
                    circle.f589cy = parseLength(strTrim);
                    break;
                case 14:
                    SVG.Length length = parseLength(strTrim);
                    circle.f590r = length;
    ...
    private void parseAttributesEllipse(SVG.Ellipse ellipse, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            switch (C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()]) {
                ...
                case 11:
                    SVG.Length length2 = parseLength(strTrim);
                    ellipse.f594ry = length2;
                    if (length2.isNegative()) {
                        throw new SVGParseException("Invalid <ellipse> element. ry cannot be negative");
                    }
                    break;
                case 12:
                    ellipse.f591cx = parseLength(strTrim);
                    break;
                case 13:
                    ellipse.f592cy = parseLength(strTrim);
                    break;
            }
        }
    }
    ...
    private void parseAttributesLine(SVG.Line line, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            switch (C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()]) {
                case 15:
                    line.f597x1 = parseLength(strTrim);
                    break;
                case 16:
                    line.f599y1 = parseLength(strTrim);
                    break;
                case 17:
                    line.f598x2 = parseLength(strTrim);
                    break;
                case 18:
                    line.f600y2 = parseLength(strTrim);
                    break;
            }
        }
    }
    ...
    private void parseAttributesTextPosition(SVG.TextPositionedContainer textPositionedContainer, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                textPositionedContainer.f624x = parseLengthList(strTrim);
            } else if (i2 == 2) {
                textPositionedContainer.f625y = parseLengthList(strTrim);
            } else if (i2 == 19) {
                textPositionedContainer.f622dx = parseLengthList(strTrim);
            } else if (i2 == 20) {
                textPositionedContainer.f623dy = parseLengthList(strTrim);
            }
        }
    }
    ...
    private void parseAttributesTRef(SVG.TRef tRef, Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            String strTrim = attributes.getValue(i).trim();
            if (C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()] == 6 && ("".equals(attributes.getURI(i)) || "http://www.w3.org/1999/xlink".equals(attributes.getURI(i)))) {
                tRef.href = strTrim;
            }
        }
    }
    ...
    */
    ...
    private void parseAttributesLinearGradient(SVG.SvgLinearGradient svgLinearGradient, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            switch (C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()]) {
                case 15:
                    svgLinearGradient.f613x1 = parseLength(strTrim);
                    break;
                case 16:
                    svgLinearGradient.f615y1 = parseLength(strTrim);
                    break;
                case 17:
                    svgLinearGradient.f614x2 = parseLength(strTrim);
                    break;
                case 18:
                    svgLinearGradient.f616y2 = parseLength(strTrim);
                    break;
            }
        }
    }
    ...
    */
    private void parseAttributesRadialGradient(SVG.SvgRadialGradient svgRadialGradient, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 35) {
                svgRadialGradient.f619fx = parseLength(strTrim);
            } else if (i2 != 36) {
                switch (i2) {
                    case 12:
                        svgRadialGradient.f617cx = parseLength(strTrim);
                        break;
                    case 13:
                        svgRadialGradient.f618cy = parseLength(strTrim);
                        break;
                    case 14:
                        SVG.Length length = parseLength(strTrim);
                        svgRadialGradient.f621r = length;
                        if (length.isNegative()) {
                ...
                svgRadialGradient.f620fy = parseLength(strTrim);
            }
        }
    }
    ...
    private void parseAttributesStop(SVG.Stop stop, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String strTrim = attributes.getValue(i).trim();
            if (C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()] == 37) {
    ...
    private void parseAttributesClipPath(SVG.ClipPath clipPath, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String strTrim = attributes.getValue(i).trim();
            if (C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()] == 38) {
                if ("objectBoundingBox".equals(strTrim)) {
    ...
    */
    private void parseAttributesPattern(SVG.Pattern pattern, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                pattern.f604x = parseLength(strTrim);
            } else if (i2 == 2) {
                pattern.f605y = parseLength(strTrim);
            } else if (i2 == 3) {
                SVG.Length length = parseLength(strTrim);
    ...
    private void parseAttributesMask(SVG.Mask mask, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                mask.f601x = parseLength(strTrim);
            } else if (i2 == 2) {
                mask.f602y = parseLength(strTrim);
            } else if (i2 == 3) {
                SVG.Length length = parseLength(strTrim);
                mask.width = length;
                if (length.isNegative()) {
    ...
    private void parseAttributesCore(SVG.SvgElementBase svgElementBase, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            if (qName.equals("id") || qName.equals("xml:id")) {
                svgElementBase.f612id = attributes.getValue(i).trim();
                return;
            }
            if (qName.equals("xml:space")) {
                String strTrim = attributes.getValue(i).trim();
                if (AnalyticsStrings.BUTTON_ACCESSIBLE_COLORS_DEFAULT.equals(strTrim)) {
    ...
    static void processStyleProperty(SVG.Style style, String str, String str2) {
        ...
        try {
            switch (C48161.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(str).ordinal()]) {
                case 47:
                ...
                case 55:
                    ...
                    break;
                case 56:
                    if (ApiRenderablePlatforms.VERSIONS_NONE.equals(str2)) {
                ...
                case SDK_ASSET_ICON_GLOBE_VALUE:
                    ...
                    break;
                case 73:
                    if (str2.indexOf(EnumC7081g.SDK_ASSET_ILLUSTRATION_SIGNATURE_VALUE) < 0) {
                        if ("|inline|block|list-item|run-in|compact|marker|table|inline-table|table-row-group|table-header-group|table-footer-group|table-row|table-column-group|table-column|table-cell|table-caption|none|".contains('|' + str2 + '|')) {
                            style.display = Boolean.valueOf(!str2.equals(ApiRenderablePlatforms.VERSIONS_NONE));
    ...
    private static SVG.SvgPaint parseColourSpecifer(String str) {
        str.getClass();
        if (str.equals(ApiRenderablePlatforms.VERSIONS_NONE)) {
    ...
    private static SVG.Colour parseColour(String str) throws SVGParseException {
        if (str.charAt(0) == '#') {
            ...
            if (endPos == 4) {
                ...
                int i = iValue & 3840;
                int i2 = iValue & EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_CIRCLE_VALUE;
                int i3 = iValue & 15;
            ...
            if (endPos == 5) {
                ...
                int i5 = iValue2 & 3840;
                int i6 = iValue2 & EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_CIRCLE_VALUE;
                int i7 = iValue2 & 15;
        ...
        if (zStartsWith || lowerCase.startsWith("rgb(")) {
            ...
            textScanner.skipWhitespace();
            float fNextFloat = textScanner.nextFloat();
            if (!Float.isNaN(fNextFloat) && textScanner.consume(TickerInputView.PERCENT_SYMBOL)) {
                fNextFloat = (fNextFloat * 256.0f) / 100.0f;
            }
            float fCheckedNextFloat = textScanner.checkedNextFloat(fNextFloat);
            if (!Float.isNaN(fCheckedNextFloat) && textScanner.consume(TickerInputView.PERCENT_SYMBOL)) {
                fCheckedNextFloat = (fCheckedNextFloat * 256.0f) / 100.0f;
            }
            float fCheckedNextFloat2 = textScanner.checkedNextFloat(fCheckedNextFloat);
            if (!Float.isNaN(fCheckedNextFloat2) && textScanner.consume(TickerInputView.PERCENT_SYMBOL)) {
        ...
        if (zStartsWith2 || lowerCase.startsWith("hsl(")) {
            ...
            if (!Float.isNaN(fCheckedNextFloat4)) {
                textScanner2.consume(TickerInputView.PERCENT_SYMBOL);
            }
    ...
    */
    ...
    private static String parseFunctionalIRI(String str, String str2) {
        if (str.equals(ApiRenderablePlatforms.VERSIONS_NONE) || !str.startsWith("url(")) {
            return null;
        }
        if (str.endsWith(")")) {

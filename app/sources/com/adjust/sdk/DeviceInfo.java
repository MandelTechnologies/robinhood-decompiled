...
class DeviceInfo {
    ...
    private String getDeviceType(Configuration configuration) {
        if (this.isGooglePlayGamesForPC) {
            return com.singular.sdk.internal.Constants.REVENUE_PRODUCT_CATEGORY_KEY;
        }
    ...
    private String getFacebookAttributionId(Context context) {
        ...
        try {
            ...
            String string2 = cursorQuery.getString(cursorQuery.getColumnIndex("aid"));
            cursorQuery.close();
            return string2;
        } catch (Exception unused) {
        }
    ...
    public static class UtilDeviceIds {
        ...
        public static void getFireAdvertisingIdAsync(ContentResolver contentResolver, OnAmazonAdIdReadListener onAmazonAdIdReadListener) {
            ...
            try {
                onAmazonAdIdReadListener.onAmazonAdIdRead(Settings.Secure.getString(contentResolver, com.singular.sdk.internal.Constants.AMAZON_ADVERTISING_ID));
            } catch (Exception e) {
        ...
        private static String getFireAdvertisingId(ContentResolver contentResolver) {
            ...
            try {
                return Settings.Secure.getString(contentResolver, com.singular.sdk.internal.Constants.AMAZON_ADVERTISING_ID);
            } catch (Exception unused) {
                return null;
            }
        }
        ...
        private static Boolean getFireTrackingEnabled(ContentResolver contentResolver) {
            try {
                return Boolean.valueOf(Settings.Secure.getInt(contentResolver, com.singular.sdk.internal.Constants.AMAZON_LIMIT_AD_TRACKING) == 0);
            } catch (Exception unused) {
                return null;
            }
        }

...
import com.google.maps.android.p053ui.SquareTextView;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    static /* synthetic */ ClusterManager.OnClusterItemInfoWindowClickListener access$400(DefaultClusterRenderer defaultClusterRenderer) {
    ...
    public void onAdd() {
        ...
        this.mClusterManager.getMarkerCollection().setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() { // from class: com.google.maps.android.clustering.view.DefaultClusterRenderer.2
            ...
            public void onInfoWindowClick(Marker marker) {
                DefaultClusterRenderer.access$400(DefaultClusterRenderer.this);
            }
        });
        ...
        this.mClusterManager.getClusterMarkerCollection().setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() { // from class: com.google.maps.android.clustering.view.DefaultClusterRenderer$$ExternalSyntheticLambda1
            ...
            public final boolean onMarkerClick(Marker marker) {
                return DefaultClusterRenderer.m9311$r8$lambda$a4rL9je4o9aw4Ep75dE4NQoyDg(this.f$0, marker);
            }
        });
    ...
    /* renamed from: $r8$lambda$a4r-L9je4o9aw4Ep75dE4NQoyDg, reason: not valid java name */
    public static /* synthetic */ boolean m9311$r8$lambda$a4rL9je4o9aw4Ep75dE4NQoyDg(DefaultClusterRenderer defaultClusterRenderer, Marker marker) {
        ClusterManager.OnClusterClickListener<T> onClusterClickListener = defaultClusterRenderer.mClickListener;
        return onClusterClickListener != null && onClusterClickListener.onClusterClick(defaultClusterRenderer.mClusterMarkerCache.get(marker));
    }
    ...
    private static double distanceSquared(Point point, Point point2) {
        double d = point.f928x;
        double d2 = point2.f928x;
        double d3 = (d - d2) * (d - d2);
        double d4 = point.f929y;
        double d5 = point2.f929y;
    ...
    private class AnimationTask extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            this.markerWithPosition.position = this.f927to;
        }
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            if (this.f927to == null || this.from == null || this.marker == null) {
                return;
            }
            float animatedFraction = valueAnimator.getAnimatedFraction();
            LatLng latLng = this.f927to;

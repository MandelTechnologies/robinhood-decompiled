...
public class PointQuadTree<T extends Item> {
    ...
    public void add(T t) {
        ...
        if (this.mBounds.contains(point.f928x, point.f929y)) {
            insert(point.f928x, point.f929y, t);
        }
    }
    ...
    private void split() {
        ...
        this.mItems = null;
        for (T t : set) {
            insert(t.getPoint().f928x, t.getPoint().f929y, t);
        }
    }
    ...
    public boolean remove(T t) {
        Point point = t.getPoint();
        if (this.mBounds.contains(point.f928x, point.f929y)) {
            return remove(point.f928x, point.f929y, t);
        }
        return false;
    }

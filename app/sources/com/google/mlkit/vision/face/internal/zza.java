...
final class zza implements zzb {
    ...
    private final void zzf() throws RemoteException, DynamiteModule.LoadingException {
        if (this.zzb.zzc() != 2) {
            if (this.zzh == null) {
    ...
    private final zzoy zzg(zzou zzouVar) throws RemoteException, DynamiteModule.LoadingException {
        return this.zzd ? zze(DynamiteModule.PREFER_LOCAL, "com.google.mlkit.dynamite.face", "com.google.mlkit.vision.face.bundled.internal.ThickFaceDetectorCreator", zzouVar) : zze(DynamiteModule.PREFER_REMOTE, "com.google.android.gms.vision.face", "com.google.android.gms.vision.face.mlkit.FaceDetectorCreator", zzouVar);
    }
    ...
    private static List zzh(zzoy zzoyVar, InputImage inputImage) throws MlKitException {
        ...
        try {
            List listZzd = zzoyVar.zzd(ImageUtils.getInstance().getImageDataWrapper(inputImage), new zzoq(inputImage.getFormat(), inputImage.getWidth(), inputImage.getHeight(), CommonConvertUtils.convertToMVRotation(inputImage.getRotationDegrees()), SystemClock.elapsedRealtime()));
    ...
    public final Pair zza(InputImage inputImage) throws MlKitException {
        ...
        List listZzh2 = null;
        if (zzoyVar3 != null) {
            listZzh = zzh(zzoyVar3, inputImage);
            if (!this.zzb.zzg()) {
                zzh.zzf(listZzh);
            }
        } else {
        ...
        if (zzoyVar4 != null) {
            listZzh2 = zzh(zzoyVar4, inputImage);
            zzh.zzf(listZzh2);
        }
        return new Pair(listZzh, listZzh2);
    }
    ...
    final zzoy zze(DynamiteModule.VersionPolicy versionPolicy, String str, String str2, zzou zzouVar) throws RemoteException, DynamiteModule.LoadingException {

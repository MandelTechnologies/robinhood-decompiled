...
final class zzq implements zzm {
    ...
    public final boolean zzc() throws MlKitException {
        ...
        try {
            zzaj zzajVarZzd = zzal.zza(DynamiteModule.load(this.zzb, DynamiteModule.PREFER_REMOTE, "com.google.android.gms.vision.dynamite").instantiate("com.google.android.gms.vision.barcode.ChimeraNativeBarcodeDetectorCreator")).zzd(ObjectWrapper.wrap(this.zzb), this.zzc);
            this.zze = zzajVarZzd;

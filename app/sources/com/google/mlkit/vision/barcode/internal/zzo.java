...
final class zzo implements zzm {
    ...
    public final boolean zzc() throws MlKitException {
        ...
        if (zzd(this.zze)) {
            ...
            if (!OptionalModuleUtils.areAllRequiredModulesAvailable(this.zze, zza)) {
                if (!this.zzd) {
                    OptionalModuleUtils.requestDownload(this.zze, zzcs.zzh("barcode", "tflite_dynamite"));
                    this.zzd = true;
                }
    ...
    final zzyl zze(DynamiteModule.VersionPolicy versionPolicy, String str, String str2) throws RemoteException, DynamiteModule.LoadingException {
        boolean z;
        ...
        if (barcodeScannerOptions.zzd()) {
            z = true;
        } else {
            this.zzf.zzb();
            z = false;
        }
        return zzyoVarZza.zzd(iObjectWrapperWrap, new zzyd(iZza, z));
    }
}

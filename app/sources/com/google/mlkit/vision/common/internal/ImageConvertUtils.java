...
public class ImageConvertUtils {
    ...
    public static Bitmap yv12ToBitmap(ByteBuffer byteBuffer, int i, int i2, int i3) throws MlKitException, IllegalAccessException, NoSuchMethodException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    private static byte[] zzb(byte[] bArr, int i, int i2) throws MlKitException, IllegalAccessException, NoSuchMethodException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    public ByteBuffer convertToNv21Buffer(InputImage inputImage, boolean z) throws MlKitException {
        ...
        for (int i4 = 0; i4 < height; i4++) {
            ...
            while (i5 < width) {
                ...
                int i11 = i7 & 255;
                int i12 = i8 & 255;
                byteBufferAllocate.put(i2, (byte) Math.min(255, (((((i11 * 66) + (i12 * EnumC7081g.SDK_ASSET_ILLUSTRATION_FORM_VALUE)) + (i9 * 25)) + 128) >> 8) + 16));
                if (i4 % 2 == 0 && i3 % 2 == 0) {
    ...
    public Bitmap nv21ToBitmap(ByteBuffer byteBuffer, int i, int i2, int i3) throws MlKitException, IllegalAccessException, NoSuchMethodException, IOException, SecurityException, IllegalArgumentException, InvocationTargetException {

...
final class zze implements zzm {
    ...
    public final Text zza(InputImage inputImage) throws MlKitException {
        ...
        int i = iConvertToMVRotation;
        try {
            return zzk.zza(((com.google.android.gms.internal.mlkit_vision_text_common.zzh) Preconditions.checkNotNull(this.zzd)).zze(ObjectWrapper.wrap(bitmapConvertToUpRightBitmap), new com.google.android.gms.internal.mlkit_vision_text_common.zzd(inputImage.getWidth(), inputImage.getHeight(), 0, 0L, i)), inputImage.getCoordinatesMatrix());
    ...
    public final void zzb() throws MlKitException {
        ...
        try {
            com.google.android.gms.internal.mlkit_vision_text_common.zzh zzhVarZzd = com.google.android.gms.internal.mlkit_vision_text_common.zzj.zza(DynamiteModule.load(this.zza, DynamiteModule.PREFER_REMOTE, "com.google.android.gms.vision.dynamite").instantiate("com.google.android.gms.vision.text.ChimeraNativeTextRecognizerCreator")).zzd(ObjectWrapper.wrap(this.zza), this.zzb);
            this.zzd = zzhVarZzd;

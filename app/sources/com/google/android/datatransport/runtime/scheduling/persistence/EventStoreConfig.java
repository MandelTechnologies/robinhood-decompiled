...
abstract class EventStoreConfig {
    static final EventStoreConfig DEFAULT = builder().setMaxStorageSizeInBytes(SddrPdfUploadDuxo.FILE_SIZE_LIMIT).setLoadBatchSize(200).setCriticalSectionEnterTimeoutMs(10000).setEventCleanUpAge(SlipPostTradeUpsellStore.MIN_PROMPT_GAP_MILLIS).setMaxBlobByteSizePerRow(81920).build();

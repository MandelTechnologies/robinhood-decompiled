...
final class SchemaManager extends SQLiteOpenHelper {
    ...
    static {
        ...
        Migration migration4 = new Migration() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager$$ExternalSyntheticLambda3
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager.Migration
            public final void upgrade(SQLiteDatabase sQLiteDatabase) throws SQLException {
                SchemaManager.m9231$r8$lambda$y1ozSJfaQLQnaXGsXgjLyyzCDo(sQLiteDatabase);
            }
        };
        ...
        Migration migration5 = new Migration() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager$$ExternalSyntheticLambda4
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager.Migration
            public final void upgrade(SQLiteDatabase sQLiteDatabase) throws SQLException {
                SchemaManager.m9230$r8$lambda$qLPbOYW3vYokeWUTGz9t89hvNg(sQLiteDatabase);
            }
        };
    ...
    public static /* synthetic */ void $r8$lambda$6O8JIimDLSwAQqPiJF1tsPggWhY(SQLiteDatabase sQLiteDatabase) throws SQLException {
    ...
    public static /* synthetic */ void $r8$lambda$sUYLmiPu6mhLbt9d0yj4BIg5XSE(SQLiteDatabase sQLiteDatabase) throws SQLException {
        sQLiteDatabase.execSQL("ALTER TABLE transport_contexts ADD COLUMN extras BLOB");
        sQLiteDatabase.execSQL("CREATE UNIQUE INDEX contexts_backend_priority_extras on transport_contexts(backend_name, priority, extras)");
        sQLiteDatabase.execSQL("DROP INDEX contexts_backend_priority");
    }

    /* renamed from: $r8$lambda$y1ozSJfaQLQnaXGsXgjLyyzC-Do, reason: not valid java name */
    public static /* synthetic */ void m9231$r8$lambda$y1ozSJfaQLQnaXGsXgjLyyzCDo(SQLiteDatabase sQLiteDatabase) throws SQLException {
        sQLiteDatabase.execSQL("ALTER TABLE events ADD COLUMN inline BOOLEAN NOT NULL DEFAULT 1");
        sQLiteDatabase.execSQL("DROP TABLE IF EXISTS event_payloads");
        sQLiteDatabase.execSQL("CREATE TABLE event_payloads (sequence_num INTEGER NOT NULL, event_id INTEGER NOT NULL, bytes BLOB NOT NULL,FOREIGN KEY (event_id) REFERENCES events(_id) ON DELETE CASCADE,PRIMARY KEY (sequence_num, event_id))");
    }

    /* renamed from: $r8$lambda$qLPbOYW3vYokeWUTGz-9t89hvNg, reason: not valid java name */
    public static /* synthetic */ void m9230$r8$lambda$qLPbOYW3vYokeWUTGz9t89hvNg(SQLiteDatabase sQLiteDatabase) throws SQLException {
    ...
    public static /* synthetic */ void $r8$lambda$_Gnx1vnj32VOEkFIbdCjsyHxuFo(SQLiteDatabase sQLiteDatabase) throws SQLException {

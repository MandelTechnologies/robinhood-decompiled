...
public class SplitCompat {
        ...
        try {
            ...
            try {
                ...
                for (zzt zztVar : setZzj) {
                    ...
                    int i = com.google.android.play.core.splitinstall.zzs.$r8$clinit;
    ...
    private static boolean zzi(Context context, boolean z) {
        ...
        while (true) {
            if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(atomicReference, null, splitCompat)) {
                z2 = true;
                break;
            }

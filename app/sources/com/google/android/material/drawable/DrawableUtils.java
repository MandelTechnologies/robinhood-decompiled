...
public final class DrawableUtils {
    ...
    public static AttributeSet parseDrawableXml(Context context, int i, CharSequence charSequence) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int next;
        try {
    ...
    public static ColorStateList getColorStateListOrNull(Drawable drawable) {
        ...
        if (Build.VERSION.SDK_INT < 29 || !DrawableUtils$$ExternalSyntheticApiModelOutline0.m836m(drawable)) {
            return null;
        }
        return DrawableUtils$$ExternalSyntheticApiModelOutline1.m837m(drawable).getColorStateList();
    }

...
public class ChipDrawable extends MaterialShapeDrawable implements Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private void loadFromAttributes(AttributeSet attributeSet, int i, int i2) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(R$styleable.Chip_checkedIconTint)) {
            setCheckedIconTint(MaterialResources.getColorStateList(this.context, typedArrayObtainStyledAttributes, R$styleable.Chip_checkedIconTint));
        }
    ...
    private void drawDebug(Canvas canvas, Rect rect) {
        ...
        if (paint != null) {
            paint.setColor(ColorUtils.setAlphaComponent(-16777216, EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE));
            ...
            this.debugPaint.setColor(ColorUtils.setAlphaComponent(-65536, EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE));
            calculateChipTouchBounds(rect, this.rectF);
            canvas2.drawRect(this.rectF, this.debugPaint);
            this.debugPaint.setColor(ColorUtils.setAlphaComponent(-16711936, EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE));

...
import androidx.core.util.Pools2;
...
public class TabLayout extends HorizontalScrollView {
    ...
    float tabTextSize;
    private final Pools<TabView> tabViewPool;
    private final ArrayList<Tab> tabs;
    boolean unboundedRipple;
    ViewPager viewPager;
    private int viewPagerScrollState;
    private static final int DEF_STYLE_RES = R$style.Widget_Design_TabLayout;
    private static final Pools<Tab> tabPool = new Pools3(16);
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i) throws Resources.NotFoundException {
        ...
        this.tabViewPool = new Pools2(12);
    ...
    public Tab newTab() {
        ...
        if (tabCreateTabFromPool.f678id != -1) {
            tabCreateTabFromPool.view.setId(tabCreateTabFromPool.f678id);
        }
    ...
    private TabView createTabView(Tab tab) {
        Pools<TabView> pools = this.tabViewPool;
        TabView tabViewAcquire = pools != null ? pools.acquire() : null;

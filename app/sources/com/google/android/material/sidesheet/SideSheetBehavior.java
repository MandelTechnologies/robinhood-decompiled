...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements MaterialBackHandler {
    ...
    private ValueAnimator.AnimatorUpdateListener getCoplanarFinishAnimatorUpdateListener() {
        ...
        return new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$$ExternalSyntheticLambda2
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                SideSheetBehavior.m9234$r8$lambda$vg37JzyumMkESCn5KJfiWrmBw(this.f$0, marginLayoutParams, coplanarSiblingAdjacentMargin, coplanarSiblingView, valueAnimator);
            }
        };
    }

    /* renamed from: $r8$lambda$v-g37JzyumMkESCn5K-JfiWrmBw, reason: not valid java name */
    public static /* synthetic */ void m9234$r8$lambda$vg37JzyumMkESCn5KJfiWrmBw(SideSheetBehavior sideSheetBehavior, ViewGroup.MarginLayoutParams marginLayoutParams, int i, View view, ValueAnimator valueAnimator) {
    ...
    class StateSettlingTracker {
        private final Runnable continueSettlingRunnable = new Runnable() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$StateSettlingTracker$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                SideSheetBehavior.StateSettlingTracker.m9235$r8$lambda$moQjjbcBo6ApC5WH96319nIACo(this.f$0);
            }
        };
        ...
        public static /* synthetic */ void m9235$r8$lambda$moQjjbcBo6ApC5WH96319nIACo(StateSettlingTracker stateSettlingTracker) {

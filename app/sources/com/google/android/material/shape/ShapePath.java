...
public class ShapePath {
    ...
    private final List<PathOperation> f9816operations = new ArrayList();
    ...
    public void lineTo(float f, float f2) {
        ...
        pathLineOperation.f676x = f;
        pathLineOperation.f677y = f2;
        this.f9816operations.add(pathLineOperation);
    ...
    public void addArc(float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        this.f9816operations.add(pathArcOperation);
    ...
    public void applyToPath(Matrix matrix, Path path) {
        int size = this.f9816operations.size();
        for (int i = 0; i < size; i++) {
            this.f9816operations.get(i).applyToPath(matrix, path);
        }
    }
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        private final PathLineOperation f9818operation;
        private final float startX;
        private final float startY;

        public LineShadowOperation(PathLineOperation pathLineOperation, float f, float f2) {
            this.f9818operation = pathLineOperation;
            this.startX = f;
            this.startY = f2;
        }
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.f9818operation.f677y - this.startY, this.f9818operation.f676x - this.startX), 0.0f);
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.f9818operation.f677y - this.startY) / (this.f9818operation.f676x - this.startX)));
        }
    }
    ...
    static class ArcShadowOperation extends ShadowCompatOperation {
        ...
        /* renamed from: operation, reason: collision with root package name */
        private final PathArcOperation f9817operation;

        public ArcShadowOperation(PathArcOperation pathArcOperation) {
            this.f9817operation = pathArcOperation;
        }

        @Override // com.google.android.material.shape.ShapePath.ShadowCompatOperation
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            shadowRenderer.drawCornerShadow(canvas, matrix, new RectF(this.f9817operation.getLeft(), this.f9817operation.getTop(), this.f9817operation.getRight(), this.f9817operation.getBottom()), i, this.f9817operation.getStartAngle(), this.f9817operation.getSweepAngle());
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            path.lineTo(this.f676x, this.f677y);

...
import androidx.compose.p011ui.autofill.AndroidAutofill$$ExternalSyntheticApiModelOutline0;
import androidx.compose.p011ui.autofill.AndroidAutofill$$ExternalSyntheticApiModelOutline1;
...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    static {
        ...
        FRAMEWORK_BUTTON_DRAWABLE_RES_ID = Resources.getSystem().getIdentifier("btn_check_material_anim", ResourceTypes.DRAWABLE, "android");
    }
    ...
    public void setCheckedState(int i) {
        AutofillManager autofillManagerM154m;
        ...
        if (this.checkedState != i) {
            ...
            if (Build.VERSION.SDK_INT >= 26 && (autofillManagerM154m = AndroidAutofill$$ExternalSyntheticApiModelOutline1.m154m(getContext().getSystemService(AndroidAutofill$$ExternalSyntheticApiModelOutline0.m153m()))) != null) {
                autofillManagerM154m.notifyValueChanged(this);
            }

...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    private void restoreState(Bundle bundle) {
        ...
        this.inputMode = bundle.getInt("TIME_PICKER_INPUT_MODE", this.time.f9819format != 1 ? 0 : 1);
        ...
        if (this.activePresenter instanceof TimePickerTextInputPresenter) {
            view.postDelayed(new Runnable() { // from class: com.google.android.material.timepicker.MaterialTimePicker$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    MaterialTimePicker.m9240$r8$lambda$LokL45Te3dObsZLP0tg9jf7Yfk(this.f$0);
                }
            }, 100L);
        }
    }

    /* renamed from: $r8$lambda$LokL4-5Te3dObsZLP0tg9jf7Yfk, reason: not valid java name */
    public static /* synthetic */ void m9240$r8$lambda$LokL45Te3dObsZLP0tg9jf7Yfk(MaterialTimePicker materialTimePicker) {

...
class TimeModel implements Parcelable {
    ...
    public int getHourContentDescriptionResId() {
        return this.f9819format == 1 ? R$string.material_hour_24h_suffix : R$string.material_hour_suffix;
    }
    ...
    public int hashCode() {
        return Arrays.hashCode(new Object[]{Integer.valueOf(this.f9819format), Integer.valueOf(this.hour), Integer.valueOf(this.minute), Integer.valueOf(this.selection)});
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.hour == timeModel.hour && this.minute == timeModel.minute && this.f9819format == timeModel.f9819format && this.selection == timeModel.selection;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeInt(this.f9819format);
    }

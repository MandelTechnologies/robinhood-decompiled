...
public final class BadgeState {
    ...
    BadgeState(Context context, int i, int i2, int i3, State state) throws XmlPullParserException, Resources.NotFoundException, IOException {
        ...
        if (state.contentDescriptionNumberless == null) {
            string2 = context.getString(R$string.mtrl_badge_numberless_content_description);
        } else {
            string2 = state.contentDescriptionNumberless;
        }
        state2.contentDescriptionNumberless = string2;
        ...
        if (state.badgeGravity == null) {
            iIntValue7 = typedArrayGenerateTypedArray.getInt(R$styleable.Badge_badgeGravity, MaterialCardView.CHECKED_ICON_GRAVITY_TOP_END);
        } else {

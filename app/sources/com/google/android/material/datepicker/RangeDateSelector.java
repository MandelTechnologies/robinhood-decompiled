...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    private final String invalidRangeEndError = PlaceholderUtils.XXShortPlaceholderText;
    ...
    @Override // com.google.android.material.datepicker.DateSelector
    public int getDefaultThemeResId(Context context) throws Resources.NotFoundException {
        int i;
    ...
    @Override // com.google.android.material.datepicker.DateSelector
    public String getSelectionContentDescription(Context context) throws Resources.NotFoundException {
        String string2;
        String string3;
        Resources resources = context.getResources();
        ...
        if (str2 == null) {
            string3 = resources.getString(R$string.mtrl_picker_announce_current_selection_none);
        } else {
            string3 = str2;
        }
        return resources.getString(R$string.mtrl_picker_announce_current_range_selection, string2, string3);
    }
    ...
    private void clearInvalidRange(TextInputLayout textInputLayout, TextInputLayout textInputLayout2) {
        ...
        if (textInputLayout2.getError() == null || !PlaceholderUtils.XXShortPlaceholderText.contentEquals(textInputLayout2.getError())) {
            return;
        }
    ...
    private void setInvalidRange(TextInputLayout textInputLayout, TextInputLayout textInputLayout2) {
        ...
        textInputLayout2.setError(PlaceholderUtils.XXShortPlaceholderText);
    }

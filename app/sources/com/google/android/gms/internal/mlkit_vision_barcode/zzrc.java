...
public enum zzrc implements zzfc {
    ...
    AGGREGATED_ON_DEVICE_FACE_MESH_DETECTION(EnumC7081g.SDK_ASSET_ICON_OVERRIDE_VALUE),
    AGGREGATED_ON_DEVICE_IMAGE_QUALITY_ANALYSIS_DETECTION(EnumC7081g.SDK_ASSET_ICON_PAUSE_VALUE),
    AGGREGATED_ON_DEVICE_IMAGE_CAPTIONING_INFERENCE(EnumC7081g.SDK_ASSET_ICON_PIN_VALUE),
    AGGREGATED_ON_DEVICE_DOCUMENT_DETECT_PROCESS(EnumC7081g.SDK_ASSET_ICON_PRODUCT_IDV_VALUE),
    AGGREGATED_ON_DEVICE_DOCUMENT_CROP_PROCESS(EnumC7081g.SDK_ASSET_ICON_PRODUCT_MONITOR_VALUE),
    AGGREGATED_ON_DEVICE_DOCUMENT_ENHANCE_PROCESS(EnumC7081g.SDK_ASSET_ICON_PROGRESS_VALUE),
    AGGREGATED_ON_DEVICE_STAIN_REMOVAL_PROCESS(EnumC7081g.SDK_ASSET_ICON_QUESTION_VALUE),
    AGGREGATED_ON_DEVICE_SHADOW_REMOVAL_PROCESS(EnumC7081g.SDK_ASSET_ICON_REJECTED_REC_VALUE),
    AGGREGATED_ON_DEVICE_SUBJECT_SEGMENTATION_INFERENCE(EnumC7081g.SDK_ASSET_ICON_SHIELD_CAUTION_VALUE),
    ...
    OPTIONAL_MODULE_DOCUMENT_DETECT_INIT(RhRoomDatabase.MIGRATION_START_VER),
    ...
    ON_DEVICE_STAIN_REMOVAL_PROCESS(CylinderBarConstants.TOTAL_ANIMATION_DURATION_SINGLE),

...
public final class zzaz {
    public static int zza(int i, int i2, String str) {
        ...
        if (i < 0) {
            strZzb = zzba.zzb("%s (%s) must not be negative", ApiOptionSimulatedReturnsConfigurationV3Request.ApiOptionUnderlying.TYPE_INDEX, Integer.valueOf(i));
        } else {
            if (i2 < 0) {
                throw new IllegalArgumentException("negative size: " + i2);
            }
            strZzb = zzba.zzb("%s (%s) must be less than size (%s)", ApiOptionSimulatedReturnsConfigurationV3Request.ApiOptionUnderlying.TYPE_INDEX, Integer.valueOf(i), Integer.valueOf(i2));
        }
    ...
    public static int zzb(int i, int i2, String str) {
        if (i < 0 || i > i2) {
            throw new IndexOutOfBoundsException(zzg(i, i2, ApiOptionSimulatedReturnsConfigurationV3Request.ApiOptionUnderlying.TYPE_INDEX));
        }
        return i;
    }

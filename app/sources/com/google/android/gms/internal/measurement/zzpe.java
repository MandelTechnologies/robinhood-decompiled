...
public final class zzpe implements zzpd {
    ...
    static {
        ...
        zzh = zzkgVarZzb.zzf("measurement.config.url_scheme", Constants.SCHEME);
        ...
        zzF = zzkgVarZzb.zzc("measurement.upload.refresh_blacklisted_config_interval", SlipPostTradeUpsellStore.MIN_PROMPT_GAP_MILLIS);
        ...
        zzac = zzkgVarZzb.zzf("measurement.rb.attribution.uri_scheme", Constants.SCHEME);
        zzad = zzkgVarZzb.zzc("measurement.sdk.attribution.cache.ttl", SlipPostTradeUpsellStore.MIN_PROMPT_GAP_MILLIS);

...
public final class zzaa {
    private static final ImmutableSet zza = ImmutableSet.m1014of("_syn", "_err", "_el");
    private String zzb;
    ...
    public final String toString() {
        ...
        long j = this.zzc;
        StringBuilder sb = new StringBuilder(length + 25 + String.valueOf(j).length() + 9 + string2.length() + 1);

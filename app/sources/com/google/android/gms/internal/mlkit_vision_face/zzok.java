...
public final class zzok implements zzob {
    ...
    public zzok(Context context, zznt zzntVar) {
        ...
        if (cCTDestination.getSupportedEncodings().contains(Encoding.m790of("json"))) {
            this.zza = new Lazy(new Provider() { // from class: com.google.android.gms.internal.mlkit_vision_face.zzoh
                @Override // com.google.firebase.inject.Provider
                public final Object get() {
                    return transportFactoryNewFactory.getTransport("FIREBASE_ML_SDK", byte[].class, Encoding.m790of("json"), new Transformer() { // from class: com.google.android.gms.internal.mlkit_vision_face.zzoj
        ...
        this.zzb = new Lazy(new Provider() { // from class: com.google.android.gms.internal.mlkit_vision_face.zzoi
            @Override // com.google.firebase.inject.Provider
            public final Object get() {
                return transportFactoryNewFactory.getTransport("FIREBASE_ML_SDK", byte[].class, Encoding.m790of("proto"), new Transformer() { // from class: com.google.android.gms.internal.mlkit_vision_face.zzog
                    @Override // com.google.android.datatransport.Transformer
                    public final Object apply(Object obj) {
                        return (byte[]) obj;
                    }
    ...
    static Event zzb(zznt zzntVar, zznr zznrVar) {
        ...
        return zznrVar.zza() != 0 ? Event.ofData(zznrVar.zze(iZza, false)) : Event.ofTelemetry(zznrVar.zze(iZza, false));
    }

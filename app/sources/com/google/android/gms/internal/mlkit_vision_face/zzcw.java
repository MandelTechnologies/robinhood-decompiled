...
final class zzcw implements ObjectEncoderContext {
    ...
    static {
        ...
        zzd = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_vision_face.zzcv
            ...
            public final void encode(Object obj, Object obj2) throws IOException {
                zzcw.zzg((Map.Entry) obj, (ObjectEncoderContext) obj2);
            }
        };
    }
    ...
    private final zzcw zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
    ...
    private final void zzn(int i) throws IOException {
        while ((i & (-128)) != 0) {
            this.zze.write((i & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | 128);
            i >>>= 7;
        }
        this.zze.write(i & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE);
    }

    private final void zzo(long j) throws IOException {
        while (((-128) & j) != 0) {
            this.zze.write((((int) j) & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | 128);
            j >>>= 7;
        }
        this.zze.write(((int) j) & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE);
    }

...
public final class zzpp extends zzjf {
    ...
    */
    ...
    @TargetApi(30)
    final boolean zzW() throws ExecutionException, InterruptedException, TimeoutException {
        Object e;
        Integer num;
        if (this.zzh == null) {
    ...
    final boolean zzu(String str, String str2, int i, Object obj) {
        if (obj != null && !(obj instanceof Long) && !(obj instanceof Float) && !(obj instanceof Integer) && !(obj instanceof Byte) && !(obj instanceof Short) && !(obj instanceof Boolean) && !(obj instanceof Double)) {
            ...
            if (string2.codePointCount(0, string2.length()) > i) {
                this.zzu.zzaV().zzh().zzd("Value is too long; discarded. Value kind, name, value length", str, str2, Integer.valueOf(string2.length()));
                return false;
            }
        }
        return true;

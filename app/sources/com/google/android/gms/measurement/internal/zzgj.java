...
final class zzgj extends com.google.android.gms.internal.measurement.zzby {
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) throws Throwable {
        zzaw.zza(this.zza.zzu.zzaV(), sQLiteDatabase, NotificationSettings4FragmentKey.SETTINGS_MESSAGES, "create table if not exists messages ( type INTEGER NOT NULL, entry BLOB NOT NULL)", "type,entry", zzgl.zza);
    }

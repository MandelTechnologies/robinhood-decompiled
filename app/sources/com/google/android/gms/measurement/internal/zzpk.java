...
public final class zzpk extends zzos {
    ...
    final zzbg zzA(com.google.android.gms.internal.measurement.zzaa zzaaVar) {
        ...
        String string2 = (!bundleZzB.containsKey("_o") || (obj = bundleZzB.get("_o")) == null) ? "app" : obj.toString();
        String strZzb = zzjm.zzb(zzaaVar.zzb());
        if (strZzb == null) {
            strZzb = zzaaVar.zzb();
        }
        return new zzbg(strZzb, new zzbe(bundleZzB), string2, zzaaVar.zza());
    }
    ...
    final zzoh zzf(String str, com.google.android.gms.internal.measurement.zzic zzicVar, com.google.android.gms.internal.measurement.zzhr zzhrVar, String str2) {
        ...
        Set setM829m = zzpk$$ExternalSyntheticBackport0.m829m(zzicVar2.zzc().zzk(str, zzfy.zzau).split(","));
        ...
        zzN(builder, "gmp_app_id", zzicVar.zzac(), setM829m);
        zzicVar2.zzc().zzi();
        zzN(builder, "gmp_version", String.valueOf(133005L), setM829m);
        ...
        zzN(builder, "app_instance_id", strZzV, setM829m);
        zzN(builder, "rdid", zzicVar.zzP(), setM829m);
        zzN(builder, "bundle_id", zzicVar.zzK(), setM829m);
        String strZzk2 = zzhrVar.zzk();
        String strZza = zzjm.zza(strZzk2);
        if (true != TextUtils.isEmpty(strZza)) {
            strZzk2 = strZza;
        }
        zzN(builder, "app_event_name", strZzk2, setM829m);
        zzN(builder, "app_version", String.valueOf(zzicVar.zzai()), setM829m);
        ...
        zzN(builder, "os_version", strZzD, setM829m);
        zzN(builder, "timestamp", String.valueOf(zzhrVar.zzn()), setM829m);
        boolean zZzS = zzicVar.zzS();
        String str3 = Constants.SdidMigrationStatusCodes.ALREADY_SDID;
        if (zZzS) {
            zzN(builder, "lat", Constants.SdidMigrationStatusCodes.ALREADY_SDID, setM829m);
        }
        zzN(builder, "privacy_sandbox_version", String.valueOf(zzicVar.zzaG()), setM829m);
        zzN(builder, "trigger_uri_source", Constants.SdidMigrationStatusCodes.ALREADY_SDID, setM829m);
        zzN(builder, "trigger_uri_timestamp", String.valueOf(jCurrentTimeMillis), setM829m);
        zzN(builder, "request_uuid", str2, setM829m);
        ...
        zzQ(builder, zzicVar2.zzc().zzk(str, zzfy.zzat).split("\\|"), bundle, setM829m);
        ...
        zzQ(builder, zzicVar2.zzc().zzk(str, zzfy.zzas).split("\\|"), bundle2, setM829m);
        if (true != zzicVar.zzaC()) {
            str3 = "0";
        }
        zzN(builder, "dma", str3, setM829m);
        if (!zzicVar.zzaE().isEmpty()) {
            zzN(builder, "dma_cps", zzicVar.zzaE(), setM829m);
        }
        if (zzicVar.zzaK()) {
            com.google.android.gms.internal.measurement.zzha zzhaVarZzaL = zzicVar.zzaL();
            if (!zzhaVarZzaL.zzb().isEmpty()) {
                zzN(builder, "dl_gclid", zzhaVarZzaL.zzb(), setM829m);
            }
            if (!zzhaVarZzaL.zzd().isEmpty()) {
                zzN(builder, "dl_gbraid", zzhaVarZzaL.zzd(), setM829m);
            }
            if (!zzhaVarZzaL.zzf().isEmpty()) {
                zzN(builder, "dl_gs", zzhaVarZzaL.zzf(), setM829m);
            }
            if (zzhaVarZzaL.zzh() > 0) {
                zzN(builder, "dl_ss_ts", String.valueOf(zzhaVarZzaL.zzh()), setM829m);
            }
            if (!zzhaVarZzaL.zzj().isEmpty()) {
                zzN(builder, "mr_gclid", zzhaVarZzaL.zzj(), setM829m);
            }
            if (!zzhaVarZzaL.zzm().isEmpty()) {
                zzN(builder, "mr_gbraid", zzhaVarZzaL.zzm(), setM829m);
            }
            if (!zzhaVarZzaL.zzo().isEmpty()) {
                zzN(builder, "mr_gs", zzhaVarZzaL.zzo(), setM829m);
            }
            if (zzhaVarZzaL.zzq() > 0) {
                zzN(builder, "mr_click_ts", String.valueOf(zzhaVarZzaL.zzq()), setM829m);
            }
        }

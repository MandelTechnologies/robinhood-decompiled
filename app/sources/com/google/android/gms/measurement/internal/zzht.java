...
public final class zzht extends zzos implements zzak {
    ...
    final boolean zzn(String str) {
        return Constants.SdidMigrationStatusCodes.ALREADY_SDID.equals(zza(str, "measurement.upload.blacklist_internal"));
    }

    final boolean zzo(String str) {
        return Constants.SdidMigrationStatusCodes.ALREADY_SDID.equals(zza(str, "measurement.upload.blacklist_public"));
    }
    ...
    final boolean zzr(String str) throws Throwable {
        ...
        zzE(str);
        Map map = this.zza;
        return map.get(str) != null && ((Set) map.get(str)).contains(MatchaQrCodeDuxo6.USER_ID_KEY);
    }

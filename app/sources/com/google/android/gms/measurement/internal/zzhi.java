    ...
    public final void run() throws IllegalStateException {
        ...
        if (bundleZze != null) {
            ...
            if (j == 0) {
                ...
                String string2 = bundleZze.getString(Constants.INSTALL_REFERRER);
                if (string2 == null || string2.isEmpty()) {
                    zzicVar2.zzaV().zzb().zza("No referrer defined in Install Referrer response");
                } else {
                    zzicVar2.zzaV().zzk().zzb("InstallReferrer API result", string2);
                    Bundle bundleZzi = zzicVar2.zzk().zzi(Uri.parse("?".concat(string2)));
                    if (bundleZzi == null) {

    ...
    public final void run() throws IOException {
        ...
        try {
            ...
            if (responseCode == 200) {
                ...
                zba.m812e("Unable to revoke access!", new Object[0]);
            }
            zba.m811d("Response Code: " + responseCode, new Object[0]);
        } catch (IOException e) {
            zba.m812e("IOException when revoking access: ".concat(String.valueOf(e.toString())), new Object[0]);
        } catch (Exception e2) {
            zba.m812e("Exception when revoking access: ".concat(String.valueOf(e2.toString())), new Object[0]);
        }

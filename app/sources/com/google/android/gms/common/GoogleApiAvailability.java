...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public void showErrorNotification(Context context, int i) throws Resources.NotFoundException {
        zae(context, i, null, getErrorResolutionPendingIntent(context, i, 0, Constants.RequestParamsKeys.APP_NAME_KEY));
    }
        ...
        if (PlatformVersion.isAtLeastO()) {
            ...
            if (str2 == null) {
                ...
                if (notificationChannel == null) {
                    notificationManager.createNotificationChannel(GoogleApiAvailability$$ExternalSyntheticApiModelOutline4.m803m("com.google.android.gms.availability", string2, 4));

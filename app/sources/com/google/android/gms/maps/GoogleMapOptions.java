...
public final class GoogleMapOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    private static final Integer zza = Integer.valueOf(Color.argb(255, EnumC7081g.SDK_ASSET_ILLUSTRATION_INSTITUTION_TRANSFER_CIRCLE_VALUE, EnumC7081g.SDK_ASSET_ILLUSTRATION_INFOCARD_BANKSTATEMENT_VALUE, 225));
    private Boolean zzb;
    private Boolean zzc;
    private int zzd;
    ...
    public static GoogleMapOptions createFromAttributes(Context context, AttributeSet attributeSet) {
        ...
        if (typedArrayObtainAttributes.hasValue(R$styleable.MapAttrs_mapId) && (string2 = typedArrayObtainAttributes.getString(R$styleable.MapAttrs_mapId)) != null && !string2.isEmpty()) {
            googleMapOptions.mapId(string2);
        }

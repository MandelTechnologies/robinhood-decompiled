...
public class AuthenticatorSelectionCriteria extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public AuthenticatorSelectionCriteria build() {
            ...
            String string2 = attachment == null ? null : attachment.toString();
            Boolean bool = this.zzb;
            ResidentKeyRequirement residentKeyRequirement = this.zzc;
            return new AuthenticatorSelectionCriteria(string2, bool, null, residentKeyRequirement == null ? null : residentKeyRequirement.toString());
        }

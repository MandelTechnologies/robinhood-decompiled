...
final class zzlk extends zzlm {
    ...
    /* synthetic */ zzlk(InputStream inputStream, int i, zzlj zzljVar) {
        super(null);
    ...
    private final void zzL(int i) throws IOException {
        ...
        throw new zznv("Protocol message was too large.  May be malicious.  Use CodedInputStream.setSizeLimit() to increase the size limit.");
    }
    ...
    @Override // com.google.android.recaptcha.internal.zzlm
    ...
    final long zzs() throws IOException {
        ...
        throw new zznv("CodedInputStream encountered a malformed varint.");
    }
    ...
    public final zzlg zzw() throws IOException {
        ...
        int i2 = this.zzi;
        if (iZzj <= i - i2 && iZzj > 0) {
            zzlg zzlgVarZzk = zzlg.zzk(this.zzf, i2, iZzj);
            this.zzi += iZzj;
            return zzlgVarZzk;
        }
        if (iZzj == 0) {
        ...
        if (bArrZzO != null) {
            return zzlg.zzk(bArrZzO, 0, bArrZzO.length);
        }
        int i3 = this.zzi;
        int i4 = this.zzg;
        int i5 = i4 - i3;
    ...
    public final String zzx() throws IOException {
        ...
        if (iZzj > 0) {
            ...
            int i2 = this.zzi;
            if (iZzj <= i - i2) {
                String str = new String(this.zzf, i2, iZzj, zznt.zza);
                this.zzi += iZzj;
                return str;
            }
        }
        ...
        if (iZzj > this.zzg) {
            return new String(zzN(iZzj, false), zznt.zza);
        }
        zzL(iZzj);
        String str2 = new String(this.zzf, this.zzi, iZzj, zznt.zza);
        this.zzi += iZzj;
        return str2;
    }
    ...
    public final String zzy() throws IOException {
        ...
        return zzqf.zzd(bArrZzN, i, iZzj);
    }

    @Override // com.google.android.recaptcha.internal.zzlm
    public final void zzz(int i) throws zznv {
        if (this.zzj != i) {
    ...
    @Override // com.google.android.recaptcha.internal.zzlm
    public final int zze(int i) throws zznv {
        if (i < 0) {
            throw new zznv("CodedInputStream encountered an embedded string or message which claimed to have negative size.");
        }

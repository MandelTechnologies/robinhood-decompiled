...
final class zznd extends zzkt implements RandomAccess, zzns, zzoz {
    private float[] zza;
    private int zzb;

    static {
        new zznd(new float[0], 0, false);
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zznt.zzb;
        collection.getClass();
        if (!(collection instanceof zznd)) {
            return super.addAll(collection);
        }
        zznd zzndVar = (zznd) collection;
        int i = zzndVar.zzb;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zzndVar.zza, 0, this.zza, this.zzb, zzndVar.zzb);
        this.zzb = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzb != zzndVar.zzb) {
            return false;
        }
        float[] fArr = zzndVar.zza;
    ...
    public final /* bridge */ /* synthetic */ zzns zzd(int i) {
        if (i >= this.zzb) {
            return new zznd(Arrays.copyOf(this.zza, i), this.zzb, true);
        }
    ...
    private zznd(float[] fArr, int i, boolean z) {
        super(z);
        this.zza = fArr;
        this.zzb = i;
    }

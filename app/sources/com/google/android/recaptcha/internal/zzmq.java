...
final class zzmq extends zzkt implements RandomAccess, zzns, zzoz {
    private double[] zza;
    private int zzb;

    static {
        new zzmq(new double[0], 0, false);
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zznt.zzb;
        collection.getClass();
        if (!(collection instanceof zzmq)) {
            return super.addAll(collection);
        }
        zzmq zzmqVar = (zzmq) collection;
        int i = zzmqVar.zzb;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zzmqVar.zza, 0, this.zza, this.zzb, zzmqVar.zzb);
        this.zzb = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzb != zzmqVar.zzb) {
            return false;
        }
        double[] dArr = zzmqVar.zza;
    ...
    public final /* bridge */ /* synthetic */ zzns zzd(int i) {
        if (i >= this.zzb) {
            return new zzmq(Arrays.copyOf(this.zza, i), this.zzb, true);
        }
    ...
    private zzmq(double[] dArr, int i, boolean z) {
        super(z);
        this.zza = dArr;
        this.zzb = i;
    }

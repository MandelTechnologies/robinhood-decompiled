...
interface zzpd {
    ...
    @Deprecated
    void zzC(List list, zzpe zzpeVar, zzmw zzmwVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzpe zzpeVar, zzmw zzmwVar) throws IOException;
    ...
    zzlg zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzpe zzpeVar, zzmw zzmwVar) throws IOException;

    void zzu(Object obj, zzpe zzpeVar, zzmw zzmwVar) throws IOException;

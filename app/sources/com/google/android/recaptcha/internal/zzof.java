...
final class zzof extends zzkt implements RandomAccess, zznr, zzoz {
    private static final zzof zza = new zzof(new long[0], 0, false);
    private long[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zznt.zzb;
        collection.getClass();
        if (!(collection instanceof zzof)) {
            return super.addAll(collection);
        }
        zzof zzofVar = (zzof) collection;
        int i = zzofVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zzofVar.zzb, 0, this.zzb, this.zzc, zzofVar.zzc);
        this.zzc = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzofVar.zzc) {
            return false;
        }
        long[] jArr = zzofVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzns zzd(int i) {
        if (i >= this.zzc) {
            return new zzof(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzof(long[] jArr, int i, boolean z) {
        super(z);
        this.zzb = jArr;
        this.zzc = i;
    }

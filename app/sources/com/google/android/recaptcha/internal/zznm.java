...
final class zznm extends zzkt implements RandomAccess, zznq, zzoz {
    private static final zznm zza = new zznm(new int[0], 0, false);
    private int[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zznt.zzb;
        collection.getClass();
        if (!(collection instanceof zznm)) {
            return super.addAll(collection);
        }
        zznm zznmVar = (zznm) collection;
        int i = zznmVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zznmVar.zzb, 0, this.zzb, this.zzc, zznmVar.zzc);
        this.zzc = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zznmVar.zzc) {
            return false;
        }
        int[] iArr = zznmVar.zzb;
    ...
    public final zznq zzd(int i) {
        if (i >= this.zzc) {
            return new zznm(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zznm(int[] iArr, int i, boolean z) {
        super(z);
        this.zzb = iArr;
        this.zzc = i;
    }

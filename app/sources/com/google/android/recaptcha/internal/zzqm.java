...
public final class zzqm {
    ...
    protected zzqm(byte[] bArr, byte[] bArr2) {
        if (bArr.length != 32) {
    ...
    public static String zze(String str, byte[] bArr, zzqn zzqnVar) {
        ...
        return new String(new zzqm(bArr, bArr2).zzd(bArr3), zza);
    }

    public static String zzf(String str, byte[] bArr, zzqn zzqnVar) {
        byte[] bArr2 = new byte[12];
        new SecureRandom().nextBytes(bArr2);
        byte[] bArrZzd = new zzqm(bArr, bArr2).zzd(str.getBytes(zza));

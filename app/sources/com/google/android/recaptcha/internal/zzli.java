...
final class zzli extends zzlm {
    ...
    /* synthetic */ zzli(byte[] bArr, int i, int i2, boolean z, zzlh zzlhVar) {
        super(null);
    ...
    public final zzlg zzw() throws IOException {
        ...
        if (iZzj > 0) {
            ...
            int i2 = this.zzh;
            if (iZzj <= i - i2) {
                zzlg zzlgVarZzk = zzlg.zzk(this.zze, i2, iZzj);
                this.zzh += iZzj;
                return zzlgVarZzk;
            }
        }
        ...
        if (iZzj > 0) {
            ...
            if (iZzj <= i3 - i4) {
                int i5 = iZzj + i4;
                this.zzh = i5;
                return new zzlf(Arrays.copyOfRange(this.zze, i4, i5));
            }
        }
        if (iZzj <= 0) {
    ...
    public final String zzx() throws IOException {
        ...
        if (iZzj > 0) {
            ...
            int i2 = this.zzh;
            if (iZzj <= i - i2) {
                String str = new String(this.zze, i2, iZzj, zznt.zza);
                this.zzh += iZzj;
                return str;
            }
        }
    ...
    public final String zzy() throws IOException {
        ...
        if (iZzj > 0) {
            ...
            int i2 = this.zzh;
            if (iZzj <= i - i2) {
                String strZzd = zzqf.zzd(this.zze, i2, iZzj);
                this.zzh += iZzj;
                return strZzd;
            }
        }

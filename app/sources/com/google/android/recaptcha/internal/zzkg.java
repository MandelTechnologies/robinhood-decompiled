...
final class zzkg extends zzki {
    zzkg(String str, String str2, Character ch) {
        zzkf zzkfVar = new zzkf(str, str2.toCharArray());
        super(zzkfVar, ch);
        zzjh.zza(zzkfVar.zzf.length == 64);
    }

    @Override // com.google.android.recaptcha.internal.zzki, com.google.android.recaptcha.internal.zzkj
    final int zza(byte[] bArr, CharSequence charSequence) throws zzkh {

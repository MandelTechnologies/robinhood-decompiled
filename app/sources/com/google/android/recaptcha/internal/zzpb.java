...
final class zzpb extends zzkt implements RandomAccess {
    private static final zzpb zza = new zzpb(new Object[0], 0, false);
    private Object[] zzb;
    private int zzc;
    ...
    public final /* bridge */ /* synthetic */ zzns zzd(int i) {
        if (i >= this.zzc) {
            return new zzpb(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
        throw new IllegalArgumentException();
    }

    private zzpb(Object[] objArr, int i, boolean z) {
        super(z);
        this.zzb = objArr;
        this.zzc = i;
    }

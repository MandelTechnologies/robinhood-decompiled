...
public final class AutocompleteImplFragment extends Fragment {
    ...
    public final void onViewCreated(@RecentlyNonNull View view, Bundle bundle) throws Throwable {
        int identifier;
        try {
            this.zzg = (EditText) view.findViewById(C4882R.id.places_autocomplete_search_bar);
            this.zzh = (RecyclerView) view.findViewById(C4882R.id.places_autocomplete_list);
            this.zzi = view.findViewById(C4882R.id.places_autocomplete_back_button);
            this.zzj = view.findViewById(C4882R.id.places_autocomplete_clear_button);
            this.zzk = view.findViewById(C4882R.id.places_autocomplete_search_bar_separator);
            this.zzl = view.findViewById(C4882R.id.places_autocomplete_progress);
            this.zzm = view.findViewById(C4882R.id.places_autocomplete_try_again_progress);
            this.zzn = view.findViewById(C4882R.id.places_autocomplete_powered_by_google);
            this.zzo = view.findViewById(C4882R.id.places_autocomplete_powered_by_google_separator);
            this.zzp = view.findViewById(C4882R.id.places_autocomplete_sad_cloud);
            this.zzq = (TextView) view.findViewById(C4882R.id.places_autocomplete_error_message);
            this.zzr = (TextView) view.findViewById(C4882R.id.places_autocomplete_try_again);
            this.zzg.addTextChangedListener(this.zzt);
            this.zzg.setOnFocusChangeListener(new zzl(null));
            this.zzg.setHint(TextUtils.isEmpty(this.zzb.zzl()) ? zzkw.zzc(requireContext(), C4882R.string.places_autocomplete_search_hint) : this.zzb.zzl());
            ...
            if (iOrdinal == 0) {
                ...
                if (iZza != 0 && iZzb != 0) {
                    int iZza2 = zzkx.zza(iZza, ContextCompat.getColor(requireContext(), C4882R.color.places_text_white_alpha_87), ContextCompat.getColor(requireContext(), C4882R.color.places_text_black_alpha_87));
                    int iZza3 = zzkx.zza(iZza, ContextCompat.getColor(requireContext(), C4882R.color.places_text_white_alpha_26), ContextCompat.getColor(requireContext(), C4882R.color.places_text_black_alpha_26));
                    view.findViewById(C4882R.id.places_autocomplete_search_bar_container).setBackgroundColor(iZza);
                    Window window = requireActivity().getWindow();
                    if (zzkx.zzc(iZzb, -1, -16777216)) {
            ...
            } else if (iOrdinal == 1 && (identifier = getResources().getIdentifier("status_bar_height", ResourceTypes.DIMENSION, "android")) > 0) {
    ...
    final /* synthetic */ void zzg(zzkv zzkvVar) throws Throwable {
        try {
            ...
            switch (zzkvVar.zzf() - 1) {
                ...
                case 5:
                    ...
                    this.zzq.setText(getString(C4882R.string.places_autocomplete_no_results_for_query, zzkvVar.zze()));
                    this.zzq.setVisibility(0);
                    return;
                case 6:
                    break;
            ...
            this.zzq.setText(getString(C4882R.string.places_search_error));
            this.zzq.setVisibility(0);
        } catch (Error e) {
            e = e;
            zzkd.zzb(e);

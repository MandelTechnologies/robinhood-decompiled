...
public final class zzt extends RecyclerView.ViewHolder {
    ...
    public zzt(final zzd zzdVar, View view) {
        super(view);
        this.zza = (TextView) view.findViewById(C4882R.id.places_autocomplete_prediction_primary_text);
        this.zzb = (TextView) view.findViewById(C4882R.id.places_autocomplete_prediction_secondary_text);
    ...
    public final void zza(AutocompletePrediction autocompletePrediction, boolean z) {
        ...
        this.zzd = z;
        this.zza.setText(autocompletePrediction.getPrimaryText(new ForegroundColorSpan(ContextCompat.getColor(this.itemView.getContext(), C4882R.color.places_autocomplete_prediction_primary_text_highlight))));

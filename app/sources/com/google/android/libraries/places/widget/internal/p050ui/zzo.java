...
public final class zzo extends DefaultItemAnimator {
    ...
    public zzo(Resources resources) {
        this.zzd = resources.getDimensionPixelSize(C4882R.dimen.places_autocomplete_vertical_dropdown);
    }
    ...
    public final boolean animateAdd(RecyclerView.ViewHolder viewHolder) throws Throwable {
        try {
    ...
    public final void endAnimation(RecyclerView.ViewHolder viewHolder) throws Throwable {
        try {

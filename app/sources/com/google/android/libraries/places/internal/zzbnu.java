...
final class zzbnu implements zzbde {
    ...
    private static final zzbdd zzc(InetSocketAddress inetSocketAddress) throws IOException {
        try {
            try {
                URI uri = new URI(Constants.SCHEME, null, zzbjd.zze(inetSocketAddress), inetSocketAddress.getPort(), null, null, null);
                ...
                PasswordAuthentication passwordAuthenticationZza = zzbns.zza(zzbjd.zze(inetSocketAddress2), inetSocketAddress2.getAddress(), inetSocketAddress2.getPort(), Constants.SCHEME, "", null);

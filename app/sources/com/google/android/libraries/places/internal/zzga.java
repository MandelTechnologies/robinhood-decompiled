...
public final class zzga implements PlacesClient {
    ...
    @Override // com.google.android.libraries.places.api.net.PlacesClient
    public final Task zzb(final FetchPlaceRequest fetchPlaceRequest, final int i) throws Throwable {
        try {
    ...
    @Override // com.google.android.libraries.places.api.net.PlacesClient
    public final Task zzd(final FindAutocompletePredictionsRequest findAutocompletePredictionsRequest, final int i) throws Throwable {
        try {
    ...
    public final Task zzf(IsOpenRequest isOpenRequest, int i) throws Throwable {
        List arrayList;
        try {
            ...
            final zzej zzejVarZza = zzej.zza();
            final int i3 = 1;
            return this.zzg.zzh() ? this.zzf.zzg(fetchPlaceRequestBuild, 1).continueWith(new Continuation(fetchPlaceRequestBuild, i3, zzejVarZza) { // from class: com.google.android.libraries.places.internal.zzfx
                public final /* synthetic */ FetchPlaceRequest zzb;
                public final /* synthetic */ zzej zzc;
            ...
            }).continueWithTask(new zzfr()) : this.zza.zzb(fetchPlaceRequestBuild, 1).continueWith(new Continuation(fetchPlaceRequestBuild, i3, zzejVarZza) { // from class: com.google.android.libraries.places.internal.zzfz
                public final /* synthetic */ FetchPlaceRequest zzb;
                public final /* synthetic */ zzej zzc;

...
public final class zzbsz {
    ...
    public final String toString() {
        ...
        String string2 = listZza == null ? "[use default]" : listZza.toString();
        zzbtn[] zzbtnVarArr = new zzbtn[this.zzh.length];
        while (true) {
            String[] strArr3 = this.zzh;
            if (i >= strArr3.length) {
                return "ConnectionSpec(cipherSuites=" + string2 + ", tlsVersions=" + String.valueOf(zzbto.zza(zzbtnVarArr)) + ", supportsTlsExtensions=" + this.zze + ")";
            }

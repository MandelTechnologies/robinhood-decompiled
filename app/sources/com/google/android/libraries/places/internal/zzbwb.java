...
public final class zzbwb implements Cloneable, ByteChannel, zzbwd, zzbwc {
        ...
        while (j > 0) {
            ...
            if (j < j2) {
                ...
                if (zzbwnVar != null && zzbwnVar.zzf) {
                    if ((zzbwnVar.zzd + j) - (zzbwnVar.zze ? 0 : zzbwnVar.zzc) <= 8192) {
                        zzbwn zzbwnVar5 = source.zza;
                        Intrinsics.checkNotNull(zzbwnVar5);
                        zzbwnVar5.zze(zzbwnVar, i3);
                        source.zzb -= j;
                        this.zzb += j;
                        return;
                    }
            ...
            if (zzbwnVar8 == null) {
                ...
                if (zzbwnVar10.zzf) {
                    ...
                    if (i5 <= i6 + i2) {
                        ...
                        Intrinsics.checkNotNull(zzbwnVar14);
    ...
    public final zzbwb zzs(String string2) {
        Intrinsics.checkNotNullParameter(string2, "string");
        zzt(string2, 0, string2.length());
        return this;
    }

    public final zzbwb zzt(String string2, int i, int i2) {
        Intrinsics.checkNotNullParameter(string2, "string");
        if (i2 < 0) {
            throw new IllegalArgumentException("endIndex < beginIndex: " + i2 + " < 0");
        }
        if (i2 > string2.length()) {
            throw new IllegalArgumentException("endIndex > string.length: " + i2 + " > " + string2.length());
        }
        int i3 = 0;
        while (i3 < i2) {
            int i4 = i3 + 1;
            ...
            if (cCharAt < 128) {
                ...
                i3 = i4;
                while (i3 < iMin) {
                    char cCharAt2 = string2.charAt(i3);
                    if (cCharAt2 >= 128) {
                        break;
                    }
                ...
                if (cCharAt < 2048) {
                    ...
                    char cCharAt3 = i4 < i2 ? string2.charAt(i4) : (char) 0;
                    if (cCharAt > 56319 || cCharAt3 < 56320 || cCharAt3 >= 57344) {
                        ...
                        bArr4[i10] = (byte) ((i11 >> 18) | EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_CIRCLE_VALUE);
    ...
    public final zzbwb zzu(int i) {
        ...
        bArr3[i4] = (byte) ((i >> 18) | EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_CIRCLE_VALUE);
    ...
    public final String zzj(long j) throws EOFException {
        ...
        if (j7 == 0 || (zzbwnVar = this.zza) == null) {
            ...
            loop3: while (j6 < j7) {
                ...
                j2 = j8;
                j3 = -1;
                int iMin = (int) Math.min(zzbwnVar.zzd, (zzbwnVar.zzc + j7) - j6);
                for (int i = (int) ((zzbwnVar.zzc + j9) - j6); i < iMin; i++) {
                    if (bArr[i] == 10) {
                        j4 = i - zzbwnVar.zzc;
                        j5 = j4 + j6;
                        break loop3;
                ...
                j9 = j6 + (zzbwnVar.zzd - zzbwnVar.zzc);
                zzbwnVar = zzbwnVar.zzg;
                Intrinsics.checkNotNull(zzbwnVar);
                j8 = j2;
                j6 = j9;
            ...
            j6 = 0;
            while (true) {
                long j10 = (zzbwnVar.zzd - zzbwnVar.zzc) + j6;
                if (j10 > 0) {
                    break;
                }
                zzbwnVar = zzbwnVar.zzg;
            ...
            loop6: while (j6 < j7) {
                ...
                int iMin2 = (int) Math.min(zzbwnVar.zzd, (zzbwnVar.zzc + j7) - j6);
                for (int i2 = (int) ((zzbwnVar.zzc + j11) - j6); i2 < iMin2; i2++) {
                    if (bArr2[i2] == 10) {
                        j4 = i2 - zzbwnVar.zzc;
                        j5 = j4 + j6;
                        break loop3;
                ...
                j11 = (zzbwnVar.zzd - zzbwnVar.zzc) + j6;
                zzbwnVar = zzbwnVar.zzg;
                Intrinsics.checkNotNull(zzbwnVar);
                j6 = j11;
            }

...
final class zzbfq extends zzayo {
    ...
    private static final byte[] zzb = ContentEncoding.GZIP.getBytes(Charset.forName("US-ASCII"));
    ...
    zzbfq(zzbcl zzbclVar, Executor executor, zzayj zzayjVar, zzbfp zzbfpVar, ScheduledExecutorService scheduledExecutorService, zzbfg zzbfgVar, zzbam zzbamVar) {
        this.zzd = zzbclVar;
    ...
    public final String toString() {
        ...
        zzmmVarZzb.zzd("method", this.zzd);

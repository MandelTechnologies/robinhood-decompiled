...
final class zzbtu {
    ...
    final int zza(int i, int i2) throws IOException {
        ...
        while (true) {
            ...
            i2 += (iZzh & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) << i4;
            i4 += 7;
        }
    }
    ...
    final zzbwf zzc() throws IOException {
        int iZzh = zzh();
        int i = iZzh & 128;
        long jZza = zza(iZzh, EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE);
        if (i != 128) {
    ...
    */
    final void zze() throws IOException {
        ...
        while (true) {
            ...
            if ((bZzc & 128) == 128) {
                int iZza2 = zza(i, EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE);
                int i2 = iZza2 - 1;
                if (!zzm(i2)) {
                    int length = zzbtw.zzb.length;

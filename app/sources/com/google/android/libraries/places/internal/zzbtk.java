...
final class zzbtk implements InvocationHandler {
    ...
    public final Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
        ...
        if (name.equals(OptionChainCustomizationLogging.UNSUPPORTED_TOAST_IDENTIFIER) && Void.TYPE == returnType) {
            this.zzb = true;
            return null;
        }
        ...
        if ((name.equals("selectProtocol") || name.equals(Fields4.TYPE)) && returnType == String.class && objArr.length == 1) {

...
public final class zzaxg {
    ...
    public static String zza(zzawl zzawlVar) {
        ...
        if (iZzc2 != 0) {
            sb.append(".");
            sb.append(iZzc2 % InvestFlowConstants.MAX_ONE_TIME_AMOUNT == 0 ? String.format(Locale.ENGLISH, "%1$03d", Integer.valueOf(iZzc2 / InvestFlowConstants.MAX_ONE_TIME_AMOUNT)) : iZzc2 % 1000 == 0 ? String.format(Locale.ENGLISH, "%1$06d", Integer.valueOf(iZzc2 / 1000)) : String.format(Locale.ENGLISH, "%1$09d", Integer.valueOf(iZzc2)));
        }
        sb.append("Z");
        return sb.toString();
    }

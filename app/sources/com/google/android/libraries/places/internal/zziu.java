...
public final class zziu implements zzev {
    ...
    public final Task zza(FetchPhotoRequest fetchPhotoRequest, int i) {
        ...
        Task taskContinueWith = zzfgVar.zzb(zzhrVar, new zzhs()).continueWith(new Continuation() { // from class: com.google.android.libraries.places.internal.zzim
        ...
        final int i2 = 1;
        return taskContinueWith.continueWith(new Continuation(jZza, i2) { // from class: com.google.android.libraries.places.internal.zzin
    ...
    public final Task zzd(FindCurrentPlaceRequest findCurrentPlaceRequest, Location location, zznx zznxVar, int i) {
        ...
        zzfa zzfaVar = this.zzb;
        final long jZza = zzdvVar.zza();
        Task taskContinueWith = zzfaVar.zza(zzifVar, zzig.class).continueWith(new Continuation() { // from class: com.google.android.libraries.places.internal.zziq
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task) {
        ...
        final int i2 = 1;
        return taskContinueWith.continueWith(new Continuation(jZza, i2) { // from class: com.google.android.libraries.places.internal.zzir
            public final /* synthetic */ long zzb;

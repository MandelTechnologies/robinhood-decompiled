...
final class zzbtv {
    ...
    final void zza(zzbwf zzbwfVar) throws IOException {
        zzc(zzbwfVar.zzc(), EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE, 0);
    ...
    */
    final void zzb(List list) throws IOException {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (i2 != -1) {
                zzc(i2, EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE, 128);
            } else if (i == -1) {
                this.zzc.zzm(64);
                zza(zzbwfVarZzg);
                zza(zzbwfVar);
    ...
    final void zzc(int i, int i2, int i3) throws IOException {
        ...
        int i4 = i - i2;
        while (i4 >= 128) {
            this.zzc.zzm(128 | (i4 & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE));
            i4 >>>= 7;
        }
        this.zzc.zzm(i4);
    }

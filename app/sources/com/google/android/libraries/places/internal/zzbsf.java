...
final class zzbsf implements zzbgf, zzbrj, zzbsr {
    ...
    public zzbsf(zzbru zzbruVar, InetSocketAddress inetSocketAddress, String str, String str2, zzaye zzayeVar, zzbaa zzbaaVar, Runnable runnable) {
        ...
        this.zzf = str;
        this.zzv = 4194304;
        this.zzj = Blake2xsDigest.UNKNOWN_DIGEST_LENGTH;
    ...
    static /* bridge */ /* synthetic */ Socket zzA(zzbsf zzbsfVar, InetSocketAddress inetSocketAddress, InetSocketAddress inetSocketAddress2, String str, String str2) throws NumberFormatException, IOException, zzbdp {
        ...
        try {
            ...
            zzbujVar.zzc(Headers.USER_AGENT, zzbsfVar.zzg);
            ...
            try {
                ...
                try {
                    ...
                    zzbwbVar.zzs("Unable to read body: " + e2.toString());
                }
                try {
    ...
    final void zzP(int i, zzbdo zzbdoVar, zzbfs zzbfsVar, boolean z, zzbtp zzbtpVar, zzbcf zzbcfVar) {
        synchronized (this.zzo) {
            try {

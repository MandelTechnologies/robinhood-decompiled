...
abstract class zzx extends Place {
    ...
    public final String toString() {
        ...
        String string2 = booleanPlaceAttributeValue13.toString();
        String strValueOf4 = String.valueOf(openingHours2);
        String string3 = booleanPlaceAttributeValue12.toString();
        String string4 = booleanPlaceAttributeValue11.toString();
        ...
        String string5 = booleanPlaceAttributeValue10.toString();
        String strValueOf11 = String.valueOf(list2);
        String string6 = booleanPlaceAttributeValue9.toString();
        String string7 = booleanPlaceAttributeValue8.toString();
        String string8 = booleanPlaceAttributeValue7.toString();
        String string9 = booleanPlaceAttributeValue6.toString();
        String string10 = booleanPlaceAttributeValue5.toString();
        String string11 = booleanPlaceAttributeValue4.toString();
        String string12 = booleanPlaceAttributeValue3.toString();
        String string13 = booleanPlaceAttributeValue2.toString();
        ...
        String string14 = booleanPlaceAttributeValue.toString();

    ...
    static int applyMaskPenaltyRule3(ByteMatrix byteMatrix) {
        ...
        for (int i2 = 0; i2 < height; i2++) {
            for (int i3 = 0; i3 < width; i3++) {
                ...
                int i5 = i2 + 6;
                if (i5 < height && array2[i2][i3] == 1 && array2[i2 + 1][i3] == 0 && array2[i2 + 2][i3] == 1 && array2[i2 + 3][i3] == 1 && array2[i2 + 4][i3] == 1 && array2[i2 + 5][i3] == 0 && array2[i5][i3] == 1 && (isWhiteVertical(array2, i3, i2 - 4, i2) || isWhiteVertical(array2, i3, i2 + 7, i2 + 11))) {
                    i++;
                }
            }
        }
    ...
    private static int applyMaskPenaltyRule1Internal(ByteMatrix byteMatrix, boolean z) {
        ...
        for (int i2 = 0; i2 < height; i2++) {
            ...
            for (int i4 = 0; i4 < width; i4++) {
                byte b2 = z ? array2[i2][i4] : array2[i4][i2];
                if (b2 == b) {
                    i3++;
                } else {
                    if (i3 >= 5) {

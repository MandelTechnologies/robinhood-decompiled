...
public final class Encoder {
    ...
    */
    public static QRCode encode(String str, ErrorCorrectionLevel errorCorrectionLevel, Map<EncodeHintType, ?> map) throws NumberFormatException, WriterException {
        boolean z;
        boolean z2;
    ...
    static void terminateBits(int i, BitArray bitArray) throws WriterException {
        ...
        for (int i4 = 0; i4 < sizeInBytes; i4++) {
            bitArray.appendBits((i4 & 1) == 0 ? EnumC7081g.SDK_ASSET_ILLUSTRATION_INSTITUTION_TRANSFER_CIRCLE_VALUE : 17, 8);
        }
        if (bitArray.getSize() != i2) {
    ...
    static void appendBytes(String str, Mode mode, BitArray bitArray, Charset charset) throws WriterException {
        int i = C57191.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()];
        if (i == 1) {

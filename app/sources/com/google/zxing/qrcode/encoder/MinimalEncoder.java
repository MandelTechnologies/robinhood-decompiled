...
final class MinimalEncoder {
    ...
    static Version getVersion(VersionSize versionSize) {
        int i = C57201.f963x9d14eba6[versionSize.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C57201 {
        ...
        static {
            ...
            try {
                f963x9d14eba6[VersionSize.MEDIUM.ordinal()] = 2;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f963x9d14eba6[VersionSize.LARGE.ordinal()] = 3;
    ...
    boolean canEncode(Mode mode, char c) {
        int i = C57201.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()];
        if (i == 1) {
    ...
    static int getCompactedOrdinal(Mode mode) {
        int i;
        if (mode == null || (i = C57201.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()]) == 1) {
            return 0;
        }
        if (i == 2) {
            return 1;
    ...
    private final class Edge {
        ...
        /* synthetic */ Edge(MinimalEncoder minimalEncoder, Mode mode, int i, int i2, int i3, Edge edge, Version version, C57201 c57201) {
        ...
        private Edge(Mode mode, int i, int i2, int i3, Edge edge, Version version) {
            ...
            int i5 = C57201.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()];
            if (i5 == 1) {
    ...
    final class ResultList {
        ...
        ResultList(Version version, Edge edge) {
            ...
            int i8 = C57201.f963x9d14eba6[MinimalEncoder.getVersionSize(version).ordinal()];
            if (i8 == 1) {
                i2 = 9;
            } else if (i8 != 2) {
                i = 27;
        ...
        final class ResultNode {
            ...
            public int getSize(Version version) {
                ...
                int i2 = C57201.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[this.mode.ordinal()];
                if (i2 != 1) {
                    if (i2 == 2) {

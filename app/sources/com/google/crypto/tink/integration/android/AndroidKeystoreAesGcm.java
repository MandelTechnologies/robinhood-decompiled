...
public final class AndroidKeystoreAesGcm implements Aead {
    ...
    public byte[] encrypt(final byte[] plaintext, final byte[] aad) throws GeneralSecurityException, InterruptedException {
        try {
    ...
    @Override // com.google.crypto.tink.Aead
    public byte[] decrypt(final byte[] ciphertext, final byte[] aad) throws GeneralSecurityException, InterruptedException {
        try {

...
public final class AesGcmSiv implements Aead {
    ...
    public AesGcmSiv(final byte[] key) throws GeneralSecurityException {
        ...
        this.keySpec = new SecretKeySpec(key, BiometricChangeManager.ALGORITHM);
    }
    ...
    @Override // com.google.crypto.tink.Aead
    public byte[] decrypt(final byte[] ciphertext, final byte[] associatedData) throws GeneralSecurityException, ClassNotFoundException {
    ...
    private static AlgorithmParameterSpec getParams(final byte[] buf, int offset, int len) throws GeneralSecurityException, ClassNotFoundException {
        try {

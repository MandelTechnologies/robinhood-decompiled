...
final class MessageSchema<T> implements Schema<T> {
    ...
    */
    ...
    private int getSerializedSizeProto2(T t) {
        ...
        while (i4 < this.buffer.length) {
            ...
            if (iType <= 17) {
                ...
                i = (!this.useCachedSizeField || iType < FieldType.DOUBLE_LIST_PACKED.m1019id() || iType > FieldType.SINT64_LIST_PACKED.m1019id()) ? 0 : this.buffer[i4 + 2] & 1048575;
                i2 = 0;
            }
            long jOffset = offset(iTypeAndOffsetAt);
            int i9 = i3;
    ...
    private int getSerializedSizeProto3(T t) {
        ...
        for (int i2 = 0; i2 < this.buffer.length; i2 += 3) {
            ...
            long jOffset = offset(iTypeAndOffsetAt);
            int i3 = (iType < FieldType.DOUBLE_LIST_PACKED.m1019id() || iType > FieldType.SINT64_LIST_PACKED.m1019id()) ? 0 : this.buffer[i2 + 2] & 1048575;
            switch (iType) {
                case 0:
    ...
    */
    ...
    private <K, V> int parseMapField(T t, byte[] bArr, int i, int i2, int i3, long j, ArrayDecoders.Registers registers) throws IOException {
        ...
        return decodeMapEntry(bArr, i, i2, null, this.mapFieldSchema.forMutableMapData(object), registers);
    }
            ...
            if (i22 < i20) {
                ...
                if (iPositionForFieldNumber == i21) {
                    ...
                    if (iType <= 17) {
                        ...
                        switch (i12) {
                            ...
                            case 3:
                                ...
                                if (i31 == 0) {
                                    ...
                                    T t6 = t5;
                                    unsafe2 = unsafe3;
                                    unsafe2.putLong(t6, jOffset, registers2.long1);
                                    t4 = t6;
                                    i17 = i13 | i35;
                                    i20 = i2;
                                    i22 = iDecodeVarint64;
                            ...
                            case 14:
                                ...
                                if (i31 == 1) {
                                    T t7 = t5;
                                    unsafe3.putLong(t7, jOffset, ArrayDecoders.decodeFixed64(bArr3, i29));
                                    unsafe3 = unsafe3;
                                    t5 = t7;
                            ...
                            case 16:
                                ...
                                if (i31 == 0) {
                                    ...
                                    unsafe7.putLong(t8, jOffset, CodedInputStream.decodeZigZag64(registers.long1));
                                    t5 = t8;
                                    int i38 = i14;
                                    i26 = i13 | i35;
                                    bArr5 = bArr;
                        ...
                        if (iType == 27) {
                            if (i31 == 2) {
                                Internal.ProtobufList protobufListMutableCopyWithCapacity2 = (Internal.ProtobufList) unsafe8.getObject(t9, jOffset);
                                if (!protobufListMutableCopyWithCapacity2.isModifiable()) {
                                    int size = protobufListMutableCopyWithCapacity2.size();
                                    protobufListMutableCopyWithCapacity2 = protobufListMutableCopyWithCapacity2.mutableCopyWithCapacity2(size == 0 ? 10 : size * 2);
                                    unsafe8.putObject(t9, jOffset, protobufListMutableCopyWithCapacity2);
                                }
                                unsafe4 = unsafe8;
    ...
    private final <K, V> void mergeMap(Object obj, int i, Object obj2, ExtensionRegistryLite extensionRegistryLite, Reader reader) throws IOException {
        ...
        Map<?, ?> mapForMutableMapData = this.mapFieldSchema.forMutableMapData(object);
        this.mapFieldSchema.forMapMetadata(obj2);
        reader.readMap(mapForMutableMapData, null, extensionRegistryLite);
    }
    ...
    private final <K, V, UT, UB> UB filterUnknownEnumMap(int i, int i2, Map<K, V> map, Internal.EnumVerifier enumVerifier, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
        ...
        while (it.hasNext()) {
            ...
            if (!enumVerifier.isInRange(((Integer) next.getValue()).intValue())) {
                ...
                ByteString.CodedBuilder codedBuilderNewCodedBuilder = ByteString.newCodedBuilder(MapEntryLite.computeSerializedSize(null, next.getKey(), next.getValue()));
                try {
                    MapEntryLite.writeTo(codedBuilderNewCodedBuilder.getCodedOutput(), null, next.getKey(), next.getValue());

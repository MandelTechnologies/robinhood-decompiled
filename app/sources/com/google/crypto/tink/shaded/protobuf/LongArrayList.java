...
final class LongArrayList extends AbstractProtobufList<Long> implements Internal.LongList, RandomAccess, PrimitiveNonBoxingCollection {
    ...
    public boolean equals(Object obj) {
        ...
        long[] jArr = longArrayList.f9829array;
        for (int i = 0; i < this.size; i++) {
            if (this.f9829array[i] != jArr[i]) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode() {
        int iHashLong = 1;
        for (int i = 0; i < this.size; i++) {
            iHashLong = (iHashLong * 31) + Internal.hashLong(this.f9829array[i]);
        }
        return iHashLong;
    }
    ...
    public Internal.ProtobufList<Long> mutableCopyWithCapacity2(int i) {
        ...
        return new LongArrayList(Arrays.copyOf(this.f9829array, i), this.size);
    }
    ...
    public void addLong(long j) {
        ...
        if (i == jArr.length) {
            ...
            this.f9829array = jArr2;
        }
        long[] jArr3 = this.f9829array;
        int i2 = this.size;
        this.size = i2 + 1;
        jArr3[i2] = j;
    }
    ...
    private void addLong(int i, long j) {
        ...
        if (i2 < jArr.length) {
            ...
            System.arraycopy(jArr, 0, jArr2, 0, i);
            System.arraycopy(this.f9829array, i, jArr2, i + 1, this.size - i);
            this.f9829array = jArr2;
        }
        this.f9829array[i] = j;
        this.size++;
    ...
    public boolean addAll(Collection<? extends Long> collection) {
        ...
        long[] jArr = this.f9829array;
        if (i3 > jArr.length) {
            this.f9829array = Arrays.copyOf(jArr, i3);
        }
        System.arraycopy(longArrayList.f9829array, 0, this.f9829array, this.size, longArrayList.size);
        this.size = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public boolean remove(Object obj) {
        ensureIsMutable();
        for (int i = 0; i < this.size; i++) {
            if (obj.equals(Long.valueOf(this.f9829array[i]))) {
                long[] jArr = this.f9829array;

...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    private static boolean isValidType(WireFormat.FieldType fieldType, Object obj) {
        ...
        switch (C53351.$SwitchMap$com$google$protobuf$WireFormat$JavaType[fieldType.getJavaType().ordinal()]) {
            case 7:
    ...
    static int computeElementSizeNoTag(WireFormat.FieldType fieldType, Object obj) {
        switch (C53351.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:

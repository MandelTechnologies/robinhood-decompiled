...
import com.google.firebase.perf.p052v1.GaugeMetadata;
...
public class GaugeManager {
    ...
    private GaugeManager() {
        this(new Lazy(new Provider() { // from class: com.google.firebase.perf.session.gauges.GaugeManager$$ExternalSyntheticLambda2
            ...
            @Override // com.google.firebase.inject.Provider
            public final Object get() {
                return GaugeManager.$r8$lambda$j5erG_A0Rdw7nFjKKUqwgsZvu3Q();
            }
        }), new Lazy(new Provider() { // from class: com.google.firebase.perf.session.gauges.GaugeManager$$ExternalSyntheticLambda4
            @Override // com.google.firebase.inject.Provider
            public final Object get() {
                return GaugeManager.m9291$r8$lambda$BWISMzAHQe8qlp3y7Z7QjyRJ74();
            }
        }));
    }

    public static /* synthetic */ CpuGaugeCollector $r8$lambda$j5erG_A0Rdw7nFjKKUqwgsZvu3Q() {
        return new CpuGaugeCollector();
    }

    /* renamed from: $r8$lambda$BWISMzAHQe8qlp3y7Z7QjyR-J74, reason: not valid java name */
    public static /* synthetic */ MemoryGaugeCollector m9291$r8$lambda$BWISMzAHQe8qlp3y7Z7QjyRJ74() {
        ...
        try {
            ...
            this.gaugeManagerDataCollectionJob = this.gaugeManagerExecutor.get().scheduleAtFixedRate(new Runnable() { // from class: com.google.firebase.perf.session.gauges.GaugeManager$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    this.f$0.syncFlush(strSessionId, applicationProcessState);
                }
    ...
    public void stopCollectingGauges() {
        ...
        this.gaugeManagerExecutor.get().schedule(new Runnable() { // from class: com.google.firebase.perf.session.gauges.GaugeManager$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.syncFlush(str, applicationProcessState);
            }
    ...
    private long getCpuGaugeCollectionFrequencyMs(ApplicationProcessState applicationProcessState) {
        ...
        int i = C54541.$SwitchMap$com$google$firebase$perf$v1$ApplicationProcessState[applicationProcessState.ordinal()];
        if (i == 1) {

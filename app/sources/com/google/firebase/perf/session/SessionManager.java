    ...
    public void setApplicationContext(final Context context) {
        ...
        this.syncInitFuture = Executors.newSingleThreadExecutor().submit(new Runnable() { // from class: com.google.firebase.perf.session.SessionManager$$ExternalSyntheticLambda0
            ...
            public final void run() {
                SessionManager.$r8$lambda$B4EZpGOcGV8Pbms2hfENARWWl40(this.f$0, context, perfSession);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$B4EZpGOcGV8Pbms2hfENARWWl40(SessionManager sessionManager, Context context, PerfSession perfSession) {
        sessionManager.gaugeManager.initializeGaugeMetadataManager(context);
        if (perfSession.isGaugeAndEventCollectionEnabled()) {
            sessionManager.gaugeManager.logGaugeMetadata(perfSession.sessionId(), ApplicationProcessState.FOREGROUND);
        }
    }

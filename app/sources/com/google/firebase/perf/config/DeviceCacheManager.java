...
public class DeviceCacheManager {
        ...
        if (this.sharedPref == null && context != null) {
            this.serialExecutor.execute(new Runnable() { // from class: com.google.firebase.perf.config.DeviceCacheManager$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    DeviceCacheManager.m9288$r8$lambda$1JM_XhL1CV9Ty5wLYuYqCnOoU(this.f$0, context);
                }
            });
        }
    }

    /* renamed from: $r8$lambda$1JM_XhL1CV9Ty5w-LYuY-qCnOoU, reason: not valid java name */
    public static /* synthetic */ void m9288$r8$lambda$1JM_XhL1CV9Ty5wLYuYqCnOoU(DeviceCacheManager deviceCacheManager, Context context) {
    ...
    public Optional<Boolean> getBoolean(String str) {
        ...
        try {
            return Optional.m1049of(Boolean.valueOf(this.sharedPref.getBoolean(str, false)));
    ...
    public Optional<String> getString(String str) {
        ...
        try {
            return Optional.m1049of(this.sharedPref.getString(str, ""));
        } catch (ClassCastException e) {
    ...
    public Optional<Double> getDouble(String str) {
        ...
        try {
            try {
                return Optional.m1049of(Double.valueOf(Double.longBitsToDouble(this.sharedPref.getLong(str, 0L))));
            } catch (ClassCastException unused) {
                return Optional.m1049of(Double.valueOf(Float.valueOf(this.sharedPref.getFloat(str, 0.0f)).doubleValue()));
            }
        } catch (ClassCastException e) {
    ...
    public Optional<Long> getLong(String str) {
        ...
        try {
            return Optional.m1049of(Long.valueOf(this.sharedPref.getLong(str, 0L)));
        } catch (ClassCastException e) {
            logger.debug("Key %s from sharedPreferences has type other than long: %s", str, e.getMessage());
            return Optional.absent();
        }

...
import androidx.core.content.p012pm.PackageInfoCompat;
...
public class ConfigFetchHttpClient {
    ...
    private JSONObject createFetchRequestBody(String str, String str2, Map<String, String> map, Long l) throws PackageManager.NameNotFoundException, FirebaseRemoteConfigClientException {
        ...
        map2.put("analyticsUserProperties", new JSONObject((Map<?, ?>) map));
        if (l != null) {
            map2.put("firstOpenTime", convertToISOString(l.longValue()));
        }
        return new JSONObject((Map<?, ?>) map2);
    }
    ...
    private static ConfigContainer extractConfigs(JSONObject jSONObject, Date date) throws FirebaseRemoteConfigClientException {
        ...
        try {
            ...
            String string2 = jSONObject.has("templateVersion") ? jSONObject.getString("templateVersion") : null;
            if (string2 != null) {
                builderWithFetchTime.withTemplateVersionNumber(Long.parseLong(string2));
            }
            try {

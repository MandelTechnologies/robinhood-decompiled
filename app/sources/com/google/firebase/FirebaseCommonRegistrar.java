...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List<Component<?>> getComponents() {
        ...
        arrayList.add(LibraryVersionComponent.fromContext("android-installer", new LibraryVersionComponent.VersionExtractor() { // from class: com.google.firebase.FirebaseCommonRegistrar$$ExternalSyntheticLambda3
            @Override // com.google.firebase.platforminfo.LibraryVersionComponent.VersionExtractor
            public final String extract(Object obj) {
                return FirebaseCommonRegistrar.m9248$r8$lambda$4HULsSJXjiWd9yqSIuIvr69gmw((Context) obj);
            }
        }));
    ...
    /* renamed from: $r8$lambda$4HU-LsSJXjiWd9yqSIuIvr69gmw, reason: not valid java name */
    public static /* synthetic */ String m9248$r8$lambda$4HULsSJXjiWd9yqSIuIvr69gmw(Context context) {

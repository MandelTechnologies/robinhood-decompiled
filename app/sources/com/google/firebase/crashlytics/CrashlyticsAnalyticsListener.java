...
class CrashlyticsAnalyticsListener implements AnalyticsConnector.AnalyticsConnectorListener {
    ...
    public void onMessageTriggered(int i, Bundle bundle) {
        String string2;
        Logger.getLogger().m1029v(String.format(Locale.US, "Analytics listener received message. ID: %d, Extras: %s", Integer.valueOf(i), bundle));
        ...
        notifyEventReceivers(string2, bundle2);
    }

...
public class CrashlyticsCore {
    ...
    public boolean onPreExecute(AppData appData, SettingsProvider settingsProvider) {
        ...
        try {
            ...
            UserMetadata userMetadata = new UserMetadata(string2, this.fileStore, this.backgroundWorker);
            ...
            if (zDidPreviousInitializationFail && CommonUtils.canTryConnection(this.context)) {
                Logger.getLogger().m1023d("Crashlytics did not finish previous background initialization. Initializing synchronously.");
                finishInitSynchronously(settingsProvider);
                return false;
            }
            Logger.getLogger().m1023d("Successfully configured exception handler.");
            return true;
        } catch (Exception e) {
            Logger.getLogger().m1026e("Crashlytics was not started due to an exception during initialization", e);
    ...
    public Task<Void> doBackgroundInitialization(SettingsProvider settingsProvider) {
        ...
        try {
            ...
            if (!settingsProvider.getSettingsSync().featureFlagData.collectReports) {
                Logger.getLogger().m1023d("Collection of crash reports disabled in Crashlytics settings.");
            ...
            Logger.getLogger().m1026e("Crashlytics encountered a problem during asynchronous initialization.", e);
    ...
    private void finishInitSynchronously(final SettingsProvider settingsProvider) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        Logger.getLogger().m1023d("Crashlytics detected incomplete initialization on previous app launch. Will initialize synchronously.");
        try {
            futureSubmit.get(3L, TimeUnit.SECONDS);
        } catch (InterruptedException e) {
            Logger.getLogger().m1026e("Crashlytics was interrupted during initialization.", e);
        } catch (ExecutionException e2) {
            Logger.getLogger().m1026e("Crashlytics encountered a problem during initialization.", e2);
        } catch (TimeoutException e3) {
            Logger.getLogger().m1026e("Crashlytics timed out during initialization.", e3);
        }
    }
    ...
    void markInitializationStarted() {
        ...
        Logger.getLogger().m1029v("Initialization marker file was created.");
    }
        ...
        this.backgroundWorker.submit(new Callable<Boolean>() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore.3
            ...
            public Boolean call() throws Exception {
                try {
                    ...
                    Logger.getLogger().m1026e("Problem encountered deleting Crashlytics initialization marker.", e);
    ...
    static boolean isBuildIdValid(String str, boolean z) {
        if (!z) {
            Logger.getLogger().m1029v("Configured not to require a build ID.");
            return true;
        }

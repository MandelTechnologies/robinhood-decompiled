...
public class CrashlyticsReportDataCapture {
    ...
    static {
        ...
        map.put("x86", 0);
        map.put("x86_64", 1);
        GENERATOR = String.format(Locale.US, "Crashlytics Android SDK/%s", "19.0.3");
    }

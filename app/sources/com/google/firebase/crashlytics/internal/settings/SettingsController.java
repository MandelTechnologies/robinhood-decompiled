...
public class SettingsController implements SettingsProvider {
                ...
                if (cachedSettings != null) {
                    ...
                    if (settingsJson != null) {
                        ...
                        if (!SettingsCacheBehavior.IGNORE_CACHE_EXPIRATION.equals(settingsCacheBehavior) && settingsJson.isExpired(currentTimeMillis)) {
                            Logger.getLogger().m1029v("Cached settings have expired.");
                            return null;
                        }
                        try {
                            Logger.getLogger().m1029v("Returning cached settings.");
                            return settingsJson;
                        } catch (Exception e) {
                            e = e;
                            settings = settingsJson;
                            Logger.getLogger().m1026e("Failed to get cached settings", e);
                            return settings;
                        }
                    }
                    Logger.getLogger().m1026e("Failed to parse cached settings data.", null);
                    return null;
                }
                Logger.getLogger().m1023d("No cached settings data found.");
            }
            return null;
        } catch (Exception e2) {
            e = e2;
    ...
    public void logSettings(JSONObject jSONObject, String str) throws JSONException {
        Logger.getLogger().m1023d(str + jSONObject.toString());
    }

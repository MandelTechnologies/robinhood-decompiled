...
final class C5417xce3d994b extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame {
    private final String file;
    private final int importance;
    private final long offset;

    /* renamed from: pc */
    private final long f907pc;
    private final String symbol;

    private C5417xce3d994b(long j, String str, String str2, long j2, int i) {
        this.f907pc = j;
        this.symbol = str;
        this.file = str2;
        this.offset = j2;
    ...
    public String toString() {
        return "Frame{pc=" + this.f907pc + ", symbol=" + this.symbol + ", file=" + this.file + ", offset=" + this.offset + ", importance=" + this.importance + "}";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame) {
            ...
            if (this.f907pc == frame.getPc() && this.symbol.equals(frame.getSymbol()) && ((str = this.file) != null ? str.equals(frame.getFile()) : frame.getFile() == null) && this.offset == frame.getOffset() && this.importance == frame.getImportance()) {
                return true;
            }
        }
        return false;
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame build() {
            ...
            return new C5417xce3d994b(this.f908pc, str, this.file, this.offset, this.importance);
        }
    }
}

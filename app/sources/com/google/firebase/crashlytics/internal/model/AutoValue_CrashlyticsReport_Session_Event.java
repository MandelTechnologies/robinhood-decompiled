...
final class AutoValue_CrashlyticsReport_Session_Event extends CrashlyticsReport.Session.Event {
    ...
    private final String f9835type;
    ...
    public String toString() {
        return "Event{timestamp=" + this.timestamp + ", type=" + this.f9835type + ", app=" + this.app + ", device=" + this.device + ", log=" + this.log + ", rollouts=" + this.rollouts + "}";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CrashlyticsReport.Session.Event) {
            ...
            if (this.timestamp == event.getTimestamp() && this.f9835type.equals(event.getType()) && this.app.equals(event.getApp()) && this.device.equals(event.getDevice()) && ((log = this.log) != null ? log.equals(event.getLog()) : event.getLog() == null) && ((rolloutsState = this.rollouts) != null ? rolloutsState.equals(event.getRollouts()) : event.getRollouts() == null)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        ...
        int iHashCode = (((((((((int) (j ^ (j >>> 32))) ^ 1000003) * 1000003) ^ this.f9835type.hashCode()) * 1000003) ^ this.app.hashCode()) * 1000003) ^ this.device.hashCode()) * 1000003;
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Builder {
        ...
        public CrashlyticsReport.Session.Event build() {
            ...
            if (this.set$0 != 1 || (str = this.f9836type) == null || (application = this.app) == null || (device = this.device) == null) {
                StringBuilder sb = new StringBuilder();
                if ((1 & this.set$0) == 0) {
                    sb.append(" timestamp");
                }
                if (this.f9836type == null) {
                    sb.append(" type");
                }
                if (this.app == null) {
                    sb.append(" app");

...
final class C5414xc2f5febc extends CrashlyticsReport.Session.Event.Application.Execution.Exception {
    ...
    private final String f9837type;

    private C5414xc2f5febc(String str, String str2, List<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> list, CrashlyticsReport.Session.Event.Application.Execution.Exception exception, int i) {
        this.f9837type = str;
        this.reason = str2;
        this.frames = list;
    ...
    public String toString() {
        return "Exception{type=" + this.f9837type + ", reason=" + this.reason + ", frames=" + this.frames + ", causedBy=" + this.causedBy + ", overflowCount=" + this.overflowCount + "}";
    }
    ...
    public int hashCode() {
        int iHashCode = (this.f9837type.hashCode() ^ 1000003) * 1000003;
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Exception.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Exception build() {
            ...
            if (this.set$0 != 1 || (str = this.f9838type) == null || (list = this.frames) == null) {
                StringBuilder sb = new StringBuilder();
                if (this.f9838type == null) {
                    sb.append(" type");
                }
                if (this.frames == null) {
                    sb.append(" frames");
            ...
            return new C5414xc2f5febc(str, this.reason, list, this.causedBy, this.overflowCount);
        }
    }
}

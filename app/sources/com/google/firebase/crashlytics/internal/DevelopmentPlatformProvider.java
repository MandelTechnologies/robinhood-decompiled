        ...
        private DevelopmentPlatform() throws Resources.NotFoundException {
            ...
            if (resourcesIdentifier == 0) {
                if (DevelopmentPlatformProvider.this.assetFileExists("flutter_assets/NOTICES.Z")) {
                    ...
                    Logger.getLogger().m1029v("Development platform is: Flutter");
                    return;
                } else {
            ...
            String string2 = DevelopmentPlatformProvider.this.context.getResources().getString(resourcesIdentifier);
            this.developmentPlatformVersion = string2;
            Logger.getLogger().m1029v("Unity Editor version is: " + string2);
        }
    }
}

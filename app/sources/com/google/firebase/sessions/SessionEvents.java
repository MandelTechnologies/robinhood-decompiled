...
public final class SessionEvents {
    ...
    public final ApplicationInfo getApplicationInfo(FirebaseApp firebaseApp) throws PackageManager.NameNotFoundException {
        ...
        ApplicationInfo3 applicationInfo3 = ApplicationInfo3.LOG_ENVIRONMENT_PROD;
        ...
        return new ApplicationInfo(applicationId, MODEL, "2.0.3", RELEASE, applicationInfo3, new AndroidApplicationInfo(packageName, str3, str, MANUFACTURER, currentProcessDetails, processDetailsProvider.getAppProcessDetails(applicationContext3)));
    }

    private final SessionEvent2 toDataCollectionState(SessionSubscriber subscriber) {
        if (subscriber == null) {
            return SessionEvent2.COLLECTION_SDK_NOT_INSTALLED;
        }
        if (subscriber.isDataCollectionEnabled()) {
            return SessionEvent2.COLLECTION_ENABLED;
        }
        return SessionEvent2.COLLECTION_DISABLED;
    }
}

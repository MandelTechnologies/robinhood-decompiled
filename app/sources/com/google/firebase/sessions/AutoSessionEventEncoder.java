...
public final class AutoSessionEventEncoder implements Configurator {
    ...
    private static final class SessionEventEncoder implements ObjectEncoder<SessionEvent> {
        ...
        private static final FieldDescriptor EVENTTYPE_DESCRIPTOR = FieldDescriptor.m1041of("eventType");
        private static final FieldDescriptor SESSIONDATA_DESCRIPTOR = FieldDescriptor.m1041of("sessionData");
        private static final FieldDescriptor APPLICATIONINFO_DESCRIPTOR = FieldDescriptor.m1041of("applicationInfo");
    ...
    private static final class SessionInfoEncoder implements ObjectEncoder<SessionInfo> {
        ...
        private static final FieldDescriptor SESSIONID_DESCRIPTOR = FieldDescriptor.m1041of("sessionId");
        private static final FieldDescriptor FIRSTSESSIONID_DESCRIPTOR = FieldDescriptor.m1041of("firstSessionId");
        private static final FieldDescriptor SESSIONINDEX_DESCRIPTOR = FieldDescriptor.m1041of("sessionIndex");
        private static final FieldDescriptor EVENTTIMESTAMPUS_DESCRIPTOR = FieldDescriptor.m1041of("eventTimestampUs");
        private static final FieldDescriptor DATACOLLECTIONSTATUS_DESCRIPTOR = FieldDescriptor.m1041of("dataCollectionStatus");
    ...
    private static final class DataCollectionStatusEncoder implements ObjectEncoder<DataCollectionStatus> {
        ...
        private static final FieldDescriptor PERFORMANCE_DESCRIPTOR = FieldDescriptor.m1041of("performance");
        private static final FieldDescriptor CRASHLYTICS_DESCRIPTOR = FieldDescriptor.m1041of("crashlytics");
        private static final FieldDescriptor SESSIONSAMPLINGRATE_DESCRIPTOR = FieldDescriptor.m1041of("sessionSamplingRate");
    ...
    private static final class ApplicationInfoEncoder implements ObjectEncoder<ApplicationInfo> {
        ...
        private static final FieldDescriptor APPID_DESCRIPTOR = FieldDescriptor.m1041of("appId");
        private static final FieldDescriptor DEVICEMODEL_DESCRIPTOR = FieldDescriptor.m1041of("deviceModel");
        private static final FieldDescriptor SESSIONSDKVERSION_DESCRIPTOR = FieldDescriptor.m1041of("sessionSdkVersion");
        private static final FieldDescriptor OSVERSION_DESCRIPTOR = FieldDescriptor.m1041of("osVersion");
        private static final FieldDescriptor LOGENVIRONMENT_DESCRIPTOR = FieldDescriptor.m1041of("logEnvironment");
        private static final FieldDescriptor ANDROIDAPPINFO_DESCRIPTOR = FieldDescriptor.m1041of("androidAppInfo");
    ...
    private static final class AndroidApplicationInfoEncoder implements ObjectEncoder<AndroidApplicationInfo> {
        ...
        private static final FieldDescriptor PACKAGENAME_DESCRIPTOR = FieldDescriptor.m1041of("packageName");
        private static final FieldDescriptor VERSIONNAME_DESCRIPTOR = FieldDescriptor.m1041of("versionName");
        private static final FieldDescriptor APPBUILDVERSION_DESCRIPTOR = FieldDescriptor.m1041of("appBuildVersion");
        private static final FieldDescriptor DEVICEMANUFACTURER_DESCRIPTOR = FieldDescriptor.m1041of("deviceManufacturer");

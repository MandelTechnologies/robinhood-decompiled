...
public final class EventGDTLogger implements EventGDTLogger2 {
    ...
    @Override // com.google.firebase.sessions.EventGDTLogger2
    public void log(SessionEvent sessionEvent) {
        Intrinsics.checkNotNullParameter(sessionEvent, "sessionEvent");
        this.transportFactoryProvider.get().getTransport("FIREBASE_APPQUALITY_SESSION", SessionEvent.class, Encoding.m790of("json"), new Transformer() { // from class: com.google.firebase.sessions.EventGDTLogger$$ExternalSyntheticLambda0

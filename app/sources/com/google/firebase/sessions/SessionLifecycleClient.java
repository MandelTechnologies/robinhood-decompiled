...
public final class SessionLifecycleClient {
    ...
    private final SessionLifecycleClient3 serviceConnection;
    ...
    public SessionLifecycleClient(CoroutineContext backgroundDispatcher) {
        ...
        this.serviceConnection = new ServiceConnection() { // from class: com.google.firebase.sessions.SessionLifecycleClient$serviceConnection$1
            ...
            public void onServiceConnected(ComponentName className, IBinder serviceBinder) {
                Log.d("SessionLifecycleClient", "Connected to SessionLifecycleService. Queue size " + this.this$0.queuedMessages.size());
    ...
    public static final class ClientUpdateHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 3) {
                ...
                if (data == null || (string2 = data.getString("SessionUpdateExtra")) == null) {
                    string2 = "";
                }
                handleSessionUpdate(string2);
                return;
            }
        ...
        private final void handleSessionUpdate(String sessionId) {
            ...
            BuildersKt__Builders_commonKt.launch$default(CoroutineScope2.CoroutineScope(this.backgroundDispatcher), null, null, new SessionLifecycleClient2(sessionId, null), 3, null);
        }
    }
    ...
    @DebugMetadata(m3644c = "com.google.firebase.sessions.SessionLifecycleClient$sendLifecycleEvents$1", m3645f = "SessionLifecycleClient.kt", m3646l = {151}, m3647m = "invokeSuspend")
    @SourceDebugExtension
    /* renamed from: com.google.firebase.sessions.SessionLifecycleClient$sendLifecycleEvents$1 */
    static final class C54961 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ List<Message> $messages;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C54961(List<Message> list, Continuation<? super C54961> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return SessionLifecycleClient.this.new C54961(this.$messages, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C54961) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Job sendLifecycleEvents(List<Message> messages) {
        return BuildersKt__Builders_commonKt.launch$default(CoroutineScope2.CoroutineScope(this.backgroundDispatcher), null, null, new C54961(messages, null), 3, null);
    }
    ...
    public final void sendMessageToServer(Message msg) throws RemoteException {
        if (this.service != null) {
            try {
                ...
                Log.w("SessionLifecycleClient", "Unable to deliver message: " + msg.what, e);
                queueMessage(msg);
                return;
            }
        }

...
public final /* data */ class DataCollectionStatus {
    ...
    public DataCollectionStatus(SessionEvent2 performance, SessionEvent2 crashlytics, double d) {
    ...
    public /* synthetic */ DataCollectionStatus(SessionEvent2 sessionEvent2, SessionEvent2 sessionEvent22, double d, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? SessionEvent2.COLLECTION_SDK_NOT_INSTALLED : sessionEvent2, (i & 2) != 0 ? SessionEvent2.COLLECTION_SDK_NOT_INSTALLED : sessionEvent22, (i & 4) != 0 ? 1.0d : d);
    }

    public final SessionEvent2 getPerformance() {
        return this.performance;
    }

    public final SessionEvent2 getCrashlytics() {

...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    private static final ObjectEncoder<Map.Entry<Object, Object>> DEFAULT_MAP_ENCODER = new ObjectEncoder() { // from class: com.google.firebase.encoders.proto.ProtobufDataEncoderContext$$ExternalSyntheticLambda0
        ...
        public final void encode(Object obj, Object obj2) throws IOException {
            ProtobufDataEncoderContext.m9275$r8$lambda$HMpWU6Ryr444SahjVbEVRqtyxs((Map.Entry) obj, (ObjectEncoderContext) obj2);
        }
    };

    /* renamed from: $r8$lambda$HMpWU6Ryr444SahjVbEVRqty-xs, reason: not valid java name */
    public static /* synthetic */ void m9275$r8$lambda$HMpWU6Ryr444SahjVbEVRqtyxs(Map.Entry entry, ObjectEncoderContext objectEncoderContext) throws IOException {
    ...
    static /* synthetic */ class C54301 {
        ...
        static {
            ...
            try {
                f909x531607dd[Protobuf.IntEncoding.SIGNED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f909x531607dd[Protobuf.IntEncoding.FIXED.ordinal()] = 3;
    ...
    ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (!z || i != 0) {
            ...
            int i2 = C54301.f909x531607dd[protobuf.intEncoding().ordinal()];
            if (i2 == 1) {
    ...
    ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (!z || j != 0) {
            Protobuf protobuf = getProtobuf(fieldDescriptor);
            int i = C54301.f909x531607dd[protobuf.intEncoding().ordinal()];
            if (i == 1) {
                writeVarInt32(protobuf.tag() << 3);
                writeVarInt64(j);
                return this;
    ...
    private void writeVarInt32(int i) throws IOException {
        while ((i & (-128)) != 0) {
            this.output.write((i & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | 128);
            i >>>= 7;
        }
        this.output.write(i & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE);
    }

    private void writeVarInt64(long j) throws IOException {
        while (((-128) & j) != 0) {
            this.output.write((((int) j) & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | 128);
            j >>>= 7;
        }
        this.output.write(((int) j) & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE);
    }
}

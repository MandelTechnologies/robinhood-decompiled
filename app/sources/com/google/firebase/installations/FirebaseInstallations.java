...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    private final Utils f9840utils;
    ...
    @SuppressLint({"ThreadPoolCreation"})
    FirebaseInstallations(ExecutorService executorService, Executor executor, FirebaseApp firebaseApp, FirebaseInstallationServiceClient firebaseInstallationServiceClient, PersistedInstallation persistedInstallation, Utils utils2, Lazy<IidStore> lazy, RandomFidGenerator randomFidGenerator) {
    ...
    private Task<InstallationTokenResult> addGetAuthTokenListener() {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        addStateListeners(new GetAuthTokenListener(this.f9840utils, taskCompletionSource));
        return taskCompletionSource.getTask();
    }
    ...
    public void doNetworkCallIfNecessary(boolean z) {
        ...
        try {
            if (multiProcessSafePrefs.isErrored() || multiProcessSafePrefs.isUnregistered()) {
                ...
                if (!z && !this.f9840utils.isAuthTokenExpired(multiProcessSafePrefs)) {
                    return;
                }
    ...
    private PersistedInstallationEntry fetchAuthTokenFromServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C54343.f911xe5baa01a[tokenResultGenerateAuthToken.getResponseCode().ordinal()];
        if (i == 1) {
            return persistedInstallationEntry.withAuthToken(tokenResultGenerateAuthToken.getToken(), tokenResultGenerateAuthToken.getTokenExpirationTimestamp(), this.f9840utils.currentTimeInSecs());
        }
        if (i == 2) {
            return persistedInstallationEntry.withFisError("BAD CONFIG");
        }
    ...
    static /* synthetic */ class C54343 {
        ...
        static {
            ...
            try {
                f911xe5baa01a[TokenResult.ResponseCode.BAD_CONFIG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f911xe5baa01a[TokenResult.ResponseCode.AUTH_ERROR.ordinal()] = 3;
            ...
            try {
                f910xc38d2559[InstallationResponse.ResponseCode.BAD_CONFIG.ordinal()] = 2;

    ...
    private void initQueue() {
        synchronized (this.internalQueue) {
            try {
                ...
                String string2 = this.sharedPreferences.getString(this.queueName, "");
                if (!TextUtils.isEmpty(string2) && string2.contains(this.itemSeparator)) {
                    String[] strArrSplit = string2.split(this.itemSeparator, -1);

    ...
    public Task<Void> processIntent(final Intent intent) {
        ...
        this.executor.execute(new Runnable() { // from class: com.google.firebase.messaging.EnhancedIntentService$$ExternalSyntheticLambda1
            ...
            public final void run() {
                EnhancedIntentService.m9278$r8$lambda$9b4qTh6k1amVzUe1kAE6oojA28(this.f$0, intent, taskCompletionSource);
            }
        });
        return taskCompletionSource.getTask();
    }

    /* renamed from: $r8$lambda$9b4qTh6k1amVzUe1kAE6oojA2-8, reason: not valid java name */
    public static /* synthetic */ void m9278$r8$lambda$9b4qTh6k1amVzUe1kAE6oojA28(EnhancedIntentService enhancedIntentService, Intent intent, TaskCompletionSource taskCompletionSource) {

...
public class NotificationParams {
    ...
    public NotificationParams(Bundle bundle) {
        if (bundle == null) {
            throw new NullPointerException(WebsocketGatewayConstants.DATA_KEY);
        }
    ...
    public boolean getBoolean(String str) {
        ...
        return Constants.SdidMigrationStatusCodes.ALREADY_SDID.equals(string2) || Boolean.parseBoolean(string2);
    }
    ...
    public Long getLong(String str) {
        ...
        try {
            ...
            Log.w("NotificationParams", "Couldn't parse value of " + userFriendlyKey(str) + "(" + string2 + ") into a long");
            return null;
        }
    }
    ...
    public Uri getLink() {
        String string2 = getString("gcm.n.link_android");
        if (TextUtils.isEmpty(string2)) {
            string2 = getString("gcm.n.link");
        }
        if (TextUtils.isEmpty(string2)) {
            return null;
        }
    ...
    public String getSoundResourceName() {
        String string2 = getString("gcm.n.sound2");
        return TextUtils.isEmpty(string2) ? getString("gcm.n.sound") : string2;
    }
    ...
    public String getPossiblyLocalizedString(Resources resources, String str, String str2) {
        ...
        return !TextUtils.isEmpty(string2) ? string2 : getLocalizedString(resources, str, str2);
    }
    ...
    public static boolean isNotification(Bundle bundle) {
        return Constants.SdidMigrationStatusCodes.ALREADY_SDID.equals(bundle.getString("gcm.n.e")) || Constants.SdidMigrationStatusCodes.ALREADY_SDID.equals(bundle.getString(keyWithOldPrefix("gcm.n.e")));
    }

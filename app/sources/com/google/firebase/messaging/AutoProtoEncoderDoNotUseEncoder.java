...
public final class AutoProtoEncoderDoNotUseEncoder implements Configurator {
    ...
    private static final class ProtoEncoderDoNotUseEncoder implements ObjectEncoder<ProtoEncoderDoNotUse> {
        ...
        private static final FieldDescriptor MESSAGINGCLIENTEVENTEXTENSION_DESCRIPTOR = FieldDescriptor.m1041of("messagingClientEventExtension");
    ...
    private static final class MessagingClientEventEncoder implements ObjectEncoder<MessagingClientEvent> {
        ...
        private static final FieldDescriptor TOPIC_DESCRIPTOR = FieldDescriptor.builder(WebsocketGatewayConstants.TOPIC_KEY).withProperty(AtProtobuf.builder().tag(10).build()).build();

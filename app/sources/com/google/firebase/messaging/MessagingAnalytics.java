...
public class MessagingAnalytics {
    ...
    public static boolean shouldUploadScionMetrics(Bundle bundle) {
        ...
        return Constants.SdidMigrationStatusCodes.ALREADY_SDID.equals(bundle.getString("google.c.a.e"));
    }
    ...
    private static void setUserPropertyIfRequired(Bundle bundle) {
        ...
        if (Constants.SdidMigrationStatusCodes.ALREADY_SDID.equals(bundle.getString("google.c.a.tc"))) {
    ...
    static void logToScion(String str, Bundle bundle) {
        try {
            ...
            if (!TextUtils.isEmpty(messageLabel)) {
                bundle2.putString(AnnotatedPrivateKey.LABEL, messageLabel);
            }
    ...
    private static void logToFirelog(MessagingClientEvent.Event event, Intent intent, TransportFactory transportFactory) {
        ...
        try {
            transportFactory.getTransport("FCM_CLIENT_EVENT_LOGGING", MessagingClientEventExtension.class, Encoding.m790of("proto"), new Transformer() { // from class: com.google.firebase.messaging.MessagingAnalytics$$ExternalSyntheticLambda0
    ...
    static String getMessageId(Bundle bundle) {
        ...
        return string2 == null ? bundle.getString("message_id") : string2;
    }
    ...
    static String getInstanceId(Bundle bundle) {
        String string2 = bundle.getString("google.to");
    ...
    static String getMessageTypeForScion(Bundle bundle) {
        ...
        return WebsocketGatewayConstants.DATA_KEY;
    }

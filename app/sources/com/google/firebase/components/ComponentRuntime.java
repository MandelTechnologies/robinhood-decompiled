...
public class ComponentRuntime implements ComponentContainer, ComponentLoader {
    ...
    private ComponentRuntime(Executor executor, Iterable<Provider<ComponentRegistrar>> iterable, Collection<Component<?>> collection, ComponentRegistrarProcessor componentRegistrarProcessor) {
        ...
        arrayList.add(Component.m1020of(eventBus, EventBus.class, Subscriber.class, Publisher.class));
        arrayList.add(Component.m1020of(this, ComponentLoader.class, new Class[0]));
    ...
    private void discoverComponents(List<Component<?>> list) {
        ...
        synchronized (this) {
            ...
            while (it2.hasNext()) {
                Object[] array2 = it2.next().getProvidedInterfaces().toArray();
    ...
    public <T> Deferred<T> getDeferred(Qualified<T> qualified) {
        ...
        return OptionalProvider.m1021of(provider);
    }
    ...
    public void initializeEagerComponents(boolean z) {
        HashMap map;
        if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(this.eagerComponentsInitializedWith, null, Boolean.valueOf(z))) {
            synchronized (this) {

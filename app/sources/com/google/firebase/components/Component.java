...
public final class Component<T> {
    ...
    public boolean isValue() {
        return this.f9831type == 0;
    }

    public Component<T> withFactory(ComponentFactory<T> componentFactory) {
        return new Component<>(this.name, this.providedInterfaces, this.dependencies, this.instantiation, this.f9831type, componentFactory, this.publishedEvents);
    }

    public String toString() {
        return "Component<" + Arrays.toString(this.providedInterfaces.toArray()) + ">{" + this.instantiation + ", type=" + this.f9831type + ", deps=" + Arrays.toString(this.dependencies.toArray()) + "}";
    }
    ...
    @SafeVarargs
    /* renamed from: of */
    public static <T> Component<T> m1020of(final T t, Class<T> cls, Class<? super T>... clsArr) {
    ...
    public static class Builder<T> {
        ...
        public Component<T> build() {
            ...
            return new Component<>(this.name, new HashSet(this.providedInterfaces), new HashSet(this.dependencies), this.instantiation, this.f9832type, this.factory, this.publishedEvents);
        }
    }
}

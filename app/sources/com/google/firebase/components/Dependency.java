...
public final class Dependency {
    ...
    public boolean isRequired() {
        return this.f9833type == 1;
    }

    public boolean isSet() {
        return this.f9833type == 2;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Dependency) {
            ...
            if (this.anInterface.equals(dependency.anInterface) && this.f9833type == dependency.f9833type && this.injection == dependency.injection) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return ((((this.anInterface.hashCode() ^ 1000003) * 1000003) ^ this.f9833type) * 1000003) ^ this.injection;
    }

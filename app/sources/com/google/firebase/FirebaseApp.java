...
public class FirebaseApp {
    ...
    protected FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        ComponentRuntime.Builder processor = ComponentRuntime.builder(UiExecutor.INSTANCE).addLazyComponentRegistrars(listDiscoverLazy).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponentRegistrar(new ExecutorsRegistrar()).addComponent(Component.m1020of(context, Context.class, new Class[0])).addComponent(Component.m1020of(this, FirebaseApp.class, new Class[0])).addComponent(Component.m1020of(firebaseOptions, FirebaseOptions.class, new Class[0])).setProcessor(new ComponentMonitor());
        if (UserManagerCompat.isUserUnlocked(context) && FirebaseInitProvider.isCurrentlyInitializing()) {
            processor.addComponent(Component.m1020of(startupTime, StartupTime.class, new Class[0]));
        }
        ...
        addBackgroundStateChangeListener(new BackgroundStateChangeListener() { // from class: com.google.firebase.FirebaseApp$$ExternalSyntheticLambda1
            ...
            public final void onBackgroundStateChanged(boolean z) {
                FirebaseApp.m9247$r8$lambda$ACPzvYjhpDUdi_U1Jr3TE9psg(this.f$0, z);
            }
        });
        FirebaseTrace.popTrace();
    }
    ...
    public static /* synthetic */ void m9247$r8$lambda$ACPzvYjhpDUdi_U1Jr3TE9psg(FirebaseApp firebaseApp, boolean z) {
        if (z) {
    ...
    private static class UserUnlockReceiver extends BroadcastReceiver {
        ...
        public static void ensureReceiverRegistered(Context context) {
            if (INSTANCE.get() == null) {
                ...
                if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(INSTANCE, null, userUnlockReceiver)) {
        ...
        public static void ensureBackgroundStateListenerRegistered(Context context) {
            if (PlatformVersion.isAtLeastIceCreamSandwich() && (context.getApplicationContext() instanceof Application)) {
                ...
                if (INSTANCE.get() == null) {
                    ...
                    if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(INSTANCE, null, globalBackgroundStateListener)) {

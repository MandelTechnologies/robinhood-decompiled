...
public final class GsonBuilder {
    ...
    public GsonBuilder registerTypeAdapter(Type type2, Object obj) {
        ...
        if (isTypeObjectOrJsonElement(type2)) {
            throw new IllegalArgumentException("Cannot override built-in adapter for " + type2);
        }
    ...
    private static boolean isTypeObjectOrJsonElement(Type type2) {
        if (type2 instanceof Class) {
            return type2 == Object.class || JsonElement.class.isAssignableFrom((Class) type2);
        }
        return false;
    }

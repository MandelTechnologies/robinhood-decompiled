...
final class FloatArrayList extends AbstractProtobufList<Float> implements Internal.FloatList, RandomAccess, PrimitiveNonBoxingCollection {
    ...
    public boolean equals(Object o) {
        ...
        float[] fArr = floatArrayList.f9853array;
        for (int i = 0; i < this.size; i++) {
            if (Float.floatToIntBits(this.f9853array[i]) != Float.floatToIntBits(fArr[i])) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode() {
        ...
        for (int i = 0; i < this.size; i++) {
            iFloatToIntBits = (iFloatToIntBits * 31) + Float.floatToIntBits(this.f9853array[i]);
        }
    ...
    public Internal.ProtobufList<Float> mutableCopyWithCapacity2(int capacity) {
        ...
        return new FloatArrayList(Arrays.copyOf(this.f9853array, capacity), this.size, true);
    }
    ...
    public int indexOf(Object element) {
        ...
        for (int i = 0; i < size; i++) {
            if (this.f9853array[i] == fFloatValue) {
                return i;
            }
        }
        return -1;
    ...
    public void addFloat(float element) {
        ...
        if (i == fArr.length) {
            ...
            this.f9853array = fArr2;
        }
        float[] fArr3 = this.f9853array;
        int i2 = this.size;
        this.size = i2 + 1;
        fArr3[i2] = element;
    }
    ...
    private void addFloat(int index, float element) {
        ...
        if (i < fArr.length) {
            ...
            System.arraycopy(this.f9853array, index, fArr2, index + 1, this.size - index);
            this.f9853array = fArr2;
        }
        this.f9853array[index] = element;
        this.size++;
        ((AbstractList) this).modCount++;
    }
    ...
    public boolean addAll(Collection<? extends Float> collection) {
        ...
        float[] fArr = this.f9853array;
        if (i3 > fArr.length) {
            this.f9853array = Arrays.copyOf(fArr, i3);
        }
        System.arraycopy(floatArrayList.f9853array, 0, this.f9853array, this.size, floatArrayList.size);
        this.size = i3;
        ((AbstractList) this).modCount++;
        return true;
    }

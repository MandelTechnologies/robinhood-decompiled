...
final class LongArrayList extends AbstractProtobufList<Long> implements Internal.LongList, RandomAccess, PrimitiveNonBoxingCollection {
    ...
    public boolean equals(Object o) {
        ...
        long[] jArr = longArrayList.f9857array;
        for (int i = 0; i < this.size; i++) {
            if (this.f9857array[i] != jArr[i]) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode() {
        int iHashLong = 1;
        for (int i = 0; i < this.size; i++) {
            iHashLong = (iHashLong * 31) + Internal.hashLong(this.f9857array[i]);
        }
        return iHashLong;
    }
    ...
    public Internal.ProtobufList<Long> mutableCopyWithCapacity2(int capacity) {
        ...
        return new LongArrayList(Arrays.copyOf(this.f9857array, capacity), this.size, true);
    }
    ...
    public int indexOf(Object element) {
        ...
        for (int i = 0; i < size; i++) {
            if (this.f9857array[i] == jLongValue) {
                return i;
            }
        }
        return -1;
    ...
    public void addLong(long element) {
        ...
        if (i == jArr.length) {
            ...
            this.f9857array = jArr2;
        }
        long[] jArr3 = this.f9857array;
        int i2 = this.size;
        this.size = i2 + 1;
        jArr3[i2] = element;
    }
    ...
    private void addLong(int index, long element) {
        ...
        if (i < jArr.length) {
            ...
            System.arraycopy(this.f9857array, index, jArr2, index + 1, this.size - index);
            this.f9857array = jArr2;
        }
        this.f9857array[index] = element;
        this.size++;
        ((AbstractList) this).modCount++;
    }
    ...
    public boolean addAll(Collection<? extends Long> collection) {
        ...
        long[] jArr = this.f9857array;
        if (i3 > jArr.length) {
            this.f9857array = Arrays.copyOf(jArr, i3);
        }
        System.arraycopy(longArrayList.f9857array, 0, this.f9857array, this.size, longArrayList.size);
        this.size = i3;
        ((AbstractList) this).modCount++;
        return true;
    }

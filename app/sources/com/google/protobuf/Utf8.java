                    ...
                    if (i5 != length) {
                        try {
                            ...
                            if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                ...
                                int i6 = iPosition + 1;
                                try {
                                    out.put(iPosition, (byte) ((codePoint >>> 18) | EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_CIRCLE_VALUE));
                                    i = iPosition + 2;
                    ...
                    if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || i5 > i3 - 3) {
                        if (i5 <= i3 - 4) {
                            ...
                            if (i7 != in.length()) {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                    out[i5] = (byte) ((codePoint >>> 18) | EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_CIRCLE_VALUE);
                    ...
                    if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || j4 > j5 - 3) {
                        ...
                        if (j4 <= j3 - 4) {
                            ...
                            if (i3 != length2) {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                    UnsafeUtil.putByte(out, j4, (byte) ((codePoint >>> 18) | EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_CIRCLE_VALUE));
                        ...
                        if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || jPosition > jLimit - 3) {
                            ...
                            if (jPosition <= j4 - 4) {
                                ...
                                if (i3 != length) {
                                    ...
                                    if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                        int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                        UnsafeUtil.putByte(jPosition, (byte) ((codePoint >>> 18) | EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_CIRCLE_VALUE));
                                        c2 = 128;

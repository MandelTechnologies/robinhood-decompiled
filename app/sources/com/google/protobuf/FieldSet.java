...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    /* synthetic */ FieldSet(SmallSortedMap smallSortedMap, C56711 c56711) {
        this(smallSortedMap);
    }
    ...
    public static <T extends FieldDescriptorLite<T>> Builder<T> newBuilder() {
        return new Builder<>((C56711) null);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static boolean isValidType(final WireFormat.FieldType type2, final Object value) {
        Internal.checkNotNull(value);
        switch (C56711.$SwitchMap$com$google$protobuf$WireFormat$JavaType[type2.getJavaType().ordinal()]) {
            case 7:
    ...
    static int getWireFormatForFieldType(final WireFormat.FieldType type2, boolean isPacked) {
        if (isPacked) {
            return 2;
        }
    ...
    public static Object readPrimitiveField(CodedInputStream input, final WireFormat.FieldType type2, boolean checkUtf8) throws IOException {
        if (checkUtf8) {
    ...
    static void writeElement(final CodedOutputStream output, final WireFormat.FieldType type2, final int number, final Object value) throws IOException {
        if (type2 == WireFormat.FieldType.GROUP) {
            output.writeGroup(number, (MessageLite) value);
        } else {
            output.writeTag(number, getWireFormatForFieldType(type2, false));
            writeElementNoTag(output, type2, value);
        }
    }

    /* renamed from: com.google.protobuf.FieldSet$1 */
    static /* synthetic */ class C56711 {
    ...
    static void writeElementNoTag(final CodedOutputStream output, final WireFormat.FieldType type2, final Object value) throws IOException {
        switch (C56711.$SwitchMap$com$google$protobuf$WireFormat$FieldType[type2.ordinal()]) {
            case 1:
    ...
    static int computeElementSize(final WireFormat.FieldType type2, final int number, final Object value) {
        int iComputeTagSize = CodedOutputStream.computeTagSize(number);
        if (type2 == WireFormat.FieldType.GROUP) {
            iComputeTagSize *= 2;
        }
        return iComputeTagSize + computeElementSizeNoTag(type2, value);
    }

    static int computeElementSizeNoTag(final WireFormat.FieldType type2, final Object value) {
        switch (C56711.$SwitchMap$com$google$protobuf$WireFormat$FieldType[type2.ordinal()]) {
            case 1:
    ...
    static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        /* synthetic */ Builder(C56711 c56711) {
            this();
        }

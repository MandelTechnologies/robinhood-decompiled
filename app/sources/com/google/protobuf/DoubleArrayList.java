...
final class DoubleArrayList extends AbstractProtobufList<Double> implements Internal.DoubleList, RandomAccess, PrimitiveNonBoxingCollection {
    ...
    public boolean equals(Object o) {
        ...
        double[] dArr = doubleArrayList.f9850array;
        for (int i = 0; i < this.size; i++) {
            if (Double.doubleToLongBits(this.f9850array[i]) != Double.doubleToLongBits(dArr[i])) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode() {
        int iHashLong = 1;
        for (int i = 0; i < this.size; i++) {
            iHashLong = (iHashLong * 31) + Internal.hashLong(Double.doubleToLongBits(this.f9850array[i]));
        }
        return iHashLong;
    }
    ...
    public Internal.ProtobufList<Double> mutableCopyWithCapacity2(int capacity) {
        ...
        return new DoubleArrayList(Arrays.copyOf(this.f9850array, capacity), this.size, true);
    }
    ...
    public int indexOf(Object element) {
        ...
        for (int i = 0; i < size; i++) {
            if (this.f9850array[i] == dDoubleValue) {
                return i;
            }
        }
        return -1;
    ...
    public void addDouble(double element) {
        ...
        if (i == dArr.length) {
            ...
            this.f9850array = dArr2;
        }
        double[] dArr3 = this.f9850array;
        int i2 = this.size;
        this.size = i2 + 1;
        dArr3[i2] = element;
    }
    ...
    private void addDouble(int index, double element) {
        ...
        if (i < dArr.length) {
            ...
            System.arraycopy(this.f9850array, index, dArr2, index + 1, this.size - index);
            this.f9850array = dArr2;
        }
        this.f9850array[index] = element;
        this.size++;
        ((AbstractList) this).modCount++;
    }
    ...
    public boolean addAll(Collection<? extends Double> collection) {
        ...
        double[] dArr = this.f9850array;
        if (i3 > dArr.length) {
            this.f9850array = Arrays.copyOf(dArr, i3);
        }
        System.arraycopy(doubleArrayList.f9850array, 0, this.f9850array, this.size, doubleArrayList.size);
        this.size = i3;
        ((AbstractList) this).modCount++;
        return true;
    }

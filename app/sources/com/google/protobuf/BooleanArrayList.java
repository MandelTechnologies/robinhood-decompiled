...
final class BooleanArrayList extends AbstractProtobufList<Boolean> implements Internal.BooleanList, RandomAccess, PrimitiveNonBoxingCollection {
    ...
    public boolean equals(Object o) {
        ...
        boolean[] zArr = booleanArrayList.f9849array;
        for (int i = 0; i < this.size; i++) {
            if (this.f9849array[i] != zArr[i]) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode() {
        int iHashBoolean = 1;
        for (int i = 0; i < this.size; i++) {
            iHashBoolean = (iHashBoolean * 31) + Internal.hashBoolean(this.f9849array[i]);
        }
        return iHashBoolean;
    }
    ...
    public Internal.ProtobufList<Boolean> mutableCopyWithCapacity2(int capacity) {
        ...
        return new BooleanArrayList(Arrays.copyOf(this.f9849array, capacity), this.size, true);
    }
    ...
    public int indexOf(Object element) {
        ...
        for (int i = 0; i < size; i++) {
            if (this.f9849array[i] == zBooleanValue) {
                return i;
            }
        }
        return -1;
    ...
    public void addBoolean(boolean element) {
        ...
        if (i == zArr.length) {
            ...
            this.f9849array = zArr2;
        }
        boolean[] zArr3 = this.f9849array;
        int i2 = this.size;
        this.size = i2 + 1;
        zArr3[i2] = element;
    }
    ...
    private void addBoolean(int index, boolean element) {
        ...
        if (i < zArr.length) {
            ...
            System.arraycopy(this.f9849array, index, zArr2, index + 1, this.size - index);
            this.f9849array = zArr2;
        }
        this.f9849array[index] = element;
        this.size++;
        ((AbstractList) this).modCount++;
    }
    ...
    public boolean addAll(Collection<? extends Boolean> collection) {
        ...
        boolean[] zArr = this.f9849array;
        if (i3 > zArr.length) {
            this.f9849array = Arrays.copyOf(zArr, i3);
        }
        System.arraycopy(booleanArrayList.f9849array, 0, this.f9849array, this.size, booleanArrayList.size);
        this.size = i3;
        ((AbstractList) this).modCount++;
        return true;
    }

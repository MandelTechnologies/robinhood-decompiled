...
public final class FieldType {
    ...
    static {
        ...
        for (FieldType fieldType52 : fieldTypeArrValues) {
            VALUES[fieldType52.f942id] = fieldType52;
        }
    }

    private FieldType(String $enum$name, int $enum$ordinal, int id, Collection collection, JavaType javaType) {
        int i;
        this.f942id = id;
        this.collection = collection;
        this.javaType = javaType;
        int i2 = C56721.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i2 == 1 || i2 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i = C56721.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i == 2 || i == 3) ? false : true;
    }

    /* renamed from: com.google.protobuf.FieldType$1 */
    static /* synthetic */ class C56721 {
    ...
    private boolean isValidForList(java.lang.reflect.Field field) {
        ...
        java.lang.reflect.Type listParameter = getListParameter(type2, actualTypeArguments);
    ...
    private static java.lang.reflect.Type getGenericSuperList(Class<?> clazz) {
        for (java.lang.reflect.Type type2 : clazz.getGenericInterfaces()) {

...
public abstract class CodedOutputStream extends ByteOutput {
        ...
        public final void writeUInt32NoTag(int value) throws IOException {
            while ((value & (-128)) != 0) {
                try {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    bArr[i] = (byte) ((value & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | 128);
                    value >>>= 7;
                } catch (IndexOutOfBoundsException e) {
                    throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1), e);
                }
        ...
        public final void writeUInt64NoTag(long value) throws IOException {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS && spaceLeft() >= 10) {
                while ((value & (-128)) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, i, (byte) ((((int) value) & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | 128));
                    value >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
            ...
            while ((value & (-128)) != 0) {
                try {
                    ...
                    this.position = i3 + 1;
                    bArr3[i3] = (byte) ((((int) value) & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | 128);
                    value >>>= 7;
                } catch (IndexOutOfBoundsException e) {
                    throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1), e);
                }
    ...
    private static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt32NoTag(int value) throws IOException {
            while ((value & (-128)) != 0) {
                try {
                    this.buffer.put((byte) ((value & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | 128));
                    value >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new OutOfSpaceException(e);
                }
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            while (((-128) & value) != 0) {
                try {
                    this.buffer.put((byte) ((((int) value) & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | 128));
                    value >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new OutOfSpaceException(e);
                }
        ...
        public void writeUInt32NoTag(int value) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((value & (-128)) != 0) {
                    long j = this.position;
                    this.position = j + 1;
                    UnsafeUtil.putByte(j, (byte) ((value & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | 128));
                    value >>>= 7;
                }
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((value & (-128)) != 0) {
                    long j = this.position;
                    this.position = j + 1;
                    UnsafeUtil.putByte(j, (byte) ((((int) value) & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | 128));
                    value >>>= 7;
                }
                long j2 = this.position;
                this.position = 1 + j2;
            ...
            while (true) {
                ...
                if ((value & (-128)) == 0) {
                    ...
                    this.position = j3 + 1;
                    UnsafeUtil.putByte(j3, (byte) ((((int) value) & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | 128));
                    value >>>= 7;
                }
            }
        }
        ...
        final void bufferUInt32NoTag(int value) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((value & (-128)) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, i, (byte) ((value & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | 128));
                    value >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
            ...
            while ((value & (-128)) != 0) {
                ...
                int i3 = this.position;
                this.position = i3 + 1;
                bArr3[i3] = (byte) ((value & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | 128);
                this.totalBytesWritten++;
                value >>>= 7;
            }
            byte[] bArr4 = this.buffer;
        ...
        public void writeStringNoTag(String value) throws IOException {
            ...
            try {
                ...
                if (iComputeUInt32SizeNoTag2 == iComputeUInt32SizeNoTag) {
                    ...
                    this.position = i4;
                    int iEncode2 = Utf8.encode(value, this.buffer, i4, this.limit - i4);
                    this.position = i3;
    ...
    private static final class OutputStreamEncoder extends AbstractBufferedEncoder {
        ...
        public void write(byte[] value, int offset, int length) throws IOException {
            ...
            int i2 = this.position;
            if (i - i2 >= length) {
                System.arraycopy(value, offset, this.buffer, i2, length);
                this.position += length;
                this.totalBytesWritten += length;
                return;
            }
            int i3 = i - i2;
            System.arraycopy(value, offset, this.buffer, i2, i3);
            int i4 = offset + i3;
            int i5 = length - i3;
            ...
            doFlush();
            if (i5 <= this.limit) {
                System.arraycopy(value, i4, this.buffer, 0, i5);
                this.position = i5;
            } else {
                this.out.write(value, i4, i5);
            }
            this.totalBytesWritten += i5;
        }
        ...
        public void write(ByteBuffer value) throws IOException {
            ...
            int i2 = this.position;
            if (i - i2 >= iRemaining) {
                value.get(this.buffer, i2, iRemaining);
                this.position += iRemaining;
                this.totalBytesWritten += iRemaining;
                return;
            }
            int i3 = i - i2;
            value.get(this.buffer, i2, i3);
            ...
            while (true) {
                int i5 = this.limit;
                if (i4 > i5) {
                    value.get(this.buffer, 0, i5);
                    this.out.write(this.buffer, 0, this.limit);
                    int i6 = this.limit;
                    i4 -= i6;
                    this.totalBytesWritten += i6;
                } else {
                    value.get(this.buffer, 0, i4);
                    this.position = i4;

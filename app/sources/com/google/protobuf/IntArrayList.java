...
final class IntArrayList extends AbstractProtobufList<Integer> implements Internal.IntList, RandomAccess, PrimitiveNonBoxingCollection {
    ...
    public boolean equals(Object o) {
        ...
        int[] iArr = intArrayList.f9855array;
        for (int i = 0; i < this.size; i++) {
            if (this.f9855array[i] != iArr[i]) {
                return false;
            }
        }
        return true;
    ...
    public Internal.ProtobufList<Integer> mutableCopyWithCapacity2(int capacity) {
        ...
        return new IntArrayList(Arrays.copyOf(this.f9855array, capacity), this.size, true);
    }
    ...
    public int indexOf(Object element) {
        ...
        for (int i = 0; i < size; i++) {
            if (this.f9855array[i] == iIntValue) {
                return i;
            }
        }
        return -1;
    ...
    public void addInt(int element) {
        ...
        if (i == iArr.length) {
            ...
            this.f9855array = iArr2;
        }
        int[] iArr3 = this.f9855array;
        int i2 = this.size;
        this.size = i2 + 1;
        iArr3[i2] = element;
    }
    ...
    private void addInt(int index, int element) {
        ...
        if (i < iArr.length) {
            ...
            System.arraycopy(this.f9855array, index, iArr2, index + 1, this.size - index);
            this.f9855array = iArr2;
        }
        this.f9855array[index] = element;
        this.size++;
        ((AbstractList) this).modCount++;
    }
    ...
    public boolean addAll(Collection<? extends Integer> collection) {
        ...
        int[] iArr = this.f9855array;
        if (i3 > iArr.length) {
            this.f9855array = Arrays.copyOf(iArr, i3);
        }
        System.arraycopy(intArrayList.f9855array, 0, this.f9855array, this.size, intArrayList.size);
        this.size = i3;
        ((AbstractList) this).modCount++;
        return true;
    }

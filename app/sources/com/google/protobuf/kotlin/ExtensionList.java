...
public final class ExtensionList<E, M extends MessageLite> implements List<E>, KMarkers {
    ...
    public ListIterator<E> listIterator() {
        return new UnmodifiableCollections3(this.delegate.listIterator());
    }

    @Override // java.util.List
    public ListIterator<E> listIterator(int index) {
        return new UnmodifiableCollections3(this.delegate.listIterator(index));
    }

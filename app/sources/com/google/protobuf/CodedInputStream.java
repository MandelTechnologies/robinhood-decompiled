...
public abstract class CodedInputStream {
    ...
    public static int readRawVarint32(final int firstByte, final InputStream input) throws IOException {
        ...
        int i = firstByte & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE;
        int i2 = 7;
        while (i2 < 32) {
            int i3 = input.read();
            if (i3 == -1) {
            ...
            i |= (i3 & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) << i2;
            if ((i3 & 128) == 0) {
                return i;
            }
            i2 += 7;
    ...
    private static final class StreamDecoder extends CodedInputStream {
        ...
        private boolean tryRefillBuffer(int n) throws IOException {
            ...
            if (n > (i2 - i3) - i || i3 + i + n > this.currentLimit) {
                return false;
            }
            ...
            int i7 = read(inputStream, bArr2, i6, Math.min(bArr2.length - i6, (this.sizeLimit - this.totalBytesRetired) - i6));
        ...
        private byte[] readRawBytesSlowPathOneChunk(final int size) throws IOException {
            ...
            int i5 = this.bufferSize - i2;
            int i6 = size - i5;
            if (i6 >= 4096 && i6 > available(this.input)) {
                return null;
            }
            byte[] bArr = new byte[size];
            ...
            this.bufferSize = 0;
            while (i5 < size) {
                int i7 = read(this.input, bArr, i5, size - i5);
                if (i7 == -1) {
                    throw InvalidProtocolBufferException.truncatedMessage();
                }

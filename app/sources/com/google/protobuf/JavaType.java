...
public final class JavaType {
    ...
    private JavaType(String $enum$name, int $enum$ordinal, Class type2, Class boxedType, Object defaultDefault) {
        this.f9856type = type2;
    ...
    public boolean isValidType(Class<?> t) {
        return this.f9856type.isAssignableFrom(t);
    }
}

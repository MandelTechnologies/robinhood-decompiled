...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    private final FieldType f9851type;
    ...
    public Class<?> getMessageFieldClass() {
        int i = C56691.$SwitchMap$com$google$protobuf$FieldType[this.f9851type.ordinal()];
        if (i == 1 || i == 2) {
    ...
    public static final class Builder {
        ...
        /* renamed from: type, reason: collision with root package name */
        private FieldType f9852type;

        /* synthetic */ Builder(C56691 c56691) {
            this();
        }
        ...
        public FieldInfo build() {
            ...
            if (oneofInfo != null) {
                return FieldInfo.forOneofMemberField(this.fieldNumber, this.f9852type, oneofInfo, this.oneofStoredType, this.enforceUtf8, this.enumVerifier);
            }
            ...
            if (field != null) {
                if (this.required) {
                    return FieldInfo.forLegacyRequiredField(this.field, this.fieldNumber, this.f9852type, field, this.presenceMask, this.enforceUtf8, this.enumVerifier);
                }
                return FieldInfo.forExplicitPresenceField(this.field, this.fieldNumber, this.f9852type, field, this.presenceMask, this.enforceUtf8, this.enumVerifier);
            }
            Internal.EnumVerifier enumVerifier = this.enumVerifier;
            if (enumVerifier != null) {
                java.lang.reflect.Field field2 = this.cachedSizeField;
                if (field2 == null) {
                    return FieldInfo.forFieldWithEnumVerifier(this.field, this.fieldNumber, this.f9852type, enumVerifier);
                }
                return FieldInfo.forPackedFieldWithEnumVerifier(this.field, this.fieldNumber, this.f9852type, enumVerifier, field2);
            }
            java.lang.reflect.Field field3 = this.cachedSizeField;
            if (field3 == null) {
                return FieldInfo.forField(this.field, this.fieldNumber, this.f9852type, this.enforceUtf8);
            }
            return FieldInfo.forPackedField(this.field, this.fieldNumber, this.f9852type, field3);
        }
    }
}

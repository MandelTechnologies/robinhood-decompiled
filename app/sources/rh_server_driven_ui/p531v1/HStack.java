...
public final class HStack extends Message {
    ...
    public /* bridge */ /* synthetic */ Message.Builder newBuilder() {
        return (Message.Builder) m29745newBuilder();
    }

    public /* synthetic */ HStack(List list, double d, StackAlignment stackAlignment, Boolean bool, ByteString byteString, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public HStack(List<WeightedItem> components, double d, StackAlignment alignment, Boolean bool, ByteString unknownFields) {
    ...
    public /* synthetic */ Void m29745newBuilder() {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof HStack)) {
            return false;
        }
        HStack hStack = (HStack) other;
        return Intrinsics.areEqual(unknownFields(), hStack.unknownFields()) && Intrinsics.areEqual(this.components, hStack.components) && this.spacing == hStack.spacing && this.alignment == hStack.alignment && Intrinsics.areEqual(this.web_flex_no_wrap, hStack.web_flex_no_wrap);
    }
    ...
    public String toString() {
        ...
        return CollectionsKt.joinToString$default(arrayList, ", ", "HStack{", "}", 0, null, null, 56, null);
    }

    public static /* synthetic */ HStack copy$default(HStack hStack, List list, double d, StackAlignment stackAlignment, Boolean bool, ByteString byteString, int i, Object obj) {
        if ((i & 1) != 0) {
            list = hStack.components;
        }
        if ((i & 2) != 0) {
            d = hStack.spacing;
        }
        if ((i & 4) != 0) {
            stackAlignment = hStack.alignment;
        }
        if ((i & 8) != 0) {
            bool = hStack.web_flex_no_wrap;
        }
        if ((i & 16) != 0) {
            byteString = hStack.unknownFields();
        }
        ByteString byteString2 = byteString;
        StackAlignment stackAlignment2 = stackAlignment;
        return hStack.copy(list, d, stackAlignment2, bool, byteString2);
    }

    public final HStack copy(List<WeightedItem> components, double spacing, StackAlignment alignment, Boolean web_flex_no_wrap, ByteString unknownFields) {
        Intrinsics.checkNotNullParameter(components, "components");
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        Intrinsics.checkNotNullParameter(unknownFields, "unknownFields");
        return new HStack(components, spacing, alignment, web_flex_no_wrap, unknownFields);
    }

    static {
        final FieldEncoding fieldEncoding = FieldEncoding.LENGTH_DELIMITED;
        final KClass orCreateKotlinClass = Reflection.getOrCreateKotlinClass(HStack.class);
        final Syntax syntax = Syntax.PROTO_3;
        ADAPTER = new ProtoAdapter<HStack>(fieldEncoding, orCreateKotlinClass, syntax) { // from class: rh_server_driven_ui.v1.HStack$Companion$ADAPTER$1
            @Override // com.squareup.wire.ProtoAdapter
            public int encodedSize(HStack value) {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(ProtoWriter writer, HStack value) throws IOException {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(ReverseProtoWriter writer, HStack value) throws IOException {
                Intrinsics.checkNotNullParameter(writer, "writer");
                Intrinsics.checkNotNullParameter(value, "value");
                writer.writeBytes(value.unknownFields());
                ProtoAdapter.BOOL.encodeWithTag(writer, 4, (int) value.getWeb_flex_no_wrap());
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public HStack decode(ProtoReader reader) throws IOException {
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (iNextTag == -1) {
                            return new HStack(arrayList, dDoubleValue, stackAlignment, boolDecode, reader.endMessageAndGetUnknownFields(jBeginMessage));
                        }
                        if (iNextTag == 1) {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public HStack redact(HStack value) {
                Intrinsics.checkNotNullParameter(value, "value");
                return HStack.copy$default(value, Internal.m26823redactElements(value.getComponents(), WeightedItem.ADAPTER), 0.0d, null, null, ByteString.EMPTY, 14, null);
            }
        };
    }
}

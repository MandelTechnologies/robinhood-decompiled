...
public final class CompletableMergeDelayErrorIterable extends Completable {
    ...
    public void subscribeActual(final CompletableObserver completableObserver) {
        ...
        try {
            ...
            while (!compositeDisposable.getDisposed()) {
                try {
                    if (it.hasNext()) {
                        ...
                        try {
                            ...
                            completableSource.subscribe(new CompletableObserver(completableObserver, compositeDisposable, atomicThrowable, atomicInteger) { // from class: io.reactivex.internal.operators.completable.CompletableMergeDelayErrorArray$MergeInnerCompletableObserver

    ...
    static final class FlatMapSingleObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        */
        ...
        SpscLinkedArrayQueue<R> getOrCreateQueue() {
            ...
            } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(this.queue, null, spscLinkedArrayQueue));
        ...
        void drainLoop() {
            ...
            while (!this.cancelled) {
                ...
                C0008xc140899a c0008xc140899aPoll = spscLinkedArrayQueue != null ? spscLinkedArrayQueue.poll() : null;
                boolean z2 = c0008xc140899aPoll == null;
                if (z && z2) {

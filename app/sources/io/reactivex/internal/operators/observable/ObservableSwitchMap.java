    ...
    static final class SwitchMapObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(this.active, switchMapInnerObserver, switchMapInnerObserver3));
            ...
            while (!this.cancelled) {
                ...
                if (switchMapInnerObserver != null && (simpleQueue = switchMapInnerObserver.queue) != null) {
                    if (switchMapInnerObserver.done) {
                        ...
                        if (z) {
                            if (zIsEmpty) {
                                PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(atomicReference, switchMapInnerObserver, null);
                            }
                        } else if (this.errors.get() != null) {
                            observer.onError(this.errors.terminate());
                            return;
                    ...
                    while (!this.cancelled) {
                        if (switchMapInnerObserver == atomicReference.get()) {
                            ...
                            boolean z5 = c0008xc140899aPoll == null;
                            if (z4 && z5) {
                                PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(atomicReference, switchMapInnerObserver, null);
                            } else if (!z5) {
                                observer.onNext(c0008xc140899aPoll);
                            } else if (!z3) {
                                continue;
                            }
                        }

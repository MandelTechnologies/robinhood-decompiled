...
public final class ObservableBufferTimed<T, U extends Collection<? super T>> extends AbstractObservableWithUpstream<T, U> {
            ...
            if (DisposableHelper.validate(this.upstream, disposable)) {
                ...
                try {
                    ...
                    if (!this.cancelled) {
                        ...
                        if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(this.timer, null, disposableSchedulePeriodicallyDirect)) {
                            return;
                        }
    ...
    static final class BufferSkipBoundedObserver<T, U extends Collection<? super T>> extends QueueDrainObserver<T, U, U> implements Runnable, Disposable {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.upstream, disposable)) {
                ...
                try {
                    ...
                    this.downstream.onSubscribe(this);
                    Scheduler.Worker worker = this.f6601w;
                    long j = this.timeskip;
                    worker.schedulePeriodically(this, j, j, this.unit);
                    this.f6601w.schedule(new RemoveFromBufferEmit(collection), this.timespan, this.unit);
                } catch (Throwable th) {
                    Exceptions.throwIfFatal(th);
                    disposable.dispose();
                    EmptyDisposable.error(th, this.downstream);
        ...
        public void onComplete() {
            ...
            this.done = true;
            if (enter()) {
                QueueDrainHelper.drainLoop(this.queue, this.downstream, false, this.f6601w, this);
            }
        }
            ...
            try {
                ...
                synchronized (this) {
                    try {
                        ...
                        this.buffers.add(collection);
                        this.f6601w.schedule(new RemoveFromBuffer(collection), this.timespan, this.unit);
                    } catch (Throwable th) {
                        throw th;
                    }
                }
        ...
        final class RemoveFromBuffer implements Runnable {
            ...
            public void run() {
                synchronized (BufferSkipBoundedObserver.this) {
                    BufferSkipBoundedObserver.this.buffers.remove(this.f6602b);
                }
                BufferSkipBoundedObserver bufferSkipBoundedObserver = BufferSkipBoundedObserver.this;
                bufferSkipBoundedObserver.fastPathOrderedEmit(this.f6602b, false, bufferSkipBoundedObserver.f6601w);
            }
        }
        ...
        final class RemoveFromBufferEmit implements Runnable {
            ...
            public void run() {
                ...
                BufferSkipBoundedObserver bufferSkipBoundedObserver = BufferSkipBoundedObserver.this;
                bufferSkipBoundedObserver.fastPathOrderedEmit(this.buffer, false, bufferSkipBoundedObserver.f6601w);
            }
        }
    }
    ...
    static final class BufferExactBoundedObserver<T, U extends Collection<? super T>> extends QueueDrainObserver<T, U, U> implements Runnable, Disposable {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.upstream, disposable)) {
                ...
                try {
                    this.buffer = (U) ObjectHelper.requireNonNull(this.bufferSupplier.call(), "The buffer supplied is null");
                    this.downstream.onSubscribe(this);
                    Scheduler.Worker worker = this.f6600w;
                    long j = this.timespan;
        ...
        public void onNext(T r8) {
            ...
            L2d:
                ...
                boolean r8 = r7.restartTimerOnMaxSize
                if (r8 == 0) goto L5b
                io.reactivex.Scheduler$Worker r0 = r7.f6600w
                long r2 = r7.timespan

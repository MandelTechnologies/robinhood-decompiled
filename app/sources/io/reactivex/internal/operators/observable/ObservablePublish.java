...
public final class ObservablePublish<T> extends ConnectableObservable<T> implements ObservablePublishClassic<T> {
    ...
    public void connect(Consumer<? super Disposable> consumer) {
        ...
        while (true) {
            ...
            if (publishObserver != null && !publishObserver.getDisposed()) {
                break;
            }
            PublishObserver<T> publishObserver2 = new PublishObserver<>(this.current);
            if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(this.current, publishObserver, publishObserver2)) {
    ...
    static final class PublishObserver<T> implements Observer<T>, Disposable {
        ...
        public void dispose() {
            ...
            if (atomicReference.getAndSet(innerDisposableArr) != innerDisposableArr) {
                PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(this.current, this, null);
        ...
        public void subscribe(Observer<? super T> observer) {
            ...
            while (true) {
                ...
                if (publishObserver == null || publishObserver.getDisposed()) {
                    ...
                    if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(this.curr, publishObserver, publishObserver2)) {
                        publishObserver = publishObserver2;
                    } else {
                        continue;
                    }

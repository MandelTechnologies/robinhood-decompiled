...
public final class ObservableScalarXMap {
    public static <T, R> boolean tryScalarXMapSubscribe(ObservableSource<T> observableSource, Observer<? super R> observer, Function<? super T, ? extends ObservableSource<? extends R>> function) {
        ...
        try {
            C0007xc1408999 c0007xc1408999 = (Object) ((Callable) observableSource).call();
            if (c0007xc1408999 == null) {
                EmptyDisposable.complete(observer);
                return true;
            }
            try {
                ObservableSource observableSource2 = (ObservableSource) ObjectHelper.requireNonNull(function.apply(c0007xc1408999), "The mapper returned a null ObservableSource");

...
public final class ObservablePublishAlt<T> extends ConnectableObservable<T> implements ResettableConnectable {
    ...
    public void connect(Consumer<? super Disposable> consumer) {
        ...
        while (true) {
            ...
            if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(this.current, publishConnection, publishConnection2)) {
    ...
    public void resetIf(Disposable disposable) {
        PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(this.current, (PublishConnection) disposable, null);
    }

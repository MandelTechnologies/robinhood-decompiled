...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    /* renamed from: as */
    public final <R> R m3344as(ObservableConverter<T, ? extends R> observableConverter) {
    ...
    /* renamed from: to */
    public final <R> R m3345to(Function<? super Observable<T>, R> function) {
        try {
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy backpressureStrategy) {
        ...
        int i = C456721.$SwitchMap$io$reactivex$BackpressureStrategy[backpressureStrategy.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C456721 {

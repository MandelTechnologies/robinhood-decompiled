...
public final class BehaviorSubject<T> extends Subject<T> {
    ...
    public void onError(Throwable th) {
        ...
        if (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(this.terminalEvent, null, th)) {
    ...
    public void onComplete() {
        if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m88m(this.terminalEvent, null, ExceptionHelper.TERMINATED)) {

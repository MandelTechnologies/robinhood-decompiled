...
public class OrgJsonSerializer<T> implements Serializer<T> {
    ...
    @Override // io.jsonwebtoken.p476io.Serializer
    ...
    protected byte[] toBytes(Object obj) {
        ...
        if (obj instanceof JSONObject) {
            ...
            string2 = (String) Classes.invokeStatic(JSON_WRITER_CLASS_NAME, "valueToString", VALUE_TO_STRING_ARG_TYPES, obj);
        }
        return string2.getBytes(Strings.UTF_8);
    }
}

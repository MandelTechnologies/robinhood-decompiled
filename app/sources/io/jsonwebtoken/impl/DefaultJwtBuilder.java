...
import io.jsonwebtoken.p476io.Encoder;
import io.jsonwebtoken.p476io.Encoders;
import io.jsonwebtoken.p476io.EncodingException;
import io.jsonwebtoken.p476io.SerializationException;
import io.jsonwebtoken.p476io.Serializer;
...
public class DefaultJwtBuilder implements JwtBuilder {
    ...
    public String compact() throws EncodingException, CompressionException {
        ...
        Header headerEnsureHeader = ensureHeader();
        if (headerEnsureHeader instanceof JwsHeader) {
            defaultJwsHeader = (JwsHeader) headerEnsureHeader;
        } else {
            defaultJwsHeader = new DefaultJwsHeader(headerEnsureHeader);
        }
        if (this.key != null) {
        ...
        try {
            ...
            String str2 = strBase64UrlEncode + '.' + this.base64UrlEncoder.encode(bytes);
            Key key = this.key;
            if (key != null) {

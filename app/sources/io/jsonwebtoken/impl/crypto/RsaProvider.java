...
public abstract class RsaProvider extends SignatureProvider {
    ...
    public static KeyPair generateKeyPair(SignatureAlgorithm signatureAlgorithm) {
        ...
        int i = C455411.$SwitchMap$io$jsonwebtoken$SignatureAlgorithm[signatureAlgorithm.ordinal()];
    ...
    static /* synthetic */ class C455411 {
    ...
    protected static KeyPair generateKeyPair(String str, int i, SecureRandom secureRandom) throws NoSuchAlgorithmException {
        try {

...
public final class Keys {
    ...
    /* renamed from: EC */
    private static final String f6579EC = "io.jsonwebtoken.impl.crypto.EllipticCurveProvider";
    ...
    static /* synthetic */ class C455511 {
    ...
    public static SecretKey secretKeyFor(SignatureAlgorithm signatureAlgorithm) throws IllegalArgumentException {
        ...
        int i = C455511.$SwitchMap$io$jsonwebtoken$SignatureAlgorithm[signatureAlgorithm.ordinal()];
        if (i == 1 || i == 2 || i == 3) {
    ...
    public static KeyPair keyPairFor(SignatureAlgorithm signatureAlgorithm) throws IllegalArgumentException {
        Assert.notNull(signatureAlgorithm, "SignatureAlgorithm cannot be null.");
        switch (C455511.$SwitchMap$io$jsonwebtoken$SignatureAlgorithm[signatureAlgorithm.ordinal()]) {
            case 4:
            case 5:
            case 6:
            case 7:
            ...
            case 11:
            case 12:
                return (KeyPair) Classes.invokeStatic(f6579EC, "generateKeyPair", SIG_ARG_TYPES, signatureAlgorithm);
            default:

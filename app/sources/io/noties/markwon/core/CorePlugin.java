...
public class CorePlugin extends AbstractMarkwonPlugin {
    ...
    private void text(MarkwonVisitor.Builder builder) {
        builder.mo3341on(Text.class, new MarkwonVisitor.NodeVisitor<Text>() { // from class: io.noties.markwon.core.CorePlugin.1
    ...
    private static void strongEmphasis(MarkwonVisitor.Builder builder) {
        builder.mo3341on(StrongEmphasis.class, new MarkwonVisitor.NodeVisitor<StrongEmphasis>() { // from class: io.noties.markwon.core.CorePlugin.2
            @Override // io.noties.markwon.MarkwonVisitor.NodeVisitor
    ...
    private static void emphasis(MarkwonVisitor.Builder builder) {
        builder.mo3341on(Emphasis.class, new MarkwonVisitor.NodeVisitor<Emphasis>() { // from class: io.noties.markwon.core.CorePlugin.3
            @Override // io.noties.markwon.MarkwonVisitor.NodeVisitor
    ...
    private static void blockQuote(MarkwonVisitor.Builder builder) {
        builder.mo3341on(BlockQuote.class, new MarkwonVisitor.NodeVisitor<BlockQuote>() { // from class: io.noties.markwon.core.CorePlugin.4
            @Override // io.noties.markwon.MarkwonVisitor.NodeVisitor
    ...
    private static void code(MarkwonVisitor.Builder builder) {
        builder.mo3341on(Code.class, new MarkwonVisitor.NodeVisitor<Code>() { // from class: io.noties.markwon.core.CorePlugin.5
            @Override // io.noties.markwon.MarkwonVisitor.NodeVisitor
    ...
    private static void fencedCodeBlock(MarkwonVisitor.Builder builder) {
        builder.mo3341on(FencedCodeBlock.class, new MarkwonVisitor.NodeVisitor<FencedCodeBlock>() { // from class: io.noties.markwon.core.CorePlugin.6
            @Override // io.noties.markwon.MarkwonVisitor.NodeVisitor
    ...
    private static void indentedCodeBlock(MarkwonVisitor.Builder builder) {
        builder.mo3341on(IndentedCodeBlock.class, new MarkwonVisitor.NodeVisitor<IndentedCodeBlock>() { // from class: io.noties.markwon.core.CorePlugin.7
            @Override // io.noties.markwon.MarkwonVisitor.NodeVisitor
    ...
    private static void image(MarkwonVisitor.Builder builder) {
        builder.mo3341on(Image.class, new MarkwonVisitor.NodeVisitor<Image>() { // from class: io.noties.markwon.core.CorePlugin.8
            @Override // io.noties.markwon.MarkwonVisitor.NodeVisitor
    ...
    private static void bulletList(MarkwonVisitor.Builder builder) {
        builder.mo3341on(BulletList.class, new SimpleBlockNodeVisitor());
    }

    private static void orderedList(MarkwonVisitor.Builder builder) {
        builder.mo3341on(OrderedList.class, new SimpleBlockNodeVisitor());
    }

    private static void listItem(MarkwonVisitor.Builder builder) {
        builder.mo3341on(ListItem.class, new MarkwonVisitor.NodeVisitor<ListItem>() { // from class: io.noties.markwon.core.CorePlugin.9
            @Override // io.noties.markwon.MarkwonVisitor.NodeVisitor
    ...
    private static void thematicBreak(MarkwonVisitor.Builder builder) {
        builder.mo3341on(ThematicBreak.class, new MarkwonVisitor.NodeVisitor<ThematicBreak>() { // from class: io.noties.markwon.core.CorePlugin.10
            @Override // io.noties.markwon.MarkwonVisitor.NodeVisitor
    ...
    private static void heading(MarkwonVisitor.Builder builder) {
        builder.mo3341on(Heading.class, new MarkwonVisitor.NodeVisitor<Heading>() { // from class: io.noties.markwon.core.CorePlugin.11
            @Override // io.noties.markwon.MarkwonVisitor.NodeVisitor
    ...
    private static void softLineBreak(MarkwonVisitor.Builder builder) {
        builder.mo3341on(SoftLineBreak.class, new MarkwonVisitor.NodeVisitor<SoftLineBreak>() { // from class: io.noties.markwon.core.CorePlugin.12
            @Override // io.noties.markwon.MarkwonVisitor.NodeVisitor
    ...
    private static void hardLineBreak(MarkwonVisitor.Builder builder) {
        builder.mo3341on(HardLineBreak.class, new MarkwonVisitor.NodeVisitor<HardLineBreak>() { // from class: io.noties.markwon.core.CorePlugin.13
            @Override // io.noties.markwon.MarkwonVisitor.NodeVisitor
    ...
    private static void paragraph(MarkwonVisitor.Builder builder) {
        builder.mo3341on(Paragraph.class, new MarkwonVisitor.NodeVisitor<Paragraph>() { // from class: io.noties.markwon.core.CorePlugin.14
            @Override // io.noties.markwon.MarkwonVisitor.NodeVisitor
    ...
    private static void link(MarkwonVisitor.Builder builder) {
        builder.mo3341on(Link.class, new MarkwonVisitor.NodeVisitor<Link>() { // from class: io.noties.markwon.core.CorePlugin.15
            @Override // io.noties.markwon.MarkwonVisitor.NodeVisitor

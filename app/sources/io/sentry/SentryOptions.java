...
public class SentryOptions {
    ...
    private SentryOptions(boolean z) {
        ...
        this.connectionTimeoutMillis = OptionChainListView9.SELLOUT_SNACKBAR_DISPLAY_DURATION_MS;
        this.readTimeoutMillis = OptionChainListView9.SELLOUT_SNACKBAR_DISPLAY_DURATION_MS;
        ...
        this.cron = null;
        this.experimental = new ExperimentalOptions();
    ...
    private SdkVersion createSdkVersion() {
        SdkVersion sdkVersion = new SdkVersion("sentry.java", "7.14.0");
        sdkVersion.setVersion("7.14.0");
        return sdkVersion;
    }

    private void addPackageInfo() {
        SentryIntegrationPackageStorage.getInstance().addPackage("maven:io.sentry:sentry", "7.14.0");
    }

...
public final class DeduplicateMultithreadedEventProcessor implements EventProcessor {
    ...
    public SentryEvent process(SentryEvent sentryEvent, Hint hint) {
        ...
        String type2;
        Long threadId;
        if (!HintUtils.hasType(hint, UncaughtExceptionHandlerIntegration.UncaughtExceptionHint.class) || (unhandledException = sentryEvent.getUnhandledException()) == null || (type2 = unhandledException.getType()) == null || (threadId = unhandledException.getThreadId()) == null) {
            return sentryEvent;
        }
        Long l = this.processedEvents.get(type2);
        ...
        this.processedEvents.put(type2, threadId);
        return sentryEvent;
    }
}

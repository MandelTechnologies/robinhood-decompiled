...
public final class AsyncHttpTransport implements ITransport {
    ...
    public void send(SentryEnvelope sentryEnvelope, Hint hint) throws IOException {
        ...
        if (futureSubmit != null && futureSubmit.isCancelled()) {
            ...
            HintUtils.runIfHasType(hint, Enqueable.class, new HintUtils.SentryConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$$ExternalSyntheticLambda1
                @Override // io.sentry.util.HintUtils.SentryConsumer
                public final void accept(Object obj) {
                    AsyncHttpTransport.$r8$lambda$QFwmx00Wn2W01Tfksx3lb2VnVcQ(this.f$0, (Enqueable) obj);
                }
            });
        }
    }

    public static /* synthetic */ void $r8$lambda$QFwmx00Wn2W01Tfksx3lb2VnVcQ(AsyncHttpTransport asyncHttpTransport, Enqueable enqueable) {
    ...
    private static QueuedThreadPoolExecutor initExecutor(int i, final IEnvelopeCache iEnvelopeCache, final ILogger iLogger, SentryDateProvider sentryDateProvider) {
        return new QueuedThreadPoolExecutor(1, i, new AsyncConnectionThreadFactory(), new RejectedExecutionHandler() { // from class: io.sentry.transport.AsyncHttpTransport$$ExternalSyntheticLambda0
            ...
            public final void rejectedExecution(Runnable runnable, ThreadPoolExecutor threadPoolExecutor) {
                AsyncHttpTransport.$r8$lambda$hglTxZhA61EC5fC9u56hg8qtENw(iEnvelopeCache, iLogger, runnable, threadPoolExecutor);
            }
        }, iLogger, sentryDateProvider);
    }

    public static /* synthetic */ void $r8$lambda$hglTxZhA61EC5fC9u56hg8qtENw(IEnvelopeCache iEnvelopeCache, ILogger iLogger, Runnable runnable, ThreadPoolExecutor threadPoolExecutor) {
    ...
    private static void markHintWhenSendingFailed(Hint hint, final boolean z) {
        HintUtils.runIfHasType(hint, SubmissionResult.class, new HintUtils.SentryConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$$ExternalSyntheticLambda2
            @Override // io.sentry.util.HintUtils.SentryConsumer
            public final void accept(Object obj) {
                ((SubmissionResult) obj).setResult(false);
            }
        });
        HintUtils.runIfHasType(hint, Retryable.class, new HintUtils.SentryConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$$ExternalSyntheticLambda3
            @Override // io.sentry.util.HintUtils.SentryConsumer
            public final void accept(Object obj) {
    ...
    final class EnvelopeSender implements Runnable {
        ...
        private TransportResult flush() {
            ...
            HintUtils.runIfHasType(this.hint, DiskFlushNotification.class, new HintUtils.SentryConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$EnvelopeSender$$ExternalSyntheticLambda1
                @Override // io.sentry.util.HintUtils.SentryConsumer
                public final void accept(Object obj) {
                    AsyncHttpTransport.EnvelopeSender.m28544$r8$lambda$4Y2wdjjAwcDW8vX65EqEzFK0(this.f$0, (DiskFlushNotification) obj);
                }
            });
                ...
                try {
                    ...
                    HintUtils.runIfHasType(this.hint, Retryable.class, new HintUtils.SentryConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$EnvelopeSender$$ExternalSyntheticLambda3
                        ...
                        public final void accept(Object obj, Class cls) {
                            AsyncHttpTransport.EnvelopeSender.$r8$lambda$D07djJzsG__0PvuVMBIYEINIxw8(this.f$0, sentryEnvelopeAttachReportToEnvelope, obj, cls);
                        }
                    });
            ...
            HintUtils.runIfHasType(this.hint, Retryable.class, new HintUtils.SentryConsumer() { // from class: io.sentry.transport.AsyncHttpTransport$EnvelopeSender$$ExternalSyntheticLambda5
                ...
                @Override // io.sentry.util.HintUtils.SentryHintFallback
                public final void accept(Object obj, Class cls) {
                    AsyncHttpTransport.EnvelopeSender.$r8$lambda$zXig3gXDHVCRyLZNRRRDh1ONCA8(this.f$0, obj, cls);
                }
            });
            return transportResult;
        }

        /* renamed from: $r8$lambda$4Y2-wdjjA-wcDW8vX65-EqEzFK0, reason: not valid java name */
        public static /* synthetic */ void m28544$r8$lambda$4Y2wdjjAwcDW8vX65EqEzFK0(EnvelopeSender envelopeSender, DiskFlushNotification diskFlushNotification) {
        ...
        public static /* synthetic */ void $r8$lambda$D07djJzsG__0PvuVMBIYEINIxw8(EnvelopeSender envelopeSender, SentryEnvelope sentryEnvelope, Object obj, Class cls) {
        ...
        public static /* synthetic */ void $r8$lambda$zXig3gXDHVCRyLZNRRRDh1ONCA8(EnvelopeSender envelopeSender, Object obj, Class cls) {
            LogUtils.logNotInstanceOf(cls, obj, AsyncHttpTransport.this.options.getLogger());

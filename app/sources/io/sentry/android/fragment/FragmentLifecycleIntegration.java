...
public final class FragmentLifecycleIntegration implements Application.ActivityLifecycleCallbacks, Integration, Closeable {
    ...
    public FragmentLifecycleIntegration(Application application, boolean z, boolean z2) {
        Intrinsics.checkNotNullParameter(application, "application");
        Set set = z ? ArraysKt.toSet(FragmentLifecycleState.values()) : null;
        this(application, (Set<? extends FragmentLifecycleState>) (set == null ? SetsKt.emptySet() : set), z2);
    }
    ...
    public void register(IHub hub, SentryOptions options) {
        ...
        IntegrationUtils.addIntegrationToSdkVersion((Class<?>) FragmentLifecycleIntegration.class);
        SentryIntegrationPackageStorage.getInstance().addPackage("maven:io.sentry:sentry-android-fragment", "7.14.0");
    }

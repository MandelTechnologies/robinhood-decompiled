...
public final class SentryAndroidOptions extends SentryOptions {
    ...
    public SentryAndroidOptions() {
        setSentryClientName("sentry.java.android/7.14.0");
        setSdkVersion(createSdkVersion());
        setAttachServerName(false);
    }

    private SdkVersion createSdkVersion() {
        SdkVersion sdkVersionUpdateSdkVersion = SdkVersion.updateSdkVersion(getSdkVersion(), "sentry.java.android", "7.14.0");
        sdkVersionUpdateSdkVersion.addPackage("maven:io.sentry:sentry-android-core", "7.14.0");

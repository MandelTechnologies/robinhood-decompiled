...
final class AndroidTransportGate implements ITransportGate {
    ...
    /* renamed from: io.sentry.android.core.AndroidTransportGate$1 */
    static /* synthetic */ class C457031 {
    ...
    boolean isConnected(IConnectionStatusProvider.ConnectionStatus connectionStatus) {
        int i = C457031.$SwitchMap$io$sentry$IConnectionStatusProvider$ConnectionStatus[connectionStatus.ordinal()];
        return i == 1 || i == 2 || i == 3;
    }
}

...
public final class PhoneStateBreadcrumbsIntegration implements Integration, Closeable {
            ...
            try {
                sentryOptions.getExecutorService().submit(new Runnable() { // from class: io.sentry.android.core.PhoneStateBreadcrumbsIntegration$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        PhoneStateBreadcrumbsIntegration.m28528$r8$lambda$GIPTUyohKcQuMA6C_BSRlGBZJE(this.f$0, iHub, sentryOptions);
                    }
                });
            } catch (Throwable th) {
    ...
    /* renamed from: $r8$lambda$GIPTUy-ohKcQuMA6C_BSRlGBZJE, reason: not valid java name */
    public static /* synthetic */ void m28528$r8$lambda$GIPTUyohKcQuMA6C_BSRlGBZJE(PhoneStateBreadcrumbsIntegration phoneStateBreadcrumbsIntegration, IHub iHub, SentryOptions sentryOptions) {
        synchronized (phoneStateBreadcrumbsIntegration.startLock) {
            try {
                if (!phoneStateBreadcrumbsIntegration.isClosed) {
                    phoneStateBreadcrumbsIntegration.startTelephonyListener(iHub, sentryOptions);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    private void startTelephonyListener(IHub iHub, SentryOptions sentryOptions) {
        ...
        if (telephonyManager != null) {
            try {
                ...
                IntegrationUtils.addIntegrationToSdkVersion((Class<?>) PhoneStateBreadcrumbsIntegration.class);
                return;
            } catch (Throwable th) {

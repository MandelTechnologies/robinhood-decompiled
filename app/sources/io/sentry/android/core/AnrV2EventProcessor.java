...
public final class AnrV2EventProcessor implements BackfillingEventProcessor {
    ...
    AnrV2EventProcessor(Context context, SentryAndroidOptions sentryAndroidOptions, BuildInfoProvider buildInfoProvider, SecureRandom secureRandom) {
    ...
    private boolean sampleReplay(SentryEvent sentryEvent) {
        String str = (String) PersistingOptionsObserver.read(this.options, "replay-error-sample-rate.json", String.class);
        if (str == null) {
            return false;
        }
        try {
    ...
    private void setReplayId(SentryEvent sentryEvent) {
        String str = (String) PersistingScopeObserver.read(this.options, "replay.json", String.class);
        ...
        PersistingScopeObserver.store(this.options, str, "replay.json");
        sentryEvent.getContexts().put("replay_id", str);
    }

    private void setTrace(SentryEvent sentryEvent) {
        SpanContext spanContext = (SpanContext) PersistingScopeObserver.read(this.options, "trace.json", SpanContext.class);
    ...
    private void setLevel(SentryEvent sentryEvent) {
        SentryLevel sentryLevel = (SentryLevel) PersistingScopeObserver.read(this.options, "level.json", SentryLevel.class);
    ...
    private void setFingerprints(SentryEvent sentryEvent, Object obj) {
        List<String> list = (List) PersistingScopeObserver.read(this.options, "fingerprint.json", List.class);
    ...
    private void setTransaction(SentryEvent sentryEvent) {
        String str = (String) PersistingScopeObserver.read(this.options, "transaction.json", String.class);
    ...
    private void setContexts(SentryBaseEvent sentryBaseEvent) {
        Contexts contexts = (Contexts) PersistingScopeObserver.read(this.options, "contexts.json", Contexts.class);
        if (contexts == null) {
            return;
        }
    ...
    private void setExtras(SentryBaseEvent sentryBaseEvent) {
        Map map = (Map) PersistingScopeObserver.read(this.options, "extras.json", Map.class);
        if (map == null) {
            return;
        }
    ...
    private void setBreadcrumbs(SentryBaseEvent sentryBaseEvent) {
        List list = (List) PersistingScopeObserver.read(this.options, "breadcrumbs.json", List.class, new Breadcrumb.Deserializer());
        if (list == null) {
            return;
        }
    ...
    private void setUser(SentryBaseEvent sentryBaseEvent) {
        if (sentryBaseEvent.getUser() == null) {
            sentryBaseEvent.setUser((User) PersistingScopeObserver.read(this.options, "user.json", User.class));
        }
    }

    private void setRequest(SentryBaseEvent sentryBaseEvent) {
        if (sentryBaseEvent.getRequest() == null) {
            sentryBaseEvent.setRequest((Request) PersistingScopeObserver.read(this.options, "request.json", Request.class));
        }
    }
    ...
    private void setApp(SentryBaseEvent sentryBaseEvent, Object obj) {
        ...
        if (sentryBaseEvent.getRelease() != null) {
            ...
            release = (String) PersistingOptionsObserver.read(this.options, "release.json", String.class);
        }
        if (release != null) {
            try {
    ...
    private void setRelease(SentryBaseEvent sentryBaseEvent) {
        if (sentryBaseEvent.getRelease() == null) {
            sentryBaseEvent.setRelease((String) PersistingOptionsObserver.read(this.options, "release.json", String.class));
        }
    }

    private void setEnvironment(SentryBaseEvent sentryBaseEvent) {
        if (sentryBaseEvent.getEnvironment() == null) {
            String environment = (String) PersistingOptionsObserver.read(this.options, "environment.json", String.class);
            if (environment == null) {
    ...
    private void setDebugMeta(SentryBaseEvent sentryBaseEvent) {
        ...
        if (images != null) {
            String str = (String) PersistingOptionsObserver.read(this.options, "proguard-uuid.json", String.class);
            if (str != null) {
    ...
    private void setDist(SentryBaseEvent sentryBaseEvent) {
        ...
        if (sentryBaseEvent.getDist() == null) {
            sentryBaseEvent.setDist((String) PersistingOptionsObserver.read(this.options, "dist.json", String.class));
        }
        if (sentryBaseEvent.getDist() != null || (str = (String) PersistingOptionsObserver.read(this.options, "release.json", String.class)) == null) {
            return;
        }
        try {
    ...
    private void setSdk(SentryBaseEvent sentryBaseEvent) {
        if (sentryBaseEvent.getSdk() == null) {
            sentryBaseEvent.setSdk((SdkVersion) PersistingOptionsObserver.read(this.options, "sdk-version.json", SdkVersion.class));
        }
    }
    ...
    private String getDeviceId() {
        try {
            return Installation.m3347id(this.context);
        } catch (Throwable th) {
    ...
    private void setSideLoadedInfo(SentryBaseEvent sentryBaseEvent) {
        try {
            ContextUtils.SideLoadedInfo sideLoadedInfoRetrieveSideLoadedInfo = ContextUtils.retrieveSideLoadedInfo(this.context, this.options.getLogger(), this.buildInfoProvider);
            if (sideLoadedInfoRetrieveSideLoadedInfo != null) {
                for (Map.Entry<String, String> entry : sideLoadedInfoRetrieveSideLoadedInfo.asTags().entrySet()) {

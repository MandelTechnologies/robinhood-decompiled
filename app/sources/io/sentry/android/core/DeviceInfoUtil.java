...
public final class DeviceInfoUtil {
    ...
    /* renamed from: os */
    private final OperatingSystem f6640os;
    ...
    public DeviceInfoUtil(Context context, SentryAndroidOptions sentryAndroidOptions) {
        ...
        this.f6640os = retrieveOperatingSystemInformation();
    ...
    private void setDeviceIO(Device device, boolean z) {
        ...
        int i = C457041.$SwitchMap$io$sentry$IConnectionStatusProvider$ConnectionStatus[this.options.getConnectionStatusProvider().getConnectionStatus().ordinal()];
        if (i == 1) {
            bool = Boolean.FALSE;
        } else {
    ...
    /* renamed from: io.sentry.android.core.DeviceInfoUtil$1 */
    /* loaded from: classes14.dex */
    static /* synthetic */ class C457041 {

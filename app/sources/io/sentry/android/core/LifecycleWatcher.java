...
final class LifecycleWatcher implements DefaultLifecycleObserver {
    ...
    private void startSession() {
        ...
        this.hub.configureScope(new ScopeCallback() { // from class: io.sentry.android.core.LifecycleWatcher$$ExternalSyntheticLambda0
            ...
            public final void run(IScope iScope) {
                LifecycleWatcher.m28527$r8$lambda$jSkmrMpxu_0sul8_2sUqtcDVL0(this.f$0, iScope);
            }
        });
    ...
    /* renamed from: $r8$lambda$jSkmrMpxu_0sul8_2sU-qtcDVL0, reason: not valid java name */
    public static /* synthetic */ void m28527$r8$lambda$jSkmrMpxu_0sul8_2sUqtcDVL0(LifecycleWatcher lifecycleWatcher, IScope iScope) {
        Session session;

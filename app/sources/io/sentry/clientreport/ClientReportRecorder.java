...
public final class ClientReportRecorder implements IClientReportRecorder {
    ...
    public void recordLostEnvelopeItem(DiscardReason discardReason, SentryEnvelopeItem sentryEnvelopeItem) {
        ...
        try {
            SentryItemType type2 = sentryEnvelopeItem.getHeader().getType();
            if (SentryItemType.ClientReport.equals(type2)) {
                try {
                ...
                DataCategory dataCategoryCategoryFromItemType = categoryFromItemType(type2);

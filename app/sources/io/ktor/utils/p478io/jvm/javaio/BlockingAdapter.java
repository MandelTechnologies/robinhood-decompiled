...
import kotlinx.coroutines.EventLoop4;
import kotlinx.coroutines.Job;
import kotlinx.coroutines.Job4;

/* compiled from: Blocking.kt */
@Metadata(m3635d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\b\n\u0002\b\u000e\n\u0002\u0018\u0002\n\u0002\b\b\b\"\u0018\u00002\u00020\u0001B\u0013\u0012\n\b\u0002\u0010\u0003\u001a\u0004\u0018\u00010\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\u0017\u0010\t\u001a\u00020\b2\u0006\u0010\u0007\u001a\u00020\u0006H\u0002¢\u0006\u0004\b\t\u0010\nJ\u001d\u0010\r\u001a\u00020\u00012\f\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u00010\u000bH\u0002¢\u0006\u0004\b\r\u0010\u000eJ\u0013\u0010\u000f\u001a\u00020\bH¤@ø\u0001\u0000¢\u0006\u0004\b\u000f\u0010\u000eJ\r\u0010\u0010\u001a\u00020\b¢\u0006\u0004\b\u0010\u0010\u0011J%\u0010\u0017\u001a\u00020\u00142\u0006\u0010\u0013\u001a\u00020\u00122\u0006\u0010\u0015\u001a\u00020\u00142\u0006\u0010\u0016\u001a\u00020\u0014¢\u0006\u0004\b\u0017\u0010\u0018J\u0015\u0010\u0017\u001a\u00020\u00142\u0006\u0010\u0019\u001a\u00020\u0001¢\u0006\u0004\b\u0017\u0010\u001aJ\u0017\u0010\u001c\u001a\u00020\b2\u0006\u0010\u001b\u001a\u00020\u0014H\u0004¢\u0006\u0004\b\u001c\u0010\u001dR\u0019\u0010\u0003\u001a\u0004\u0018\u00010\u00028\u0006¢\u0006\f\n\u0004\b\u0003\u0010\u001e\u001a\u0004\b\u001f\u0010 R\u001a\u0010!\u001a\b\u0012\u0004\u0012\u00020\b0\u000b8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b!\u0010\"R\u0016\u0010$\u001a\u0004\u0018\u00010#8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b$\u0010%R$\u0010\u0015\u001a\u00020\u00142\u0006\u0010&\u001a\u00020\u00148\u0004@BX\u0084\u000e¢\u0006\f\n\u0004\b\u0015\u0010'\u001a\u0004\b(\u0010)R$\u0010\u0016\u001a\u00020\u00142\u0006\u0010&\u001a\u00020\u00148\u0004@BX\u0084\u000e¢\u0006\f\n\u0004\b\u0016\u0010'\u001a\u0004\b*\u0010)\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006+"}, m3636d2 = {"Lio/ktor/utils/io/jvm/javaio/BlockingAdapter;", "", "Lkotlinx/coroutines/Job;", "parent", "<init>", "(Lkotlinx/coroutines/Job;)V", "Ljava/lang/Thread;", "thread", "", "parkingLoop", "(Ljava/lang/Thread;)V", "Lkotlin/coroutines/Continuation;", "ucont", "rendezvousBlock", "(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "loop", "shutdown", "()V", "", "buffer", "", "offset", "length", "submitAndAwait", "([BII)I", "jobToken", "(Ljava/lang/Object;)I", Constants.RETRY_COUNT, "finish", "(I)V", "Lkotlinx/coroutines/Job;", "getParent", "()Lkotlinx/coroutines/Job;", "end", "Lkotlin/coroutines/Continuation;", "Lkotlinx/coroutines/DisposableHandle;", "disposable", "Lkotlinx/coroutines/DisposableHandle;", "<set-?>", "I", "getOffset", "()I", "getLength", "ktor-io"}, m3637k = 1, m3638mv = {1, 8, 0}, m3640xi = 48)
...
abstract class BlockingAdapter {
    ...
    public BlockingAdapter(Job job) {
        ...
        Continuation<Unit> continuation = new Continuation<Unit>() { // from class: io.ktor.utils.io.jvm.javaio.BlockingAdapter$end$1
            ...
            public void resumeWith(Object result) {
                ...
                Job parent;
                Object objM28553exceptionOrNullimpl = Result.m28553exceptionOrNullimpl(result);
                if (objM28553exceptionOrNullimpl == null) {
                    objM28553exceptionOrNullimpl = Unit.INSTANCE;
                }
                ...
                } while (!C2031xc40028dd.m363m(BlockingAdapter.state$FU, blockingAdapter, obj, objM28553exceptionOrNullimpl));
                if (z) {
                    Pollers3.getParkingImpl().unpark(obj);
                } else if ((obj instanceof Continuation) && (thM28553exceptionOrNullimpl = Result.m28553exceptionOrNullimpl(result)) != null) {
                    ((Continuation) obj).resumeWith(Result.m28550constructorimpl(ResultKt.createFailure(thM28553exceptionOrNullimpl)));
                }
                if (Result.m28555isFailureimpl(result) && !(Result.m28553exceptionOrNullimpl(result) instanceof CancellationException) && (parent = this.this$0.getParent()) != null) {
                    Job.DefaultImpls.cancel$default(parent, null, 1, null);
                }
                Job4 job4 = this.this$0.disposable;
                if (job4 != null) {
                    job4.dispose();
                }
            }
        ...
        this.disposable = job != null ? job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: io.ktor.utils.io.jvm.javaio.BlockingAdapter$disposable$1
            ...
            public final void invoke2(Throwable th) {
                if (th != null) {
                    ...
                    continuation2.resumeWith(Result.m28550constructorimpl(ResultKt.createFailure(th)));
                }
            }
        }) : null;
    ...
    public final Object rendezvousBlock(Continuation<Object> ucont) {
        ...
        while (true) {
            ...
            if (C2031xc40028dd.m363m(state$FU, this, obj3, continuationIntercepted)) {
                if (obj != null) {
                    Pollers3.getParkingImpl().unpark(obj);
                }
    ...
    public final void shutdown() {
        Job4 job4 = this.disposable;
        if (job4 != null) {
            job4.dispose();
        }
        Continuation<Unit> continuation = this.end;
        Result.Companion companion = Result.INSTANCE;
        continuation.resumeWith(Result.m28550constructorimpl(ResultKt.createFailure(new CancellationException("Stream closed"))));
    }
    ...
    public final int submitAndAwait(Object jobToken) throws Throwable {
        ...
        } while (!C2031xc40028dd.m363m(state$FU, this, obj, noWhenBranchMatchedException));
        Intrinsics.checkNotNull(continuation);
        continuation.resumeWith(Result.m28550constructorimpl(jobToken));
    ...
    private final void parkingLoop(Thread thread) {
        ...
        if (!Pollers3.isParkingAllowed()) {
            BlockingKt.getADAPTER_LOGGER().warn("Blocking network thread detected. \nIt can possible lead to a performance decline or even a deadlock.\nPlease make sure you're using blocking IO primitives like InputStream and OutputStream only in \nthe context of Dispatchers.IO:\n```\nwithContext(Dispatchers.IO) {\n    myInputStream.read()\n}\n```");
        }
        while (true) {
            long jProcessNextEventInCurrentThread = EventLoop4.processNextEventInCurrentThread();
            if (this.state != thread) {
                return;
            }
            if (jProcessNextEventInCurrentThread > 0) {
                Pollers3.getParkingImpl().park(jProcessNextEventInCurrentThread);
            }
        }
    }

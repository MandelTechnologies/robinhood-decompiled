...
final class InputAdapter extends InputStream {
    ...
    public synchronized void close() {
        try {
            super.close();
            ByteReadChannel2.cancel(this.channel);

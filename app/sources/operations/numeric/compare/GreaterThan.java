...
/* compiled from: GreaterThan.kt */
@Metadata(m3635d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\bÀ\u0002\u0018\u00002\u00020\u00012\u00020\u0002B\u0007\b\u0002¢\u0006\u0002\u0010\u0003J\u001c\u0010\u0004\u001a\u00020\u00052\b\u0010\u0006\u001a\u0004\u0018\u00010\u00052\b\u0010\u0007\u001a\u0004\u0018\u00010\u0005H\u0016¨\u0006\b"}, m3636d2 = {"Loperations/numeric/compare/GreaterThan;", "Loperation/StandardLogicOperation;", "Loperations/ComparingOperation;", "()V", "evaluateLogic", "", "expression", WebsocketGatewayConstants.DATA_KEY, "core"}, m3637k = 1, m3638mv = {1, 8, 0}, m3640xi = 48)
...
public final class GreaterThan implements StandardLogicOperation, ComparingOperation {
    ...
    public List<Comparable<?>> unwrapAsComparableWithTypeSensitivity(Comparable<?> comparable, Comparable<?> comparable2) {
        return ComparingOperation.DefaultImpls.unwrapAsComparableWithTypeSensitivity(this, comparable, comparable2);
    }

    @Override // operations.BooleanUnwrapStrategy
    public Boolean unwrapValueAsBoolean(Object obj) {
        return ComparingOperation.DefaultImpls.unwrapValueAsBoolean(this, obj);
    }

    @Override // operation.StandardLogicOperation
    public Object evaluateLogic(Object expression, Object data) {
        return Boolean.valueOf(compareListOfTwo(AnyUtils.getAsList(expression), new Function2<Integer, Integer, Boolean>() { // from class: operations.numeric.compare.GreaterThan.evaluateLogic.1

...
public final /* data */ class SduiTextInputValidators {
    ...
    public SduiTextInputValidators() {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SduiTextInputValidators)) {
            return false;
        }
        SduiTextInputValidators sduiTextInputValidators = (SduiTextInputValidators) other;
        return Intrinsics.areEqual(this.maxLengthValidator, sduiTextInputValidators.maxLengthValidator) && Intrinsics.areEqual(this.minLengthValidator, sduiTextInputValidators.minLengthValidator) && Intrinsics.areEqual(this.nonEmptyValidator, sduiTextInputValidators.nonEmptyValidator) && Intrinsics.areEqual(this.regexValidators, sduiTextInputValidators.regexValidators);
    }
    ...
    public String toString() {
        return "SduiTextInputValidators(maxLengthValidator=" + this.maxLengthValidator + ", minLengthValidator=" + this.minLengthValidator + ", nonEmptyValidator=" + this.nonEmptyValidator + ", regexValidators=" + this.regexValidators + ")";
    }

    /* compiled from: SDUIGenerated.kt */
    @Metadata(m3635d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m3636d2 = {"Lmicrogram/ui/sdui/SduiTextInputValidators$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lmicrogram/ui/sdui/SduiTextInputValidators;", "microgram-ui"}, m3637k = 1, m3638mv = {1, 9, 0}, m3640xi = 48)
    ...
    public SduiTextInputValidators(SduiLengthValidator sduiLengthValidator, SduiLengthValidator sduiLengthValidator2, SduiNonEmptyValidator sduiNonEmptyValidator, List<SduiRegexValidator> list) {
        this.maxLengthValidator = sduiLengthValidator;
        this.minLengthValidator = sduiLengthValidator2;
        this.nonEmptyValidator = sduiNonEmptyValidator;
        this.regexValidators = list;
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$microgram_ui(SduiTextInputValidators self, Encoding3 output, SerialDescriptor serialDesc) {
    ...
    public /* synthetic */ SduiTextInputValidators(SduiLengthValidator sduiLengthValidator, SduiLengthValidator sduiLengthValidator2, SduiNonEmptyValidator sduiNonEmptyValidator, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {

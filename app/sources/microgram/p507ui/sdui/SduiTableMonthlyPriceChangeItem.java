...
public final /* data */ class SduiTableMonthlyPriceChangeItem extends SduiComponent {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SduiTableMonthlyPriceChangeItem)) {
            return false;
        }
        SduiTableMonthlyPriceChangeItem sduiTableMonthlyPriceChangeItem = (SduiTableMonthlyPriceChangeItem) other;
        return Intrinsics.areEqual(this.defaultValue, sduiTableMonthlyPriceChangeItem.defaultValue) && Intrinsics.areEqual(this.instrumentID, sduiTableMonthlyPriceChangeItem.instrumentID) && Intrinsics.areEqual((Object) this.priceBaseline, (Object) sduiTableMonthlyPriceChangeItem.priceBaseline) && this.sduiComponentType == sduiTableMonthlyPriceChangeItem.sduiComponentType;
    }
    ...
    public String toString() {
        return "SduiTableMonthlyPriceChangeItem(defaultValue=" + this.defaultValue + ", instrumentID=" + this.instrumentID + ", priceBaseline=" + this.priceBaseline + ", sduiComponentType=" + this.sduiComponentType + ")";
    }

    /* compiled from: SDUIGenerated.kt */
    @Metadata(m3635d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m3636d2 = {"Lmicrogram/ui/sdui/SduiTableMonthlyPriceChangeItem$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lmicrogram/ui/sdui/SduiTableMonthlyPriceChangeItem;", "microgram-ui"}, m3637k = 1, m3638mv = {1, 9, 0}, m3640xi = 48)
    public static final class Companion {
        ...
        public final KSerializer<SduiTableMonthlyPriceChangeItem> serializer() {
            return SduiTableMonthlyPriceChangeItem$$serializer.INSTANCE;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    @Deprecated
    public /* synthetic */ SduiTableMonthlyPriceChangeItem(int i, @SerialName("default_value") SduiPriceChangeDefaultValue sduiPriceChangeDefaultValue, @SerialName("instrument_id") String str, @SerialName("price_baseline") Double d, @SerialName("sdui_component_type") SduiComponentType sduiComponentType, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (2 != (i & 2)) {
            PluginExceptions.throwMissingFieldException(i, 2, SduiTableMonthlyPriceChangeItem$$serializer.INSTANCE.getDescriptor());
        }
        if ((i & 1) == 0) {
        ...
        if ((i & 8) == 0) {
            this.sduiComponentType = SduiComponentType.TABLE_1_M_CHANGE_ITEM;
        } else {
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$microgram_ui(SduiTableMonthlyPriceChangeItem self, Encoding3 output, SerialDescriptor serialDesc) {
        ...
        if (!output.shouldEncodeElementDefault(serialDesc, 3) && self.sduiComponentType == SduiComponentType.TABLE_1_M_CHANGE_ITEM) {
            return;
        }

...
public final /* data */ class SduiOrEvaluator extends SduiLogicEvaluator {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SduiOrEvaluator)) {
            return false;
        }
        SduiOrEvaluator sduiOrEvaluator = (SduiOrEvaluator) other;
        return Intrinsics.areEqual(this.lhs, sduiOrEvaluator.lhs) && this.operatorType == sduiOrEvaluator.operatorType && Intrinsics.areEqual(this.rhs, sduiOrEvaluator.rhs);
    }
    ...
    public String toString() {
        return "SduiOrEvaluator(lhs=" + this.lhs + ", operatorType=" + this.operatorType + ", rhs=" + this.rhs + ")";
    }

    /* compiled from: SDUIGenerated.kt */
    @Metadata(m3635d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004HÆ\u0001¨\u0006\u0006"}, m3636d2 = {"Lmicrogram/ui/sdui/SduiOrEvaluator$Companion;", "", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lmicrogram/ui/sdui/SduiOrEvaluator;", "microgram-ui"}, m3637k = 1, m3638mv = {1, 9, 0}, m3640xi = 48)
    public static final class Companion {
        ...
        public final KSerializer<SduiOrEvaluator> serializer() {
            return SduiOrEvaluator$$serializer.INSTANCE;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    @Deprecated
    public /* synthetic */ SduiOrEvaluator(int i, SduiLogicEvaluator sduiLogicEvaluator, @SerialName("operator_type") SduiLogicalOperatorType sduiLogicalOperatorType, SduiLogicEvaluator sduiLogicEvaluator2, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (5 != (i & 5)) {
            PluginExceptions.throwMissingFieldException(i, 5, SduiOrEvaluator$$serializer.INSTANCE.getDescriptor());
        }
        this.lhs = sduiLogicEvaluator;
        if ((i & 2) == 0) {
            this.operatorType = SduiLogicalOperatorType.f7107OR;
        } else {
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$microgram_ui(SduiOrEvaluator self, Encoding3 output, SerialDescriptor serialDesc) {
        ...
        if (output.shouldEncodeElementDefault(serialDesc, 1) || self.operatorType != SduiLogicalOperatorType.f7107OR) {

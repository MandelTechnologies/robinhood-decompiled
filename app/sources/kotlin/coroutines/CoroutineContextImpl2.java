...
public abstract class CoroutineContextImpl2<B extends CoroutineContext.Element, E extends B> implements CoroutineContext.Key<E> {
    ...
    public CoroutineContextImpl2(CoroutineContext.Key<B> baseKey, Function1<? super CoroutineContext.Element, ? extends E> safeCast) {
        Intrinsics.checkNotNullParameter(baseKey, "baseKey");
        Intrinsics.checkNotNullParameter(safeCast, "safeCast");
        this.safeCast = safeCast;
        this.topmostKey = baseKey instanceof CoroutineContextImpl2 ? (CoroutineContext.Key<B>) ((CoroutineContextImpl2) baseKey).topmostKey : baseKey;
    }

...
public final class ArraysKt___ArraysKt$asIterable$$inlined$Iterable$1<T> implements Iterable<T>, KMarkers {
    ...
    public Iterator<T> iterator() {
        return ArrayIterator2.iterator(this.$this_asIterable$inlined);
    }
}

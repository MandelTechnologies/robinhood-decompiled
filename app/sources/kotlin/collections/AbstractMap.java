...
public abstract class AbstractMap<K, V> implements Map<K, V>, KMarkers {
        ...
        if (this._keys == null) {
            this._keys = new AbstractSet<K>(this) { // from class: kotlin.collections.AbstractMap$keys$1
                ...
                public Iterator<K> iterator() {
                    return new AbstractMap3(this.this$0.entrySet().iterator());
                }
    ...
    public String toString() {
        return _Collections3.joinToString$default(entrySet(), ", ", "{", "}", 0, null, new Function1() { // from class: kotlin.collections.AbstractMap$$ExternalSyntheticLambda0
        ...
        if (this._values == null) {
            this._values = new AbstractCollection<V>(this) { // from class: kotlin.collections.AbstractMap.values.1
                ...
                public Iterator<V> iterator() {
                    return new AbstractMap4(this.this$0.entrySet().iterator());
                }

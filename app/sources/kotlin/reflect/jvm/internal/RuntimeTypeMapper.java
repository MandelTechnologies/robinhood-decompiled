...
import kotlin.reflect.jvm.internal.impl.serialization.deserialization.descriptors.DeserializedMemberDescriptor2;
...
public final class RuntimeTypeMapper {
    ...
    public final RuntimeTypeMapper2 mapSignature(FunctionDescriptor possiblySubstitutedFunction) {
        Method member;
        ...
        if (original instanceof DeserializedMemberDescriptor2) {
            ...
            if ((proto instanceof ProtoBuf.Function) && (jvmMethodSignature = JvmProtoBufUtil.INSTANCE.getJvmMethodSignature((ProtoBuf.Function) proto, deserializedMemberDescriptor.getNameResolver(), deserializedMemberDescriptor.getTypeTable())) != null) {
                return new RuntimeTypeMapper2.KotlinFunction(jvmMethodSignature);
            }
            if ((proto instanceof ProtoBuf.Constructor) && (jvmConstructorSignature = JvmProtoBufUtil.INSTANCE.getJvmConstructorSignature((ProtoBuf.Constructor) proto, deserializedMemberDescriptor.getNameResolver(), deserializedMemberDescriptor.getTypeTable())) != null) {
                ...
                if (inlineClassesUtils.isInlineClass(containingDeclaration)) {
                    return new RuntimeTypeMapper2.KotlinFunction(jvmConstructorSignature);
                }
                DeclarationDescriptor containingDeclaration2 = possiblySubstitutedFunction.getContainingDeclaration();
                Intrinsics.checkNotNullExpressionValue(containingDeclaration2, "getContainingDeclaration(...)");
                if (inlineClassesUtils.isMultiFieldValueClass(containingDeclaration2)) {
                    ...
                    if (constructorDescriptor.isPrimary()) {
                        ...
                        String jvmDescriptor = ValueClassAwareCaller2.toJvmDescriptor(constructedClass);
                ...
                return new RuntimeTypeMapper2.KotlinConstructor(jvmConstructorSignature);
            }
            return mapJvmFunctionSignature(original);
        }
        if (original instanceof JavaMethodDescriptor) {
            SourceElement source = ((JavaMethodDescriptor) original).getSource();
            JavaSourceElementFactory2 javaSourceElementFactory2 = source instanceof JavaSourceElementFactory2 ? (JavaSourceElementFactory2) source : null;
            JavaElement javaElement = javaSourceElementFactory2 != null ? javaSourceElementFactory2.getJavaElement() : null;
            ...
            return new RuntimeTypeMapper2.JavaMethod(member);
        }
        if (original instanceof JavaClassConstructorDescriptor) {
            ...
            JavaSourceElementFactory2 javaSourceElementFactory22 = source2 instanceof JavaSourceElementFactory2 ? (JavaSourceElementFactory2) source2 : null;
            JavaElement javaElement2 = javaSourceElementFactory22 != null ? javaSourceElementFactory22.getJavaElement() : null;
            if (javaElement2 instanceof ReflectJavaConstructor) {
                return new RuntimeTypeMapper2.JavaConstructor(((ReflectJavaConstructor) javaElement2).getMember());
            }
            if (javaElement2 instanceof ReflectJavaClass) {
                ReflectJavaClass reflectJavaClass = (ReflectJavaClass) javaElement2;
                if (reflectJavaClass.isAnnotationType()) {
                    return new RuntimeTypeMapper2.FakeJavaAnnotationConstructor(reflectJavaClass.getElement());
                }
            }
    ...
    public final RuntimeTypeMapper3 mapPropertySignature(PropertyDescriptor possiblyOverriddenProperty) {
        ...
        if (original instanceof DeserializedMemberDescriptor4) {
            ...
            ProtoBuf.Property proto = deserializedMemberDescriptor4.getProto();
            ...
            if (jvmPropertySignature != null) {
                return new RuntimeTypeMapper3.KotlinProperty(original, proto, jvmPropertySignature, deserializedMemberDescriptor4.getNameResolver(), deserializedMemberDescriptor4.getTypeTable());
            }
            ...
            if (javaElement instanceof ReflectJavaField) {
                return new RuntimeTypeMapper3.JavaField(((ReflectJavaField) javaElement).getMember());
            }
            if (javaElement instanceof ReflectJavaMethod) {
                ...
                return new RuntimeTypeMapper3.JavaMethodProperty(member, reflectJavaMethod != null ? reflectJavaMethod.getMember() : null);
            }
        ...
        RuntimeTypeMapper2.KotlinFunction kotlinFunctionMapJvmFunctionSignature = mapJvmFunctionSignature(getter);
        PropertySetterDescriptor setter2 = original.getSetter();
        return new RuntimeTypeMapper3.MappedKotlinProperty(kotlinFunctionMapJvmFunctionSignature, setter2 != null ? mapJvmFunctionSignature(setter2) : null);
    }
    ...
    private final RuntimeTypeMapper2.KotlinFunction mapJvmFunctionSignature(FunctionDescriptor descriptor) {
        return new RuntimeTypeMapper2.KotlinFunction(new JvmMemberSignature.Method(mapName(descriptor), methodSignatureMapping3.computeJvmDescriptor$default(descriptor, false, false, 1, null)));
    }

    private final String mapName(CallableMemberDescriptor descriptor) {
        String jvmMethodNameIfSpecial = specialBuiltinMembers3.getJvmMethodNameIfSpecial(descriptor);
        if (jvmMethodNameIfSpecial != null) {
            return jvmMethodNameIfSpecial;
        }
        if (descriptor instanceof PropertyGetterDescriptor) {
            String strAsString = DescriptorUtils2.getPropertyIfAccessor(descriptor).getName().asString();
            Intrinsics.checkNotNullExpressionValue(strAsString, "asString(...)");
            return JvmAbi.getterName(strAsString);
        }
        if (descriptor instanceof PropertySetterDescriptor) {
            String strAsString2 = DescriptorUtils2.getPropertyIfAccessor(descriptor).getName().asString();
    ...
    public final ClassId mapJvmClassToKotlinClassId(Class<?> klass) {
        ...
        if (klass.isArray()) {
            ...
            return ClassId.Companion.topLevel(StandardNames.FqNames.f10743array.toSafe());
        }
        ...
        ClassId classId = reflectClassUtil.getClassId(klass);

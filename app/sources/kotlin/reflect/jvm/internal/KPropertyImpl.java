...
public abstract class KPropertyImpl<V> extends KCallableImpl<V> implements KProperty<V> {
    ...
    public static final Field _javaField$lambda$2(KPropertyImpl kPropertyImpl) {
        ...
        RuntimeTypeMapper3 runtimeTypeMapper3MapPropertySignature = RuntimeTypeMapper.INSTANCE.mapPropertySignature(kPropertyImpl.getDescriptor());
        ...
        if (runtimeTypeMapper3MapPropertySignature instanceof RuntimeTypeMapper3.JavaField) {
            return ((RuntimeTypeMapper3.JavaField) runtimeTypeMapper3MapPropertySignature).getField();
        }
        if ((runtimeTypeMapper3MapPropertySignature instanceof RuntimeTypeMapper3.JavaMethodProperty) || (runtimeTypeMapper3MapPropertySignature instanceof RuntimeTypeMapper3.MappedKotlinProperty)) {
            return null;
        }
    ...
    public final Member computeDelegateSource() {
        ...
        RuntimeTypeMapper3 runtimeTypeMapper3MapPropertySignature = RuntimeTypeMapper.INSTANCE.mapPropertySignature(getDescriptor());
        if (runtimeTypeMapper3MapPropertySignature instanceof RuntimeTypeMapper3.KotlinProperty) {
            RuntimeTypeMapper3.KotlinProperty kotlinProperty = (RuntimeTypeMapper3.KotlinProperty) runtimeTypeMapper3MapPropertySignature;
    ...
    protected final Object getDelegateImpl(Member fieldOrMethod, Object receiver1, Object receiver2) throws exceptions2, SecurityException {
        try {
    ...
    public static abstract class Getter<V> extends Accessor<V, V> implements KProperty.Getter<V> {
        ...
        public static final Caller caller_delegate$lambda$1(Getter getter) {
            return KPropertyImpl2.computeCallerForAccessor(getter, true);
        }
    ...
    /* compiled from: KPropertyImpl.kt */
    @Metadata(m3635d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\b&\u0018\u0000*\u0004\b\u0001\u0010\u00012\u000e\u0012\u0004\u0012\u0002H\u0001\u0012\u0004\u0012\u00020\u00030\u00022\b\u0012\u0004\u0012\u0002H\u00010\u0004B\u0007¢\u0006\u0004\b\u0005\u0010\u0006J\b\u0010\u0017\u001a\u00020\bH\u0016J\u0013\u0010\u0018\u001a\u00020\u00192\b\u0010\u001a\u001a\u0004\u0018\u00010\u001bH\u0096\u0002J\b\u0010\u001c\u001a\u00020\u001dH\u0016R\u0014\u0010\u0007\u001a\u00020\b8VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\t\u0010\nR\u001b\u0010\u000b\u001a\u00020\f8VX\u0096\u0084\u0002¢\u0006\f\n\u0004\b\u000f\u0010\u0010\u001a\u0004\b\r\u0010\u000eR\u001f\u0010\u0011\u001a\u0006\u0012\u0002\b\u00030\u00128VX\u0096\u0084\u0002¢\u0006\f\n\u0004\b\u0015\u0010\u0016\u001a\u0004\b\u0013\u0010\u0014¨\u0006\u001e"}, m3636d2 = {"Lkotlin/reflect/jvm/internal/KPropertyImpl$Setter;", "V", "Lkotlin/reflect/jvm/internal/KPropertyImpl$Accessor;", "", "Lkotlin/reflect/KMutableProperty$Setter;", "<init>", "()V", "name", "", "getName", "()Ljava/lang/String;", "descriptor", "Lkotlin/reflect/jvm/internal/impl/descriptors/PropertySetterDescriptor;", "getDescriptor", "()Lorg/jetbrains/kotlin/descriptors/PropertySetterDescriptor;", "descriptor$delegate", "Lkotlin/reflect/jvm/internal/ReflectProperties$LazySoftVal;", "caller", "Lkotlin/reflect/jvm/internal/calls/Caller;", "getCaller", "()Lkotlin/reflect/jvm/internal/calls/Caller;", "caller$delegate", "Lkotlin/Lazy;", "toString", "equals", "", "other", "", "hashCode", "", "kotlin-reflection"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    /* loaded from: classes14.dex */
    public static abstract class Setter<V> extends Accessor<V, Unit> implements KProperty2.Setter<V> {
        ...
        public static final Caller caller_delegate$lambda$1(Setter setter) {
            return KPropertyImpl2.computeCallerForAccessor(setter, false);
        }

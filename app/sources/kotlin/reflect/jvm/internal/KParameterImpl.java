...
public final class KParameterImpl implements KParameter {
    ...
    /* compiled from: KParameterImpl.kt */
    @Metadata(m3635d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0002\b\u0006\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0017\u0012\u000e\u0010\u0002\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00010\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\b\u0010\u000b\u001a\u00020\fH\u0016J\u0013\u0010\r\u001a\u00020\u000e2\b\u0010\u000f\u001a\u0004\u0018\u00010\u0010H\u0096\u0002J\b\u0010\t\u001a\u00020\nH\u0016J\b\u0010\u0011\u001a\u00020\fH\u0016R\u001b\u0010\u0002\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00010\u0003¢\u0006\n\n\u0002\u0010\b\u001a\u0004\b\u0006\u0010\u0007R\u000e\u0010\t\u001a\u00020\nX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0012"}, m3636d2 = {"Lkotlin/reflect/jvm/internal/KParameterImpl$CompoundTypeImpl;", "Ljava/lang/reflect/Type;", "types", "", "<init>", "([Ljava/lang/reflect/Type;)V", "getTypes", "()[Ljava/lang/reflect/Type;", "[Ljava/lang/reflect/Type;", "hashCode", "", "getTypeName", "", "equals", "", "other", "", "toString", "kotlin-reflection"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    ...
    public KType getType() {
        ...
        return new KTypeImpl(type2, new Function0(this) { // from class: kotlin.reflect.jvm.internal.KParameterImpl$$Lambda$1
            private final KParameterImpl arg$0;
    ...
    public static final Type _get_type_$lambda$1(KParameterImpl kParameterImpl) {
        ...
        if (caller instanceof ValueClassAwareCaller) {
            if (kParameterImpl.callable.isBound()) {
                ...
                PrimitiveRanges2 realSlicesOfParameters = valueClassAwareCaller.getRealSlicesOfParameters(kParameterImpl.getIndex() + 1);
                int last = valueClassAwareCaller.getRealSlicesOfParameters(0).getLast() + 1;
                listSlice = CollectionsKt.slice(valueClassAwareCaller.getParameterTypes(), new PrimitiveRanges2(realSlicesOfParameters.getFirst() - last, realSlicesOfParameters.getLast() - last));
            } else {

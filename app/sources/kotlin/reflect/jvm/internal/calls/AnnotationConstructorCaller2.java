...
@Metadata(m3635d1 = {"\u00004\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0001\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0010$\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0004\u001a\u001c\u0010\u0000\u001a\u0004\u0018\u00010\u0001*\u0004\u0018\u00010\u00012\n\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u0003H\u0002\u001a$\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\t2\n\u0010\n\u001a\u0006\u0012\u0002\b\u00030\u0003H\u0002\u001aI\u0010\u000b\u001a\u0002H\f\"\b\b\u0000\u0010\f*\u00020\u00012\f\u0010\r\u001a\b\u0012\u0004\u0012\u0002H\f0\u00032\u0012\u0010\u000e\u001a\u000e\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\u00010\u000f2\u000e\b\u0002\u0010\u0010\u001a\b\u0012\u0004\u0012\u00020\u00120\u0011H\u0000¢\u0006\u0002\u0010\u0013¨\u0006\u0014²\u0006\n\u0010\u0015\u001a\u00020\u0007X\u008a\u0084\u0002²\u0006\n\u0010\u0016\u001a\u00020\tX\u008a\u0084\u0002"}, m3636d2 = {"transformKotlinToJvm", "", "expectedType", "Ljava/lang/Class;", "throwIllegalArgumentType", "", ApiOptionSimulatedReturnsConfigurationV3Request.ApiOptionUnderlying.TYPE_INDEX, "", "name", "", "expectedJvmType", "createAnnotationInstance", "T", "annotationClass", "values", "", "methods", "", "Ljava/lang/reflect/Method;", "(Ljava/lang/Class;Ljava/util/Map;Ljava/util/List;)Ljava/lang/Object;", "kotlin-reflection", "hashCode", "toString"}, m3637k = 2, m3638mv = {2, 1, 0}, m3640xi = 48)
@SourceDebugExtension
/* renamed from: kotlin.reflect.jvm.internal.calls.AnnotationConstructorCallerKt, reason: use source file name */
...
public final class AnnotationConstructorCaller2 {
    ...
    */
    private static final <T> boolean createAnnotationInstance$equals(Class<T> cls, List<Method> list, Map<String, ? extends Object> map, Object obj) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (Intrinsics.areEqual((annotation == null || (annotationClass = JvmClassMapping.getAnnotationClass(annotation)) == null) ? null : JvmClassMapping.getJavaClass(annotationClass), cls)) {
    ...
    public static final <T> T createAnnotationInstance(final Class<T> annotationClass, final Map<String, ? extends Object> values, final List<Method> methods) {
        ...
        final Lazy lazy = LazyKt.lazy(new Function0(values) { // from class: kotlin.reflect.jvm.internal.calls.AnnotationConstructorCallerKt$$Lambda$0
            ...
            public Object invoke() {
                return Integer.valueOf(AnnotationConstructorCaller2.createAnnotationInstance$lambda$3(this.arg$0));
            }
        });
        final Lazy lazy2 = LazyKt.lazy(new Function0(annotationClass, values) { // from class: kotlin.reflect.jvm.internal.calls.AnnotationConstructorCallerKt$$Lambda$1
            ...
            @Override // kotlin.jvm.functions.Function0
            public Object invoke() {
                return AnnotationConstructorCaller2.createAnnotationInstance$lambda$7(this.arg$0, this.arg$1);
            }
        });
        T t = (T) Proxy.newProxyInstance(annotationClass.getClassLoader(), new Class[]{annotationClass}, new InvocationHandler(annotationClass, values, lazy2, lazy, methods) { // from class: kotlin.reflect.jvm.internal.calls.AnnotationConstructorCallerKt$$Lambda$2
            ...
            public Object invoke(Object obj, Method method, Object[] objArr) {
                return AnnotationConstructorCaller2.createAnnotationInstance$lambda$9(this.arg$0, this.arg$1, this.arg$2, this.arg$3, this.arg$4, obj, method, objArr);
            }
        });
    ...
    public static final int createAnnotationInstance$lambda$3(Map map) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            iHashCode2 += iHashCode ^ (str.hashCode() * EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE);
        }
        return iHashCode2;
    }
    ...
    public static final String createAnnotationInstance$lambda$7(Class cls, Map map) throws IOException {
        ...
        _Collections3.joinTo(map.entrySet(), sb, (EnumC7081g.SDK_ASSET_ILLUSTRATION_SIGNATURE_VALUE & 2) != 0 ? ", " : ", ", (EnumC7081g.SDK_ASSET_ILLUSTRATION_SIGNATURE_VALUE & 4) != 0 ? "" : "(", (EnumC7081g.SDK_ASSET_ILLUSTRATION_SIGNATURE_VALUE & 8) == 0 ? ")" : "", (EnumC7081g.SDK_ASSET_ILLUSTRATION_SIGNATURE_VALUE & 16) != 0 ? -1 : 0, (EnumC7081g.SDK_ASSET_ILLUSTRATION_SIGNATURE_VALUE & 32) != 0 ? "..." : null, (EnumC7081g.SDK_ASSET_ILLUSTRATION_SIGNATURE_VALUE & 64) != 0 ? null : new Function1() { // from class: kotlin.reflect.jvm.internal.calls.AnnotationConstructorCallerKt$$Lambda$3
            @Override // kotlin.jvm.functions.Function1
            public Object invoke(Object obj) {
                return AnnotationConstructorCaller2.createAnnotationInstance$lambda$7$lambda$6$lambda$5((Map.Entry) obj);
            }
        });
        return sb.toString();
    }
    ...
    public static final CharSequence createAnnotationInstance$lambda$7$lambda$6$lambda$5(Map.Entry entry) {
        ...
        Object value = entry.getValue();
        if (value instanceof boolean[]) {
            string2 = Arrays.toString((boolean[]) value);
            Intrinsics.checkNotNullExpressionValue(string2, "toString(...)");
        } else if (value instanceof char[]) {
            string2 = Arrays.toString((char[]) value);
            Intrinsics.checkNotNullExpressionValue(string2, "toString(...)");
        } else if (value instanceof byte[]) {
            string2 = Arrays.toString((byte[]) value);
            Intrinsics.checkNotNullExpressionValue(string2, "toString(...)");
        } else if (value instanceof short[]) {
            string2 = Arrays.toString((short[]) value);
            Intrinsics.checkNotNullExpressionValue(string2, "toString(...)");
        } else if (value instanceof int[]) {
            string2 = Arrays.toString((int[]) value);
            Intrinsics.checkNotNullExpressionValue(string2, "toString(...)");
        } else if (value instanceof float[]) {
            string2 = Arrays.toString((float[]) value);
            Intrinsics.checkNotNullExpressionValue(string2, "toString(...)");
        } else if (value instanceof long[]) {
            string2 = Arrays.toString((long[]) value);
            Intrinsics.checkNotNullExpressionValue(string2, "toString(...)");
        } else if (value instanceof double[]) {
            string2 = Arrays.toString((double[]) value);
            Intrinsics.checkNotNullExpressionValue(string2, "toString(...)");
        } else if (value instanceof Object[]) {
            string2 = Arrays.toString((Object[]) value);
            Intrinsics.checkNotNullExpressionValue(string2, "toString(...)");
        } else {

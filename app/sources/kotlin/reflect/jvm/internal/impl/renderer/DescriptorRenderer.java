...
public abstract class DescriptorRenderer {
    ...
    public final DescriptorRenderer withOptions(Function1<? super DescriptorRenderer4, Unit> changeOptions) {
    ...
    static {
        ...
        WITHOUT_MODIFIERS = companion.withOptions(new Function1() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer$$Lambda$0
            ...
            public Object invoke(Object obj) {
                return DescriptorRenderer.WITHOUT_MODIFIERS$lambda$0((DescriptorRenderer4) obj);
            }
        });
        COMPACT_WITH_MODIFIERS = companion.withOptions(new Function1() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer$$Lambda$1
            @Override // kotlin.jvm.functions.Function1
            public Object invoke(Object obj) {
                return DescriptorRenderer.COMPACT_WITH_MODIFIERS$lambda$1((DescriptorRenderer4) obj);
            }
        });
        COMPACT = companion.withOptions(new Function1() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer$$Lambda$2
            @Override // kotlin.jvm.functions.Function1
            public Object invoke(Object obj) {
                return DescriptorRenderer.COMPACT$lambda$2((DescriptorRenderer4) obj);
            }
        });
        COMPACT_WITHOUT_SUPERTYPES = companion.withOptions(new Function1() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer$$Lambda$3
            @Override // kotlin.jvm.functions.Function1
            public Object invoke(Object obj) {
                return DescriptorRenderer.COMPACT_WITHOUT_SUPERTYPES$lambda$3((DescriptorRenderer4) obj);
            }
        });
        COMPACT_WITH_SHORT_TYPES = companion.withOptions(new Function1() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer$$Lambda$4
            @Override // kotlin.jvm.functions.Function1
            public Object invoke(Object obj) {
                return DescriptorRenderer.COMPACT_WITH_SHORT_TYPES$lambda$4((DescriptorRenderer4) obj);
            }
        });
        ONLY_NAMES_WITH_SHORT_TYPES = companion.withOptions(new Function1() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer$$Lambda$5
            @Override // kotlin.jvm.functions.Function1
            public Object invoke(Object obj) {
                return DescriptorRenderer.ONLY_NAMES_WITH_SHORT_TYPES$lambda$5((DescriptorRenderer4) obj);
            }
        });
        FQ_NAMES_IN_TYPES = companion.withOptions(new Function1() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer$$Lambda$6
            @Override // kotlin.jvm.functions.Function1
            public Object invoke(Object obj) {
                return DescriptorRenderer.FQ_NAMES_IN_TYPES$lambda$6((DescriptorRenderer4) obj);
            }
        });
        FQ_NAMES_IN_TYPES_WITH_ANNOTATIONS = companion.withOptions(new Function1() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer$$Lambda$7
            @Override // kotlin.jvm.functions.Function1
            public Object invoke(Object obj) {
                return DescriptorRenderer.FQ_NAMES_IN_TYPES_WITH_ANNOTATIONS$lambda$7((DescriptorRenderer4) obj);
            }
        });
        SHORT_NAMES_IN_TYPES = companion.withOptions(new Function1() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer$$Lambda$8
            @Override // kotlin.jvm.functions.Function1
            public Object invoke(Object obj) {
                return DescriptorRenderer.SHORT_NAMES_IN_TYPES$lambda$8((DescriptorRenderer4) obj);
            }
        });
        DEBUG_TEXT = companion.withOptions(new Function1() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer$$Lambda$9
            @Override // kotlin.jvm.functions.Function1
            public Object invoke(Object obj) {
                return DescriptorRenderer.DEBUG_TEXT$lambda$9((DescriptorRenderer4) obj);
            }
        });
        HTML = companion.withOptions(new Function1() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer$$Lambda$10
            @Override // kotlin.jvm.functions.Function1
            public Object invoke(Object obj) {
                return DescriptorRenderer.HTML$lambda$10((DescriptorRenderer4) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit WITHOUT_MODIFIERS$lambda$0(DescriptorRenderer4 withOptions) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit COMPACT_WITH_MODIFIERS$lambda$1(DescriptorRenderer4 withOptions) {
        Intrinsics.checkNotNullParameter(withOptions, "$this$withOptions");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit COMPACT$lambda$2(DescriptorRenderer4 withOptions) {
        Intrinsics.checkNotNullParameter(withOptions, "$this$withOptions");
        withOptions.setWithDefinedIn(false);
        withOptions.setModifiers(SetsKt.emptySet());
        return Unit.INSTANCE;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit COMPACT_WITHOUT_SUPERTYPES$lambda$3(DescriptorRenderer4 withOptions) {
        Intrinsics.checkNotNullParameter(withOptions, "$this$withOptions");
        withOptions.setWithDefinedIn(false);
        withOptions.setModifiers(SetsKt.emptySet());
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit COMPACT_WITH_SHORT_TYPES$lambda$4(DescriptorRenderer4 withOptions) {
        Intrinsics.checkNotNullParameter(withOptions, "$this$withOptions");
        withOptions.setModifiers(SetsKt.emptySet());
        withOptions.setClassifierNamePolicy(ClassifierNamePolicy.SHORT.INSTANCE);
        withOptions.setParameterNameRenderingPolicy(DescriptorRenderer7.ONLY_NON_SYNTHESIZED);
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit ONLY_NAMES_WITH_SHORT_TYPES$lambda$5(DescriptorRenderer4 withOptions) {
        Intrinsics.checkNotNullParameter(withOptions, "$this$withOptions");
        withOptions.setWithDefinedIn(false);
        withOptions.setModifiers(SetsKt.emptySet());
        withOptions.setClassifierNamePolicy(ClassifierNamePolicy.SHORT.INSTANCE);
        withOptions.setWithoutTypeParameters(true);
        withOptions.setParameterNameRenderingPolicy(DescriptorRenderer7.NONE);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit FQ_NAMES_IN_TYPES$lambda$6(DescriptorRenderer4 withOptions) {
        Intrinsics.checkNotNullParameter(withOptions, "$this$withOptions");
        withOptions.setModifiers(DescriptorRenderer3.ALL_EXCEPT_ANNOTATIONS);
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit FQ_NAMES_IN_TYPES_WITH_ANNOTATIONS$lambda$7(DescriptorRenderer4 withOptions) {
        Intrinsics.checkNotNullParameter(withOptions, "$this$withOptions");
        withOptions.setModifiers(DescriptorRenderer3.ALL);
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit SHORT_NAMES_IN_TYPES$lambda$8(DescriptorRenderer4 withOptions) {
        Intrinsics.checkNotNullParameter(withOptions, "$this$withOptions");
        withOptions.setClassifierNamePolicy(ClassifierNamePolicy.SHORT.INSTANCE);
        withOptions.setParameterNameRenderingPolicy(DescriptorRenderer7.ONLY_NON_SYNTHESIZED);
        return Unit.INSTANCE;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit DEBUG_TEXT$lambda$9(DescriptorRenderer4 withOptions) {
        Intrinsics.checkNotNullParameter(withOptions, "$this$withOptions");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit HTML$lambda$10(DescriptorRenderer4 withOptions) {
        Intrinsics.checkNotNullParameter(withOptions, "$this$withOptions");
        withOptions.setTextFormat(DescriptorRenderer9.HTML);
        withOptions.setModifiers(DescriptorRenderer3.ALL);
        return Unit.INSTANCE;
    }
}

...
public final class RuntimeModuleData {
    ...
    private final context5 deserialization;
    private final PackagePartScopeCache packagePartScopeCache;

    public /* synthetic */ RuntimeModuleData(context5 context5Var, PackagePartScopeCache packagePartScopeCache, DefaultConstructorMarker defaultConstructorMarker) {
        this(context5Var, packagePartScopeCache);
    }

    private RuntimeModuleData(context5 context5Var, PackagePartScopeCache packagePartScopeCache) {
        this.deserialization = context5Var;

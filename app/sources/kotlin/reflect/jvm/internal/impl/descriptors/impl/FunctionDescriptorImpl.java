...
public abstract class FunctionDescriptorImpl extends DeclarationDescriptorNonRootImpl implements FunctionDescriptor {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int i) {
        ...
        switch (i) {
            ...
            case 31:
                ...
                break;
            case 25:
                objArr[0] = EventSenderWorker.INPUT_DATA_KEY_CONFIGURATION;
                break;
            default:
    ...
    protected FunctionDescriptor doSubstitute(CopyConfiguration copyConfiguration) {
        ...
        FunctionDescriptorImpl functionDescriptorImplCreateSubstitutedCopy = createSubstitutedCopy(declarationDescriptor, functionDescriptor2, copyConfiguration.kind, copyConfiguration.name, annotations2, getSourceToUseForCopy(copyConfiguration.preserveSourceElement, functionDescriptor2));
        ...
        if (!copyConfiguration.newContextReceiverParameters.isEmpty()) {
            ...
            for (ReceiverParameterDescriptor receiverParameterDescriptor2 : copyConfiguration.newContextReceiverParameters) {
                ...
                int i2 = i + 1;
                arrayList2.add(DescriptorFactory.createContextReceiverParameterForCallable(functionDescriptorImplCreateSubstitutedCopy, kotlinTypeSubstitute2, ((ImplicitReceiver2) receiverParameterDescriptor2.getValue()).getCustomLabelName(), receiverParameterDescriptor2.getAnnotations(), i));
        ...
        if (receiverParameterDescriptor4 != null) {
            ...
            zArr[r15] = zArr[r15] | (receiverParameterDescriptorSubstitute != copyConfiguration.dispatchReceiverParameter ? true : r15);
        ...
        boolean z = zArr[r15] | (kotlinTypeSubstitute != copyConfiguration.newReturnType ? true : r15);
        zArr[r15] = z;
    ...
    public static List<ValueParameterDescriptor> getSubstitutedValueParameters(FunctionDescriptor functionDescriptor, List<ValueParameterDescriptor> list, TypeSubstitutor typeSubstitutor, boolean z, boolean z2, boolean[] zArr) {
        ...
        for (ValueParameterDescriptor valueParameterDescriptor : list) {
            ...
            KotlinType kotlinTypeSubstitute = typeSubstitutor.substitute(type2, variance);

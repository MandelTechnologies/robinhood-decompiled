...
public final class MultiFieldValueClassRepresentation<Type extends RigidTypeMarker> extends ValueClassRepresentation<Type> {
    ...
    private final List<Tuples2<Name, Type>> underlyingPropertyNamesToTypes;

    public List<Tuples2<Name, Type>> getUnderlyingPropertyNamesToTypes() {
        return this.underlyingPropertyNamesToTypes;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public MultiFieldValueClassRepresentation(List<? extends Tuples2<Name, ? extends Type>> underlyingPropertyNamesToTypes) {
        super(null);

...
/* renamed from: kotlin.reflect.jvm.internal.impl.descriptors.annotations.AnnotationUtilKt, reason: use source file name */
...
public final class annotationUtil {
    ...
    public static final AnnotationDescriptor createDeprecatedAnnotation(final KotlinBuiltIns kotlinBuiltIns, String message, String replaceWith, String level, boolean z) {
        ...
        BuiltInAnnotationDescriptor builtInAnnotationDescriptor = new BuiltInAnnotationDescriptor(kotlinBuiltIns, StandardNames.FqNames.replaceWith, MapsKt.mapOf(Tuples4.m3642to(REPLACE_WITH_EXPRESSION_NAME, new StringValue(replaceWith)), Tuples4.m3642to(REPLACE_WITH_IMPORTS_NAME, new ArrayValue(CollectionsKt.emptyList(), new Function1(kotlinBuiltIns) { // from class: kotlin.reflect.jvm.internal.impl.descriptors.annotations.AnnotationUtilKt$$Lambda$0
            ...
            public Object invoke(Object obj) {
                return annotationUtil.createDeprecatedAnnotation$lambda$0(this.arg$0, (ModuleDescriptor) obj);
            }
        }))), false, 8, null);
        FqName fqName = StandardNames.FqNames.deprecated;
        Tuples2 tuples2M3642to = Tuples4.m3642to(DEPRECATED_MESSAGE_NAME, new StringValue(message));
        Tuples2 tuples2M3642to2 = Tuples4.m3642to(DEPRECATED_REPLACE_WITH_NAME, new AnnotationValue(builtInAnnotationDescriptor));
        ...
        return new BuiltInAnnotationDescriptor(kotlinBuiltIns, fqName, MapsKt.mapOf(tuples2M3642to, tuples2M3642to2, Tuples4.m3642to(name, new EnumValue(classId, nameIdentifier))), z);
    }
    ...
    public static final KotlinType createDeprecatedAnnotation$lambda$0(KotlinBuiltIns kotlinBuiltIns, ModuleDescriptor module) {
        ...
        KotlinType4 arrayType = module.getBuiltIns().getArrayType(Variance.INVARIANT, kotlinBuiltIns.getStringType());

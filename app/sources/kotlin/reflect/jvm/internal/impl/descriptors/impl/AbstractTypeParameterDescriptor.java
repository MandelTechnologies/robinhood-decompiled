...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    private final storage5<KotlinType4> defaultType;
    private final int index;
    private final boolean reified;
    private final StorageManager storageManager;
    private final storage5<TypeConstructor> typeConstructor;
    ...
    protected abstract void mo28707reportSupertypeLoopError(KotlinType kotlinType);
    ...
    protected AbstractTypeParameterDescriptor(final StorageManager storageManager, DeclarationDescriptor declarationDescriptor, Annotations annotations, final Name name, Variance variance, boolean z, int i, SourceElement sourceElement, final SupertypeLoopChecker supertypeLoopChecker) {
        ...
        this.defaultType = storageManager.createLazyValue(new Function0<KotlinType4>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeParameterDescriptor.2
            @Override // kotlin.jvm.functions.Function0
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> listMo28705getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo28705getSupertypes();
        if (listMo28705getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
        return listMo28705getSupertypes;
    }
    ...
    private class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        public KotlinBuiltIns getBuiltIns() {
            KotlinBuiltIns builtIns = DescriptorUtils2.getBuiltIns(this.this$0);
            if (builtIns == null) {
                $$$reportNull$$$0(4);
            }
            return builtIns;
        ...
        protected void reportSupertypeLoopError(KotlinType kotlinType) {
            ...
            this.this$0.mo28707reportSupertypeLoopError(kotlinType);
        }

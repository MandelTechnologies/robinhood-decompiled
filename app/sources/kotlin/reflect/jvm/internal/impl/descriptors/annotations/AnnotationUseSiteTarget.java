...
public final class AnnotationUseSiteTarget {
    ...
    public static final AnnotationUseSiteTarget ALL = new AnnotationUseSiteTarget(DisplaySpans.ALL, 0, null, 1, null);
    ...
    private AnnotationUseSiteTarget(String str, int i, String str2) {
        this.renderName = str2 == null ? capitalizeDecapitalize.toLowerCaseAsciiOnly(name()) : str2;
    }
    ...
    static {
        ...
        $ENTRIES = EnumEntries2.enumEntries(annotationUseSiteTargetArr$values);
    }

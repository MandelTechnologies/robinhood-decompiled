...
public final class RuntimeSourceElementFactory implements JavaSourceElementFactory {
    ...
    /* compiled from: RuntimeSourceElementFactory.kt */
    public static final class RuntimeSourceElement implements JavaSourceElementFactory2 {
        ...
        @Override // kotlin.reflect.jvm.internal.impl.load.java.sources.JavaSourceElementFactory2
    ...
    public JavaSourceElementFactory2 source(JavaElement javaElement) {
        Intrinsics.checkNotNullParameter(javaElement, "javaElement");

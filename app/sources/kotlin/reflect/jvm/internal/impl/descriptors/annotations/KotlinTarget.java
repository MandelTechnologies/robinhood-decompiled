...
public final class KotlinTarget {
    ...
    static {
        ...
        $ENTRIES = EnumEntries2.enumEntries(kotlinTargetArr$values);
        ...
        USE_SITE_MAPPING = MapsKt.mapOf(Tuples4.m3642to(annotationUseSiteTarget, kotlinTarget13), Tuples4.m3642to(AnnotationUseSiteTarget.FIELD, kotlinTarget9), Tuples4.m3642to(AnnotationUseSiteTarget.PROPERTY, kotlinTarget8), Tuples4.m3642to(AnnotationUseSiteTarget.FILE, kotlinTarget12), Tuples4.m3642to(AnnotationUseSiteTarget.PROPERTY_GETTER, kotlinTarget11), Tuples4.m3642to(AnnotationUseSiteTarget.PROPERTY_SETTER, kotlinTarget10), Tuples4.m3642to(AnnotationUseSiteTarget.RECEIVER, kotlinTarget13), Tuples4.m3642to(AnnotationUseSiteTarget.SETTER_PARAMETER, kotlinTarget13), Tuples4.m3642to(AnnotationUseSiteTarget.PROPERTY_DELEGATE_FIELD, kotlinTarget9));
    }

...
public class LazySubstitutingClassDescriptor extends ModuleAwareClassDescriptor {
    ...
    */
    ...
    public MemberScope getMemberScope(TypeSubstitution typeSubstitution) {
        ...
        MemberScope memberScope = getMemberScope(typeSubstitution, DescriptorUtils2.getKotlinTypeRefiner(DescriptorUtils.getContainingModule(this)));
        if (memberScope == null) {
            $$$reportNull$$$0(11);
        }
        return memberScope;
    ...
    public MemberScope getUnsubstitutedMemberScope() {
        MemberScope unsubstitutedMemberScope = getUnsubstitutedMemberScope(DescriptorUtils2.getKotlinTypeRefiner(DescriptorUtils.getContainingModule(this.original)));
    ...
    public KotlinType4 getDefaultType() {
        KotlinType4 kotlinType4SimpleTypeWithNonTrivialMemberScope = KotlinTypeFactory.simpleTypeWithNonTrivialMemberScope(TypeAttributeTranslator2.INSTANCE.toAttributes(getAnnotations(), null, null), getTypeConstructor(), TypeUtils.getDefaultTypeProjections(getTypeConstructor().getParameters()), false, getUnsubstitutedMemberScope());
    ...
    public ClassDescriptor mo28697getCompanionObjectDescriptor() {
        return this.original.mo28697getCompanionObjectDescriptor();
    }
    ...
    public ClassConstructorDescriptor mo28698getUnsubstitutedPrimaryConstructor() {
        return this.original.mo28698getUnsubstitutedPrimaryConstructor();
    }
    ...
    public ValueClassRepresentation<KotlinType4> getValueClassRepresentation() {
        ValueClassRepresentation<KotlinType4> valueClassRepresentation = this.original.getValueClassRepresentation();
        if (valueClassRepresentation == null) {
            return null;
        }
        return valueClassRepresentation.mapUnderlyingType(new Function1<KotlinType4, KotlinType4>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.LazySubstitutingClassDescriptor.2
            @Override // kotlin.jvm.functions.Function1
            public KotlinType4 invoke(KotlinType4 kotlinType4) {
                return LazySubstitutingClassDescriptor.this.substituteSimpleType(kotlinType4);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public KotlinType4 substituteSimpleType(KotlinType4 kotlinType4) {
        return (kotlinType4 == null || this.originalSubstitutor.isEmpty()) ? kotlinType4 : (KotlinType4) getSubstitutor().substitute(kotlinType4, Variance.INVARIANT);
    }
}

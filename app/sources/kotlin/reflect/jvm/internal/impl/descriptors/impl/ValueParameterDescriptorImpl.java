...
public class ValueParameterDescriptorImpl extends VariableDescriptorImpl implements ValueParameterDescriptor {
    ...
    public /* bridge */ /* synthetic */ ConstantValue mo28700getCompileTimeInitializer() {
    ...
    public ValueParameterDescriptor copy(CallableDescriptor newOwner, Name newName, int i) {
        ...
        SourceElement NO_SOURCE = SourceElement.NO_SOURCE;
        Intrinsics.checkNotNullExpressionValue(NO_SOURCE, "NO_SOURCE");
        return new ValueParameterDescriptorImpl(newOwner, null, i, annotations, newName, type2, zDeclaresDefaultValue, zIsCrossinline, zIsNoinline, varargElementType, NO_SOURCE);
    }

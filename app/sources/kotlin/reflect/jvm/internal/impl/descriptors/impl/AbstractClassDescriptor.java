...
public abstract class AbstractClassDescriptor extends ModuleAwareClassDescriptor {
    protected final storage5<KotlinType4> defaultType;
    private final Name name;
    private final storage5<ReceiverParameterDescriptor> thisAsReceiverParameter;
    private final storage5<MemberScope> unsubstitutedInnerClassesScope;
    ...
    public AbstractClassDescriptor(StorageManager storageManager, Name name) {
        ...
        this.name = name;
        this.defaultType = storageManager.createLazyValue(new Function0<KotlinType4>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractClassDescriptor.1
            @Override // kotlin.jvm.functions.Function0
            public KotlinType4 invoke() {
                AbstractClassDescriptor abstractClassDescriptor = AbstractClassDescriptor.this;
                return TypeUtils.makeUnsubstitutedType(abstractClassDescriptor, abstractClassDescriptor.getUnsubstitutedMemberScope(), new Function1<KotlinTypeRefiner, KotlinType4>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractClassDescriptor.1.1
                    @Override // kotlin.jvm.functions.Function1
                    public KotlinType4 invoke(KotlinTypeRefiner kotlinTypeRefiner) {
                        ...
                        if (classifierDescriptorRefineDescriptor == null) {
                            return (KotlinType4) AbstractClassDescriptor.this.defaultType.invoke();
                        }
    ...
    public MemberScope getUnsubstitutedMemberScope() {
        MemberScope unsubstitutedMemberScope = getUnsubstitutedMemberScope(DescriptorUtils2.getKotlinTypeRefiner(DescriptorUtils.getContainingModule(this)));
        if (unsubstitutedMemberScope == null) {
            $$$reportNull$$$0(17);
        }
        return unsubstitutedMemberScope;
    ...
    public KotlinType4 getDefaultType() {
        KotlinType4 kotlinType4 = (KotlinType4) this.defaultType.invoke();
        if (kotlinType4 == null) {
            $$$reportNull$$$0(20);
        }
        return kotlinType4;

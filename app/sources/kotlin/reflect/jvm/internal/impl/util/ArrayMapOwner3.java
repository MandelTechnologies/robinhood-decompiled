...
/* renamed from: kotlin.reflect.jvm.internal.impl.util.TypeRegistry, reason: use source file name */
/* loaded from: classes23.dex */
public abstract class ArrayMapOwner3<K, V> {
    ...
    public final <T extends V, KK extends K> ArrayMapOwner2<K, V, T> generateNullableAccessor(KClass<KK> kClass) {
        Intrinsics.checkNotNullParameter(kClass, "kClass");
        return new ArrayMapOwner2<>(getId(kClass));
    }
    ...
    public static final int getId$lambda$0(ArrayMapOwner3 arrayMapOwner3, String it) {
        Intrinsics.checkNotNullParameter(it, "it");
        return arrayMapOwner3.idCounter.getAndIncrement();
    }
    ...
    public final int getId(String keyQualifiedName) {
        ...
        return customComputeIfAbsent(this.idPerType, keyQualifiedName, new Function1(this) { // from class: kotlin.reflect.jvm.internal.impl.util.TypeRegistry$$Lambda$0
            private final ArrayMapOwner3 arg$0;
            ...
            public Object invoke(Object obj) {
                return Integer.valueOf(ArrayMapOwner3.getId$lambda$0(this.arg$0, (String) obj));
            }
        });
    }

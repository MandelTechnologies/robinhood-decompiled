...
public final class ConstantValueFactory {
    ...
    public final ArrayValue createArrayValue(List<? extends ConstantValue<?>> value, KotlinType type2) {
        Intrinsics.checkNotNullParameter(value, "value");
        Intrinsics.checkNotNullParameter(type2, "type");
        return new TypedArrayValue(value, type2);
    }
    ...
    private final ArrayValue createArrayValue(List<?> list, ModuleDescriptor moduleDescriptor, final PrimitiveType primitiveType) {
        ...
        if (moduleDescriptor != null) {
            KotlinType4 primitiveArrayKotlinType = moduleDescriptor.getBuiltIns().getPrimitiveArrayKotlinType(primitiveType);
    ...
    public static final KotlinType createArrayValue$lambda$0(PrimitiveType primitiveType, ModuleDescriptor it) {
        ...
        KotlinType4 primitiveArrayKotlinType = it.getBuiltIns().getPrimitiveArrayKotlinType(primitiveType);
        Intrinsics.checkNotNullExpressionValue(primitiveArrayKotlinType, "getPrimitiveArrayKotlinType(...)");

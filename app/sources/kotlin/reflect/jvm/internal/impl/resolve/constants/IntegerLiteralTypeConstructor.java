...
public final class IntegerLiteralTypeConstructor implements TypeConstructor {
    ...
    private final KotlinType4 f10755type;
    ...
    public static final class Companion {
        ...
        public final KotlinType4 findIntersectionType(Collection<? extends KotlinType4> types) {
        ...
        private final KotlinType4 findCommonSuperTypeOrIntersectionType(Collection<? extends KotlinType4> collection, Mode mode) {
            ...
            while (it.hasNext()) {
                ...
                next = IntegerLiteralTypeConstructor.Companion.fold((KotlinType4) next, kotlinType4, mode);
            }
            return (KotlinType4) next;
        }

        private final KotlinType4 fold(KotlinType4 kotlinType4, KotlinType4 kotlinType42, Mode mode) {
            if (kotlinType4 != null && kotlinType42 != null) {
                TypeConstructor constructor = kotlinType4.getConstructor();
                TypeConstructor constructor2 = kotlinType42.getConstructor();
                ...
                if (z) {
                    return fold((IntegerLiteralTypeConstructor) constructor, kotlinType42);
                }
                if (constructor2 instanceof IntegerLiteralTypeConstructor) {
                    return fold((IntegerLiteralTypeConstructor) constructor2, kotlinType4);
                }
            }
            return null;
        }

        private final KotlinType4 fold(IntegerLiteralTypeConstructor integerLiteralTypeConstructor, IntegerLiteralTypeConstructor integerLiteralTypeConstructor2, Mode mode) {
            Set setIntersect;
        ...
        private final KotlinType4 fold(IntegerLiteralTypeConstructor integerLiteralTypeConstructor, KotlinType4 kotlinType4) {
            if (integerLiteralTypeConstructor.getPossibleTypes().contains(kotlinType4)) {
                return kotlinType4;
            }
            return null;
        }
    ...
    private IntegerLiteralTypeConstructor(long j, ModuleDescriptor moduleDescriptor, Set<? extends KotlinType> set) {
        this.f10755type = KotlinTypeFactory.integerLiteralType(TypeAttributes.Companion.getEmpty(), this, false);
    ...
    public static final List supertypes_delegate$lambda$2(IntegerLiteralTypeConstructor integerLiteralTypeConstructor) {
        KotlinType4 defaultType = integerLiteralTypeConstructor.getBuiltIns().getComparable().getDefaultType();
        Intrinsics.checkNotNullExpressionValue(defaultType, "getDefaultType(...)");
        List listMutableListOf = CollectionsKt.mutableListOf(TypeSubstitution7.replace$default(defaultType, CollectionsKt.listOf(new TypeProjectionImpl(Variance.IN_VARIANCE, integerLiteralTypeConstructor.f10755type)), null, 2, null));

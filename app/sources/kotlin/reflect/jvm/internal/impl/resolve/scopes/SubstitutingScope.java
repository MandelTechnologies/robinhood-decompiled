...
public final class SubstitutingScope implements MemberScope {
    ...
    public SubstitutingScope(MemberScope workerScope, final TypeSubstitutor givenSubstitutor) {
        ...
        this.capturingSubstitutor = CapturedTypeConstructor4.wrapWithCapturingSubstitution$default(substitution, false, 1, null).buildSubstitutor();
    ...
    public void mo28710recordLookup(Name name, LookupLocation lookupLocation) {
    ...
    public ClassifierDescriptor mo28706getContributedClassifier(Name name, LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        ClassifierDescriptor classifierDescriptorMo28706getContributedClassifier = this.workerScope.mo28706getContributedClassifier(name, location);
        if (classifierDescriptorMo28706getContributedClassifier != null) {
            return (ClassifierDescriptor) substitute((SubstitutingScope) classifierDescriptorMo28706getContributedClassifier);
        }
        return null;
    }

...
public final class DescriptorEquivalenceForOverrides {
    ...
    public static final boolean areCallableDescriptorsEquivalent$lambda$3(boolean z, final CallableDescriptor callableDescriptor, final CallableDescriptor callableDescriptor2, TypeConstructor c1, TypeConstructor c2) {
        ...
        ClassifierDescriptor classifierDescriptorMo28704getDeclarationDescriptor = c1.mo28704getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo28704getDeclarationDescriptor2 = c2.mo28704getDeclarationDescriptor();
        if ((classifierDescriptorMo28704getDeclarationDescriptor instanceof TypeParameterDescriptor) && (classifierDescriptorMo28704getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
            return INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) classifierDescriptorMo28704getDeclarationDescriptor, (TypeParameterDescriptor) classifierDescriptorMo28704getDeclarationDescriptor2, z, new Function2(callableDescriptor, callableDescriptor2) { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$$Lambda$3

...
import kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer2;
import kotlin.reflect.jvm.internal.impl.renderer.DescriptorRenderer3;
...
public class MemberComparator implements Comparator<DeclarationDescriptor> {
    ...
    private static final DescriptorRenderer RENDERER = DescriptorRenderer.Companion.withOptions(new Function1<DescriptorRenderer4, Unit>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.MemberComparator.1
        @Override // kotlin.jvm.functions.Function1
        public Unit invoke(DescriptorRenderer4 descriptorRenderer4) {
            descriptorRenderer4.setWithDefinedIn(false);
            descriptorRenderer4.setVerbose(true);
            descriptorRenderer4.setAnnotationArgumentsRenderingPolicy(DescriptorRenderer2.UNLESS_EMPTY);
            descriptorRenderer4.setModifiers(DescriptorRenderer3.ALL);

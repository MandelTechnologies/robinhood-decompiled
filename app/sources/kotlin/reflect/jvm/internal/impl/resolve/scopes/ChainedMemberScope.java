...
public final class ChainedMemberScope implements MemberScope {
    ...
    public Collection<PropertyDescriptor> getContributedVariables(Name name, LookupLocation location) {
        ...
        for (MemberScope memberScope : memberScopeArr) {
            collectionConcat = scopeUtils.concat(collectionConcat, memberScope.getContributedVariables(name, location));
        }
    ...
    public Collection<SimpleFunctionDescriptor> getContributedFunctions(Name name, LookupLocation location) {
        ...
        for (MemberScope memberScope : memberScopeArr) {
            collectionConcat = scopeUtils.concat(collectionConcat, memberScope.getContributedFunctions(name, location));
        }
        return collectionConcat == null ? SetsKt.emptySet() : collectionConcat;
    }
    ...
    public Collection<DeclarationDescriptor> getContributedDescriptors(MemberScope3 kindFilter, Function1<? super Name, Boolean> nameFilter) {
        ...
        for (MemberScope memberScope : memberScopeArr) {
            collectionConcat = scopeUtils.concat(collectionConcat, memberScope.getContributedDescriptors(kindFilter, nameFilter));
        }
        return collectionConcat == null ? SetsKt.emptySet() : collectionConcat;
    }
    ...
    public Set<Name> getClassifierNames() {
        return MemberScope4.flatMapClassifierNamesOrNull(ArraysKt.asIterable(this.scopes));
    }
    ...
    public void mo28710recordLookup(Name name, LookupLocation location) {
        ...
        Intrinsics.checkNotNullParameter(location, "location");
        for (MemberScope memberScope : this.scopes) {
            memberScope.mo28710recordLookup(name, location);
        }
    }

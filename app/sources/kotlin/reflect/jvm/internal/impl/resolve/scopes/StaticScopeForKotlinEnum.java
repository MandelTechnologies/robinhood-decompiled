...
public final class StaticScopeForKotlinEnum extends MemberScopeImpl {
    ...
    private final storage5 functions$delegate;
    private final storage5 properties$delegate;
    ...
    public /* bridge */ /* synthetic */ ClassifierDescriptor mo28706getContributedClassifier(Name name, LookupLocation lookupLocation) {
    ...
    private final List<SimpleFunctionDescriptor> getFunctions() {
        return (List) storage7.getValue(this.functions$delegate, this, (KProperty<?>) $$delegatedProperties[0]);
    }
    ...
    private final List<PropertyDescriptor> getProperties() {
        return (List) storage7.getValue(this.properties$delegate, this, (KProperty<?>) $$delegatedProperties[1]);
    }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScopeImpl, kotlin.reflect.jvm.internal.impl.resolve.scopes.ResolutionScope
    public List<CallableMemberDescriptor> getContributedDescriptors(MemberScope3 kindFilter, Function1<? super Name, Boolean> nameFilter) {

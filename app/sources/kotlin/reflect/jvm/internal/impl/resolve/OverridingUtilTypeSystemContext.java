...
import kotlin.reflect.jvm.internal.impl.types.checker.ClassicTypeCheckerState;
...
public final class OverridingUtilTypeSystemContext implements ClassicTypeSystemContext {
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.model.TypeSystemContext
    public KotlinType4 captureFromArguments(RigidTypeMarker rigidTypeMarker, CaptureStatus captureStatus) {
    ...
    @Override // kotlin.reflect.jvm.internal.impl.types.model.TypeSystemContext
    public AbstractTypeChecker3.SupertypesPolicy substitutionSupertypePolicy(RigidTypeMarker rigidTypeMarker) {
    ...
    public AbstractTypeChecker3 newTypeCheckerState(boolean z, boolean z2, boolean z3) {
        if (this.customSubtype == null) {
            return ClassicTypeCheckerState.createClassicTypeCheckerState(z, z2, this, this.kotlinTypePreparator, this.kotlinTypeRefiner);
        }
        return new AbstractTypeChecker3(z, z2, z3, this, this.kotlinTypePreparator, this.kotlinTypeRefiner) { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtilTypeSystemContext.newTypeCheckerState.1
            ...
            @Override // kotlin.reflect.jvm.internal.impl.types.AbstractTypeChecker3

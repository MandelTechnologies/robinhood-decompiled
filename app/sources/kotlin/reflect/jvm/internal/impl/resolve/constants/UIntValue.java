...
public final class UIntValue extends UnsignedValueConstant<Integer> {
    ...
    public KotlinType getType(ModuleDescriptor module) {
        ...
        ClassDescriptor classDescriptorFindClassAcrossModuleDependencies = findClassInModule.findClassAcrossModuleDependencies(module, StandardNames.FqNames.uInt);

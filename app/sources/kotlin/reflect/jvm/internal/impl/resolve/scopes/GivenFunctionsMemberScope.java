...
public abstract class GivenFunctionsMemberScope extends MemberScopeImpl {
    ...
    private final storage5 allDescriptors$delegate;
    ...
    private final List<DeclarationDescriptor> getAllDescriptors() {
        return (List) storage7.getValue(this.allDescriptors$delegate, this, (KProperty<?>) $$delegatedProperties[0]);
    }
    ...
    public Collection<DeclarationDescriptor> getContributedDescriptors(MemberScope3 kindFilter, Function1<? super Name, Boolean> nameFilter) {
        ...
        return !kindFilter.acceptsKinds(MemberScope3.CALLABLES.getKindMask()) ? CollectionsKt.emptyList() : getAllDescriptors();
    }
    ...
    private final List<DeclarationDescriptor> createFakeOverrides(List<? extends FunctionDescriptor> list) {
        ...
        Collection<KotlinType> collectionMo28705getSupertypes = this.containingClass.getTypeConstructor().mo28705getSupertypes();
        ...
        for (Map.Entry entry : linkedHashMap.entrySet()) {
            ...
            for (Map.Entry entry2 : linkedHashMap2.entrySet()) {
                ...
                overridingUtil.generateOverridesInFunctionGroup(name2, list4, collectionEmptyList, this.containingClass, new OverridingStrategy2() { // from class: kotlin.reflect.jvm.internal.impl.resolve.scopes.GivenFunctionsMemberScope.createFakeOverrides.4

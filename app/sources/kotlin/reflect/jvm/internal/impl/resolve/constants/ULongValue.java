...
public final class ULongValue extends UnsignedValueConstant<Long> {
    ...
    public KotlinType getType(ModuleDescriptor module) {
        ...
        ClassDescriptor classDescriptorFindClassAcrossModuleDependencies = findClassInModule.findClassAcrossModuleDependencies(module, StandardNames.FqNames.uLong);

...
public final class ReflectionTypes {
    ...
    public final ClassDescriptor find(String str, int i) {
        ...
        ClassifierDescriptor classifierDescriptorMo28706getContributedClassifier = getKotlinReflectScope().mo28706getContributedClassifier(nameIdentifier, LookupLocation3.FROM_REFLECTION);
    ...
    private static final class ClassLookup {
        ...
        public final ClassDescriptor getValue(ReflectionTypes types, KProperty<?> property) {
            ...
            return types.find(capitalizeDecapitalize.capitalizeAsciiOnly(property.getName()), this.numberOfTypeParameters);
        }
    }
    ...
    public static final class Companion {
        ...
        public final KotlinType createKPropertyStarType(ModuleDescriptor module) {
            Intrinsics.checkNotNullParameter(module, "module");
            ClassDescriptor classDescriptorFindClassAcrossModuleDependencies = findClassInModule.findClassAcrossModuleDependencies(module, StandardNames.FqNames.kProperty);

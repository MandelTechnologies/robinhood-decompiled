...
public final class FunctionInvokeDescriptor extends SimpleFunctionDescriptorImpl {
    ...
    protected FunctionDescriptor doSubstitute(FunctionDescriptorImpl.CopyConfiguration configuration) {
        ...
        while (it.hasNext()) {
            ...
            if (functionTypes.extractParameterNameFromFunctionTypeArgument(type2) != null) {
                ...
                while (it2.hasNext()) {
                    ...
                    arrayList.add(functionTypes.extractParameterNameFromFunctionTypeArgument(type3));
                }
    ...
    private final FunctionDescriptor replaceParameterNames(List<Name> list) {
        ...
        if (size == 0) {
            ...
            Intrinsics.checkNotNullExpressionValue(valueParameters, "getValueParameters(...)");
            List<Tuples2> listZip = CollectionsKt.zip(list, valueParameters);
            if ((listZip instanceof Collection) && listZip.isEmpty()) {
                return this;
            }
            for (Tuples2 tuples2 : listZip) {
                if (!Intrinsics.areEqual((Name) tuples2.component1(), ((ValueParameterDescriptor) tuples2.component2()).getName())) {
                }
            }
            return this;
        }

...
import kotlin.reflect.jvm.internal.impl.utils.addToStdlib.addToStdlib;
...
public final class FunctionClassDescriptor extends AbstractClassDescriptor {
    ...
    public /* bridge */ /* synthetic */ ClassDescriptor mo28697getCompanionObjectDescriptor() {
        return (ClassDescriptor) getCompanionObjectDescriptor();
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor
    /* renamed from: getUnsubstitutedPrimaryConstructor, reason: collision with other method in class */
    public /* bridge */ /* synthetic */ ClassConstructorDescriptor mo28698getUnsubstitutedPrimaryConstructor() {
    ...
    public FunctionClassDescriptor(StorageManager storageManager, PackageFragmentDescriptor containingDeclaration, FunctionTypeKind functionTypeKind, int i) {
        ...
        PrimitiveRanges2 primitiveRanges2 = new PrimitiveRanges2(1, i);
    ...
    private final class FunctionTypeConstructor extends AbstractClassTypeConstructor {
            ...
            if (Intrinsics.areEqual(functionTypeKind, function)) {
                ...
                if (Intrinsics.areEqual(functionTypeKind, suspendFunction)) {
                    ...
                    if (!Intrinsics.areEqual(functionTypeKind, FunctionTypeKind.KSuspendFunction.INSTANCE)) {
                        addToStdlib.shouldNotBeCalled$default(null, 1, null);
        ...
        public FunctionClassDescriptor mo28704getDeclarationDescriptor() {
            return FunctionClassDescriptor.this;
        }

        public String toString() {
            return mo28704getDeclarationDescriptor().toString();
        }

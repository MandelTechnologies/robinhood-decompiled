...
public final class JavaToKotlinClassMapper {
    ...
    public final Collection<ClassDescriptor> mapPlatformClass(FqName fqName, KotlinBuiltIns builtIns) {
        ...
        FqName onlyToMutable = JavaToKotlinClassMap.INSTANCE.readOnlyToMutable(DescriptorUtils2.getFqNameUnsafe(classDescriptorMapJavaToKotlin$default));
    ...
    public final ClassDescriptor convertMutableToReadOnly(ClassDescriptor mutable) {
        ...
        ClassDescriptor builtInClassByFqName = DescriptorUtils2.getBuiltIns(mutable).getBuiltInClassByFqName(fqNameMutableToReadOnly);
    ...
    public final ClassDescriptor convertReadOnlyToMutable(ClassDescriptor readOnly) {
        ...
        ClassDescriptor builtInClassByFqName = DescriptorUtils2.getBuiltIns(readOnly).getBuiltInClassByFqName(onlyToMutable);
        Intrinsics.checkNotNullExpressionValue(builtInClassByFqName, "getBuiltInClassByFqName(...)");
        return builtInClassByFqName;
    }
}

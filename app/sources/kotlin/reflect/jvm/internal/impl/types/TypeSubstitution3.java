...
/* renamed from: kotlin.reflect.jvm.internal.impl.types.IndexedParametersSubstitution, reason: use source file name */
/* loaded from: classes14.dex */
public final class TypeSubstitution3 extends TypeSubstitution {
    private final boolean approximateContravariantCapturedTypes;
    private final TypeProjection[] arguments;
    private final TypeParameterDescriptor[] parameters;

    public /* synthetic */ TypeSubstitution3(TypeParameterDescriptor[] typeParameterDescriptorArr, TypeProjection[] typeProjectionArr, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public TypeSubstitution3(TypeParameterDescriptor[] parameters, TypeProjection[] arguments, boolean z) {
    ...
    public TypeSubstitution3(List<? extends TypeParameterDescriptor> parameters, List<? extends TypeProjection> argumentsList) {

...
public class TypeProjectionImpl extends TypeProjectionBase {
    ...
    private final KotlinType f10759type;
    ...
    public KotlinType getType() {
        KotlinType kotlinType = this.f10759type;
        if (kotlinType == null) {
            $$$reportNull$$$0(5);
        }
        return kotlinType;
    ...
    public TypeProjection refine(KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        return new TypeProjectionImpl(this.projection, kotlinTypeRefiner.refineType((KotlinTypeMarker) this.f10759type));
    }
}

...
import kotlin.reflect.jvm.internal.impl.types.checker.NewKotlinTypeChecker5;
...
public abstract class KotlinType implements Annotated, KotlinTypeMarker {
    ...
    public abstract KotlinType5 unwrap();
    ...
    public Annotations getAnnotations() {
        return AnnotationsTypeAttribute2.getAnnotations(getAttributes());
    }

    private final int computeHashCode() {
        if (KotlinType3.isError(this)) {
    ...
    public final boolean equals(Object obj) {
        ...
        return isMarkedNullable() == kotlinType.isMarkedNullable() && NewKotlinTypeChecker5.INSTANCE.strictEqualTypes(unwrap(), kotlinType.unwrap());
    }
}

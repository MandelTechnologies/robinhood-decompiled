...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public abstract ClassifierDescriptor mo28704getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor classifierDescriptorMo28704getDeclarationDescriptor = mo28704getDeclarationDescriptor();
        if (hasMeaningfulFqName(classifierDescriptorMo28704getDeclarationDescriptor)) {
            iIdentityHashCode = DescriptorUtils.getFqName(classifierDescriptorMo28704getDeclarationDescriptor).hashCode();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor classifierDescriptorMo28704getDeclarationDescriptor = mo28704getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo28704getDeclarationDescriptor2 = typeConstructor.mo28704getDeclarationDescriptor();
        if (classifierDescriptorMo28704getDeclarationDescriptor2 != null && hasMeaningfulFqName(classifierDescriptorMo28704getDeclarationDescriptor) && hasMeaningfulFqName(classifierDescriptorMo28704getDeclarationDescriptor2)) {
            return isSameClassifier(classifierDescriptorMo28704getDeclarationDescriptor2);
        }
        return false;
    }

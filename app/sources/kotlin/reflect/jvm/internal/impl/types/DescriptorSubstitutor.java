...
public class DescriptorSubstitutor {
    ...
    public static TypeSubstitutor substituteTypeParameters(List<TypeParameterDescriptor> list, TypeSubstitution typeSubstitution, DeclarationDescriptor declarationDescriptor, List<TypeParameterDescriptor> list2, boolean[] zArr) {
        ...
        TypeSubstitution4 typeSubstitution4CreateByConstructorsMap = TypeSubstitution4.createByConstructorsMap(map);
        TypeSubstitutor typeSubstitutorCreateChainedSubstitutor = TypeSubstitutor.createChainedSubstitutor(typeSubstitution, typeSubstitution4CreateByConstructorsMap);
        TypeSubstitutor typeSubstitutorCreateChainedSubstitutor2 = TypeSubstitutor.createChainedSubstitutor(typeSubstitution.replaceWithNonApproximating(), typeSubstitution4CreateByConstructorsMap);
        for (TypeParameterDescriptor typeParameterDescriptor2 : list) {
            ...
            for (KotlinType kotlinType : typeParameterDescriptor2.getUpperBounds()) {
                ...
                KotlinType kotlinTypeSubstitute = (((classifierDescriptorMo28704getDeclarationDescriptor instanceof TypeParameterDescriptor) && TypeUtils2.hasTypeParameterRecursiveBounds((TypeParameterDescriptor) classifierDescriptorMo28704getDeclarationDescriptor)) ? typeSubstitutorCreateChainedSubstitutor : typeSubstitutorCreateChainedSubstitutor2).substitute(kotlinType, Variance.OUT_VARIANCE);

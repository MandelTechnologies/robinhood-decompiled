...
public final class TypeVariance {
    ...
    /* renamed from: IN */
    public static final TypeVariance f7036IN = new TypeVariance(CountryCode.COUNTRY_CODE_IN, 0, "in");
    ...
    private static final /* synthetic */ TypeVariance[] $values() {
        return new TypeVariance[]{f7036IN, OUT, INV};
    }
    ...
    static {
        ...
        $ENTRIES = EnumEntries2.enumEntries(typeVarianceArr$values);
    }

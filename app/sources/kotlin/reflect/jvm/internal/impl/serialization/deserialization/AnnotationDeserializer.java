...
public final class AnnotationDeserializer {
    ...
    public final AnnotationDescriptor deserializeAnnotation(ProtoBuf.Annotation proto, NameResolver nameResolver) {
        ...
        ClassDescriptor classDescriptorResolveClass = resolveClass(NameResolverUtil.getClassId(nameResolver, proto.getId()));
        ...
        if (proto.getArgumentCount() != 0 && !ErrorUtils.isError(classDescriptorResolveClass) && DescriptorUtils.isAnnotationClass(classDescriptorResolveClass)) {
            ...
            if (classConstructorDescriptor != null) {
                ...
                for (ProtoBuf.Annotation.Argument argument : argumentList) {
                    ...
                    Tuples2<Name, ConstantValue<?>> tuples2ResolveArgument = resolveArgument(argument, linkedHashMap, nameResolver);
                    if (tuples2ResolveArgument != null) {
                        arrayList.add(tuples2ResolveArgument);
                    }
                }
    ...
    private final Tuples2<Name, ConstantValue<?>> resolveArgument(ProtoBuf.Annotation.Argument argument, Map<Name, ? extends ValueParameterDescriptor> map, NameResolver nameResolver) {
        ...
        return new Tuples2<>(name, resolveValueAndCheckExpectedType(type2, value, nameResolver));
    }
        ...
        switch (type2 == null ? -1 : WhenMappings.$EnumSwitchMapping$0[type2.ordinal()]) {
            ...
            case 13:
                ...
                for (ProtoBuf.Annotation.Argument.Value value2 : list) {
                    KotlinType4 anyType = getBuiltIns().getAnyType();

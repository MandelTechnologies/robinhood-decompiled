...
public class DeserializedPackageMemberScope extends DeserializedMemberScope {
    ...
    public /* bridge */ /* synthetic */ Collection getContributedDescriptors(MemberScope3 memberScope3, Function1 function1) {
        return getContributedDescriptors(memberScope3, (Function1<? super Name, Boolean>) function1);
    }

    public DeserializedPackageMemberScope(PackageFragmentDescriptor packageDescriptor, ProtoBuf.Package proto, NameResolver nameResolver, BinaryVersion metadataVersion, DeserializedContainerSource deserializedContainerSource, context5 components, String debugName, Function0<? extends Collection<Name>> classNames) {
        ...
        context6 context6VarCreateContext = components.createContext(packageDescriptor, nameResolver, typeTable2, companion.create(versionRequirementTable), metadataVersion, deserializedContainerSource);
        ...
        super(context6VarCreateContext, functionList, propertyList, typeAliasList, classNames);
    ...
    @Override // kotlin.reflect.jvm.internal.impl.resolve.scopes.MemberScopeImpl, kotlin.reflect.jvm.internal.impl.resolve.scopes.ResolutionScope
    public List<DeclarationDescriptor> getContributedDescriptors(MemberScope3 kindFilter, Function1<? super Name, Boolean> nameFilter) {
        Intrinsics.checkNotNullParameter(kindFilter, "kindFilter");
        Intrinsics.checkNotNullParameter(nameFilter, "nameFilter");
        Collection<DeclarationDescriptor> collectionComputeDescriptors = computeDescriptors(kindFilter, nameFilter, LookupLocation3.WHEN_GET_ALL_DESCRIPTORS);
    ...
    public ClassifierDescriptor mo28706getContributedClassifier(Name name, LookupLocation location) {
        ...
        return super.mo28706getContributedClassifier(name, location);
    }

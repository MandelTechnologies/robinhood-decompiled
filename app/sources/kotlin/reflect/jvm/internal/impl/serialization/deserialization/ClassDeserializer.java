...
public final class ClassDeserializer {
    ...
    public ClassDeserializer(context5 components) {
    ...
    private final ClassDescriptor createClass(ClassKey classKey) {
        ...
        if (outerClassId != null) {
            ...
            Iterator<T> it2 = PackageFragmentProvider2.packageFragments(this.components.getPackageFragmentProvider(), classId.getPackageFqName()).iterator();
            while (true) {
                if (!it2.hasNext()) {
                    next = null;
                    break;
            ...
            context6VarCreateContext = context5Var.createContext(packageFragmentDescriptor2, nameResolverComponent1, typeTable2, companion.create(versionRequirementTable), binaryVersionComponent3, null);
            binaryVersionComponent3 = binaryVersionComponent3;
        }
        return new DeserializedClassDescriptor(context6VarCreateContext, classComponent2, nameResolverComponent1, binaryVersionComponent3, sourceElementComponent4);
    }

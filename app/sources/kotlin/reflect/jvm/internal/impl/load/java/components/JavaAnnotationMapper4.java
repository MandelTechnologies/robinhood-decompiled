...
/* renamed from: kotlin.reflect.jvm.internal.impl.load.java.components.JavaDeprecatedAnnotationDescriptor, reason: use source file name */
/* loaded from: classes14.dex */
public final class JavaAnnotationMapper4 extends JavaAnnotationMapper2 {
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(JavaAnnotationMapper4.class, "allValueArguments", "getAllValueArguments()Ljava/util/Map;", 0))};
    private final storage5 allValueArguments$delegate;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public JavaAnnotationMapper4(JavaAnnotation javaAnnotation, context4 c) {
        ...
        this.allValueArguments$delegate = c.getStorageManager().createLazyValue(new Function0() { // from class: kotlin.reflect.jvm.internal.impl.load.java.components.JavaDeprecatedAnnotationDescriptor$$Lambda$0
            ...
            public Object invoke() {
                return JavaAnnotationMapper4.allValueArguments_delegate$lambda$0();
            }
        });
    }
    ...
    public static final Map allValueArguments_delegate$lambda$0() {
        return MapsKt.mapOf(Tuples4.m3642to(JavaAnnotationMapper.INSTANCE.getDEPRECATED_ANNOTATION_MESSAGE$descriptors_jvm(), new StringValue("Deprecated in Java")));
    }
}

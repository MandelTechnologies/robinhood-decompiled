...
import kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.typeEnhancement5;
...
public class JavaPropertyDescriptor extends PropertyDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    private final Tuples2<CallableDescriptor.UserDataKey<?>, ?> singleUserData;
    ...
    public JavaCallableMemberDescriptor enhance(KotlinType kotlinType, List<KotlinType> list, KotlinType kotlinType2, Tuples2<CallableDescriptor.UserDataKey<?>, ?> tuples2) {
        ...
        JavaPropertyDescriptor javaPropertyDescriptor = new JavaPropertyDescriptor(getContainingDeclaration(), getAnnotations(), getModality(), getVisibility(), isVar(), getName(), getSource(), original, getKind(), this.isStaticFinal, tuples2);
        ...
        Function0<storage6<ConstantValue<?>>> function0 = this.compileTimeInitializerFactory;
        if (function0 != null) {
    ...
    public boolean isConst() {
        ...
        if (this.isStaticFinal && ConstUtil.canBeUsedForConstVal(type2)) {
            return !typeEnhancement5.hasEnhancedNullability(type2) || KotlinBuiltIns.isString(type2);
        }
        return false;
    }
    ...
    public <V> V getUserData(CallableDescriptor.UserDataKey<V> userDataKey) {
        Tuples2<CallableDescriptor.UserDataKey<?>, ?> tuples2 = this.singleUserData;
        if (tuples2 == null || !tuples2.getFirst().equals(userDataKey)) {
            return null;
        }

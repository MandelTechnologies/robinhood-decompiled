...
public final class JavaClassDataFinder implements ClassDataFinder {
    ...
    public ClassData findClassData(ClassId classId) {
        ...
        KotlinJvmBinaryClass kotlinJvmBinaryClassFindKotlinClass = KotlinClassFinder2.findKotlinClass(this.kotlinClassFinder, classId, this.deserializedDescriptorResolver.getComponents().getConfiguration().getMetadataVersion());

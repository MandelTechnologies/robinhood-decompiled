...
public abstract class AbstractBinaryClassAnnotationLoader<A, S extends AnnotationsContainer<? extends A>> implements AnnotationLoader<A> {
    ...
    private static final class PropertyRelatedElement {
        ...
        static {
            ...
            $ENTRIES = EnumEntries2.enumEntries(propertyRelatedElementArr$values);
        }
    ...
    private final List<A> loadPropertyAnnotations(ProtoContainer protoContainer, ProtoBuf.Property property, PropertyRelatedElement propertyRelatedElement) {
        ...
        if (propertyRelatedElement == PropertyRelatedElement.PROPERTY) {
            MemberSignature propertySignature$default = AbstractBinaryClassAnnotationLoader2.getPropertySignature$default(property, protoContainer.getNameResolver(), protoContainer.getTypeTable(), false, true, false, 40, null);
        ...
        MemberSignature propertySignature$default2 = AbstractBinaryClassAnnotationLoader2.getPropertySignature$default(property, protoContainer.getNameResolver(), protoContainer.getTypeTable(), true, false, false, 48, null);
    ...
    private final int computeJvmParameterIndexShift(ProtoContainer protoContainer, MessageLite messageLite) {
        if (messageLite instanceof ProtoBuf.Function) {
            return protoTypeTableUtil.hasReceiver((ProtoBuf.Function) messageLite) ? 1 : 0;
        }
        if (messageLite instanceof ProtoBuf.Property) {
            return protoTypeTableUtil.hasReceiver((ProtoBuf.Property) messageLite) ? 1 : 0;
        }
    ...
    protected final MemberSignature getCallableSignature(MessageLite proto, NameResolver nameResolver, TypeTable typeTable, AnnotatedCallableKind kind, boolean z) {
        ...
        if (proto instanceof ProtoBuf.Property) {
            ...
            JvmProtoBuf.JvmPropertySignature jvmPropertySignature = (JvmProtoBuf.JvmPropertySignature) ProtoBufUtil.getExtensionOrNull((GeneratedMessageLite.ExtendableMessage) proto, propertySignature);
            ...
            if (i != 1) {
                if (i != 2) {
                    ...
                    return AbstractBinaryClassAnnotationLoader2.getPropertySignature((ProtoBuf.Property) proto, nameResolver, typeTable, true, true, z);
                }
    ...
    public static final class Companion {
        ...
        public final KotlinJvmBinaryClass getSpecialCaseContainerClass(ProtoContainer container, boolean z, boolean z2, Boolean bool, boolean z3, KotlinClassFinder kotlinClassFinder, MetadataVersion metadataVersion) {
            ...
            if (z) {
                ...
                if (container instanceof ProtoContainer.Class) {
                    ...
                    if (r8.getKind() == ProtoBuf.Class.Kind.INTERFACE) {
                        ...
                        return KotlinClassFinder2.findKotlinClass(kotlinClassFinder, classId.createNestedClassId(nameIdentifier), metadataVersion);
                    }
                }
                if (bool.booleanValue() && (container instanceof ProtoContainer.Package)) {
                    ...
                    if (facadeClassName != null) {
                        ...
                        return KotlinClassFinder2.findKotlinClass(kotlinClassFinder, companion.topLevel(new FqName(StringsKt.replace$default(internalName, '/', '.', false, 4, (Object) null))), metadataVersion);
                    }
                }
            }
            ...
            return knownJvmBinaryClass == null ? KotlinClassFinder2.findKotlinClass(kotlinClassFinder, jvmPackagePartSource2.getClassId(), metadataVersion) : knownJvmBinaryClass;
        }
    }
}

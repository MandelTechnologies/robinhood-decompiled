...
/* renamed from: kotlin.reflect.jvm.internal.impl.load.java.PropertiesConventionUtilKt, reason: use source file name */
...
public final class propertiesConventionUtil {
    ...
    private static final Name propertyNameFromAccessorMethodName(Name name, String str, boolean z, String str2) {
        ...
        String strDecapitalizeSmartForCompiler = capitalizeDecapitalize.decapitalizeSmartForCompiler(StringsKt.removePrefix(identifier, str), true);

...
public final class DescriptorResolverUtils {
    ...
    private static <D extends CallableMemberDescriptor> Collection<D> resolveOverrides(Name name, Collection<D> collection, Collection<D> collection2, ClassDescriptor classDescriptor, final ErrorReporter errorReporter, OverridingUtil overridingUtil, final boolean z) {
        ...
        overridingUtil.generateOverridesInFunctionGroup(name, collection, collection2, classDescriptor, new OverridingStrategy2() { // from class: kotlin.reflect.jvm.internal.impl.load.java.components.DescriptorResolverUtils.1
            private static /* synthetic */ void $$$reportNull$$$0(int i) {
                ...
                if (i == 1) {
                    ...
                    objArr[0] = KaizenExperiment.VARIATION_MEMBER;
                } else if (i != 4) {

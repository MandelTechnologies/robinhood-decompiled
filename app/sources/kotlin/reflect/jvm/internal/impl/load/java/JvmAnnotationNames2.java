...
/* renamed from: kotlin.reflect.jvm.internal.impl.load.java.JvmAnnotationNamesKt, reason: use source file name */
...
public final class JvmAnnotationNames2 {
    ...
    static {
        ...
        javaToKotlinNameMap = MapsKt.mapOf(Tuples4.m3642to(JvmAnnotationNames.TARGET_ANNOTATION, StandardNames.FqNames.target), Tuples4.m3642to(JvmAnnotationNames.RETENTION_ANNOTATION, StandardNames.FqNames.retention), Tuples4.m3642to(JvmAnnotationNames.DEPRECATED_ANNOTATION, StandardNames.FqNames.deprecated), Tuples4.m3642to(JvmAnnotationNames.DOCUMENTED_ANNOTATION, StandardNames.FqNames.mustBeDocumented));

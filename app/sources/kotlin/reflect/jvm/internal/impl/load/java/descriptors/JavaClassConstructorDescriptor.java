...
public class JavaClassConstructorDescriptor extends ClassConstructorDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    public /* bridge */ /* synthetic */ JavaCallableMemberDescriptor enhance(KotlinType kotlinType, List list, KotlinType kotlinType2, Tuples2 tuples2) {
        return enhance(kotlinType, (List<KotlinType>) list, kotlinType2, (Tuples2<CallableDescriptor.UserDataKey<?>, ?>) tuples2);
    }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.load.java.descriptors.JavaCallableMemberDescriptor
    public JavaClassConstructorDescriptor enhance(KotlinType kotlinType, List<KotlinType> list, KotlinType kotlinType2, Tuples2<CallableDescriptor.UserDataKey<?>, ?> tuples2) {
        if (list == null) {
            $$$reportNull$$$0(16);
        }
        if (kotlinType2 == null) {
        ...
        if (tuples2 != null) {
            javaClassConstructorDescriptorCreateSubstitutedCopy.putInUserDataMap(tuples2.getFirst(), tuples2.getSecond());
        }

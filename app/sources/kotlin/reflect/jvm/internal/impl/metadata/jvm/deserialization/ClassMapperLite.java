...
public final class ClassMapperLite {
    ...
    private static final String f10752kotlin = CollectionsKt.joinToString$default(CollectionsKt.listOf((Object[]) new Character[]{'k', 'o', 't', 'l', 'i', 'n'}), "", null, null, 0, null, null, 62, null);
    ...
    static {
        ...
        if (progressionLastElement >= 0) {
            ...
            while (true) {
                ...
                String str = f10752kotlin;
                sb.append(str);
                sb.append('/');
                sb.append((String) listListOf.get(i));
                int i2 = i + 1;
                linkedHashMap.put(sb.toString(), listListOf.get(i2));
                linkedHashMap.put(str + '/' + ((String) listListOf.get(i)) + ContentTypeResource.Field.Type.Array.identifier, '[' + ((String) listListOf.get(i2)));
        ...
        linkedHashMap.put(f10752kotlin + "/Unit", "V");
        ...
        for (String str5 : CollectionsKt.listOf((Object[]) new String[]{"Char", "Byte", "Short", "Int", "Float", "Long", "Double", "String", "Enum"})) {
            map$lambda$0$add(linkedHashMap, str5 + ".Companion", f10752kotlin + "/jvm/internal/" + str5 + "CompanionObject");
        }
        map = linkedHashMap;
    }

    private static final void map$lambda$0$add(Map<String, String> map2, String str, String str2) {
        map2.put(f10752kotlin + '/' + str, Matrix.MATRIX_TYPE_RANDOM_LT + str2 + ';');
    }
    ...
    public static final String mapClass(String classId) {
        ...
        return Matrix.MATRIX_TYPE_RANDOM_LT + StringsKt.replace$default(classId, '.', TickerInputView.CURRENCY_SYMBOL, false, 4, (Object) null) + ';';
    }
}

...
public final class ProtoBuf {
        ...
        */
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            if (getSealedSubclassFqNameList().size() > 0) {
                codedOutputStream.writeRawVarint32(EnumC7081g.SDK_ASSET_ILLUSTRATION_CONSUMER_VALUE);
            ...
            if (getContextReceiverTypeIdList().size() > 0) {
                codedOutputStream.writeRawVarint32(EnumC7081g.SDK_ASSET_ILLUSTRATION_INCOME_PAYROLL_URL_VALUE);
            ...
            if (getMultiFieldValueClassUnderlyingNameList().size() > 0) {
                codedOutputStream.writeRawVarint32(EnumC7081g.f2773x8d9721ad);
            ...
            if (getMultiFieldValueClassUnderlyingTypeIdList().size() > 0) {
                codedOutputStream.writeRawVarint32(EnumC7081g.SDK_ASSET_ICON_EXTERNAL_VALUE);
        ...
        public int getSerializedSize() {
            ...
            for (int i18 = 0; i18 < this.compilerPluginData_.size(); i18++) {
                size += CodedOutputStream.computeMessageSize(33, this.compilerPluginData_.get(i18));
            }
    ...
    public static final class Constructor extends GeneratedMessageLite.ExtendableMessage<Constructor> implements ConstructorOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i4 = 0; i4 < this.compilerPluginData_.size(); i4++) {
                size += CodedOutputStream.computeMessageSize(32, this.compilerPluginData_.get(i4));
            }
            int iExtensionsSerializedSize = size + extensionsSerializedSize() + this.unknownFields.size();
            this.memoizedSerializedSize = iExtensionsSerializedSize;
            return iExtensionsSerializedSize;
    ...
    public static final class Function extends GeneratedMessageLite.ExtendableMessage<Function> implements FunctionOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i7 = 0; i7 < this.compilerPluginData_.size(); i7++) {
                size += CodedOutputStream.computeMessageSize(33, this.compilerPluginData_.get(i7));
            }
            int iExtensionsSerializedSize = size + extensionsSerializedSize() + this.unknownFields.size();
            this.memoizedSerializedSize = iExtensionsSerializedSize;
            return iExtensionsSerializedSize;
    ...
    public static final class Property extends GeneratedMessageLite.ExtendableMessage<Property> implements PropertyOrBuilder {
            ...
            while (true) {
                ...
                if (!z) {
                    try {
                        ...
                        if (((c == true ? 1 : 0) & 16384) == unknownField) {
                            this.compilerPluginData_ = Collections.unmodifiableList(this.compilerPluginData_);
                        }
                        try {
                            codedOutputStreamNewInstance.flush();
        ...
        public int getSerializedSize() {
            ...
            int size = iComputeInt32SizeNoTag2 + iComputeInt32SizeNoTag3 + (getVersionRequirementList().size() * 2);
            for (int i6 = 0; i6 < this.compilerPluginData_.size(); i6++) {
    ...
    public static final class CompilerPluginData extends GeneratedMessageLite implements CompilerPluginDataOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<CompilerPluginData, Builder> implements CompilerPluginDataOrBuilder {
            ...
            public CompilerPluginData build() {
                ...
                throw AbstractMessageLite.Builder.newUninitializedMessageException(compilerPluginDataBuildPartial);
            }
            ...
            */
            public Builder mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws Throwable {
                ...
                try {
                    try {
                        CompilerPluginData partialFrom = CompilerPluginData.PARSER.parsePartialFrom(codedInputStream, extensionRegistryLite);
                        if (partialFrom != null) {
                            mergeFrom(partialFrom);
                        }
                        return this;

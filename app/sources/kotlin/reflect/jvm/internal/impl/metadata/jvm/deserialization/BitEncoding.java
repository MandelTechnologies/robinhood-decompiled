...
public class BitEncoding {
    ...
    private static /* synthetic */ void $$$reportNull$$$0(int i) {
        ...
        if (i == 1 || i == 3 || i == 6 || i == 8 || i == 10 || i == 12 || i == 14) {
            ...
            objArr[0] = WebsocketGatewayConstants.DATA_KEY;
        }
        if (i == 1) {
    ...
    private static void addModuloByte(byte[] bArr, int i) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            bArr[i2] = (byte) ((bArr[i2] + i) & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE);
        }
    }
    ...
    public static byte[] decodeBytes(String[] strArr) {
        ...
        if (strArr.length > 0 && !strArr[0].isEmpty()) {
            ...
            if (cCharAt == 0) {
                byte[] bArrStringsToBytes = utfEncoding.stringsToBytes(dropMarker(strArr));
        ...
        addModuloByte(bArrCombineStringArrayIntoBytes, EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE);

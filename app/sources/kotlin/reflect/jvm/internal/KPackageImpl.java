...
public final class KPackageImpl extends KDeclarationContainerImpl {
    ...
    final class Data extends KDeclarationContainerImpl.Data {
        ...
        public final Tuples3<JvmNameResolver, ProtoBuf.Package, MetadataVersion> getMetadata() {
            return (Tuples3) this.metadata.getValue();
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final Tuples3 metadata_delegate$lambda$4(Data data) {
            KotlinClassHeader classHeader;
            ReflectKotlinClass kotlinClass = data.getKotlinClass();
            if (kotlinClass != null && (classHeader = kotlinClass.getClassHeader()) != null) {
                ...
                if (data2 != null && strings != null) {
                    Tuples2<JvmNameResolver, ProtoBuf.Package> packageDataFrom = JvmProtoBufUtil.readPackageDataFrom(data2, strings);
    ...
    public Collection<PropertyDescriptor> getProperties(Name name) {
        ...
        return getScope().getContributedVariables(name, LookupLocation3.FROM_REFLECTION);
    }

    @Override // kotlin.reflect.jvm.internal.KDeclarationContainerImpl
    public Collection<FunctionDescriptor> getFunctions(Name name) {
        Intrinsics.checkNotNullParameter(name, "name");
        return getScope().getContributedFunctions(name, LookupLocation3.FROM_REFLECTION);
    }

    @Override // kotlin.reflect.jvm.internal.KDeclarationContainerImpl
    public PropertyDescriptor getLocalProperty(int index) {
        Tuples3<JvmNameResolver, ProtoBuf.Package, MetadataVersion> metadata = this.data.getValue().getMetadata();
        if (metadata != null) {
            ...
            ProtoBuf.Property property = (ProtoBuf.Property) ProtoBufUtil.getExtensionOrNull(packageComponent2, packageLocalVariable, index);
            if (property != null) {
                Class<?> jClass = getJClass();
                ProtoBuf.TypeTable typeTable = packageComponent2.getTypeTable();
                Intrinsics.checkNotNullExpressionValue(typeTable, "getTypeTable(...)");
                return (PropertyDescriptor) UtilKt.deserializeToDescriptor(jClass, property, jvmNameResolverComponent1, new TypeTable(typeTable), metadataVersionComponent3, KPackageImpl2.INSTANCE);
            }
        }
        return null;
    }
    ...
    public String toString() {
        return "file class " + reflectClassUtil.getClassId(getJClass()).asSingleFqName();
    }
}

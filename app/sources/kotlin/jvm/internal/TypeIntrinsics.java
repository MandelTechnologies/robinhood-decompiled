...
public class TypeIntrinsics {
    ...
    public static boolean isMutableList(Object obj) {
        if (obj instanceof List) {
            return !(obj instanceof KMarkers) || (obj instanceof KMarkers5);
        }
        return false;
    }
    ...
    public static boolean isMutableSet(Object obj) {
        if (obj instanceof Set) {
            return !(obj instanceof KMarkers) || (obj instanceof KMarkers8);
        }
        return false;
    }
    ...
    public static boolean isMutableMap(Object obj) {
        if (obj instanceof Map) {
            return !(obj instanceof KMarkers) || (obj instanceof KMarkers7);
        }
        return false;
    }
    ...
    public static boolean isMutableMapEntry(Object obj) {
        if (obj instanceof Map.Entry) {
            return !(obj instanceof KMarkers) || (obj instanceof KMarkers7.Entry);
        }
        return false;
    }

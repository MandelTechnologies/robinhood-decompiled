...
public final class ConnectionSpecSelector {
    ...
    public final ConnectionSpec configureSecureSocket(SSLSocket sslSocket) throws IOException {
        ...
        String string2 = Arrays.toString(enabledProtocols);

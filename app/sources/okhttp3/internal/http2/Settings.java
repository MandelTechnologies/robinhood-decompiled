...
public final class Settings {
    ...
    public final int getInitialWindowSize() {
        return (this.set & 128) != 0 ? this.values[7] : Blake2xsDigest.UNKNOWN_DIGEST_LENGTH;
    }

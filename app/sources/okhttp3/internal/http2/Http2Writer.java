...
public final class Http2Writer implements Closeable {
    ...
    public final void frameHeader(int streamId, int length, int type2, int flags) throws IOException {
        int i;
        int i2;
        int i3;
        int i4;

...
@Metadata(m3635d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010$\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\n\bÆ\u0002\u0018\u00002\u00020\u0001:\u0002\u0015\u0016B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u001b\u0010\u0007\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u0004H\u0002¢\u0006\u0004\b\u0007\u0010\bJ\u0015\u0010\n\u001a\u00020\u00052\u0006\u0010\t\u001a\u00020\u0005¢\u0006\u0004\b\n\u0010\u000bR\u001d\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\r0\f8\u0006¢\u0006\f\n\u0004\b\u000e\u0010\u000f\u001a\u0004\b\u0010\u0010\u0011R#\u0010\u0012\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u00048\u0006¢\u0006\f\n\u0004\b\u0012\u0010\u0013\u001a\u0004\b\u0014\u0010\b¨\u0006\u0017"}, m3636d2 = {"Lokhttp3/internal/http2/Hpack;", "", "<init>", "()V", "", "Lokio/ByteString;", "", "nameToFirstIndex", "()Ljava/util/Map;", "name", "checkLowercase", "(Lokio/ByteString;)Lokio/ByteString;", "", "Lokhttp3/internal/http2/Header;", "STATIC_HEADER_TABLE", "[Lokhttp3/internal/http2/Header;", "getSTATIC_HEADER_TABLE", "()[Lokhttp3/internal/http2/Header;", "NAME_TO_FIRST_INDEX", "Ljava/util/Map;", "getNAME_TO_FIRST_INDEX", "Reader", "Writer", "okhttp"}, m3637k = 1, m3638mv = {1, 8, 0}, m3640xi = 48)
    ...
    public static final class Reader {
        ...
        public final void readHeaders() throws IOException {
            while (!this.source.exhausted()) {
                ...
                if ((iAnd & 128) == 128) {
                    readIndexedHeader(readInt(iAnd, EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) - 1);
                } else if (iAnd == 64) {
        ...
        public final int readInt(int firstByte, int prefixMask) throws IOException {
            ...
            while (true) {
                ...
                prefixMask += (i3 & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) << i2;
                i2 += 7;
            }
        }
        ...
        public final ByteString readByteString() throws IOException {
            int i = readByte();
            boolean z = (i & 128) == 128;
            long j = readInt(i, EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE);
            if (z) {
        ...
        */
        public final void writeHeaders(List<Header> headerBlock) throws IOException {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (length2 != -1) {
                    writeInt(length2, EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE, 128);
                } else if (length == -1) {
        ...
        public final void writeInt(int value, int prefixMask, int bits) {
            ...
            while (i >= 128) {
                this.out.writeByte(128 | (i & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE));
                i >>>= 7;
            }
        ...
        public final void writeByteString(ByteString data) throws IOException {
            ...
            if (this.useCompression) {
                ...
                if (huffman.encodedLength(data) < data.size()) {
                    ...
                    writeInt(byteString.size(), EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE, 128);
                    this.out.write(byteString);
                    return;
                }
            }
            writeInt(data.size(), EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE, 0);
            this.out.write(data);
        }

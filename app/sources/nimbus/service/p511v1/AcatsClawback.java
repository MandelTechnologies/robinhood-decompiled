...
public final class AcatsClawback extends Message {
    ...
    public AcatsClawback() {
        this(false, null, null, null, 15, null);
    }

    public /* synthetic */ AcatsClawback(boolean z, String str, String str2, ByteString byteString, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? false : z, (i & 2) != 0 ? "" : str, (i & 4) != 0 ? "" : str2, (i & 8) != 0 ? ByteString.EMPTY : byteString);
    }

    @Override // com.squareup.wire.Message
    public /* bridge */ /* synthetic */ Message.Builder newBuilder() {
        return (Message.Builder) m29347newBuilder();
    }
    ...
    public AcatsClawback(boolean z, String clawback_amount, String moved_match_amount, ByteString unknownFields) {
    ...
    public /* synthetic */ Void m29347newBuilder() {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof AcatsClawback)) {
            return false;
        }
        AcatsClawback acatsClawback = (AcatsClawback) other;
        return Intrinsics.areEqual(unknownFields(), acatsClawback.unknownFields()) && this.is_insufficient_funds == acatsClawback.is_insufficient_funds && Intrinsics.areEqual(this.clawback_amount, acatsClawback.clawback_amount) && Intrinsics.areEqual(this.moved_match_amount, acatsClawback.moved_match_amount);
    }
    ...
    public String toString() {
        ...
        return CollectionsKt.joinToString$default(arrayList, ", ", "AcatsClawback{", "}", 0, null, null, 56, null);
    }

    public static /* synthetic */ AcatsClawback copy$default(AcatsClawback acatsClawback, boolean z, String str, String str2, ByteString byteString, int i, Object obj) {
        if ((i & 1) != 0) {
            z = acatsClawback.is_insufficient_funds;
        }
        if ((i & 2) != 0) {
            str = acatsClawback.clawback_amount;
        }
        if ((i & 4) != 0) {
            str2 = acatsClawback.moved_match_amount;
        }
        if ((i & 8) != 0) {
            byteString = acatsClawback.unknownFields();
        }
        return acatsClawback.copy(z, str, str2, byteString);
    }

    public final AcatsClawback copy(boolean is_insufficient_funds, String clawback_amount, String moved_match_amount, ByteString unknownFields) {
        Intrinsics.checkNotNullParameter(clawback_amount, "clawback_amount");
        Intrinsics.checkNotNullParameter(moved_match_amount, "moved_match_amount");
        Intrinsics.checkNotNullParameter(unknownFields, "unknownFields");
        return new AcatsClawback(is_insufficient_funds, clawback_amount, moved_match_amount, unknownFields);
    }

    static {
        final FieldEncoding fieldEncoding = FieldEncoding.LENGTH_DELIMITED;
        final KClass orCreateKotlinClass = Reflection.getOrCreateKotlinClass(AcatsClawback.class);
        final Syntax syntax = Syntax.PROTO_3;
        ADAPTER = new ProtoAdapter<AcatsClawback>(fieldEncoding, orCreateKotlinClass, syntax) { // from class: nimbus.service.v1.AcatsClawback$Companion$ADAPTER$1
            @Override // com.squareup.wire.ProtoAdapter
            public int encodedSize(AcatsClawback value) {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(ProtoWriter writer, AcatsClawback value) throws IOException {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(ReverseProtoWriter writer, AcatsClawback value) throws IOException {
                Intrinsics.checkNotNullParameter(writer, "writer");
                Intrinsics.checkNotNullParameter(value, "value");
                writer.writeBytes(value.unknownFields());
                if (!Intrinsics.areEqual(value.getMoved_match_amount(), "")) {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public AcatsClawback redact(AcatsClawback value) {
                Intrinsics.checkNotNullParameter(value, "value");
                return AcatsClawback.copy$default(value, false, null, null, ByteString.EMPTY, 7, null);
            }

            @Override // com.squareup.wire.ProtoAdapter
            public AcatsClawback decode(ProtoReader reader) throws IOException {
                ...
                while (true) {
                    ...
                    if (iNextTag == -1) {
                        return new AcatsClawback(zBooleanValue, strDecode, strDecode2, reader.endMessageAndGetUnknownFields(jBeginMessage));
                    }
                    if (iNextTag == 1) {

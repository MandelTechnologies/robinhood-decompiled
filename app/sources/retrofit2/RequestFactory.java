    ...
    static final class Builder {
        ...
        private ParameterHandler<?> parseParameter(int i, Type type2, Annotation[] annotationArr, boolean z) {
            ...
            if (annotationArr != null) {
                ...
                for (Annotation annotation : annotationArr) {
                    ParameterHandler<?> parameterAnnotation = parseParameterAnnotation(i, type2, annotationArr, annotation);
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type2, Annotation[] annotationArr, Annotation annotation) {
            ...
            if (annotation instanceof Path) {
                ...
                return new ParameterHandler.Path(this.method, i, strValue, this.retrofit.stringConverter(type2, annotationArr), path.encoded());
            }
            if (annotation instanceof Query) {
                ...
                if (Iterable.class.isAssignableFrom(rawType)) {
                    ...
                    return new ParameterHandler.Query(strValue2, this.retrofit.stringConverter(Utils.getParameterUpperBound(0, (ParameterizedType) type2), annotationArr), zEncoded).iterable();
                }
                if (rawType.isArray()) {
                ...
                return new ParameterHandler.Query(strValue2, this.retrofit.stringConverter(type2, annotationArr), zEncoded);
            }
            if (annotation instanceof QueryName) {
                ...
                if (Iterable.class.isAssignableFrom(rawType2)) {
                    ...
                    return new ParameterHandler.QueryName(this.retrofit.stringConverter(Utils.getParameterUpperBound(0, (ParameterizedType) type2), annotationArr), zEncoded2).iterable();
                }
                if (rawType2.isArray()) {
                ...
                return new ParameterHandler.QueryName(this.retrofit.stringConverter(type2, annotationArr), zEncoded2);
            }
            ...
            if (annotation instanceof Header) {
                ...
                if (Iterable.class.isAssignableFrom(rawType4)) {
                    ...
                    return new ParameterHandler.Header(strValue3, this.retrofit.stringConverter(Utils.getParameterUpperBound(0, (ParameterizedType) type2), annotationArr), header.allowUnsafeNonAsciiValues()).iterable();
                }
                if (rawType4.isArray()) {
                ...
                return new ParameterHandler.Header(strValue3, this.retrofit.stringConverter(type2, annotationArr), header.allowUnsafeNonAsciiValues());
            }
            ...
            if (annotation instanceof Field) {
                ...
                if (Iterable.class.isAssignableFrom(rawType6)) {
                    ...
                    return new ParameterHandler.Field(strValue4, this.retrofit.stringConverter(Utils.getParameterUpperBound(0, (ParameterizedType) type2), annotationArr), zEncoded3).iterable();
                }
                if (rawType6.isArray()) {
                ...
                return new ParameterHandler.Field(strValue4, this.retrofit.stringConverter(type2, annotationArr), zEncoded3);
            }
            ...
            if (annotation instanceof Part) {
                ...
                Headers headersM3818of = Headers.m3818of("Content-Disposition", "form-data; name=\"" + strValue5 + "\"", "Content-Transfer-Encoding", part.encoding());
                if (Iterable.class.isAssignableFrom(rawType8)) {
                    if (!(type2 instanceof ParameterizedType)) {
                        throw Utils.parameterError(this.method, i, rawType8.getSimpleName() + " must include generic type (e.g., " + rawType8.getSimpleName() + "<String>)", new Object[0]);
                    }
                    ...
                    return new ParameterHandler.Part(this.method, i, headersM3818of, this.retrofit.requestBodyConverter(parameterUpperBound4, annotationArr, this.methodAnnotations)).iterable();
                }
                if (rawType8.isArray()) {
                    ...
                    return new ParameterHandler.Part(this.method, i, headersM3818of, this.retrofit.requestBodyConverter(clsBoxIfPrimitive, annotationArr, this.methodAnnotations)).array();
                }
                if (MultipartBody.Part.class.isAssignableFrom(rawType8)) {
                    throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                }
                return new ParameterHandler.Part(this.method, i, headersM3818of, this.retrofit.requestBodyConverter(type2, annotationArr, this.methodAnnotations));
            }
            if (annotation instanceof PartMap) {
                ...
                Type supertype4 = Utils.getSupertype(type2, rawType9, Map.class);
            ...
            if (annotation instanceof Body) {
                ...
                try {
                    Converter converterRequestBodyConverter = this.retrofit.requestBodyConverter(type2, annotationArr, this.methodAnnotations);
                    this.gotBody = true;

...
public abstract class Mont256 {
    ...
    /* renamed from: M */
    private static final long f7935M = 4294967295L;
    ...
    public static void reduce(int[] iArr, int[] iArr2, int i) {
        ...
        while (i2 < 8) {
            int i3 = iArr[c];
            long j = (i3 * i) & f7935M;
            long j2 = (((iArr2[c] & f7935M) * j) + (i3 & f7935M)) >>> 32;
            int i4 = 1;
            while (i4 < 8) {
                long j3 = j2 + ((iArr2[i4] & f7935M) * j) + (iArr[i4] & f7935M);
                iArr[i4 - 1] = (int) j3;
                j2 = j3 >>> 32;
                i4++;
                i2 = i2;
    ...
    public static void reduceXF(int[] iArr, int[] iArr2) {
        for (int i = 0; i < 8; i++) {
            long j = iArr[0] & f7935M;
            long j2 = j;
            for (int i2 = 1; i2 < 8; i2++) {
                long j3 = j2 + ((iArr2[i2] & f7935M) * j) + (iArr[i2] & f7935M);
                iArr[i2 - 1] = (int) j3;
                j2 = j3 >>> 32;
            }
            iArr[7] = (int) j2;

...
import org.bouncycastle.math.p525ec.endo.ECEndomorphism;
import org.bouncycastle.math.p525ec.endo.GLVEndomorphism;
...
public abstract class ECCurve {
    ...
    /* renamed from: a */
    protected ECFieldElement f7807a;

    /* renamed from: b */
    protected ECFieldElement f7808b;
    ...
    public static abstract class AbstractF2m extends ECCurve {
        ...
        @Override // org.bouncycastle.math.p525ec.ECCurve
        ...
        synchronized BigInteger[] getSi() {
            try {
                if (this.f7809si == null) {
                    this.f7809si = Tnaf.getSi(this);
                }
            } catch (Throwable th) {
                throw th;
            }
        ...
        public boolean isKoblitz() {
            if (this.order == null || this.cofactor == null || !this.f7808b.isOne()) {
                return false;
            }
            return this.f7807a.isZero() || this.f7807a.isOne();
        }
    ...
    public static abstract class AbstractFp extends ECCurve {
        ...
        protected ECPoint decompressPoint(int i, BigInteger bigInteger) {
            ECFieldElement eCFieldElementFromBigInteger = fromBigInteger(bigInteger);
            ECFieldElement eCFieldElementSqrt = eCFieldElementFromBigInteger.square().add(this.f7807a).multiply(eCFieldElementFromBigInteger).add(this.f7808b).sqrt();
    ...
    public static class F2m extends AbstractF2m {
        ...
        public F2m(int i, int i2, int i3, int i4, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
            ...
            this.f7807a = fromBigInteger(bigInteger);
            this.f7808b = fromBigInteger(bigInteger2);
            this.coord = 6;
        }
        ...
        protected F2m(int i, int i2, int i3, int i4, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger, BigInteger bigInteger2) {
            ...
            this.infinity = new ECPoint.F2m(this, null, null);
            this.f7807a = eCFieldElement;
            this.f7808b = eCFieldElement2;
            this.coord = 6;
        }
        ...
        protected ECCurve cloneCurve() {
            return new F2m(this.f7813m, this.f7810k1, this.f7811k2, this.f7812k3, this.f7807a, this.f7808b, this.order, this.cofactor);
        }

        @Override // org.bouncycastle.math.p525ec.ECCurve
        public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
            final int i3 = (this.f7813m + 63) >>> 6;
            final int[] iArr = isTrinomial() ? new int[]{this.f7810k1} : new int[]{this.f7810k1, this.f7811k2, this.f7812k3};
            final long[] jArr = new long[i2 * i3 * 2];
            int i4 = 0;
            for (int i5 = 0; i5 < i2; i5++) {
                ECPoint eCPoint = eCPointArr[i + i5];
                ((ECFieldElement.F2m) eCPoint.getRawXCoord()).f7818x.copyTo(jArr, i4);
                int i6 = i4 + i3;
                ((ECFieldElement.F2m) eCPoint.getRawYCoord()).f7818x.copyTo(jArr, i6);
                i4 = i6 + i3;
            }
            return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.ECCurve.F2m.1
                private ECPoint createPoint(long[] jArr2, long[] jArr3) {
                    return F2m.this.createRawPoint(new ECFieldElement.F2m(F2m.this.f7813m, iArr, new LongArray(jArr2)), new ECFieldElement.F2m(F2m.this.f7813m, iArr, new LongArray(jArr3)));
                }
                ...
                @Override // org.bouncycastle.math.p525ec.AbstractECLookupTable, org.bouncycastle.math.p525ec.ECLookupTable
        ...
        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.F2m(this.f7813m, this.f7810k1, this.f7811k2, this.f7812k3, bigInteger);
        }
        ...
        public boolean isTrinomial() {
            return this.f7811k2 == 0 && this.f7812k3 == 0;
        }
    ...
    public static class C47948Fp extends AbstractFp {
        private static final int FP_DEFAULT_COORDS = 4;
        ECPoint.C47951Fp infinity;
        ...
        public C47948Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3) {
            this(bigInteger, bigInteger2, bigInteger3, null, null);
        }

        public C47948Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, BigInteger bigInteger5) {
            super(bigInteger);
            this.f7814q = bigInteger;
            this.f7815r = ECFieldElement.C47949Fp.calculateResidue(bigInteger);
            this.infinity = new ECPoint.C47951Fp(this, null, null);
            this.f7807a = fromBigInteger(bigInteger2);
            this.f7808b = fromBigInteger(bigInteger3);
            this.order = bigInteger4;
            this.cofactor = bigInteger5;
            this.coord = 4;
        }

        protected C47948Fp(BigInteger bigInteger, BigInteger bigInteger2, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger3, BigInteger bigInteger4) {
            super(bigInteger);
            this.f7814q = bigInteger;
            this.f7815r = bigInteger2;
            this.infinity = new ECPoint.C47951Fp(this, null, null);
            this.f7807a = eCFieldElement;
            this.f7808b = eCFieldElement2;
            this.order = bigInteger3;
        ...
        @Override // org.bouncycastle.math.p525ec.ECCurve
        protected ECCurve cloneCurve() {
            return new C47948Fp(this.f7814q, this.f7815r, this.f7807a, this.f7808b, this.order, this.cofactor);
        }

        @Override // org.bouncycastle.math.p525ec.ECCurve
        protected ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
            return new ECPoint.C47951Fp(this, eCFieldElement, eCFieldElement2);
        }

        @Override // org.bouncycastle.math.p525ec.ECCurve
        protected ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
            return new ECPoint.C47951Fp(this, eCFieldElement, eCFieldElement2, eCFieldElementArr);
        }

        @Override // org.bouncycastle.math.p525ec.ECCurve
        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.C47949Fp(this.f7814q, this.f7815r, bigInteger);
        }

        @Override // org.bouncycastle.math.p525ec.ECCurve
        public int getFieldSize() {
            return this.f7814q.bitLength();
        }
        ...
        public ECPoint importPoint(ECPoint eCPoint) {
            ...
            return (this == eCPoint.getCurve() || getCoordinateSystem() != 2 || eCPoint.isInfinity() || !((coordinateSystem = eCPoint.getCurve().getCoordinateSystem()) == 2 || coordinateSystem == 3 || coordinateSystem == 4)) ? super.importPoint(eCPoint) : new ECPoint.C47951Fp(this, fromBigInteger(eCPoint.f7822x.toBigInteger()), fromBigInteger(eCPoint.f7823y.toBigInteger()), new ECFieldElement[]{fromBigInteger(eCPoint.f7824zs[0].toBigInteger())});
        }

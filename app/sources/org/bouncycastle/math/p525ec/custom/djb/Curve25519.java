...
public class Curve25519 extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f7827q = Curve25519FieldElement.f7831Q;
    ...
    public Curve25519() {
        ...
        this.f7807a = fromBigInteger(C_a);
        this.f7808b = fromBigInteger(C_b);
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy(((Curve25519FieldElement) eCPoint.getRawXCoord()).f7832x, 0, iArr, i3);
            Nat256.copy(((Curve25519FieldElement) eCPoint.getRawYCoord()).f7832x, 0, iArr, i3 + 8);
            i3 += 16;
        }

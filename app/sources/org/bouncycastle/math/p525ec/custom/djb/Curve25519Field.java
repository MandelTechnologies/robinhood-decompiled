...
public class Curve25519Field {
    ...
    /* renamed from: M */
    private static final long f7828M = 4294967295L;

    /* renamed from: P7 */
    private static final int f7830P7 = Integer.MAX_VALUE;
    private static final int PInv = 19;

    /* renamed from: P */
    static final int[] f7829P = {-19, -1, -1, -1, -1, -1, -1, Integer.MAX_VALUE};
    private static final int[] PExt = {361, 0, 0, 0, 0, 0, 0, 0, -19, -1, -1, -1, -1, -1, -1, 1073741823};

    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        Nat256.add(iArr, iArr2, iArr3);
        if (Nat256.gte(iArr3, f7829P)) {
            subPFrom(iArr3);
        }
    }
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        ...
        if (Nat256.gte(iArr2, f7829P)) {
            subPFrom(iArr2);
        }
    }

    private static int addPExtTo(int[] iArr) {
        long j = iArr[0] & f7828M;
        int[] iArr2 = PExt;
        long j2 = j + (iArr2[0] & f7828M);
        iArr[0] = (int) j2;
        long jIncAt = j2 >> 32;
        if (jIncAt != 0) {
            jIncAt = Nat.incAt(8, iArr, 1);
        }
        long j3 = jIncAt + ((iArr[8] & f7828M) - 19);
        iArr[8] = (int) j3;
        long jDecAt = j3 >> 32;
        if (jDecAt != 0) {
            jDecAt = Nat.decAt(15, iArr, 9);
        }
        long j4 = jDecAt + (iArr[15] & f7828M) + (f7828M & (iArr2[15] + 1));
        iArr[15] = (int) j4;
        return (int) (j4 >> 32);
    }

    private static int addPTo(int[] iArr) {
        long j = (iArr[0] & f7828M) - 19;
        iArr[0] = (int) j;
        long jDecAt = j >> 32;
        if (jDecAt != 0) {
            jDecAt = Nat.decAt(7, iArr, 1);
        }
        long j2 = jDecAt + (f7828M & iArr[7]) + 2147483648L;
        iArr[7] = (int) j2;
        return (int) (j2 >> 32);
    }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat256.add(iArr, f7829P, iArr2);
            Nat.shiftDownBit(8, iArr2, 0);
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f7829P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(8, iArr, f7829P) == 0);
    }
    ...
    private static int subPExtFrom(int[] iArr) {
        ...
        long j3 = jDecAt + (iArr[8] & f7828M) + 19;
        iArr[8] = (int) j3;
        long jIncAt = j3 >> 32;
        if (jIncAt != 0) {
            jIncAt = Nat.incAt(15, iArr, 9);
        }
        long j4 = jIncAt + ((iArr[15] & f7828M) - (f7828M & (iArr2[15] + 1)));
        iArr[15] = (int) j4;
        return (int) (j4 >> 32);
    }
    ...
    private static int subPFrom(int[] iArr) {
        ...
        long j2 = jIncAt + ((f7828M & iArr[7]) - 2147483648L);
        iArr[7] = (int) j2;
        return (int) (j2 >> 32);
    }

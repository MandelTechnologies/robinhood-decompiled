...
public class SecT233Field {
    ...
    public static long[] fromBigInteger(BigInteger bigInteger) {
        return Nat.fromBigInteger64(EnumC7081g.SDK_ASSET_ILLUSTRATION_INFOCARD_BANKSTATEMENT_VALUE, bigInteger);
    }
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j7 = j2 ^ (j2 << 37);
        long[] jArrCreateExt64 = Nat256.createExt64();
        int[] iArr = {32, 117, EnumC7081g.SDK_ASSET_ILLUSTRATION_MD_ERROR_ATTEMPT_2_NEW_VALUE};
        int i = 0;
        while (i < 3) {
            int i2 = iArr[i];
            int i3 = i2 >>> 6;

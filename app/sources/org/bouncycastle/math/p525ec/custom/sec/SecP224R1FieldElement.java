...
public class SecP224R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f7875Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000000000000000000001"));

    /* renamed from: x */
    protected int[] f7876x;

    public SecP224R1FieldElement() {
        this.f7876x = Nat224.create();
    }

    public SecP224R1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f7875Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP224R1FieldElement");
        }
        this.f7876x = SecP224R1Field.fromBigInteger(bigInteger);
    }
    ...
    /* renamed from: RM */
    private static void m3959RM(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int[] iArr5, int[] iArr6, int[] iArr7) {
    ...
    /* renamed from: RP */
    private static void m3960RP(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int[] iArr5) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            while (true) {
                i2--;
                if (i2 >= 0) {
                    m3961RS(iArr2, iArr3, iArr4, iArr5);
                }
            }
            m3959RM(iArr, iArrCreate, iArrCreate2, iArr2, iArr3, iArr4, iArr5);
        }
    }

    /* renamed from: RS */
    private static void m3961RS(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4) {
    ...
    private static boolean trySqrt(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        m3960RP(iArr, iArrCreate, iArrCreate2, iArrCreate3, iArr3);
        ...
        for (int i = 1; i < 96; i++) {
            ...
            m3961RS(iArrCreate, iArrCreate2, iArrCreate3, iArr3);
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.add(this.f7876x, ((SecP224R1FieldElement) eCFieldElement).f7876x, iArrCreate);
    ...
    public ECFieldElement addOne() {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.addOne(this.f7876x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.inv(((SecP224R1FieldElement) eCFieldElement).f7876x, iArrCreate);
        SecP224R1Field.multiply(iArrCreate, this.f7876x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP224R1FieldElement) {
            return Nat224.m3966eq(this.f7876x, ((SecP224R1FieldElement) obj).f7876x);
        }
        return false;
    }
    ...
    public int getFieldSize() {
        return f7875Q.bitLength();
    }

    public int hashCode() {
        return f7875Q.hashCode() ^ Arrays.hashCode(this.f7876x, 0, 7);
    }

    @Override // org.bouncycastle.math.p525ec.ECFieldElement
    public ECFieldElement invert() {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.inv(this.f7876x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.p525ec.ECFieldElement
    public boolean isOne() {
        return Nat224.isOne(this.f7876x);
    }

    @Override // org.bouncycastle.math.p525ec.ECFieldElement
    public boolean isZero() {
        return Nat224.isZero(this.f7876x);
    }

    @Override // org.bouncycastle.math.p525ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.multiply(this.f7876x, ((SecP224R1FieldElement) eCFieldElement).f7876x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement negate() {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.negate(this.f7876x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement sqrt() {
        ...
        int[] iArrRandom = Mod.random(SecP224R1Field.f7873P);
        int[] iArrCreate2 = Nat224.create();
        if (!isSquare(iArr)) {
            return null;
        }
        ...
        if (Nat224.m3966eq(iArr, iArrRandom)) {
    ...
    public ECFieldElement square() {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.square(this.f7876x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224R1Field.subtract(this.f7876x, ((SecP224R1FieldElement) eCFieldElement).f7876x, iArrCreate);
        return new SecP224R1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.p525ec.ECFieldElement
    public boolean testBitZero() {
        return Nat224.getBit(this.f7876x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p525ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f7876x);
    }
}

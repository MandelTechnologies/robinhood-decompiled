...
public class SecT163R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT163R1Curve() {
        super(EnumC7081g.SDK_ASSET_ILLUSTRATION_PAYWITHPLAID_LOGO_VALUE, 3, 6, 7);
        this.infinity = new SecT163R1Point(this, null, null);
        this.f7807a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("07B6882CAAEFA84F9554FF8428BD88E246D2782AE2")));
        this.f7808b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0713612DCDDCB40AAB946BDA29CA91F73AF958AFD9")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat192.copy64(((SecT163FieldElement) eCPoint.getRawXCoord()).f7899x, 0, jArr, i3);
            Nat192.copy64(((SecT163FieldElement) eCPoint.getRawYCoord()).f7899x, 0, jArr, i3 + 3);
            i3 += 6;
        }

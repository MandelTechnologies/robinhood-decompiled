...
public class SecP160K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160K1Point(this.curve, this.f7822x, this.f7823y.negate(), this.f7824zs);
    }
    ...
    public ECPoint twice() {
        ...
        int[] iArrCreate = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement.f7854x, iArrCreate);
        int[] iArrCreate2 = Nat160.create();
        SecP160R2Field.square(iArrCreate, iArrCreate2);
        int[] iArrCreate3 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement2.f7854x, iArrCreate3);
        SecP160R2Field.reduce32(Nat160.addBothTo(iArrCreate3, iArrCreate3, iArrCreate3), iArrCreate3);
        SecP160R2Field.multiply(iArrCreate, secP160R2FieldElement2.f7854x, iArrCreate);
        ...
        SecP160R2Field.square(iArrCreate3, secP160R2FieldElement4.f7854x);
        int[] iArr = secP160R2FieldElement4.f7854x;
        ...
        SecP160R2Field.subtract(iArrCreate, secP160R2FieldElement4.f7854x, secP160R2FieldElement5.f7854x);
        int[] iArr3 = secP160R2FieldElement5.f7854x;
        ...
        if (!secP160R2FieldElement3.isOne()) {
            int[] iArr5 = secP160R2FieldElement6.f7854x;
            SecP160R2Field.multiply(iArr5, secP160R2FieldElement3.f7854x, iArr5);
        }

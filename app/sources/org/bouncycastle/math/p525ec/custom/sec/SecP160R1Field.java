...
public class SecP160R1Field {
    ...
    /* renamed from: M */
    private static final long f7845M = 4294967295L;

    /* renamed from: P4 */
    private static final int f7847P4 = -1;
    private static final int PExt9 = -1;
    private static final int PInv = -2147483647;

    /* renamed from: P */
    static final int[] f7846P = {Integer.MAX_VALUE, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat160.add(iArr, iArr2, iArr3) != 0 || (iArr3[4] == -1 && Nat160.gte(iArr3, f7846P))) {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(5, iArr, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f7846P))) {
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(5, iArr2, Nat160.add(iArr, f7846P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f7846P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(5, iArr, f7846P) == 0);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        long j = iArr[5] & f7845M;
        long j2 = iArr[6] & f7845M;
        long j3 = iArr[7] & f7845M;
        long j4 = iArr[8] & f7845M;
        long j5 = iArr[9] & f7845M;
        long j6 = (iArr[0] & f7845M) + j + (j << 31);
        iArr2[0] = (int) j6;
        long j7 = (j6 >>> 32) + (iArr[1] & f7845M) + j2 + (j2 << 31);
        iArr2[1] = (int) j7;
        long j8 = (j7 >>> 32) + (iArr[2] & f7845M) + j3 + (j3 << 31);
        iArr2[2] = (int) j8;
        long j9 = (j8 >>> 32) + (iArr[3] & f7845M) + j4 + (j4 << 31);
        iArr2[3] = (int) j9;
        long j10 = (j9 >>> 32) + (f7845M & iArr[4]) + j5 + (j5 << 31);
        iArr2[4] = (int) j10;
        reduce32((int) (j10 >>> 32), iArr2);
    }

    public static void reduce32(int i, int[] iArr) {
        if ((i == 0 || Nat160.mulWordsAdd(PInv, i, iArr, 0) == 0) && !(iArr[4] == -1 && Nat160.gte(iArr, f7846P))) {
            return;
        }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(5, iArr, 0, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f7846P))) {
            Nat.addWordTo(5, PInv, iArr2);
        }
    }
}

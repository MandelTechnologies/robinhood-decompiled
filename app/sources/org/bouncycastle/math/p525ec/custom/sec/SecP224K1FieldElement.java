...
public class SecP224K1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: x */
    protected int[] f7870x;

    /* renamed from: Q */
    public static final BigInteger f7869Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFE56D"));
    private static final int[] PRECOMP_POW2 = {868209154, -587542221, 579297866, -1014948952, -1470801668, 514782679, -1897982644};

    public SecP224K1FieldElement() {
        this.f7870x = Nat224.create();
    }

    public SecP224K1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f7869Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP224K1FieldElement");
        }
        this.f7870x = SecP224K1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP224K1Field.add(this.f7870x, ((SecP224K1FieldElement) eCFieldElement).f7870x, iArrCreate);
    ...
    public ECFieldElement addOne() {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.addOne(this.f7870x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.inv(((SecP224K1FieldElement) eCFieldElement).f7870x, iArrCreate);
        SecP224K1Field.multiply(iArrCreate, this.f7870x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP224K1FieldElement) {
            return Nat224.m3966eq(this.f7870x, ((SecP224K1FieldElement) obj).f7870x);
        }
        return false;
    }
    ...
    public int getFieldSize() {
        return f7869Q.bitLength();
    }

    public int hashCode() {
        return f7869Q.hashCode() ^ Arrays.hashCode(this.f7870x, 0, 7);
    }

    @Override // org.bouncycastle.math.p525ec.ECFieldElement
    public ECFieldElement invert() {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.inv(this.f7870x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.p525ec.ECFieldElement
    public boolean isOne() {
        return Nat224.isOne(this.f7870x);
    }

    @Override // org.bouncycastle.math.p525ec.ECFieldElement
    public boolean isZero() {
        return Nat224.isZero(this.f7870x);
    }

    @Override // org.bouncycastle.math.p525ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.multiply(this.f7870x, ((SecP224K1FieldElement) eCFieldElement).f7870x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement negate() {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.negate(this.f7870x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.p525ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f7870x;
        ...
        if (Nat224.m3966eq(iArr, iArrCreate5)) {
    ...
    public ECFieldElement square() {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.square(this.f7870x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.subtract(this.f7870x, ((SecP224K1FieldElement) eCFieldElement).f7870x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }

    @Override // org.bouncycastle.math.p525ec.ECFieldElement
    public boolean testBitZero() {
        return Nat224.getBit(this.f7870x, 0) == 1;
    }

    @Override // org.bouncycastle.math.p525ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f7870x);
    }
}

...
public class SecP160R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP160R1FieldElement secP160R1FieldElement = (SecP160R1FieldElement) this.f7822x;
        SecP160R1FieldElement secP160R1FieldElement2 = (SecP160R1FieldElement) this.f7823y;
        ...
        SecP160R1FieldElement secP160R1FieldElement5 = (SecP160R1FieldElement) this.f7824zs[0];
        ...
        if (zIsOne) {
            iArr = secP160R1FieldElement3.f7849x;
            iArr2 = secP160R1FieldElement4.f7849x;
        } else {
            SecP160R1Field.square(secP160R1FieldElement5.f7849x, iArrCreate2);
            SecP160R1Field.multiply(iArrCreate2, secP160R1FieldElement3.f7849x, iArrCreate);
            SecP160R1Field.multiply(iArrCreate2, secP160R1FieldElement5.f7849x, iArrCreate2);
            SecP160R1Field.multiply(iArrCreate2, secP160R1FieldElement4.f7849x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP160R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP160R1FieldElement.f7849x;
            iArr4 = secP160R1FieldElement2.f7849x;
        } else {
            SecP160R1Field.square(secP160R1FieldElement6.f7849x, iArrCreate3);
            SecP160R1Field.multiply(iArrCreate3, secP160R1FieldElement.f7849x, iArrCreateExt);
            SecP160R1Field.multiply(iArrCreate3, secP160R1FieldElement6.f7849x, iArrCreate3);
            SecP160R1Field.multiply(iArrCreate3, secP160R1FieldElement2.f7849x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP160R1Field.square(iArrCreate, secP160R1FieldElement7.f7849x);
        int[] iArr5 = secP160R1FieldElement7.f7849x;
        ...
        SecP160R1Field.subtract(iArrCreate2, secP160R1FieldElement7.f7849x, secP160R1FieldElement8.f7849x);
        SecP160R1Field.multiplyAddToExt(secP160R1FieldElement8.f7849x, iArrCreate, iArrCreateExt);
        SecP160R1Field.reduce(iArrCreateExt, secP160R1FieldElement8.f7849x);
        SecP160R1FieldElement secP160R1FieldElement9 = new SecP160R1FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = secP160R1FieldElement9.f7849x;
            SecP160R1Field.multiply(iArr6, secP160R1FieldElement5.f7849x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP160R1FieldElement9.f7849x;
            SecP160R1Field.multiply(iArr7, secP160R1FieldElement6.f7849x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160R1Point(this.curve, this.f7822x, this.f7823y.negate(), this.f7824zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP160R1FieldElement secP160R1FieldElement = (SecP160R1FieldElement) this.f7823y;
        if (secP160R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP160R1FieldElement secP160R1FieldElement2 = (SecP160R1FieldElement) this.f7822x;
        SecP160R1FieldElement secP160R1FieldElement3 = (SecP160R1FieldElement) this.f7824zs[0];
        int[] iArrCreate = Nat160.create();
        int[] iArrCreate2 = Nat160.create();
        int[] iArrCreate3 = Nat160.create();
        SecP160R1Field.square(secP160R1FieldElement.f7849x, iArrCreate3);
        int[] iArrCreate4 = Nat160.create();
        SecP160R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP160R1FieldElement3.isOne();
        int[] iArr = secP160R1FieldElement3.f7849x;
        if (!zIsOne) {
            SecP160R1Field.square(iArr, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP160R1Field.subtract(secP160R1FieldElement2.f7849x, iArr, iArrCreate);
        SecP160R1Field.add(secP160R1FieldElement2.f7849x, iArr, iArrCreate2);
        ...
        SecP160R1Field.square(iArrCreate2, secP160R1FieldElement4.f7849x);
        int[] iArr2 = secP160R1FieldElement4.f7849x;
        SecP160R1Field.subtract(iArr2, iArrCreate3, iArr2);
        int[] iArr3 = secP160R1FieldElement4.f7849x;
        ...
        SecP160R1Field.subtract(iArrCreate3, secP160R1FieldElement4.f7849x, secP160R1FieldElement5.f7849x);
        int[] iArr4 = secP160R1FieldElement5.f7849x;
        SecP160R1Field.multiply(iArr4, iArrCreate2, iArr4);
        int[] iArr5 = secP160R1FieldElement5.f7849x;
        ...
        SecP160R1Field.twice(secP160R1FieldElement.f7849x, secP160R1FieldElement6.f7849x);
        if (!zIsOne) {
            int[] iArr6 = secP160R1FieldElement6.f7849x;
            SecP160R1Field.multiply(iArr6, secP160R1FieldElement3.f7849x, iArr6);
        }

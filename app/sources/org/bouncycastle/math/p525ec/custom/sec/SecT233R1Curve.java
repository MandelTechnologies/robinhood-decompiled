...
public class SecT233R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT233R1Curve() {
        super(EnumC7081g.SDK_ASSET_ILLUSTRATION_INFOCARD_BANKSTATEMENT_VALUE, 74, 0, 0);
        this.infinity = new SecT233R1Point(this, null, null);
        this.f7807a = fromBigInteger(BigInteger.valueOf(1L));
        this.f7808b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0066647EDE6C332C7F8C0923BB58213B333B20E9CE4281FE115F7D8F90AD")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat256.copy64(((SecT233FieldElement) eCPoint.getRawXCoord()).f7901x, 0, jArr, i3);
            Nat256.copy64(((SecT233FieldElement) eCPoint.getRawYCoord()).f7901x, 0, jArr, i3 + 4);
            i3 += 8;
        }

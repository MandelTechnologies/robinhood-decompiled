...
public class SecP128R1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f7838q = SecP128R1FieldElement.f7841Q;
    ...
    public SecP128R1Curve() {
        ...
        this.f7807a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFC")));
        this.f7808b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("E87579C11079F43DD824993C2CEE5ED3")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat128.copy(((SecP128R1FieldElement) eCPoint.getRawXCoord()).f7842x, 0, iArr, i3);
            Nat128.copy(((SecP128R1FieldElement) eCPoint.getRawYCoord()).f7842x, 0, iArr, i3 + 4);
            i3 += 8;
        }

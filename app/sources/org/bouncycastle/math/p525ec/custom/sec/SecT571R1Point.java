...
public class SecT571R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecT571FieldElement secT571FieldElement4 = (SecT571FieldElement) this.f7822x;
        ...
        SecT571FieldElement secT571FieldElement6 = (SecT571FieldElement) this.f7823y;
        SecT571FieldElement secT571FieldElement7 = (SecT571FieldElement) this.f7824zs[0];
        ...
        long[] jArrPrecompMultiplicand = secT571FieldElement7.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement7.f7905x);
        if (jArrPrecompMultiplicand == null) {
            jArr = secT571FieldElement5.f7905x;
            c = 0;
            jArr2 = secT571FieldElement8.f7905x;
        } else {
            c = 0;
            SecT571Field.multiplyPrecomp(secT571FieldElement5.f7905x, jArrPrecompMultiplicand, jArrCreate642);
            SecT571Field.multiplyPrecomp(secT571FieldElement8.f7905x, jArrPrecompMultiplicand, jArrCreate644);
            jArr = jArrCreate642;
            jArr2 = jArrCreate644;
        }
        long[] jArrPrecompMultiplicand2 = secT571FieldElement9.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement9.f7905x);
        long[] jArr4 = secT571FieldElement4.f7905x;
        if (jArrPrecompMultiplicand2 == null) {
            jArr3 = secT571FieldElement6.f7905x;
        } else {
            SecT571Field.multiplyPrecomp(jArr4, jArrPrecompMultiplicand2, jArrCreate64);
            SecT571Field.multiplyPrecomp(secT571FieldElement6.f7905x, jArrPrecompMultiplicand2, jArrCreate643);
            jArr4 = jArrCreate64;
            jArr3 = jArrCreate643;
        }
        ...
        if (secT571FieldElement5.isZero()) {
            ...
            SecT571Field.multiply(jArrCreate64, jArrCreate642, secT571FieldElement11.f7905x);
            ...
            SecT571Field.multiplyPrecomp(jArrCreate644, jArrPrecompMultiplicand3, secT571FieldElement12.f7905x);
            if (jArrPrecompMultiplicand2 != null) {
                long[] jArr5 = secT571FieldElement12.f7905x;
            ...
            SecT571Field.add(secT571FieldElement6.f7905x, secT571FieldElement7.f7905x, jArrCreate644);
            SecT571Field.multiplyAddToExt(jArrCreate644, secT571FieldElement12.f7905x, jArrCreateExt64);
            SecT571FieldElement secT571FieldElement13 = new SecT571FieldElement(jArrCreate644);
            SecT571Field.reduce(jArrCreateExt64, secT571FieldElement13.f7905x);
            if (jArrPrecompMultiplicand != null) {
                long[] jArr6 = secT571FieldElement12.f7905x;
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecT571FieldElement secT571FieldElement = (SecT571FieldElement) this.f7822x;
        if (secT571FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecT571FieldElement secT571FieldElement2 = (SecT571FieldElement) this.f7823y;
        SecT571FieldElement secT571FieldElement3 = (SecT571FieldElement) this.f7824zs[0];
        long[] jArrCreate64 = Nat576.create64();
        long[] jArrCreate642 = Nat576.create64();
        long[] jArrPrecompMultiplicand = secT571FieldElement3.isOne() ? null : SecT571Field.precompMultiplicand(secT571FieldElement3.f7905x);
        long[] jArr2 = secT571FieldElement2.f7905x;
        if (jArrPrecompMultiplicand == null) {
            jArr = secT571FieldElement3.f7905x;
        } else {
            SecT571Field.multiplyPrecomp(jArr2, jArrPrecompMultiplicand, jArrCreate64);
            SecT571Field.square(secT571FieldElement3.f7905x, jArrCreate642);
            jArr2 = jArrCreate64;
            jArr = jArrCreate642;
        }
        long[] jArrCreate643 = Nat576.create64();
        SecT571Field.square(secT571FieldElement2.f7905x, jArrCreate643);
        ...
        SecT571Field.square(jArrCreate643, secT571FieldElement4.f7905x);
        SecT571FieldElement secT571FieldElement5 = new SecT571FieldElement(jArrCreate643);
        if (jArrPrecompMultiplicand != null) {
            long[] jArr3 = secT571FieldElement5.f7905x;
            SecT571Field.multiply(jArr3, jArr, jArr3);
        }
        long[] jArr4 = secT571FieldElement.f7905x;
        if (jArrPrecompMultiplicand != null) {
        ...
        SecT571Field.addBothTo(secT571FieldElement4.f7905x, secT571FieldElement5.f7905x, jArrCreate642);
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        SecT571FieldElement secT571FieldElement4 = (SecT571FieldElement) this.f7823y;
        SecT571FieldElement secT571FieldElement5 = (SecT571FieldElement) this.f7824zs[0];
        SecT571FieldElement secT571FieldElement6 = (SecT571FieldElement) eCPoint.getRawYCoord();
        long[] jArrCreate64 = Nat576.create64();
        long[] jArrCreate642 = Nat576.create64();
        long[] jArrCreate643 = Nat576.create64();
        long[] jArrCreate644 = Nat576.create64();
        SecT571Field.square(secT571FieldElement.f7905x, jArrCreate64);
        SecT571Field.square(secT571FieldElement4.f7905x, jArrCreate642);
        SecT571Field.square(secT571FieldElement5.f7905x, jArrCreate643);
        SecT571Field.multiply(secT571FieldElement4.f7905x, secT571FieldElement5.f7905x, jArrCreate644);
        ...
        SecT571Field.multiplyPrecomp(secT571FieldElement6.f7905x, jArrPrecompMultiplicand, jArrCreate643);
        ...
        SecT571Field.multiplyPrecomp(secT571FieldElement2.f7905x, jArrPrecompMultiplicand, jArrCreate64);
        ...
        SecT571Field.square(jArrCreate643, secT571FieldElement7.f7905x);
        long[] jArr = secT571FieldElement7.f7905x;
        ...
        SecT571Field.multiply(jArrCreate643, jArrCreate642, secT571FieldElement8.f7905x);
        long[] jArr2 = secT571FieldElement8.f7905x;
        ...
        SecT571Field.add(jArrCreate643, jArrCreate642, secT571FieldElement9.f7905x);
        long[] jArr3 = secT571FieldElement9.f7905x;
        SecT571Field.square(jArr3, jArr3);
        Nat.zero64(18, jArrCreateExt64);
        SecT571Field.multiplyAddToExt(secT571FieldElement9.f7905x, jArrCreate644, jArrCreateExt64);
        SecT571Field.addOne(secT571FieldElement6.f7905x, jArrCreate644);
        SecT571Field.multiplyAddToExt(jArrCreate644, secT571FieldElement8.f7905x, jArrCreateExt64);
        SecT571Field.reduce(jArrCreateExt64, secT571FieldElement9.f7905x);

...
public class SecT163R2Curve extends ECCurve.AbstractF2m {
    ...
    public SecT163R2Curve() {
        ...
        this.f7807a = fromBigInteger(BigInteger.valueOf(1L));
        this.f7808b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("020A601907B8C953CA1481EB10512F78744A3205FD")));

...
public class SecP128R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP128R1FieldElement secP128R1FieldElement = (SecP128R1FieldElement) this.f7822x;
        SecP128R1FieldElement secP128R1FieldElement2 = (SecP128R1FieldElement) this.f7823y;
        ...
        SecP128R1FieldElement secP128R1FieldElement5 = (SecP128R1FieldElement) this.f7824zs[0];
        ...
        if (zIsOne) {
            iArr = secP128R1FieldElement3.f7842x;
            iArr2 = secP128R1FieldElement4.f7842x;
        } else {
            SecP128R1Field.square(secP128R1FieldElement5.f7842x, iArrCreate2);
            SecP128R1Field.multiply(iArrCreate2, secP128R1FieldElement3.f7842x, iArrCreate);
            SecP128R1Field.multiply(iArrCreate2, secP128R1FieldElement5.f7842x, iArrCreate2);
            SecP128R1Field.multiply(iArrCreate2, secP128R1FieldElement4.f7842x, iArrCreate2);
            iArr = iArrCreate;
            iArr2 = iArrCreate2;
        }
        boolean zIsOne2 = secP128R1FieldElement6.isOne();
        if (zIsOne2) {
            iArr3 = secP128R1FieldElement.f7842x;
            iArr4 = secP128R1FieldElement2.f7842x;
        } else {
            SecP128R1Field.square(secP128R1FieldElement6.f7842x, iArrCreate3);
            SecP128R1Field.multiply(iArrCreate3, secP128R1FieldElement.f7842x, iArrCreateExt);
            SecP128R1Field.multiply(iArrCreate3, secP128R1FieldElement6.f7842x, iArrCreate3);
            SecP128R1Field.multiply(iArrCreate3, secP128R1FieldElement2.f7842x, iArrCreate3);
            iArr3 = iArrCreateExt;
            iArr4 = iArrCreate3;
        }
        ...
        SecP128R1Field.square(iArrCreate, secP128R1FieldElement7.f7842x);
        int[] iArr5 = secP128R1FieldElement7.f7842x;
        ...
        SecP128R1Field.subtract(iArrCreate2, secP128R1FieldElement7.f7842x, secP128R1FieldElement8.f7842x);
        SecP128R1Field.multiplyAddToExt(secP128R1FieldElement8.f7842x, iArrCreate, iArrCreateExt);
        SecP128R1Field.reduce(iArrCreateExt, secP128R1FieldElement8.f7842x);
        SecP128R1FieldElement secP128R1FieldElement9 = new SecP128R1FieldElement(iArrCreate4);
        if (!zIsOne) {
            int[] iArr6 = secP128R1FieldElement9.f7842x;
            SecP128R1Field.multiply(iArr6, secP128R1FieldElement5.f7842x, iArr6);
        }
        if (!zIsOne2) {
            int[] iArr7 = secP128R1FieldElement9.f7842x;
            SecP128R1Field.multiply(iArr7, secP128R1FieldElement6.f7842x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP128R1Point(this.curve, this.f7822x, this.f7823y.negate(), this.f7824zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP128R1FieldElement secP128R1FieldElement = (SecP128R1FieldElement) this.f7823y;
        if (secP128R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP128R1FieldElement secP128R1FieldElement2 = (SecP128R1FieldElement) this.f7822x;
        SecP128R1FieldElement secP128R1FieldElement3 = (SecP128R1FieldElement) this.f7824zs[0];
        int[] iArrCreate = Nat128.create();
        int[] iArrCreate2 = Nat128.create();
        int[] iArrCreate3 = Nat128.create();
        SecP128R1Field.square(secP128R1FieldElement.f7842x, iArrCreate3);
        int[] iArrCreate4 = Nat128.create();
        SecP128R1Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP128R1FieldElement3.isOne();
        int[] iArr = secP128R1FieldElement3.f7842x;
        if (!zIsOne) {
            SecP128R1Field.square(iArr, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP128R1Field.subtract(secP128R1FieldElement2.f7842x, iArr, iArrCreate);
        SecP128R1Field.add(secP128R1FieldElement2.f7842x, iArr, iArrCreate2);
        ...
        SecP128R1Field.square(iArrCreate2, secP128R1FieldElement4.f7842x);
        int[] iArr2 = secP128R1FieldElement4.f7842x;
        SecP128R1Field.subtract(iArr2, iArrCreate3, iArr2);
        int[] iArr3 = secP128R1FieldElement4.f7842x;
        ...
        SecP128R1Field.subtract(iArrCreate3, secP128R1FieldElement4.f7842x, secP128R1FieldElement5.f7842x);
        int[] iArr4 = secP128R1FieldElement5.f7842x;
        SecP128R1Field.multiply(iArr4, iArrCreate2, iArr4);
        int[] iArr5 = secP128R1FieldElement5.f7842x;
        ...
        SecP128R1Field.twice(secP128R1FieldElement.f7842x, secP128R1FieldElement6.f7842x);
        if (!zIsOne) {
            int[] iArr6 = secP128R1FieldElement6.f7842x;
            SecP128R1Field.multiply(iArr6, secP128R1FieldElement3.f7842x, iArr6);
        }

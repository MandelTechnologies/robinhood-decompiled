...
public class SecP128R1Field {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(4, iArr, iArr2) != 0 || ((iArr2[3] >>> 1) >= 2147483646 && Nat128.gte(iArr2, f7840P))) {
            addPInvTo(iArr2);
        }
    }

    private static void addPInvTo(int[] iArr) {
        long j = (iArr[0] & f7839M) + 1;
        iArr[0] = (int) j;
        long j2 = j >> 32;
        if (j2 != 0) {
            long j3 = j2 + (iArr[1] & f7839M);
            iArr[1] = (int) j3;
            long j4 = (j3 >> 32) + (iArr[2] & f7839M);
            iArr[2] = (int) j4;
            j2 = j4 >> 32;
        }
        iArr[3] = (int) (j2 + (f7839M & iArr[3]) + 2);
    }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(4, iArr2, Nat128.add(iArr, f7840P, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f7840P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(4, iArr, f7840P) == 0);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        long j = iArr[0] & f7839M;
        long j2 = iArr[1] & f7839M;
        long j3 = iArr[2] & f7839M;
        long j4 = iArr[3] & f7839M;
        long j5 = iArr[4] & f7839M;
        long j6 = iArr[5] & f7839M;
        long j7 = iArr[6] & f7839M;
        long j8 = iArr[7] & f7839M;
        long j9 = j4 + j8;
        long j10 = j7 + (j8 << 1);
        long j11 = j6 + (j10 << 1);
        long j12 = j2 + j11;
    ...
    public static void reduce32(int i, int[] iArr) {
        while (i != 0) {
            long j = i & f7839M;
            long j2 = (iArr[0] & f7839M) + j;
            iArr[0] = (int) j2;
            long j3 = j2 >> 32;
            if (j3 != 0) {
                long j4 = j3 + (iArr[1] & f7839M);
                iArr[1] = (int) j4;
                long j5 = (j4 >> 32) + (iArr[2] & f7839M);
                iArr[2] = (int) j5;
                j3 = j5 >> 32;
            }
            long j6 = j3 + (f7839M & iArr[3]) + (j << 1);
            iArr[3] = (int) j6;
            i = (int) (j6 >> 32);
        }
        if ((iArr[3] >>> 1) < 2147483646 || !Nat128.gte(iArr, f7840P)) {
            return;
        }
        addPInvTo(iArr);
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(4, iArr, 0, iArr2) != 0 || ((iArr2[3] >>> 1) >= 2147483646 && Nat128.gte(iArr2, f7840P))) {
            addPInvTo(iArr2);
        }
    }
}

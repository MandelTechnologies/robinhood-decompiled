...
public abstract class WNafUtil {
    private static final int[] DEFAULT_WINDOW_SIZE_CUTOFFS = {13, 41, EnumC7081g.SDK_ASSET_ILLUSTRATION_DEPOSIT_SWITCH_VALUE, 337, 897, 2305};
            ...
            public PreCompInfo precompute(PreCompInfo preCompInfo) {
                ...
                if (z) {
                    if (eCPointArrResizeTable2 == null) {
                        ...
                        if (length2 < i3) {
                            eCPointArrResizeTable2 = WNafUtil.resizeTable(eCPointArrResizeTable2, i3);
                        }
                    }
                    while (length2 < i3) {

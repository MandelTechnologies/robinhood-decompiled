...
class Tnaf {
    ...
    public static BigInteger norm(byte b, ZTauElement zTauElement) {
        BigInteger bigIntegerSubtract;
        BigInteger bigInteger = zTauElement.f7825u;
        BigInteger bigIntegerMultiply = bigInteger.multiply(bigInteger);
        BigInteger bigIntegerMultiply2 = zTauElement.f7825u.multiply(zTauElement.f7826v);
        BigInteger bigInteger2 = zTauElement.f7826v;
    ...
    public static ZTauElement partModReduction(BigInteger bigInteger, int i, byte b, BigInteger[] bigIntegerArr, byte b2, byte b3) {
        ...
        return new ZTauElement(bigInteger.subtract(bigIntegerAdd.multiply(zTauElementRound.f7825u)).subtract(BigInteger.valueOf(2L).multiply(bigIntegerArr[1]).multiply(zTauElementRound.f7826v)), bigIntegerArr[1].multiply(zTauElementRound.f7825u).subtract(bigIntegerArr[0].multiply(zTauElementRound.f7826v)));
    }
    ...
    */
    ...
    public static byte[] tauAdicNaf(byte b, ZTauElement zTauElement) {
        ...
        BigInteger bigIntegerClearBit = zTauElement.f7825u;
        BigInteger bigInteger = zTauElement.f7826v;
        int i = 0;
        int i2 = 0;
        while (true) {
            BigInteger bigInteger2 = ECConstants.ZERO;
    ...
    public static byte[] tauAdicWNaf(byte b, ZTauElement zTauElement, byte b2, BigInteger bigInteger, BigInteger bigInteger2, ZTauElement[] zTauElementArr) {
        ...
        BigInteger bigIntegerAdd = zTauElement.f7825u;
        BigInteger bigIntegerAdd2 = zTauElement.f7826v;
        int i = 0;
        while (true) {
            ...
            if (bigIntegerAdd.testBit(0)) {
                ...
                if (z) {
                    bigIntegerAdd = bigIntegerAdd.subtract(zTauElementArr[bIntValue].f7825u);
                    bigIntegerAdd2 = bigIntegerAdd2.subtract(zTauElementArr[bIntValue].f7826v);
                } else {
                    bigIntegerAdd = bigIntegerAdd.add(zTauElementArr[bIntValue].f7825u);
                    bigIntegerAdd2 = bigIntegerAdd2.add(zTauElementArr[bIntValue].f7826v);
                }
            } else {
                bArr[i] = 0;
            }

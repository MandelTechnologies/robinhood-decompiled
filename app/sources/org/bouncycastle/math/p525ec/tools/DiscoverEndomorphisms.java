package org.bouncycastle.math.p525ec.tools;
...
public class DiscoverEndomorphisms {
    ...
    private static void printGLVTypeAParameters(X9ECParameters x9ECParameters, BigInteger bigInteger, ECFieldElement[] eCFieldElementArr) {
        ...
        printProperty(Constants.RequestParamsKeys.PACKAGE_NAME_KEY, eCFieldElement.toBigInteger().toString(16));
    ...
    private static void printScalarDecompositionParameters(BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        printProperty(DocUploadParentFragment.V2_TAG, "{ " + bigIntegerArrChooseShortest[0].toString(16) + ", " + bigIntegerArrChooseShortest[1].toString(16) + " }");

...
public abstract class ECPoint {
    ...
    /* renamed from: x */
    protected ECFieldElement f7822x;

    /* renamed from: y */
    protected ECFieldElement f7823y;

    /* renamed from: zs */
    protected ECFieldElement[] f7824zs;
    ...
    public static abstract class AbstractF2m extends ECPoint {
        ...
        protected boolean satisfiesCurveEquation() {
            ...
            ECFieldElement eCFieldElement4 = this.f7824zs[0];
            boolean zIsOne = eCFieldElement4.isOne();
            if (eCFieldElement.isZero()) {
                ECFieldElement eCFieldElementSquare = this.f7823y.square();
                if (!zIsOne) {
                    b = b.multiply(eCFieldElement4.square());
                }
                return eCFieldElementSquare.equals(b);
            }
            ECFieldElement eCFieldElement5 = this.f7823y;
        ...
        public AbstractF2m tau() {
            ...
            ECFieldElement eCFieldElement = this.f7822x;
            if (coordinateSystem == 0) {
                eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.square(), this.f7823y.square());
            } else {
                if (coordinateSystem != 1) {
                ...
                eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.square(), this.f7823y.square(), new ECFieldElement[]{this.f7824zs[0].square()});
            }
        ...
        public AbstractF2m tauPow(int i) {
            ...
            ECFieldElement eCFieldElement = this.f7822x;
            if (coordinateSystem == 0) {
                eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i), this.f7823y.squarePow(i));
            } else {
                if (coordinateSystem != 1) {
                    if (coordinateSystem != 5) {
                        if (coordinateSystem != 6) {
                ...
                eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i), this.f7823y.squarePow(i), new ECFieldElement[]{this.f7824zs[0].squarePow(i)});
            }
            return (AbstractF2m) eCPointCreateRawPoint;
        }
    }
    ...
    public static class F2m extends AbstractF2m {
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            ECCurve curve = getCurve();
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElementMultiply4 = this.f7822x;
            ECFieldElement eCFieldElement = eCPoint.f7822x;
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElement2 = this.f7823y;
                ECFieldElement eCFieldElement3 = eCPoint.f7823y;
            ...
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElement4 = this.f7823y;
                ECFieldElement eCFieldElementMultiply5 = this.f7824zs[0];
                ECFieldElement eCFieldElement5 = eCPoint.f7823y;
                ECFieldElement eCFieldElement6 = eCPoint.f7824zs[0];
            ...
            ECFieldElement eCFieldElement7 = this.f7823y;
            ECFieldElement eCFieldElement8 = this.f7824zs[0];
            ECFieldElement eCFieldElement9 = eCPoint.f7823y;
            ECFieldElement eCFieldElement10 = eCPoint.f7824zs[0];
        ...
        public ECPoint negate() {
            if (!isInfinity()) {
                ...
                if (!eCFieldElement.isZero()) {
                    int curveCoordinateSystem = getCurveCoordinateSystem();
                    if (curveCoordinateSystem == 0) {
                        return new F2m(this.curve, eCFieldElement, this.f7823y.add(eCFieldElement));
                    }
                    if (curveCoordinateSystem == 1) {
                        return new F2m(this.curve, eCFieldElement, this.f7823y.add(eCFieldElement), new ECFieldElement[]{this.f7824zs[0]});
                    }
                    if (curveCoordinateSystem == 5) {
                        return new F2m(this.curve, eCFieldElement, this.f7823y.addOne());
                    }
                    if (curveCoordinateSystem != 6) {
                        throw new IllegalStateException("unsupported coordinate system");
                    }
        ...
        public ECPoint twice() {
            ...
            ECCurve curve = getCurve();
            ECFieldElement eCFieldElementMultiply = this.f7822x;
            if (eCFieldElementMultiply.isZero()) {
                return curve.getInfinity();
            }
            int coordinateSystem = curve.getCoordinateSystem();
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElementAdd2 = this.f7823y.divide(eCFieldElementMultiply).add(eCFieldElementMultiply);
            ...
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElementMultiply2 = this.f7823y;
                ECFieldElement eCFieldElement = this.f7824zs[0];
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = eCPoint.f7822x;
            ECFieldElement eCFieldElement3 = eCPoint.f7824zs[0];
            if (eCFieldElement2.isZero() || !eCFieldElement3.isOne()) {
                return twice().add(eCPoint);
            }
            ECFieldElement eCFieldElement4 = this.f7823y;
            ECFieldElement eCFieldElement5 = this.f7824zs[0];
            ECFieldElement eCFieldElement6 = eCPoint.f7823y;
    ...
    public static class C47951Fp extends AbstractFp {
        C47951Fp(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
            super(eCCurve, eCFieldElement, eCFieldElement2);
        }

        C47951Fp(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
            super(eCCurve, eCFieldElement, eCFieldElement2, eCFieldElementArr);
        }
        ...
        */
        public ECPoint add(ECPoint eCPoint) {
            ...
            ECCurve curve = getCurve();
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElementMultiply2 = this.f7822x;
            ECFieldElement eCFieldElementMultiply3 = this.f7823y;
            ECFieldElement eCFieldElementMultiply4 = eCPoint.f7822x;
            ECFieldElement eCFieldElementMultiply5 = eCPoint.f7823y;
            if (coordinateSystem == 0) {
                ...
                return new C47951Fp(curve, eCFieldElementSubtract4, eCFieldElementDivide.multiply(eCFieldElementMultiply2.subtract(eCFieldElementSubtract4)).subtract(eCFieldElementMultiply3));
            }
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElementMultiply6 = this.f7824zs[0];
                ECFieldElement eCFieldElement2 = eCPoint.f7824zs[0];
                ...
                return new C47951Fp(curve, eCFieldElementSubtract6.multiply(eCFieldElementSubtract7), eCFieldElementMultiply8.subtract(eCFieldElementSubtract7).multiplyMinusProduct(eCFieldElementSubtract5, eCFieldElementMultiply3, eCFieldElementMultiply7), new ECFieldElement[]{eCFieldElementMultiply7.multiply(eCFieldElementMultiply6)});
            }
            if (coordinateSystem != 2 && coordinateSystem != 4) {
                throw new IllegalStateException("unsupported coordinate system");
            }
            ECFieldElement eCFieldElement3 = this.f7824zs[0];
            ECFieldElement eCFieldElement4 = eCPoint.f7824zs[0];
            ...
            if (zIsOne3 || !eCFieldElement3.equals(eCFieldElement4)) {
                ...
                if (eCFieldElementMultiply == eCFieldElementSubtract8) {
                    ...
                    return new C47951Fp(curve, eCFieldElementSubtract, eCFieldElementMultiplyMinusProduct, eCFieldElementArr);
                }
                eCFieldElementSubtract = eCFieldElementSubtract10;
            } else {
        ...
        @Override // org.bouncycastle.math.p525ec.ECPoint
        protected ECPoint detach() {
            return new C47951Fp(null, getAffineXCoord(), getAffineYCoord());
        }
        ...
        public ECPoint negate() {
            ...
            ECCurve curve = getCurve();
            return curve.getCoordinateSystem() != 0 ? new C47951Fp(curve, this.f7822x, this.f7823y.negate(), this.f7824zs) : new C47951Fp(curve, this.f7822x, this.f7823y.negate());
        }
        ...
        public ECPoint threeTimes() {
            if (!isInfinity()) {
                ECFieldElement eCFieldElement = this.f7823y;
                if (!eCFieldElement.isZero()) {
                    ECCurve curve = getCurve();
                    int coordinateSystem = curve.getCoordinateSystem();
                    if (coordinateSystem != 0) {
                    ...
                    ECFieldElement eCFieldElement2 = this.f7822x;
                    ...
                    return new C47951Fp(curve, eCFieldElementAdd2, eCFieldElement2.subtract(eCFieldElementAdd2).multiply(eCFieldElementSubtract2).subtract(eCFieldElement));
                }
            }
            return this;
        }
        ...
        public ECPoint timesPow2(int i) {
            ...
            ECCurve curve = getCurve();
            ECFieldElement eCFieldElementSubtract = this.f7823y;
            if (eCFieldElementSubtract.isZero()) {
                return curve.getInfinity();
            }
            int coordinateSystem = curve.getCoordinateSystem();
            ...
            if (coordinateSystem == 0) {
                ...
                return new C47951Fp(curve, eCFieldElementMultiply.multiply(eCFieldElementSquare2), eCFieldElementSubtract.multiply(eCFieldElementSquare2.multiply(eCFieldElementInvert)));
            }
            if (coordinateSystem == 1) {
                return new C47951Fp(curve, eCFieldElementMultiply.multiply(eCFieldElementFromBigInteger), eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger.multiply(eCFieldElementFromBigInteger.square())});
            }
            if (coordinateSystem == 2) {
                return new C47951Fp(curve, eCFieldElementMultiply, eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger});
            }
            if (coordinateSystem == 4) {
                return new C47951Fp(curve, eCFieldElementMultiply, eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger, a});
            }
            throw new IllegalStateException("unsupported coordinate system");
        }
        ...
        public ECPoint twice() {
            ...
            if (coordinateSystem == 0) {
                ...
                return new C47951Fp(curve, eCFieldElementSubtract2, eCFieldElementDivide.multiply(eCFieldElement2.subtract(eCFieldElementSubtract2)).subtract(eCFieldElement));
            }
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElement3 = this.f7824zs[0];
                ...
                return new C47951Fp(curve, eCFieldElementMultiply3, eCFieldElementFour.subtract(eCFieldElementSubtract3).multiply(eCFieldElementAdd).subtract(two(eCFieldElementTwo2.square())), new ECFieldElement[]{two(zIsOne ? two(eCFieldElementTwo2) : eCFieldElementTwo.square()).multiply(eCFieldElementMultiply2)});
            }
            if (coordinateSystem != 2) {
                if (coordinateSystem == 4) {
            ...
            return new C47951Fp(curve, eCFieldElementSubtract4, eCFieldElementSubtract5, new ECFieldElement[]{eCFieldElementTwo3});
        }

        protected C47951Fp twiceJacobianModified(boolean z) {
            ECFieldElement eCFieldElement = this.f7822x;
            ECFieldElement eCFieldElement2 = this.f7823y;
            ECFieldElement eCFieldElement3 = this.f7824zs[0];
            ...
            return new C47951Fp(getCurve(), eCFieldElementSubtract, eCFieldElementSubtract2, new ECFieldElement[]{eCFieldElementTwo, eCFieldElementTwo4});
        }
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = this.f7822x;
            ECFieldElement eCFieldElement3 = eCPoint.f7822x;
            ECFieldElement eCFieldElement4 = eCPoint.f7823y;
            ...
            return new C47951Fp(curve, eCFieldElementAdd, eCFieldElement2.subtract(eCFieldElementAdd).multiply(eCFieldElementSubtract4).subtract(eCFieldElement));
        }
    ...
    protected ECPoint(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
        ...
        this.curve = eCCurve;
        this.f7822x = eCFieldElement;
        this.f7823y = eCFieldElement2;
        this.f7824zs = eCFieldElementArr;
    }
    ...
    public int hashCode() {
        ...
        ECPoint eCPointNormalize = normalize();
        return (i ^ (eCPointNormalize.getXCoord().hashCode() * 17)) ^ (eCPointNormalize.getYCoord().hashCode() * EnumC7081g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE);
    }
    ...
    boolean implIsValid(final boolean z, final boolean z2) {
        ...
        return !((ValidityPrecompInfo) getCurve().precompute(this, "bc_validity", new PreCompCallback() { // from class: org.bouncycastle.math.ec.ECPoint.1
            @Override // org.bouncycastle.math.p525ec.PreCompCallback
    ...
    public boolean isInfinity() {
        if (this.f7822x == null || this.f7823y == null) {
            return true;
        }
        ECFieldElement[] eCFieldElementArr = this.f7824zs;
    ...
    public boolean isNormalized() {
        int curveCoordinateSystem = getCurveCoordinateSystem();
        return curveCoordinateSystem == 0 || curveCoordinateSystem == 5 || isInfinity() || this.f7824zs[0].isOne();
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.f7824zs.length; i++) {
            stringBuffer.append(',');
            stringBuffer.append(this.f7824zs[i]);
        }
        stringBuffer.append(')');

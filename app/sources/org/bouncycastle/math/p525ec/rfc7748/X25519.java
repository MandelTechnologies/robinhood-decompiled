package org.bouncycastle.math.p525ec.rfc7748;

import com.plaid.internal.EnumC7081g;
import java.security.SecureRandom;
import org.bouncycastle.math.p525ec.rfc8032.Ed25519;
...
public abstract class X25519 {
    ...
    private static class C47990F extends X25519Field {
        private C47990F() {
        }
    }
    ...
    public static void scalarMult(byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, int i3) {
        ...
        int i4 = EnumC7081g.SDK_ASSET_ILLUSTRATION_SECOND_DEPOSIT_CIRCLE_VALUE;
        int i5 = 1;
        while (true) {

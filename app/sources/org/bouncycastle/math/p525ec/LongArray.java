...
class LongArray implements Cloneable {
    ...
    private static long interleave3_13to65(int i) {
        return (INTERLEAVE5_TABLE[i & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE] & 4294967295L) | ((r0[i >>> 7] & 4294967295L) << 35);
    }

    private static long interleave3_21to63(int i) {
        return (INTERLEAVE3_TABLE[i & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE] & 4294967295L) | ((r0[i >>> 14] & 4294967295L) << 42) | ((r0[(i >>> 7) & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE] & 4294967295L) << 21);
    }

...
public class Fingerprint {
    ...
    public Fingerprint(byte[] bArr) {
        this(bArr, EnumC7081g.SDK_ASSET_ILLUSTRATION_SECURE_TOKENIZATION_VALUE);
    }
    ...
    public static byte[] calculateFingerprint(byte[] bArr) {
        return calculateFingerprint(bArr, EnumC7081g.SDK_ASSET_ILLUSTRATION_SECURE_TOKENIZATION_VALUE);
    }
    ...
    public static byte[] calculateFingerprintSHA512_160(byte[] bArr) {
        SHA512tDigest sHA512tDigest = new SHA512tDigest(EnumC7081g.SDK_ASSET_ILLUSTRATION_SECURE_TOKENIZATION_VALUE);

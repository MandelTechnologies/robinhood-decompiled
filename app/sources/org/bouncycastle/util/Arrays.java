...
public final class Arrays {
    ...
    public static int hashCode(byte[] bArr) {
        ...
        while (true) {
            ...
            i = (i * EnumC7081g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ bArr[length];
        }
    }
    ...
    public static int hashCode(byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            i3 = (i3 * EnumC7081g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ bArr[i + i2];
        }
    }
    ...
    public static int hashCode(char[] cArr) {
        ...
        while (true) {
            ...
            i = (i * EnumC7081g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ cArr[length];
        }
    }
    ...
    public static int hashCode(int[] iArr) {
        ...
        while (true) {
            ...
            i = (i * EnumC7081g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ iArr[length];
        }
    }
    ...
    public static int hashCode(int[] iArr, int i, int i2) {
        ...
        while (true) {
            ...
            i3 = (i3 * EnumC7081g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ iArr[i + i2];
        }
    }
    ...
    public static int hashCode(long[] jArr) {
        ...
        while (true) {
            ...
            long j = jArr[length];
            i = (((i * EnumC7081g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ ((int) j)) * EnumC7081g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ ((int) (j >>> 32));
        }
    }
    ...
    public static int hashCode(long[] jArr, int i, int i2) {
        ...
        while (true) {
            ...
            long j = jArr[i + i2];
            i3 = (((i3 * EnumC7081g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ ((int) j)) * EnumC7081g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ ((int) (j >>> 32));
        }
    }
    ...
    public static int hashCode(Object[] objArr) {
        ...
        while (true) {
            ...
            iHashCode = (iHashCode * EnumC7081g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ Objects.hashCode(objArr[length]);
        }
    }
    ...
    public static int hashCode(short[] sArr) {
        ...
        while (true) {
            ...
            i = (i * EnumC7081g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ (sArr[length] & 255);
        }
    }
    ...
    public static int hashCode(int[][] iArr) {
        ...
        for (int i = 0; i != iArr.length; i++) {
            iHashCode = (iHashCode * EnumC7081g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) + hashCode(iArr[i]);
        }
        return iHashCode;
    }
    ...
    public static int hashCode(short[][] sArr) {
        ...
        for (int i = 0; i != sArr.length; i++) {
            iHashCode = (iHashCode * EnumC7081g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) + hashCode(sArr[i]);
        }
        return iHashCode;
    }

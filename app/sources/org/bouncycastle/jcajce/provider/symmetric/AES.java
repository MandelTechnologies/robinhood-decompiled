...
import org.bouncycastle.asn1.p515bc.BCObjectIdentifiers;
...
public final class AES {
    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
        ...
        protected AlgorithmParameters engineGenerateParameters() throws InvalidParameterSpecException {
            ...
            try {
                AlgorithmParameters algorithmParametersCreateParametersInstance = createParametersInstance(BiometricChangeManager.ALGORITHM);
    ...
    public static class KeyFactory extends BaseSecretKeyFactory {
        public KeyFactory() {
            super(BiometricChangeManager.ALGORITHM, null);
        }
    }
    ...
    public static class KeyGen extends BaseKeyGenerator {
        ...
        public KeyGen(int i) {
            super(BiometricChangeManager.ALGORITHM, i, new CipherKeyGenerator());
        }
    }
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.2", BiometricChangeManager.ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.22", BiometricChangeManager.ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.42", BiometricChangeManager.ALGORITHM);
            StringBuilder sb2 = new StringBuilder();
            sb2.append("Alg.Alias.AlgorithmParameters.");
            ASN1ObjectIdentifier aSN1ObjectIdentifier = NISTObjectIdentifiers.id_aes128_CBC;
            sb2.append(aSN1ObjectIdentifier);
            configurableProvider.addAlgorithm(sb2.toString(), BiometricChangeManager.ALGORITHM);
            ...
            configurableProvider.addAlgorithm(sb3.toString(), BiometricChangeManager.ALGORITHM);
            ...
            configurableProvider.addAlgorithm(sb4.toString(), BiometricChangeManager.ALGORITHM);
            ...
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameterGenerator.2.16.840.1.101.3.4.2", BiometricChangeManager.ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameterGenerator.2.16.840.1.101.3.4.22", BiometricChangeManager.ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameterGenerator.2.16.840.1.101.3.4.42", BiometricChangeManager.ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameterGenerator." + aSN1ObjectIdentifier, BiometricChangeManager.ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameterGenerator." + aSN1ObjectIdentifier2, BiometricChangeManager.ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.AlgorithmParameterGenerator." + aSN1ObjectIdentifier3, BiometricChangeManager.ALGORITHM);
            ...
            configurableProvider.addAlgorithm("Alg.Alias.Cipher.2.16.840.1.101.3.4.2", BiometricChangeManager.ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.Cipher.2.16.840.1.101.3.4.22", BiometricChangeManager.ALGORITHM);
            configurableProvider.addAlgorithm("Alg.Alias.Cipher.2.16.840.1.101.3.4.42", BiometricChangeManager.ALGORITHM);
            ...
            addGMacAlgorithm(configurableProvider, BiometricChangeManager.ALGORITHM, str + "$AESGMAC", str + "$KeyGen128");
            addPoly1305Algorithm(configurableProvider, BiometricChangeManager.ALGORITHM, str + "$Poly1305", str + "$Poly1305KeyGen");
        }
    }

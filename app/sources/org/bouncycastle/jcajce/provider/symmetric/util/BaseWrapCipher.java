...
public abstract class BaseWrapCipher extends CipherSpi implements PBE {
    ...
    protected byte[] engineGetIV() {
        return Arrays.clone(this.f7765iv);
    }
    ...
    protected AlgorithmParameters engineGetParameters() throws InvalidParameterSpecException {
        if (this.engineParams == null && this.f7765iv != null) {
            ...
            try {
                ...
                algorithmParametersCreateParametersInstance.init(new IvParameterSpec(this.f7765iv));
            } catch (Exception e) {
    ...
    protected void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if ((keyParameter instanceof KeyParameter) && (i2 = this.ivSize) != 0 && (i == 3 || i == 1)) {
            ...
            keyParameter = new ParametersWithIV(keyParameter, this.f7765iv);
        }
    ...
    @Override // javax.crypto.CipherSpi
    protected int engineUpdate(byte[] bArr, int i, int i2, byte[] bArr2, int i3) throws IOException, ShortBufferException {
        ErasableOutputStream erasableOutputStream = this.wrapStream;
        if (erasableOutputStream == null) {
            throw new IllegalStateException("not supported in a wrapping mode");
        }

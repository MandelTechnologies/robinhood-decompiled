                        ...
                        if (params.containsKey(numValueOf)) {
                            ...
                            if (i2 == 1024) {
                                ...
                                if (Properties.isOverrideSet("org.bouncycastle.dsa.FIPS186-2for1024bits")) {
                                    ...
                                    dSAParametersGenerator.init(new DSAParameterGenerationParameters(1024, EnumC7081g.SDK_ASSET_ILLUSTRATION_SECURE_TOKENIZATION_VALUE, defaultCertainty, this.random));

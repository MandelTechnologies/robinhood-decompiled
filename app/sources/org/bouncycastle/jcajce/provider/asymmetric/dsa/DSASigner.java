...
public class DSASigner extends SignatureSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
    ...
    private DSAEncoding f10840encoding = StandardDSAEncoding.INSTANCE;
    ...
    protected byte[] engineSign() throws SignatureException {
        ...
        try {
            ...
            return this.f10840encoding.encode(this.signer.getOrder(), bigIntegerArrGenerateSignature[0], bigIntegerArrGenerateSignature[1]);
        } catch (Exception e) {
    ...
    protected boolean engineVerify(byte[] bArr) throws SignatureException {
        ...
        try {
            BigInteger[] bigIntegerArrDecode = this.f10840encoding.decode(this.signer.getOrder(), bArr);

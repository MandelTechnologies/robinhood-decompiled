...
class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
    ...
    private X509CertificateInternal getInternalCertificate() throws IOException {
        ...
        synchronized (this.cacheLock) {
            try {
                ...
                try {
                    encoded = this.f7757c.getEncoded(ASN1Encoding.DER);
                    x509CertificateEncodingException = null;
                } catch (IOException e) {
                    encoded = null;
                    x509CertificateEncodingException = new X509CertificateEncodingException(e);
                }
                X509CertificateInternal x509CertificateInternal3 = new X509CertificateInternal(this.bcHelper, this.f7757c, this.basicConstraints, this.keyUsage, this.sigAlgName, this.sigAlgParams, encoded, x509CertificateEncodingException);
                synchronized (this.cacheLock) {
                    try {
    ...
    public boolean equals(Object obj) throws IOException {
        ...
        if (obj instanceof X509CertificateObject) {
            ...
            } else if ((this.internalCertificateValue == null || x509CertificateObject.internalCertificateValue == null) && (signature = this.f7757c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CertificateObject.f7757c.getSignature())) {
                return false;
            }

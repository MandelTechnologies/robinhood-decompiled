...
public abstract class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public static class C47901EC extends KeyPairGeneratorSpi {
        ...
        static {
            ...
            ecParameters.put(Integers.valueOf(HttpStatusCode.DOWNTIME_ERROR), new ECGenParameterSpec("P-521"));
        }
        ...
        public C47901EC(String str, ProviderConfiguration providerConfiguration) {
            super(str);
            this.engine = new ECKeyPairGenerator();
            this.ecParams = null;
            this.strength = 239;
    ...
    public static class ECDH extends C47901EC {
        public ECDH() {
            super("ECDH", BouncyCastleProvider.CONFIGURATION);
        }
    }

    public static class ECDHC extends C47901EC {
        public ECDHC() {
            super("ECDHC", BouncyCastleProvider.CONFIGURATION);
        }
    }

    public static class ECDSA extends C47901EC {
        public ECDSA() {
            super("ECDSA", BouncyCastleProvider.CONFIGURATION);
        }
    }

    public static class ECMQV extends C47901EC {
        public ECMQV() {

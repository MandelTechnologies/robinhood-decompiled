...
public abstract class BaseAgreementSpi extends KeyAgreementSpi {
    ...
    static {
        ...
        map2.put(BiometricChangeManager.ALGORITHM, numValueOf4);
        ...
        map2.put(aSN1ObjectIdentifier12.getId(), Integers.valueOf(EnumC7081g.SDK_ASSET_ILLUSTRATION_SECURE_TOKENIZATION_VALUE));
        ...
        map.put(BiometricChangeManager.ALGORITHM, aSN1ObjectIdentifier);
        ...
        map3.put(aSN1ObjectIdentifier2.getId(), BiometricChangeManager.ALGORITHM);
        map3.put(aSN1ObjectIdentifier3.getId(), BiometricChangeManager.ALGORITHM);
        map3.put(aSN1ObjectIdentifier3.getId(), BiometricChangeManager.ALGORITHM);
        hashtable.put("DESEDE", aSN1ObjectIdentifier9);
        hashtable.put(BiometricChangeManager.ALGORITHM, aSN1ObjectIdentifier);

...
public abstract class DSABase extends SignatureSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
    ...
    protected byte[] engineSign() throws SignatureException {
        ...
        try {
            ...
            return this.f10841encoding.encode(this.signer.getOrder(), bigIntegerArrGenerateSignature[0], bigIntegerArrGenerateSignature[1]);
        } catch (Exception e) {
    ...
    protected boolean engineVerify(byte[] bArr) throws SignatureException {
        ...
        try {
            BigInteger[] bigIntegerArrDecode = this.f10841encoding.decode(this.signer.getOrder(), bArr);

...
import org.bouncycastle.asn1.p518x9.ECNamedCurveTable;
import org.bouncycastle.asn1.p518x9.X962Parameters;
import org.bouncycastle.asn1.p518x9.X9ECParameters;
import org.bouncycastle.crypto.p519ec.CustomNamedCurves;
...
public class EC5Util {
    ...
    static {
        ...
        customCurves.put(new ECCurve.C47948Fp(curve.getField().getCharacteristic(), curve.getA().toBigInteger(), curve.getB().toBigInteger(), curve.getOrder(), curve.getCofactor()), curve);
    }
    ...
    public static ECCurve convertCurve(EllipticCurve ellipticCurve) {
        ...
        if (field instanceof ECFieldFp) {
            ECCurve.C47948Fp c47948Fp = new ECCurve.C47948Fp(((ECFieldFp) field).getP(), a, b);
            return customCurves.containsKey(c47948Fp) ? (ECCurve) customCurves.get(c47948Fp) : c47948Fp;
        }
    ...
    public static ECPoint convertPoint(org.bouncycastle.math.p525ec.ECPoint eCPoint) {
        org.bouncycastle.math.p525ec.ECPoint eCPointNormalize = eCPoint.normalize();
        return new ECPoint(eCPointNormalize.getAffineXCoord().toBigInteger(), eCPointNormalize.getAffineYCoord().toBigInteger());
    }

    public static org.bouncycastle.math.p525ec.ECPoint convertPoint(ECParameterSpec eCParameterSpec, ECPoint eCPoint) {
        return convertPoint(convertCurve(eCParameterSpec.getCurve()), eCPoint);
    }

    public static org.bouncycastle.math.p525ec.ECPoint convertPoint(ECCurve eCCurve, ECPoint eCPoint) {
    ...
    public static org.bouncycastle.jce.spec.ECParameterSpec convertSpec(ECParameterSpec eCParameterSpec) {
        ...
        org.bouncycastle.math.p525ec.ECPoint eCPointConvertPoint = convertPoint(eCCurveConvertCurve, eCParameterSpec.getGenerator());

...
import org.bouncycastle.asn1.p515bc.EncryptedObjectStoreData;
import org.bouncycastle.asn1.p515bc.EncryptedPrivateKeyData;
import org.bouncycastle.asn1.p515bc.EncryptedSecretKeyData;
import org.bouncycastle.asn1.p515bc.ObjectData;
import org.bouncycastle.asn1.p515bc.ObjectDataSequence;
import org.bouncycastle.asn1.p515bc.ObjectStore;
import org.bouncycastle.asn1.p515bc.ObjectStoreData;
import org.bouncycastle.asn1.p515bc.ObjectStoreIntegrityCheck;
import org.bouncycastle.asn1.p515bc.PbkdMacIntegrityCheck;
import org.bouncycastle.asn1.p515bc.SecretKeyData;
import org.bouncycastle.asn1.p515bc.SignatureCheck;
...
class BcFKSKeyStoreSpi extends KeyStoreSpi {
    ...
    private static class SharedKeyStoreSpi extends BcFKSKeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
        ...
        private final Map<String, byte[]> f10845cache;
        ...
        public Key engineGetKey(String str, char[] cArr) throws InvalidKeySpecException, NoSuchAlgorithmException, UnrecoverableKeyException {
            try {
                ...
                if (!this.f10845cache.containsKey(str) || Arrays.constantTimeAreEqual(this.f10845cache.get(str), bArrCalculateMac)) {
                    Key keyEngineGetKey = super.engineGetKey(str, cArr);
                    if (keyEngineGetKey != null && !this.f10845cache.containsKey(str)) {
                        this.f10845cache.put(str, bArrCalculateMac);
                    }
    ...
    private Cipher createCipher(String str, byte[] bArr) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException {
        ...
        cipherCreateCipher.init(1, new SecretKeySpec(bArr, BiometricChangeManager.ALGORITHM));
    ...
    private byte[] decryptData(String str, AlgorithmIdentifier algorithmIdentifier, char[] cArr, byte[] bArr) throws IOException, InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        try {
            ...
            cipherCreateCipher.init(2, new SecretKeySpec(generateKey(keyDerivationFunc, str, cArr, 32), BiometricChangeManager.ALGORITHM), algorithmParametersCreateAlgorithmParameters);
    ...
    public void engineSetKeyEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) throws KeyStoreException {
        ...
        if (key instanceof PrivateKey) {
            ...
            try {
                ...
                if (upperCase.indexOf(BiometricChangeManager.ALGORITHM) > -1) {

...
public class PKCS12KeyStoreSpi extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore {
    ...
    private class CertId {
        ...
        CertId(PublicKey publicKey) {
            this.f7758id = PKCS12KeyStoreSpi.this.createSubjectKeyId(publicKey).getKeyIdentifier();
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof CertId) {
                return Arrays.areEqual(this.f7758id, ((CertId) obj).f7758id);
            }
            return false;
        }

        public int hashCode() {
            return Arrays.hashCode(this.f7758id);
        }
    }
    ...
    protected byte[] cryptData(boolean z, AlgorithmIdentifier algorithmIdentifier, char[] cArr, boolean z2, byte[] bArr) throws InvalidKeyException, IOException, InvalidAlgorithmParameterException {
        ...
        int i = z ? 1 : 2;
        if (algorithm.m3856on(PKCSObjectIdentifiers.pkcs_12PbeIds)) {
    ...
    /* JADX WARN: Type inference failed for: r6v2, types: [org.bouncycastle.asn1.ASN1OctetString] */
    ...
    */
    public void engineLoad(InputStream inputStream, char[] cArr) throws NoSuchAlgorithmException, IOException, InvalidKeyException, CertificateException, InvalidAlgorithmParameterException {
        char[] cArr2;
        boolean z;
        boolean z2;
        int i;
        ...
        try {
                ...
                try {
                    ...
                    if (authSafe.getContentType().equals((ASN1Primitive) PKCSObjectIdentifiers.data)) {
                        ...
                        while (i5 != contentInfo.length) {
                            if (contentInfo[i5].getContentType().equals((ASN1Primitive) PKCSObjectIdentifiers.data)) {
                                        ...
                                        if (safeBag.getBagAttributes() != null) {
                                            ...
                                            while (objects.hasMoreElements()) {
                                                ...
                                                if (aSN1Set.size() > 0) {
                                                    ...
                                                    aSN1OctetString2 = aSN1Primitive2;
                                                ...
                                                if (aSN1ObjectIdentifier.equals((ASN1Primitive) PKCSObjectIdentifiers.pkcs_9_at_friendlyName)) {
                                                    string3 = ((ASN1BMPString) aSN1OctetString2).getString();
                                ...
                                boolean z6 = z;
                                if (contentInfo[i5].getContentType().equals((ASN1Primitive) PKCSObjectIdentifiers.encryptedData)) {
                                    EncryptedData encryptedData = EncryptedData.getInstance(contentInfo[i5].getContent());
                                    char[] cArr3 = cArr2;
                                    z3 = z6;
                                    cArr2 = cArr3;
                                    ASN1Sequence aSN1Sequence4 = ASN1Sequence.getInstance(cryptData(false, encryptedData.getEncryptionAlgorithm(), cArr3, z6, encryptedData.getContent().getOctets()));
                                    int i7 = 0;
                                        ...
                                        if (safeBag2.getBagId().equals((ASN1Primitive) PKCSObjectIdentifiers.certBag)) {
                                            ...
                                            while (objects2.hasMoreElements()) {
                                                ...
                                                if (aSN1ObjectIdentifier2.equals((ASN1Primitive) PKCSObjectIdentifiers.pkcs_9_at_friendlyName)) {
                                                    string4 = ((ASN1BMPString) aSN1Primitive).getString();
                                            ...
                                            if (string4 == null) {
                                                ...
                                                this.localIds.put(string4, str2);
                                            }
                                        } else {
                                            aSN1Sequence = aSN1Sequence4;
                                            i2 = i7;
                                            if (safeBag2.getBagId().equals((ASN1Primitive) PKCSObjectIdentifiers.keyBag)) {
                                                ...
                                                while (objects3.hasMoreElements()) {
                                                    ...
                                                    if (aSN1Set3.size() > 0) {
                                                        ...
                                                        if (aSN1ObjectIdentifier3.equals((ASN1Primitive) PKCSObjectIdentifiers.pkcs_9_at_friendlyName)) {
                                                            string5 = ((ASN1BMPString) aSN1Primitive3).getString();
                                                            this.keys.put(string5, privateKey);
                                                ...
                                                String str3 = new String(Hex.encode(aSN1OctetString4.getOctets()));
                                                if (string5 == null) {
                                                    this.keys.put(str3, privateKey);
                                                } else {
                                                    this.localIds.put(string5, str3);
                                                }
                                            } else {
                                    ...
                                    z3 = z6;
                                    System.out.println("extra " + contentInfo[i5].getContentType().getId());
                                    System.out.println("extra " + ASN1Dump.dumpAsString(contentInfo[i5].getContent()));
                                }
                            }
                            i5++;
                            z = z3;
                    ...
                    while (i != vector.size()) {
                        ...
                        try {
                            ...
                            if (safeBag3.getBagAttributes() != null) {
                                ...
                                while (objects4.hasMoreElements()) {
                                    ...
                                    if (aSN1Set4.size() > 0) {
                                        ...
                                        } else if (!aSN1ObjectIdentifier4.equals((ASN1Primitive) PKCSObjectIdentifiers.pkcs_9_at_friendlyName)) {
                                            string2 = ((ASN1BMPString) aSN1Primitive4).getString();
                                        } else if (aSN1ObjectIdentifier4.equals((ASN1Primitive) PKCSObjectIdentifiers.pkcs_9_at_localKeyId)) {
                                            r6 = (ASN1OctetString) aSN1Primitive4;
                                        }
                                    }
                                    string2 = string2;
                                }
                            ...
                            if (!z2) {
                                ...
                                if (string2 != 0) {
                                    this.certs.put(string2, GenerateCertificate);
                                }
            ...
            cArr2 = cArr;
            if (cArr2 != null && cArr2.length != 0 && !Properties.isOverrideSet("org.bouncycastle.pkcs12.ignore_useless_passwd")) {
    ...
    protected PrivateKey unwrapKey(AlgorithmIdentifier algorithmIdentifier, byte[] bArr, char[] cArr, boolean z) throws NoSuchAlgorithmException, InvalidKeyException, IOException, InvalidAlgorithmParameterException {
        Key keyUnwrap;
        ASN1ObjectIdentifier algorithm = algorithmIdentifier.getAlgorithm();
        try {
            if (algorithm.m3856on(PKCSObjectIdentifiers.pkcs_12PbeIds)) {
                ...
                keyUnwrap = cipherCreateCipher.unwrap(bArr, "", 2);
            } else {
                if (!algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.id_PBES2)) {
                    throw new IOException("exception unwrapping private key - cannot recognise: " + algorithm);
                }
                keyUnwrap = createCipher(4, cArr, algorithmIdentifier).unwrap(bArr, "", 2);
            }
            return (PrivateKey) keyUnwrap;
        } catch (Exception e) {

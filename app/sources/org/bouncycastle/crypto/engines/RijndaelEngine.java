...
public class RijndaelEngine implements BlockCipher {
    ...
    /* renamed from: A0 */
    private long f7507A0;

    /* renamed from: A1 */
    private long f7508A1;

    /* renamed from: A2 */
    private long f7509A2;

    /* renamed from: A3 */
    private long f7510A3;
    ...
    private void InvMixColumn() {
        ...
        long jMul0xe3 = 0;
        long jMul0xe4 = 0;
        for (int i = 0; i < this.f7511BC; i += 8) {
            int i2 = (int) ((this.f7507A0 >> i) & 255);
            int i3 = (int) ((this.f7508A1 >> i) & 255);
            int i4 = (int) ((this.f7509A2 >> i) & 255);
            int i5 = (int) ((this.f7510A3 >> i) & 255);
            int i6 = -1;
        ...
        this.f7507A0 = jMul0xe;
        this.f7508A1 = jMul0xe4;
        this.f7509A2 = jMul0xe2;
        this.f7510A3 = jMul0xe3;
    }
    ...
    private void MixColumn() {
        ...
        this.f7507A0 = jMul0x2;
        this.f7508A1 = jMul0x24;
        this.f7509A2 = jMul0x22;
        this.f7510A3 = jMul0x23;
    }

    private void ShiftRow(byte[] bArr) {
        this.f7508A1 = shift(this.f7508A1, bArr[1]);
        this.f7509A2 = shift(this.f7509A2, bArr[2]);
        this.f7510A3 = shift(this.f7510A3, bArr[3]);
    }

    private void Substitution(byte[] bArr) {
        this.f7507A0 = applyS(this.f7507A0, bArr);
        this.f7508A1 = applyS(this.f7508A1, bArr);
        this.f7509A2 = applyS(this.f7509A2, bArr);
        this.f7510A3 = applyS(this.f7510A3, bArr);
    }
    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        this.ROUNDS = length >= this.blockBits ? i + 6 : (this.f7511BC / 8) + 6;
        int i6 = 0;
        int i7 = 0;
        ...
        int i8 = 0;
        int i9 = 0;
        while (i8 < i && i9 < (this.ROUNDS + i3) * (this.f7511BC / i2)) {
            int i10 = i4;
            while (i10 < 4) {
                int i11 = this.f7511BC;
        ...
        int i13 = i4;
        int i14 = i13;
        while (i9 < (this.ROUNDS + 1) * (this.f7511BC / 8)) {
            int i15 = i13;
            while (i15 < i5) {
                byte[] bArr3 = bArr2[i15];
                i15++;
                bArr3[i13] = (byte) (bArr3[i13] ^ f7505S[bArr2[i15 % 4][i - 1] & 255]);
            }
            ...
            if (i <= 6) {
                ...
                for (int i20 = i13; i20 < i5; i20++) {
                    ...
                    bArr7[i5] = (byte) (bArr7[i5] ^ f7505S[bArr7[3] & 255]);
                }
            ...
            int i23 = i13;
            while (i23 < i && i9 < (this.ROUNDS + 1) * (this.f7511BC / 8)) {
                int i24 = i13;
                while (i24 < i5) {
                    int i25 = this.f7511BC;
    ...
    private byte mul0x9(int i) {
        if (i >= 0) {
            return aLogtable[i + EnumC7081g.SDK_ASSET_ICON_CANCEL_VALUE];
        }
        return (byte) 0;
    }
    ...
    private byte mul0xd(int i) {
        if (i >= 0) {
            return aLogtable[i + EnumC7081g.SDK_ASSET_ILLUSTRATION_MD_ERROR_ATTEMPT_02_VALUE];
        }
        return (byte) 0;
    }
    ...
    private byte mul0xe(int i) {
        if (i >= 0) {
            return aLogtable[i + EnumC7081g.SDK_ASSET_ILLUSTRATION_ACCOUNT_CIRCLE_VALUE];
        }
        return (byte) 0;
    }

    private void packBlock(byte[] bArr, int i) {
        for (int i2 = 0; i2 != this.f7511BC; i2 += 8) {
            bArr[i] = (byte) (this.f7507A0 >> i2);
            bArr[i + 1] = (byte) (this.f7508A1 >> i2);
            int i3 = i + 3;
            bArr[i + 2] = (byte) (this.f7509A2 >> i2);
            i += 4;
            bArr[i3] = (byte) (this.f7510A3 >> i2);
        }
    }

    private long shift(long j, int i) {
        return ((j << (this.f7511BC - i)) | (j >>> i)) & this.BC_MASK;
    }

    private void unpackBlock(byte[] bArr, int i) {
        this.f7507A0 = bArr[i] & 255;
        this.f7508A1 = bArr[i + 1] & 255;
        int i2 = i + 3;
        this.f7509A2 = bArr[i + 2] & 255;
        int i3 = i + 4;
        this.f7510A3 = bArr[i2] & 255;
        for (int i4 = 8; i4 != this.f7511BC; i4 += 8) {
            this.f7507A0 |= (bArr[i3] & 255) << i4;
            this.f7508A1 |= (bArr[i3 + 1] & 255) << i4;
            int i5 = i3 + 3;
            this.f7509A2 |= (bArr[i3 + 2] & 255) << i4;
            i3 += 4;
            this.f7510A3 |= (bArr[i5] & 255) << i4;
        }
    }

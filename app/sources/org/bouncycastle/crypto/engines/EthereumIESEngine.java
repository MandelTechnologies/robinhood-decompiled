...
public class EthereumIESEngine {
    ...
    public static class HandshakeKDFFunction implements DigestDerivationFunction {
        ...
        public int generateBytes(byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
            ...
            int i7 = this.counterStart & AssetHomeEducationTourScreen.SortButtonOffset;
            int i8 = 0;
            while (i8 < i5) {
        ...
        public void init(DerivationParameters derivationParameters) {
            if (derivationParameters instanceof KDFParameters) {
                ...
                this.f7482iv = kDFParameters.getIV();
            } else {
    ...
    private byte[] decryptBlock(byte[] bArr, int i, int i2) throws InvalidCipherTextException, IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        int iProcessBytes;
        byte[] bArr4;
        if (i2 < this.f7481V.length + this.mac.getMacSize()) {
            throw new InvalidCipherTextException("length of input must be greater than the MAC and V combined");
        }
        if (this.cipher == null) {
            int length = (i2 - this.f7481V.length) - this.mac.getMacSize();
            ...
            for (int i4 = 0; i4 != length; i4++) {
                bArr4[i4] = (byte) (bArr[(this.f7481V.length + i) + i4] ^ bArr5[i4]);
            }
            bArr3 = bArr;
            iProcessBytes = 0;
        } else {
        ...
        byte[] lengthTag = this.f7481V.length != 0 ? getLengthTag(encodingV) : null;
        int i6 = i + i2;
        ...
        Mac mac = this.mac;
        byte[] bArr14 = this.f7480IV;
        mac.update(bArr14, 0, bArr14.length);
        Mac mac2 = this.mac;
        byte[] bArr15 = this.f7481V;
    ...
    private byte[] encryptBlock(byte[] bArr, int i, int i2) throws InvalidCipherTextException, IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        if (this.cipher == null) {
            ...
            if (this.f7480IV != null) {
                bufferedBlockCipher = this.cipher;
                keyParameter = new ParametersWithIV(new KeyParameter(bArr6), this.f7480IV);
            } else {
                bufferedBlockCipher = this.cipher;
        ...
        byte[] bArr14 = this.f7481V;
        byte[] bArr15 = new byte[bArr14.length + i2 + macSize];
        System.arraycopy(bArr14, 0, bArr15, 0, bArr14.length);
        System.arraycopy(bArr3, 0, bArr15, this.f7481V.length, i2);
        System.arraycopy(bArr10, 0, bArr15, this.f7481V.length + i2, macSize);
        return bArr15;
    }
    ...
    private void extractParams(CipherParameters cipherParameters) {
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f7480IV = parametersWithIV.getIV();
    ...
    public byte[] processBlock(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        if (this.forEncryption) {
            ...
            if (ephemeralKeyPairGenerator != null) {
                ...
                this.f7481V = ephemeralKeyPairGenerate.getEncodedPublicKey();
            }
        } else if (this.keyParser != null) {
            ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(bArr, i, i2);
            try {
                this.pubParam = this.keyParser.readKey(byteArrayInputStream);
                this.f7481V = Arrays.copyOfRange(bArr, i, (i2 - byteArrayInputStream.available()) + i);
            } catch (IOException e) {

...
public class AESEngine implements BlockCipher {
    ...
    /* renamed from: m1 */
    private static final int f7426m1 = -2139062144;

    /* renamed from: m2 */
    private static final int f7427m2 = 2139062143;

    /* renamed from: m3 */
    private static final int f7428m3 = 27;

    /* renamed from: m4 */
    private static final int f7429m4 = -1061109568;

    /* renamed from: m5 */
    private static final int f7430m5 = 1061109567;
    private int ROUNDS;
    ...
    private static int FFmulX(int i) {
        return (((i & f7426m1) >>> 7) * 27) ^ ((f7427m2 & i) << 1);
    }
    ...
    public String getAlgorithmName() {
        return BiometricChangeManager.ALGORITHM;
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (z) {
            this.f7431s = Arrays.clone(f7423S);
        } else {
            this.f7431s = Arrays.clone(f7424Si);
        }
    }

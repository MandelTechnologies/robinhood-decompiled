...
public class VMPCEngine implements StreamCipher {
    ...
    /* renamed from: n */
    protected byte f7533n = 0;

    /* renamed from: P */
    protected byte[] f7532P = null;

    /* renamed from: s */
    protected byte f7534s = 0;
    ...
    protected void initKey(byte[] bArr, byte[] bArr2) {
        this.f7534s = (byte) 0;
        this.f7532P = new byte[256];
        for (int i = 0; i < 256; i++) {
            this.f7532P[i] = (byte) i;
        }
        for (int i2 = 0; i2 < 768; i2++) {
            byte[] bArr3 = this.f7532P;
            byte b = this.f7534s;
            int i3 = i2 & 255;
            byte b2 = bArr3[i3];

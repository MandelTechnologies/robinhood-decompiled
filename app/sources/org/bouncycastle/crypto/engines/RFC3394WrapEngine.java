...
public class RFC3394WrapEngine implements Wrapper {
    ...
    public RFC3394WrapEngine(BlockCipher blockCipher, boolean z) {
        this.f7504iv = new byte[]{-90, -90, -90, -90, -90, -90, -90, -90};
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f7504iv = parametersWithIV.getIV();
            this.param = (KeyParameter) parametersWithIV.getParameters();
            if (this.f7504iv.length != 8) {
    ...
    public byte[] unwrap(byte[] bArr, int i, int i2) throws InvalidCipherTextException, IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        if (Arrays.constantTimeAreEqual(bArr4, this.f7504iv)) {
            return bArr3;
        }
    ...
    public byte[] wrap(byte[] bArr, int i, int i2) throws IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        System.arraycopy(bArr, i, bArr3, this.f7504iv.length, i2);
        this.engine.init(this.wrapCipherMode, this.param);
        for (int i4 = 0; i4 != 6; i4++) {
            for (int i5 = 1; i5 <= i3; i5++) {
                System.arraycopy(bArr3, 0, bArr4, 0, this.f7504iv.length);
                int i6 = i5 * 8;
                System.arraycopy(bArr3, i6, bArr4, this.f7504iv.length, 8);
                this.engine.processBlock(bArr4, 0, bArr4, 0);
                int i7 = (i3 * i4) + i5;
                int i8 = 1;
                while (i7 != 0) {
                    int length = this.f7504iv.length - i8;

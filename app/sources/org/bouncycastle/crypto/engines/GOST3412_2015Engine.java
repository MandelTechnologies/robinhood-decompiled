...
public class GOST3412_2015Engine implements BlockCipher {
    ...
    /* renamed from: C */
    private void m3922C(byte[] bArr, int i) {
        Arrays.clear(bArr);
        bArr[15] = (byte) i;
        m3924L(bArr);
    }
    ...
    /* renamed from: F */
    private void m3923F(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        byte[] bArrLSX = LSX(bArr, bArr2);
        m3927X(bArrLSX, bArr3);
    ...
    private void GOST3412_2015Func(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        if (this.forEncryption) {
            ...
            m3927X(bArrCopyOf, this.subKeys[9]);
        } else {
            while (true) {
                bArr3 = this.subKeys;
                if (i3 <= 0) {
            ...
            m3927X(bArrCopyOf, bArr3[0]);
        }
        System.arraycopy(bArrCopyOf, 0, bArr2, i2, 16);
    }

    /* renamed from: L */
    private void m3924L(byte[] bArr) {
        for (int i = 0; i < 16; i++) {
            m3925R(bArr);
        }
    }
    ...
    /* renamed from: R */
    private void m3925R(byte[] bArr) {
        byte bM3928l = m3928l(bArr);
        System.arraycopy(bArr, 0, bArr, 1, 15);
        bArr[0] = bM3928l;
    }

    /* renamed from: S */
    private void m3926S(byte[] bArr) {
        for (int i = 0; i < bArr.length; i++) {
            bArr[i] = f7484PI[unsignedByte(bArr[i])];
        }
    }

    /* renamed from: X */
    private void m3927X(byte[] bArr, byte[] bArr2) {
        for (int i = 0; i < bArr.length; i++) {
    ...
    private void generateSubKeys(byte[] bArr) {
        ...
        for (int i5 = 1; i5 < 5; i5++) {
            for (int i6 = 1; i6 <= 8; i6++) {
                m3922C(bArr7, ((i5 - 1) * 8) + i6);
                m3923F(bArr7, bArr2, bArr3);
            }
            int i7 = i5 * 2;

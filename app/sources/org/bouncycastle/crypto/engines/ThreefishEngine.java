...
public class ThreefishEngine implements BlockCipher {
    ...
    private static final class Threefish1024Cipher extends ThreefishCipher {
        ...
        void decryptBlock(long[] jArr, long[] jArr2) {
            long[] jArr3 = this.f7529kw;
            long[] jArr4 = this.f7530t;
    ...
    private static abstract class ThreefishCipher {
        ...
        /* renamed from: kw */
        protected final long[] f7529kw;

        /* renamed from: t */
        protected final long[] f7530t;
    ...
    private void setKey(long[] jArr) {
        ...
        while (true) {
            ...
            if (i >= i2) {
                long[] jArr2 = this.f7527kw;
                jArr2[i2] = j;
                System.arraycopy(jArr2, 0, jArr2, i2 + 1, i2);
                return;
            } else {
                long[] jArr3 = this.f7527kw;
                long j2 = jArr[i];
                jArr3[i] = j2;
                j ^= j2;
                i++;

...
public final class TwofishEngine implements BlockCipher {
    ...
    private int F32(int i, int[] iArr) {
        int i2;
        int i3;
        int iM3946b0 = m3946b0(i);
        int iM3947b1 = m3947b1(i);
        int iM3948b2 = m3948b2(i);
        int iM3949b3 = m3949b3(i);
        int i4 = iArr[0];
        int i5 = iArr[1];
        int i6 = iArr[2];
        int i7 = iArr[3];
        ...
        if (i8 != 0) {
            if (i8 == 1) {
                ...
                byte[][] bArr = f7531P;
                i2 = (iArr2[(bArr[0][iM3946b0] & 255) ^ m3946b0(i4)] ^ this.gMDS1[(bArr[0][iM3947b1] & 255) ^ m3947b1(i4)]) ^ this.gMDS2[(bArr[1][iM3948b2] & 255) ^ m3948b2(i4)];
                i3 = this.gMDS3[(bArr[1][iM3949b3] & 255) ^ m3949b3(i4)];
                return i3 ^ i2;
            }
            if (i8 != 2) {
                if (i8 != 3) {
            ...
            byte[][] bArr2 = f7531P;
            byte[] bArr3 = bArr2[0];
            i2 = (iArr3[(bArr3[(bArr3[iM3946b0] & 255) ^ m3946b0(i5)] & 255) ^ m3946b0(i4)] ^ this.gMDS1[(bArr2[0][(bArr2[1][iM3947b1] & 255) ^ m3947b1(i5)] & 255) ^ m3947b1(i4)]) ^ this.gMDS2[(bArr2[1][(bArr2[0][iM3948b2] & 255) ^ m3948b2(i5)] & 255) ^ m3948b2(i4)];
            int[] iArr4 = this.gMDS3;
            byte[] bArr4 = bArr2[1];
            i3 = iArr4[(bArr4[(bArr4[iM3949b3] & 255) ^ m3949b3(i5)] & 255) ^ m3949b3(i4)];
            return i3 ^ i2;
        }
        byte[][] bArr5 = f7531P;
        iM3946b0 = (bArr5[1][iM3946b0] & 255) ^ m3946b0(i7);
        iM3947b1 = (bArr5[0][iM3947b1] & 255) ^ m3947b1(i7);
        iM3948b2 = (bArr5[0][iM3948b2] & 255) ^ m3948b2(i7);
        iM3949b3 = (bArr5[1][iM3949b3] & 255) ^ m3949b3(i7);
        byte[][] bArr6 = f7531P;
        iM3946b0 = (bArr6[1][iM3946b0] & 255) ^ m3946b0(i6);
        iM3947b1 = (bArr6[1][iM3947b1] & 255) ^ m3947b1(i6);
        iM3948b2 = (bArr6[0][iM3948b2] & 255) ^ m3948b2(i6);
        iM3949b3 = (bArr6[0][iM3949b3] & 255) ^ m3949b3(i6);
        int[] iArr32 = this.gMDS0;
        byte[][] bArr22 = f7531P;
        byte[] bArr32 = bArr22[0];
        i2 = (iArr32[(bArr32[(bArr32[iM3946b0] & 255) ^ m3946b0(i5)] & 255) ^ m3946b0(i4)] ^ this.gMDS1[(bArr22[0][(bArr22[1][iM3947b1] & 255) ^ m3947b1(i5)] & 255) ^ m3947b1(i4)]) ^ this.gMDS2[(bArr22[1][(bArr22[0][iM3948b2] & 255) ^ m3948b2(i5)] & 255) ^ m3948b2(i4)];
        int[] iArr42 = this.gMDS3;
        byte[] bArr42 = bArr22[1];
        i3 = iArr42[(bArr42[(bArr42[iM3949b3] & 255) ^ m3949b3(i5)] & 255) ^ m3949b3(i4)];
        return i3 ^ i2;
    }
    ...
    private int RS_rem(int i) {
        ...
        int i5 = ((i3 >>> 1) ^ ((i2 & 1) != 0 ? EnumC7081g.SDK_ASSET_ILLUSTRATION_ETH_WITH_PLAID_VALUE : 0)) ^ i4;
        return ((((i << 8) ^ (i5 << 24)) ^ (i4 << 16)) ^ (i5 << 8)) ^ i3;
    }

    /* renamed from: b0 */
    private int m3946b0(int i) {
        return i & 255;
    }

    /* renamed from: b1 */
    private int m3947b1(int i) {
        return (i >>> 8) & 255;
    }

    /* renamed from: b2 */
    private int m3948b2(int i) {
        return (i >>> 16) & 255;
    }

    /* renamed from: b3 */
    private int m3949b3(int i) {
        return (i >>> 24) & 255;
    }
        ...
        while (i13 < 256) {
            ...
            if (i14 != 0) {
                if (i14 == 1) {
                    ...
                    byte[][] bArr2 = f7531P;
                    iArr5[i15] = iArr6[(bArr2[0][i13] & 255) ^ m3946b0(i8)];
                    this.gSBox[i15 + 1] = this.gMDS1[(bArr2[0][i13] & 255) ^ m3947b1(i8)];
                    this.gSBox[i15 + 512] = this.gMDS2[(bArr2[1][i13] & 255) ^ m3948b2(i8)];
                    this.gSBox[i15 + 513] = this.gMDS3[(bArr2[1][i13] & 255) ^ m3949b3(i8)];
                } else if (i14 == i10) {
                    iM3949b32 = i13;
                    iM3946b02 = iM3949b32;
                    iM3947b12 = iM3946b02;
                    ...
                    byte[][] bArr3 = f7531P;
                    byte[] bArr4 = bArr3[0];
                    iArr7[i16] = iArr8[(bArr4[(bArr4[iM3946b02] & 255) ^ m3946b0(i9)] & 255) ^ m3946b0(i8)];
                    this.gSBox[i16 + 1] = this.gMDS1[(bArr3[0][(bArr3[1][iM3947b12] & 255) ^ m3947b1(i9)] & 255) ^ m3947b1(i8)];
                    this.gSBox[i16 + 512] = this.gMDS2[(bArr3[1][(bArr3[0][iM3948b22] & 255) ^ m3948b2(i9)] & 255) ^ m3948b2(i8)];
                    int[] iArr9 = this.gMDS3;
                    byte[] bArr5 = bArr3[1];
                    this.gSBox[i16 + 513] = iArr9[(bArr5[(bArr5[iM3949b32] & 255) ^ m3949b3(i9)] & 255) ^ m3949b3(i8)];
                } else if (i14 == 3) {
                    iM3949b3 = i13;
                    iM3946b0 = iM3949b3;
                    iM3947b1 = iM3946b0;
                ...
                byte[][] bArr6 = f7531P;
                iM3946b0 = (bArr6[1][i13] & 255) ^ m3946b0(i12);
                iM3947b1 = (bArr6[0][i13] & 255) ^ m3947b1(i12);
                iM3948b2 = (bArr6[0][i13] & 255) ^ m3948b2(i12);
                iM3949b3 = (bArr6[1][i13] & 255) ^ m3949b3(i12);
            }
            byte[][] bArr7 = f7531P;
            iM3946b02 = (bArr7[1][iM3946b0] & 255) ^ m3946b0(i11);
            iM3947b12 = (bArr7[1][iM3947b1] & 255) ^ m3947b1(i11);
            iM3948b22 = (bArr7[0][iM3948b2] & 255) ^ m3948b2(i11);
            iM3949b32 = (bArr7[0][iM3949b3] & 255) ^ m3949b3(i11);
            int[] iArr72 = this.gSBox;
            int i162 = i13 * 2;
            int[] iArr82 = this.gMDS0;
            byte[][] bArr32 = f7531P;
            byte[] bArr42 = bArr32[0];
            iArr72[i162] = iArr82[(bArr42[(bArr42[iM3946b02] & 255) ^ m3946b0(i9)] & 255) ^ m3946b0(i8)];
            this.gSBox[i162 + 1] = this.gMDS1[(bArr32[0][(bArr32[1][iM3947b12] & 255) ^ m3947b1(i9)] & 255) ^ m3947b1(i8)];
            this.gSBox[i162 + 512] = this.gMDS2[(bArr32[1][(bArr32[0][iM3948b22] & 255) ^ m3948b2(i9)] & 255) ^ m3948b2(i8)];
            int[] iArr92 = this.gMDS3;
            byte[] bArr52 = bArr32[1];
            this.gSBox[i162 + 513] = iArr92[(bArr52[(bArr52[iM3949b32] & 255) ^ m3949b3(i9)] & 255) ^ m3949b3(i8)];
            i13++;
            i10 = 2;
        }
    }

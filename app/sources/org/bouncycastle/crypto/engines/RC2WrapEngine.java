...
public class RC2WrapEngine implements Wrapper {
    ...
    /* renamed from: iv */
    private byte[] f7497iv;
    private CipherParameters param;
    private ParametersWithIV paramPlusIV;

    /* renamed from: sr */
    private SecureRandom f7498sr;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof ParametersWithRandom) {
            ...
            this.f7498sr = parametersWithRandom.getRandom();
            cipherParameters = parametersWithRandom.getParameters();
        } else {
            this.f7498sr = CryptoServicesRegistrar.getSecureRandom();
        }
        if (!(cipherParameters instanceof ParametersWithIV)) {
            ...
            if (this.forWrapping) {
                ...
                this.f7497iv = bArr;
                this.f7498sr.nextBytes(bArr);
                this.paramPlusIV = new ParametersWithIV(this.param, this.f7497iv);
                return;
            }
            return;
        }
        ...
        this.f7497iv = parametersWithIV.getIV();
        this.param = this.paramPlusIV.getParameters();
        if (!this.forWrapping) {
            throw new IllegalArgumentException("You should not supply an IV for unwrapping");
        }
        byte[] bArr2 = this.f7497iv;
    ...
    public byte[] unwrap(byte[] bArr, int i, int i2) throws InvalidCipherTextException, IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        ParametersWithIV parametersWithIV = new ParametersWithIV(this.param, this.f7497iv);
        this.paramPlusIV = parametersWithIV;
    ...
    public byte[] wrap(byte[] bArr, int i, int i2) throws IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        byte[] bArr6 = this.f7497iv;
        int length2 = bArr6.length + length;
        byte[] bArr7 = new byte[length2];
        System.arraycopy(bArr6, 0, bArr7, 0, bArr6.length);
        System.arraycopy(bArr5, 0, bArr7, this.f7497iv.length, length);

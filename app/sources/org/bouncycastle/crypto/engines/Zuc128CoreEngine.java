...
public class Zuc128CoreEngine implements StreamCipher, Memoable {
    ...
    /* renamed from: L1 */
    private static int m3950L1(int i) {
        return ROT(i, 24) ^ (((ROT(i, 2) ^ i) ^ ROT(i, 10)) ^ ROT(i, 18));
    }

    /* renamed from: L2 */
    private static int m3951L2(int i) {
    ...
    private void setKeyAndIV(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i <= 0) {
                ...
                LFSRWithInitialisationMode(m3952F() >>> 1);
                i--;
            }
        }
    }
    ...
    int m3952F() {
        ...
        int i5 = i2 + iArr[1];
        int i6 = iArr[2] ^ i3;
        int iM3950L1 = m3950L1((i5 << 16) | (i6 >>> 16));
        int iM3951L2 = m3951L2((i6 << 16) | (i5 >>> 16));
        int[] iArr3 = this.f7538F;
        byte[] bArr = f7536S0;
        byte b = bArr[iM3950L1 >>> 24];
        byte[] bArr2 = f7537S1;
        iArr3[0] = MAKEU32(b, bArr2[(iM3950L1 >>> 16) & 255], bArr[(iM3950L1 >>> 8) & 255], bArr2[iM3950L1 & 255]);
        this.f7538F[1] = MAKEU32(bArr[iM3951L2 >>> 24], bArr2[(iM3951L2 >>> 16) & 255], bArr[(iM3951L2 >>> 8) & 255], bArr2[iM3951L2 & 255]);
        return i4;
    }
    ...
    public void reset(Memoable memoable) {
        ...
        int[] iArr3 = zuc128CoreEngine.f7538F;
        int[] iArr4 = this.f7538F;

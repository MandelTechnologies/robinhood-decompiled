...
public class CramerShoupCiphertext {
    ...
    public CramerShoupCiphertext(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
        this.f7467u1 = bigInteger;
        this.f7468u2 = bigInteger2;
        this.f7466e = bigInteger3;
        this.f7469v = bigInteger4;
    }

    public CramerShoupCiphertext(byte[] bArr) {
        int iBigEndianToInt = Pack.bigEndianToInt(bArr, 0);
        int i = 4 + iBigEndianToInt;
        this.f7467u1 = new BigInteger(Arrays.copyOfRange(bArr, 4, i));
        int i2 = iBigEndianToInt + 8;
        int iBigEndianToInt2 = Pack.bigEndianToInt(bArr, i) + i2;
        this.f7468u2 = new BigInteger(Arrays.copyOfRange(bArr, i2, iBigEndianToInt2));
        int iBigEndianToInt3 = Pack.bigEndianToInt(bArr, iBigEndianToInt2);
        int i3 = iBigEndianToInt2 + 4;
        int i4 = iBigEndianToInt3 + i3;
        this.f7466e = new BigInteger(Arrays.copyOfRange(bArr, i3, i4));
        int iBigEndianToInt4 = Pack.bigEndianToInt(bArr, i4);
        int i5 = i4 + 4;
        this.f7469v = new BigInteger(Arrays.copyOfRange(bArr, i5, iBigEndianToInt4 + i5));
    }
    ...
    public void setU2(BigInteger bigInteger) {
        this.f7468u2 = bigInteger;
    }

    public void setV(BigInteger bigInteger) {
        this.f7469v = bigInteger;
    }

    public byte[] toByteArray() {
        byte[] byteArray = this.f7467u1.toByteArray();
        int length = byteArray.length;
        byte[] byteArray2 = this.f7468u2.toByteArray();
        int length2 = byteArray2.length;
        byte[] byteArray3 = this.f7466e.toByteArray();
        int length3 = byteArray3.length;
        byte[] byteArray4 = this.f7469v.toByteArray();
    ...
    public String toString() {
        ...
        stringBuffer.append("u1: " + this.f7467u1.toString());
        stringBuffer.append("\nu2: " + this.f7468u2.toString());
        stringBuffer.append("\ne: " + this.f7466e.toString());
        stringBuffer.append("\nv: " + this.f7469v.toString());

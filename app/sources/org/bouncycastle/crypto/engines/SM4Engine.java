...
public class SM4Engine implements BlockCipher {
    ...
    /* renamed from: X */
    private final int[] f7515X = new int[4];
    ...
    /* renamed from: CK */
    private static final int[] f7513CK = {462357, 472066609, 943670861, 1415275113, 1886879365, -1936483679, -1464879427, -993275175, -521670923, -66909679, 404694573, 876298825, 1347903077, 1819507329, -2003855715, -1532251463, -1060647211, -589042959, -117504499, 337322537, 808926789, 1280531041, 1752135293, -2071227751, -1599623499, -1128019247, -656414995, -184876535, 269950501, 741554753, 1213159005, 1684763257};

    /* renamed from: FK */
    private static final int[] f7514FK = {-1548633402, 1453994832, 1736282519, -1301273892};

    /* renamed from: F0 */
    private int m3937F0(int[] iArr, int i) {
        return m3942T((iArr[3] ^ (iArr[1] ^ iArr[2])) ^ i) ^ iArr[0];
    }

    /* renamed from: F1 */
    private int m3938F1(int[] iArr, int i) {
        return m3942T((iArr[0] ^ (iArr[2] ^ iArr[3])) ^ i) ^ iArr[1];
    }

    /* renamed from: F2 */
    private int m3939F2(int[] iArr, int i) {
        return m3942T((iArr[1] ^ (iArr[3] ^ iArr[0])) ^ i) ^ iArr[2];
    }

    /* renamed from: F3 */
    private int m3940F3(int[] iArr, int i) {
        return m3942T((iArr[2] ^ (iArr[0] ^ iArr[1])) ^ i) ^ iArr[3];
    }

    /* renamed from: L */
    private int m3941L(int i) {
    ...
    private int[] expandKey(boolean z, byte[] bArr) {
        ...
        if (z) {
            ...
            for (int i4 = 4; i4 < 32; i4++) {
                iArr[i4] = iArr[i4 - 4] ^ T_ap(((iArr[i4 - 3] ^ iArr[i4 - 2]) ^ iArr[i4 - 1]) ^ f7513CK[i4]);
            }
        } else {
            int i5 = iArr4[0];
            ...
            for (int i7 = 27; i7 >= 0; i7--) {
                iArr[i7] = iArr[i7 + 4] ^ T_ap(((iArr[i7 + 3] ^ iArr[i7 + 2]) ^ iArr[i7 + 1]) ^ f7513CK[31 - i7]);
            }
        }
        return iArr;
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        this.f7516rk = expandKey(z, key);
    }

    @Override // org.bouncycastle.crypto.BlockCipher
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws IllegalStateException, DataLengthException {
        if (this.f7516rk == null) {
        ...
        this.f7515X[0] = Pack.bigEndianToInt(bArr, i);
        this.f7515X[1] = Pack.bigEndianToInt(bArr, i + 4);
        this.f7515X[2] = Pack.bigEndianToInt(bArr, i + 8);
        this.f7515X[3] = Pack.bigEndianToInt(bArr, i + 12);
        for (int i3 = 0; i3 < 32; i3 += 4) {
            int[] iArr = this.f7515X;
            iArr[0] = m3937F0(iArr, this.f7516rk[i3]);
            int[] iArr2 = this.f7515X;
            iArr2[1] = m3938F1(iArr2, this.f7516rk[i3 + 1]);
            int[] iArr3 = this.f7515X;
            iArr3[2] = m3939F2(iArr3, this.f7516rk[i3 + 2]);
            int[] iArr4 = this.f7515X;
            iArr4[3] = m3940F3(iArr4, this.f7516rk[i3 + 3]);
        }
        Pack.intToBigEndian(this.f7515X[3], bArr2, i2);
        Pack.intToBigEndian(this.f7515X[2], bArr2, i2 + 4);
        Pack.intToBigEndian(this.f7515X[1], bArr2, i2 + 8);
        Pack.intToBigEndian(this.f7515X[0], bArr2, i2 + 12);
        return 16;
    }

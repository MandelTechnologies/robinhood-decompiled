...
public class IDEAEngine implements BlockCipher {
    ...
    private int[] expandKey(byte[] bArr) {
        ...
        for (i = 8; i < 52; i++) {
            int i3 = i & 7;
            if (i3 < 6) {
                iArr[i] = (((iArr[i - 7] & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) << 9) | (iArr[i - 6] >> 7)) & 65535;
            } else if (i3 == 6) {
                iArr[i] = (((iArr[i - 7] & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) << 9) | (iArr[i - 14] >> 7)) & 65535;
            } else {
                iArr[i] = (((iArr[i - 15] & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) << 9) | (iArr[i - 14] >> 7)) & 65535;
            }
        }
        return iArr;
    }

...
public class SkipjackEngine implements BlockCipher {
    ...
    /* renamed from: g */
    private int m3944g(int i, int i2) {
        int i3 = (i2 >> 8) & 255;
        int i4 = i2 & 255;
        short[] sArr = ftable;
    ...
    /* renamed from: h */
    private int m3945h(int i, int i2) {
        int i3 = i2 & 255;
        int i4 = (i2 >> 8) & 255;
        short[] sArr = ftable;
    ...
    public int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i8 = 0; i8 < 2; i8++) {
            int i9 = 0;
            while (i9 < 8) {
                int iM3945h = m3945h(i7, i4);
                int i10 = (i5 ^ iM3945h) ^ (i7 + 1);
                i7--;
                i9++;
                int i11 = i6;
                i6 = i3;
    ...
    public int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        int i3 = (bArr[i] << 8) + (bArr[i + 1] & 255);
        int iM3944g = (bArr[i + 2] << 8) + (bArr[i + 3] & 255);
        ...
        for (int i7 = 0; i7 < 2; i7++) {
            ...
            while (i10 < 8) {
                int i11 = i6 + 1;
                int i12 = (iM3944g ^ i3) ^ i11;
                i10++;
                iM3944g = m3944g(i6, i3);
                i3 = i5;
                i5 = i4;
                i4 = i12;
                i6 = i11;
        ...
        bArr2[i2] = (byte) (i3 >> 8);
        bArr2[i2 + 1] = (byte) i3;
        bArr2[i2 + 2] = (byte) (iM3944g >> 8);
        bArr2[i2 + 3] = (byte) iM3944g;

...
public class JPAKEParticipant {
    ...
    /* renamed from: b */
    private BigInteger f7239b;
    private final Digest digest;

    /* renamed from: g */
    private final BigInteger f7240g;
    ...
    /* renamed from: p */
    private final BigInteger f7241p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    /* renamed from: q */
    private final BigInteger f7242q;
    private final SecureRandom random;
    private int state;

    /* renamed from: x1 */
    private BigInteger f7243x1;

    /* renamed from: x2 */
    private BigInteger f7244x2;
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        JPAKEUtil.validateNotNull(jPAKEPrimeOrderGroup, Constants.RequestParamsKeys.PLATFORM_KEY);
        ...
        this.f7241p = jPAKEPrimeOrderGroup.getP();
        this.f7242q = jPAKEPrimeOrderGroup.getQ();
        this.f7240g = jPAKEPrimeOrderGroup.getG();
        this.digest = digest;
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        this.password = null;
        BigInteger bigIntegerCalculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f7241p, this.f7242q, this.gx4, this.f7244x2, bigIntegerCalculateS, this.f7239b);
        this.f7243x1 = null;
        this.f7244x2 = null;
        this.f7239b = null;
        this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        ...
        this.f7243x1 = JPAKEUtil.generateX1(this.f7242q, this.random);
        this.f7244x2 = JPAKEUtil.generateX2(this.f7242q, this.random);
        this.gx1 = JPAKEUtil.calculateGx(this.f7241p, this.f7240g, this.f7243x1);
        this.gx2 = JPAKEUtil.calculateGx(this.f7241p, this.f7240g, this.f7244x2);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f7241p, this.f7242q, this.f7240g, this.gx1, this.f7243x1, this.participantId, this.digest, this.random);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f7241p, this.f7242q, this.f7240g, this.gx2, this.f7244x2, this.participantId, this.digest, this.random);
        this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        BigInteger bigIntegerCalculateGA = JPAKEUtil.calculateGA(this.f7241p, this.gx1, this.gx3, this.gx4);
        BigInteger bigIntegerCalculateX2s = JPAKEUtil.calculateX2s(this.f7242q, this.f7244x2, JPAKEUtil.calculateS(this.password));
        BigInteger bigIntegerCalculateA = JPAKEUtil.calculateA(this.f7241p, this.f7242q, bigIntegerCalculateGA, bigIntegerCalculateX2s);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f7241p, this.f7242q, bigIntegerCalculateGA, bigIntegerCalculateA, bigIntegerCalculateX2s, this.participantId, this.digest, this.random);
        this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f7241p, this.f7242q, this.f7240g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
        JPAKEUtil.validateZeroKnowledgeProof(this.f7241p, this.f7242q, this.f7240g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
        this.state = 20;
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        BigInteger bigIntegerCalculateGA = JPAKEUtil.calculateGA(this.f7241p, this.gx3, this.gx1, this.gx2);
        this.f7239b = jPAKERound2Payload.getA();
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f7241p, this.f7242q, bigIntegerCalculateGA, this.f7239b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
        this.state = 40;
    }

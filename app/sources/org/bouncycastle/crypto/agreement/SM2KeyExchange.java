...
public class SM2KeyExchange {
    ...
    /* renamed from: S1 */
    private byte[] m3858S1(Digest digest, ECPoint eCPoint, byte[] bArr) {
    ...
    /* renamed from: S2 */
    private byte[] m3859S2(Digest digest, ECPoint eCPoint, byte[] bArr) {
    ...
    private BigInteger reduce(BigInteger bigInteger) {
        return bigInteger.and(BigInteger.valueOf(1L).shiftLeft(this.f7238w).subtract(BigInteger.valueOf(1L))).setBit(this.f7238w);
    }
    ...
    public byte[][] calculateKeyWithConfirmation(int i, byte[] bArr, CipherParameters cipherParameters) {
        ...
        if (!this.initiator) {
            ...
            return new byte[][]{bArrKdf, m3858S1(this.digest, eCPointCalculateU, bArrCalculateInnerHash), m3859S2(this.digest, eCPointCalculateU, bArrCalculateInnerHash)};
        }
        ...
        if (Arrays.constantTimeAreEqual(m3858S1(this.digest, eCPointCalculateU, bArrCalculateInnerHash2), bArr)) {
            return new byte[][]{bArrKdf2, m3859S2(this.digest, eCPointCalculateU, bArrCalculateInnerHash2)};
        }
    ...
    public void init(CipherParameters cipherParameters) {
        ...
        this.f7238w = (this.ecParams.getCurve().getFieldSize() / 2) - 1;
    }
}

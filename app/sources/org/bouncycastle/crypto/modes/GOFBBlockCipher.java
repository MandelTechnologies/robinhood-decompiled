...
public class GOFBBlockCipher extends StreamBlockCipher {
    ...
    /* renamed from: C1 */
    static final int f7615C1 = 16843012;

    /* renamed from: C2 */
    static final int f7616C2 = 16843009;

    /* renamed from: IV */
    private byte[] f7617IV;
    ...
    public GOFBBlockCipher(BlockCipher blockCipher) {
        ...
        this.f7617IV = new byte[blockCipher.getBlockSize()];
    ...
    protected byte calculateByte(byte b) throws IllegalStateException, DataLengthException {
        if (this.byteCount == 0) {
            if (this.firstStep) {
                ...
                this.f7618N3 = bytesToint(this.ofbOutV, 0);
                this.f7619N4 = bytesToint(this.ofbOutV, 4);
            }
            int i = this.f7618N3 + 16843009;
            this.f7618N3 = i;
            int i2 = this.f7619N4;
            int i3 = i2 + 16843012;
            this.f7619N4 = i3;
            if (i3 < 16843012 && i3 > 0) {
                this.f7619N4 = i2 + R.attr.format;
            }
            intTobytes(i, this.ofbV, 0);
            intTobytes(this.f7619N4, this.ofbV, 4);
            this.cipher.processBlock(this.ofbV, 0, this.ofbOutV, 0);
        }
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            byte[] bArr = this.f7617IV;
            if (length < bArr.length) {
                System.arraycopy(iv, 0, bArr, bArr.length - iv.length, iv.length);
                int i = 0;
                while (true) {
                    byte[] bArr2 = this.f7617IV;

...
public class G3413CTRBlockCipher extends StreamBlockCipher {
    ...
    private byte[] generateBuf() throws IllegalStateException, DataLengthException {
        ...
        return GOST3413CipherUtil.MSB(bArr2, this.f7607s);
    }
    ...
    private void initArrays() {
        ...
        this.f7606IV = new byte[i / 2];
        this.CTR = new byte[i];
        this.buf = new byte[this.f7607s];
    }
    ...
    public int processBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws IllegalStateException, DataLengthException {
        processBytes(bArr, i, this.f7607s, bArr2, i2);
        return this.f7607s;
    }

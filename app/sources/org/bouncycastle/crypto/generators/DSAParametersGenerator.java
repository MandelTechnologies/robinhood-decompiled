...
public class DSAParametersGenerator {
    ...
    private DSAParameters generateParameters_FIPS186_2() {
        ...
        int i2 = this.f7547L;
        int i3 = (i2 - 1) / EnumC7081g.SDK_ASSET_ILLUSTRATION_SECURE_TOKENIZATION_VALUE;
        int i4 = i2 / 8;
        ...
        while (true) {
            ...
            if (isProbablePrime(bigInteger)) {
                ...
                while (i6 < 4096) {
                    ...
                    if (bigIntegerSubtract.bitLength() == this.f7547L && isProbablePrime(bigIntegerSubtract)) {
    ...
    private DSAParameters generateParameters_FIPS186_3() {
        ...
        byte[] bArr = new byte[this.f7548N / 8];
        int i2 = this.f7547L;
        ...
        loop0: while (true) {
            ...
            bit = new BigInteger(1, bArr3).mod(ONE.shiftLeft(this.f7548N - 1)).setBit(0).setBit(this.f7548N - 1);
            if (isProbablePrime(bit)) {
                byte[] bArrClone = Arrays.clone(bArr);
                int i7 = this.f7547L * 4;
                i = 0;
                while (i < i7) {
    ...
    public void init(int i, int i2, SecureRandom secureRandom) {
        this.f7547L = i;
        this.f7548N = getDefaultN(i);
        this.certainty = i2;
        this.iterations = Math.max(getMinimumIterations(this.f7547L), (i2 + 1) / 2);

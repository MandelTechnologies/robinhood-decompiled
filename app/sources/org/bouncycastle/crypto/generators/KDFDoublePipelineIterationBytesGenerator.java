...
public class KDFDoublePipelineIterationBytesGenerator implements MacDerivationFunction {
    ...
    public KDFDoublePipelineIterationBytesGenerator(Mac mac) {
        ...
        this.f7552h = macSize;
        this.f7551a = new byte[macSize];
        this.f7553k = new byte[macSize];
    }
    ...
    private void generateNext() throws IllegalStateException, DataLengthException {
        if (this.generatedBytes == 0) {
            ...
            this.prf.doFinal(this.f7551a, 0);
        } else {
            Mac mac2 = this.prf;
            byte[] bArr2 = this.f7551a;
        ...
        if (this.useCounter) {
            int i = (this.generatedBytes / this.f7552h) + 1;
            byte[] bArr4 = this.ios;
        ...
        this.prf.doFinal(this.f7553k, 0);
    }
    ...
    public int generateBytes(byte[] bArr, int i, int i2) throws IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        System.arraycopy(this.f7553k, i7, bArr, i, iMin);
        ...
        while (true) {
            ...
            generateNext();
            iMin = Math.min(this.f7552h, i8);
            System.arraycopy(this.f7553k, 0, bArr, i, iMin);
            this.generatedBytes += iMin;
            i8 -= iMin;
        }
    }
    ...
    public void init(DerivationParameters derivationParameters) throws IllegalArgumentException {
        ...
        if (kDFDoublePipelineIterationParameters.useCounter()) {
            BigInteger bigIntegerMultiply = TWO.pow(r).multiply(BigInteger.valueOf(this.f7552h));

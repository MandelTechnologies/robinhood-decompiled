...
public class ECKeyPairGenerator implements AsymmetricCipherKeyPairGenerator, ECConstants {
    ...
    public AsymmetricCipherKeyPair generateKeyPair() {
        ...
        while (true) {
            ...
            if (bigIntegerCreateRandomBigInteger.compareTo(ECConstants.ONE) >= 0 && bigIntegerCreateRandomBigInteger.compareTo(n) < 0 && WNafUtil.getNafWeight(bigIntegerCreateRandomBigInteger) >= i) {

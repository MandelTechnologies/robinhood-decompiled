...
public class Argon2BytesGenerator {
    ...
    private static class Block {
        ...
        private Block() {
            this.f7540v = new long[128];
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void copyBlock(Block block) {
            System.arraycopy(block.f7540v, 0, this.f7540v, 0, 128);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void xor(Block block, Block block2) {
            long[] jArr = this.f7540v;
            long[] jArr2 = block.f7540v;
            long[] jArr3 = block2.f7540v;
            for (int i = 0; i < 128; i++) {
        ...
        void fromBytes(byte[] bArr) {
            ...
            Pack.littleEndianToLong(bArr, 0, this.f7540v);
        }
        ...
        void toBytes(byte[] bArr) {
            ...
            Pack.longToLittleEndian(this.f7540v, bArr, 0);
        }
    }
    ...
    private static class FillBlock {
        ...
        private FillBlock() {
            this.f7541R = new Block();
            this.f7542Z = new Block();
        ...
        private void applyBlake() {
            for (int i = 0; i < 8; i++) {
                int i2 = i * 16;
                Argon2BytesGenerator.roundFunction(this.f7542Z, i2, i2 + 1, i2 + 2, i2 + 3, i2 + 4, i2 + 5, i2 + 6, i2 + 7, i2 + 8, i2 + 9, i2 + 10, i2 + 11, i2 + 12, i2 + 13, i2 + 14, i2 + 15);
            }
            for (int i3 = 0; i3 < 8; i3++) {
                int i4 = i3 * 2;
                Argon2BytesGenerator.roundFunction(this.f7542Z, i4, i4 + 1, i4 + 16, i4 + 17, i4 + 32, i4 + 33, i4 + 48, i4 + 49, i4 + 64, i4 + 65, i4 + 80, i4 + 81, i4 + 96, i4 + 97, i4 + 112, i4 + 113);
            }
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void fillBlock(Block block, Block block2) {
            this.f7542Z.copyBlock(block);
            applyBlake();
            block2.xor(block, this.f7542Z);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void fillBlock(Block block, Block block2, Block block3) {
            this.f7541R.xor(block, block2);
            this.f7542Z.copyBlock(this.f7541R);
            applyBlake();
            block3.xor(this.f7541R, this.f7542Z);
        }
        ...
        public void fillBlockWithXor(Block block, Block block2, Block block3) {
            ...
            this.f7542Z.copyBlock(this.f7541R);
            applyBlake();
            block3.xorWith(this.f7541R, this.f7542Z);
        }
    }
    ...
    /* renamed from: F */
    private static void m3953F(long[] jArr, int i, int i2, int i3, int i4) {
    ...
    private void fillSegment(FillBlock fillBlock, Position position) {
        ...
        while (true) {
            ...
            long pseudoRandom = getPseudoRandom(fillBlock2, startingIndex, block, block2, i3, zIsDataIndependentAddressing);
    ...
    private long getPseudoRandom(FillBlock fillBlock, int i, Block block, Block block2, int i2, boolean z) {
        if (!z) {
            return this.memory[i2].f7540v[0];
        }
        int i3 = i % 128;
        if (i3 == 0) {
            nextAddresses(fillBlock, block2, block);
        }
        return block.f7540v[i3];
    }
    ...
    private void initAddressBlocks(FillBlock fillBlock, Position position, Block block, Block block2) {
        block.f7540v[0] = intToLong(position.pass);
        block.f7540v[1] = intToLong(position.lane);
        block.f7540v[2] = intToLong(position.slice);
        block.f7540v[3] = intToLong(this.memory.length);
        block.f7540v[4] = intToLong(this.parameters.getIterations());
        block.f7540v[5] = intToLong(this.parameters.getType());
    ...
    public static void roundFunction(Block block, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16) {
        long[] jArr = block.f7540v;
        m3953F(jArr, i, i5, i9, i13);
        m3953F(jArr, i2, i6, i10, i14);
        m3953F(jArr, i3, i7, i11, i15);
        m3953F(jArr, i4, i8, i12, i16);
        m3953F(jArr, i, i6, i11, i16);
        m3953F(jArr, i2, i7, i12, i13);
        m3953F(jArr, i3, i8, i9, i14);
        m3953F(jArr, i4, i5, i10, i15);
    }

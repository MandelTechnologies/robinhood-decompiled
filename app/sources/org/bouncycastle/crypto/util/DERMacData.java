...
public final class DERMacData {
    ...
    static /* synthetic */ class C478641 {
    ...
    public static final class Builder {
        ...
        public DERMacData build() {
            int i = C478641.$SwitchMap$org$bouncycastle$crypto$util$DERMacData$Type[this.f10838type.ordinal()];
            C478641 c478641 = null;
            if (i == 1 || i == 2) {
                return new DERMacData(concatenate(this.f10838type.getHeader(), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.ephemDataU), DerUtil.toByteArray(this.ephemDataV), this.text), c478641);
            }
            if (i == 3 || i == 4) {
                return new DERMacData(concatenate(this.f10838type.getHeader(), DerUtil.toByteArray(this.idV), DerUtil.toByteArray(this.idU), DerUtil.toByteArray(this.ephemDataV), DerUtil.toByteArray(this.ephemDataU), this.text), c478641);
            }
    ...
    /* synthetic */ DERMacData(byte[] bArr, C478641 c478641) {
        this(bArr);
    }

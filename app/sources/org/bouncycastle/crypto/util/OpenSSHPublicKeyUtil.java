    ...
    public static AsymmetricKeyParameter parsePublicKey(SSHBuffer sSHBuffer) {
        ...
        if (RSA.equals(string2)) {
            ...
            if (DSS.equals(string2)) {
                ...
                ASN1ObjectIdentifier byName = SSHNamedCurves.getByName(string3);
                X9ECParameters parameters = SSHNamedCurves.getParameters(byName);
                if (parameters == null) {
                    throw new IllegalStateException("unable to find curve for " + string2 + " using curve name " + string3);
                }
            ...
            } else if (ED_25519.equals(string2)) {

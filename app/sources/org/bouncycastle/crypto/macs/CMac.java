...
public class CMac implements Mac {
    ...
    private static byte[] lookupPoly(int i) {
        int i2 = i * 8;
        int i3 = EnumC7081g.SDK_ASSET_ILLUSTRATION_DEV_RAISE_INSTITUTION_VALUE;
        switch (i2) {
            case 64:
            ...
            case 448:
                ...
                break;
            case 512:
                i3 = EnumC7081g.SDK_ASSET_ILLUSTRATION_EXIT_BRUSHSTROKE_VALUE;
                break;
            case 768:
                i3 = 655377;
                break;

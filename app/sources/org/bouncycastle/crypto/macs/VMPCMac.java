...
public class VMPCMac implements Mac {
    ...
    /* renamed from: x1 */
    private byte f7595x1;

    /* renamed from: x2 */
    private byte f7596x2;

    /* renamed from: x3 */
    private byte f7597x3;

    /* renamed from: x4 */
    private byte f7598x4;

    /* renamed from: n */
    private byte f7593n = 0;

    /* renamed from: P */
    private byte[] f7590P = null;

    /* renamed from: s */
    private byte f7594s = 0;

    private void initKey(byte[] bArr, byte[] bArr2) {
        this.f7594s = (byte) 0;
        this.f7590P = new byte[256];
        for (int i = 0; i < 256; i++) {
            this.f7590P[i] = (byte) i;
        }
        for (int i2 = 0; i2 < 768; i2++) {
            byte[] bArr3 = this.f7590P;
            byte b = this.f7594s;
            int i3 = i2 & 255;
            byte b2 = bArr3[i3];
    ...
    public int doFinal(byte[] bArr, int i) throws IllegalStateException, DataLengthException {
        for (int i2 = 1; i2 < 25; i2++) {
            byte[] bArr2 = this.f7590P;
            byte b = this.f7594s;
            byte b2 = this.f7593n;
            byte b3 = bArr2[(b + bArr2[b2 & 255]) & 255];
            this.f7594s = b3;
            byte b4 = this.f7598x4;
            byte b5 = this.f7597x3;
            byte b6 = bArr2[(b4 + b5 + i2) & 255];
            this.f7598x4 = b6;
            byte b7 = this.f7596x2;
            byte b8 = bArr2[(b5 + b7 + i2) & 255];
            this.f7597x3 = b8;
            byte b9 = this.f7595x1;
            byte b10 = bArr2[(b7 + b9 + i2) & 255];
            this.f7596x2 = b10;
            byte b11 = bArr2[(b9 + b3 + i2) & 255];
            this.f7595x1 = b11;
            byte[] bArr3 = this.f7591T;
            byte b12 = this.f7592g;
            ...
            this.f7592g = (byte) ((b12 + 4) & 31);
            byte b13 = bArr2[b2 & 255];
            bArr2[b2 & 255] = bArr2[b3 & 255];
            bArr2[b3 & 255] = b13;
            this.f7593n = (byte) ((b2 + 1) & 255);
        }
        for (int i3 = 0; i3 < 768; i3++) {
            byte[] bArr4 = this.f7590P;
            byte b14 = this.f7594s;
            int i4 = i3 & 255;
            byte b15 = bArr4[i4];
            byte b16 = bArr4[(b14 + b15 + this.f7591T[i3 & 31]) & 255];
            this.f7594s = b16;
        ...
        for (int i5 = 0; i5 < 20; i5++) {
            byte[] bArr6 = this.f7590P;
            int i6 = i5 & 255;
            byte b17 = bArr6[(this.f7594s + bArr6[i6]) & 255];
            this.f7594s = b17;
    ...
    public void update(byte b) throws IllegalStateException {
        ...
        byte b6 = this.f7598x4;
        byte b7 = this.f7597x3;
        byte b8 = bArr[(b6 + b7) & 255];
        this.f7598x4 = b8;
        byte b9 = this.f7596x2;
        byte b10 = bArr[(b7 + b9) & 255];
        this.f7597x3 = b10;
        byte b11 = this.f7595x1;
        byte b12 = bArr[(b9 + b11) & 255];
        this.f7596x2 = b12;
        byte b13 = bArr[(b11 + b4 + b5) & 255];
        this.f7595x1 = b13;
        byte[] bArr2 = this.f7591T;
        byte b14 = this.f7592g;
        ...
        this.f7592g = (byte) ((b14 + 4) & 31);
        byte b15 = bArr[b3 & 255];
        bArr[b3 & 255] = bArr[b4 & 255];
        bArr[b4 & 255] = b15;
        this.f7593n = (byte) ((b3 + 1) & 255);
    }

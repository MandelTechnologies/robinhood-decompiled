...
public class Blake3Digest implements ExtendedDigest, Memoable, Xof {
    ...
    /* renamed from: IV */
    private static final int[] f7284IV = {1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225};
    ...
    private void initChunkBlock(int i, boolean z) {
        ...
        System.arraycopy(f7284IV, 0, this.theV, 8, 4);
        int[] iArr = this.theV;
    ...
    private void initNullKey() {
        System.arraycopy(f7284IV, 0, this.theK, 0, 8);
    }

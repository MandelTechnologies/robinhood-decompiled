...
public class DualECSP800DRBG implements SP80090DRBG {
    ...
    /* renamed from: _P */
    private ECPoint f7722_P;

    /* renamed from: _Q */
    private ECPoint f7723_Q;
    private ECCurve.C47948Fp _curve;
    ...
    static {
        ...
        nistPoints = new DualECPoints[]{new DualECPoints(128, c47948Fp.createPoint(bigInteger, bigInteger2), c47948Fp.createPoint(bigInteger3, bigInteger4), 1), new DualECPoints(192, c47948Fp.createPoint(bigInteger5, bigInteger6), c47948Fp.createPoint(bigInteger7, bigInteger8), 1), new DualECPoints(256, c47948Fp.createPoint(bigInteger9, bigInteger10), c47948Fp.createPoint(bigInteger11, bigInteger12), 1)};
        ECCurve.C47948Fp c47948Fp = (ECCurve.C47948Fp) NISTNamedCurves.getByName("P-256").getCurve();
        ECCurve.C47948Fp c47948Fp2 = (ECCurve.C47948Fp) NISTNamedCurves.getByName("P-384").getCurve();
        ECCurve.C47948Fp c47948Fp3 = (ECCurve.C47948Fp) NISTNamedCurves.getByName("P-521").getCurve();
    }
    ...
    */
    public DualECSP800DRBG(DualECPoints[] dualECPointsArr, Digest digest, int i, EntropySource entropySource, byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i > dualECPointsArr[i2].getSecurityStrength()) {
                ...
                this.f7722_P = dualECPointsArr[i2].getP();
                this.f7723_Q = dualECPointsArr[i2].getQ();
            }
        }
    }
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z) {
        ...
        BigInteger bigInteger = bArr2 != null ? new BigInteger(1, xor(this.f7724_s, Utils.hash_df(this._digest, bArr2, this._seedlen))) : new BigInteger(1, this.f7724_s);
        int length3 = 0;
        Arrays.fill(bArr, (byte) 0);
        int length4 = 0;
        for (int i = 0; i < length2; i++) {
            bigInteger = getScalarMultipleXCoord(this.f7722_P, bigInteger);
            byte[] byteArray = getScalarMultipleXCoord(this.f7723_Q, bigInteger).toByteArray();
        ...
        if (length4 < bArr.length) {
            bigInteger = getScalarMultipleXCoord(this.f7722_P, bigInteger);
            byte[] byteArray2 = getScalarMultipleXCoord(this.f7723_Q, bigInteger).toByteArray();
        ...
        this.f7724_s = BigIntegers.asUnsignedByteArray(this._sLength, getScalarMultipleXCoord(this.f7722_P, bigInteger));
        return length;
    }
    ...
    public void reseed(byte[] bArr) {
        ...
        this.f7724_s = Utils.hash_df(this._digest, Arrays.concatenate(pad8(this.f7724_s, this._seedlen), getEntropy(), bArr), this._seedlen);

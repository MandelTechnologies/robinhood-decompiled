...
class SP80038G {
    ...
    protected static BigInteger calculateY_FF1(BlockCipher blockCipher, BigInteger bigInteger, byte[] bArr, int i, int i2, int i3, byte[] bArr2, short[] sArr) throws IllegalStateException, DataLengthException {
        int length = bArr.length;
        byte[] bArrAsUnsignedByteArray = BigIntegers.asUnsignedByteArray(num(bigInteger, sArr));
    ...
    protected static BigInteger calculateY_FF3(BlockCipher blockCipher, BigInteger bigInteger, byte[] bArr, int i, int i2, short[] sArr) throws IllegalStateException, DataLengthException {
    ...
    static short[] decFF1(BlockCipher blockCipher, int i, byte[] bArr, int i2, int i3, int i4, short[] sArr, short[] sArr2) throws IllegalStateException, DataLengthException {
        int length = bArr.length;
        int iCeil = (((int) Math.ceil((Math.log(i) * i4) / LOG2)) + 7) / 8;
        int i5 = (((iCeil + 3) / 4) * 4) + 4;
        byte[] bArrCalculateP_FF1 = calculateP_FF1(i, (byte) i3, i2, length);
        BigInteger bigIntegerValueOf = BigInteger.valueOf(i);
        BigInteger[] bigIntegerArrCalculateModUV = calculateModUV(bigIntegerValueOf, i3, i4);
        int i6 = 9;
        short[] sArr3 = sArr;
        short[] sArr4 = sArr2;
        int i7 = i3;
        while (i6 >= 0) {
            ...
            int i9 = i5;
            int i10 = i6;
            BigInteger bigInteger = bigIntegerValueOf;
            i7 = i2 - i7;
            str(bigInteger, num(bigInteger, sArr4).subtract(calculateY_FF1(blockCipher, bigInteger, bArr, i8, i9, i10, bArrCalculateP_FF1, sArr3)).mod(bigIntegerArrCalculateModUV[i10 & 1]), i7, sArr4, 0);
            i6 = i10 - 1;
            bigIntegerValueOf = bigInteger;
            short[] sArr5 = sArr4;
            sArr4 = sArr3;
            sArr3 = sArr5;
            i5 = i9;
    ...
    private static short[] decFF3_1(BlockCipher blockCipher, int i, byte[] bArr, int i2, int i3, int i4, short[] sArr, short[] sArr2) throws IllegalStateException, DataLengthException {
        BigInteger bigIntegerValueOf = BigInteger.valueOf(i);
        BigInteger[] bigIntegerArrCalculateModUV = calculateModUV(bigIntegerValueOf, i3, i4);
        rev(sArr);
        rev(sArr2);
        ...
        while (i5 >= 0) {
            ...
            byte[] bArr2 = bArr;
            str(bigIntegerValueOf, num(bigIntegerValueOf, sArr4).subtract(calculateY_FF3(blockCipher2, bigIntegerValueOf, bArr2, 4 - (i6 * 4), i5, sArr3)).mod(bigIntegerArrCalculateModUV[1 - i6]), i4, sArr4, 0);
            i5--;
            short[] sArr5 = sArr3;
            sArr3 = sArr4;
            sArr4 = sArr5;
    ...
    private static short[] encFF1(BlockCipher blockCipher, int i, byte[] bArr, int i2, int i3, int i4, short[] sArr, short[] sArr2) throws IllegalStateException, DataLengthException {
        int length = bArr.length;
        int iCeil = (((int) Math.ceil((Math.log(i) * i4) / LOG2)) + 7) / 8;
        int i5 = (((iCeil + 3) / 4) * 4) + 4;
        byte[] bArrCalculateP_FF1 = calculateP_FF1(i, (byte) i3, i2, length);
        ...
        while (i7 < 10) {
            BigInteger bigInteger = bigIntegerValueOf;
            i6 = i2 - i6;
            str(bigInteger, num(bigInteger, sArr3).add(calculateY_FF1(blockCipher, bigInteger, bArr, iCeil, i5, i7, bArrCalculateP_FF1, sArr4)).mod(bigIntegerArrCalculateModUV[i7 & 1]), i6, sArr3, 0);
            i7++;
            short[] sArr5 = sArr3;
            sArr3 = sArr4;
            sArr4 = sArr5;
    ...
    private static short[] encFF3_1(BlockCipher blockCipher, int i, byte[] bArr, int i2, int i3, int i4, short[] sArr, short[] sArr2) throws IllegalStateException, DataLengthException {
        BigInteger bigIntegerValueOf = BigInteger.valueOf(i);
        BigInteger[] bigIntegerArrCalculateModUV = calculateModUV(bigIntegerValueOf, i3, i4);
        rev(sArr);
        rev(sArr2);
        ...
        while (i5 < 8) {
            ...
            BlockCipher blockCipher2 = blockCipher;
            byte[] bArr2 = bArr;
            str(bigIntegerValueOf, num(bigIntegerValueOf, sArr).add(calculateY_FF3(blockCipher2, bigIntegerValueOf, bArr2, 4 - (i6 * 4), i5, sArr3)).mod(bigIntegerArrCalculateModUV[1 - i6]), i3, sArr, 0);
            i5++;
            short[] sArr4 = sArr3;
            sArr3 = sArr;
            sArr = sArr4;
    ...
    protected static BigInteger num(BigInteger bigInteger, short[] sArr) {
        BigInteger bigIntegerAdd = BigIntegers.ZERO;
        for (short s : sArr) {
            bigIntegerAdd = bigIntegerAdd.multiply(bigInteger).add(BigInteger.valueOf(s & 65535));
        }
    ...
    protected static byte[] prf(BlockCipher blockCipher, byte[] bArr) throws IllegalStateException, DataLengthException {
        if (bArr.length % 16 != 0) {
            throw new IllegalArgumentException();
        }
    ...
    protected static void str(BigInteger bigInteger, BigInteger bigInteger2, int i, short[] sArr, int i2) {
        ...
        for (int i3 = 1; i3 <= i; i3++) {
            ...
            sArr[(i2 + i) - i3] = (short) bigIntegerArrDivideAndRemainder[1].intValue();

...
public class GOST3410Signer implements DSAExt {
    ...
    public boolean verifySignature(byte[] bArr, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigIntegerModPow = bigInteger3.modPow(parameters.getQ().subtract(new BigInteger(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED)), parameters.getQ());

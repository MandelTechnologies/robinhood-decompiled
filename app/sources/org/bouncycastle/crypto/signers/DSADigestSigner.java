...
public class DSADigestSigner implements Signer {
    ...
    public byte[] generateSignature() {
        ...
        try {
            return this.f10836encoding.encode(getOrder(), bigIntegerArrGenerateSignature[0], bigIntegerArrGenerateSignature[1]);
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        try {
            BigInteger[] bigIntegerArrDecode = this.f10836encoding.decode(getOrder(), bArr);

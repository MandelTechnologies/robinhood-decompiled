...
public class SM2Signer implements Signer, ECConstants {
    ...
    private final DSAEncoding f10837encoding;
    ...
    public SM2Signer(DSAEncoding dSAEncoding) {
        ...
        this.f10837encoding = dSAEncoding;
        ...
        while (true) {
            ...
            if (!bigIntegerMod.equals(bigInteger) && !bigIntegerMod.add(bigIntegerNextK).equals(n)) {
                ...
                if (!bigIntegerMod2.equals(bigInteger)) {
                    try {
                        return this.f10837encoding.encode(this.ecParams.getN(), bigIntegerMod, bigIntegerMod2);
                    } catch (Exception e) {
    ...
    public boolean verifySignature(byte[] bArr) {
        try {
            BigInteger[] bigIntegerArrDecode = this.f10837encoding.decode(this.ecParams.getN(), bArr);

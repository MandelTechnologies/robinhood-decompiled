...
public final class CryptoServicesRegistrar {
    ...
    public static final class Property {
        ...
        private final Class f10830type;
    ...
    public static <T> T getSizedProperty(Property property, int i) {
        ...
        int i2 = 0;
        if (property.f10830type.isAssignableFrom(DHParameters.class)) {
        ...
        } else if (property.f10830type.isAssignableFrom(DSAParameters.class)) {
            while (i2 != objArrLookupProperty.length) {
    ...
    private static <T> void localSetGlobalProperty(Property property, T... tArr) {
        if (!property.f10830type.isAssignableFrom(tArr[0].getClass())) {

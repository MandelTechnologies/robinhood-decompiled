...
class CrlCache {
    ...
    private static Map<URI, WeakReference<PKIXCRLStore>> f10849cache = Collections.synchronizedMap(new WeakHashMap());
    ...
    static synchronized PKIXCRLStore getCrl(CertificateFactory certificateFactory, Date date, URI uri) throws IOException, CRLException {
        try {
            WeakReference<PKIXCRLStore> weakReference = f10849cache.get(uri);
            ...
            f10849cache.put(uri, new WeakReference<>(localCRLStore));

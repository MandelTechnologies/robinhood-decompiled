...
import org.bouncycastle.asn1.p518x9.X962Parameters;
import org.bouncycastle.asn1.p518x9.X9ECParameters;
import org.bouncycastle.asn1.p518x9.X9ECPoint;
import org.bouncycastle.asn1.p518x9.X9IntegerConverter;
...
public class JCEECPublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public JCEECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f7777q = EC5Util.convertPoint(params, eCPublicKeySpec.getW());
    }

    public JCEECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters) {
        this.algorithm = str;
        this.f7777q = eCPublicKeyParameters.getQ();
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(String str, JCEECPublicKey jCEECPublicKey) {
        this.algorithm = str;
        this.f7777q = jCEECPublicKey.f7777q;
    ...
    public JCEECPublicKey(String str, org.bouncycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.algorithm = str;
        this.f7777q = eCPublicKeySpec.getQ();
        if (eCPublicKeySpec.getParams() != null) {
            ...
            if (this.f7777q.getCurve() == null) {
                this.f7777q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f7777q.getAffineXCoord().toBigInteger(), this.f7777q.getAffineYCoord().toBigInteger());
            }
    ...
    public JCEECPublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f7777q = EC5Util.convertPoint(params, eCPublicKey.getW());
    }
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (algorithm.getAlgorithm().equals((ASN1Primitive) CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            try {
                ...
                this.f7777q = curve2.decodePoint(bArr);
        ...
        this.f7777q = new X9ECPoint(curve, dEROctetString).getPoint();
    }
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger bigInteger = this.f7777q.getAffineXCoord().toBigInteger();
            BigInteger bigInteger2 = this.f7777q.getAffineYCoord().toBigInteger();
    ...
    public ECPoint getQ() {
        return this.ecSpec == null ? this.f7777q.getDetachedPoint() : this.f7777q;
    }

    @Override // java.security.interfaces.ECPublicKey
    public java.security.spec.ECPoint getW() {
        return EC5Util.convertPoint(this.f7777q);
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f7777q.getAffineXCoord().toBigInteger().toString(16));
        stringBuffer.append(strLineSeparator);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f7777q.getAffineYCoord().toBigInteger().toString(16));
        stringBuffer.append(strLineSeparator);

...
public class BrokenJCEBlockCipher implements BrokenPBE {
    ...
    protected int engineDoFinal(byte[] bArr, int i, int i2, byte[] bArr2, int i3) throws IllegalStateException, DataLengthException, BadPaddingException, IllegalBlockSizeException {
        byte[] bArr3;
        int i4;
        int iProcessBytes;
        if (i2 != 0) {
    ...
    protected AlgorithmParameters engineGetParameters() throws NoSuchAlgorithmException, IOException, NoSuchProviderException {
    ...
    protected void engineSetMode(String str) throws NumberFormatException {
        ...
        if (upperCase.equals(BiometricChangeManager.BLOCK_MODE)) {
    ...
    protected byte[] engineUpdate(byte[] bArr, int i, int i2) throws IllegalStateException, DataLengthException {

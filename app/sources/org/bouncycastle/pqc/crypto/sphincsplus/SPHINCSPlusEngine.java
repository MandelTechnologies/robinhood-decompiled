...
abstract class SPHINCSPlusEngine {
    ...
    static class Sha256Engine extends SPHINCSPlusEngine {
        ...
        /* renamed from: F */
        public byte[] mo3977F(byte[] bArr, ADRS adrs, byte[] bArr2) throws DataLengthException, IllegalArgumentException {
            ...
            return Arrays.copyOfRange(this.digestBuf, 0, this.f8062N);
        }

        @Override // org.bouncycastle.pqc.crypto.sphincsplus.SPHINCSPlusEngine
        /* renamed from: H */
        public byte[] mo3978H(byte[] bArr, ADRS adrs, byte[] bArr2, byte[] bArr3) throws DataLengthException, IllegalArgumentException {
            ...
            this.treeDigest.update(bArr, 0, bArr.length);
            this.treeDigest.update(this.padding, 0, 64 - this.f8062N);
            this.treeDigest.update(bArrCompressedADRS, 0, bArrCompressedADRS.length);
        ...
        IndexedDigest H_msg(byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) throws DataLengthException, IllegalArgumentException {
            int i = ((this.f8058A * this.f8061K) + 7) / 8;
            int i2 = this.f8060H;
            int i3 = i2 / this.f8059D;
            int i4 = i2 - i3;
            int i5 = (i3 + 7) / 8;
            int i6 = (i4 + 7) / 8;
        ...
        public byte[] PRF_msg(byte[] bArr, byte[] bArr2, byte[] bArr3) {
            ...
            return Arrays.copyOfRange(this.hmacBuf, 0, this.f8062N);
        }
    ...
    static class Shake256Engine extends SPHINCSPlusEngine {
        ...
        @Override // org.bouncycastle.pqc.crypto.sphincsplus.SPHINCSPlusEngine
        /* renamed from: F */
        byte[] mo3977F(byte[] bArr, ADRS adrs, byte[] bArr2) {
            if (this.robust) {
        ...
        @Override // org.bouncycastle.pqc.crypto.sphincsplus.SPHINCSPlusEngine
        /* renamed from: H */
        byte[] mo3978H(byte[] bArr, ADRS adrs, byte[] bArr2, byte[] bArr3) {
            byte[] bArrConcatenate = Arrays.concatenate(bArr2, bArr3);
            if (this.robust) {
    ...
    /* renamed from: F */
    abstract byte[] mo3977F(byte[] bArr, ADRS adrs, byte[] bArr2);

    /* renamed from: H */
    abstract byte[] mo3978H(byte[] bArr, ADRS adrs, byte[] bArr2, byte[] bArr3);

...
public class GMSSRootSig {
    ...
    private void oneStep() {
        ...
        if (8 % i == 0) {
            ...
            if (i2 == 0) {
                ...
                if (i3 < this.mdsize) {
                    byte[] bArr = this.hash;
                    byte b = bArr[i3];
                    this.test = this.f7967k & b;
                    bArr[i3] = (byte) (b >>> this.f7969w);
                } else {
                    int i4 = this.checksum;
                    this.test = this.f7967k & i4;
                    this.checksum = i4 >>> this.f7969w;
                }
            } else if (i2 > 0) {
        ...
        if (i < 8) {
            ...
            if (i8 == 0) {
                int i9 = this.counter;
                if (i9 % 8 == 0) {
                    int i10 = this.f7966ii;
                    int i11 = this.mdsize;
                    if (i10 < i11) {
                        this.big8 = 0L;
                        if (i9 < ((i11 / i) << 3)) {
                            for (int i12 = 0; i12 < this.f7969w; i12++) {
                                long j2 = this.big8;
                                byte[] bArr6 = this.hash;
                                int i13 = this.f7966ii;
                                this.big8 = j2 ^ ((bArr6[i13] & 255) << (i12 << 3));
                                this.f7966ii = i13 + 1;
                            }
                        } else {
                            for (int i14 = 0; i14 < this.mdsize % this.f7969w; i14++) {
                                long j3 = this.big8;
                                byte[] bArr7 = this.hash;
                                int i15 = this.f7966ii;
                ...
                this.test = (int) (this.big8 & this.f7967k);
                this.privateKeyOTS = this.gmssRandom.nextSeed(this.seed);
            } else if (i8 > 0) {
        ...
        if (i < 57) {
            ...
            if (j4 == 0) {
                ...
                if (i20 < i21) {
                    ...
                    long j5 = j >>> i19;
                    this.big8 = j5;
                    this.test8 = j5 & this.f7967k;
                } else {
                    int i25 = this.checksum;
                    this.test8 = this.f7967k & i25;
                    this.checksum = i25 >>> i;
                }
                this.privateKeyOTS = this.gmssRandom.nextSeed(this.seed);
            } else if (j4 > 0) {
    ...
    public int[] getStatInt() {
        return new int[]{this.counter, this.test, this.f7966ii, this.f7968r, this.steps, this.keysize, this.height, this.f7969w, this.checksum};
    }
    ...
    public void initSign(byte[] bArr, byte[] bArr2) {
        ...
        int log = getLog((this.messagesize << this.f7969w) + 1);
        int i4 = this.f7969w;
        int i5 = 8;
        if (8 % i4 == 0) {
            int i6 = 8 / i4;
            ...
            for (int i7 = 0; i7 < this.mdsize; i7++) {
                for (int i8 = 0; i8 < i6; i8++) {
                    byte b = bArr4[i7];
                    i += this.f7967k & b;
                    bArr4[i7] = (byte) (b >>> this.f7969w);
                }
            }
            int i9 = (this.messagesize << this.f7969w) - i;
            this.checksum = i9;
            int i10 = 0;
            while (i10 < log) {
                i += this.f7967k & i9;
            ...
            for (int i15 = 0; i15 < i12; i15++) {
                long j = 0;
                for (int i16 = 0; i16 < this.f7969w; i16++) {
                    j ^= (bArr4[i13] & 255) << (i16 << 3);
                    i13++;
                }
                int i17 = 0;
                while (i17 < i5) {
                    i14 += (int) (this.f7967k & j);
                    j >>>= this.f7969w;
                    i17++;
                    i5 = i5;
                    i12 = i12;
            ...
            int i18 = this.mdsize % this.f7969w;
            long j2 = 0;
            ...
            int i21 = 0;
            while (i21 < i20) {
                i14 += (int) (this.f7967k & j2);
                int i22 = this.f7969w;
                j2 >>>= i22;
                i21 += i22;
            }
            int i23 = (this.messagesize << this.f7969w) - i14;
            this.checksum = i23;
            int i24 = 0;
            i = i14;
            while (i24 < log) {
            ...
            while (true) {
                ...
                i27 = (int) (i27 + ((j3 >>> i29) & this.f7967k));
            }
            int i32 = i26 >>> 3;
            if (i32 < i2) {
                int i33 = i26 % 8;
                ...
                i27 = (int) (i27 + ((j4 >>> i33) & this.f7967k));
            }
            int i35 = (this.messagesize << this.f7969w) - i27;
            this.checksum = i35;
            int i36 = 0;
            i = i27;
            while (i36 < log) {
        ...
        this.keysize = this.messagesize + ((int) Math.ceil(log / this.f7969w));
    ...
    public String toString() {
        ...
        for (int i = 0; i < 9; i++) {
            str = str + statInt[i] + PlaceholderUtils.XXShortPlaceholderText;
        }
        for (int i2 = 0; i2 < 5; i2++) {
            str = str + new String(Hex.encode(statByte[i2])) + PlaceholderUtils.XXShortPlaceholderText;
        }
        return str;
    }

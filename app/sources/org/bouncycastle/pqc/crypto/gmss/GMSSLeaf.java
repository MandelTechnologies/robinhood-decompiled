...
public class GMSSLeaf {
    ...
    public GMSSLeaf(Digest digest, byte[][] bArr, int[] iArr) {
        ...
        this.gmssRandom = new GMSSRandom(digest);
        this.mdsize = this.messDigestOTS.getDigestSize();
        this.keysize = ((int) Math.ceil((r9 << 3) / this.f7962w)) + ((int) Math.ceil(getLog((r9 << this.f7962w) + 1) / this.f7962w));
        this.two_power_w = 1 << this.f7962w;
    ...
    private GMSSLeaf(GMSSLeaf gMSSLeaf) {
        ...
        this.f7960i = gMSSLeaf.f7960i;
        this.f7961j = gMSSLeaf.f7961j;
        this.two_power_w = gMSSLeaf.two_power_w;
        this.f7962w = gMSSLeaf.f7962w;
    ...
    private void updateLeafCalc() {
        ...
        for (int i = 0; i < this.steps + 10000; i++) {
            int i2 = this.f7960i;
            if (i2 == this.keysize && this.f7961j == this.two_power_w - 1) {
            ...
            if (i2 == 0 || this.f7961j == this.two_power_w - 1) {
                this.f7960i = i2 + 1;
                this.f7961j = 0;
                ...
                int i3 = this.f7961j + 1;
                this.f7961j = i3;
                if (i3 == this.two_power_w - 1) {
                    byte[] bArr5 = this.privateKeyOTS;
                    byte[] bArr6 = this.concHashs;
                    int i4 = this.mdsize;
                    System.arraycopy(bArr5, 0, bArr6, (this.f7960i - 1) * i4, i4);
                }
            }
        }
        throw new IllegalStateException("unable to updateLeaf in steps: " + this.steps + PlaceholderUtils.XXShortPlaceholderText + this.f7960i + PlaceholderUtils.XXShortPlaceholderText + this.f7961j);
    }
    ...
    public int[] getStatInt() {
        return new int[]{this.f7960i, this.f7961j, this.steps, this.f7962w};
    }
    ...
    public String toString() {
        ...
        String str = "";
        for (int i = 0; i < 4; i++) {
            str = str + getStatInt()[i] + PlaceholderUtils.XXShortPlaceholderText;
        }
        String string2 = str + PlaceholderUtils.XXShortPlaceholderText + this.mdsize + PlaceholderUtils.XXShortPlaceholderText + this.keysize + PlaceholderUtils.XXShortPlaceholderText + this.two_power_w + PlaceholderUtils.XXShortPlaceholderText;

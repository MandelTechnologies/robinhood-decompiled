...
public class GMSSRootCalc {
    ...
    public GMSSRootCalc(int i, int i2, GMSSDigestProvider gMSSDigestProvider) {
        ...
        this.retain = new Vector[this.f7965K - 1];
    ...
    public void initialize(Vector vector) {
        int i;
        this.treehash = new Treehash[this.heightOfTree - this.f7965K];
        int i2 = 0;
        while (true) {
            i = this.heightOfTree;
            if (i2 >= i - this.f7965K) {
        ...
        this.retain = new Vector[this.f7965K - 1];
        for (int i4 = 0; i4 < this.f7965K - 1; i4++) {
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < this.heightOfTree + 1 + size; i2++) {
            str = str + new String(Hex.encode(getStatByte()[i2])) + PlaceholderUtils.XXShortPlaceholderText;
        }
    ...
    public void update(byte[] bArr) {
        ...
        } else if (i == 3 && this.heightOfTree > this.f7965K) {
            this.treehash[0].setFirstNode(bArr);
        }
        int i2 = this.index[0];
        if ((i2 - 3) % 2 == 0 && i2 >= 3 && this.heightOfTree == this.f7965K) {
        ...
        while (this.tailStack.size() > 0 && i5 == ((Integer) this.heightOfNodes.lastElement()).intValue()) {
            ...
            if (i5 < this.heightOfTree) {
                ...
                if (i5 >= this.heightOfTree - this.f7965K) {
                    if (i5 == 0) {
                        System.out.println("M���P");
                    }
                    int i8 = this.index[i5];
                    if ((i8 - 3) % 2 == 0 && i8 >= 3) {
                        this.retain[i5 - (this.heightOfTree - this.f7965K)].insertElementAt(bArr2, 0);
                    }
    ...
    public void update(byte[] bArr, byte[] bArr2) {
        ...
        if (i < this.heightOfTree - this.f7965K && this.indexForNextSeed - 2 == this.index[0]) {

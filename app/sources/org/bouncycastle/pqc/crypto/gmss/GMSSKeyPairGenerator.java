...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private AsymmetricCipherKeyPair genKeyPair() {
        ...
        while (true) {
            ...
            treehashArr[i4] = new Treehash[i6 - this.f7959K[i4]];
            if (i4 > 0) {
                int i7 = i4 - 1;
                int[] iArr2 = new int[2];
                ...
                treehashArr2[i7] = new Treehash[this.heightOfTrees[i4] - this.f7959K[i4]];
            }
    ...
    private GMSSRootCalc generateCurrentAuthpathAndRoot(byte[] bArr, Vector vector, byte[] bArr2, int i) {
        ...
        GMSSRootCalc gMSSRootCalc = new GMSSRootCalc(this.heightOfTrees[i], this.f7959K[i], this.digestProvider);

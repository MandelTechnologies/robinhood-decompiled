...
public class HSSPublicKeyParameters extends LMSKeyParameters implements LMSContextBasedVerifier {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f7973l != hSSPublicKeyParameters.f7973l) {
            return false;
        }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.f7973l).bytes(this.lmsPublicKey.getEncoded()).build();
    }
    ...
    public int hashCode() {
        return (this.f7973l * 31) + this.lmsPublicKey.hashCode();
    }

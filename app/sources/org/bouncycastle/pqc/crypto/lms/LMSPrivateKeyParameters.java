...
public class LMSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
    ...
    /* renamed from: T1 */
    private static CacheKey f7986T1;
    private static CacheKey[] internedKeys;

    /* renamed from: I */
    private final byte[] f7987I;
    ...
    static {
        ...
        f7986T1 = cacheKey;
        CacheKey[] cacheKeyArr = new CacheKey[EnumC7081g.SDK_ASSET_ILLUSTRATION_FORM_VALUE];
    ...
    private LMSPrivateKeyParameters(LMSPrivateKeyParameters lMSPrivateKeyParameters, int i, int i2) {
        ...
        this.f7988q = i;
        this.f7987I = lMSPrivateKeyParameters.f7987I;
        this.maxQ = i2;
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f7988q != lMSPrivateKeyParameters.f7988q || this.maxQ != lMSPrivateKeyParameters.maxQ || !Arrays.areEqual(this.f7987I, lMSPrivateKeyParameters.f7987I)) {
            return false;
        }
    ...
    LMOtsPrivateKey getCurrentOTSKey() {
        ...
        synchronized (this) {
            try {
                ...
                lMOtsPrivateKey = new LMOtsPrivateKey(this.otsParameters, this.f7987I, i, this.masterSecret);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(0).u32str(this.parameters.getType()).u32str(this.otsParameters.getType()).bytes(this.f7987I).u32str(this.f7988q).u32str(this.maxQ).u32str(this.masterSecret.length).bytes(this.masterSecret).build();
    }

    public byte[] getI() {
        return Arrays.clone(this.f7987I);
    }
        ...
        synchronized (this) {
            try {
                if (this.publicKey == null) {
                    this.publicKey = new LMSPublicKeyParameters(this.parameters, this.otsParameters, findT(f7986T1), this.f7987I);
                }
    ...
    public long getUsagesRemaining() {
        return this.maxQ - this.f7988q;
    }

    public int hashCode() {
        int iHashCode = ((this.f7988q * 31) + Arrays.hashCode(this.f7987I)) * 31;
        LMSigParameters lMSigParameters = this.parameters;

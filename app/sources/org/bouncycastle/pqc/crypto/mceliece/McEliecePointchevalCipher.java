...
public class McEliecePointchevalCipher implements MessageEncryptor {
    ...
    private void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f8026n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f8025k = mcElieceCCA2PrivateKeyParameters.getK();
        this.f8028t = mcElieceCCA2PrivateKeyParameters.getT();
    }

    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        this.messDigest = Utils.getDigest(mcElieceCCA2PublicKeyParameters.getDigest());
        this.f8026n = mcElieceCCA2PublicKeyParameters.getN();
        this.f8025k = mcElieceCCA2PublicKeyParameters.getK();
        this.f8028t = mcElieceCCA2PublicKeyParameters.getT();
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (!z) {
            ...
            if (!(cipherParameters instanceof ParametersWithRandom)) {
                this.f8027sr = CryptoServicesRegistrar.getSecureRandom();
            ...
            this.f8027sr = parametersWithRandom.getRandom();
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException, ArrayIndexOutOfBoundsException {
        ...
        int i = (this.f8026n + 7) >> 3;
        int length = bArr.length - i;
        byte[][] bArrSplit = ByteUtils.split(bArr, i);
        byte[] bArr2 = bArrSplit[0];
        byte[] bArr3 = bArrSplit[1];
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f8026n, bArr2));
        ...
        if (Conversions.encode(this.f8026n, this.f8028t, bArr5).equals(gF2Vector)) {
            return ByteUtils.split(bArr4, length - (this.f8025k >> 3))[0];
        }
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        this.f8027sr.nextBytes(bArr2);
        GF2Vector gF2Vector = new GF2Vector(this.f8025k, this.f8027sr);
        ...
        byte[] encoded2 = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, gF2Vector, Conversions.encode(this.f8026n, this.f8028t, bArr3)).getEncoded();
        DigestRandomGenerator digestRandomGenerator = new DigestRandomGenerator(new SHA1Digest());
        digestRandomGenerator.addSeedMaterial(encoded);

...
public class McElieceKobaraImaiCipher implements MessageEncryptor {
    ...
    private void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f8019n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f8018k = mcElieceCCA2PrivateKeyParameters.getK();
        this.f8021t = mcElieceCCA2PrivateKeyParameters.getT();
    }

    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        this.messDigest = Utils.getDigest(mcElieceCCA2PublicKeyParameters.getDigest());
        this.f8019n = mcElieceCCA2PublicKeyParameters.getN();
        this.f8018k = mcElieceCCA2PublicKeyParameters.getK();
        this.f8021t = mcElieceCCA2PublicKeyParameters.getT();
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (!z) {
            ...
            if (!(cipherParameters instanceof ParametersWithRandom)) {
                this.f8020sr = CryptoServicesRegistrar.getSecureRandom();
            ...
            this.f8020sr = parametersWithRandom.getRandom();
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException, ArrayIndexOutOfBoundsException {
        ...
        int i2 = this.f8018k >> 3;
        int iBitLength = (IntegerFunctions.binomial(this.f8019n, this.f8021t).bitLength() - 1) >> 3;
        ...
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f8019n, bArr));
        ...
        byte[] bArrDecode = Conversions.decode(this.f8019n, this.f8021t, gF2Vector);
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        byte[] encoded = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, GF2Vector.OS2VP(this.f8018k, bArr9), Conversions.encode(this.f8019n, this.f8021t, bArr8)).getEncoded();

...
public class Layer {
    ...
    public Layer(int i, int i2, SecureRandom secureRandom) {
        ...
        this.coeff_gamma = (short[][]) Array.newInstance((Class<?>) cls, this.f8040oi, this.viNext);
        int i6 = this.f8040oi;
        this.coeff_eta = new short[i6];
        for (int i7 = 0; i7 < i6; i7++) {
            for (int i8 = 0; i8 < this.f8040oi; i8++) {
                for (int i9 = 0; i9 < this.f8041vi; i9++) {
                    this.coeff_alpha[i7][i8][i9] = (short) (secureRandom.nextInt() & 255);
                }
            }
        }
        for (int i10 = 0; i10 < i6; i10++) {
            for (int i11 = 0; i11 < this.f8041vi; i11++) {
                for (int i12 = 0; i12 < this.f8041vi; i12++) {
    ...
    public boolean equals(Object obj) {
        if (obj != null && (obj instanceof Layer)) {
            ...
            if (this.f8041vi == layer.getVi() && this.viNext == layer.getViNext() && this.f8040oi == layer.getOi() && RainbowUtil.equals(this.coeff_alpha, layer.getCoeffAlpha()) && RainbowUtil.equals(this.coeff_beta, layer.getCoeffBeta()) && RainbowUtil.equals(this.coeff_gamma, layer.getCoeffGamma()) && RainbowUtil.equals(this.coeff_eta, layer.getCoeffEta())) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return (((((((((((this.f8041vi * 37) + this.viNext) * 37) + this.f8040oi) * 37) + Arrays.hashCode(this.coeff_alpha)) * 37) + Arrays.hashCode(this.coeff_beta)) * 37) + Arrays.hashCode(this.coeff_gamma)) * 37) + Arrays.hashCode(this.coeff_eta);
    }
    ...
    public short[][] plugInVinegars(short[] sArr) {
        ...
        short[] sArr3 = new short[this.f8040oi];
        for (int i3 = 0; i3 < this.f8040oi; i3++) {
            for (int i4 = 0; i4 < this.f8041vi; i4++) {
                for (int i5 = 0; i5 < this.f8041vi; i5++) {
                    sArr3[i3] = GF2Field.addElem(sArr3[i3], GF2Field.multElem(GF2Field.multElem(this.coeff_beta[i3][i4][i5], sArr[i4]), sArr[i5]));
                }
            }
        }
        for (int i6 = 0; i6 < this.f8040oi; i6++) {
            for (int i7 = 0; i7 < this.f8040oi; i7++) {
                for (int i8 = 0; i8 < this.f8041vi; i8++) {

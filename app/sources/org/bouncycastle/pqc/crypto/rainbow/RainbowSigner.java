...
public class RainbowSigner implements MessageSigner {
    ...
    /* renamed from: cf */
    private ComputeInField f8052cf = new ComputeInField();
    RainbowKeyParameters key;
    private SecureRandom random;
    int signableDocumentLength;

    /* renamed from: x */
    private short[] f8053x;

    private short[] initSign(Layer[] layerArr, short[] sArr) throws RuntimeException {
        short[] sArr2 = new short[sArr.length];
        short[] sArrMultiplyMatrix = this.f8052cf.multiplyMatrix(((RainbowPrivateKeyParameters) this.key).getInvA1(), this.f8052cf.addVect(((RainbowPrivateKeyParameters) this.key).getB1(), sArr));
        for (int i = 0; i < layerArr[0].getVi(); i++) {
            this.f8053x[i] = (short) this.random.nextInt();
            short[] sArr3 = this.f8053x;
    ...
    public byte[] generateSignature(byte[] bArr) throws Exception {
        ...
        this.f8053x = new short[((RainbowPrivateKeyParameters) this.key).getInvA2().length];
        ...
        while (true) {
            try {
                ...
                for (int i3 = 0; i3 < length; i3++) {
                    ...
                    short[] sArrSolveEquation = this.f8052cf.solveEquation(layers[i3].plugInVinegars(this.f8053x), sArr);
                    if (sArrSolveEquation == null) {
                        throw new Exception("LES is not solveable!");
                    }
                    for (int i5 = 0; i5 < sArrSolveEquation.length; i5++) {
                        this.f8053x[layers[i3].getVi() + i5] = sArrSolveEquation[i5];
                    }
                }
                short[] sArrMultiplyMatrix = this.f8052cf.multiplyMatrix(((RainbowPrivateKeyParameters) this.key).getInvA2(), this.f8052cf.addVect(((RainbowPrivateKeyParameters) this.key).getB2(), this.f8053x));

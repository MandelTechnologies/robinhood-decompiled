...
class ErrorCorrection {
    ...
    static short LDDecode(int i, int i2, int i3, int i4) {
        return (short) (((((m3969g(i) + m3969g(i2)) + m3969g(i3)) + m3969g(i4)) - 98312) >>> 31);
    }
    ...
    /* renamed from: f */
    static int m3968f(int[] iArr, int i, int i2, int i3) {
        int i4 = (i3 * 2730) >> 25;
    ...
    static void helpRec(short[] sArr, short[] sArr2, byte[] bArr, byte b) {
        ...
        while (i < 256) {
            ...
            int i4 = i + 512;
            int i5 = i + 768;
            int iM3968f = (24577 - (((m3968f(iArr, 0, 4, (sArr2[i] * s) + i2) + m3968f(iArr, 1, 5, (sArr2[i3] * s) + i2)) + m3968f(iArr, 2, 6, (sArr2[i4] * s) + i2)) + m3968f(iArr, 3, 7, (sArr2[i5] * s) + i2))) >> 31;
            int i6 = ~iM3968f;
            int[] iArr2 = {(i6 & iArr[0]) ^ (iArr[4] & iM3968f), (i6 & iArr[1]) ^ (iArr[5] & iM3968f), (i6 & iArr[2]) ^ (iArr[6] & iM3968f), (iArr[7] & iM3968f) ^ (i6 & iArr[3])};
            int i7 = iArr2[0];
            int i8 = iArr2[3];
            sArr[i] = (short) ((i7 - i8) & 3);
            sArr[i3] = (short) ((iArr2[1] - i8) & 3);
            sArr[i4] = (short) ((iArr2[2] - i8) & 3);
            sArr[i5] = (short) (((-iM3968f) + (i8 * 2)) & 3);
            i++;
            s = 8;
        }
    }

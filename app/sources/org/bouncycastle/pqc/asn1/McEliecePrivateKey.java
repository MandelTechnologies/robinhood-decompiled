...
public class McEliecePrivateKey extends ASN1Object {
    ...
    private McEliecePrivateKey(ASN1Sequence aSN1Sequence) {
        this.f7948n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f7947k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f7948n));
        aSN1EncodableVector.add(new ASN1Integer(this.f7947k));

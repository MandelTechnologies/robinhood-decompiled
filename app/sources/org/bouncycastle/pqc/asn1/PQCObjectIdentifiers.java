...
public interface PQCObjectIdentifiers {
    ...
    static {
        ...
        rainbowWithSha1 = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        rainbowWithSha224 = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        rainbowWithSha256 = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        rainbowWithSha384 = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        rainbowWithSha512 = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);
        ASN1ObjectIdentifier aSN1ObjectIdentifier2 = new ASN1ObjectIdentifier(GMSSKeyPairGenerator.OID);
        gmss = aSN1ObjectIdentifier2;
        gmssWithSha1 = aSN1ObjectIdentifier2.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        gmssWithSha224 = aSN1ObjectIdentifier2.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        gmssWithSha256 = aSN1ObjectIdentifier2.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        gmssWithSha384 = aSN1ObjectIdentifier2.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        gmssWithSha512 = aSN1ObjectIdentifier2.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);

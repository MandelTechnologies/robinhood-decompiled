...
public final class GoppaCode {
    ...
    public static class MaMaPe {
        ...
        /* renamed from: h */
        private GF2Matrix f8086h;

        /* renamed from: p */
        private Permutation f8087p;

        /* renamed from: s */
        private GF2Matrix f8088s;

        public MaMaPe(GF2Matrix gF2Matrix, GF2Matrix gF2Matrix2, Permutation permutation) {
            this.f8088s = gF2Matrix;
            this.f8086h = gF2Matrix2;
            this.f8087p = permutation;
        }
    ...
    public static class MatrixSet {
        ...
        /* renamed from: g */
        private GF2Matrix f8089g;
        private int[] setJ;

        public MatrixSet(GF2Matrix gF2Matrix, int[] iArr) {
            this.f8089g = gF2Matrix;
            this.setJ = iArr;
        }

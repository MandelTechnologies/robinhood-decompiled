...
public class GF2Vector extends Vector {
    ...
    public GF2Vector(int i, SecureRandom secureRandom) {
        this.length = i;
        int i2 = (i + 31) >> 5;
        this.f8083v = new int[i2];
        int i3 = i2 - 1;
        for (int i4 = i3; i4 >= 0; i4--) {
            this.f8083v[i4] = secureRandom.nextInt();
        }
        int i5 = i & 31;
        if (i5 != 0) {
            int[] iArr = this.f8083v;
    ...
    public GF2Vector(GF2Vector gF2Vector) {
        ...
        this.f8083v = IntUtils.clone(gF2Vector.f8083v);
    }
    ...
    public Vector add(Vector vector) {
        ...
        int[] iArrClone = IntUtils.clone(gF2Vector.f8083v);
        for (int length = iArrClone.length - 1; length >= 0; length--) {
            iArrClone[length] = iArrClone[length] ^ this.f8083v[length];
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.length == gF2Vector.length && IntUtils.equals(this.f8083v, gF2Vector.f8083v);
    }
    ...
    public GF2Vector extractLeftVector(int i) {
        ...
        int i3 = i >> 5;
        int i4 = i & 31;
        System.arraycopy(this.f8083v, 0, gF2Vector.f8083v, 0, i3);
        if (i4 != 0) {
            gF2Vector.f8083v[i3] = ((1 << i4) - 1) & this.f8083v[i3];
        }
        return gF2Vector;
    }
    ...
    public GF2Vector extractRightVector(int i) {
        ...
        int i8 = 0;
        if (i6 == 0) {
            System.arraycopy(this.f8083v, i5, gF2Vector.f8083v, 0, i7);
            return gF2Vector;
        }
        while (true) {
            i2 = i7 - 1;
            ...
            int[] iArr = gF2Vector.f8083v;
            int[] iArr2 = this.f8083v;
            int i9 = i5 + 1;
            iArr[i8] = (iArr2[i5] >>> i6) | (iArr2[i9] << (32 - i6));
            i8++;
            i5 = i9;
        }
        int[] iArr3 = gF2Vector.f8083v;
        int[] iArr4 = this.f8083v;
        int i10 = i5 + 1;
        int i11 = iArr4[i5] >>> i6;
        iArr3[i2] = i11;
        if (i10 < iArr4.length) {
    ...
    public int getBit(int i) {
        ...
        int i2 = i >> 5;
        int i3 = i & 31;
        return (this.f8083v[i2] & (1 << i3)) >>> i3;
    }

    @Override // org.bouncycastle.pqc.math.linearalgebra.Vector
    public byte[] getEncoded() {
        return LittleEndianConversions.toByteArray(this.f8083v, (this.length + 7) >> 3);
    }
    ...
    @Override // org.bouncycastle.pqc.math.linearalgebra.Vector
    public int hashCode() {
        return (this.length * 31) + Arrays.hashCode(this.f8083v);
    }

    @Override // org.bouncycastle.pqc.math.linearalgebra.Vector
    public boolean isZero() {
        for (int length = this.f8083v.length - 1; length >= 0; length--) {
            if (this.f8083v[length] != 0) {
                return false;
            }
        }
        return true;
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.length; i++) {
            ...
            stringBuffer.append((this.f8083v[i >> 5] & (1 << (i & 31))) == 0 ? '0' : '1');
        }

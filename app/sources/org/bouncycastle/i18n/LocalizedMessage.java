...
public class LocalizedMessage {
    ...
    protected String f10839encoding;
    protected FilteredArguments extraArgs;
    protected Filter filter;

    /* renamed from: id */
    protected final String f7734id;
    ...
    public LocalizedMessage(String str, String str2) throws NullPointerException {
        this.f10839encoding = DEFAULT_ENCODING;
        this.extraArgs = null;
        this.filter = null;
        this.loader = null;
    ...
    protected String formatWithTimeZone(String str, Object[] objArr, Locale locale, TimeZone timeZone) {
        MessageFormat messageFormat = new MessageFormat(PlaceholderUtils.XXShortPlaceholderText);
    ...
    public String getEntry(String str, Locale locale, TimeZone timeZone) throws MissingEntryException {
        ...
        try {
            ...
            String string2 = (classLoader == null ? ResourceBundle.getBundle(this.resource, locale) : ResourceBundle.getBundle(this.resource, locale, classLoader)).getString(str3);
            if (!this.f10839encoding.equals(DEFAULT_ENCODING)) {
                string2 = new String(string2.getBytes(DEFAULT_ENCODING), this.f10839encoding);
            }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f7734id);
        stringBuffer.append("\"");
        ...
        stringBuffer.append(this.f10839encoding);

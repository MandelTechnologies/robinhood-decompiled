...
public interface ISISMTTObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        id_isismtt_cp = aSN1ObjectIdentifierBranch;
        id_isismtt_cp_accredited = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch2 = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        id_isismtt_at = aSN1ObjectIdentifierBranch2;
        id_isismtt_at_dateOfCertGen = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        id_isismtt_at_procuration = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        id_isismtt_at_admission = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        id_isismtt_at_monetaryLimit = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        id_isismtt_at_declarationOfMajority = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);

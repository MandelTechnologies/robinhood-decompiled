...
public interface BSIObjectIdentifiers {
    ...
    static {
        ...
        ecdsa_plain_SHA1 = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        ecdsa_plain_SHA224 = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        ecdsa_plain_SHA256 = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        ecdsa_plain_SHA384 = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        ecdsa_plain_SHA512 = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);
        ...
        algorithm = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        ...
        ecka_eg_X963kdf_SHA1 = aSN1ObjectIdentifierBranch4.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        ecka_eg_X963kdf_SHA224 = aSN1ObjectIdentifierBranch4.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        ecka_eg_X963kdf_SHA256 = aSN1ObjectIdentifierBranch4.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        ecka_eg_X963kdf_SHA384 = aSN1ObjectIdentifierBranch4.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        ecka_eg_X963kdf_SHA512 = aSN1ObjectIdentifierBranch4.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);
        ecka_eg_X963kdf_RIPEMD160 = aSN1ObjectIdentifierBranch4.branch("6");
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch5 = aSN1ObjectIdentifierBranch3.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        ecka_eg_SessionKDF = aSN1ObjectIdentifierBranch5;
        ecka_eg_SessionKDF_3DES = aSN1ObjectIdentifierBranch5.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        ecka_eg_SessionKDF_AES128 = aSN1ObjectIdentifierBranch5.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        ecka_eg_SessionKDF_AES192 = aSN1ObjectIdentifierBranch5.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        ecka_eg_SessionKDF_AES256 = aSN1ObjectIdentifierBranch5.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
    }
}

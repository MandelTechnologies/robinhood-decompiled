...
public interface CMSObjectIdentifiers {
    ...
    static {
        ...
        id_ri_ocsp_response = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        id_ri_scvp = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);

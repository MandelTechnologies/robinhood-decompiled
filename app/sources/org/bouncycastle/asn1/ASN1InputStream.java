...
public class ASN1InputStream extends FilterInputStream implements BERTags {
    ...
    static int readTagNumber(InputStream inputStream, int i) throws IOException {
        ...
        if ((i3 & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) == 0) {
        ...
        while ((i3 & 128) != 0) {
            ...
            i4 = ((i3 & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | i4) << 7;
            i3 = inputStream.read();
            if (i3 < 0) {
                throw new EOFException("EOF found inside tag value.");
            }
        }
        return (i3 & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | i4;
    }

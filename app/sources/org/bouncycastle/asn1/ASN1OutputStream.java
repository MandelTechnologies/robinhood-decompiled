...
public class ASN1OutputStream {
    ...
    /* renamed from: os */
    private OutputStream f7155os;

    ASN1OutputStream(OutputStream outputStream) {
        this.f7155os = outputStream;
    }
    ...
    public static ASN1OutputStream create(OutputStream outputStream, String str) {
        return str.equals(ASN1Encoding.DER) ? new DEROutputStream(outputStream) : str.equals(ASN1Encoding.f7154DL) ? new DLOutputStream(outputStream) : new ASN1OutputStream(outputStream);
    }
    ...
    final void writeIdentifier(boolean z, int i, int i2) throws IOException {
        if (z) {
            ...
            int i3 = 5;
            bArr[5] = (byte) (i2 & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE);
            while (i2 > 127) {
                i2 >>>= 7;
                i3--;
                bArr[i3] = (byte) ((i2 & EnumC7081g.SDK_ASSET_ILLUSTRATION_BRIEFCASE_VALUE) | 128);
            }
            int i4 = i3 - 1;
            bArr[i4] = (byte) (31 | i);
            write(bArr, i4, 6 - i4);

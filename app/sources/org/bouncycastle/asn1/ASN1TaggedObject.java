...
public abstract class ASN1TaggedObject extends ASN1Primitive implements ASN1TaggedObjectParser {
    ...
    byte[] getContents() {
        try {
            ...
            int length = ASN1InputStream.readLength(byteArrayInputStream, byteArrayInputStream.available(), false);
    ...
    public int hashCode() {
        return (((this.tagClass * 7919) ^ this.tagNo) ^ (isExplicit() ? 15 : EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_CIRCLE_VALUE)) ^ this.obj.toASN1Primitive().hashCode();
    }

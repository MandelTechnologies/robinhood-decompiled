...
public abstract class ASN1OctetString extends ASN1Primitive implements ASN1OctetStringParser {
    ...
    boolean asn1Equals(ASN1Primitive aSN1Primitive) {
        if (aSN1Primitive instanceof ASN1OctetString) {
            return Arrays.areEqual(this.f10823string, ((ASN1OctetString) aSN1Primitive).f10823string);
        }
        return false;
    }
    ...
    public InputStream getOctetStream() {
        return new ByteArrayInputStream(this.f10823string);
    }

    public byte[] getOctets() {
        return this.f10823string;
    }
    ...
    ASN1Primitive toDERObject() {
        return new DEROctetString(this.f10823string);
    }
    ...
    public String toString() {
        return "#" + Strings.fromByteArray(Hex.encode(this.f10823string));
    }
}

...
public interface TeleTrusTObjectIdentifiers {
    ...
    static {
        ...
        rsaSignatureWithripemd160 = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        rsaSignatureWithripemd128 = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        rsaSignatureWithripemd256 = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch2 = aSN1ObjectIdentifier.branch("3.2");
        ecSign = aSN1ObjectIdentifierBranch2;
        ecSignWithSha1 = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        ecSignWithRipemd160 = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch5 = aSN1ObjectIdentifierBranch4.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        versionOne = aSN1ObjectIdentifierBranch5;
        brainpoolP160r1 = aSN1ObjectIdentifierBranch5.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        brainpoolP160t1 = aSN1ObjectIdentifierBranch5.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        brainpoolP192r1 = aSN1ObjectIdentifierBranch5.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        brainpoolP192t1 = aSN1ObjectIdentifierBranch5.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        brainpoolP224r1 = aSN1ObjectIdentifierBranch5.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);

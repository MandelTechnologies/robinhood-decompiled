...
public class IDEACBCPar extends ASN1Object {
    ...
    /* renamed from: iv */
    ASN1OctetString f7168iv;

    private IDEACBCPar(ASN1Sequence aSN1Sequence) {
        this.f7168iv = aSN1Sequence.size() == 1 ? (ASN1OctetString) aSN1Sequence.getObjectAt(0) : null;
    }

    public IDEACBCPar(byte[] bArr) {
        this.f7168iv = new DEROctetString(bArr);
    }
    ...
    public byte[] getIV() {
        ASN1OctetString aSN1OctetString = this.f7168iv;

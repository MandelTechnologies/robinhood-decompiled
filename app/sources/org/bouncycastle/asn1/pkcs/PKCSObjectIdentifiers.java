...
public interface PKCSObjectIdentifiers {
    ...
    static {
        ...
        rsaEncryption = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        md2WithRSAEncryption = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        md4WithRSAEncryption = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        md5WithRSAEncryption = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        sha1WithRSAEncryption = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);
        ...
        dhKeyAgreement = aSN1ObjectIdentifier2.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        ASN1ObjectIdentifier aSN1ObjectIdentifier3 = new ASN1ObjectIdentifier("1.2.840.113549.1.5");
        pkcs_5 = aSN1ObjectIdentifier3;
        pbeWithMD2AndDES_CBC = aSN1ObjectIdentifier3.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        pbeWithMD2AndRC2_CBC = aSN1ObjectIdentifier3.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        pbeWithMD5AndDES_CBC = aSN1ObjectIdentifier3.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        ...
        RC2_CBC = aSN1ObjectIdentifier4.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        rc4 = aSN1ObjectIdentifier4.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        ...
        md2 = aSN1ObjectIdentifier5.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        md4 = aSN1ObjectIdentifier5.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        md5 = aSN1ObjectIdentifier5.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);
        ...
        pkcs_9_at_emailAddress = aSN1ObjectIdentifier6.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID).intern();
        pkcs_9_at_unstructuredName = aSN1ObjectIdentifier6.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED).intern();
        pkcs_9_at_contentType = aSN1ObjectIdentifier6.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET).intern();
        pkcs_9_at_messageDigest = aSN1ObjectIdentifier6.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS).intern();
        pkcs_9_at_signingTime = aSN1ObjectIdentifier6.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION).intern();
        ...
        x509Certificate = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID).intern();
        sdsiCertificate = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED).intern();
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch2 = aSN1ObjectIdentifier6.branch("23");
        crlTypes = aSN1ObjectIdentifierBranch2;
        x509Crl = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID).intern();
        ...
        id_ct_authData = aSN1ObjectIdentifier7.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        id_ct_TSTInfo = aSN1ObjectIdentifier7.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch3 = aSN1ObjectIdentifierIntern.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        ...
        id_cti_ets_proofOfOrigin = aSN1ObjectIdentifier8.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        id_cti_ets_proofOfReceipt = aSN1ObjectIdentifier8.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        id_cti_ets_proofOfDelivery = aSN1ObjectIdentifier8.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        id_cti_ets_proofOfSender = aSN1ObjectIdentifier8.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        id_cti_ets_proofOfApproval = aSN1ObjectIdentifier8.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);
        ...
        id_aa_receiptRequest = aSN1ObjectIdentifier9.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        id_aa_contentHint = aSN1ObjectIdentifier9.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        id_aa_msgSigDigest = aSN1ObjectIdentifier9.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);
        ...
        keyBag = aSN1ObjectIdentifierBranch8.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        pkcs8ShroudedKeyBag = aSN1ObjectIdentifierBranch8.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        certBag = aSN1ObjectIdentifierBranch8.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        crlBag = aSN1ObjectIdentifierBranch8.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        secretBag = aSN1ObjectIdentifierBranch8.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);
        safeContentsBag = aSN1ObjectIdentifierBranch8.branch("6");
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch9 = aSN1ObjectIdentifier10.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        pkcs_12PbeIds = aSN1ObjectIdentifierBranch9;
        pbeWithSHAAnd128BitRC4 = aSN1ObjectIdentifierBranch9.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        pbeWithSHAAnd40BitRC4 = aSN1ObjectIdentifierBranch9.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        pbeWithSHAAnd3_KeyTripleDES_CBC = aSN1ObjectIdentifierBranch9.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        pbeWithSHAAnd2_KeyTripleDES_CBC = aSN1ObjectIdentifierBranch9.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        pbeWithSHAAnd128BitRC2_CBC = aSN1ObjectIdentifierBranch9.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);

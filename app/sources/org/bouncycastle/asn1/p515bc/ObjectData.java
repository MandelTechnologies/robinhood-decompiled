package org.bouncycastle.asn1.p515bc;
...
public class ObjectData extends ASN1Object {
    ...
    private ObjectData(ASN1Sequence aSN1Sequence) {
        this.f10824type = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(0)).getValue();
    ...
    public BigInteger getType() {
        return this.f10824type;
    }

    @Override // org.bouncycastle.asn1.ASN1Object, org.bouncycastle.asn1.ASN1Encodable
    public ASN1Primitive toASN1Primitive() {
        ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector(6);
        aSN1EncodableVector.add(new ASN1Integer(this.f10824type));

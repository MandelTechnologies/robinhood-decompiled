...
public interface SECObjectIdentifiers {
    ...
    static {
        ...
        sect163k1 = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        sect163r1 = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        sect239k1 = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        sect113r1 = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        sect113r2 = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);

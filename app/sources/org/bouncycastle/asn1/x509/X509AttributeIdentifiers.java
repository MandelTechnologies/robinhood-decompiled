...
public interface X509AttributeIdentifiers {
    ...
    static {
        ...
        id_pe_ac_auditIdentity = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        ...
        id_aca_authenticationInfo = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        id_aca_accessIdentity = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        id_aca_chargingIdentity = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        id_aca_group = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);

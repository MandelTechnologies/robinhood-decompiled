...
public class KeyPurposeId extends ASN1Object {
    ...
    /* renamed from: id */
    private ASN1ObjectIdentifier f7210id;

    static {
        ASN1ObjectIdentifier aSN1ObjectIdentifier = new ASN1ObjectIdentifier("1.3.6.1.5.5.7.3");
        id_kp = aSN1ObjectIdentifier;
        anyExtendedKeyUsage = new KeyPurposeId(Extension.extendedKeyUsage.branch("0"));
        id_kp_serverAuth = new KeyPurposeId(aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID));
        id_kp_clientAuth = new KeyPurposeId(aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED));
        id_kp_codeSigning = new KeyPurposeId(aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET));
        id_kp_emailProtection = new KeyPurposeId(aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS));
        id_kp_ipsecEndSystem = new KeyPurposeId(aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION));
    ...
    private KeyPurposeId(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        this.f7210id = aSN1ObjectIdentifier;
    }

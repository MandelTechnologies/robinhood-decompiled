...
public interface X509ObjectIdentifiers {
    ...
    static {
        ...
        id_pe = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierIntern = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED).intern();
        id_ad_caIssuers = aSN1ObjectIdentifierIntern;
        ASN1ObjectIdentifier aSN1ObjectIdentifierIntern2 = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID).intern();

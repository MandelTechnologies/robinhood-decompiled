...
public class PKIXNameConstraintValidator implements NameConstraintValidator {
    ...
    private Set intersectIPRange(byte[] bArr, byte[] bArr2) {
        ...
        return compareTo(max(bArrMinMaxIPs[0], bArrMinMaxIPs[2]), min(bArrMinMaxIPs[1], bArrMinMaxIPs[3])) == 1 ? Collections.EMPTY_SET : Collections.singleton(ipWithSubnetMask(m3857or(bArrMinMaxIPs[0], bArrMinMaxIPs[2]), m3857or(bArr4, bArr6)));
    }
    ...
    /* renamed from: or */
    private static byte[] m3857or(byte[] bArr, byte[] bArr2) {

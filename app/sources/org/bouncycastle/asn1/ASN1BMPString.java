...
public abstract class ASN1BMPString extends ASN1Primitive implements ASN1String {
    ...
    final char[] f10820string;

    ASN1BMPString(String str) {
        if (str == null) {
            throw new NullPointerException("'string' cannot be null");
        }
        this.f10820string = str.toCharArray();
    }
    ...
    final boolean asn1Equals(ASN1Primitive aSN1Primitive) {
        if (aSN1Primitive instanceof ASN1BMPString) {
            return Arrays.areEqual(this.f10820string, ((ASN1BMPString) aSN1Primitive).f10820string);
        }
        return false;
    }
    ...
    final void encode(ASN1OutputStream aSN1OutputStream, boolean z) throws IOException {
        int length = this.f10820string.length;
    ...
    final int encodedLength(boolean z) {
        return ASN1OutputStream.getLengthOfEncodingDL(z, this.f10820string.length * 2);
    }

    @Override // org.bouncycastle.asn1.ASN1String
    public final String getString() {
        return new String(this.f10820string);
    }

    @Override // org.bouncycastle.asn1.ASN1Primitive, org.bouncycastle.asn1.ASN1Object
    public final int hashCode() {
        return Arrays.hashCode(this.f10820string);
    }

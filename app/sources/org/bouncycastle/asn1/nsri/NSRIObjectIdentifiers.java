...
public interface NSRIObjectIdentifiers {
    ...
    static {
        ...
        id_pad = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        id_pad_null = aSN1ObjectIdentifierBranch.branch("0");
        id_pad_1 = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        id_aria128_ecb = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        id_aria128_cbc = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        id_aria128_cfb = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        id_aria128_ofb = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        id_aria128_ctr = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);

...
public abstract class DERGenerator extends ASN1Generator {
    ...
    void writeDEREncoded(int i, byte[] bArr) throws IOException {
        ...
        int i3 = i2 | 128;
        if (this._isExplicit) {
            int i4 = i2 | EnumC7081g.SDK_ASSET_ILLUSTRATION_SECURE_TOKENIZATION_VALUE;
        ...
        if ((i & 32) != 0) {
            writeDEREncoded(this._out, i2 | EnumC7081g.SDK_ASSET_ILLUSTRATION_SECURE_TOKENIZATION_VALUE, bArr);
        } else {

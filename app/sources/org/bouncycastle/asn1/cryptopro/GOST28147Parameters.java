...
public class GOST28147Parameters extends ASN1Object {
    ...
    public GOST28147Parameters(byte[] bArr, ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        this.f7163iv = new DEROctetString(bArr);
    ...
    public byte[] getIV() {
        return Arrays.clone(this.f7163iv.getOctets());
    }

    @Override // org.bouncycastle.asn1.ASN1Object, org.bouncycastle.asn1.ASN1Encodable
    public ASN1Primitive toASN1Primitive() {
        ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector(2);
        aSN1EncodableVector.add(this.f7163iv);

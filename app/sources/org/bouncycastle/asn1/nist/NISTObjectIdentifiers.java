...
public interface NISTObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        hashAlgs = aSN1ObjectIdentifierBranch;
        id_sha256 = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        id_sha384 = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        id_sha512 = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        id_sha224 = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        id_sha512_224 = aSN1ObjectIdentifierBranch.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch2 = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        aes = aSN1ObjectIdentifierBranch2;
        id_aes128_ECB = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        id_aes128_CBC = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        id_aes128_OFB = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        id_aes128_CFB = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        id_aes128_wrap = aSN1ObjectIdentifierBranch2.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifierBranch3 = aSN1ObjectIdentifier.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        sigAlgs = aSN1ObjectIdentifierBranch3;
        id_dsa_with_sha2 = aSN1ObjectIdentifierBranch3;
        dsa_with_sha224 = aSN1ObjectIdentifierBranch3.branch(Constants.SdidMigrationStatusCodes.ALREADY_SDID);
        dsa_with_sha256 = aSN1ObjectIdentifierBranch3.branch(Constants.SdidMigrationStatusCodes.SUCCESSFULLY_MIGRATED);
        dsa_with_sha384 = aSN1ObjectIdentifierBranch3.branch(Constants.SdidMigrationStatusCodes.DID_NOT_SEND_START_SESSION_WITH_SDID_YET);
        dsa_with_sha512 = aSN1ObjectIdentifierBranch3.branch(Constants.SdidMigrationStatusCodes.MISSING_PARAMS);
        id_dsa_with_sha3_224 = aSN1ObjectIdentifierBranch3.branch(Constants.SdidMigrationStatusCodes.CAUGHT_EXCEPTION);

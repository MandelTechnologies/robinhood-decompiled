...
public final class Symmetry454Chronology extends AbstractChronology implements Serializable {
    ...
    static final ValueRange DAY_OF_MONTH_RANGE = ValueRange.m3599of(1, 28, 35);
    ...
    @Override // p479j$.time.chrono.Chronology
    public Symmetry454Date date(Era era, int i, int i2, int i3) {
        return date(prolepticYear(era, i), i2, i3);
    }

    @Override // p479j$.time.chrono.Chronology
    public Symmetry454Date date(int i, int i2, int i3) {
        return Symmetry454Date.m4010of(i, i2, i3);
    }

    @Override // p479j$.time.chrono.Chronology
    public Symmetry454Date dateYearDay(Era era, int i, int i2) {
        return dateYearDay(prolepticYear(era, i), i2);
    }

    @Override // p479j$.time.chrono.Chronology
    public Symmetry454Date dateYearDay(int i, int i2) {
        return Symmetry454Date.ofYearDay(i, i2);
    }

    @Override // p479j$.time.chrono.Chronology
    public Symmetry454Date dateEpochDay(long j) {
        return Symmetry454Date.ofEpochDay(j);
    }
    ...
    public Symmetry454Date dateNow(ZoneId zoneId) {
        return Symmetry454Date.now(zoneId);
    }
    ...
    public Symmetry454Date date(TemporalAccessor temporalAccessor) {
        return Symmetry454Date.from(temporalAccessor);
    }
    ...
    /* renamed from: org.threeten.extra.chrono.Symmetry454Chronology$1 */
    static /* synthetic */ class C480491 {
    ...
    public ValueRange range(ChronoField chronoField) {
        switch (C480491.$SwitchMap$java$time$temporal$ChronoField[chronoField.ordinal()]) {
            case 1:
            case 2:
            case 3:

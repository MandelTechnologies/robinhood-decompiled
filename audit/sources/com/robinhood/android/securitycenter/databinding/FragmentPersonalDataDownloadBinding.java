...
public final class FragmentPersonalDataDownloadBinding implements ViewBinding {
    ...
    public static FragmentPersonalDataDownloadBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C28186R.layout.fragment_personal_data_download, viewGroup, false);
        if (z) {
    ...
    public static FragmentPersonalDataDownloadBinding bind(View view) {
        int i = C28186R.id.personal_data_download_cta;
        RdsButton rdsButton = (RdsButton) ViewBindings.findChildViewById(view, i);
        if (rdsButton != null) {
            i = C28186R.id.personal_data_download_details_list;
            RecyclerView recyclerView = (RecyclerView) ViewBindings.findChildViewById(view, i);
            if (recyclerView != null) {
                i = C28186R.id.personal_data_download_details_title;
                RhTextView rhTextView = (RhTextView) ViewBindings.findChildViewById(view, i);
                if (rhTextView != null) {
                    i = C28186R.id.personal_data_download_footer;
                    RhTextView rhTextView2 = (RhTextView) ViewBindings.findChildViewById(view, i);
                    if (rhTextView2 != null) {
                        i = C28186R.id.personal_data_download_subtitle;
                        RhTextView rhTextView3 = (RhTextView) ViewBindings.findChildViewById(view, i);
                        if (rhTextView3 != null) {
                            i = C28186R.id.personal_data_download_title;

...
public final class ManualAddress2Fragment_MembersInjector implements MembersInjector<ManualAddress2Fragment> {
    ...
    @JvmStatic
    public static final MembersInjector<ManualAddress2Fragment> create(Provider<BaseFragmentSingletons> provider, Provider<AnalyticsLogger> provider2, Provider<UserStore> provider3, Provider<AddressStore> provider4, Provider<UserInfoStore> provider5, Provider<ProfileInfoStore> provider6, Provider<AppType> provider7) {
        return INSTANCE.create(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }

    @JvmStatic
    public static final void injectAppType(ManualAddress2Fragment manualAddress2Fragment, AppType appType) {
        INSTANCE.injectAppType(manualAddress2Fragment, appType);
    }

    public ManualAddress2Fragment_MembersInjector(Provider<BaseFragmentSingletons> singletons, Provider<AnalyticsLogger> analytics, Provider<UserStore> userStore, Provider<AddressStore> addressStore, Provider<UserInfoStore> userInfoStore, Provider<ProfileInfoStore> profileInfoStore, Provider<AppType> appType) {
    ...
    public void injectMembers(ManualAddress2Fragment instance) {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final MembersInjector<ManualAddress2Fragment> create(Provider<BaseFragmentSingletons> singletons, Provider<AnalyticsLogger> analytics, Provider<UserStore> userStore, Provider<AddressStore> addressStore, Provider<UserInfoStore> userInfoStore, Provider<ProfileInfoStore> profileInfoStore, Provider<AppType> appType) {
            Intrinsics.checkNotNullParameter(singletons, "singletons");
            Intrinsics.checkNotNullParameter(analytics, "analytics");
            Intrinsics.checkNotNullParameter(userStore, "userStore");
            Intrinsics.checkNotNullParameter(addressStore, "addressStore");
            ...
            Intrinsics.checkNotNullParameter(profileInfoStore, "profileInfoStore");
            Intrinsics.checkNotNullParameter(appType, "appType");
            return new ManualAddress2Fragment_MembersInjector(singletons, analytics, userStore, addressStore, userInfoStore, profileInfoStore, appType);
        }

        @JvmStatic
        public final void injectAppType(ManualAddress2Fragment instance, AppType appType) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(appType, "appType");

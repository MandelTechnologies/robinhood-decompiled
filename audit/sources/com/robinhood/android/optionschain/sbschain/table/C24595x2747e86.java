...
@DebugMetadata(m3644c = "com.robinhood.android.optionschain.sbschain.table.OptionSideBySideChainTableKt$OptionSideBySideChainTable$16$1$2$2$10$1$1", m3645f = "OptionSideBySideChainTable.kt", m3646l = {550}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.android.optionschain.sbschain.table.OptionSideBySideChainTableKt$OptionSideBySideChainTable$16$1$2$2$10$1$1 */
/* loaded from: classes11.dex */
final class C24595x2747e86 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    C24595x2747e86(LazyListState lazyListState, OptionSideBySideChainTableEvent optionSideBySideChainTableEvent, SnapshotState4<Integer> snapshotState4, SnapshotState4<OptionSideBySideChainTableViewState> snapshotState42, SnapshotLongState2 snapshotLongState2, SnapshotState<Boolean> snapshotState, Continuation<? super C24595x2747e86> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new C24595x2747e86(this.$lazyListState, this.$localEvent, this.$scrollQuoteToTableCenterOffset$delegate, this.$viewState$delegate, this.$startTableLoading$delegate, this.$isTableReady$delegate, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((C24595x2747e86) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            int quoteIndex = ((OptionSideBySideChainTableEvent.ScrollToQuotePosition) this.$localEvent).getQuoteIndex();
            int i2 = -OptionSideBySideChainTableKt$OptionSideBySideChainTable$16$1.invoke$lambda$70$lambda$69$lambda$26(this.$scrollQuoteToTableCenterOffset$delegate);
            this.label = 1;

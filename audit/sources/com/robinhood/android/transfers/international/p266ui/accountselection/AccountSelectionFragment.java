...
import com.robinhood.android.transfers.international.p266ui.actions.AccountSelectedAction;
...
public final class AccountSelectionFragment extends GenericComposeFragment implements AutoLoggableFragment {
    ...
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(AccountSelectionFragment.class, "callbacks", "getCallbacks()Lcom/robinhood/android/transfers/international/ui/actions/InternationalTransferFlowActionResolver;", 0))};
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            try {
                iArr[Args.Type.INTERNAL.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[Args.Type.EXTERNAL.ordinal()] = 2;
    ...
    public static final Unit ComposeContent$lambda$3(AccountSelectionFragment accountSelectionFragment, int i, Composer composer, int i2) {
    ...
    public Screen getEventScreen() {
        ...
        if (i == 1) {
            name = Screen.Name.I18N_TRANSFER_CURRENCY_SELECTION;
        } else {
            if (i != 2) {
                throw new NoWhenBranchMatchedException();
            }
            name = Screen.Name.I18N_TRANSFER_ACCOUNT_SELECTION;
        }
    ...
    public void ComposeContent(Composer composer, final int i) {
        ...
        if ((i2 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(780780254, i2, -1, "com.robinhood.android.transfers.international.ui.accountselection.AccountSelectionFragment.ComposeContent (AccountSelectionFragment.kt:53)");
            }
            AccountSelectionViewState accountSelectionViewStateComposeContent$lambda$0 = ComposeContent$lambda$0(FlowExtKt.collectAsStateWithLifecycle(getDuxo().getStateFlow(), (LifecycleOwner) null, (Lifecycle.State) null, (CoroutineContext) null, composerStartRestartGroup, 0, 7));
            if (accountSelectionViewStateComposeContent$lambda$0 instanceof AccountSelectionViewState.Loaded) {
                composerStartRestartGroup.startReplaceGroup(-1318098014);
                AccountSelectionViewState.Loaded loaded = (AccountSelectionViewState.Loaded) accountSelectionViewStateComposeContent$lambda$0;
                composerStartRestartGroup.startReplaceGroup(5004770);
                boolean zChangedInstance = composerStartRestartGroup.changedInstance(this);
                Object objRememberedValue = composerStartRestartGroup.rememberedValue();
                if (zChangedInstance || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = new Function1() { // from class: com.robinhood.android.transfers.international.ui.accountselection.AccountSelectionFragment$$ExternalSyntheticLambda0
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj) {
                            return AccountSelectionFragment.ComposeContent$lambda$2$lambda$1(this.f$0, (MultiCurrencyAccount) obj);
                        }
                    };
                    composerStartRestartGroup.updateRememberedValue(objRememberedValue);
                }
                composerStartRestartGroup.endReplaceGroup();
                AccountSelectionComposableKt.AccountSelectionComposable(loaded, (Function1) objRememberedValue, composerStartRestartGroup, 0);
                composerStartRestartGroup.endReplaceGroup();
            } else {
                if (!(accountSelectionViewStateComposeContent$lambda$0 instanceof AccountSelectionViewState.Loading)) {
                    composerStartRestartGroup.startReplaceGroup(-1289447600);
                    composerStartRestartGroup.endReplaceGroup();
                    throw new NoWhenBranchMatchedException();
                }
                composerStartRestartGroup.startReplaceGroup(-1317299578);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: com.robinhood.android.transfers.international.ui.accountselection.AccountSelectionFragment$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return AccountSelectionFragment.ComposeContent$lambda$3(this.f$0, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit ComposeContent$lambda$2$lambda$1(AccountSelectionFragment accountSelectionFragment, MultiCurrencyAccount it) {
        Intrinsics.checkNotNullParameter(it, "it");
        EventLogger.DefaultImpls.logTap$default(accountSelectionFragment.getEventLogger(), null, accountSelectionFragment.getEventScreen(), new Component(Component.ComponentType.ROW, MultiCurrencyAccount2.getLoggingIdentifier(it), null, 4, null), null, accountSelectionFragment.getScreenEventContext(), false, 41, null);
        accountSelectionFragment.getCallbacks().resolve(new AccountSelectedAction(it));
        return Unit.INSTANCE;
    }

    private static final AccountSelectionViewState ComposeContent$lambda$0(SnapshotState4<? extends AccountSelectionViewState> snapshotState4) {
        return snapshotState4.getValue();
    }

    /* compiled from: AccountSelectionFragment.kt */
    @Metadata(m3635d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, m3636d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "com.robinhood.android.transfers.international.ui.accountselection.AccountSelectionFragment$onViewCreated$1", m3645f = "AccountSelectionFragment.kt", m3646l = {}, m3647m = "invokeSuspend")
    /* renamed from: com.robinhood.android.transfers.international.ui.accountselection.AccountSelectionFragment$onViewCreated$1 */
    static final class C303281 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        int label;

        C303281(Continuation<? super C303281> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C303281 c303281 = AccountSelectionFragment.this.new C303281(continuation);
            c303281.L$0 = obj;
            return c303281;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C303281) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }

        /* compiled from: AccountSelectionFragment.kt */
        @Metadata(m3635d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\n"}, m3636d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
        @DebugMetadata(m3644c = "com.robinhood.android.transfers.international.ui.accountselection.AccountSelectionFragment$onViewCreated$1$1", m3645f = "AccountSelectionFragment.kt", m3646l = {91}, m3647m = "invokeSuspend")
        /* renamed from: com.robinhood.android.transfers.international.ui.accountselection.AccountSelectionFragment$onViewCreated$1$1, reason: invalid class name */
        static final class AnonymousClass1 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* compiled from: AccountSelectionFragment.kt */
            @Metadata(m3635d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u00012\u000e\u0010\u0002\u001a\n\u0012\u0004\u0012\u00020\u0004\u0018\u00010\u0003H\n"}, m3636d2 = {"<anonymous>", "", "event", "Lcom/robinhood/android/udf/event/Event;", "Lcom/robinhood/android/transfers/international/ui/accountselection/AccountSelectionEvent;"}, m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
            @DebugMetadata(m3644c = "com.robinhood.android.transfers.international.ui.accountselection.AccountSelectionFragment$onViewCreated$1$1$1", m3645f = "AccountSelectionFragment.kt", m3646l = {}, m3647m = "invokeSuspend")
            @SourceDebugExtension
            /* renamed from: com.robinhood.android.transfers.international.ui.accountselection.AccountSelectionFragment$onViewCreated$1$1$1, reason: invalid class name and collision with other inner class name */
            static final class C506031 extends ContinuationImpl7 implements Function2<Event<AccountSelectionDuxo4>, Continuation<? super Unit>, Object> {
                /* synthetic */ Object L$0;
                int label;
                final /* synthetic */ AccountSelectionFragment this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C506031(AccountSelectionFragment accountSelectionFragment, Continuation<? super C506031> continuation) {
                    super(2, continuation);
                    this.this$0 = accountSelectionFragment;
                }
                ...
                @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    C506031 c506031 = new C506031(this.this$0, continuation);
                    c506031.L$0 = obj;
                    return c506031;
                }

                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Event<AccountSelectionDuxo4> event, Continuation<? super Unit> continuation) {
                    return ((C506031) create(event, continuation)).invokeSuspend(Unit.INSTANCE);
                }
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (event != null) {
                        ...
                        if ((event.getData() instanceof AccountSelectionDuxo4.Error) && (eventConsumer = (EventConsumer) event.getGetEventConsumer().invoke()) != null) {
                            eventConsumer.consume(event, new Function1() { // from class: com.robinhood.android.transfers.international.ui.accountselection.AccountSelectionFragment$onViewCreated$1$1$1$invokeSuspend$$inlined$consumeIfType$1
                                @Override // kotlin.jvm.functions.Function1
                                ...
                                public final void m19652invoke(Object it) {
                                    Intrinsics.checkNotNullParameter(it, "it");
                                    AbsErrorHandler.handleError$default(accountSelectionFragment.getActivityErrorHandler(), ((AccountSelectionDuxo4.Error) event.getData()).getThrowable(), false, 2, null);
                                }
                            });
                        }
                    }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    StateFlow<Event<AccountSelectionDuxo4>> eventFlow = this.this$0.getDuxo().getEventFlow();
                    C506031 c506031 = new C506031(this.this$0, null);
                    this.label = 1;
                    if (FlowKt.collectLatest(eventFlow, c506031, this) == coroutine_suspended) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ResultKt.throwOnFailure(obj);
                BuildersKt__Builders_commonKt.launch$default((CoroutineScope) this.L$0, null, null, new AnonymousClass1(AccountSelectionFragment.this, null), 3, null);
                return Unit.INSTANCE;
            }
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        BaseFragment.collectDuxoState$default(this, null, new C303281(null), 1, null);
    }

    /* compiled from: AccountSelectionFragment.kt */
    @Metadata(m3635d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0087\b\u0018\u00002\u00020\u0001:\u0001\u0018B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\t\u0010\b\u001a\u00020\u0003HÆ\u0003J\u0013\u0010\t\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u0003HÆ\u0001J\u0006\u0010\n\u001a\u00020\u000bJ\u0013\u0010\f\u001a\u00020\r2\b\u0010\u000e\u001a\u0004\u0018\u00010\u000fHÖ\u0003J\t\u0010\u0010\u001a\u00020\u000bHÖ\u0001J\t\u0010\u0011\u001a\u00020\u0012HÖ\u0001J\u0016\u0010\u0013\u001a\u00020\u00142\u0006\u0010\u0015\u001a\u00020\u00162\u0006\u0010\u0017\u001a\u00020\u000bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u0019"}, m3636d2 = {"Lcom/robinhood/android/transfers/international/ui/accountselection/AccountSelectionFragment$Args;", "Landroid/os/Parcelable;", "type", "Lcom/robinhood/android/transfers/international/ui/accountselection/AccountSelectionFragment$Args$Type;", "<init>", "(Lcom/robinhood/android/transfers/international/ui/accountselection/AccountSelectionFragment$Args$Type;)V", "getType", "()Lcom/robinhood/android/transfers/international/ui/accountselection/AccountSelectionFragment$Args$Type;", "component1", "copy", "describeContents", "", "equals", "", "other", "", "hashCode", "toString", "", "writeToParcel", "", "dest", "Landroid/os/Parcel;", "flags", "Type", "feature-international-transfers_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    public static final /* data */ class Args implements Parcelable {
        ...
        public static final class Creator implements Parcelable.Creator<Args> {
            ...
            public final Args createFromParcel(Parcel parcel) {
                ...
                return new Args(Type.valueOf(parcel.readString()));
            }
        ...
        public static /* synthetic */ Args copy$default(Args args, Type type2, int i, Object obj) {
            if ((i & 1) != 0) {
                type2 = args.type;
            }
        ...
        public final Args copy(Type type2) {
        ...
        /* compiled from: AccountSelectionFragment.kt */
        @Metadata(m3635d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0005\b\u0086\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003j\u0002\b\u0004j\u0002\b\u0005¨\u0006\u0006"}, m3636d2 = {"Lcom/robinhood/android/transfers/international/ui/accountselection/AccountSelectionFragment$Args$Type;", "", "<init>", "(Ljava/lang/String;I)V", "INTERNAL", "EXTERNAL", "feature-international-transfers_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
        public static final class Type {
            ...
            private static final /* synthetic */ Type[] $values() {
                return new Type[]{INTERNAL, EXTERNAL};
            }

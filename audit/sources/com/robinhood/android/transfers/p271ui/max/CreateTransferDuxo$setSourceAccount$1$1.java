...
@DebugMetadata(m3644c = "com.robinhood.android.transfers.ui.max.CreateTransferDuxo$setSourceAccount$1$1", m3645f = "CreateTransferDuxo.kt", m3646l = {1676}, m3647m = "invokeSuspend")
/* loaded from: classes9.dex */
final class CreateTransferDuxo$setSourceAccount$1$1 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    CreateTransferDuxo$setSourceAccount$1$1(CreateTransferDuxo createTransferDuxo, TransferAccount transferAccount, TransferAccount transferAccount2, CreateTransferViewState createTransferViewState, Continuation<? super CreateTransferDuxo$setSourceAccount$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CreateTransferDuxo$setSourceAccount$1$1(this.this$0, this.$account, this.$finalSinkAccount, this.$this_applyMutation, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((CreateTransferDuxo$setSourceAccount$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (dynamicPillValueManagedService != null) {
                ...
                TransferAccount transferAccount2 = this.$finalSinkAccount;

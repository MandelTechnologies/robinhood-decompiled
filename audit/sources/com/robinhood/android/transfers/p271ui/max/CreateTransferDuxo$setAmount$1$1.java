...
@DebugMetadata(m3644c = "com.robinhood.android.transfers.ui.max.CreateTransferDuxo$setAmount$1$1", m3645f = "CreateTransferDuxo.kt", m3646l = {2018}, m3647m = "invokeSuspend")
/* loaded from: classes9.dex */
final class CreateTransferDuxo$setAmount$1$1 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ CreateTransferViewState $this_applyMutation;
    int label;
    final /* synthetic */ CreateTransferDuxo this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CreateTransferDuxo$setAmount$1$1(CreateTransferDuxo createTransferDuxo, CreateTransferViewState createTransferViewState, Continuation<? super CreateTransferDuxo$setAmount$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CreateTransferDuxo$setAmount$1$1(this.this$0, this.$this_applyMutation, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((CreateTransferDuxo$setAmount$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

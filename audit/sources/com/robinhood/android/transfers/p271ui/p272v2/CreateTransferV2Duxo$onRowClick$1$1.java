...
@DebugMetadata(m3644c = "com.robinhood.android.transfers.ui.v2.CreateTransferV2Duxo$onRowClick$1$1", m3645f = "CreateTransferV2Duxo.kt", m3646l = {986}, m3647m = "invokeSuspend")
/* loaded from: classes9.dex */
final class CreateTransferV2Duxo$onRowClick$1$1 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ CreateTransferV2DataRowState.OnClickAction $rowOnClickAction;
    final /* synthetic */ CreateTransferV2DataState $state;
    int label;
    final /* synthetic */ CreateTransferV2Duxo this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CreateTransferV2Duxo$onRowClick$1$1(CreateTransferV2Duxo createTransferV2Duxo, CreateTransferV2DataRowState.OnClickAction onClickAction, CreateTransferV2DataState createTransferV2DataState, Continuation<? super CreateTransferV2Duxo$onRowClick$1$1> continuation) {
        super(2, continuation);
        this.this$0 = createTransferV2Duxo;
        this.$rowOnClickAction = onClickAction;
        this.$state = createTransferV2DataState;
    }

    @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CreateTransferV2Duxo$onRowClick$1$1(this.this$0, this.$rowOnClickAction, this.$state, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((CreateTransferV2Duxo$onRowClick$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            TransferAccountDirection direction = ((CreateTransferV2DataRowState.OnClickAction.AccountSelection) this.$rowOnClickAction).getDirection();
            TransferDirectionV2 direction2 = this.$state.getDirection();
            ...
            this.label = 1;
            if (MicrogramConverters2.launchBottomSheet(accountSelectionBottomSheetService, direction, direction2, adjustedFrequency, amount, (16 & 16) != 0 ? Currencies.USD : null, entryPoint, fromAccountId, toAccountId, iraContributionType, this) == coroutine_suspended) {

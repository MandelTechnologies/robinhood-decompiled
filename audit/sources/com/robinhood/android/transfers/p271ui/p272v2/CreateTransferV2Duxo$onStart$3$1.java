...
@DebugMetadata(m3644c = "com.robinhood.android.transfers.ui.v2.CreateTransferV2Duxo$onStart$3$1", m3645f = "CreateTransferV2Duxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes9.dex */
final class CreateTransferV2Duxo$onStart$3$1 extends ContinuationImpl7 implements Function2<CreateTransferV2DataState, Continuation<? super CreateTransferV2DataState>, Object> {
    final /* synthetic */ BigDecimal $eligibleDepositAsInstant;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    CreateTransferV2Duxo$onStart$3$1(BigDecimal bigDecimal, Continuation<? super CreateTransferV2Duxo$onStart$3$1> continuation) {
        super(2, continuation);
        this.$eligibleDepositAsInstant = bigDecimal;
    }

    @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        CreateTransferV2Duxo$onStart$3$1 createTransferV2Duxo$onStart$3$1 = new CreateTransferV2Duxo$onStart$3$1(this.$eligibleDepositAsInstant, continuation);
        createTransferV2Duxo$onStart$3$1.L$0 = obj;
        return createTransferV2Duxo$onStart$3$1;
    }
    ...
    public final Object invoke(CreateTransferV2DataState createTransferV2DataState, Continuation<? super CreateTransferV2DataState> continuation) {
        return ((CreateTransferV2Duxo$onStart$3$1) create(createTransferV2DataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

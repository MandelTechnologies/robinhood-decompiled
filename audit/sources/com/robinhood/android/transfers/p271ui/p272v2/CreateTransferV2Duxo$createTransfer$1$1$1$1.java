...
@DebugMetadata(m3644c = "com.robinhood.android.transfers.ui.v2.CreateTransferV2Duxo$createTransfer$1$1$1$1", m3645f = "CreateTransferV2Duxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes9.dex */
final class CreateTransferV2Duxo$createTransfer$1$1$1$1 extends ContinuationImpl7 implements Function2<CreateTransferV2DataState, Continuation<? super CreateTransferV2DataState>, Object> {
    private /* synthetic */ Object L$0;
    int label;

    CreateTransferV2Duxo$createTransfer$1$1$1$1(Continuation<? super CreateTransferV2Duxo$createTransfer$1$1$1$1> continuation) {
        super(2, continuation);
    }

    @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        CreateTransferV2Duxo$createTransfer$1$1$1$1 createTransferV2Duxo$createTransfer$1$1$1$1 = new CreateTransferV2Duxo$createTransfer$1$1$1$1(continuation);
        createTransferV2Duxo$createTransfer$1$1$1$1.L$0 = obj;
        return createTransferV2Duxo$createTransfer$1$1$1$1;
    }
    ...
    public final Object invoke(CreateTransferV2DataState createTransferV2DataState, Continuation<? super CreateTransferV2DataState> continuation) {
        return ((CreateTransferV2Duxo$createTransfer$1$1$1$1) create(createTransferV2DataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

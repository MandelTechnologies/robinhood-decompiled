...
/* compiled from: InternalTransferHistoryDetailViewState.kt */
...
public final /* data */ class InternalTransferHistoryDetailViewState {
    ...
    public InternalTransferHistoryDetailViewState() {
        this(null, null, null, null, false, false, false, null, null, null, 1023, null);
    }

    public static /* synthetic */ InternalTransferHistoryDetailViewState copy$default(InternalTransferHistoryDetailViewState internalTransferHistoryDetailViewState, TransactionOverview transactionOverview, MinervaTransaction minervaTransaction, CharSequence charSequence, CharSequence charSequence2, boolean z, boolean z2, boolean z3, UiEvent uiEvent, UiEvent uiEvent2, StringResource stringResource, int i, Object obj) {
        if ((i & 1) != 0) {
            transactionOverview = internalTransferHistoryDetailViewState.overview;
        }
        if ((i & 2) != 0) {
            minervaTransaction = internalTransferHistoryDetailViewState.transaction;
        }
        if ((i & 4) != 0) {
            charSequence = internalTransferHistoryDetailViewState.detail;
        }
        if ((i & 8) != 0) {
            charSequence2 = internalTransferHistoryDetailViewState.loadingText;
        }
        if ((i & 16) != 0) {
            z = internalTransferHistoryDetailViewState.isLoading;
        }
        if ((i & 32) != 0) {
            z2 = internalTransferHistoryDetailViewState.showCancelButton;
        }
        if ((i & 64) != 0) {
            z3 = internalTransferHistoryDetailViewState.isCancelRequestInFlight;
        }
        if ((i & 128) != 0) {
            uiEvent = internalTransferHistoryDetailViewState.cancelSuccessEvent;
        }
        if ((i & 256) != 0) {
            uiEvent2 = internalTransferHistoryDetailViewState.cancelErrorEvent;
        }
        if ((i & 512) != 0) {
            stringResource = internalTransferHistoryDetailViewState.additionalInfoText;
        }
        ...
        boolean z5 = z;
        boolean z6 = z2;
        return internalTransferHistoryDetailViewState.copy(transactionOverview, minervaTransaction, charSequence, charSequence2, z5, z6, z4, uiEvent4, uiEvent3, stringResource2);
    }
    ...
    public final InternalTransferHistoryDetailViewState copy(TransactionOverview overview, MinervaTransaction transaction, CharSequence detail, CharSequence loadingText, boolean isLoading, boolean showCancelButton, boolean isCancelRequestInFlight, UiEvent<Unit> cancelSuccessEvent, UiEvent<Throwable> cancelErrorEvent, StringResource additionalInfoText) {
        return new InternalTransferHistoryDetailViewState(overview, transaction, detail, loadingText, isLoading, showCancelButton, isCancelRequestInFlight, cancelSuccessEvent, cancelErrorEvent, additionalInfoText);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof InternalTransferHistoryDetailViewState)) {
            return false;
        }
        InternalTransferHistoryDetailViewState internalTransferHistoryDetailViewState = (InternalTransferHistoryDetailViewState) other;
        return Intrinsics.areEqual(this.overview, internalTransferHistoryDetailViewState.overview) && Intrinsics.areEqual(this.transaction, internalTransferHistoryDetailViewState.transaction) && Intrinsics.areEqual(this.detail, internalTransferHistoryDetailViewState.detail) && Intrinsics.areEqual(this.loadingText, internalTransferHistoryDetailViewState.loadingText) && this.isLoading == internalTransferHistoryDetailViewState.isLoading && this.showCancelButton == internalTransferHistoryDetailViewState.showCancelButton && this.isCancelRequestInFlight == internalTransferHistoryDetailViewState.isCancelRequestInFlight && Intrinsics.areEqual(this.cancelSuccessEvent, internalTransferHistoryDetailViewState.cancelSuccessEvent) && Intrinsics.areEqual(this.cancelErrorEvent, internalTransferHistoryDetailViewState.cancelErrorEvent) && Intrinsics.areEqual(this.additionalInfoText, internalTransferHistoryDetailViewState.additionalInfoText);
    }
    ...
    public String toString() {
        ...
        CharSequence charSequence = this.detail;
        CharSequence charSequence2 = this.loadingText;
        return "InternalTransferHistoryDetailViewState(overview=" + transactionOverview + ", transaction=" + minervaTransaction + ", detail=" + ((Object) charSequence) + ", loadingText=" + ((Object) charSequence2) + ", isLoading=" + this.isLoading + ", showCancelButton=" + this.showCancelButton + ", isCancelRequestInFlight=" + this.isCancelRequestInFlight + ", cancelSuccessEvent=" + this.cancelSuccessEvent + ", cancelErrorEvent=" + this.cancelErrorEvent + ", additionalInfoText=" + this.additionalInfoText + ")";
    }

    public InternalTransferHistoryDetailViewState(TransactionOverview transactionOverview, MinervaTransaction minervaTransaction, CharSequence charSequence, CharSequence charSequence2, boolean z, boolean z2, boolean z3, UiEvent<Unit> uiEvent, UiEvent<Throwable> uiEvent2, StringResource stringResource) {
    ...
    public /* synthetic */ InternalTransferHistoryDetailViewState(TransactionOverview transactionOverview, MinervaTransaction minervaTransaction, CharSequence charSequence, CharSequence charSequence2, boolean z, boolean z2, boolean z3, UiEvent uiEvent, UiEvent uiEvent2, StringResource stringResource, int i, DefaultConstructorMarker defaultConstructorMarker) {

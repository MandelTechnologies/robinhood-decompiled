...
public final class MergeNewsFeedEmbeddedArticleHeroBinding implements ViewBinding {
    ...
    public static MergeNewsFeedEmbeddedArticleHeroBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static MergeNewsFeedEmbeddedArticleHeroBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C20334R.layout.merge_news_feed_embedded_article_hero, viewGroup, false);
        if (z) {
    ...
    public static MergeNewsFeedEmbeddedArticleHeroBinding bind(View view) {
                            ...
                            if (newsFeedRelatedInstrumentsView != null) {
                                ...
                                if (rhTextView != null) {
                                    ...
                                    if (rhTextView2 != null) {
                                        ...
                                        if (rhTextView3 != null) {
                                            return new MergeNewsFeedEmbeddedArticleHeroBinding(constraintLayout, barrier, viewFindChildViewById, space, imageView, imageView2, imageView3, newsFeedRelatedInstrumentsView, constraintLayout, rhTextView, rhTextView2, rhTextView3);
                                        }
                                    }
                                }
                            }

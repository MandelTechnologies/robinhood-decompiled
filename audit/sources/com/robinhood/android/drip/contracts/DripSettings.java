...
public final class DripSettings implements FragmentKey, TabFragmentKey {
    ...
    public static final class Creator implements Parcelable.Creator<DripSettings> {
        ...
        public final DripSettings createFromParcel(Parcel parcel) {
            ...
            return new DripSettings(parcel.readString());
        }
    ...
    public DripSettings(String str) {
        this.accountNumber = str;
    }

    public /* synthetic */ DripSettings(String str, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? null : str);
    }

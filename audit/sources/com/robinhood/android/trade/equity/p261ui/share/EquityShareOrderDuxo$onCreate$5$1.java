...
@DebugMetadata(m3644c = "com.robinhood.android.trade.equity.ui.share.EquityShareOrderDuxo$onCreate$5$1", m3645f = "EquityShareOrderDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes9.dex */
final class EquityShareOrderDuxo$onCreate$5$1 extends ContinuationImpl7 implements Function2<EquityShareOrderDataState, Continuation<? super EquityShareOrderDataState>, Object> {
    final /* synthetic */ boolean $isMarketBuysEnabled;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    EquityShareOrderDuxo$onCreate$5$1(boolean z, Continuation<? super EquityShareOrderDuxo$onCreate$5$1> continuation) {
        super(2, continuation);
        this.$isMarketBuysEnabled = z;
    }

    @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        EquityShareOrderDuxo$onCreate$5$1 equityShareOrderDuxo$onCreate$5$1 = new EquityShareOrderDuxo$onCreate$5$1(this.$isMarketBuysEnabled, continuation);
        equityShareOrderDuxo$onCreate$5$1.L$0 = obj;
        return equityShareOrderDuxo$onCreate$5$1;
    }
    ...
    public final Object invoke(EquityShareOrderDataState equityShareOrderDataState, Continuation<? super EquityShareOrderDataState> continuation) {
        return ((EquityShareOrderDuxo$onCreate$5$1) create(equityShareOrderDataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

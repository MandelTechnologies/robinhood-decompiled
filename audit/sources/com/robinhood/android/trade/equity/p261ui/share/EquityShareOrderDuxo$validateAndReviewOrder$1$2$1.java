...
@DebugMetadata(m3644c = "com.robinhood.android.trade.equity.ui.share.EquityShareOrderDuxo$validateAndReviewOrder$1$2$1", m3645f = "EquityShareOrderDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes9.dex */
final class EquityShareOrderDuxo$validateAndReviewOrder$1$2$1 extends ContinuationImpl7 implements Function2<EquityShareOrderDataState, Continuation<? super EquityShareOrderDataState>, Object> {
    final /* synthetic */ ValidationState $validationState;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    EquityShareOrderDuxo$validateAndReviewOrder$1$2$1(ValidationState validationState, Continuation<? super EquityShareOrderDuxo$validateAndReviewOrder$1$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        EquityShareOrderDuxo$validateAndReviewOrder$1$2$1 equityShareOrderDuxo$validateAndReviewOrder$1$2$1 = new EquityShareOrderDuxo$validateAndReviewOrder$1$2$1(this.$validationState, continuation);
        equityShareOrderDuxo$validateAndReviewOrder$1$2$1.L$0 = obj;
        return equityShareOrderDuxo$validateAndReviewOrder$1$2$1;
    }
    ...
    public final Object invoke(EquityShareOrderDataState equityShareOrderDataState, Continuation<? super EquityShareOrderDataState> continuation) {
        return ((EquityShareOrderDuxo$validateAndReviewOrder$1$2$1) create(equityShareOrderDataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

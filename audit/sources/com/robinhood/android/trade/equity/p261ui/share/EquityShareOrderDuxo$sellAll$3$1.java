...
@DebugMetadata(m3644c = "com.robinhood.android.trade.equity.ui.share.EquityShareOrderDuxo$sellAll$3$1", m3645f = "EquityShareOrderDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes9.dex */
final class EquityShareOrderDuxo$sellAll$3$1 extends ContinuationImpl7 implements Function2<EquityShareOrderDataState, Continuation<? super EquityShareOrderDataState>, Object> {
    ...
    EquityShareOrderDuxo$sellAll$3$1(EquityShareOrderDuxo equityShareOrderDuxo, Position position, Continuation<? super EquityShareOrderDuxo$sellAll$3$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        EquityShareOrderDuxo$sellAll$3$1 equityShareOrderDuxo$sellAll$3$1 = new EquityShareOrderDuxo$sellAll$3$1(this.this$0, this.$position, continuation);
        equityShareOrderDuxo$sellAll$3$1.L$0 = obj;
        return equityShareOrderDuxo$sellAll$3$1;
    }
    ...
    public final Object invoke(EquityShareOrderDataState equityShareOrderDataState, Continuation<? super EquityShareOrderDataState> continuation) {
        return ((EquityShareOrderDuxo$sellAll$3$1) create(equityShareOrderDataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

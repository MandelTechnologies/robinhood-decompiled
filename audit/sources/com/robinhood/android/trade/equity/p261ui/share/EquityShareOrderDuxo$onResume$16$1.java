...
@DebugMetadata(m3644c = "com.robinhood.android.trade.equity.ui.share.EquityShareOrderDuxo$onResume$16$1", m3645f = "EquityShareOrderDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes9.dex */
final class EquityShareOrderDuxo$onResume$16$1 extends ContinuationImpl7 implements Function2<EquityShareOrderDataState, Continuation<? super EquityShareOrderDataState>, Object> {
    final /* synthetic */ WithholdingEstimatedAmount $response;
    private /* synthetic */ Object L$0;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    EquityShareOrderDuxo$onResume$16$1(WithholdingEstimatedAmount withholdingEstimatedAmount, Continuation<? super EquityShareOrderDuxo$onResume$16$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        EquityShareOrderDuxo$onResume$16$1 equityShareOrderDuxo$onResume$16$1 = new EquityShareOrderDuxo$onResume$16$1(this.$response, continuation);
        equityShareOrderDuxo$onResume$16$1.L$0 = obj;
        return equityShareOrderDuxo$onResume$16$1;
    }
    ...
    public final Object invoke(EquityShareOrderDataState equityShareOrderDataState, Continuation<? super EquityShareOrderDataState> continuation) {
        return ((EquityShareOrderDuxo$onResume$16$1) create(equityShareOrderDataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

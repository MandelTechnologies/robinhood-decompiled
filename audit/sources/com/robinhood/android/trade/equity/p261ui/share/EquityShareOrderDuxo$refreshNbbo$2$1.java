...
@DebugMetadata(m3644c = "com.robinhood.android.trade.equity.ui.share.EquityShareOrderDuxo$refreshNbbo$2$1", m3645f = "EquityShareOrderDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes9.dex */
final class EquityShareOrderDuxo$refreshNbbo$2$1 extends ContinuationImpl7 implements Function2<EquityShareOrderDataState, Continuation<? super EquityShareOrderDataState>, Object> {
    private /* synthetic */ Object L$0;
    int label;

    EquityShareOrderDuxo$refreshNbbo$2$1(Continuation<? super EquityShareOrderDuxo$refreshNbbo$2$1> continuation) {
        super(2, continuation);
    }

    @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        EquityShareOrderDuxo$refreshNbbo$2$1 equityShareOrderDuxo$refreshNbbo$2$1 = new EquityShareOrderDuxo$refreshNbbo$2$1(continuation);
        equityShareOrderDuxo$refreshNbbo$2$1.L$0 = obj;
        return equityShareOrderDuxo$refreshNbbo$2$1;
    }
    ...
    public final Object invoke(EquityShareOrderDataState equityShareOrderDataState, Continuation<? super EquityShareOrderDataState> continuation) {
        return ((EquityShareOrderDuxo$refreshNbbo$2$1) create(equityShareOrderDataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

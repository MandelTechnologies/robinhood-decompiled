...
public final class FragmentEquityOrderBinding implements ViewBinding {
    ...
    private FragmentEquityOrderBinding(ConstraintLayout constraintLayout, TradeAccountSwitcherView tradeAccountSwitcherView, CardView cardView, ConstraintLayout constraintLayout2, ConstraintLayout constraintLayout3, BlockableNestedScrollView blockableNestedScrollView, LinearLayout linearLayout, ShimmerLoadingView shimmerLoadingView, MarketSessionChangeAlertView marketSessionChangeAlertView, RdsNumpadView rdsNumpadView, Space space, EquityOrderTypeTooltipView equityOrderTypeTooltipView, RdsButton rdsButton, RdsTextButton rdsTextButton, CoordinatorLayout coordinatorLayout, RhTextView rhTextView, ComposeView composeView) {
    ...
    public static FragmentEquityOrderBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentEquityOrderBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C29365R.layout.fragment_equity_order, viewGroup, false);
        if (z) {
    ...
    public static FragmentEquityOrderBinding bind(View view) {
                                                    ...
                                                    if (rdsTextButton != null) {
                                                        ...
                                                        if (coordinatorLayout != null) {
                                                            ...
                                                            if (rhTextView != null) {
                                                                ...
                                                                if (composeView != null) {
                                                                    return new FragmentEquityOrderBinding(constraintLayout, tradeAccountSwitcherView, cardView, constraintLayout, constraintLayout2, blockableNestedScrollView, linearLayout, shimmerLoadingView, marketSessionChangeAlertView, rdsNumpadView, space, equityOrderTypeTooltipView, rdsButton, rdsTextButton, coordinatorLayout, rhTextView, composeView);
                                                                }
                                                            }
                                                        }
                                                    }

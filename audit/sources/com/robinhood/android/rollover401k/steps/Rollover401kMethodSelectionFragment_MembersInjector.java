...
public final class Rollover401kMethodSelectionFragment_MembersInjector implements MembersInjector<Rollover401kMethodSelectionFragment> {
    ...
    @JvmStatic
    public static final MembersInjector<Rollover401kMethodSelectionFragment> create(Provider<BaseFragmentSingletons> provider, Provider<GenericComposeSingletons> provider2, Provider<Markwon> provider3, Provider<Retirement401kRolloverStore> provider4) {
        return INSTANCE.create(provider, provider2, provider3, provider4);
    }

    @JvmStatic
    public static final void injectRetirement401kRolloverStore(Rollover401kMethodSelectionFragment rollover401kMethodSelectionFragment, Retirement401kRolloverStore retirement401kRolloverStore) {
        INSTANCE.injectRetirement401kRolloverStore(rollover401kMethodSelectionFragment, retirement401kRolloverStore);
    }

    public Rollover401kMethodSelectionFragment_MembersInjector(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<Markwon> markwon, Provider<Retirement401kRolloverStore> retirement401kRolloverStore) {
    ...
    public void injectMembers(Rollover401kMethodSelectionFragment instance) {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final MembersInjector<Rollover401kMethodSelectionFragment> create(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<Markwon> markwon, Provider<Retirement401kRolloverStore> retirement401kRolloverStore) {
            Intrinsics.checkNotNullParameter(singletons, "singletons");
            Intrinsics.checkNotNullParameter(genericComposeSingletons, "genericComposeSingletons");
            Intrinsics.checkNotNullParameter(markwon, "markwon");
            Intrinsics.checkNotNullParameter(retirement401kRolloverStore, "retirement401kRolloverStore");
            return new Rollover401kMethodSelectionFragment_MembersInjector(singletons, genericComposeSingletons, markwon, retirement401kRolloverStore);
        }

        @JvmStatic
        public final void injectRetirement401kRolloverStore(Rollover401kMethodSelectionFragment instance, Retirement401kRolloverStore retirement401kRolloverStore) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(retirement401kRolloverStore, "retirement401kRolloverStore");

...
public final class Rollover401kDiyFragment_MembersInjector implements MembersInjector<Rollover401kDiyFragment> {
    ...
    @JvmStatic
    public static final MembersInjector<Rollover401kDiyFragment> create(Provider<BaseFragmentSingletons> provider, Provider<GenericComposeSingletons> provider2, Provider<Markwon> provider3, Provider<Retirement401kRolloverStore> provider4, Provider<SurveyManager3> provider5) {
        return INSTANCE.create(provider, provider2, provider3, provider4, provider5);
    }

    @JvmStatic
    public static final void injectUserLeapManager(Rollover401kDiyFragment rollover401kDiyFragment, SurveyManager3 surveyManager3) {
        INSTANCE.injectUserLeapManager(rollover401kDiyFragment, surveyManager3);
    }

    public Rollover401kDiyFragment_MembersInjector(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<Markwon> markwon, Provider<Retirement401kRolloverStore> retirement401kRolloverStore, Provider<SurveyManager3> userLeapManager) {
    ...
    public void injectMembers(Rollover401kDiyFragment instance) {
        ...
        Rollover401kGenericFragment_MembersInjector.Companion companion3 = Rollover401kGenericFragment_MembersInjector.INSTANCE;
    ...
    /* compiled from: Rollover401kDiyFragment_MembersInjector.kt */
    @Metadata(m3635d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003JT\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u00052\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\b2\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u000b0\b2\f\u0010\f\u001a\b\u0012\u0004\u0012\u00020\r0\b2\f\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u000f0\b2\f\u0010\u0010\u001a\b\u0012\u0004\u0012\u00020\u00110\bH\u0007J\u0018\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u00062\u0006\u0010\u0010\u001a\u00020\u0011H\u0007¨\u0006\u0015"}, m3636d2 = {"Lcom/robinhood/android/rollover401k/steps/Rollover401kDiyFragment_MembersInjector$Companion;", "", "<init>", "()V", AnalyticsStrings.BUTTON_NEW_LIST_CREATE, "Ldagger/MembersInjector;", "Lcom/robinhood/android/rollover401k/steps/Rollover401kDiyFragment;", "singletons", "Ljavax/inject/Provider;", "Lcom/robinhood/android/common/ui/di/BaseFragmentSingletons;", "genericComposeSingletons", "Lcom/robinhood/compose/app/GenericComposeSingletons;", "markwon", "Lio/noties/markwon/Markwon;", "retirement401kRolloverStore", "Lcom/robinhood/librobinhood/data/store/bonfire/retirement/Retirement401kRolloverStore;", "userLeapManager", "Lcom/robinhood/userleap/UserLeapManager;", "injectUserLeapManager", "", "instance", "feature-rollover-401k_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    public static final class Companion {
        ...
        @JvmStatic
        public final MembersInjector<Rollover401kDiyFragment> create(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<Markwon> markwon, Provider<Retirement401kRolloverStore> retirement401kRolloverStore, Provider<SurveyManager3> userLeapManager) {
            Intrinsics.checkNotNullParameter(singletons, "singletons");
            Intrinsics.checkNotNullParameter(genericComposeSingletons, "genericComposeSingletons");
            Intrinsics.checkNotNullParameter(markwon, "markwon");
            Intrinsics.checkNotNullParameter(retirement401kRolloverStore, "retirement401kRolloverStore");
            Intrinsics.checkNotNullParameter(userLeapManager, "userLeapManager");
            return new Rollover401kDiyFragment_MembersInjector(singletons, genericComposeSingletons, markwon, retirement401kRolloverStore, userLeapManager);
        }

        @JvmStatic
        public final void injectUserLeapManager(Rollover401kDiyFragment instance, SurveyManager3 userLeapManager) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(userLeapManager, "userLeapManager");

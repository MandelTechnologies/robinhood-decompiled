...
@DebugMetadata(m3644c = "com.robinhood.android.idl.common.pagination.RealIdlPaginatedResponseEndpoint$fetchAllPages$networkCall$1", m3645f = "IdlPaginatedResponseEndpoint.kt", m3646l = {EnumC7081g.SDK_ASSET_ILLUSTRATION_SQUARE_CASH_GENERIC_INSTITUTION_VALUE}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.android.idl.common.pagination.RealIdlPaginatedResponseEndpoint$fetchAllPages$networkCall$1, reason: use source file name */
/* loaded from: classes10.dex */
final class IdlPaginatedResponseEndpoint4<P, T> extends ContinuationImpl7 implements Function3<P, IdlPaginationCursor, Continuation<? super T>, Object> {
    ...
    IdlPaginatedResponseEndpoint4(IdlPaginatedResponseEndpoint3<P, T> idlPaginatedResponseEndpoint3, Continuation<? super IdlPaginatedResponseEndpoint4> continuation) {
    ...
    public final Object invoke(P p, IdlPaginationCursor idlPaginationCursor, Continuation<? super T> continuation) {
        IdlPaginatedResponseEndpoint4 idlPaginatedResponseEndpoint4 = new IdlPaginatedResponseEndpoint4(this.this$0, continuation);
        idlPaginatedResponseEndpoint4.L$0 = p;
        idlPaginatedResponseEndpoint4.L$1 = idlPaginationCursor;
        return idlPaginatedResponseEndpoint4.invokeSuspend(Unit.INSTANCE);
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlin.jvm.functions.Function3
    public /* bridge */ /* synthetic */ Object invoke(Object obj, IdlPaginationCursor idlPaginationCursor, Object obj2) {
        return invoke((IdlPaginatedResponseEndpoint4<P, T>) obj, idlPaginationCursor, (Continuation) obj2);
    }

...
@DebugMetadata(m3644c = "com.robinhood.android.idl.common.pagination.RealIdlPaginatedResponseEndpoint$refreshAllPages$networkCall$1", m3645f = "IdlPaginatedResponseEndpoint.kt", m3646l = {EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_NAVBAR_DARK_APPEARANCE_VALUE, EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_NAVBAR_DARK_APPEARANCE_VALUE}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.android.idl.common.pagination.RealIdlPaginatedResponseEndpoint$refreshAllPages$networkCall$1, reason: use source file name */
/* loaded from: classes10.dex */
final class IdlPaginatedResponseEndpoint6<P, T> extends ContinuationImpl7 implements Function3<P, IdlPaginationCursor, Continuation<? super T>, Object> {
    ...
    IdlPaginatedResponseEndpoint6(boolean z, IdlPaginatedResponseEndpoint3<P, T> idlPaginatedResponseEndpoint3, Continuation<? super IdlPaginatedResponseEndpoint6> continuation) {
    ...
    public final Object invoke(P p, IdlPaginationCursor idlPaginationCursor, Continuation<? super T> continuation) {
        IdlPaginatedResponseEndpoint6 idlPaginatedResponseEndpoint6 = new IdlPaginatedResponseEndpoint6(this.$force, this.this$0, continuation);
        idlPaginatedResponseEndpoint6.L$0 = p;
        idlPaginatedResponseEndpoint6.L$1 = idlPaginationCursor;
        return idlPaginatedResponseEndpoint6.invokeSuspend(Unit.INSTANCE);
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlin.jvm.functions.Function3
    public /* bridge */ /* synthetic */ Object invoke(Object obj, IdlPaginationCursor idlPaginationCursor, Object obj2) {
        return invoke((IdlPaginatedResponseEndpoint6<P, T>) obj, idlPaginationCursor, (Continuation) obj2);
    }

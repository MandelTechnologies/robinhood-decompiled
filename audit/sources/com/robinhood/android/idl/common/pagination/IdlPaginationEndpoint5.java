...
@DebugMetadata(m3644c = "com.robinhood.android.idl.common.pagination.RealIdlPaginatedEndpoint$forceFetchAllPages$networkCall$1", m3645f = "IdlPaginationEndpoint.kt", m3646l = {EnumC7081g.SDK_ASSET_ILLUSTRATION_DEV_LOGS_VALUE}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.android.idl.common.pagination.RealIdlPaginatedEndpoint$forceFetchAllPages$networkCall$1, reason: use source file name */
/* loaded from: classes10.dex */
final class IdlPaginationEndpoint5<P, T> extends ContinuationImpl7 implements Function3<P, IdlPaginationCursor, Continuation<? super T>, Object> {
    ...
    IdlPaginationEndpoint5(IdlPaginationEndpoint3<P, T> idlPaginationEndpoint3, Continuation<? super IdlPaginationEndpoint5> continuation) {
    ...
    public final Object invoke(P p, IdlPaginationCursor idlPaginationCursor, Continuation<? super T> continuation) {
        IdlPaginationEndpoint5 idlPaginationEndpoint5 = new IdlPaginationEndpoint5(this.this$0, continuation);
        idlPaginationEndpoint5.L$0 = p;
        idlPaginationEndpoint5.L$1 = idlPaginationCursor;
        return idlPaginationEndpoint5.invokeSuspend(Unit.INSTANCE);
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlin.jvm.functions.Function3
    public /* bridge */ /* synthetic */ Object invoke(Object obj, IdlPaginationCursor idlPaginationCursor, Object obj2) {
        return invoke((IdlPaginationEndpoint5<P, T>) obj, idlPaginationCursor, (Continuation) obj2);
    }

...
/* renamed from: com.robinhood.android.supportchat.thread.compose.CxChatTopBarKt$Preview$1$2, reason: use source file name */
/* loaded from: classes9.dex */
final class CxChatTopBar3 implements Function2<Composer, Integer, Unit> {
    final /* synthetic */ CxChatTopBar4.Args $args;

    CxChatTopBar3(CxChatTopBar4.Args args) {
        this.$args = args;
    }
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1665398616, i, -1, "com.robinhood.android.supportchat.thread.compose.Preview.<anonymous>.<anonymous> (CxChatTopBar.kt:252)");
        }
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new Function0() { // from class: com.robinhood.android.supportchat.thread.compose.CxChatTopBarKt$Preview$1$2$$ExternalSyntheticLambda0

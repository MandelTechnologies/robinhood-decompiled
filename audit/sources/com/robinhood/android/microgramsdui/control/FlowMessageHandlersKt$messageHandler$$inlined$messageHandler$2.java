...
public final class FlowMessageHandlersKt$messageHandler$$inlined$messageHandler$2 implements MessageHandler {
    final /* synthetic */ JsonAdapter $adapter$inlined;
    final /* synthetic */ SharedFlow2 $this_messageHandler;

    @Metadata(m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "com.robinhood.android.microgramsdui.control.FlowMessageHandlersKt$messageHandler$$inlined$messageHandler$2", m3645f = "FlowMessageHandlers.kt", m3646l = {16}, m3647m = "handle")
    /* renamed from: com.robinhood.android.microgramsdui.control.FlowMessageHandlersKt$messageHandler$$inlined$messageHandler$2$1 */
    public static final class C218781 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        public C218781(Continuation continuation) {
            super(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return FlowMessageHandlersKt$messageHandler$$inlined$messageHandler$2.this.handle(null, this);
        }
    }

    public FlowMessageHandlersKt$messageHandler$$inlined$messageHandler$2(SharedFlow2 sharedFlow2, JsonAdapter jsonAdapter) {
    ...
    */
    public Object handle(Message message, Continuation continuation) throws IOException {
        C218781 c218781;
        if (continuation instanceof C218781) {
            c218781 = (C218781) continuation;
            int i = c218781.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c218781.label = i - Integer.MIN_VALUE;
            } else {
                c218781 = new C218781(continuation);
            }
        }
        Object obj = c218781.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c218781.label;
        if (i2 == 0) {
            ...
            if (objFromJson != null) {
                c218781.label = 1;
                if (sharedFlow2.emit(objFromJson, c218781) == coroutine_suspended) {

...
@DebugMetadata(m3644c = "com.robinhood.android.challenge.verification.backup.BackupCodeVerificationDuxo$submitChallenge$2$1", m3645f = "BackupCodeVerificationDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.android.challenge.verification.backup.BackupCodeVerificationDuxo$submitChallenge$2$1, reason: use source file name */
/* loaded from: classes7.dex */
final class BackupCodeVerificationDuxo5 extends ContinuationImpl7 implements Function2<ChallengeVerificationDataState, Continuation<? super ChallengeVerificationDataState>, Object> {
    ...
    BackupCodeVerificationDuxo5(BackupCodeVerificationDuxo backupCodeVerificationDuxo, Challenge challenge, Continuation<? super BackupCodeVerificationDuxo5> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        BackupCodeVerificationDuxo5 backupCodeVerificationDuxo5 = new BackupCodeVerificationDuxo5(this.this$0, this.$challenge, continuation);
        backupCodeVerificationDuxo5.L$0 = obj;
        return backupCodeVerificationDuxo5;
    }
    ...
    public final Object invoke(ChallengeVerificationDataState challengeVerificationDataState, Continuation<? super ChallengeVerificationDataState> continuation) {
        return ((BackupCodeVerificationDuxo5) create(challengeVerificationDataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

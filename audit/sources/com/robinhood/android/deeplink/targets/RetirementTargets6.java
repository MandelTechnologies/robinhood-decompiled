...
/* renamed from: com.robinhood.android.deeplink.targets.RetirementTargetsKt, reason: use source file name */
/* loaded from: classes2.dex */
public final class RetirementTargets6 {
    /* JADX INFO: Access modifiers changed from: private */
    public static final Intent[] getIntent(DeeplinkTarget2 deeplinkTarget2) {
        return new Intent[]{Navigator.DefaultImpls.createIntent$default(deeplinkTarget2.getNavigator(), deeplinkTarget2.getContext(), new TabLinkIntentKey.Retirement(deeplinkTarget2.getUri().getQueryParameter("account_number"), deeplinkTarget2.getUri().getQueryParameter("context"), deeplinkTarget2.getUri().getQueryParameter("first_swipey")), null, false, 12, null)};
    }
}

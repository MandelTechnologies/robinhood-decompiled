...
final class StatsSectionKt$BidAskSection$1$6$1 implements Function1<ConstrainScope, Unit> {
    final /* synthetic */ ConstraintLayoutBaseScope4 $ask;

    StatsSectionKt$BidAskSection$1$6$1(ConstraintLayoutBaseScope4 constraintLayoutBaseScope4) {
        this.$ask = constraintLayoutBaseScope4;
    }
    ...
    public final void invoke2(ConstrainScope constrainAs) {
        ...
        ConstraintScopeCommon5.m8162linkToVpY3zN4$default(constrainAs.getBottom(), this.$ask.getTop(), 0.0f, 0.0f, 6, null);

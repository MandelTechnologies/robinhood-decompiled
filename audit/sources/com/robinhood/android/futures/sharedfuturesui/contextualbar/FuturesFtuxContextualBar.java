...
/* renamed from: com.robinhood.android.futures.sharedfuturesui.contextualbar.ComposableSingletons$FuturesFtuxContextualBarKt, reason: use source file name */
/* loaded from: classes3.dex */
public final class FuturesFtuxContextualBar {
    public static final FuturesFtuxContextualBar INSTANCE = new FuturesFtuxContextualBar();

    /* renamed from: lambda$-1965602962, reason: not valid java name */
    private static Function4<AnimatedContentScope, FtuxContextualBarData, Composer, Integer, Unit> f8998lambda$1965602962 = ComposableLambda3.composableLambdaInstance(-1965602962, false, new Function4<AnimatedContentScope, FtuxContextualBarData, Composer, Integer, Unit>() { // from class: com.robinhood.android.futures.sharedfuturesui.contextualbar.ComposableSingletons$FuturesFtuxContextualBarKt$lambda$-1965602962$1
        ...
        public final void invoke(AnimatedContentScope AnimatedContent, FtuxContextualBarData animatedState, Composer composer, int i) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1965602962, i, -1, "com.robinhood.android.futures.sharedfuturesui.contextualbar.ComposableSingletons$FuturesFtuxContextualBarKt.lambda$-1965602962.<anonymous> (FuturesFtuxContextualBar.kt:58)");
            }
            ...
            composer.startReplaceGroup(1486781192);
            if (subText != null) {
    ...
    /* renamed from: getLambda$-1965602962$lib_shared_futures_ui_externalDebug, reason: not valid java name */
    public final Function4<AnimatedContentScope, FtuxContextualBarData, Composer, Integer, Unit> m14747getLambda$1965602962$lib_shared_futures_ui_externalDebug() {
        return f8998lambda$1965602962;
    }
}

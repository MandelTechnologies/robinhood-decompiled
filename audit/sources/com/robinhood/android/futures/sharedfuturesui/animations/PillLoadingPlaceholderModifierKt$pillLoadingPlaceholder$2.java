...
final class PillLoadingPlaceholderModifierKt$pillLoadingPlaceholder$2 implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    final /* synthetic */ PillLoadingPlaceholderDrawPill $drawPill;
    final /* synthetic */ Shape $shape;

    PillLoadingPlaceholderModifierKt$pillLoadingPlaceholder$2(int i, float f, Shape shape, float f2, Brush brush, PillLoadingPlaceholderDrawPill pillLoadingPlaceholderDrawPill, long j) {
        this.$animationDurationMills = i;
        this.$borderWidth = f;
        this.$shape = shape;
        this.$alpha = f2;
        this.$borderBrush = brush;
        this.$drawPill = pillLoadingPlaceholderDrawPill;
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i) {
        ...
        composer.startReplaceGroup(1306171249);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1306171249, i, -1, "com.robinhood.android.futures.sharedfuturesui.animations.pillLoadingPlaceholder.<anonymous> (PillLoadingPlaceholderModifier.kt:96)");
        }
        ...
        boolean zChanged = composer.changed(this.$borderWidth) | composer.changed(this.$shape) | composer.changed(this.$alpha) | composer.changed(snapshotState4AnimateFloat) | composer.changed(this.$borderBrush) | composer.changedInstance(this.$drawPill) | composer.changed(this.$backgroundColor);
        final float f = this.$borderWidth;
        final Shape shape = this.$shape;
        final float f2 = this.$alpha;
        final PillLoadingPlaceholderDrawPill pillLoadingPlaceholderDrawPill = this.$drawPill;
        final Brush brush = this.$borderBrush;
        final long j = this.$backgroundColor;
        Object objRememberedValue = composer.rememberedValue();
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            Object obj = new Function1() { // from class: com.robinhood.android.futures.sharedfuturesui.animations.PillLoadingPlaceholderModifierKt$pillLoadingPlaceholder$2$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj2) {
                    return PillLoadingPlaceholderModifierKt$pillLoadingPlaceholder$2.invoke$lambda$6$lambda$5(f, shape, f2, pillLoadingPlaceholderDrawPill, snapshotState4AnimateFloat, brush, j, (CacheDrawScope) obj2);
                }
            };
    ...
    public static final DrawResult invoke$lambda$6$lambda$5(float f, Shape shape, final float f2, final PillLoadingPlaceholderDrawPill pillLoadingPlaceholderDrawPill, final SnapshotState4 snapshotState4, final Brush brush, final long j, CacheDrawScope drawWithCache) {
        ...
        final PathMeasure pathMeasure = PathMeasures.toPathMeasure(outlineMo4911createOutlinePq9zytI);
        ...
        return drawWithCache.onDrawBehind(new Function1() { // from class: com.robinhood.android.futures.sharedfuturesui.animations.PillLoadingPlaceholderModifierKt$pillLoadingPlaceholder$2$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return PillLoadingPlaceholderModifierKt$pillLoadingPlaceholder$2.invoke$lambda$6$lambda$5$lambda$4(f2, fM6582getMinDimensionimpl2, fM6582getMinDimensionimpl3, pathMeasure, f4, pillLoadingPlaceholderDrawPill, snapshotState4, outlineMo4911createOutlinePq9zytI, brush, stroke, fM6582getMinDimensionimpl, j, (DrawScope) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit invoke$lambda$6$lambda$5$lambda$4(float f, float f2, float f3, PathMeasure pathMeasure, float f4, PillLoadingPlaceholderDrawPill pillLoadingPlaceholderDrawPill, SnapshotState4 snapshotState4, Outline outline, Brush brush, Stroke stroke, float f5, long j, DrawScope onDrawBehind) {
        ...
        long offsetAtCurrentProgress = PathMeasures.getOffsetAtCurrentProgress(pathMeasure, invoke$lambda$0(snapshotState4));
        ...
        try {
            ...
            pillLoadingPlaceholderDrawPill.mo14256drawPilliUh5c1k(onDrawBehind, f5, j2, f6, j);
            return Unit.INSTANCE;
        } catch (Throwable th) {
            float f8 = -f4;

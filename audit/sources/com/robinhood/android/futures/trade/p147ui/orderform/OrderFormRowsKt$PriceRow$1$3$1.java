...
final class OrderFormRowsKt$PriceRow$1$3$1 implements Function1<ConstrainScope, Unit> {
    final /* synthetic */ ConstraintLayoutBaseScope4 $bid;

    OrderFormRowsKt$PriceRow$1$3$1(ConstraintLayoutBaseScope4 constraintLayoutBaseScope4) {
    ...
    public final void invoke2(ConstrainScope constrainAs) {
        ...
        ConstraintScopeCommon6.m8185linkToVpY3zN4$default(constrainAs.getStart(), this.$bid.getEnd(), 0.0f, 0.0f, 6, null);
    }
}

...
public final /* data */ class LadderPriceData {
    ...
    public static /* synthetic */ LadderPriceData copy$default(LadderPriceData ladderPriceData, List list, List list2, Long l, DxFeedData.Trade trade, Long l2, FuturesQuote futuresQuote, Long l3, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            list = ladderPriceData.bids;
        }
        if ((i & 2) != 0) {
            list2 = ladderPriceData.asks;
        }
        if ((i & 4) != 0) {
            l = ladderPriceData.dxDomTimestamp;
        }
        if ((i & 8) != 0) {
            trade = ladderPriceData.lastTrade;
        }
        if ((i & 16) != 0) {
            l2 = ladderPriceData.dxTradeTimestamp;
        }
        if ((i & 32) != 0) {
            futuresQuote = ladderPriceData.quote;
        }
        if ((i & 64) != 0) {
            l3 = ladderPriceData.quoteTimestamp;
        }
        if ((i & 128) != 0) {
            z = ladderPriceData.loggedDxDataIssue;
        }
        Long l4 = l3;
        boolean z2 = z;
        Long l5 = l2;
        FuturesQuote futuresQuote2 = futuresQuote;
        return ladderPriceData.copy(list, list2, l, trade, l5, futuresQuote2, l4, z2);
    }

    public final LadderPriceData copy(List<? extends Tuples2<? extends BigDecimal, Integer>> bids, List<? extends Tuples2<? extends BigDecimal, Integer>> asks, Long dxDomTimestamp, DxFeedData.Trade lastTrade, Long dxTradeTimestamp, FuturesQuote quote, Long quoteTimestamp, boolean loggedDxDataIssue) {
        return new LadderPriceData(bids, asks, dxDomTimestamp, lastTrade, dxTradeTimestamp, quote, quoteTimestamp, loggedDxDataIssue);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LadderPriceData)) {
            return false;
        }
        LadderPriceData ladderPriceData = (LadderPriceData) other;
        return Intrinsics.areEqual(this.bids, ladderPriceData.bids) && Intrinsics.areEqual(this.asks, ladderPriceData.asks) && Intrinsics.areEqual(this.dxDomTimestamp, ladderPriceData.dxDomTimestamp) && Intrinsics.areEqual(this.lastTrade, ladderPriceData.lastTrade) && Intrinsics.areEqual(this.dxTradeTimestamp, ladderPriceData.dxTradeTimestamp) && Intrinsics.areEqual(this.quote, ladderPriceData.quote) && Intrinsics.areEqual(this.quoteTimestamp, ladderPriceData.quoteTimestamp) && this.loggedDxDataIssue == ladderPriceData.loggedDxDataIssue;
    }
    ...
    public String toString() {
        return "LadderPriceData(bids=" + this.bids + ", asks=" + this.asks + ", dxDomTimestamp=" + this.dxDomTimestamp + ", lastTrade=" + this.lastTrade + ", dxTradeTimestamp=" + this.dxTradeTimestamp + ", quote=" + this.quote + ", quoteTimestamp=" + this.quoteTimestamp + ", loggedDxDataIssue=" + this.loggedDxDataIssue + ")";
    }

    /* JADX WARN: Multi-variable type inference failed */
    public LadderPriceData(List<? extends Tuples2<? extends BigDecimal, Integer>> list, List<? extends Tuples2<? extends BigDecimal, Integer>> list2, Long l, DxFeedData.Trade trade, Long l2, FuturesQuote futuresQuote, Long l3, boolean z) {
        this.bids = list;
        this.asks = list2;
    ...
    public /* synthetic */ LadderPriceData(List list, List list2, Long l, DxFeedData.Trade trade, Long l2, FuturesQuote futuresQuote, Long l3, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {

...
/* compiled from: DirectDepositBranchFragment.kt */
@Metadata(m3635d1 = {"\u0000Z\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0007\u0018\u0000 -2\u00020\u00012\u00020\u0002:\u0002,-B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\u001a\u0010\u0019\u001a\u00020\u001a2\u0006\u0010\u001b\u001a\u00020\u001c2\b\u0010\u001d\u001a\u0004\u0018\u00010\u001eH\u0016J\u0010\u0010\u001f\u001a\u00020\u001a2\u0006\u0010 \u001a\u00020!H\u0016J\u0010\u0010\"\u001a\u00020\u001a2\u0006\u0010#\u001a\u00020$H\u0016J\u0010\u0010%\u001a\u00020\u001a2\u0006\u0010#\u001a\u00020$H\u0002J\u0018\u0010&\u001a\u00020\u001a2\u0006\u0010'\u001a\u00020(2\u0006\u0010)\u001a\u00020*H\u0002J\b\u0010+\u001a\u00020\u001aH\u0016R\u001e\u0010\u0005\u001a\u00020\u00068\u0006@\u0006X\u0087.¢\u0006\u000e\n\u0000\u001a\u0004\b\u0007\u0010\b\"\u0004\b\t\u0010\nR\u001b\u0010\u000b\u001a\u00020\f8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u000f\u0010\u0010\u001a\u0004\b\r\u0010\u000eR\u001b\u0010\u0011\u001a\u00020\f8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0013\u0010\u0010\u001a\u0004\b\u0012\u0010\u000eR\u001b\u0010\u0014\u001a\u00020\u00158BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0018\u0010\u0010\u001a\u0004\b\u0016\u0010\u0017¨\u0006."}, m3636d2 = {"Lcom/robinhood/android/directdeposit/ui/intro/DirectDepositBranchFragment;", "Lcom/robinhood/android/common/ui/BaseFragment;", "Lcom/robinhood/android/common/mcduckling/ui/detail/card/SecondaryAuthenticationFragment$Callbacks;", "<init>", "()V", "eventLogger", "Lcom/robinhood/analytics/EventLogger;", "getEventLogger", "()Lcom/robinhood/analytics/EventLogger;", "setEventLogger", "(Lcom/robinhood/analytics/EventLogger;)V", "accountInfoRow", "Lcom/robinhood/android/designsystem/row/RdsRowView;", "getAccountInfoRow", "()Lcom/robinhood/android/designsystem/row/RdsRowView;", "accountInfoRow$delegate", "Lkotlin/properties/ReadOnlyProperty;", "prefilledRow", "getPrefilledRow", "prefilledRow$delegate", "callbacks", "Lcom/robinhood/android/directdeposit/ui/intro/DirectDepositBranchFragment$Callbacks;", "getCallbacks", "()Lcom/robinhood/android/directdeposit/ui/intro/DirectDepositBranchFragment$Callbacks;", "callbacks$delegate", "onViewCreated", "", "view", "Landroid/view/View;", "savedInstanceState", "Landroid/os/Bundle;", "configureToolbar", "toolbar", "Lcom/robinhood/android/common/ui/view/RhToolbar;", "onSecondaryAuthenticationSuccess", "requestCode", "", "requestSecondaryAuth", "logRowTap", "setupType", "Lcom/robinhood/rosetta/eventlogging/DirectDepositContext$DirectDepositType;", "action", "Lcom/robinhood/rosetta/eventlogging/UserInteractionEventData$Action;", "onStart", "Callbacks", "Companion", "feature-direct-deposit_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
@SourceDebugExtension
/* loaded from: classes27.dex */
public final class DirectDepositBranchFragment extends BaseFragment implements SecondaryAuthenticationFragment.Callbacks {
    private static final int REQUEST_ACCOUNT_INFO_AUTH = 1;
    private static final int REQUEST_PRE_FILLED_FORM_AUTH = 2;

    /* renamed from: accountInfoRow$delegate, reason: from kotlin metadata */
    private final Interfaces2 accountInfoRow;

    /* renamed from: callbacks$delegate, reason: from kotlin metadata */
    private final Interfaces2 callbacks;
    public EventLogger eventLogger;

    /* renamed from: prefilledRow$delegate, reason: from kotlin metadata */
    private final Interfaces2 prefilledRow;
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(DirectDepositBranchFragment.class, "accountInfoRow", "getAccountInfoRow()Lcom/robinhood/android/designsystem/row/RdsRowView;", 0)), Reflection.property1(new PropertyReference1Impl(DirectDepositBranchFragment.class, "prefilledRow", "getPrefilledRow()Lcom/robinhood/android/designsystem/row/RdsRowView;", 0)), Reflection.property1(new PropertyReference1Impl(DirectDepositBranchFragment.class, "callbacks", "getCallbacks()Lcom/robinhood/android/directdeposit/ui/intro/DirectDepositBranchFragment$Callbacks;", 0))};
    ...
    /* compiled from: DirectDepositBranchFragment.kt */
    @Metadata(m3635d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\bf\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H&J\b\u0010\u0004\u001a\u00020\u0003H&¨\u0006\u0005"}, m3636d2 = {"Lcom/robinhood/android/directdeposit/ui/intro/DirectDepositBranchFragment$Callbacks;", "", "onSeeAccountInfo", "", "onGetPreFilledForm", "feature-direct-deposit_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    public interface Callbacks {
        void onGetPreFilledForm();

        void onSeeAccountInfo();
    }

    public DirectDepositBranchFragment() {
        super(C14044R.layout.fragment_direct_deposit_branch);
        this.accountInfoRow = bindView(C14044R.id.direct_deposit_account_info);
        this.prefilledRow = bindView(C14044R.id.direct_deposit_pre_filled);
        this.callbacks = new CallbacksProperty(Reflection.getOrCreateKotlinClass(Callbacks.class), new Function1<Fragment, Object>() { // from class: com.robinhood.android.directdeposit.ui.intro.DirectDepositBranchFragment$special$$inlined$hostActivityCallbacks$1
            ...
            public final Object invoke(Fragment CallbacksProperty) {
                ...
                for (Context context : BaseContexts.baseContexts(fragmentActivityRequireActivity)) {
                    if (context instanceof DirectDepositBranchFragment.Callbacks) {
                        return context;
                    }
                }
    ...
    private final RdsRowView getAccountInfoRow() {
        return (RdsRowView) this.accountInfoRow.getValue(this, $$delegatedProperties[0]);
    }

    private final RdsRowView getPrefilledRow() {
        return (RdsRowView) this.prefilledRow.getValue(this, $$delegatedProperties[1]);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        OnClickListeners.onClick(getAccountInfoRow(), new Function0() { // from class: com.robinhood.android.directdeposit.ui.intro.DirectDepositBranchFragment$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return DirectDepositBranchFragment.onViewCreated$lambda$0(this.f$0);
            }
        });
        OnClickListeners.onClick(getPrefilledRow(), new Function0() { // from class: com.robinhood.android.directdeposit.ui.intro.DirectDepositBranchFragment$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return DirectDepositBranchFragment.onViewCreated$lambda$1(this.f$0);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit onViewCreated$lambda$0(DirectDepositBranchFragment directDepositBranchFragment) {
        directDepositBranchFragment.logRowTap(DirectDepositContext.DirectDepositType.ONLINE, UserInteractionEventData.Action.VIEW_DD_ACCOUNT_INFO);
        directDepositBranchFragment.requestSecondaryAuth(1);
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit onViewCreated$lambda$1(DirectDepositBranchFragment directDepositBranchFragment) {
        directDepositBranchFragment.logRowTap(DirectDepositContext.DirectDepositType.PREFILLED_FORM, UserInteractionEventData.Action.VIEW_DD_PREFILLED_INTRO);
        directDepositBranchFragment.requestSecondaryAuth(2);
        return Unit.INSTANCE;
    }
    ...
    public static final class Companion {
        ...
        public final DirectDepositBranchFragment newInstance() {
            return new DirectDepositBranchFragment();
        }
    }
}

...
@Deprecated
/* renamed from: com.robinhood.android.options.simulatedreturnschart.RawYAxisLabel$$serializer, reason: use source file name */
/* loaded from: classes11.dex */
public /* synthetic */ class RawYAxisLabel2 implements PluginHelperInterfaces<RawYAxisLabel> {
    public static final int $stable;
    public static final RawYAxisLabel2 INSTANCE;
    private static final SerialDescriptor descriptor;

    private RawYAxisLabel2() {
    }
    ...
    static {
        RawYAxisLabel2 rawYAxisLabel2 = new RawYAxisLabel2();
        INSTANCE = rawYAxisLabel2;
        $stable = 8;
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.robinhood.android.options.simulatedreturnschart.RawYAxisLabel", rawYAxisLabel2, 3);
    ...
    public final KSerializer<?>[] childSerializers() {
        ...
        return new KSerializer[]{doubleSerializer, StringSerializer.INSTANCE, doubleSerializer};
    }

    @Override // kotlinx.serialization.KSerializer2
    public final RawYAxisLabel deserialize(Decoding2 decoder) {
        ...
        if (decodingBeginStructure.decodeSequentially()) {
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    dDecodeDoubleElement4 = decodingBeginStructure.decodeDoubleElement(serialDescriptor, 0);
                    i2 |= 1;
        ...
        return new RawYAxisLabel(i, d, str, dDecodeDoubleElement, null);
    }

    @Override // kotlinx.serialization.KSerializer3
    public final void serialize(Encoding4 encoder, RawYAxisLabel value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor serialDescriptor = descriptor;
        Encoding3 encoding3BeginStructure = encoder.beginStructure(serialDescriptor);
        RawYAxisLabel.write$Self$lib_options_simulated_returns_chart_externalDebug(value, encoding3BeginStructure, serialDescriptor);

...
public final class RhyReferralContactListFragment_MembersInjector implements MembersInjector<RhyReferralContactListFragment> {
    ...
    @JvmStatic
    public static final MembersInjector<RhyReferralContactListFragment> create(Provider<BaseFragmentSingletons> provider, Provider<GenericComposeSingletons> provider2, Provider<EventLogger> provider3, Provider<RhyGlobalLoggingContext> provider4) {
        return INSTANCE.create(provider, provider2, provider3, provider4);
    }

    @JvmStatic
    public static final void injectEventLogger(RhyReferralContactListFragment rhyReferralContactListFragment, EventLogger eventLogger) {
        INSTANCE.injectEventLogger(rhyReferralContactListFragment, eventLogger);
    }

    @JvmStatic
    public static final void injectRhyGlobalLoggingContext(RhyReferralContactListFragment rhyReferralContactListFragment, RhyGlobalLoggingContext rhyGlobalLoggingContext) {
        INSTANCE.injectRhyGlobalLoggingContext(rhyReferralContactListFragment, rhyGlobalLoggingContext);
    }

    public RhyReferralContactListFragment_MembersInjector(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<EventLogger> eventLogger, Provider<RhyGlobalLoggingContext> rhyGlobalLoggingContext) {
    ...
    public void injectMembers(RhyReferralContactListFragment instance) {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final MembersInjector<RhyReferralContactListFragment> create(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<EventLogger> eventLogger, Provider<RhyGlobalLoggingContext> rhyGlobalLoggingContext) {
            Intrinsics.checkNotNullParameter(singletons, "singletons");
            Intrinsics.checkNotNullParameter(genericComposeSingletons, "genericComposeSingletons");
            Intrinsics.checkNotNullParameter(eventLogger, "eventLogger");
            Intrinsics.checkNotNullParameter(rhyGlobalLoggingContext, "rhyGlobalLoggingContext");
            return new RhyReferralContactListFragment_MembersInjector(singletons, genericComposeSingletons, eventLogger, rhyGlobalLoggingContext);
        }

        @JvmStatic
        public final void injectEventLogger(RhyReferralContactListFragment instance, EventLogger eventLogger) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(eventLogger, "eventLogger");
        ...
        @JvmStatic
        public final void injectRhyGlobalLoggingContext(RhyReferralContactListFragment instance, RhyGlobalLoggingContext rhyGlobalLoggingContext) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(rhyGlobalLoggingContext, "rhyGlobalLoggingContext");

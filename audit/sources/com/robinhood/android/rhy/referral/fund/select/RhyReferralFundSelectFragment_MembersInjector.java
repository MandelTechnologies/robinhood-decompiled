...
public final class RhyReferralFundSelectFragment_MembersInjector implements MembersInjector<RhyReferralFundSelectFragment> {
    ...
    @JvmStatic
    public static final MembersInjector<RhyReferralFundSelectFragment> create(Provider<BaseFragmentSingletons> provider, Provider<GenericComposeSingletons> provider2, Provider<EventLogger> provider3, Provider<RhyGlobalLoggingContext> provider4) {
        return INSTANCE.create(provider, provider2, provider3, provider4);
    }

    @JvmStatic
    public static final void injectEventLogger(RhyReferralFundSelectFragment rhyReferralFundSelectFragment, EventLogger eventLogger) {
        INSTANCE.injectEventLogger(rhyReferralFundSelectFragment, eventLogger);
    }

    @JvmStatic
    public static final void injectRhyGlobalLoggingContext(RhyReferralFundSelectFragment rhyReferralFundSelectFragment, RhyGlobalLoggingContext rhyGlobalLoggingContext) {
        INSTANCE.injectRhyGlobalLoggingContext(rhyReferralFundSelectFragment, rhyGlobalLoggingContext);
    }

    public RhyReferralFundSelectFragment_MembersInjector(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<EventLogger> eventLogger, Provider<RhyGlobalLoggingContext> rhyGlobalLoggingContext) {
    ...
    public void injectMembers(RhyReferralFundSelectFragment instance) {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final MembersInjector<RhyReferralFundSelectFragment> create(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<EventLogger> eventLogger, Provider<RhyGlobalLoggingContext> rhyGlobalLoggingContext) {
            Intrinsics.checkNotNullParameter(singletons, "singletons");
            Intrinsics.checkNotNullParameter(genericComposeSingletons, "genericComposeSingletons");
            Intrinsics.checkNotNullParameter(eventLogger, "eventLogger");
            Intrinsics.checkNotNullParameter(rhyGlobalLoggingContext, "rhyGlobalLoggingContext");
            return new RhyReferralFundSelectFragment_MembersInjector(singletons, genericComposeSingletons, eventLogger, rhyGlobalLoggingContext);
        }

        @JvmStatic
        public final void injectEventLogger(RhyReferralFundSelectFragment instance, EventLogger eventLogger) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(eventLogger, "eventLogger");
        ...
        @JvmStatic
        public final void injectRhyGlobalLoggingContext(RhyReferralFundSelectFragment instance, RhyGlobalLoggingContext rhyGlobalLoggingContext) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(rhyGlobalLoggingContext, "rhyGlobalLoggingContext");

package com.robinhood.android.blackwidow.p068ui.error;
...
public final class ErrorDialog extends GenericComposeDialogFragment implements RegionGated {
    ...
    /* renamed from: com.robinhood.android.blackwidow.ui.error.ErrorDialog$ComposeContent$1 */
    static final class C98641 implements Function2<Composer, Integer, Unit> {
        C98641() {
        }
        ...
        public final void invoke(Composer composer, int i) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1096232588, i, -1, "com.robinhood.android.blackwidow.ui.error.ErrorDialog.ComposeContent.<anonymous> (ErrorDialog.kt:25)");
            }
            String strStringResource = StringResources_androidKt.stringResource(C11048R.string.general_error_title, composer, 0);
            BentoAlertDialog2.Body.Text text = new BentoAlertDialog2.Body.Text(StringResources_androidKt.stringResource(C9859R.string.explore_legend_upsell_error_subtitle, composer, 0));
            ...
            if (zChangedInstance || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new Function0() { // from class: com.robinhood.android.blackwidow.ui.error.ErrorDialog$ComposeContent$1$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        return ErrorDialog.C98641.invoke$lambda$1$lambda$0(errorDialog);
                    }
                };
            ...
            if (zChangedInstance2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue2 = new Function0() { // from class: com.robinhood.android.blackwidow.ui.error.ErrorDialog$ComposeContent$1$$ExternalSyntheticLambda1
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        return ErrorDialog.C98641.invoke$lambda$3$lambda$2(errorDialog2);
                    }
                };
        ...
        public static final Unit invoke$lambda$1$lambda$0(ErrorDialog errorDialog) {
            errorDialog.requireActivity().finish();
            return Unit.INSTANCE;
        }
    ...
    public void ComposeContent(Composer composer, final int i) {
        int i2;
        Composer composerStartRestartGroup = composer.startRestartGroup(2065385516);
        if ((i & 6) == 0) {
        ...
        if ((i2 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(2065385516, i2, -1, "com.robinhood.android.blackwidow.ui.error.ErrorDialog.ComposeContent (ErrorDialog.kt:23)");
            }
            BentoTheme2.BentoTheme(Boolean.FALSE, null, null, null, null, null, null, null, ComposableLambda3.rememberComposableLambda(-1096232588, true, new C98641(), composerStartRestartGroup, 54), composerStartRestartGroup, 100663302, EnumC7081g.SDK_ASSET_ILLUSTRATION_SECOND_DEPOSIT_CIRCLE_VALUE);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: com.robinhood.android.blackwidow.ui.error.ErrorDialog$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function2
    ...
    /* compiled from: ErrorDialog.kt */
    @Metadata(m3635d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, m3636d2 = {"Lcom/robinhood/android/blackwidow/ui/error/ErrorDialog$Companion;", "Lcom/robinhood/utils/ui/fragment/FragmentWithoutArgsCompanion;", "Lcom/robinhood/android/blackwidow/ui/error/ErrorDialog;", "<init>", "()V", "feature-black-widow-upsell_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)

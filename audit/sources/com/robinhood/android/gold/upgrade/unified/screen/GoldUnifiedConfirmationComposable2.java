...
/* renamed from: com.robinhood.android.gold.upgrade.unified.screen.ComposableSingletons$GoldUnifiedConfirmationComposableKt$lambda$-1232440915$1, reason: use source file name */
/* loaded from: classes10.dex */
final class GoldUnifiedConfirmationComposable2 implements Function2<Composer, Integer, Unit> {
    public static final GoldUnifiedConfirmationComposable2 INSTANCE = new GoldUnifiedConfirmationComposable2();

    GoldUnifiedConfirmationComposable2() {
    }
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1232440915, i, -1, "com.robinhood.android.gold.upgrade.unified.screen.ComposableSingletons$GoldUnifiedConfirmationComposableKt.lambda$-1232440915.<anonymous> (GoldUnifiedConfirmationComposable.kt:191)");
        }
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new Function0() { // from class: com.robinhood.android.gold.upgrade.unified.screen.ComposableSingletons$GoldUnifiedConfirmationComposableKt$lambda$-1232440915$1$$ExternalSyntheticLambda0

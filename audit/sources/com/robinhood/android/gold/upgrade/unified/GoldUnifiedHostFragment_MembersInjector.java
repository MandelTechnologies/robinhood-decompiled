...
public final class GoldUnifiedHostFragment_MembersInjector implements MembersInjector<GoldUnifiedHostFragment> {
    ...
    @JvmStatic
    public static final MembersInjector<GoldUnifiedHostFragment> create(Provider<BaseFragmentSingletons> provider, Provider<GenericComposeSingletons> provider2, Provider<Set<Function2<NavGraphBuilder, NavHostController, Unit>>> provider3, Provider<SurveyManager3> provider4) {
        return INSTANCE.create(provider, provider2, provider3, provider4);
    }

    @JvmStatic
    public static final void injectUserLeapManager(GoldUnifiedHostFragment goldUnifiedHostFragment, SurveyManager3 surveyManager3) {
        INSTANCE.injectUserLeapManager(goldUnifiedHostFragment, surveyManager3);
    }

    public GoldUnifiedHostFragment_MembersInjector(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<Set<Function2<NavGraphBuilder, NavHostController, Unit>>> navGraphs, Provider<SurveyManager3> userLeapManager) {
    ...
    public void injectMembers(GoldUnifiedHostFragment instance) {
    ...
    /* compiled from: GoldUnifiedHostFragment_MembersInjector.kt */
    @Metadata(m3635d1 = {"\u0000X\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J{\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u00052\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\b2\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u000b0\b2A\u0010\f\u001a=\u00129\u00127\u0012.\u0012,\u0012\u0004\u0012\u00020\u000f\u0012\u0013\u0012\u00110\u0010¢\u0006\f\b\u0011\u0012\b\b\u0012\u0012\u0004\b\b(\u0013\u0012\u0004\u0012\u00020\u00140\u000ej\u0002`\u0016¢\u0006\u0002\b\u00150\r¢\u0006\u0002\b\u00170\b2\f\u0010\u0018\u001a\b\u0012\u0004\u0012\u00020\u00190\bH\u0007J\u0018\u0010\u001a\u001a\u00020\u00142\u0006\u0010\u001b\u001a\u00020\u00062\u0006\u0010\u0018\u001a\u00020\u0019H\u0007¨\u0006\u001c"}, m3636d2 = {"Lcom/robinhood/android/gold/upgrade/unified/GoldUnifiedHostFragment_MembersInjector$Companion;", "", "<init>", "()V", AnalyticsStrings.BUTTON_NEW_LIST_CREATE, "Ldagger/MembersInjector;", "Lcom/robinhood/android/gold/upgrade/unified/GoldUnifiedHostFragment;", "singletons", "Ljavax/inject/Provider;", "Lcom/robinhood/android/common/ui/di/BaseFragmentSingletons;", "genericComposeSingletons", "Lcom/robinhood/compose/app/GenericComposeSingletons;", "navGraphs", "", "Lkotlin/Function2;", "Landroidx/navigation/NavGraphBuilder;", "Landroidx/navigation/NavHostController;", "Lkotlin/ParameterName;", "name", "navController", "", "Lkotlin/ExtensionFunctionType;", "Lcom/robinhood/android/navigation/compose/NavGraphBuilderFn;", "Lkotlin/jvm/JvmSuppressWildcards;", "userLeapManager", "Lcom/robinhood/userleap/UserLeapManager;", "injectUserLeapManager", "instance", "feature-gold-upgrade_externalRelease"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    public static final class Companion {
        ...
        @JvmStatic
        public final MembersInjector<GoldUnifiedHostFragment> create(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<Set<Function2<NavGraphBuilder, NavHostController, Unit>>> navGraphs, Provider<SurveyManager3> userLeapManager) {
            Intrinsics.checkNotNullParameter(singletons, "singletons");
            Intrinsics.checkNotNullParameter(genericComposeSingletons, "genericComposeSingletons");
            Intrinsics.checkNotNullParameter(navGraphs, "navGraphs");
            Intrinsics.checkNotNullParameter(userLeapManager, "userLeapManager");
            return new GoldUnifiedHostFragment_MembersInjector(singletons, genericComposeSingletons, navGraphs, userLeapManager);
        }

        @JvmStatic
        public final void injectUserLeapManager(GoldUnifiedHostFragment instance, SurveyManager3 userLeapManager) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(userLeapManager, "userLeapManager");

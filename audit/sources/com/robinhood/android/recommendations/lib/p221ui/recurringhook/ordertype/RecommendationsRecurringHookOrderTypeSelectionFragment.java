...
/* compiled from: RecommendationsRecurringHookOrderTypeSelectionFragment.kt */
@Metadata(m3635d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0007\u0018\u0000 %2\u00020\u00012\u00020\u0002:\u0002$%B\u0007¢\u0006\u0004\b\u0003\u0010\u0004J\b\u0010\u001b\u001a\u00020\u001cH\u0016J\r\u0010\u001d\u001a\u00020\u001cH\u0017¢\u0006\u0002\u0010\u001eJ\u0010\u0010\u001f\u001a\u00020\u001c2\u0006\u0010 \u001a\u00020!H\u0002J\b\u0010\"\u001a\u00020\u001cH\u0002J\b\u0010#\u001a\u00020\u001cH\u0002R\u001b\u0010\u0005\u001a\u00020\u00068BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\t\u0010\n\u001a\u0004\b\u0007\u0010\bR\u001c\u0010\u000b\u001a\u0010\u0012\f\u0012\n \u000e*\u0004\u0018\u00010\r0\r0\fX\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u000f\u001a\u00020\u00108BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\u0011\u0010\u0012R\u0014\u0010\u0013\u001a\u00020\u00148VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u0015\u0010\u0016R\u0014\u0010\u0017\u001a\u00020\u00188VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u0019\u0010\u001a¨\u0006&"}, m3636d2 = {"Lcom/robinhood/android/recommendations/lib/ui/recurringhook/ordertype/RecommendationsRecurringHookOrderTypeSelectionFragment;", "Lcom/robinhood/compose/app/GenericComposeFragment;", "Lcom/robinhood/android/autoeventlogging/AutoLoggableFragment;", "<init>", "()V", "duxo", "Lcom/robinhood/android/recommendations/lib/ui/recurringhook/ordertype/RecommendationsRecurringHookOrderTypeSelectionDuxo;", "getDuxo", "()Lcom/robinhood/android/recommendations/lib/ui/recurringhook/ordertype/RecommendationsRecurringHookOrderTypeSelectionDuxo;", "duxo$delegate", "Lkotlin/Lazy;", "investFlowLauncher", "Landroidx/activity/result/ActivityResultLauncher;", "Landroid/content/Intent;", "kotlin.jvm.PlatformType", "eventContext", "Lcom/robinhood/rosetta/eventlogging/Context;", "getEventContext", "()Lcom/robinhood/rosetta/eventlogging/Context;", "eventScreen", "Lcom/robinhood/rosetta/eventlogging/Screen;", "getEventScreen", "()Lcom/robinhood/rosetta/eventlogging/Screen;", "screenEventData", "Lcom/robinhood/rosetta/eventlogging/UserInteractionEventData;", "getScreenEventData", "()Lcom/robinhood/rosetta/eventlogging/UserInteractionEventData;", "onStart", "", "ComposeContent", "(Landroidx/compose/runtime/Composer;I)V", "setViewState", "viewState", "Lcom/robinhood/android/recommendations/lib/ui/recurringhook/ordertype/RecommendationsRecurringHookOrderTypeSelectionViewState;", "onCreateNewOrder", "showSelfDirectedBottomSheet", "Args", "Companion", "feature-lib-recommendations_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
@SourceDebugExtension
/* loaded from: classes11.dex */
public final class RecommendationsRecurringHookOrderTypeSelectionFragment extends GenericComposeFragment implements AutoLoggableFragment {

    /* renamed from: duxo$delegate, reason: from kotlin metadata */
    private final Lazy duxo = OldDuxos.oldDuxo(this, RecommendationsRecurringHookOrderTypeSelectionDuxo.class);
    private final ActivityResultLauncher<Intent> investFlowLauncher;

    /* renamed from: Companion, reason: from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);
    public static final int $stable = 8;
    private static final BigDecimal MIN_ORDER_AMOUNT = new BigDecimal(20);

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit ComposeContent$lambda$0(RecommendationsRecurringHookOrderTypeSelectionFragment recommendationsRecurringHookOrderTypeSelectionFragment, int i, Composer composer, int i2) {
        recommendationsRecurringHookOrderTypeSelectionFragment.ComposeContent(composer, RecomposeScopeImpl4.updateChangedFlags(i | 1));
    ...
    public RecommendationsRecurringHookOrderTypeSelectionFragment() {
        ...
        this.investFlowLauncher = activityResultLauncherRegisterForActivityResult;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final RecommendationsRecurringHookOrderTypeSelectionDuxo getDuxo() {
        return (RecommendationsRecurringHookOrderTypeSelectionDuxo) this.duxo.getValue();
    }
    ...
    public Screen getEventScreen() {
        Screen.Name name = Screen.Name.RECS_RET_RECURRING_DECISION;
    ...
    public void onStart() {
        super.onStart();
        LifecycleHost.DefaultImpls.bind$default(this, ObservablesAndroid.observeOnMainThread(getDuxo().getStates()), (LifecycleEvent) null, 1, (Object) null).subscribeKotlin(new C260141(this));
    }

    /* compiled from: RecommendationsRecurringHookOrderTypeSelectionFragment.kt */
    @Metadata(m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    /* renamed from: com.robinhood.android.recommendations.lib.ui.recurringhook.ordertype.RecommendationsRecurringHookOrderTypeSelectionFragment$onStart$1 */
    /* synthetic */ class C260141 extends FunctionReferenceImpl implements Function1<RecommendationsRecurringHookOrderTypeSelectionViewState, Unit> {
        C260141(Object obj) {
            super(1, obj, RecommendationsRecurringHookOrderTypeSelectionFragment.class, "setViewState", "setViewState(Lcom/robinhood/android/recommendations/lib/ui/recurringhook/ordertype/RecommendationsRecurringHookOrderTypeSelectionViewState;)V", 0);
        }

        @Override // kotlin.jvm.functions.Function1
        public /* bridge */ /* synthetic */ Unit invoke(RecommendationsRecurringHookOrderTypeSelectionViewState recommendationsRecurringHookOrderTypeSelectionViewState) {
            invoke2(recommendationsRecurringHookOrderTypeSelectionViewState);
            return Unit.INSTANCE;
        }

        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final void invoke2(RecommendationsRecurringHookOrderTypeSelectionViewState p0) {
            Intrinsics.checkNotNullParameter(p0, "p0");
            ((RecommendationsRecurringHookOrderTypeSelectionFragment) this.receiver).setViewState(p0);
        }
    }
    ...
    public void ComposeContent(Composer composer, final int i) {
        int i2;
        Composer composerStartRestartGroup = composer.startRestartGroup(1764070046);
        if ((i & 6) == 0) {
        ...
        if ((i2 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1764070046, i2, -1, "com.robinhood.android.recommendations.lib.ui.recurringhook.ordertype.RecommendationsRecurringHookOrderTypeSelectionFragment.ComposeContent (RecommendationsRecurringHookOrderTypeSelectionFragment.kt:70)");
            }
            AutoLoggingCompositionLocals.EventLoggable(new UserInteractionEventDescriptor(null, null, null, null, null, null, 63, null), ComposableLambda3.rememberComposableLambda(-930602039, true, new Function2<Composer, Integer, Unit>() { // from class: com.robinhood.android.recommendations.lib.ui.recurringhook.ordertype.RecommendationsRecurringHookOrderTypeSelectionFragment.ComposeContent.1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-930602039, i3, -1, "com.robinhood.android.recommendations.lib.ui.recurringhook.ordertype.RecommendationsRecurringHookOrderTypeSelectionFragment.ComposeContent.<anonymous> (RecommendationsRecurringHookOrderTypeSelectionFragment.kt:74)");
                    }
                    RecommendationsRecurringHookOrderTypeSelectionDuxo duxo = RecommendationsRecurringHookOrderTypeSelectionFragment.this.getDuxo();
                    composer2.startReplaceGroup(5004770);
                    boolean zChangedInstance = composer2.changedInstance(duxo);
                    Object objRememberedValue = composer2.rememberedValue();
                    if (zChangedInstance || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                        objRememberedValue = new RecommendationsRecurringHookOrderTypeSelectionFragment2(duxo);
                        composer2.updateRememberedValue(objRememberedValue);
                    }
                    composer2.endReplaceGroup();
                    Function0 function0 = (Function0) ((KFunction) objRememberedValue);
                    RecommendationsRecurringHookOrderTypeSelectionFragment recommendationsRecurringHookOrderTypeSelectionFragment = RecommendationsRecurringHookOrderTypeSelectionFragment.this;
                    composer2.startReplaceGroup(5004770);
                    boolean zChangedInstance2 = composer2.changedInstance(recommendationsRecurringHookOrderTypeSelectionFragment);
                    Object objRememberedValue2 = composer2.rememberedValue();
                    if (zChangedInstance2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                        objRememberedValue2 = new RecommendationsRecurringHookOrderTypeSelectionFragment3(recommendationsRecurringHookOrderTypeSelectionFragment);
                        composer2.updateRememberedValue(objRememberedValue2);
                    }
                    composer2.endReplaceGroup();
                    Function0 function02 = (Function0) ((KFunction) objRememberedValue2);
                    Screen eventScreen = RecommendationsRecurringHookOrderTypeSelectionFragment.this.getEventScreen();
                    Context eventContext = RecommendationsRecurringHookOrderTypeSelectionFragment.this.getEventContext();
                    RecommendationsRecurringHookOrderTypeSelectionFragment recommendationsRecurringHookOrderTypeSelectionFragment2 = RecommendationsRecurringHookOrderTypeSelectionFragment.this;
                    composer2.startReplaceGroup(5004770);
                    boolean zChangedInstance3 = composer2.changedInstance(recommendationsRecurringHookOrderTypeSelectionFragment2);
                    Object objRememberedValue3 = composer2.rememberedValue();
                    if (zChangedInstance3 || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                        objRememberedValue3 = new RecommendationsRecurringHookOrderTypeSelectionFragment4(recommendationsRecurringHookOrderTypeSelectionFragment2);
                        composer2.updateRememberedValue(objRememberedValue3);
                    }
                    composer2.endReplaceGroup();
                    RecommendationsRecurringHookOrderTypeSelectionContent.RecurringHookOrderTypeSelectionContent(function0, function02, eventScreen, eventContext, (Function0) ((KFunction) objRememberedValue3), composer2, 0, 0);
                    if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: com.robinhood.android.recommendations.lib.ui.recurringhook.ordertype.RecommendationsRecurringHookOrderTypeSelectionFragment$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return RecommendationsRecurringHookOrderTypeSelectionFragment.ComposeContent$lambda$0(this.f$0, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void setViewState(RecommendationsRecurringHookOrderTypeSelectionViewState viewState) {
        java.util.List<ApiRecommendationsAllocationWeightsResponse.Weight> listConsume;
        UiEvent<java.util.List<ApiRecommendationsAllocationWeightsResponse.Weight>> applyRecommendationsSplitToRecurringOrderEvent = viewState.getApplyRecommendationsSplitToRecurringOrderEvent();
        if (applyRecommendationsSplitToRecurringOrderEvent == null || (listConsume = applyRecommendationsSplitToRecurringOrderEvent.consume()) == null) {
            return;
        }
        ActivityResultLauncher<Intent> activityResultLauncher = this.investFlowLauncher;
        Navigator navigator = getNavigator();
        android.content.Context contextRequireContext = requireContext();
        Intrinsics.checkNotNullExpressionValue(contextRequireContext, "requireContext(...)");
        InvestFlowStep.Frequency frequency = InvestFlowStep.Frequency.INSTANCE;
        java.util.List<ApiRecommendationsAllocationWeightsResponse.Weight> list = listConsume;
        ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(list, 10));
        Iterator<T> it = list.iterator();
        while (it.hasNext()) {
            arrayList.add(((ApiRecommendationsAllocationWeightsResponse.Weight) it.next()).getId());
        }
        String accountNumber = ((Args) INSTANCE.getArgs((Fragment) this)).getAccountNumber();
        BigDecimal bigDecimal = MIN_ORDER_AMOUNT;
        LinkedHashMap linkedHashMap = new LinkedHashMap(RangesKt.coerceAtLeast(MapsKt.mapCapacity(CollectionsKt.collectionSizeOrDefault(list, 10)), 16));
        for (ApiRecommendationsAllocationWeightsResponse.Weight weight : list) {
            Tuples2 tuples2M3642to = Tuples4.m3642to(weight.getId(), Float.valueOf(weight.getWeight()));
            linkedHashMap.put(tuples2M3642to.getFirst(), tuples2M3642to.getSecond());
        }
        AllocationStrategy.PercentSplit percentSplit = new AllocationStrategy.PercentSplit(linkedHashMap);
        Companion companion = INSTANCE;
        activityResultLauncher.launch(Navigator.DefaultImpls.createIntent$default(navigator, contextRequireContext, new InvestFlowIntentKey((InvestFlowStep) frequency, true, true, true, (java.util.List) arrayList, accountNumber, bigDecimal, (InvestFlowFrequency) null, true, (AllocationStrategy) percentSplit, new InvestFlowLoggingParams(((Args) companion.getArgs((Fragment) this)).getSource(), ((Args) companion.getArgs((Fragment) this)).getRecommendationId()), 128, (DefaultConstructorMarker) null), null, false, 12, null));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void onCreateNewOrder() {
        ActivityResultLauncher<Intent> activityResultLauncher = this.investFlowLauncher;
        Navigator navigator = getNavigator();
        android.content.Context contextRequireContext = requireContext();
        Intrinsics.checkNotNullExpressionValue(contextRequireContext, "requireContext(...)");
        activityResultLauncher.launch(Navigator.DefaultImpls.createIntent$default(navigator, contextRequireContext, new InvestFlowIntentKey((InvestFlowStep) null, false, false, false, (java.util.List) null, ((Args) INSTANCE.getArgs((Fragment) this)).getAccountNumber(), (BigDecimal) null, (InvestFlowFrequency) null, false, (AllocationStrategy) null, (InvestFlowLoggingParams) null, 2015, (DefaultConstructorMarker) null), null, false, 12, null));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void showSelfDirectedBottomSheet() {
        RhBottomSheetDialogFragment rhBottomSheetDialogFragment = (RhBottomSheetDialogFragment) RhBottomSheetDialogFragment.INSTANCE.newInstance((Parcelable) new RhBottomSheetDialogFragment.Args(C25982R.id.recs_recurring_hook_order_type_self_directed_bottom_sheet, getString(C25982R.string.recs_recurring_hook_order_type_selection_bottom_sheet_title), null, getString(C25982R.string.f4864xfb240e83), null, getString(C25982R.string.recs_recurring_hook_order_type_selection_bottom_sheet_cta), null, null, Integer.valueOf(C20690R.drawable.pict_mono_rds_megaphone), false, false, null, null, null, false, true, false, false, null, null, null, 2064084, null));
        FragmentManager childFragmentManager = getChildFragmentManager();
        Intrinsics.checkNotNullExpressionValue(childFragmentManager, "getChildFragmentManager(...)");
        rhBottomSheetDialogFragment.show(childFragmentManager, "recs-recurring-hook-order-type-self-directed");
    }

    /* compiled from: RecommendationsRecurringHookOrderTypeSelectionFragment.kt */
    @Metadata(m3635d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\t\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0007\u0018\u00002\u00020\u0001B'\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\u0006\u0010\u0005\u001a\u00020\u0003\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0004\b\b\u0010\tJ\u0006\u0010\u0010\u001a\u00020\u0011J\u0016\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u00152\u0006\u0010\u0016\u001a\u00020\u0011R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000bR\u0011\u0010\u0004\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\u000bR\u0011\u0010\u0005\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000bR\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u000e\u0010\u000f¨\u0006\u0017"}, m3636d2 = {"Lcom/robinhood/android/recommendations/lib/ui/recurringhook/ordertype/RecommendationsRecurringHookOrderTypeSelectionFragment$Args;", "Landroid/os/Parcelable;", "source", "", "accountNumber", "accountType", "recommendationId", "Ljava/util/UUID;", "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/UUID;)V", "getSource", "()Ljava/lang/String;", "getAccountNumber", "getAccountType", "getRecommendationId", "()Ljava/util/UUID;", "describeContents", "", "writeToParcel", "", "dest", "Landroid/os/Parcel;", "flags", "feature-lib-recommendations_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    public static final class Args implements Parcelable {
        ...
        public static final class Creator implements Parcelable.Creator<Args> {
            ...
            public final Args createFromParcel(Parcel parcel) {
                ...
                return new Args(parcel.readString(), parcel.readString(), parcel.readString(), (UUID) parcel.readSerializable());
            }
        ...
        public Args(String source, String accountNumber, String accountType, UUID recommendationId) {
    ...
    /* compiled from: RecommendationsRecurringHookOrderTypeSelectionFragment.kt */
    @Metadata(m3635d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\t\b\u0002¢\u0006\u0004\b\u0004\u0010\u0005R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\b"}, m3636d2 = {"Lcom/robinhood/android/recommendations/lib/ui/recurringhook/ordertype/RecommendationsRecurringHookOrderTypeSelectionFragment$Companion;", "Lcom/robinhood/utils/ui/fragment/FragmentWithArgsCompanion;", "Lcom/robinhood/android/recommendations/lib/ui/recurringhook/ordertype/RecommendationsRecurringHookOrderTypeSelectionFragment;", "Lcom/robinhood/android/recommendations/lib/ui/recurringhook/ordertype/RecommendationsRecurringHookOrderTypeSelectionFragment$Args;", "<init>", "()V", "MIN_ORDER_AMOUNT", "Ljava/math/BigDecimal;", "feature-lib-recommendations_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    public static final class Companion implements FragmentWithArgsCompanion<RecommendationsRecurringHookOrderTypeSelectionFragment, Args> {
        ...
        public Args getArgs(RecommendationsRecurringHookOrderTypeSelectionFragment recommendationsRecurringHookOrderTypeSelectionFragment) {
            return (Args) FragmentWithArgsCompanion.DefaultImpls.getArgs(this, recommendationsRecurringHookOrderTypeSelectionFragment);
        }

        @Override // com.robinhood.utils.p409ui.fragment.FragmentWithArgsCreator
        public RecommendationsRecurringHookOrderTypeSelectionFragment newInstance(Args args) {
            return (RecommendationsRecurringHookOrderTypeSelectionFragment) FragmentWithArgsCompanion.DefaultImpls.newInstance(this, args);
        }

        @Override // com.robinhood.utils.p409ui.fragment.FragmentWithArgsCompanion
        public void setArgs(RecommendationsRecurringHookOrderTypeSelectionFragment recommendationsRecurringHookOrderTypeSelectionFragment, Args args) {
            FragmentWithArgsCompanion.DefaultImpls.setArgs(this, recommendationsRecurringHookOrderTypeSelectionFragment, args);
        }
    }
}

...
@DebugMetadata(m3644c = "com.robinhood.android.chart.blackwidowadvancedchart.InternalAdvancedChartKt$InternalAdvancedChart$2$4$1", m3645f = "InternalAdvancedChart.kt", m3646l = {271}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.android.chart.blackwidowadvancedchart.InternalAdvancedChartKt$InternalAdvancedChart$2$4$1, reason: use source file name */
/* loaded from: classes7.dex */
final class InternalAdvancedChart3 extends ContinuationImpl7 implements Function2<BwTradeSide, Continuation<? super Unit>, Object> {
    ...
    /* renamed from: com.robinhood.android.chart.blackwidowadvancedchart.InternalAdvancedChartKt$InternalAdvancedChart$2$4$1$WhenMappings */
    ...
    InternalAdvancedChart3(AdvanceChartOrderViewState advanceChartOrderViewState, EventLogger eventLogger, UserInteractionEventDescriptor userInteractionEventDescriptor, AdvanceChartOrderDuxo4 advanceChartOrderDuxo4, Continuation<? super InternalAdvancedChart3> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        InternalAdvancedChart3 internalAdvancedChart3 = new InternalAdvancedChart3(this.$orderViewState, this.$eventLogger, this.$eventDescriptor, this.$orderCallbacks, continuation);
        internalAdvancedChart3.L$0 = obj;
        return internalAdvancedChart3;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(BwTradeSide bwTradeSide, Continuation<? super Unit> continuation) {
        return ((InternalAdvancedChart3) create(bwTradeSide, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (instrumentOrderState != null) {
                ...
                this.label = 1;
                if (advanceChartOrderDuxo4.onConfirmed(bwTradeSide, instrumentOrderState, uuidRandomUUID, this) == coroutine_suspended) {

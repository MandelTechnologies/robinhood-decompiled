...
public final class Column {
    ...
    public Column(List<Character> chars, TextPaintRegistry textPaintRegistry, int i) {
        Intrinsics.checkNotNullParameter(chars, "chars");
        Intrinsics.checkNotNullParameter(textPaintRegistry, "textPaintRegistry");
        this.chars = chars;
        this.textPaintRegistry = textPaintRegistry;
        this.gravity = i;
        this.progressUpdateCallback = new Function1() { // from class: com.robinhood.android.tickerinputview.Column$$ExternalSyntheticLambda3
    ...
    public /* synthetic */ Column(List list, TextPaintRegistry textPaintRegistry, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(list, textPaintRegistry, (i2 & 4) != 0 ? 80 : i);
    }
    ...
    public final float getWidthWeight() {
        ...
        return isPercentColumn() ? 0.5f : 1.0f;
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        for (Object obj : arrayList) {
            ...
            canvas.save();
            if (this.gravity == 48) {
                canvas.translate(0.0f, (-TextPaints.calculateHeight(this.textPaintRegistry.textPaintMaxBy(new Function1() { // from class: com.robinhood.android.tickerinputview.Column$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj2) {
                        return Float.valueOf(Column.draw$lambda$4$lambda$3((TextPaint) obj2));
                    }
                }), Constants.SdidMigrationStatusCodes.ALREADY_SDID, this.tempBounds)) + TextPaints.calculateHeight(getTextPaint(), String.valueOf(cCharValue), this.tempBounds));
            }
    ...
    static /* synthetic */ void jumpTo$default(Column column, int i, boolean z, Function1 function1, int i2, Object obj) {
        ...
        if ((i2 & 4) != 0) {
            function1 = new Function1() { // from class: com.robinhood.android.tickerinputview.Column$$ExternalSyntheticLambda2
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj2) {
    ...
    static /* synthetic */ void start$default(Column column, boolean z, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            function1 = new Function1() { // from class: com.robinhood.android.tickerinputview.Column$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj2) {
    ...
    private final void start(boolean shouldAnimate, final Function1<? super Animator, Unit> doOnEnd) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(function1) { // from class: com.robinhood.android.tickerinputview.Column$sam$android_animation_ValueAnimator_AnimatorUpdateListener$0
        ...
        valueAnimatorOfFloat.addListener(new Animator.AnimatorListener() { // from class: com.robinhood.android.tickerinputview.Column$start$$inlined$doOnEnd$1
    ...
    /* compiled from: Column.kt */
    @Metadata(m3635d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, m3636d2 = {"Lcom/robinhood/android/tickerinputview/Column$Companion;", "", "<init>", "()V", "DEFAULT_INTERPOLATOR", "Landroidx/interpolator/view/animation/FastOutSlowInInterpolator;", "getDEFAULT_INTERPOLATOR", "()Landroidx/interpolator/view/animation/FastOutSlowInInterpolator;", "lib-ticker-input-view_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)

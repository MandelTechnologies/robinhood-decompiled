...
@DebugMetadata(m3644c = "com.robinhood.android.margin.ui.limit.MarginLimitActivityDuxo$onCreate$1$result$1$marginInvestingInfo$1", m3645f = "MarginLimitActivityDuxo.kt", m3646l = {49}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.android.margin.ui.limit.MarginLimitActivityDuxo$onCreate$1$result$1$marginInvestingInfo$1, reason: use source file name */
/* loaded from: classes8.dex */
final class MarginLimitActivityDuxo4 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super ApiMarginInvestingInfo>, Object> {
    final /* synthetic */ String $accountNumber;
    int label;
    final /* synthetic */ MarginLimitActivityDuxo this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    MarginLimitActivityDuxo4(MarginLimitActivityDuxo marginLimitActivityDuxo, String str, Continuation<? super MarginLimitActivityDuxo4> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MarginLimitActivityDuxo4(this.this$0, this.$accountNumber, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ApiMarginInvestingInfo> continuation) {
        return ((MarginLimitActivityDuxo4) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

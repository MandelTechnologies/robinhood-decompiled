...
public final class MarginUpgradeConfirmationFragment_MembersInjector implements MembersInjector<MarginUpgradeConfirmationFragment> {
    ...
    @JvmStatic
    public static final MembersInjector<MarginUpgradeConfirmationFragment> create(Provider<BaseFragmentSingletons> provider, Provider<GenericComposeSingletons> provider2, Provider<Markwon> provider3, Provider<MarginUpgradeEventLogger> provider4, Provider<LocalityStringResources> provider5) {
        return INSTANCE.create(provider, provider2, provider3, provider4, provider5);
    }

    @JvmStatic
    public static final void injectLocalityStringResources(MarginUpgradeConfirmationFragment marginUpgradeConfirmationFragment, LocalityStringResources localityStringResources) {
        INSTANCE.injectLocalityStringResources(marginUpgradeConfirmationFragment, localityStringResources);
    }

    public MarginUpgradeConfirmationFragment_MembersInjector(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<Markwon> markwon, Provider<MarginUpgradeEventLogger> marginUpgradeEventLogger, Provider<LocalityStringResources> localityStringResources) {
    ...
    public void injectMembers(MarginUpgradeConfirmationFragment instance) {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final MembersInjector<MarginUpgradeConfirmationFragment> create(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<Markwon> markwon, Provider<MarginUpgradeEventLogger> marginUpgradeEventLogger, Provider<LocalityStringResources> localityStringResources) {
            Intrinsics.checkNotNullParameter(singletons, "singletons");
            Intrinsics.checkNotNullParameter(genericComposeSingletons, "genericComposeSingletons");
            Intrinsics.checkNotNullParameter(markwon, "markwon");
            Intrinsics.checkNotNullParameter(marginUpgradeEventLogger, "marginUpgradeEventLogger");
            Intrinsics.checkNotNullParameter(localityStringResources, "localityStringResources");
            return new MarginUpgradeConfirmationFragment_MembersInjector(singletons, genericComposeSingletons, markwon, marginUpgradeEventLogger, localityStringResources);
        }

        @JvmStatic
        public final void injectLocalityStringResources(MarginUpgradeConfirmationFragment instance, LocalityStringResources localityStringResources) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(localityStringResources, "localityStringResources");

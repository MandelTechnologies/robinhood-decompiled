...
/* renamed from: com.robinhood.android.optionsstrategybuilder.FeatureOptionsStrategyBuilderScarletTransitionsModule_ProvidePrimaryTextColorFactory */
/* loaded from: classes17.dex */
public final class C24807x44ca40c4 implements Factory<StylePropertyTransition<?, ?>> {
    ...
    @JvmStatic
    public static final C24807x44ca40c4 create(Provider<Resources> provider) {
    ...
    public C24807x44ca40c4(Provider<Resources> resources) {
    ...
    /* renamed from: com.robinhood.android.optionsstrategybuilder.FeatureOptionsStrategyBuilderScarletTransitionsModule_ProvidePrimaryTextColorFactory$Companion, reason: from kotlin metadata */
    public static final class Companion {
        ...
        @JvmStatic
        public final C24807x44ca40c4 create(Provider<Resources> resources) {
            Intrinsics.checkNotNullParameter(resources, "resources");
            return new C24807x44ca40c4(resources);
        }

        @JvmStatic
        public final StylePropertyTransition<?, ?> providePrimaryTextColor(Resources resources) {
            Intrinsics.checkNotNullParameter(resources, "resources");
            Object objCheckNotNull = Preconditions.checkNotNull(FeatureOptionsStrategyBuilderScarletTransitionsModule.INSTANCE.providePrimaryTextColor(resources), "Cannot return null from a non-@Nullable @Provides method");

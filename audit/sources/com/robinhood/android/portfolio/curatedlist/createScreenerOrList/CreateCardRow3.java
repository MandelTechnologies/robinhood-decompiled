...
/* renamed from: com.robinhood.android.portfolio.curatedlist.createScreenerOrList.ComposableSingletons$CreateCardRowKt$lambda$-1111410635$1, reason: use source file name */
/* loaded from: classes11.dex */
final class CreateCardRow3 implements Function2<Composer, Integer, Unit> {
    public static final CreateCardRow3 INSTANCE = new CreateCardRow3();
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1111410635, i, -1, "com.robinhood.android.portfolio.curatedlist.createScreenerOrList.ComposableSingletons$CreateCardRowKt.lambda$-1111410635.<anonymous> (CreateCardRow.kt:139)");
        }
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new Function0() { // from class: com.robinhood.android.portfolio.curatedlist.createScreenerOrList.ComposableSingletons$CreateCardRowKt$lambda$-1111410635$1$$ExternalSyntheticLambda0

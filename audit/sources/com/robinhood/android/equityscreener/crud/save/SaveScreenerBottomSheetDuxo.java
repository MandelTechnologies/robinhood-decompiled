...
public final class SaveScreenerBottomSheetDuxo extends BaseDuxo<SaveScreenerBottomSheetDataState, SaveScreenerBottomSheetViewState> implements HasSavedState {
    ...
    public SaveScreenerBottomSheetDuxo(SavedStateHandle savedStateHandle, ScreenersStore screenersStore, EventLogger eventLogger, SaveScreenerBottomSheetViewState3 stateProvider, DuxoBundle duxoBundle) {
        super(new SaveScreenerBottomSheetDataState(((SaveScreenerContract.Key) INSTANCE.getArgs(savedStateHandle)).getSaveType(), null, false, null, null, null, null, EnumC7081g.SDK_ASSET_PLAID_LOGO_BLACK_BG_VALUE, null), stateProvider, duxoBundle);
    ...
    private final String getScreenerId() {
        SaveScreenerContract.SaveType saveType = ((SaveScreenerContract.Key) INSTANCE.getArgs((HasSavedState) this)).getSaveType();
        if (saveType instanceof SaveScreenerContract.SaveType.Save) {
            return ((SaveScreenerContract.SaveType.Save) saveType).getLocalScreenerId();
        }
        if (saveType instanceof SaveScreenerContract.SaveType.SaveAs) {
            return ((SaveScreenerContract.SaveType.SaveAs) saveType).getLocalScreenerId();
        }
        if (saveType instanceof SaveScreenerContract.SaveType.EditName) {
            return ((SaveScreenerContract.SaveType.EditName) saveType).getScreenerId();
        }
    ...
    public void onResume() {
        LifecycleHost.DefaultImpls.bind$default(this, this.screenersStore.getLocalScreener(getScreenerId()), (LifecycleEvent) null, 1, (Object) null).subscribeKotlin(new Function1() { // from class: com.robinhood.android.equityscreener.crud.save.SaveScreenerBottomSheetDuxo$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return SaveScreenerBottomSheetDuxo.onResume$lambda$0(this.f$0, (LocalScreenerMetadata) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit onResume$lambda$0(SaveScreenerBottomSheetDuxo saveScreenerBottomSheetDuxo, LocalScreenerMetadata localScreenerData) {
        Intrinsics.checkNotNullParameter(localScreenerData, "localScreenerData");
        saveScreenerBottomSheetDuxo.applyMutation(new SaveScreenerBottomSheetDuxo2(localScreenerData, null));
    ...
    @DebugMetadata(m3644c = "com.robinhood.android.equityscreener.crud.save.SaveScreenerBottomSheetDuxo$onDisplayNameChanged$1", m3645f = "SaveScreenerBottomSheetDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
    /* renamed from: com.robinhood.android.equityscreener.crud.save.SaveScreenerBottomSheetDuxo$onDisplayNameChanged$1 */
    static final class C156701 extends ContinuationImpl7 implements Function2<SaveScreenerBottomSheetDataState, Continuation<? super SaveScreenerBottomSheetDataState>, Object> {
        final /* synthetic */ String $displayName;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C156701(String str, Continuation<? super C156701> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C156701 c156701 = new C156701(this.$displayName, continuation);
            c156701.L$0 = obj;
            return c156701;
        }
        ...
        public final Object invoke(SaveScreenerBottomSheetDataState saveScreenerBottomSheetDataState, Continuation<? super SaveScreenerBottomSheetDataState> continuation) {
            return ((C156701) create(saveScreenerBottomSheetDataState, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return SaveScreenerBottomSheetDataState.copy$default((SaveScreenerBottomSheetDataState) this.L$0, null, null, false, null, this.$displayName, null, null, 111, null);
        }
    }

    public final void onDisplayNameChanged(String displayName) {
        Intrinsics.checkNotNullParameter(displayName, "displayName");
        applyMutation(new C156701(displayName, null));
    }

    /* compiled from: SaveScreenerBottomSheetDuxo.kt */
    @Metadata(m3635d1 = {"\u0000\u0006\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0001H\n"}, m3636d2 = {"<anonymous>", "Lcom/robinhood/android/equityscreener/crud/save/SaveScreenerBottomSheetDataState;"}, m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "com.robinhood.android.equityscreener.crud.save.SaveScreenerBottomSheetDuxo$setEmoji$1", m3645f = "SaveScreenerBottomSheetDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
    /* renamed from: com.robinhood.android.equityscreener.crud.save.SaveScreenerBottomSheetDuxo$setEmoji$1 */
    static final class C156721 extends ContinuationImpl7 implements Function2<SaveScreenerBottomSheetDataState, Continuation<? super SaveScreenerBottomSheetDataState>, Object> {
        final /* synthetic */ Emoji $emoji;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C156721(Emoji emoji, Continuation<? super C156721> continuation) {
            super(2, continuation);
            this.$emoji = emoji;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C156721 c156721 = new C156721(this.$emoji, continuation);
            c156721.L$0 = obj;
            return c156721;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(SaveScreenerBottomSheetDataState saveScreenerBottomSheetDataState, Continuation<? super SaveScreenerBottomSheetDataState> continuation) {
            return ((C156721) create(saveScreenerBottomSheetDataState, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            return SaveScreenerBottomSheetDataState.copy$default((SaveScreenerBottomSheetDataState) this.L$0, null, null, false, null, null, this.$emoji.getCharacter(), null, 95, null);
        }
    }

    public final void setEmoji(Emoji emoji) {
        Intrinsics.checkNotNullParameter(emoji, "emoji");
        applyMutation(new C156721(emoji, null));
    }

    /* compiled from: SaveScreenerBottomSheetDuxo.kt */
    @Metadata(m3635d1 = {"\u0000\u0006\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0001H\n"}, m3636d2 = {"<anonymous>", "Lcom/robinhood/android/equityscreener/crud/save/SaveScreenerBottomSheetDataState;"}, m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "com.robinhood.android.equityscreener.crud.save.SaveScreenerBottomSheetDuxo$saveScreener$1", m3645f = "SaveScreenerBottomSheetDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
    /* renamed from: com.robinhood.android.equityscreener.crud.save.SaveScreenerBottomSheetDuxo$saveScreener$1 */
    static final class C156711 extends ContinuationImpl7 implements Function2<SaveScreenerBottomSheetDataState, Continuation<? super SaveScreenerBottomSheetDataState>, Object> {
        final /* synthetic */ String $displayName;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C156711(String str, String str2, Continuation<? super C156711> continuation) {
            super(2, continuation);
            this.$displayName = str;
            this.$emoji = str2;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C156711 c156711 = new C156711(this.$displayName, this.$emoji, continuation);
            c156711.L$0 = obj;
            return c156711;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(SaveScreenerBottomSheetDataState saveScreenerBottomSheetDataState, Continuation<? super SaveScreenerBottomSheetDataState> continuation) {
            return ((C156711) create(saveScreenerBottomSheetDataState, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            ResultKt.throwOnFailure(obj);
            return SaveScreenerBottomSheetDataState.copy$default((SaveScreenerBottomSheetDataState) this.L$0, null, null, true, null, this.$displayName, this.$emoji, null, 67, null);
        }
    }

    public final void saveScreener(final String displayName, final String emoji) {
        Intrinsics.checkNotNullParameter(displayName, "displayName");
        Intrinsics.checkNotNullParameter(emoji, "emoji");
        applyMutation(new C156711(displayName, emoji, null));
        LifecycleHost.DefaultImpls.bind$default(this, this.screenersStore.saveScreener(getScreenerId(), ((SaveScreenerContract.Key) INSTANCE.getArgs((HasSavedState) this)).getSaveType() instanceof SaveScreenerContract.SaveType.SaveAs, new Function1() { // from class: com.robinhood.android.equityscreener.crud.save.SaveScreenerBottomSheetDuxo$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return SaveScreenerBottomSheetDuxo.saveScreener$lambda$1(displayName, emoji, (Screener) obj);
            }
        }), (LifecycleEvent) null, 1, (Object) null).subscribeKotlin(new Function1() { // from class: com.robinhood.android.equityscreener.crud.save.SaveScreenerBottomSheetDuxo$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return SaveScreenerBottomSheetDuxo.saveScreener$lambda$2(this.f$0, (SaveScreenerResult) obj);
            }
        }, new Function1() { // from class: com.robinhood.android.equityscreener.crud.save.SaveScreenerBottomSheetDuxo$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return SaveScreenerBottomSheetDuxo.saveScreener$lambda$3(this.f$0, (Throwable) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Screener saveScreener$lambda$1(String str, String str2, Screener saveScreener) {
        Intrinsics.checkNotNullParameter(saveScreener, "$this$saveScreener");
        return Screener.copy$default(saveScreener, null, str, null, str2, null, null, null, null, false, 0, null, null, false, 8181, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit saveScreener$lambda$2(SaveScreenerBottomSheetDuxo saveScreenerBottomSheetDuxo, SaveScreenerResult saveResult) {
        Intrinsics.checkNotNullParameter(saveResult, "saveResult");
        if (saveResult instanceof SaveScreenerResult.Success) {
            saveScreenerBottomSheetDuxo.applyMutation(new SaveScreenerBottomSheetDuxo3(saveResult, null));
        } else {
            if (!(saveResult instanceof SaveScreenerResult.Error)) {
                throw new NoWhenBranchMatchedException();
            }
            saveScreenerBottomSheetDuxo.applyMutation(new SaveScreenerBottomSheetDuxo4(saveResult, null));
        }
        return Unit.INSTANCE;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit saveScreener$lambda$3(SaveScreenerBottomSheetDuxo saveScreenerBottomSheetDuxo, Throwable it) {
        Intrinsics.checkNotNullParameter(it, "it");
        saveScreenerBottomSheetDuxo.applyMutation(new SaveScreenerBottomSheetDuxo5(null));
        return Unit.INSTANCE;
    }

    public final void logOnEditName(String name) {
    ...
    public static final class Companion implements DuxoCompanion<SaveScreenerBottomSheetDuxo, SaveScreenerContract.Key> {
        ...
        public SaveScreenerContract.Key getArgs(SavedStateHandle savedStateHandle) {
            return (SaveScreenerContract.Key) DuxoCompanion.DefaultImpls.getArgs(this, savedStateHandle);
        }

        @Override // com.robinhood.android.udf.DuxoCompanion
        public SaveScreenerContract.Key getArgs(SaveScreenerBottomSheetDuxo saveScreenerBottomSheetDuxo) {
            return (SaveScreenerContract.Key) DuxoCompanion.DefaultImpls.getArgs(this, saveScreenerBottomSheetDuxo);
        }
    }
}

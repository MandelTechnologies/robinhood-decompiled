...
public final /* data */ class IndicatorFilterDataState {
    ...
    public IndicatorFilterDataState() {
        this(null, false, null, null, null, null, 63, null);
    }

    public static /* synthetic */ IndicatorFilterDataState copy$default(IndicatorFilterDataState indicatorFilterDataState, AllIndicatorsResponse allIndicatorsResponse, boolean z, String str, ScanResultResponse scanResultResponse, Screener.Filter filter, ScreenerIndicator screenerIndicator, int i, Object obj) {
        if ((i & 1) != 0) {
            allIndicatorsResponse = indicatorFilterDataState.allIndicatorsResponse;
        }
        if ((i & 2) != 0) {
            z = indicatorFilterDataState.isLoading;
        }
        if ((i & 4) != 0) {
            str = indicatorFilterDataState.indicatorKey;
        }
        if ((i & 8) != 0) {
            scanResultResponse = indicatorFilterDataState.scanResults;
        }
        if ((i & 16) != 0) {
            filter = indicatorFilterDataState.filter;
        }
        if ((i & 32) != 0) {
            screenerIndicator = indicatorFilterDataState.indicator;
        }
        Screener.Filter filter2 = filter;
        ScreenerIndicator screenerIndicator2 = screenerIndicator;
        return indicatorFilterDataState.copy(allIndicatorsResponse, z, str, scanResultResponse, filter2, screenerIndicator2);
    }
    ...
    public final IndicatorFilterDataState copy(AllIndicatorsResponse allIndicatorsResponse, boolean isLoading, String indicatorKey, ScanResultResponse scanResults, Screener.Filter filter, ScreenerIndicator indicator) {
        Intrinsics.checkNotNullParameter(indicatorKey, "indicatorKey");
        return new IndicatorFilterDataState(allIndicatorsResponse, isLoading, indicatorKey, scanResults, filter, indicator);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof IndicatorFilterDataState)) {
            return false;
        }
        IndicatorFilterDataState indicatorFilterDataState = (IndicatorFilterDataState) other;
        return Intrinsics.areEqual(this.allIndicatorsResponse, indicatorFilterDataState.allIndicatorsResponse) && this.isLoading == indicatorFilterDataState.isLoading && Intrinsics.areEqual(this.indicatorKey, indicatorFilterDataState.indicatorKey) && Intrinsics.areEqual(this.scanResults, indicatorFilterDataState.scanResults) && Intrinsics.areEqual(this.filter, indicatorFilterDataState.filter) && Intrinsics.areEqual(this.indicator, indicatorFilterDataState.indicator);
    }
    ...
    public String toString() {
        return "IndicatorFilterDataState(allIndicatorsResponse=" + this.allIndicatorsResponse + ", isLoading=" + this.isLoading + ", indicatorKey=" + this.indicatorKey + ", scanResults=" + this.scanResults + ", filter=" + this.filter + ", indicator=" + this.indicator + ")";
    }

    public IndicatorFilterDataState(AllIndicatorsResponse allIndicatorsResponse, boolean z, String indicatorKey, ScanResultResponse scanResultResponse, Screener.Filter filter, ScreenerIndicator screenerIndicator) {
        Intrinsics.checkNotNullParameter(indicatorKey, "indicatorKey");
    ...
    public /* synthetic */ IndicatorFilterDataState(AllIndicatorsResponse allIndicatorsResponse, boolean z, String str, ScanResultResponse scanResultResponse, Screener.Filter filter, ScreenerIndicator screenerIndicator, int i, DefaultConstructorMarker defaultConstructorMarker) {

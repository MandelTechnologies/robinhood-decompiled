...
final class AppointmentsSchedulingDatetimePickerComposableKt$DateCard$1$2$1 implements Function1<ConstrainScope, Unit> {
    final /* synthetic */ ConstraintLayoutBaseScope4 $date;

    AppointmentsSchedulingDatetimePickerComposableKt$DateCard$1$2$1(ConstraintLayoutBaseScope4 constraintLayoutBaseScope4) {
    ...
    public final void invoke2(ConstrainScope constrainAs) {
        ...
        ConstraintScopeCommon5.m8162linkToVpY3zN4$default(constrainAs.getTop(), this.$date.getBottom(), 0.0f, 0.0f, 6, null);

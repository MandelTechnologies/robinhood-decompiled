...
final class ConciergeOnboardingComposableKt$ConciergeWelcome$1$3$1 implements Function1<ConstrainScope, Unit> {
    final /* synthetic */ ConstraintLayoutBaseScope4 $heroVideo;

    ConciergeOnboardingComposableKt$ConciergeWelcome$1$3$1(ConstraintLayoutBaseScope4 constraintLayoutBaseScope4) {
    ...
    public final void invoke2(ConstrainScope constrainAs) {
        ...
        ConstraintScopeCommon5.m8162linkToVpY3zN4$default(constrainAs.getTop(), this.$heroVideo.getBottom(), 0.0f, 0.0f, 6, null);
        ...
        constrainAs.setHeight(Dimension.INSTANCE.percent(0.33f));
    }
}

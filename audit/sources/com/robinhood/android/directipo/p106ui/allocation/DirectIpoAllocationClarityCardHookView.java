...
@Metadata(m3635d1 = {"\u0000^\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0007\u0018\u0000 ,2\u00020\u0001:\u0001,B\u0019\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\u0004\b\u0006\u0010\u0007J\b\u0010%\u001a\u00020&H\u0014J\u001a\u0010'\u001a\u00020&2\u0006\u0010(\u001a\u00020)2\n\b\u0002\u0010*\u001a\u0004\u0018\u00010+R\u001e\u0010\b\u001a\u00020\t8\u0006@\u0006X\u0087.¢\u0006\u000e\n\u0000\u001a\u0004\b\n\u0010\u000b\"\u0004\b\f\u0010\rR\u001e\u0010\u000e\u001a\u00020\u000f8\u0006@\u0006X\u0087.¢\u0006\u000e\n\u0000\u001a\u0004\b\u0010\u0010\u0011\"\u0004\b\u0012\u0010\u0013R\u001e\u0010\u0014\u001a\u00020\u00158\u0006@\u0006X\u0087.¢\u0006\u000e\n\u0000\u001a\u0004\b\u0016\u0010\u0017\"\u0004\b\u0018\u0010\u0019R(\u0010\u001a\u001a\u001c\u0012\u0018\u0012\u0016\u0012\u0004\u0012\u00020\u001d \u001e*\n\u0012\u0004\u0012\u00020\u001d\u0018\u00010\u001c0\u001c0\u001bX\u0082\u0004¢\u0006\u0002\n\u0000R\u001b\u0010\u001f\u001a\u00020 8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b#\u0010$\u001a\u0004\b!\u0010\"¨\u0006-"}, m3636d2 = {"Lcom/robinhood/android/directipo/ui/allocation/DirectIpoAllocationClarityCardHookView;", "Landroidx/constraintlayout/widget/ConstraintLayout;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "navigator", "Lcom/robinhood/android/navigation/Navigator;", "getNavigator", "()Lcom/robinhood/android/navigation/Navigator;", "setNavigator", "(Lcom/robinhood/android/navigation/Navigator;)V", "imageLoader", "Lcom/robinhood/android/rhimage/ImageLoader;", "getImageLoader", "()Lcom/robinhood/android/rhimage/ImageLoader;", "setImageLoader", "(Lcom/robinhood/android/rhimage/ImageLoader;)V", "markwon", "Lio/noties/markwon/Markwon;", "getMarkwon", "()Lio/noties/markwon/Markwon;", "setMarkwon", "(Lio/noties/markwon/Markwon;)V", "imagesRelay", "Lcom/jakewharton/rxrelay2/BehaviorRelay;", "Lcom/robinhood/utils/Optional;", "Lcom/robinhood/models/serverdriven/db/ThemedImageSource;", "kotlin.jvm.PlatformType", "binding", "Lcom/robinhood/android/directipo/ui/databinding/MergeIpoAnnouncementCardHookViewBinding;", "getBinding", "()Lcom/robinhood/android/directipo/ui/databinding/MergeIpoAnnouncementCardHookViewBinding;", "binding$delegate", "Lkotlin/properties/ReadOnlyProperty;", "onAttachedToWindow", "", "bind", "cardHook", "Lcom/robinhood/directipo/models/db/IpoAnnouncementCardHook;", RecurringFrequencyBottomSheet.ARG_LOGGING_CONTEXT, "Lcom/robinhood/rosetta/eventlogging/IpoAccessInstrumentContext;", "Companion", "feature-lib-direct-ipo-ui_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
@SourceDebugExtension
/* loaded from: classes27.dex */
public final class DirectIpoAllocationClarityCardHookView extends Hammer_DirectIpoAllocationClarityCardHookView {
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(DirectIpoAllocationClarityCardHookView.class, "binding", "getBinding()Lcom/robinhood/android/directipo/ui/databinding/MergeIpoAnnouncementCardHookViewBinding;", 0))};
    ...
    private final BehaviorRelay<Optional<ThemedImageSource>> imagesRelay;
    ...
    public DirectIpoAllocationClarityCardHookView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(context, "context");
        BehaviorRelay<Optional<ThemedImageSource>> behaviorRelayCreate = BehaviorRelay.create();
        Intrinsics.checkNotNullExpressionValue(behaviorRelayCreate, "create(...)");
        this.imagesRelay = behaviorRelayCreate;
        ViewGroups.inflate(this, C14228R.layout.merge_ipo_announcement_card_hook_view, true);
        this.binding = ViewBinding5.viewBinding(this, DirectIpoAllocationClarityCardHookView2.INSTANCE);
    }
    ...
    private final MergeIpoAnnouncementCardHookViewBinding getBinding() {
        Object value = this.binding.getValue(this, $$delegatedProperties[0]);
        Intrinsics.checkNotNullExpressionValue(value, "getValue(...)");
        return (MergeIpoAnnouncementCardHookViewBinding) value;
    }
    ...
    protected void onAttachedToWindow() {
        ...
        BehaviorRelay<Optional<ThemedImageSource>> behaviorRelay = this.imagesRelay;
        Context context = getContext();
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        Observable observableDistinctUntilChanged = observables.combineLatest(behaviorRelay, Contexts7.requireBaseActivityBaseContext(context).getDayNightStyleChanges()).distinctUntilChanged();
        Intrinsics.checkNotNullExpressionValue(observableDistinctUntilChanged, "distinctUntilChanged(...)");
        ViewDisposerKt.bindTo$default(observableDistinctUntilChanged, this, false, 2, null).subscribeKotlin(new Function1() { // from class: com.robinhood.android.directipo.ui.allocation.DirectIpoAllocationClarityCardHookView$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return DirectIpoAllocationClarityCardHookView.onAttachedToWindow$lambda$0(this.f$0, (Tuples2) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit onAttachedToWindow$lambda$0(DirectIpoAllocationClarityCardHookView directIpoAllocationClarityCardHookView, Tuples2 tuples2) {
        Optional optional = (Optional) tuples2.component1();
        DayNightOverlay dayNightOverlay = (DayNightOverlay) tuples2.component2();
        ThemedImageSource themedImageSource = (ThemedImageSource) optional.component1();
        if (themedImageSource == null) {
            ImageLoader imageLoader = directIpoAllocationClarityCardHookView.getImageLoader();
            ImageView cardHookImage = directIpoAllocationClarityCardHookView.getBinding().cardHookImage;
            Intrinsics.checkNotNullExpressionValue(cardHookImage, "cardHookImage");
            imageLoader.cancelRequest(cardHookImage);
            directIpoAllocationClarityCardHookView.getBinding().cardHookImage.setImageDrawable(null);
        } else if (WhenMappings.$EnumSwitchMapping$0[dayNightOverlay.ordinal()] == 1) {
            ImageLoader imageLoader2 = directIpoAllocationClarityCardHookView.getImageLoader();
            ImageSource light = themedImageSource.getLight();
            Context context = directIpoAllocationClarityCardHookView.getContext();
            Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
            ImageLoader.ImageRequest imageRequestLoad = imageLoader2.load(light.toImageUrl(context));
            ImageView cardHookImage2 = directIpoAllocationClarityCardHookView.getBinding().cardHookImage;
            Intrinsics.checkNotNullExpressionValue(cardHookImage2, "cardHookImage");
            ImageLoader.ImageRequest.DefaultImpls.into$default(imageRequestLoad, cardHookImage2, null, null, 6, null);
        } else {
            ImageLoader imageLoader3 = directIpoAllocationClarityCardHookView.getImageLoader();
            ImageSource dark = themedImageSource.getDark();
            Context context2 = directIpoAllocationClarityCardHookView.getContext();
            Intrinsics.checkNotNullExpressionValue(context2, "getContext(...)");
            ImageLoader.ImageRequest imageRequestLoad2 = imageLoader3.load(dark.toImageUrl(context2));
            ImageView cardHookImage3 = directIpoAllocationClarityCardHookView.getBinding().cardHookImage;
            Intrinsics.checkNotNullExpressionValue(cardHookImage3, "cardHookImage");
            ImageLoader.ImageRequest.DefaultImpls.into$default(imageRequestLoad2, cardHookImage3, null, null, 6, null);
        }
        return Unit.INSTANCE;
    }

    public static /* synthetic */ void bind$default(DirectIpoAllocationClarityCardHookView directIpoAllocationClarityCardHookView, IpoAnnouncementCardHook ipoAnnouncementCardHook, IpoAccessInstrumentContext ipoAccessInstrumentContext, int i, Object obj) {
        if ((i & 2) != 0) {
            ipoAccessInstrumentContext = null;
        }
        directIpoAllocationClarityCardHookView.bind(ipoAnnouncementCardHook, ipoAccessInstrumentContext);
    }

    public final void bind(final IpoAnnouncementCardHook cardHook, final IpoAccessInstrumentContext loggingContext) {
        Drawable drawable;
        Intrinsics.checkNotNullParameter(cardHook, "cardHook");
        getBinding().cardHookTitle.setText(cardHook.getTitle());
        getBinding().cardHookSubtitle.setText(getMarkwon().toMarkdown(cardHook.getSubtitleMarkdown()));
        final RdsTextButton rdsTextButton = getBinding().cardHookCtaButton;
        rdsTextButton.setText(cardHook.getTextButtonLabel());
        Intrinsics.checkNotNull(rdsTextButton);
        ServerToBentoAssetMapper2 textButtonIcon = cardHook.getTextButtonIcon();
        if (textButtonIcon != null) {
            drawable = ContextCompat.getDrawable(rdsTextButton.getContext(), textButtonIcon.getResourceId());
        } else {
            drawable = null;
        }
        TextViewsKt.setDrawableEnd(rdsTextButton, drawable);
        ViewsKt.eventData$default(rdsTextButton, false, new Function0() { // from class: com.robinhood.android.directipo.ui.allocation.DirectIpoAllocationClarityCardHookView$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return DirectIpoAllocationClarityCardHookView.bind$lambda$4$lambda$2(cardHook, loggingContext);
            }
        }, 1, null);
        OnClickListeners.onClick(rdsTextButton, new Function0() { // from class: com.robinhood.android.directipo.ui.allocation.DirectIpoAllocationClarityCardHookView$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return DirectIpoAllocationClarityCardHookView.bind$lambda$4$lambda$3(cardHook, this, rdsTextButton);
            }
        });
        this.imagesRelay.accept(Optional3.asOptional(cardHook.getImages()));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Multi-variable type inference failed */
    public static final UserInteractionEventDescriptor bind$lambda$4$lambda$2(IpoAnnouncementCardHook ipoAnnouncementCardHook, IpoAccessInstrumentContext ipoAccessInstrumentContext) {
        Component.ComponentType componentType = Component.ComponentType.BUTTON;
        String buttonLoggingIdentifier = ipoAnnouncementCardHook.getButtonLoggingIdentifier();
        if (buttonLoggingIdentifier == null) {
            buttonLoggingIdentifier = "";
        }
        String str = null;
        String str2 = null;
        String str3 = null;
    ...
    public static final class Companion implements Inflater<DirectIpoAllocationClarityCardHookView> {
        ...
        public DirectIpoAllocationClarityCardHookView inflate(ViewGroup parent) {
            Intrinsics.checkNotNullParameter(parent, "parent");
            return (DirectIpoAllocationClarityCardHookView) this.$$delegate_0.inflate(parent);
        }

        private Companion() {
            this.$$delegate_0 = Inflater.INSTANCE.include(C14228R.layout.include_allocation_clarity_card_hook_view);
        }
    }
}

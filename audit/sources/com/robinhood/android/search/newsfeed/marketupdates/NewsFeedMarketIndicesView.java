...
@Metadata(m3635d1 = {"\u0000V\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0007\u0018\u0000 +2\u00020\u00012\b\u0012\u0004\u0012\u00020\u00030\u0002:\u0001+B\u001b\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\n\b\u0002\u0010\u0006\u001a\u0004\u0018\u00010\u0007¢\u0006\u0004\b\b\u0010\tJ\b\u0010%\u001a\u00020&H\u0014J\u0010\u0010'\u001a\u00020&2\u0006\u0010(\u001a\u00020\u0003H\u0016J\u0010\u0010)\u001a\u00020&2\u0006\u0010(\u001a\u00020*H\u0002R\u001e\u0010\n\u001a\u00020\u000b8\u0006@\u0006X\u0087.¢\u0006\u000e\n\u0000\u001a\u0004\b\f\u0010\r\"\u0004\b\u000e\u0010\u000fR\u001b\u0010\u0010\u001a\u00020\u00118BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0014\u0010\u0015\u001a\u0004\b\u0012\u0010\u0013R\u000e\u0010\u0016\u001a\u00020\u0017X\u0082\u0004¢\u0006\u0002\n\u0000R$\u0010\u001a\u001a\u00020\u00192\u0006\u0010\u0018\u001a\u00020\u0019@FX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u001b\u0010\u001c\"\u0004\b\u001d\u0010\u001eR\u001e\u0010\u001f\u001a\u00020 8\u0006@\u0006X\u0087.¢\u0006\u000e\n\u0000\u001a\u0004\b!\u0010\"\"\u0004\b#\u0010$¨\u0006,"}, m3636d2 = {"Lcom/robinhood/android/search/newsfeed/marketupdates/NewsFeedMarketIndicesView;", "Landroidx/constraintlayout/widget/ConstraintLayout;", "Lcom/robinhood/utils/ui/view/Bindable;", "Lcom/robinhood/android/newsfeed/model/Element$MarketIndicators;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "navigator", "Lcom/robinhood/android/navigation/Navigator;", "getNavigator", "()Lcom/robinhood/android/navigation/Navigator;", "setNavigator", "(Lcom/robinhood/android/navigation/Navigator;)V", "binding", "Lcom/robinhood/android/search/databinding/MergeNewsFeedMarketIndicesViewBinding;", "getBinding", "()Lcom/robinhood/android/search/databinding/MergeNewsFeedMarketIndicesViewBinding;", "binding$delegate", "Lkotlin/properties/ReadOnlyProperty;", "adapter", "Lcom/robinhood/android/search/newsfeed/marketupdates/NewsFeedMarketIndicatorsAdapter;", "value", "", "bottomDividerMarginSize", "getBottomDividerMarginSize", "()I", "setBottomDividerMarginSize", "(I)V", "duxo", "Lcom/robinhood/android/search/newsfeed/marketupdates/NewsFeedMarketIndicesViewDuxo;", "getDuxo", "()Lcom/robinhood/android/search/newsfeed/marketupdates/NewsFeedMarketIndicesViewDuxo;", "setDuxo", "(Lcom/robinhood/android/search/newsfeed/marketupdates/NewsFeedMarketIndicesViewDuxo;)V", "onAttachedToWindow", "", "bind", "state", "setViewState", "Lcom/robinhood/android/search/newsfeed/marketupdates/NewsFeedMarketIndicesViewState;", "Companion", "feature-search_externalRelease"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
@SourceDebugExtension
/* loaded from: classes5.dex */
public final class NewsFeedMarketIndicesView extends Hammer_NewsFeedMarketIndicesView implements Bindable<Element.MarketIndicators> {
    private final NewsFeedMarketIndicatorsAdapter adapter;

    /* renamed from: binding$delegate, reason: from kotlin metadata */
    private final Interfaces2 binding;
    private int bottomDividerMarginSize;
    public NewsFeedMarketIndicesViewDuxo duxo;
    public Navigator navigator;
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(NewsFeedMarketIndicesView.class, "binding", "getBinding()Lcom/robinhood/android/search/databinding/MergeNewsFeedMarketIndicesViewBinding;", 0))};

    /* renamed from: Companion, reason: from kotlin metadata */
    public static final Companion INSTANCE = new Companion(null);
    public static final int $stable = 8;

    public /* synthetic */ NewsFeedMarketIndicesView(Context context, AttributeSet attributeSet, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i & 2) != 0 ? null : attributeSet);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NewsFeedMarketIndicesView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(context, "context");
        ViewGroups.inflate(this, C27909R.layout.merge_news_feed_market_indices_view, true);
        this.binding = ViewBinding5.viewBinding(this, NewsFeedMarketIndicesView2.INSTANCE);
        NewsFeedMarketIndicatorsAdapter newsFeedMarketIndicatorsAdapter = new NewsFeedMarketIndicatorsAdapter();
        this.adapter = newsFeedMarketIndicatorsAdapter;
        ViewsKt.setLoggingConfig(this, new AutoLoggingConfig(false, false, 2, null));
        RecyclerView recyclerView = getBinding().newsFeedMarketIndicesRecyclerView;
        recyclerView.setItemAnimator(null);
        recyclerView.setAdapter(newsFeedMarketIndicatorsAdapter);
    ...
    private final MergeNewsFeedMarketIndicesViewBinding getBinding() {
        Object value = this.binding.getValue(this, $$delegatedProperties[0]);
        Intrinsics.checkNotNullExpressionValue(value, "getValue(...)");
        return (MergeNewsFeedMarketIndicesViewBinding) value;
    }

    public final int getBottomDividerMarginSize() {
        return this.bottomDividerMarginSize;
    }

    public final void setBottomDividerMarginSize(int i) {
        View bottomDivider = getBinding().bottomDivider;
        Intrinsics.checkNotNullExpressionValue(bottomDivider, "bottomDivider");
        com.robinhood.utils.extensions.ViewsKt.setMarginStart(bottomDivider, i);
        View bottomDivider2 = getBinding().bottomDivider;
        Intrinsics.checkNotNullExpressionValue(bottomDivider2, "bottomDivider");
        com.robinhood.utils.extensions.ViewsKt.setMarginEnd(bottomDivider2, i);
        this.bottomDividerMarginSize = i;
    }

    public final NewsFeedMarketIndicesViewDuxo getDuxo() {
        NewsFeedMarketIndicesViewDuxo newsFeedMarketIndicesViewDuxo = this.duxo;
        if (newsFeedMarketIndicesViewDuxo != null) {
    ...
    public final void setDuxo(NewsFeedMarketIndicesViewDuxo newsFeedMarketIndicesViewDuxo) {
        Intrinsics.checkNotNullParameter(newsFeedMarketIndicesViewDuxo, "<set-?>");
        this.duxo = newsFeedMarketIndicesViewDuxo;
    }

    @Override // android.view.ViewGroup, android.view.View
    protected void onAttachedToWindow() {
        super.onAttachedToWindow();
        ViewDisposerKt.bindTo$default(ObservablesAndroid.observeOnMainThread(getDuxo().getStates()), this, false, 2, null).subscribeKotlin(new C280621(this));
        final ImageView imageView = getBinding().newsFeedMarketNewsInfoIcon;
        Intrinsics.checkNotNull(imageView);
        ViewsKt.setLoggingConfig(imageView, new AutoLoggingConfig(false, false, 2, null));
        ViewsKt.eventData$default(imageView, false, new Function0() { // from class: com.robinhood.android.search.newsfeed.marketupdates.NewsFeedMarketIndicesView$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return NewsFeedMarketIndicesView.onAttachedToWindow$lambda$3$lambda$1();
            }
        }, 1, null);
        OnClickListeners.onClick(imageView, new Function0() { // from class: com.robinhood.android.search.newsfeed.marketupdates.NewsFeedMarketIndicesView$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return NewsFeedMarketIndicesView.onAttachedToWindow$lambda$3$lambda$2(this.f$0, imageView);
            }
        });
    }
    ...
    /* renamed from: com.robinhood.android.search.newsfeed.marketupdates.NewsFeedMarketIndicesView$onAttachedToWindow$1 */
    /* synthetic */ class C280621 extends FunctionReferenceImpl implements Function1<NewsFeedMarketIndicesViewState, Unit> {
        C280621(Object obj) {
            super(1, obj, NewsFeedMarketIndicesView.class, "setViewState", "setViewState(Lcom/robinhood/android/search/newsfeed/marketupdates/NewsFeedMarketIndicesViewState;)V", 0);
        }

        @Override // kotlin.jvm.functions.Function1
        public /* bridge */ /* synthetic */ Unit invoke(NewsFeedMarketIndicesViewState newsFeedMarketIndicesViewState) {
            invoke2(newsFeedMarketIndicesViewState);
            return Unit.INSTANCE;
        }

        /* renamed from: invoke, reason: avoid collision after fix types in other method */
        public final void invoke2(NewsFeedMarketIndicesViewState p0) {
            Intrinsics.checkNotNullParameter(p0, "p0");
            ((NewsFeedMarketIndicesView) this.receiver).setViewState(p0);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final UserInteractionEventDescriptor onAttachedToWindow$lambda$3$lambda$1() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit onAttachedToWindow$lambda$3$lambda$2(NewsFeedMarketIndicesView newsFeedMarketIndicesView, ImageView imageView) {
        Navigator navigator = newsFeedMarketIndicesView.getNavigator();
        Context context = imageView.getContext();
        Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
        Navigator.DefaultImpls.showFragmentInStandaloneRdsActivity$default(navigator, context, new NewsfeedDisclosureKey("8rixPACyppBGn7iLBFpmJ"), false, false, false, false, null, false, null, null, 1020, null);
        return Unit.INSTANCE;
    }

    @Override // com.robinhood.utils.p409ui.view.Bindable
    public void bind(final Element.MarketIndicators state) {
        Intrinsics.checkNotNullParameter(state, "state");
        getDuxo().setNewsFeedContentMarketIndicators(state.getContents());
        final String strJoinToString$default = CollectionsKt.joinToString$default(state.getContents(), "_", null, null, 0, null, new Function1() { // from class: com.robinhood.android.search.newsfeed.marketupdates.NewsFeedMarketIndicesView$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return NewsFeedMarketIndicesView.bind$lambda$4((Content.MarketIndicator) obj);
            }
        }, 30, null);
        ViewsKt.eventData$default(this, false, new Function0() { // from class: com.robinhood.android.search.newsfeed.marketupdates.NewsFeedMarketIndicesView$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return NewsFeedMarketIndicesView.bind$lambda$5(strJoinToString$default, state);
            }
        }, 1, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final CharSequence bind$lambda$4(Content.MarketIndicator it) {
    ...
    public static final UserInteractionEventDescriptor bind$lambda$5(String str, Element.MarketIndicators marketIndicators) {
        String str2 = null;
        Component component = new Component(Component.ComponentType.MARKET_INDICATOR, null, null, 6, null);
        NewsFeedItem newsFeedItem = new NewsFeedItem(str, NewsFeedItem.ContentType.MARKET_INDICATOR, null, str2, 0, null, 60, null);
        int i = 0;
        int i2 = 0;
        String str3 = null;
        String str4 = null;
    ...
    public static final class Companion implements Inflater<NewsFeedMarketIndicesView> {
        ...
        public NewsFeedMarketIndicesView inflate(ViewGroup parent) {
            Intrinsics.checkNotNullParameter(parent, "parent");
            return (NewsFeedMarketIndicesView) this.$$delegate_0.inflate(parent);
        }

        private Companion() {
            this.$$delegate_0 = Inflater.INSTANCE.include(C27909R.layout.include_news_feed_market_indices_view);
        }
    }
}

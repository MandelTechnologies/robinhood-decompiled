...
/* renamed from: com.robinhood.android.configurationvitals.ConfigurationVitalsManager$onStart$1$invokeSuspend$$inlined$coGet$2 */
/* loaded from: classes17.dex */
public final class C11941x2b342f23 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super ConfigurationVitalsPreference>, Object> {
    final /* synthetic */ Lazy $this_coGet;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C11941x2b342f23(Lazy lazy, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new C11941x2b342f23(this.$this_coGet, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ConfigurationVitalsPreference> continuation) {
        return ((C11941x2b342f23) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

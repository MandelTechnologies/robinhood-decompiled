...
/* renamed from: com.robinhood.android.tradingtrends.ui.chartSection.TradingTrendsChartSectionKt$TradingTrendsChartSection$2$5$2$1, reason: use source file name */
/* loaded from: classes9.dex */
final class TradingTrendsChartSection7 implements Function1<ConstrainScope, Unit> {
    final /* synthetic */ ConstraintLayoutBaseScope4 $chart;

    TradingTrendsChartSection7(ConstraintLayoutBaseScope4 constraintLayoutBaseScope4) {
    ...
    public final void invoke2(ConstrainScope constrainAs) {
        ...
        ConstraintScopeCommon5.m8162linkToVpY3zN4$default(constrainAs.getTop(), this.$chart.getBottom(), 0.0f, 0.0f, 6, null);

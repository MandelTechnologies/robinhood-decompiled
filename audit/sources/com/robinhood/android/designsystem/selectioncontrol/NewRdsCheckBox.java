...
public class NewRdsCheckBox extends RdsSelectionControl {
    ...
    protected int getImageRes() {
        return C13997R.drawable.check_box;
    }
    ...
    protected AbstractCheckableView.AccessibilityOptions getAccessibilityOptions() {
        return new AbstractCheckableView.AccessibilityOptions(ViewsKt.getString(this, C13997R.string.checked), ViewsKt.getString(this, C13997R.string.unchecked));
    }

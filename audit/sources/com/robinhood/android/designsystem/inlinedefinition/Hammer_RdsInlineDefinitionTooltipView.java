...
public abstract class Hammer_RdsInlineDefinitionTooltipView extends FrameLayout implements ViewComponentManagerHolder {
    ...
    private Hammer_RdsInlineDefinitionTooltipView(Context context) {
        ...
        Hammer_RdsInlineDefinitionTooltipView2 hammer_RdsInlineDefinitionTooltipView2 = (Hammer_RdsInlineDefinitionTooltipView2) viewComponentManager.get();
        ...
        hammer_RdsInlineDefinitionTooltipView2.inject((RdsInlineDefinitionTooltipView) this);
        this.injected = true;
    }

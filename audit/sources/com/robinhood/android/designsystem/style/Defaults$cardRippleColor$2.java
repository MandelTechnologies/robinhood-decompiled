...
/* synthetic */ class Defaults$cardRippleColor$2 extends FunctionReferenceImpl implements Function2<RdsCardView, ColorStateList, Unit> {
    public static final Defaults$cardRippleColor$2 INSTANCE = new Defaults$cardRippleColor$2();

    Defaults$cardRippleColor$2() {
        super(2, RdsCardView.class, "setRippleColor", "setRippleColor(Landroid/content/res/ColorStateList;)V", 0);
    }

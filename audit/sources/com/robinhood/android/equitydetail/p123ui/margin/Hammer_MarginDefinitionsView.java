...
public abstract class Hammer_MarginDefinitionsView extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_MarginDefinitionsView(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_MarginDefinitionsView2 hammer_MarginDefinitionsView2 = (Hammer_MarginDefinitionsView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.margin.MarginDefinitionsView");
        hammer_MarginDefinitionsView2.inject((MarginDefinitionsView) this);
        this.injected = true;
    }
}

...
public abstract class Hammer_SimilarInstrumentsV2View extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_SimilarInstrumentsV2View(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_SimilarInstrumentsV2View2 hammer_SimilarInstrumentsV2View2 = (Hammer_SimilarInstrumentsV2View2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.similarinstruments.SimilarInstrumentsV2View");
        hammer_SimilarInstrumentsV2View2.inject((SimilarInstrumentsV2View) this);
        this.injected = true;
    }
}

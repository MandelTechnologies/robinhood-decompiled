...
public abstract class Hammer_MilestonesComposeView extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_MilestonesComposeView(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_MilestonesComposeView2 hammer_MilestonesComposeView2 = (Hammer_MilestonesComposeView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.milestones.MilestonesComposeView");
        hammer_MilestonesComposeView2.inject((MilestonesComposeView) this);
        this.injected = true;
    }
}

...
public abstract class Hammer_PositionView extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_PositionView(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_PositionView2 hammer_PositionView2 = (Hammer_PositionView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.position.PositionView");
        hammer_PositionView2.inject((PositionView) this);
        this.injected = true;
    }
}

...
public abstract class Hammer_InstrumentRatingsV2View extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_InstrumentRatingsV2View(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_InstrumentRatingsV2View2 hammer_InstrumentRatingsV2View2 = (Hammer_InstrumentRatingsV2View2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.instrumentratings.v2.InstrumentRatingsV2View");
        hammer_InstrumentRatingsV2View2.inject((InstrumentRatingsV2View) this);
        this.injected = true;
    }
}

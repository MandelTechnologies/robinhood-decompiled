...
public abstract class Hammer_ShareholderQaEventsSectionView extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_ShareholderQaEventsSectionView(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_ShareholderQaEventsSectionView2 hammer_ShareholderQaEventsSectionView2 = (Hammer_ShareholderQaEventsSectionView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.shareholderexperience.ShareholderQaEventsSectionView");
        hammer_ShareholderQaEventsSectionView2.inject((ShareholderQaEventsSectionView) this);
        this.injected = true;
    }
}

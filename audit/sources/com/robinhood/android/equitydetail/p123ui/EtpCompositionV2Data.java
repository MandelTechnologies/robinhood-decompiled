...
public final /* data */ class EtpCompositionV2Data extends DetailData {
    public static final int $stable = 8;
    private final UUID instrumentUuid;
    private final ApiStockDetail.Section section;

    public static /* synthetic */ EtpCompositionV2Data copy$default(EtpCompositionV2Data etpCompositionV2Data, UUID uuid, int i, Object obj) {
        if ((i & 1) != 0) {
            uuid = etpCompositionV2Data.instrumentUuid;
        }
        return etpCompositionV2Data.copy(uuid);
    }
    ...
    public final EtpCompositionV2Data copy(UUID instrumentUuid) {
        Intrinsics.checkNotNullParameter(instrumentUuid, "instrumentUuid");
        return new EtpCompositionV2Data(instrumentUuid);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof EtpCompositionV2Data) && Intrinsics.areEqual(this.instrumentUuid, ((EtpCompositionV2Data) other).instrumentUuid);
    }
    ...
    public String toString() {
        return "EtpCompositionV2Data(instrumentUuid=" + this.instrumentUuid + ")";
    }
    ...
    public EtpCompositionV2Data(UUID instrumentUuid) {
        super(null);
        Intrinsics.checkNotNullParameter(instrumentUuid, "instrumentUuid");

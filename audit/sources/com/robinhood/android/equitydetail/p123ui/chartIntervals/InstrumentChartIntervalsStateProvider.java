...
public final class InstrumentChartIntervalsStateProvider implements StateProvider<InstrumentChartIntervalsDataState, InstrumentChartIntervalsStateProvider3> {
    public static final int $stable = 0;

    @Override // com.robinhood.android.udf.StateProvider
    public InstrumentChartIntervalsStateProvider3 reduce(InstrumentChartIntervalsDataState dataState) {
        Intrinsics.checkNotNullParameter(dataState, "dataState");
        if (dataState.getSpanInterval() == null) {
            return InstrumentChartIntervalsStateProvider3.Loading.INSTANCE;
        }
        return new InstrumentChartIntervalsStateProvider3.Ready(dataState.getSpanInterval());
    }
}

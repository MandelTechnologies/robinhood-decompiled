...
public abstract class Hammer_IpoHeaderViewV2 extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_IpoHeaderViewV2(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_IpoHeaderViewV22 hammer_IpoHeaderViewV22 = (Hammer_IpoHeaderViewV22) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.ipo.IpoHeaderViewV2");
        hammer_IpoHeaderViewV22.inject((IpoHeaderViewV2) this);
        this.injected = true;
    }
}

...
final class InstrumentChartKt$InstrumentChart$1$9$1 implements Function1<List<? extends Point>, Unit> {
    final /* synthetic */ SnapshotState<Point> $selectedPoint$delegate;

    InstrumentChartKt$InstrumentChart$1$9$1(SnapshotState<Point> snapshotState) {

...
public abstract class Hammer_EtpCompositionV2View extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_EtpCompositionV2View(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_EtpCompositionV2View2 hammer_EtpCompositionV2View2 = (Hammer_EtpCompositionV2View2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.etp.v2.EtpCompositionV2View");
        hammer_EtpCompositionV2View2.inject((EtpCompositionV2View) this);
        this.injected = true;
    }
}

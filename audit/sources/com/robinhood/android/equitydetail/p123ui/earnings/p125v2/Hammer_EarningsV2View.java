...
public abstract class Hammer_EarningsV2View extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_EarningsV2View(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_EarningsV2View2 hammer_EarningsV2View2 = (Hammer_EarningsV2View2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equitydetail.ui.earnings.v2.EarningsV2View");
        hammer_EarningsV2View2.inject((EarningsV2View) this);
        this.injected = true;
    }
}

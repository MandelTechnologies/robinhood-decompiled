...
/* compiled from: TransactionDetailDuxo.kt */
...
public final class TransactionDetailDuxo extends BaseDuxo4<TransactionDetailState> implements HasSavedState {
    ...
    public TransactionDetailDuxo(HistoryTransactionStore historyTransactionStore, AggregatedHistoryTransactionFormatter minervaTransactionFormatters, DuxoBundle duxoBundle, SavedStateHandle savedStateHandle) {
        super(new TransactionDetailState(null, null, null, null, false, 31, null), duxoBundle);
    ...
    public void onResume() {
        super.onResume();
        Observable<? extends MinervaTransaction> observableDistinctUntilChanged = this.historyTransactionStore.fromReference(((McDucklingTransactionFragmentKey) INSTANCE.getArgs((HasSavedState) this)).getTransactionReference()).distinctUntilChanged();
        Intrinsics.checkNotNullExpressionValue(observableDistinctUntilChanged, "distinctUntilChanged(...)");
        LifecycleHost.DefaultImpls.bind$default(this, observableDistinctUntilChanged, (LifecycleEvent) null, 1, (Object) null).subscribeKotlin(new Function1() { // from class: com.robinhood.android.history.ui.transaction.TransactionDetailDuxo.onResume.1
            ...
            public final void invoke(MinervaTransaction minervaTransaction) {
                ...
                TransactionDetailDuxo transactionDetailDuxo = TransactionDetailDuxo.this;
                transactionDetailDuxo.applyMutation(new AnonymousClass1(transactionDetailDuxo, minervaTransaction, z4, z, z2, z3, null));
            }

            /* compiled from: TransactionDetailDuxo.kt */
            @Metadata(m3635d1 = {"\u0000\u0006\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0001H\n"}, m3636d2 = {"<anonymous>", "Lcom/robinhood/android/history/ui/transaction/TransactionDetailState;"}, m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
            @DebugMetadata(m3644c = "com.robinhood.android.history.ui.transaction.TransactionDetailDuxo$onResume$1$1", m3645f = "TransactionDetailDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
            /* renamed from: com.robinhood.android.history.ui.transaction.TransactionDetailDuxo$onResume$1$1, reason: invalid class name */
            static final class AnonymousClass1 extends ContinuationImpl7 implements Function2<TransactionDetailState, Continuation<? super TransactionDetailState>, Object> {
                ...
                int label;
                final /* synthetic */ TransactionDetailDuxo this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                AnonymousClass1(TransactionDetailDuxo transactionDetailDuxo, MinervaTransaction minervaTransaction, boolean z, boolean z2, boolean z3, boolean z4, Continuation<? super AnonymousClass1> continuation) {
                    super(2, continuation);
                    this.this$0 = transactionDetailDuxo;
                ...
                public final Object invoke(TransactionDetailState transactionDetailState, Continuation<? super TransactionDetailState> continuation) {
                    return ((AnonymousClass1) create(transactionDetailState, continuation)).invokeSuspend(Unit.INSTANCE);
                }
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    TransactionDetailState transactionDetailState = (TransactionDetailState) this.L$0;
                    ...
                    return TransactionDetailState.copy$default(transactionDetailState, new TransactionOverview(resource, primaryText, charSequence, listMo25632getLineItems, aggregatedHistoryTransactionFormatter4.getMerchantName(minervaTransaction4)), this.$transaction, null, null, false, 28, null);
                }
            }
        });
    }
    ...
    public static final class Companion implements DuxoCompanion<TransactionDetailDuxo, McDucklingTransactionFragmentKey> {
        ...
        public McDucklingTransactionFragmentKey getArgs(SavedStateHandle savedStateHandle) {
            return (McDucklingTransactionFragmentKey) DuxoCompanion.DefaultImpls.getArgs(this, savedStateHandle);
        }

        @Override // com.robinhood.android.udf.DuxoCompanion
        public McDucklingTransactionFragmentKey getArgs(TransactionDetailDuxo transactionDetailDuxo) {
            return (McDucklingTransactionFragmentKey) DuxoCompanion.DefaultImpls.getArgs(this, transactionDetailDuxo);
        }
    }
}

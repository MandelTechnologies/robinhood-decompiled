...
public abstract class Hammer_AccountCenterCreditAppBannerView extends GenericComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_AccountCenterCreditAppBannerView(Context context, AttributeSet attributeSet) {
        ...
        Hammer_AccountCenterCreditAppBannerView2 hammer_AccountCenterCreditAppBannerView2 = (Hammer_AccountCenterCreditAppBannerView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.accountcenter.views.AccountCenterCreditAppBannerView");
        hammer_AccountCenterCreditAppBannerView2.inject((AccountCenterCreditAppBannerView) this);
        this.injected = true;
    }
}

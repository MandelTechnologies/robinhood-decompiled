...
public abstract class Hammer_AccountCenterBannerView extends GenericComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_AccountCenterBannerView(Context context, AttributeSet attributeSet) {
        ...
        Hammer_AccountCenterBannerView2 hammer_AccountCenterBannerView2 = (Hammer_AccountCenterBannerView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.accountcenter.views.AccountCenterBannerView");
        hammer_AccountCenterBannerView2.inject((AccountCenterBannerView) this);
        this.injected = true;
    }
}

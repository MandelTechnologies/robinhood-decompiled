...
final class LiveEventCardKt$LiveEventCard$4$1$8$1 implements Function1<ConstrainScope, Unit> {
    final /* synthetic */ ConstraintLayoutBaseScope4 $leftContractInfo;
    final /* synthetic */ ConstraintLayoutBaseScope4 $seed2Metadata;

    LiveEventCardKt$LiveEventCard$4$1$8$1(ConstraintLayoutBaseScope4 constraintLayoutBaseScope4, ConstraintLayoutBaseScope4 constraintLayoutBaseScope42) {
        this.$seed2Metadata = constraintLayoutBaseScope4;
        this.$leftContractInfo = constraintLayoutBaseScope42;
    }
    ...
    public final void invoke2(ConstrainScope constrainAs) {
        ...
        ConstraintScopeCommon6.m8185linkToVpY3zN4$default(constrainAs.getStart(), this.$seed2Metadata.getEnd(), 0.0f, 0.0f, 6, null);

...
/* compiled from: InvestFlowPaymentMethodAdapter.kt */
@Metadata(m3635d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u0000 \u00162\u0014\u0012\u0004\u0012\u00020\u0002\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00040\u00030\u0001:\u0001\u0016B\u001b\u0012\u0012\u0010\u0005\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00070\u0006¢\u0006\u0004\b\b\u0010\tJ\u0010\u0010\f\u001a\u00020\u00072\u0006\u0010\n\u001a\u00020\u000bH\u0007J\u0010\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u000eH\u0016J\u001e\u0010\u0010\u001a\u00020\u00072\f\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\u00040\u00032\u0006\u0010\u000f\u001a\u00020\u000eH\u0016J\u001e\u0010\u0012\u001a\b\u0012\u0004\u0012\u00020\u00040\u00032\u0006\u0010\u0013\u001a\u00020\u00142\u0006\u0010\u0015\u001a\u00020\u000eH\u0016R\u001a\u0010\u0005\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00070\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u000bX\u0082.¢\u0006\u0002\n\u0000¨\u0006\u0017"}, m3636d2 = {"Lcom/robinhood/android/investFlow/paymentmethod/InvestFlowPaymentMethodAdapter;", "Landroidx/recyclerview/widget/ListAdapter;", "Lcom/robinhood/android/investFlow/paymentmethod/InvestFlowPaymentMethodFragment$Row;", "Lcom/robinhood/utils/ui/view/recyclerview/GenericViewHolder;", "Landroid/view/View;", "onRowClicked", "Lkotlin/Function1;", "", "<init>", "(Lkotlin/jvm/functions/Function1;)V", "state", "Lcom/robinhood/android/investFlow/paymentmethod/InvestFlowPaymentMethodViewState;", "setState", "getItemViewType", "", "position", "onBindViewHolder", "holder", "onCreateViewHolder", "parent", "Landroid/view/ViewGroup;", "viewType", "Companion", "feature-invest-flow_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
/* loaded from: classes10.dex */
public final class InvestFlowPaymentMethodAdapter extends ListAdapter<InvestFlowPaymentMethodFragment.Row, GenericViewHolder<? extends View>> {
    private static final int VIEW_TYPE_ADD_REMOVE = 0;
    private static final int VIEW_TYPE_RELATIONSHIP_BP = 1;
    private final Function1<InvestFlowPaymentMethodFragment.Row, Unit> onRowClicked;
    private InvestFlowPaymentMethodViewState state;
    public static final int $stable = 8;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public InvestFlowPaymentMethodAdapter(Function1<? super InvestFlowPaymentMethodFragment.Row, Unit> onRowClicked) {
        super(DiffCallbacks.INSTANCE.byEquality(new Function1() { // from class: com.robinhood.android.investFlow.paymentmethod.InvestFlowPaymentMethodAdapter$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return ((InvestFlowPaymentMethodFragment.Row) obj).getTitle();
            }
        }));
    ...
    public final void setState(InvestFlowPaymentMethodViewState state) {
        Intrinsics.checkNotNullParameter(state, "state");
        this.state = state;
        submitList(state.getRows());
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int position) {
        InvestFlowPaymentMethodFragment.Row item = getItem(position);
        if ((item instanceof InvestFlowPaymentMethodFragment.Row.BrokerageBuyingPower) || (item instanceof InvestFlowPaymentMethodFragment.Row.RetirementBuyingPower) || (item instanceof InvestFlowPaymentMethodFragment.Row.AchRelationship) || (item instanceof InvestFlowPaymentMethodFragment.Row.JointBuyingPower)) {
            return 1;
        }
        if ((item instanceof InvestFlowPaymentMethodFragment.Row.AddAccount) || (item instanceof InvestFlowPaymentMethodFragment.Row.RemoveBackup)) {
            return 0;
        }
    ...
    public void onBindViewHolder(GenericViewHolder<? extends View> holder, int position) throws Resources.NotFoundException {
        ...
        final InvestFlowPaymentMethodFragment.Row item = getItem(position);
        ...
        if (view instanceof RdsRadioButtonRowView) {
            ...
            InvestFlowPaymentMethodViewState investFlowPaymentMethodViewState = this.state;
            if (investFlowPaymentMethodViewState == null) {
                Intrinsics.throwUninitializedPropertyAccessException("state");
                investFlowPaymentMethodViewState = null;
            }
            InvestFlowPaymentMethodFragment.Row selectedRow = investFlowPaymentMethodViewState.getSelectedRow();
            rdsRadioButtonRowView.setChecked(Intrinsics.areEqual(selectedRow != null ? selectedRow.getTitle() : null, item.getTitle()));
            OnClickListeners.onClick(rdsRadioButtonRowView, new Function0() { // from class: com.robinhood.android.investFlow.paymentmethod.InvestFlowPaymentMethodAdapter$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return InvestFlowPaymentMethodAdapter.onBindViewHolder$lambda$2$lambda$1(this.f$0, item);
                }
            });
            return;
        }
        if (view instanceof RdsRowView) {
            ...
            OnClickListeners.onClick(rdsRowView, new Function0() { // from class: com.robinhood.android.investFlow.paymentmethod.InvestFlowPaymentMethodAdapter$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return InvestFlowPaymentMethodAdapter.onBindViewHolder$lambda$5$lambda$4(this.f$0, item);
                }
            });
        }
    }
    ...
    public static final Unit onBindViewHolder$lambda$2$lambda$1(InvestFlowPaymentMethodAdapter investFlowPaymentMethodAdapter, InvestFlowPaymentMethodFragment.Row row) {
        Function1<InvestFlowPaymentMethodFragment.Row, Unit> function1 = investFlowPaymentMethodAdapter.onRowClicked;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit onBindViewHolder$lambda$5$lambda$4(InvestFlowPaymentMethodAdapter investFlowPaymentMethodAdapter, InvestFlowPaymentMethodFragment.Row row) {
        Function1<InvestFlowPaymentMethodFragment.Row, Unit> function1 = investFlowPaymentMethodAdapter.onRowClicked;
        Intrinsics.checkNotNull(row);
        function1.invoke(row);
        return Unit.INSTANCE;

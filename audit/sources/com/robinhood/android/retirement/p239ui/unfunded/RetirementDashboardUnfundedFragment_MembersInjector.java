...
public final class RetirementDashboardUnfundedFragment_MembersInjector implements MembersInjector<RetirementDashboardUnfundedFragment> {
    ...
    @JvmStatic
    public static final MembersInjector<RetirementDashboardUnfundedFragment> create(Provider<BaseFragmentSingletons> provider, Provider<GenericComposeSingletons> provider2, Provider<Markwon> provider3, Provider<EventLogger> provider4, Provider<CrossSellLaunchManager> provider5) {
        return INSTANCE.create(provider, provider2, provider3, provider4, provider5);
    }

    @JvmStatic
    public static final void injectCrossSellLaunchManager(RetirementDashboardUnfundedFragment retirementDashboardUnfundedFragment, CrossSellLaunchManager crossSellLaunchManager) {
        INSTANCE.injectCrossSellLaunchManager(retirementDashboardUnfundedFragment, crossSellLaunchManager);
    }

    @JvmStatic
    public static final void injectEventLogger(RetirementDashboardUnfundedFragment retirementDashboardUnfundedFragment, EventLogger eventLogger) {
        INSTANCE.injectEventLogger(retirementDashboardUnfundedFragment, eventLogger);
    }

    public RetirementDashboardUnfundedFragment_MembersInjector(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<Markwon> markwon, Provider<EventLogger> eventLogger, Provider<CrossSellLaunchManager> crossSellLaunchManager) {
    ...
    public void injectMembers(RetirementDashboardUnfundedFragment instance) {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final MembersInjector<RetirementDashboardUnfundedFragment> create(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<Markwon> markwon, Provider<EventLogger> eventLogger, Provider<CrossSellLaunchManager> crossSellLaunchManager) {
            Intrinsics.checkNotNullParameter(singletons, "singletons");
            Intrinsics.checkNotNullParameter(genericComposeSingletons, "genericComposeSingletons");
            Intrinsics.checkNotNullParameter(markwon, "markwon");
            Intrinsics.checkNotNullParameter(eventLogger, "eventLogger");
            Intrinsics.checkNotNullParameter(crossSellLaunchManager, "crossSellLaunchManager");
            return new RetirementDashboardUnfundedFragment_MembersInjector(singletons, genericComposeSingletons, markwon, eventLogger, crossSellLaunchManager);
        }

        @JvmStatic
        public final void injectEventLogger(RetirementDashboardUnfundedFragment instance, EventLogger eventLogger) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(eventLogger, "eventLogger");
        ...
        @JvmStatic
        public final void injectCrossSellLaunchManager(RetirementDashboardUnfundedFragment instance, CrossSellLaunchManager crossSellLaunchManager) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(crossSellLaunchManager, "crossSellLaunchManager");

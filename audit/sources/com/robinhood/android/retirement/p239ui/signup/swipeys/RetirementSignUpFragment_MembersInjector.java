...
public final class RetirementSignUpFragment_MembersInjector implements MembersInjector<RetirementSignUpFragment> {
    ...
    @JvmStatic
    public static final MembersInjector<RetirementSignUpFragment> create(Provider<BaseFragmentSingletons> provider, Provider<GenericComposeSingletons> provider2, Provider<Markwon> provider3, Provider<SurveyManager3> provider4, Provider<CrossSellLaunchManager> provider5) {
        return INSTANCE.create(provider, provider2, provider3, provider4, provider5);
    }

    @JvmStatic
    public static final void injectCrossSellLaunchManager(RetirementSignUpFragment retirementSignUpFragment, CrossSellLaunchManager crossSellLaunchManager) {
        INSTANCE.injectCrossSellLaunchManager(retirementSignUpFragment, crossSellLaunchManager);
    }

    @JvmStatic
    public static final void injectUserLeapManager(RetirementSignUpFragment retirementSignUpFragment, SurveyManager3 surveyManager3) {
        INSTANCE.injectUserLeapManager(retirementSignUpFragment, surveyManager3);
    }

    public RetirementSignUpFragment_MembersInjector(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<Markwon> markwon, Provider<SurveyManager3> userLeapManager, Provider<CrossSellLaunchManager> crossSellLaunchManager) {
    ...
    public void injectMembers(RetirementSignUpFragment instance) {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final MembersInjector<RetirementSignUpFragment> create(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<Markwon> markwon, Provider<SurveyManager3> userLeapManager, Provider<CrossSellLaunchManager> crossSellLaunchManager) {
            Intrinsics.checkNotNullParameter(singletons, "singletons");
            Intrinsics.checkNotNullParameter(genericComposeSingletons, "genericComposeSingletons");
            Intrinsics.checkNotNullParameter(markwon, "markwon");
            Intrinsics.checkNotNullParameter(userLeapManager, "userLeapManager");
            Intrinsics.checkNotNullParameter(crossSellLaunchManager, "crossSellLaunchManager");
            return new RetirementSignUpFragment_MembersInjector(singletons, genericComposeSingletons, markwon, userLeapManager, crossSellLaunchManager);
        }

        @JvmStatic
        public final void injectUserLeapManager(RetirementSignUpFragment instance, SurveyManager3 userLeapManager) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(userLeapManager, "userLeapManager");
        ...
        @JvmStatic
        public final void injectCrossSellLaunchManager(RetirementSignUpFragment instance, CrossSellLaunchManager crossSellLaunchManager) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(crossSellLaunchManager, "crossSellLaunchManager");

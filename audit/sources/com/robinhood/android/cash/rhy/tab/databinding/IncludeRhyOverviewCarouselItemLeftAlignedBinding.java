...
public final class IncludeRhyOverviewCarouselItemLeftAlignedBinding implements ViewBinding {
    ...
    private IncludeRhyOverviewCarouselItemLeftAlignedBinding(ConstraintLayout constraintLayout, RdsTextButton rdsTextButton, LottieAnimationView lottieAnimationView, Guideline guideline, RdsIconButton rdsIconButton, ImageView imageView, RhTextView rhTextView, RhTextView rhTextView2, RdsInfoTag rdsInfoTag) {
    ...
    public static IncludeRhyOverviewCarouselItemLeftAlignedBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static IncludeRhyOverviewCarouselItemLeftAlignedBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C10285R.layout.include_rhy_overview_carousel_item_left_aligned, viewGroup, false);
        if (z) {
    ...
    public static IncludeRhyOverviewCarouselItemLeftAlignedBinding bind(View view) {
                        ...
                        if (imageView != null) {
                            ...
                            if (rhTextView != null) {
                                ...
                                if (rhTextView2 != null) {
                                    ...
                                    if (rdsInfoTag != null) {
                                        return new IncludeRhyOverviewCarouselItemLeftAlignedBinding((ConstraintLayout) view, rdsTextButton, lottieAnimationView, guideline, rdsIconButton, imageView, rhTextView, rhTextView2, rdsInfoTag);
                                    }
                                }
                            }
                        }

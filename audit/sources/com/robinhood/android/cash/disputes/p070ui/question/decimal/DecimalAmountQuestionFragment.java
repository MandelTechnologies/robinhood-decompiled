...
import com.robinhood.android.cash.disputes.databinding.FragmentDecimalAmountQuestionBinding;
...
public final class DecimalAmountQuestionFragment extends BaseFragment implements RegionGated, AutoLoggableFragment, DisputeToolbarSkipText {
    ...
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(DecimalAmountQuestionFragment.class, "binding", "getBinding()Lcom/robinhood/android/cash/disputes/databinding/FragmentDecimalAmountQuestionBinding;", 0)), Reflection.property1(new PropertyReference1Impl(DecimalAmountQuestionFragment.class, "callbacks", "getCallbacks()Lcom/robinhood/android/cash/disputes/ui/question/DisputeQuestionCallbacks;", 0))};
    ...
    public DecimalAmountQuestionFragment() {
        super(C10007R.layout.fragment_decimal_amount_question);
        this.$$delegate_0 = new RegionGated2(SpendingRegionGate.INSTANCE);
        this.$$delegate_1 = new DisputeToolbarSkipText2();
        this.eventScreen = LazyKt.lazy(new Function0() { // from class: com.robinhood.android.cash.disputes.ui.question.decimal.DecimalAmountQuestionFragment$$ExternalSyntheticLambda4
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return DecimalAmountQuestionFragment.eventScreen_delegate$lambda$0(this.f$0);
            }
        });
        this.eventContext = LazyKt.lazy(new Function0() { // from class: com.robinhood.android.cash.disputes.ui.question.decimal.DecimalAmountQuestionFragment$$ExternalSyntheticLambda5
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return DecimalAmountQuestionFragment.eventContext_delegate$lambda$1(this.f$0);
            }
        });
        this.duxo = OldDuxos.oldDuxo(this, DecimalAmountQuestionDuxo.class);
        this.binding = ViewBinding5.viewBinding(this, DecimalAmountQuestionFragment2.INSTANCE);
        this.callbacks = new CallbacksProperty(Reflection.getOrCreateKotlinClass(DisputeQuestionCallbacks.class), new Function1<Fragment, Object>() { // from class: com.robinhood.android.cash.disputes.ui.question.decimal.DecimalAmountQuestionFragment$special$$inlined$hostActivityCallbacks$1
    ...
    public static final Screen eventScreen_delegate$lambda$0(DecimalAmountQuestionFragment decimalAmountQuestionFragment) {
        Screen.Name name = Screen.Name.DISPUTES_AMOUNT_ENTRY_QUESTION;
        String string2 = ((Args) INSTANCE.getArgs((Fragment) decimalAmountQuestionFragment)).getQuestion().getId().toString();
    ...
    public static final Context eventContext_delegate$lambda$1(DecimalAmountQuestionFragment decimalAmountQuestionFragment) {
        Companion companion = INSTANCE;
        String serverValue = ((Args) companion.getArgs((Fragment) decimalAmountQuestionFragment)).getDisputeReason().getServerValue();
        String string2 = ((Args) companion.getArgs((Fragment) decimalAmountQuestionFragment)).getQuestion().getId().toString();
        Intrinsics.checkNotNullExpressionValue(string2, "toString(...)");
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Companion companion = INSTANCE;
        if (((Args) companion.getArgs((Fragment) this)).getQuestion().getType() != DisputeQuestionnaire.Question.UserInput.Type.DECIMAL) {
            throw new IllegalStateException("Check failed.");
        }
        RdsButton rdsButton = getBinding().decimalQuestionContinueButton;
        Intrinsics.checkNotNull(rdsButton);
        ViewsKt.eventData$default(rdsButton, false, new Function0() { // from class: com.robinhood.android.cash.disputes.ui.question.decimal.DecimalAmountQuestionFragment$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return DecimalAmountQuestionFragment.onViewCreated$lambda$3$lambda$2(this.f$0);
            }
        }, 1, null);
        OnClickListeners.onClick(rdsButton, new DecimalAmountQuestionFragment3(this));
        LifecycleHost.DefaultImpls.bind$default(this, ObservablesAndroid.observeOnMainThread(getBinding().decimalQuestionAmountInput.getAmountObservable()), (LifecycleEvent) null, 1, (Object) null).subscribeKotlin(new Function1() { // from class: com.robinhood.android.cash.disputes.ui.question.decimal.DecimalAmountQuestionFragment$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return DecimalAmountQuestionFragment.onViewCreated$lambda$4(this.f$0, (Optional) obj);
            }
        });
        LifecycleHost.DefaultImpls.bind$default(this, ObservablesAndroid.observeOnMainThread(getBinding().decimalQuestionNumpad.getKeyEvents()), (LifecycleEvent) null, 1, (Object) null).subscribeKotlin(new C100193(getBinding().decimalQuestionAmountInput));
        Observable<DecimalAmountQuestionViewState> observableDistinctUntilChanged = getDuxo().getStates().distinctUntilChanged();
        Intrinsics.checkNotNullExpressionValue(observableDistinctUntilChanged, "distinctUntilChanged(...)");
        LifecycleHost.DefaultImpls.bind$default(this, ObservablesAndroid.observeOnMainThread(observableDistinctUntilChanged), (LifecycleEvent) null, 1, (Object) null).subscribeKotlin(new Function1() { // from class: com.robinhood.android.cash.disputes.ui.question.decimal.DecimalAmountQuestionFragment$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return DecimalAmountQuestionFragment.onViewCreated$lambda$8(this.f$0, (DecimalAmountQuestionViewState) obj);
            }
        });
        ...
        DisputeQuestionResponse.Decimal decimal = (DisputeQuestionResponse.Decimal) (previousQuestionResponse instanceof DisputeQuestionResponse.Decimal ? previousQuestionResponse : null);
        if (decimal != null) {
            getDuxo().updatePreFillAmount(decimal);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final UserInteractionEventDescriptor onViewCreated$lambda$3$lambda$2(DecimalAmountQuestionFragment decimalAmountQuestionFragment) {
        return new UserInteractionEventDescriptor(null, null, null, decimalAmountQuestionFragment.getEventContext(), new Component(Component.ComponentType.CONTINUE_BUTTON, null, null, 6, null), null, 39, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit onViewCreated$lambda$4(DecimalAmountQuestionFragment decimalAmountQuestionFragment, Optional optional) {
        Intrinsics.checkNotNullParameter(optional, "<destruct>");
        decimalAmountQuestionFragment.getBinding().decimalQuestionContinueButton.setEnabled(((Money) optional.component1()) != null);
        return Unit.INSTANCE;
    }

    /* compiled from: DecimalAmountQuestionFragment.kt */
    @Metadata(m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    /* renamed from: com.robinhood.android.cash.disputes.ui.question.decimal.DecimalAmountQuestionFragment$onViewCreated$3 */
    /* synthetic */ class C100193 extends FunctionReferenceImpl implements Function1<KeyEvent, Unit> {
        C100193(Object obj) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit onViewCreated$lambda$8(DecimalAmountQuestionFragment decimalAmountQuestionFragment, DecimalAmountQuestionViewState decimalAmountQuestionViewState) {
        ResponseValidationResult responseValidationResultConsume;
        Money moneyConsume;
        decimalAmountQuestionFragment.getBinding().decimalQuestionTitle.setText(decimalAmountQuestionViewState.getTitleText());
        RhTextView rhTextView = decimalAmountQuestionFragment.getBinding().decimalQuestionSubtitle;
        rhTextView.setText(decimalAmountQuestionViewState.getSubtitleText());
        Intrinsics.checkNotNull(rhTextView);
        rhTextView.setVisibility(decimalAmountQuestionViewState.isSubtitleVisible() ? 0 : 8);
        decimalAmountQuestionFragment.getBinding().decimalQuestionAmountInput.setHint(decimalAmountQuestionViewState.getInputHintAmount());
        decimalAmountQuestionFragment.getBinding().decimalQuestionContinueButton.setLoading(decimalAmountQuestionViewState.getIsValidationRequestLoading());
        decimalAmountQuestionFragment.setDisputeSkipButtonEnabled(decimalAmountQuestionViewState.isSkipButtonEnabled());
        UiEvent<Money> amountPreFillEvent = decimalAmountQuestionViewState.getAmountPreFillEvent();
        if (amountPreFillEvent != null && (moneyConsume = amountPreFillEvent.consume()) != null) {
            decimalAmountQuestionFragment.getBinding().decimalQuestionAmountInput.setAmount(moneyConsume);
        }
        UiEvent<ResponseValidationResult> validationResultEvent = decimalAmountQuestionViewState.getValidationResultEvent();
        if (validationResultEvent != null && (responseValidationResultConsume = validationResultEvent.consume()) != null) {
            if (responseValidationResultConsume instanceof ResponseValidationResult.Success) {
                decimalAmountQuestionFragment.getCallbacks().onQuestionAnswered(((ResponseValidationResult.Success) responseValidationResultConsume).getValidatedQuestionResponse());
            } else {
                ...
                if (error.getErrorMessage() != null) {
                    FragmentActivity fragmentActivityRequireActivity = decimalAmountQuestionFragment.requireActivity();
                    Intrinsics.checkNotNullExpressionValue(fragmentActivityRequireActivity, "requireActivity(...)");
                    Snackbars.showLarge(fragmentActivityRequireActivity, error.getErrorMessage(), 0);
                } else {
                    AbsErrorHandler.handleError$default(decimalAmountQuestionFragment.getActivityErrorHandler(), error.getThrowable(), false, 2, null);
                }
            }
        }
        return Unit.INSTANCE;
    ...
    public void configureToolbar(RhToolbar toolbar) {
        ...
        if (displaySkipText != null) {
            ...
            setDisputeSkipButtonText(displaySkipText, new Function0() { // from class: com.robinhood.android.cash.disputes.ui.question.decimal.DecimalAmountQuestionFragment$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return DecimalAmountQuestionFragment.configureToolbar$lambda$11$lambda$10(this.f$0);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit configureToolbar$lambda$11$lambda$10(DecimalAmountQuestionFragment decimalAmountQuestionFragment) {
        decimalAmountQuestionFragment.skipQuestion();
        return Unit.INSTANCE;
    }
    ...
    /* compiled from: DecimalAmountQuestionFragment.kt */
    @Metadata(m3635d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\t\b\u0002¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, m3636d2 = {"Lcom/robinhood/android/cash/disputes/ui/question/decimal/DecimalAmountQuestionFragment$Companion;", "Lcom/robinhood/utils/ui/fragment/FragmentWithArgsCompanion;", "Lcom/robinhood/android/cash/disputes/ui/question/decimal/DecimalAmountQuestionFragment;", "Lcom/robinhood/android/cash/disputes/ui/question/decimal/DecimalAmountQuestionFragment$Args;", "<init>", "()V", "feature-cash-disputes_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    public static final class Companion implements FragmentWithArgsCompanion<DecimalAmountQuestionFragment, Args> {
        ...
        public Args getArgs(DecimalAmountQuestionFragment decimalAmountQuestionFragment) {
            return (Args) FragmentWithArgsCompanion.DefaultImpls.getArgs(this, decimalAmountQuestionFragment);
        }

        @Override // com.robinhood.utils.p409ui.fragment.FragmentWithArgsCreator
        public DecimalAmountQuestionFragment newInstance(Args args) {
            return (DecimalAmountQuestionFragment) FragmentWithArgsCompanion.DefaultImpls.newInstance(this, args);
        }

        @Override // com.robinhood.utils.p409ui.fragment.FragmentWithArgsCompanion
        public void setArgs(DecimalAmountQuestionFragment decimalAmountQuestionFragment, Args args) {
            FragmentWithArgsCompanion.DefaultImpls.setArgs(this, decimalAmountQuestionFragment, args);
        }
    }
}

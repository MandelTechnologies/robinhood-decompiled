...
/* compiled from: FreeFormTextQuestionScreenFragment.kt */
@Metadata(m3635d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u0000 \u001b2\u00020\u00012\u00020\u00022\u00020\u0003:\u0002\u001a\u001bB\u0007¢\u0006\u0004\b\u0004\u0010\u0005J\u0010\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\u0014H\u0016J\r\u0010\u0015\u001a\u00020\u0012H\u0017¢\u0006\u0002\u0010\u0016J\u0010\u0010\u0017\u001a\u00020\u00122\u0006\u0010\u0018\u001a\u00020\u0019H\u0016R!\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\b0\u00078BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u000b\u0010\f\u001a\u0004\b\t\u0010\nR\u0014\u0010\r\u001a\u00020\u000e8VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u000f\u0010\u0010¨\u0006\u001c"}, m3636d2 = {"Lcom/robinhood/android/investorprofile/question/FreeFormTextQuestionScreenFragment;", "Lcom/robinhood/compose/app/GenericComposeFragment;", "Lcom/robinhood/android/investorprofile/ui/questionnaire/QuestionableFragment;", "Lcom/robinhood/android/investorprofile/question/FreeFormTextQuestionCallbacks;", "<init>", "()V", "callbacks", "Lcom/robinhood/android/investorprofile/ui/questionnaire/QuestionFragmentCallbacks;", "Lcom/robinhood/android/investorprofile/ui/questionnaire/ContextualQuestionInfo;", "getCallbacks", "()Lcom/robinhood/android/investorprofile/ui/questionnaire/QuestionFragmentCallbacks;", "callbacks$delegate", "Lkotlin/properties/ReadOnlyProperty;", "question", "Lcom/robinhood/android/questionnaire/ui/UiQuestionnaireQuestion$Supported;", "getQuestion", "()Lcom/robinhood/android/questionnaire/ui/UiQuestionnaireQuestion$Supported;", "configureToolbar", "", "toolbar", "Lcom/robinhood/android/common/ui/view/RhToolbar;", "ComposeContent", "(Landroidx/compose/runtime/Composer;I)V", "onFreeFormTextQuestionAnswered", "answer", "Lcom/robinhood/android/questionnaire/ui/QuestionnaireAnswer$StringAnswer;", "Args", "Companion", "feature-investor-profile_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
@SourceDebugExtension
/* loaded from: classes10.dex */
public final class FreeFormTextQuestionScreenFragment extends GenericComposeFragment implements QuestionableFragment, FreeFormTextQuestionScreen {

    /* renamed from: callbacks$delegate, reason: from kotlin metadata */
    private final Interfaces2 callbacks = new CallbacksProperty(Reflection.getOrCreateKotlinClass(QuestionFragmentCallbacks.class), new Function1<Fragment, Object>() { // from class: com.robinhood.android.investorprofile.question.FreeFormTextQuestionScreenFragment$special$$inlined$parentFragmentCallbacks$1
    ...
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {Reflection.property1(new PropertyReference1Impl(FreeFormTextQuestionScreenFragment.class, "callbacks", "getCallbacks()Lcom/robinhood/android/investorprofile/ui/questionnaire/QuestionFragmentCallbacks;", 0))};
    ...
    public static final Unit ComposeContent$lambda$0(FreeFormTextQuestionScreenFragment freeFormTextQuestionScreenFragment, int i, Composer composer, int i2) {
        freeFormTextQuestionScreenFragment.ComposeContent(composer, RecomposeScopeImpl4.updateChangedFlags(i | 1));
    ...
    public void ComposeContent(Composer composer, final int i) {
        int i2;
        Composer composerStartRestartGroup = composer.startRestartGroup(-1431677128);
        if ((i & 6) == 0) {
        ...
        if ((i2 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1431677128, i2, -1, "com.robinhood.android.investorprofile.question.FreeFormTextQuestionScreenFragment.ComposeContent (FreeFormTextQuestionScreenFragment.kt:44)");
            }
            CompositionLocal3.CompositionLocalProvider(LocalNavigator.getLocalNavigator().provides(getNavigator()), ComposableLambda3.rememberComposableLambda(272481272, true, new Function2<Composer, Integer, Unit>() { // from class: com.robinhood.android.investorprofile.question.FreeFormTextQuestionScreenFragment.ComposeContent.1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(272481272, i3, -1, "com.robinhood.android.investorprofile.question.FreeFormTextQuestionScreenFragment.ComposeContent.<anonymous> (FreeFormTextQuestionScreenFragment.kt:46)");
                    }
                    Companion companion = FreeFormTextQuestionScreenFragment.INSTANCE;
                    UiQuestionnaireQuestion.StringQuestion question = ((Args) companion.getArgs((Fragment) FreeFormTextQuestionScreenFragment.this)).getQuestion();
                    QuestionnaireLoggingInfo loggingInfo = ((Args) companion.getArgs((Fragment) FreeFormTextQuestionScreenFragment.this)).getLoggingInfo();
                    final FreeFormTextQuestionScreenFragment freeFormTextQuestionScreenFragment = FreeFormTextQuestionScreenFragment.this;
                    InvestorProfileComponents3.InvestorProfileQuestionContainer(question, loggingInfo, ComposableLambda3.rememberComposableLambda(74841617, true, new Function2<Composer, Integer, Unit>() { // from class: com.robinhood.android.investorprofile.question.FreeFormTextQuestionScreenFragment.ComposeContent.1.1
                        @Override // kotlin.jvm.functions.Function2
                        ...
                        public final void invoke(Composer composer3, int i4) {
                            ...
                            if (ComposerKt.isTraceInProgress()) {
                                ComposerKt.traceEventStart(74841617, i4, -1, "com.robinhood.android.investorprofile.question.FreeFormTextQuestionScreenFragment.ComposeContent.<anonymous>.<anonymous> (FreeFormTextQuestionScreenFragment.kt:50)");
                            }
                            FreeFormTextQuestionScreen2.FreeFormTextQuestionScreen(((Args) FreeFormTextQuestionScreenFragment.INSTANCE.getArgs((Fragment) freeFormTextQuestionScreenFragment)).getQuestion(), WindowInsetsPadding6.windowInsetsPadding(Modifier.INSTANCE, WindowInsetsKt.m5186onlybOOhFvg(WindowInsets_androidKt.getSafeContent(WindowInsets.INSTANCE, composer3, 6), WindowInsetsSides.INSTANCE.m5198getBottomJoeWqyM())), freeFormTextQuestionScreenFragment, composer3, 0, 0);
                            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final /* data */ class Args implements Parcelable {
        ...
        public final Args copy(StringResource accountDisplayName, ContextualQuestionInfo contextualQuestionInfo, UiQuestionnaireQuestion.StringQuestion question, QuestionnaireLoggingInfo loggingInfo) {
        ...
        public Args(StringResource stringResource, ContextualQuestionInfo contextualQuestionInfo, UiQuestionnaireQuestion.StringQuestion question, QuestionnaireLoggingInfo loggingInfo) {
            Intrinsics.checkNotNullParameter(contextualQuestionInfo, "contextualQuestionInfo");
            Intrinsics.checkNotNullParameter(question, "question");
            Intrinsics.checkNotNullParameter(loggingInfo, "loggingInfo");
    ...
    /* compiled from: FreeFormTextQuestionScreenFragment.kt */
    @Metadata(m3635d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\t\b\u0002¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, m3636d2 = {"Lcom/robinhood/android/investorprofile/question/FreeFormTextQuestionScreenFragment$Companion;", "Lcom/robinhood/utils/ui/fragment/FragmentWithArgsCompanion;", "Lcom/robinhood/android/investorprofile/question/FreeFormTextQuestionScreenFragment;", "Lcom/robinhood/android/investorprofile/question/FreeFormTextQuestionScreenFragment$Args;", "<init>", "()V", "feature-investor-profile_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    public static final class Companion implements FragmentWithArgsCompanion<FreeFormTextQuestionScreenFragment, Args> {
        ...
        public Args getArgs(FreeFormTextQuestionScreenFragment freeFormTextQuestionScreenFragment) {
            return (Args) FragmentWithArgsCompanion.DefaultImpls.getArgs(this, freeFormTextQuestionScreenFragment);
        }

        @Override // com.robinhood.utils.p409ui.fragment.FragmentWithArgsCreator
        public FreeFormTextQuestionScreenFragment newInstance(Args args) {
            return (FreeFormTextQuestionScreenFragment) FragmentWithArgsCompanion.DefaultImpls.newInstance(this, args);
        }

        @Override // com.robinhood.utils.p409ui.fragment.FragmentWithArgsCompanion
        public void setArgs(FreeFormTextQuestionScreenFragment freeFormTextQuestionScreenFragment, Args args) {
            FragmentWithArgsCompanion.DefaultImpls.setArgs(this, freeFormTextQuestionScreenFragment, args);
        }
    }
}

...
/* renamed from: com.robinhood.android.creditcard.ui.creditapplication.pendingreview.ComposableSingletons$PendingReviewComposableKt, reason: use source file name */
/* loaded from: classes2.dex */
public final class PendingReviewComposable {
    public static final PendingReviewComposable INSTANCE = new PendingReviewComposable();

    /* renamed from: lambda$-613420544, reason: not valid java name */
    private static Function3<PaddingValues, Composer, Integer, Unit> f8795lambda$613420544 = ComposableLambda3.composableLambdaInstance(-613420544, false, new Function3<PaddingValues, Composer, Integer, Unit>() { // from class: com.robinhood.android.creditcard.ui.creditapplication.pendingreview.ComposableSingletons$PendingReviewComposableKt$lambda$-613420544$1
        ...
        public final void invoke(PaddingValues paddingValues, Composer composer, int i) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-613420544, i2, -1, "com.robinhood.android.creditcard.ui.creditapplication.pendingreview.ComposableSingletons$PendingReviewComposableKt.lambda$-613420544.<anonymous> (PendingReviewComposable.kt:58)");
            }
            ...
            Modifier modifierTestTag = TestTag3.testTag(companion, PendingReviewComposable3.PENDING_VIEW_TITLE_TEST_TAG);
            String strStringResource = StringResources_androidKt.stringResource(C12201R.string.credit_app_pending_review_title, composer, 0);
            ...
            BentoText2.m20747BentoText38GnDrw(StringResources_androidKt.stringResource(C12201R.string.credit_app_pending_review_subtitle, composer, 0), TestTag3.testTag(companion, PendingReviewComposable3.PENDING_VIEW_SUBTITLE_TEST_TAG), null, null, null, null, TextAlign.m7912boximpl(companion3.m7919getCentere0LSkKk()), 0, false, 0, 0, null, 0, bentoTheme.getTypography(composer, i3).getTextM(), composer, 48, 0, 8124);
            composer.endNode();
            if (ComposerKt.isTraceInProgress()) {
    ...
    /* renamed from: getLambda$-613420544$feature_credit_card_externalDebug, reason: not valid java name */
    public final Function3<PaddingValues, Composer, Integer, Unit> m12787getLambda$613420544$feature_credit_card_externalDebug() {
        return f8795lambda$613420544;
    }
}

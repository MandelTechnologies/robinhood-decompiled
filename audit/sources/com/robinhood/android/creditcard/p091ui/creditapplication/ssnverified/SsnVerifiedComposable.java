...
/* renamed from: com.robinhood.android.creditcard.ui.creditapplication.ssnverified.ComposableSingletons$SsnVerifiedComposableKt, reason: use source file name */
/* loaded from: classes2.dex */
public final class SsnVerifiedComposable {
    public static final SsnVerifiedComposable INSTANCE = new SsnVerifiedComposable();
    private static Function3<PaddingValues, Composer, Integer, Unit> lambda$65239589 = ComposableLambda3.composableLambdaInstance(65239589, false, new Function3<PaddingValues, Composer, Integer, Unit>() { // from class: com.robinhood.android.creditcard.ui.creditapplication.ssnverified.ComposableSingletons$SsnVerifiedComposableKt$lambda$65239589$1
        ...
        public final void invoke(PaddingValues paddingValues, Composer composer, int i) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(65239589, i2, -1, "com.robinhood.android.creditcard.ui.creditapplication.ssnverified.ComposableSingletons$SsnVerifiedComposableKt.lambda$65239589.<anonymous> (SsnVerifiedComposable.kt:57)");
            }
            ...
            BentoIcon4.Size40 size40 = new BentoIcon4.Size40(ServerToBentoAssetMapper2.CHECKMARK_24);
            ...
            Modifier modifierTestTag = TestTag3.testTag(companion, SsnVerifiedComposable3.SSN_VERIFIED_TITLE_TEST_TAG);
            String strStringResource = StringResources_androidKt.stringResource(C12201R.string.credit_app_ssn_verified_title, composer, 0);
            ...
            BentoText2.m20747BentoText38GnDrw(StringResources_androidKt.stringResource(C12201R.string.credit_app_ssn_verified_subtitle, composer, 0), TestTag3.testTag(companion, SsnVerifiedComposable3.SSN_VERIFIED_SUBTITLE_TEST_TAG), Color.m6701boximpl(bentoTheme.getColors(composer, i3).m21426getFg20d7_KjU()), null, null, null, TextAlign.m7912boximpl(companion3.m7919getCentere0LSkKk()), 0, false, 0, 0, null, 0, bentoTheme.getTypography(composer, i3).getTextM(), composer, 48, 0, 8120);
            composer.endNode();
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final Function3<PaddingValues, Composer, Integer, Unit> getLambda$65239589$feature_credit_card_externalDebug() {
        return lambda$65239589;
    }
}

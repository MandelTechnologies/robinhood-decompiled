...
public final class ErrorDialog extends GenericComposeDialogFragment implements RegionGated {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            int[] iArr = new int[ManageSolidGoldOfferResponse2.values().length];
            try {
                iArr[ManageSolidGoldOfferResponse2.ALREADY_CLAIMED.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[ManageSolidGoldOfferResponse2.NOT_SOLID_GOLD_ELIGIBLE.ordinal()] = 2;
    ...
    public void ComposeContent(Composer composer, final int i) {
        int i2;
        Composer composerStartRestartGroup = composer.startRestartGroup(-287758229);
        if ((i & 6) == 0) {
        ...
        if ((i2 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-287758229, i2, -1, "com.robinhood.android.creditcard.ui.creditapplication.solidGoldDelay.ErrorDialog.ComposeContent (ErrorDialog.kt:30)");
            }
            ...
            BentoTheme2.BentoTheme(Boolean.FALSE, null, Boolean.TRUE, null, null, null, null, null, ComposableLambda3.rememberComposableLambda(1927811619, true, new C125661(intRef, intRef2, current, this), composerStartRestartGroup, 54), composerStartRestartGroup, 100663686, 250);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: com.robinhood.android.creditcard.ui.creditapplication.solidGoldDelay.ErrorDialog$$ExternalSyntheticLambda0
    ...
    /* renamed from: com.robinhood.android.creditcard.ui.creditapplication.solidGoldDelay.ErrorDialog$ComposeContent$1 */
    static final class C125661 implements Function2<Composer, Integer, Unit> {
        final /* synthetic */ Ref.IntRef $body;
        final /* synthetic */ EventLogger $eventLogger;
        final /* synthetic */ Ref.IntRef $title;
        final /* synthetic */ ErrorDialog this$0;

        C125661(Ref.IntRef intRef, Ref.IntRef intRef2, EventLogger eventLogger, ErrorDialog errorDialog) {
            this.$title = intRef;
            this.$body = intRef2;
        ...
        public final void invoke(Composer composer, int i) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1927811619, i, -1, "com.robinhood.android.creditcard.ui.creditapplication.solidGoldDelay.ErrorDialog.ComposeContent.<anonymous> (ErrorDialog.kt:47)");
            }
            ...
            if (zChangedInstance || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new Function0() { // from class: com.robinhood.android.creditcard.ui.creditapplication.solidGoldDelay.ErrorDialog$ComposeContent$1$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        return ErrorDialog.C125661.invoke$lambda$1$lambda$0(eventLogger, errorDialog);
                    }
                };
            ...
            if (zChangedInstance2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue2 = new Function0() { // from class: com.robinhood.android.creditcard.ui.creditapplication.solidGoldDelay.ErrorDialog$ComposeContent$1$$ExternalSyntheticLambda1
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        return ErrorDialog.C125661.invoke$lambda$3$lambda$2(errorDialog2);
                    }
                };
    ...
    /* compiled from: ErrorDialog.kt */
    @Metadata(m3635d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0007\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u0006\u0010\b\u001a\u00020\tJ\u0016\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\tR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u000f"}, m3636d2 = {"Lcom/robinhood/android/creditcard/ui/creditapplication/solidGoldDelay/ErrorDialog$Args;", "Landroid/os/Parcelable;", "error", "Lcom/robinhood/android/models/creditcard/api/graphql/ManageSolidGoldOfferError;", "<init>", "(Lcom/robinhood/android/models/creditcard/api/graphql/ManageSolidGoldOfferError;)V", "getError", "()Lcom/robinhood/android/models/creditcard/api/graphql/ManageSolidGoldOfferError;", "describeContents", "", "writeToParcel", "", "dest", "Landroid/os/Parcel;", "flags", "feature-credit-card_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    public static final class Args implements Parcelable {
        ...
        public static final class Creator implements Parcelable.Creator<Args> {
            ...
            public final Args createFromParcel(Parcel parcel) {
                ...
                return new Args(ManageSolidGoldOfferResponse2.valueOf(parcel.readString()));
            }
        ...
        public Args(ManageSolidGoldOfferResponse2 error) {
    ...
    /* compiled from: ErrorDialog.kt */
    @Metadata(m3635d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\t\b\u0002¢\u0006\u0004\b\u0004\u0010\u0005¨\u0006\u0006"}, m3636d2 = {"Lcom/robinhood/android/creditcard/ui/creditapplication/solidGoldDelay/ErrorDialog$Companion;", "Lcom/robinhood/utils/ui/fragment/FragmentWithArgsCompanion;", "Lcom/robinhood/android/creditcard/ui/creditapplication/solidGoldDelay/ErrorDialog;", "Lcom/robinhood/android/creditcard/ui/creditapplication/solidGoldDelay/ErrorDialog$Args;", "<init>", "()V", "feature-credit-card_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)

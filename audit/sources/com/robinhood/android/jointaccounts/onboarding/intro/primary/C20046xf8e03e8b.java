...
/* renamed from: com.robinhood.android.jointaccounts.onboarding.intro.primary.ComposableSingletons$JointAccountOnboardingPrimaryUserIntroScreenKt$lambda$1428847699$1 */
/* loaded from: classes10.dex */
final class C20046xf8e03e8b implements Function2<Composer, Integer, Unit> {
    public static final C20046xf8e03e8b INSTANCE = new C20046xf8e03e8b();
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1428847699, i, -1, "com.robinhood.android.jointaccounts.onboarding.intro.primary.ComposableSingletons$JointAccountOnboardingPrimaryUserIntroScreenKt.lambda$1428847699.<anonymous> (JointAccountOnboardingPrimaryUserIntroScreen.kt:255)");
        }
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new Function0() { // from class: com.robinhood.android.jointaccounts.onboarding.intro.primary.ComposableSingletons$JointAccountOnboardingPrimaryUserIntroScreenKt$lambda$1428847699$1$$ExternalSyntheticLambda0

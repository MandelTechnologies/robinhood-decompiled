...
@DebugMetadata(m3644c = "com.robinhood.android.mcw.currencyconverter.CurrencyConverterDuxo$convertCurrency$1$2", m3645f = "CurrencyConverterDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes8.dex */
final class CurrencyConverterDuxo$convertCurrency$1$2 extends ContinuationImpl7 implements Function2<CurrencyConverterDataState, Continuation<? super CurrencyConverterDataState>, Object> {
    private /* synthetic */ Object L$0;
    int label;

    CurrencyConverterDuxo$convertCurrency$1$2(Continuation<? super CurrencyConverterDuxo$convertCurrency$1$2> continuation) {
        super(2, continuation);
    }

    @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        CurrencyConverterDuxo$convertCurrency$1$2 currencyConverterDuxo$convertCurrency$1$2 = new CurrencyConverterDuxo$convertCurrency$1$2(continuation);
        currencyConverterDuxo$convertCurrency$1$2.L$0 = obj;
        return currencyConverterDuxo$convertCurrency$1$2;
    }
    ...
    public final Object invoke(CurrencyConverterDataState currencyConverterDataState, Continuation<? super CurrencyConverterDataState> continuation) {
        return ((CurrencyConverterDuxo$convertCurrency$1$2) create(currencyConverterDataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

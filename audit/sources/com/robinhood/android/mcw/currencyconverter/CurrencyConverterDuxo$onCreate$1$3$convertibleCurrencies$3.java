...
@DebugMetadata(m3644c = "com.robinhood.android.mcw.currencyconverter.CurrencyConverterDuxo$onCreate$1$3$convertibleCurrencies$3", m3645f = "CurrencyConverterDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes8.dex */
final class CurrencyConverterDuxo$onCreate$1$3$convertibleCurrencies$3 extends ContinuationImpl7 implements Function2<CurrencyConverterDataState, Continuation<? super CurrencyConverterDataState>, Object> {
    private /* synthetic */ Object L$0;
    int label;

    CurrencyConverterDuxo$onCreate$1$3$convertibleCurrencies$3(Continuation<? super CurrencyConverterDuxo$onCreate$1$3$convertibleCurrencies$3> continuation) {
        super(2, continuation);
    }

    @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        CurrencyConverterDuxo$onCreate$1$3$convertibleCurrencies$3 currencyConverterDuxo$onCreate$1$3$convertibleCurrencies$3 = new CurrencyConverterDuxo$onCreate$1$3$convertibleCurrencies$3(continuation);
        currencyConverterDuxo$onCreate$1$3$convertibleCurrencies$3.L$0 = obj;
        return currencyConverterDuxo$onCreate$1$3$convertibleCurrencies$3;
    }
    ...
    public final Object invoke(CurrencyConverterDataState currencyConverterDataState, Continuation<? super CurrencyConverterDataState> continuation) {
        return ((CurrencyConverterDuxo$onCreate$1$3$convertibleCurrencies$3) create(currencyConverterDataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

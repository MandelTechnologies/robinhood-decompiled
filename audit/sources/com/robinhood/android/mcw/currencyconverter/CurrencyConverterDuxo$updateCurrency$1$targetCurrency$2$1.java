...
@DebugMetadata(m3644c = "com.robinhood.android.mcw.currencyconverter.CurrencyConverterDuxo$updateCurrency$1$targetCurrency$2$1", m3645f = "CurrencyConverterDuxo.kt", m3646l = {}, m3647m = "invokeSuspend")
/* loaded from: classes8.dex */
final class CurrencyConverterDuxo$updateCurrency$1$targetCurrency$2$1 extends ContinuationImpl7 implements Function2<CurrencyConverterDataState, Continuation<? super CurrencyConverterDataState>, Object> {
    private /* synthetic */ Object L$0;
    int label;

    CurrencyConverterDuxo$updateCurrency$1$targetCurrency$2$1(Continuation<? super CurrencyConverterDuxo$updateCurrency$1$targetCurrency$2$1> continuation) {
        super(2, continuation);
    }

    @Override // kotlin.coroutines.jvm.internal.ContinuationImpl2
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        CurrencyConverterDuxo$updateCurrency$1$targetCurrency$2$1 currencyConverterDuxo$updateCurrency$1$targetCurrency$2$1 = new CurrencyConverterDuxo$updateCurrency$1$targetCurrency$2$1(continuation);
        currencyConverterDuxo$updateCurrency$1$targetCurrency$2$1.L$0 = obj;
        return currencyConverterDuxo$updateCurrency$1$targetCurrency$2$1;
    }
    ...
    public final Object invoke(CurrencyConverterDataState currencyConverterDataState, Continuation<? super CurrencyConverterDataState> continuation) {
        return ((CurrencyConverterDuxo$updateCurrency$1$targetCurrency$2$1) create(currencyConverterDataState, continuation)).invokeSuspend(Unit.INSTANCE);
    }

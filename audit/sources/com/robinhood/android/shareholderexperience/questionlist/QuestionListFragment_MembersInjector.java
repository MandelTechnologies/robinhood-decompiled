...
public final class QuestionListFragment_MembersInjector implements MembersInjector<QuestionListFragment> {
    ...
    @JvmStatic
    public static final MembersInjector<QuestionListFragment> create(Provider<BaseFragmentSingletons> provider, Provider<ShareholderLogger> provider2) {
        return INSTANCE.create(provider, provider2);
    }

    @JvmStatic
    public static final void injectShareholderLogger(QuestionListFragment questionListFragment, ShareholderLogger shareholderLogger) {
        INSTANCE.injectShareholderLogger(questionListFragment, shareholderLogger);
    }

    public QuestionListFragment_MembersInjector(Provider<BaseFragmentSingletons> singletons, Provider<ShareholderLogger> shareholderLogger) {
    ...
    public void injectMembers(QuestionListFragment instance) {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final MembersInjector<QuestionListFragment> create(Provider<BaseFragmentSingletons> singletons, Provider<ShareholderLogger> shareholderLogger) {
            Intrinsics.checkNotNullParameter(singletons, "singletons");
            Intrinsics.checkNotNullParameter(shareholderLogger, "shareholderLogger");
            return new QuestionListFragment_MembersInjector(singletons, shareholderLogger);
        }

        @JvmStatic
        public final void injectShareholderLogger(QuestionListFragment instance, ShareholderLogger shareholderLogger) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(shareholderLogger, "shareholderLogger");

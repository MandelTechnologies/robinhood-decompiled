...
/* renamed from: com.robinhood.android.acatsin.ui.BaseAcatsFlowStepGenericActionHandlingFragment, reason: use source file name */
/* loaded from: classes24.dex */
public abstract class AcatsFlowStepFragment4 extends GenericActionHandlingFragment implements AcatsFlowStepFragment {
    public static final int $stable = GenericActionHandlingFragment.$stable;
    private final AcatsFlowStep2 flow;
    private final AcatsFlowStep step;

    public /* synthetic */ AcatsFlowStepFragment4(AcatsFlowStep2 acatsFlowStep2, AcatsFlowStep acatsFlowStep, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public AcatsFlowStepFragment4(AcatsFlowStep2 flow, AcatsFlowStep step) {

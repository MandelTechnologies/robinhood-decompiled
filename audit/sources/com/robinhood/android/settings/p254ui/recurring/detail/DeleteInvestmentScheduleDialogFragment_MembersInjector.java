...
public final class DeleteInvestmentScheduleDialogFragment_MembersInjector implements MembersInjector<DeleteInvestmentScheduleDialogFragment> {
    ...
    @JvmStatic
    public static final MembersInjector<DeleteInvestmentScheduleDialogFragment> create(Provider<BaseDialogSingletons> provider, Provider<AnalyticsLogger> provider2, Provider<ColorSchemeManager> provider3) {
        return INSTANCE.create(provider, provider2, provider3);
    }

    @JvmStatic
    public static final void injectColorSchemeManager(DeleteInvestmentScheduleDialogFragment deleteInvestmentScheduleDialogFragment, ColorSchemeManager colorSchemeManager) {
        INSTANCE.injectColorSchemeManager(deleteInvestmentScheduleDialogFragment, colorSchemeManager);
    }

    public DeleteInvestmentScheduleDialogFragment_MembersInjector(Provider<BaseDialogSingletons> singletons, Provider<AnalyticsLogger> analytics, Provider<ColorSchemeManager> colorSchemeManager) {
    ...
    public void injectMembers(DeleteInvestmentScheduleDialogFragment instance) {
    ...
    /* compiled from: DeleteInvestmentScheduleDialogFragment_MembersInjector.kt */
    @Metadata(m3635d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J8\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u00052\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\b2\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u000b0\b2\f\u0010\f\u001a\b\u0012\u0004\u0012\u00020\r0\bH\u0007J\u0018\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u00062\u0006\u0010\f\u001a\u00020\rH\u0007¨\u0006\u0011"}, m3636d2 = {"Lcom/robinhood/android/settings/ui/recurring/detail/DeleteInvestmentScheduleDialogFragment_MembersInjector$Companion;", "", "<init>", "()V", AnalyticsStrings.BUTTON_NEW_LIST_CREATE, "Ldagger/MembersInjector;", "Lcom/robinhood/android/settings/ui/recurring/detail/DeleteInvestmentScheduleDialogFragment;", "singletons", "Ljavax/inject/Provider;", "Lcom/robinhood/android/common/ui/di/BaseDialogSingletons;", "analytics", "Lcom/robinhood/analytics/AnalyticsLogger;", "colorSchemeManager", "Lcom/robinhood/android/designsystem/colorscheme/ColorSchemeManager;", "injectColorSchemeManager", "", "instance", "feature-recurring-settings_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    public static final class Companion {
        ...
        @JvmStatic
        public final MembersInjector<DeleteInvestmentScheduleDialogFragment> create(Provider<BaseDialogSingletons> singletons, Provider<AnalyticsLogger> analytics, Provider<ColorSchemeManager> colorSchemeManager) {
            Intrinsics.checkNotNullParameter(singletons, "singletons");
            Intrinsics.checkNotNullParameter(analytics, "analytics");
            Intrinsics.checkNotNullParameter(colorSchemeManager, "colorSchemeManager");
            return new DeleteInvestmentScheduleDialogFragment_MembersInjector(singletons, analytics, colorSchemeManager);
        }

        @JvmStatic
        public final void injectColorSchemeManager(DeleteInvestmentScheduleDialogFragment instance, ColorSchemeManager colorSchemeManager) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(colorSchemeManager, "colorSchemeManager");

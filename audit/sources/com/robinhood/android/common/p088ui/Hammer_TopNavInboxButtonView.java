...
public abstract class Hammer_TopNavInboxButtonView extends TopNavButtonView implements ViewComponentManagerHolder {
    ...
    private Hammer_TopNavInboxButtonView(Context context, AttributeSet attributeSet) {
        ...
        Hammer_TopNavInboxButtonView2 hammer_TopNavInboxButtonView2 = (Hammer_TopNavInboxButtonView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.common.ui.TopNavInboxButtonView");
        hammer_TopNavInboxButtonView2.inject((TopNavInboxButtonView) this);
        this.injected = true;
    }
}

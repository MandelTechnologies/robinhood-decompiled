...
public abstract class Hammer_IndexRowView extends BaseInstrumentRowView implements ViewComponentManagerHolder {
    ...
    private Hammer_IndexRowView(Context context, AttributeSet attributeSet) {
        ...
        Hammer_IndexRowView2 hammer_IndexRowView2 = (Hammer_IndexRowView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.common.views.index.IndexRowView");
        hammer_IndexRowView2.inject((IndexRowView) this);
        this.injected = true;
    }
}

...
public abstract class CryptoRecurringOrderCheck implements Validator.Check<RecurringOrderContext, RecurringOrderValidationFailureResolver> {
    ...
    public final Validator.Failure<RecurringOrderContext, RecurringOrderValidationFailureResolver> check(RecurringOrderContext input) {
        ...
        if (investmentTargetData instanceof RecurringOrderViewState.InvestmentTargetData.Crypto) {
            return check(input, (RecurringOrderViewState.InvestmentTargetData.Crypto) investmentTargetData);
        }

...
public final class UpdateUsernameFragment_MembersInjector implements MembersInjector<UpdateUsernameFragment> {
    ...
    @JvmStatic
    public static final MembersInjector<UpdateUsernameFragment> create(Provider<BaseFragmentSingletons> provider, Provider<GenericComposeSingletons> provider2, Provider<BooleanPreference> provider3) {
        return INSTANCE.create(provider, provider2, provider3);
    }

    @HasPromptedUsernameUpdatePref
    @JvmStatic
    public static final void injectHasPromptedUsernameUpdatePref(UpdateUsernameFragment updateUsernameFragment, BooleanPreference booleanPreference) {
        INSTANCE.injectHasPromptedUsernameUpdatePref(updateUsernameFragment, booleanPreference);
    }

    public UpdateUsernameFragment_MembersInjector(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<BooleanPreference> hasPromptedUsernameUpdatePref) {
    ...
    public void injectMembers(UpdateUsernameFragment instance) {
        ...
        companion3.injectHasPromptedUsernameUpdatePref(instance, booleanPreference);
    }

    /* compiled from: UpdateUsernameFragment_MembersInjector.kt */
    @Metadata(m3635d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J8\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u00052\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\b2\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u000b0\b2\f\u0010\f\u001a\b\u0012\u0004\u0012\u00020\r0\bH\u0007J\u0018\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u00062\u0006\u0010\f\u001a\u00020\rH\u0007¨\u0006\u0011"}, m3636d2 = {"Lcom/robinhood/android/matcha/ui/username/UpdateUsernameFragment_MembersInjector$Companion;", "", "<init>", "()V", AnalyticsStrings.BUTTON_NEW_LIST_CREATE, "Ldagger/MembersInjector;", "Lcom/robinhood/android/matcha/ui/username/UpdateUsernameFragment;", "singletons", "Ljavax/inject/Provider;", "Lcom/robinhood/android/common/ui/di/BaseFragmentSingletons;", "genericComposeSingletons", "Lcom/robinhood/compose/app/GenericComposeSingletons;", "hasPromptedUsernameUpdatePref", "Lcom/robinhood/prefs/BooleanPreference;", "injectHasPromptedUsernameUpdatePref", "", "instance", "feature-p2p_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
    public static final class Companion {
        ...
        @JvmStatic
        public final MembersInjector<UpdateUsernameFragment> create(Provider<BaseFragmentSingletons> singletons, Provider<GenericComposeSingletons> genericComposeSingletons, Provider<BooleanPreference> hasPromptedUsernameUpdatePref) {
            Intrinsics.checkNotNullParameter(singletons, "singletons");
            Intrinsics.checkNotNullParameter(genericComposeSingletons, "genericComposeSingletons");
            Intrinsics.checkNotNullParameter(hasPromptedUsernameUpdatePref, "hasPromptedUsernameUpdatePref");
            return new UpdateUsernameFragment_MembersInjector(singletons, genericComposeSingletons, hasPromptedUsernameUpdatePref);
        }

        @HasPromptedUsernameUpdatePref
        @JvmStatic
        public final void injectHasPromptedUsernameUpdatePref(UpdateUsernameFragment instance, BooleanPreference hasPromptedUsernameUpdatePref) {
            Intrinsics.checkNotNullParameter(instance, "instance");
            Intrinsics.checkNotNullParameter(hasPromptedUsernameUpdatePref, "hasPromptedUsernameUpdatePref");

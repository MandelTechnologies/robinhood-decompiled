...
/* renamed from: com.robinhood.android.equities.tradesettings.equity.tif.ComposableSingletons$EquityTimeInForceBottomSheetKt$lambda$-121544110$1, reason: use source file name */
/* loaded from: classes3.dex */
final class EquityTimeInForceBottomSheet3 implements Function2<Composer, Integer, Unit> {
    public static final EquityTimeInForceBottomSheet3 INSTANCE = new EquityTimeInForceBottomSheet3();

    EquityTimeInForceBottomSheet3() {
    }
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-121544110, i, -1, "com.robinhood.android.equities.tradesettings.equity.tif.ComposableSingletons$EquityTimeInForceBottomSheetKt.lambda$-121544110.<anonymous> (EquityTimeInForceBottomSheet.kt:252)");
        }
        ...
        EquityTimeInForceViewState.Loaded loaded = new EquityTimeInForceViewState.Loaded(orderTimeInForce, extensions2.persistentListOf(selectionRowState, new SelectionRowState(orderTimeInForce2, companion.invoke("Sep 7, 2025"), companion.invoke("Good til canceled (up to 90 days)"), false, 8, null)), true, orderTimeInForce, extensions2.persistentListOf(new SelectionRowState(orderTimeInForce, companion.invoke("5 PM today"), companion.invoke("Good til 24-hour session close"), false, 8, null), new SelectionRowState(orderTimeInForce2, companion.invoke("Sep 7, 2025"), companion.invoke("Good til canceled (up to 90 days)"), false, 8, null)));
        TradeSettingsStore4 tradeSettingsStore4 = TradeSettingsStore4.MAC;
        composer.startReplaceGroup(1849434622);
        Object objRememberedValue = composer.rememberedValue();
        Composer.Companion companion2 = Composer.INSTANCE;
        if (objRememberedValue == companion2.getEmpty()) {
            objRememberedValue = new Function3() { // from class: com.robinhood.android.equities.tradesettings.equity.tif.ComposableSingletons$EquityTimeInForceBottomSheetKt$lambda$-121544110$1$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function3
                public final Object invoke(Object obj, Object obj2, Object obj3) {
                    return EquityTimeInForceBottomSheet3.invoke$lambda$1$lambda$0((TradeSettingsStore4) obj, (TradeSettingsStore3) obj2, (OrderTimeInForce) obj3);
                }
            };
        ...
        if (objRememberedValue2 == companion2.getEmpty()) {
            objRememberedValue2 = new Function0() { // from class: com.robinhood.android.equities.tradesettings.equity.tif.ComposableSingletons$EquityTimeInForceBottomSheetKt$lambda$-121544110$1$$ExternalSyntheticLambda1

...
public abstract class Hammer_ShortInterestSectionView extends LoggableSdpComposeView implements ViewComponentManagerHolder {
    ...
    private Hammer_ShortInterestSectionView(ViewModelStoreOwner viewModelStoreOwner, Context context, AttributeSet attributeSet) {
        ...
        Hammer_ShortInterestSectionView2 hammer_ShortInterestSectionView2 = (Hammer_ShortInterestSectionView2) viewComponentManager.get();
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type com.robinhood.android.equities.shortinterest.ui.ShortInterestSectionView");
        hammer_ShortInterestSectionView2.inject((ShortInterestSectionView) this);
        this.injected = true;
    }
}

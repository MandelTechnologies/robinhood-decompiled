...
final class EquityEventUpdatesScreenKt$EquityEventUpdatesScreen$4$1$1$6 implements Function3<LazyItemScope, Composer, Integer, Unit> {
    final /* synthetic */ LazyPagingItems<EquityEventUpdateDto> $pagingItems;

    EquityEventUpdatesScreenKt$EquityEventUpdatesScreen$4$1$1$6(LazyPagingItems<EquityEventUpdateDto> lazyPagingItems) {
    ...
    public final void invoke(LazyItemScope item, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(504935163, i, -1, "com.robinhood.android.equities.eventupdates.EquityEventUpdatesScreen.<anonymous>.<anonymous>.<anonymous>.<anonymous> (EquityEventUpdatesScreen.kt:250)");
        }
        ...
        BentoText2.m20747BentoText38GnDrw(StringResources_androidKt.stringResource(C14719R.string.equity_event_updates_load_more_error, composer, 0), null, null, null, null, null, null, 0, false, 0, 0, null, 0, null, composer, 0, 0, 16382);
        ...
        if (zChangedInstance || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new Function0() { // from class: com.robinhood.android.equities.eventupdates.EquityEventUpdatesScreenKt$EquityEventUpdatesScreen$4$1$1$6$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return EquityEventUpdatesScreenKt$EquityEventUpdatesScreen$4$1$1$6.invoke$lambda$2$lambda$1$lambda$0(lazyPagingItems);
                }
            };

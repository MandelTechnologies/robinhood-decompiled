...
/* renamed from: com.robinhood.android.equities.companyfinancials.ui.CompanyFinancialsSectionKt$CompanyFinancialsSection$3$4$1$1, reason: use source file name */
/* loaded from: classes3.dex */
final class CompanyFinancialsSection6 implements Function1<ScrubState, Unit> {
    ...
    CompanyFinancialsSection6(UserInteractionEventDescriptor userInteractionEventDescriptor, EventLogger eventLogger, SnapshotState<ScrubState> snapshotState, SnapshotState<Boolean> snapshotState2) {
    ...
    public final void invoke2(ScrubState scrubState) {
        ...
        if (scrubState == null) {
            if (!CompanyFinancialsSection.CompanyFinancialsSection$lambda$27$lambda$25$lambda$22(this.$ignoreFirstNull$delegate)) {
                Component component = new Component(Component.ComponentType.COMPANY_FINANCIALS_CHART, null, null, 6, null);
            ...
            CompanyFinancialsSection.CompanyFinancialsSection$lambda$27$lambda$25$lambda$23(this.$ignoreFirstNull$delegate, false);
        }
    }
}

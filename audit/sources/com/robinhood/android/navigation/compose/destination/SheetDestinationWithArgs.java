...
public class SheetDestinationWithArgs<T extends Parcelable> implements BaseComposableDestination {
    ...
    public static final class Creator implements Parcelable.Creator<SheetDestinationWithArgs<?>> {
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final SheetDestinationWithArgs<?> createFromParcel(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "parcel");
            return new SheetDestinationWithArgs<>(parcel.readString(), (Class) parcel.readSerializable());
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final SheetDestinationWithArgs<?>[] newArray(int i) {
            return new SheetDestinationWithArgs[i];
        }
    }
    ...
    public SheetDestinationWithArgs(String routeScreenName, Class<T> argumentClass) {
        ...
        this.parcelableNavType = LazyKt.lazy(new Function0() { // from class: com.robinhood.android.navigation.compose.destination.SheetDestinationWithArgs$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return SheetDestinationWithArgs.parcelableNavType_delegate$lambda$0(this.f$0);
            }
        });
    ...
    public static final ParcelableNavType parcelableNavType_delegate$lambda$0(SheetDestinationWithArgs sheetDestinationWithArgs) {
        return new ParcelableNavType(sheetDestinationWithArgs.argumentClass);
    }
    ...
    public List<NamedNavArgument> getArgumentList() {
        return CollectionsKt.listOf(NamedNavArgument2.navArgument("rh_navigation_args", new Function1() { // from class: com.robinhood.android.navigation.compose.destination.SheetDestinationWithArgs$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return SheetDestinationWithArgs._get_argumentList_$lambda$1(this.f$0, (NavDestinationBuilder2) obj);
            }
        }));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit _get_argumentList_$lambda$1(SheetDestinationWithArgs sheetDestinationWithArgs, NavDestinationBuilder2 navArgument) {
        Intrinsics.checkNotNullParameter(navArgument, "$this$navArgument");
        navArgument.setType(sheetDestinationWithArgs.getParcelableNavType());
    ...
    public final ComposeNav.SheetDestWithArgs composeNav(T args) {
        Intrinsics.checkNotNullParameter(args, "args");
        return new ComposeNav.SheetDestWithArgs(this, args);
    }
}

...
public final class IndexDetailPageHistoryStateProvider implements StateProvider<IndexDetailPageHistoryDataState, DetailPageHistoryViewState> {
    public static final int $stable = 8;
    private final Resources resources;

    public IndexDetailPageHistoryStateProvider(Resources resources) {
        Intrinsics.checkNotNullParameter(resources, "resources");
        this.resources = resources;
    }

    @Override // com.robinhood.android.udf.StateProvider
    public DetailPageHistoryViewState reduce(IndexDetailPageHistoryDataState dataState) throws Resources.NotFoundException {
        ...
        String string2 = this.resources.getString(C11117R.string.detail_page_history_section_title);
        Intrinsics.checkNotNullExpressionValue(string2, "getString(...)");
        return IndexDetailPageHistoryStateProvider2.getDetailPageHistoryViewState(currentAccount, indexId, historyEvents, string2, IndexDetailPageStates2.IDP_HISTORY_DUXO_KEY_PREFIX);
    }
}

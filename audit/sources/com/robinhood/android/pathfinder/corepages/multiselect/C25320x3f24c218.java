...
/* renamed from: com.robinhood.android.pathfinder.corepages.multiselect.MultiSelectComposableKt$Options$lambda$9$lambda$8$$inlined$itemsIndexed$default$1 */
/* loaded from: classes11.dex */
public final class C25320x3f24c218 extends Lambda implements Function1<Integer, Object> {
    final /* synthetic */ List $items;
    final /* synthetic */ Function2 $key;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C25320x3f24c218(Function2 function2, List list) {
        super(1);
        this.$key = function2;
        this.$items = list;
    }

...
/* renamed from: com.robinhood.rhc.referral.ui.RewardCardComposableKt$RewardCardComposable$1$1$5$1, reason: use source file name */
/* loaded from: classes26.dex */
final class RewardCardComposable6 implements Function1<ConstrainScope, Unit> {
    final /* synthetic */ ConstraintLayoutBaseScope.VerticalAnchor $contentGuideline;

    RewardCardComposable6(ConstraintLayoutBaseScope.VerticalAnchor verticalAnchor) {
    ...
    public final void invoke2(ConstrainScope constrainAs) {
        ...
        ConstraintScopeCommon6.m8185linkToVpY3zN4$default(constrainAs.getStart(), this.$contentGuideline, 0.0f, 0.0f, 6, null);

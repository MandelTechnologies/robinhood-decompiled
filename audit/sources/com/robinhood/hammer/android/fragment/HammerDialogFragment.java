...
public class HammerDialogFragment extends DialogFragment implements FragmentComponentManagerHolder {
    ...
    public static final FragmentComponentManager componentManager_delegate$lambda$0(HammerDialogFragment hammerDialogFragment) {
        return new FragmentComponentManager(hammerDialogFragment);
    }
    ...
    private final void inject() {
        ...
        ((HammerDialogFragment2) getComponentManager().get()).getFragmentInjector().inject(this);
        this.injected = true;
    }
}

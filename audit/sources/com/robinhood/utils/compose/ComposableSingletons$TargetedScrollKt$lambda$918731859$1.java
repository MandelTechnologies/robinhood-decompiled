...
/* renamed from: com.robinhood.utils.compose.ComposableSingletons$TargetedScrollKt$lambda$-918731859$1, reason: invalid class name */
/* loaded from: classes12.dex */
final class ComposableSingletons$TargetedScrollKt$lambda$918731859$1 implements Function3<TargetedScrollColumnScope<Integer>, Composer, Integer, Unit> {
    public static final ComposableSingletons$TargetedScrollKt$lambda$918731859$1 INSTANCE = new ComposableSingletons$TargetedScrollKt$lambda$918731859$1();

    ComposableSingletons$TargetedScrollKt$lambda$918731859$1() {
    }
    ...
    public final void invoke(final TargetedScrollColumnScope<Integer> TargetedScrollColumn, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-918731859, i2, -1, "com.robinhood.utils.compose.ComposableSingletons$TargetedScrollKt.lambda$-918731859.<anonymous> (TargetedScroll.kt:340)");
        }
        final int i3 = 1;
        while (i3 < 26) {
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new Function0() { // from class: com.robinhood.utils.compose.ComposableSingletons$TargetedScrollKt$lambda$-918731859$1$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        return ComposableSingletons$TargetedScrollKt$lambda$918731859$1.invoke$lambda$1$lambda$0(TargetedScrollColumn, i3);
                    }
                };
    ...
    public static final Unit invoke$lambda$1$lambda$0(TargetedScrollColumnScope targetedScrollColumnScope, int i) {
        targetedScrollColumnScope.scrollTo(Integer.valueOf(i));
        return Unit.INSTANCE;
    }
}

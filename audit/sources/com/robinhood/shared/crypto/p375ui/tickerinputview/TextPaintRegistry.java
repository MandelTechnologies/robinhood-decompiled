...
public final class TextPaintRegistry {
    ...
    public TextPaintRegistry(TextPaint defaultTextPaint, Set<Character> currencySymbolSet) {
        ...
        this.map.put(Character.valueOf(CryptoTickerInputView.INSTANCE.getPERCENT_SYMBOL()), textPaint);
    }
    ...
    public final void updateTextSize(float textSize) {
        ...
        TextPaint textPaint2 = this.map.get(Character.valueOf(CryptoTickerInputView.INSTANCE.getPERCENT_SYMBOL()));
        if (textPaint2 != null) {

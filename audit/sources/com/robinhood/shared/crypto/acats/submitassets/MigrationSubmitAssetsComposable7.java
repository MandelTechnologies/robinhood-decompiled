...
/* renamed from: com.robinhood.shared.crypto.acats.submitassets.MigrationSubmitAssetsComposableKt$MigrationSubmitAssetsComposable$1$1$2$1$1$2$1, reason: use source file name */
/* loaded from: classes6.dex */
final class MigrationSubmitAssetsComposable7 implements Function3<LazyItemScope, Composer, Integer, Unit> {
    ...
    MigrationSubmitAssetsComposable7(BentoBaseRowState bentoBaseRowState, LifecycleAwareNavigator lifecycleAwareNavigator, ImmutableList<AssetRowText> immutableList) {
    ...
    public final void invoke(LazyItemScope item, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(542136813, i, -1, "com.robinhood.shared.crypto.acats.submitassets.MigrationSubmitAssetsComposable.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous>.<anonymous> (MigrationSubmitAssetsComposable.kt:152)");
        }
        ...
        composer.startReplaceGroup(1302444190);
        if (this.$cryptoRow.getMeta() instanceof BentoBaseRowState.Meta.SingleLineAndIcon) {
            ...
            if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new Function0() { // from class: com.robinhood.shared.crypto.acats.submitassets.MigrationSubmitAssetsComposableKt$MigrationSubmitAssetsComposable$1$1$2$1$1$2$1$$ExternalSyntheticLambda0
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        return MigrationSubmitAssetsComposable7.invoke$lambda$1$lambda$0(lifecycleAwareNavigator, immutableList);
                    }
                };
    ...
    public static final Unit invoke$lambda$1$lambda$0(LifecycleAwareNavigator lifecycleAwareNavigator, ImmutableList immutableList) throws Resources.NotFoundException {
        ...
        AssetListType assetListType = AssetListType.TRANSFERABLE_CRYPTO;

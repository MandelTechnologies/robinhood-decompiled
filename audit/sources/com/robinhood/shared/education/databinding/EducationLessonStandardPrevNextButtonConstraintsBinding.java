...
public final class EducationLessonStandardPrevNextButtonConstraintsBinding implements ViewBinding {
    ...
    private EducationLessonStandardPrevNextButtonConstraintsBinding(ConstraintLayout constraintLayout, RdsIconButton rdsIconButton, ConstraintLayout constraintLayout2, EducationLessonStandardFooterCtaView educationLessonStandardFooterCtaView, RdsIconButton rdsIconButton2) {
    ...
    public static EducationLessonStandardPrevNextButtonConstraintsBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static EducationLessonStandardPrevNextButtonConstraintsBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(C38790R.layout.education_lesson_standard_prev_next_button_constraints, viewGroup, false);
        if (z) {
    ...
    public static EducationLessonStandardPrevNextButtonConstraintsBinding bind(View view) {
        ...
        if (rdsIconButton != null) {
            ...
            if (educationLessonStandardFooterCtaView != null) {
                ...
                if (rdsIconButton2 != null) {
                    return new EducationLessonStandardPrevNextButtonConstraintsBinding(constraintLayout, rdsIconButton, constraintLayout, educationLessonStandardFooterCtaView, rdsIconButton2);
                }
            }
        }

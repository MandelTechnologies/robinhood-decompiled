...
/* compiled from: EducationQuizAnswerButton.kt */
@Metadata(m3635d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0006\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\b\u0007\u0018\u00002\u00020\u0001B\u001b\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\n\b\u0002\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\u0004\b\u0006\u0010\u0007J\u0016\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\tJ\u0010\u0010\u0014\u001a\u00020\u00102\u0006\u0010\u0015\u001a\u00020\u0016H\u0002R$\u0010\n\u001a\u00020\t2\u0006\u0010\b\u001a\u00020\t@FX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000b\u0010\f\"\u0004\b\r\u0010\u000e¨\u0006\u0017"}, m3636d2 = {"Lcom/robinhood/shared/education/ui/quiz/EducationQuizAnswerButton;", "Lcom/robinhood/android/designsystem/button/RdsButton;", "context", "Landroid/content/Context;", "attrs", "Landroid/util/AttributeSet;", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "value", "", "excludeFromAutomaticAppearLogging", "getExcludeFromAutomaticAppearLogging", "()Z", "setExcludeFromAutomaticAppearLogging", "(Z)V", "bind", "", "state", "Lcom/robinhood/shared/education/ui/quiz/QuizAnswerViewState;", "shouldColorButtons", "bindEventData", "answer", "Lcom/robinhood/shared/models/db/bonfire/education/lesson/EducationQuizAnswer;", "feature-education_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
...
public final class EducationQuizAnswerButton extends RdsButton {
    ...
    public final void bind(QuizAnswerViewState state, boolean shouldColorButtons) {
        ...
        if (state.isSelected()) {
            ScarletManager2.overrideStyle$default(this, new ThemedResourceReference(ResourceType.STYLE.INSTANCE, C20690R.attr.primaryButtonStyle), false, 2, null);
            setStrokeWidth(0);
            if (shouldColorButtons) {
                Context context = getContext();
                Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
                themeColor = EducationQuizAnswers.getFeedbackColor(answer, context);
            } else {
                Context context2 = getContext();
                Intrinsics.checkNotNullExpressionValue(context2, "getContext(...)");
                themeColor = ThemeColors.getThemeColor(context2, C20690R.attr.colorPrimary);
            }
            setBackgroundColor(themeColor);
            int i = WhenMappings.$EnumSwitchMapping$0[answer.getCorrectness().ordinal()];
            if (i == 1) {
                drawable = com.robinhood.utils.extensions.ViewsKt.getDrawable(this, C20690R.drawable.ic_rds_checkmark_16dp);
            } else if (i == 2) {
                drawable = com.robinhood.utils.extensions.ViewsKt.getDrawable(this, C20690R.drawable.ic_rds_exclamation_16dp);
            } else if (i != 3) {
            ...
            int themeColor2 = ThemeColors.getThemeColor(context3, C20690R.attr.colorBackground1);
            ScarletManager2.overrideAttribute(this, R.attr.textColor, new ThemedResourceReference(ResourceType.COLOR_STATE_LIST.INSTANCE, C20690R.attr.colorBackground1));
            Drawable icon = getIcon();
            if (icon != null) {
                icon.setColorFilter(new PorterDuffColorFilter(themeColor2, PorterDuff.Mode.SRC_IN));
            }
        } else {
            ScarletManager2.overrideStyle$default(this, new ThemedResourceReference(ResourceType.STYLE.INSTANCE, C20690R.attr.secondaryButtonStyle), false, 2, null);
            setBackgroundColor(com.robinhood.utils.extensions.ViewsKt.getColor(this, C20690R.color.transparent));
            ScarletManager2.overrideAttribute(this, R.attr.textColor, new ThemedResourceReference(ResourceType.COLOR_STATE_LIST.INSTANCE, R.attr.textColorPrimary));
            setIcon(null);
        }
    ...
    private final void bindEventData(final EducationQuizAnswer answer) {
        ViewsKt.eventData$default(this, false, new Function0() { // from class: com.robinhood.shared.education.ui.quiz.EducationQuizAnswerButton$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return EducationQuizAnswerButton.bindEventData$lambda$0(answer);
            }
        }, 1, null);
    }
    ...
    public static final UserInteractionEventDescriptor bindEventData$lambda$0(EducationQuizAnswer educationQuizAnswer) {

...
/* renamed from: com.robinhood.shared.education.ui.home.EducationHomeFragmentKt$HomeContent$2$invoke$lambda$2$lambda$1$$inlined$itemsIndexed$default$1 */
/* loaded from: classes6.dex */
public final class C38833x1ee3bbab extends Lambda implements Function1<Integer, Object> {
    final /* synthetic */ List $items;
    final /* synthetic */ Function2 $key;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C38833x1ee3bbab(Function2 function2, List list) {
        super(1);
        this.$key = function2;
        this.$items = list;
    }

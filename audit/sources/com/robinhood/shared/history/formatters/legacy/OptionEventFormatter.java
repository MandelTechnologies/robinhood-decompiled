...
public final class OptionEventFormatter extends AbstractMinervaTransactionFormatter<OptionEventTransaction> {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            try {
                iArr[OptionEvent.State.VOIDED.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                iArr[OptionEvent.State.CANCELED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                iArr[OptionEvent.State.REVERSED.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                iArr[OptionEvent.State.PREPARING.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                iArr[OptionEvent.State.DELETED.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                iArr[OptionEvent.State.PENDING.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                iArr[OptionEvent.State.QUEUED.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                iArr[OptionEvent.State.CONFIRMED.ordinal()] = 8;
    ...
    public /* bridge */ /* synthetic */ List mo25632getLineItems(MinervaTransaction minervaTransaction) {
        return (List) getLineItems((OptionEventTransaction) minervaTransaction);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OptionEventFormatter(Resources resources) {
        super(resources);
    ...
    public TransactionSummary.Badge getSummaryBadge(OptionEventTransaction transaction) {
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[transaction.getEvent().getOptionEvent().getState().ordinal()]) {
            ...
            case 2:
            case 3:
                return new TransactionSummary.Badge(getString(C23386R.string.option_event_state_voided), TransactionSummary.Tint.NEGATIVE, false, 4, null);
            case 4:
            case 5:
            case 8:
                return null;
    ...
    public CharSequence getPrimaryText(OptionEventTransaction transaction) {
        Intrinsics.checkNotNullParameter(transaction, "transaction");
        return UiOptionEvents.getHistoryRowTitle(transaction.getEvent(), getResources());
    }

    public Void getLineItems(OptionEventTransaction transaction) {
        Intrinsics.checkNotNullParameter(transaction, "transaction");

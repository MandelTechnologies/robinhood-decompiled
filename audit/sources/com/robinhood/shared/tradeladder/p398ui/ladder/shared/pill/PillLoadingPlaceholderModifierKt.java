...
public final class PillLoadingPlaceholderModifierKt {
    ...
    public static final Modifier m26167pillLoadingPlaceholderknsiBA(Modifier pillLoadingPlaceholder, Shape shape, long j, Brush borderBrush, boolean z, float f, float f2, int i) {
        ...
        return !z ? pillLoadingPlaceholder : m26165pillLoadingPlaceholderdDIYWSk(pillLoadingPlaceholder, shape, j, borderBrush, f, f2, i);
    }

    /* renamed from: pillLoadingPlaceholder-dDIYWSk$default, reason: not valid java name */
    public static /* synthetic */ Modifier m26166pillLoadingPlaceholderdDIYWSk$default(Modifier modifier, Shape shape, long j, Brush brush, float f, float f2, int i, int i2, Object obj) {
        if ((i2 & 8) != 0) {
            f = 1.0f;
        }
        float f3 = f;
        ...
        return m26165pillLoadingPlaceholderdDIYWSk(modifier, shape, j, brush, f3, f2, (i2 & 32) != 0 ? 500 : i);
    }

    /* renamed from: pillLoadingPlaceholder-dDIYWSk, reason: not valid java name */
    public static final Modifier m26165pillLoadingPlaceholderdDIYWSk(Modifier pillLoadingPlaceholder, final Shape shape, long j, Brush borderBrush, float f, float f2, int i) {
        Intrinsics.checkNotNullParameter(pillLoadingPlaceholder, "$this$pillLoadingPlaceholder");
        Intrinsics.checkNotNullParameter(shape, "shape");
        Intrinsics.checkNotNullParameter(borderBrush, "borderBrush");
        return ComposedModifier2.composed$default(Background3.m4871backgroundbw27NRU(GraphicsLayerModifier6.graphicsLayer(pillLoadingPlaceholder, new Function1() { // from class: com.robinhood.shared.tradeladder.ui.ladder.shared.pill.PillLoadingPlaceholderModifierKt$$ExternalSyntheticLambda1
    ...
    public static final Brush m26164dotRadialGradientqcb84PM(long j, long j2, float f) {
    ...
    private static final void PreviewLoadingShape(Composer composer, final int i) {
        Composer composerStartRestartGroup = composer.startRestartGroup(-1396008210);
        if (i != 0 || !composerStartRestartGroup.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1396008210, i, -1, "com.robinhood.shared.tradeladder.ui.ladder.shared.pill.PreviewLoadingShape (PillLoadingPlaceholderModifier.kt:168)");
            }
            PreviewLadderBentoTheme2.PreviewLadderBentoTheme(true, ComposableSingletons$PillLoadingPlaceholderModifierKt.INSTANCE.getLambda$838299183$lib_trade_ladder_externalDebug(), composerStartRestartGroup, 54, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: com.robinhood.shared.tradeladder.ui.ladder.shared.pill.PillLoadingPlaceholderModifierKt$$ExternalSyntheticLambda0

...
/* renamed from: com.robinhood.shared.tradeladder.ui.ladder.shared.pill.ComposableSingletons$AnimatedPendingOrderPillStackKt$lambda$-1342898602$1 */
/* loaded from: classes12.dex */
final class C41029xe6ae6973 implements Function2<Composer, Integer, Unit> {
    public static final C41029xe6ae6973 INSTANCE = new C41029xe6ae6973();
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1342898602, i, -1, "com.robinhood.shared.tradeladder.ui.ladder.shared.pill.ComposableSingletons$AnimatedPendingOrderPillStackKt.lambda$-1342898602.<anonymous> (AnimatedPendingOrderPillStack.kt:901)");
        }
        ...
        if (objRememberedValue == companion.getEmpty()) {
            objRememberedValue = SnapshotStateKt.derivedStateOf(new Function0() { // from class: com.robinhood.shared.tradeladder.ui.ladder.shared.pill.ComposableSingletons$AnimatedPendingOrderPillStackKt$lambda$-1342898602$1$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return C41029xe6ae6973.invoke$lambda$1$lambda$0(side);
                }
            });
        ...
        if (objRememberedValue4 == companion.getEmpty()) {
            objRememberedValue4 = new Function0() { // from class: com.robinhood.shared.tradeladder.ui.ladder.shared.pill.ComposableSingletons$AnimatedPendingOrderPillStackKt$lambda$-1342898602$1$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return C41029xe6ae6973.invoke$lambda$12$lambda$11$lambda$10$lambda$9(snapshotState2, snapshotState4, snapshotState);
                }
            };
    ...
    public static final LadderState.LadderData.PendingOrderRow.Group invoke$lambda$1$lambda$0(Side side) {
        ...
        LadderState.LadderData.UiPendingOrder uiPendingOrder = new LadderState.LadderData.UiPendingOrder(uuidRandomUUID, 0, side, companion.invoke("+" + AnimatedPendingOrderPillStackKt.previewTestQuantities.get(0) + " LMT"), false, false, PillStyle.PillVisualState.OUTLINED);
        UUID uuidRandomUUID2 = UUID.randomUUID();
        Intrinsics.checkNotNullExpressionValue(uuidRandomUUID2, "randomUUID(...)");
        return new LadderState.LadderData.PendingOrderRow.Group(extensions2.persistentListOf(uiPendingOrder, new LadderState.LadderData.UiPendingOrder(uuidRandomUUID2, 0, side, companion.invoke("+" + AnimatedPendingOrderPillStackKt.previewTestQuantities.get(1) + " LMT"), false, false, PillStyle.PillVisualState.ACTIVE)), companion.invoke("+" + CollectionsKt.sumOfInt(AnimatedPendingOrderPillStackKt.previewTestQuantities) + " LMT"), companion.invoke(""));
    }

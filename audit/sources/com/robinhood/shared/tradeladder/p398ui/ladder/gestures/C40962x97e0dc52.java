...
@DebugMetadata(m3644c = "com.robinhood.shared.tradeladder.ui.ladder.gestures.LadderGestureAwareLazyColumnKt$LadderGestureAwareLazyColumn$1$1$3$2", m3645f = "LadderGestureAwareLazyColumn.kt", m3646l = {EnumC7081g.SDK_ASSET_ILLUSTRATION_MD_ERROR_ATTEMPT_02_VALUE, EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_NAVBAR_VALUE}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.shared.tradeladder.ui.ladder.gestures.LadderGestureAwareLazyColumnKt$LadderGestureAwareLazyColumn$1$1$3$2 */
/* loaded from: classes12.dex */
final class C40962x97e0dc52 extends ContinuationImpl7 implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    C40962x97e0dc52(Animatable<Float, AnimationVectors2> animatable, float f, float f2, Animatable<Float, AnimationVectors2> animatable2, float f3, Continuation<? super C40962x97e0dc52> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new C40962x97e0dc52(this.$selectedPendingOrderXOffset, this.$dragX, this.$draggableLengthForDelete, this.$selectedPendingOrderYOffset, this.$currentDraggedItemOffset, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((C40962x97e0dc52) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }

...
public final class IntPreference {
    ...
    public IntPreference(SharedPreferences preferences, String key, int i) {
        ...
        this.key = key;
        this.defaultValue = i;
        Observable<Integer> observableDistinctUntilChanged = Observable.create(new ObservableOnSubscribe() { // from class: com.robinhood.prefs.IntPreference$changes$1
            /* JADX WARN: Type inference failed for: r0v1, types: [com.robinhood.prefs.IntPreference$changes$1$cancellable$1, io.reactivex.functions.Cancellable] */
            @Override // io.reactivex.ObservableOnSubscribe
            public final void subscribe(final ObservableEmitter<Integer> emitter) {
                Intrinsics.checkNotNullParameter(emitter, "emitter");
                final IntPreference intPreference = this.this$0;
...

                    {
                        this.listener = new SharedPreferences.OnSharedPreferenceChangeListener() { // from class: com.robinhood.prefs.IntPreference$changes$1$cancellable$1$listener$1
                            ...
                            public final void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String str) {
                                if (Intrinsics.areEqual(str, intPreference.key)) {
                                    emitter.onNext(Integer.valueOf(sharedPreferences.getInt(str, intPreference.defaultValue)));
                                }
                            }
                        };
                    }
                ...
                emitter.onNext(Integer.valueOf(this.this$0.get()));

...
@DebugMetadata(m3644c = "com.robinhood.store.futures.marketdata.FuturesMarketDataStore$getProductHistorical$2", m3645f = "FuturesMarketDataStore.kt", m3646l = {}, m3647m = "invokeSuspend")
@SourceDebugExtension
/* renamed from: com.robinhood.store.futures.marketdata.FuturesMarketDataStore$getProductHistorical$2, reason: use source file name */
/* loaded from: classes12.dex */
final class FuturesMarketDataStore5 extends ContinuationImpl7 implements Function2<List<? extends ApiFuturesHistorical>, Continuation<? super Unit>, Object> {
    /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ FuturesMarketDataStore this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    FuturesMarketDataStore5(FuturesMarketDataStore futuresMarketDataStore, Continuation<? super FuturesMarketDataStore5> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        FuturesMarketDataStore5 futuresMarketDataStore5 = new FuturesMarketDataStore5(this.this$0, continuation);
        futuresMarketDataStore5.L$0 = obj;
        return futuresMarketDataStore5;
    }
    ...
    public final Object invoke2(List<ApiFuturesHistorical> list, Continuation<? super Unit> continuation) {
        return ((FuturesMarketDataStore5) create(list, continuation)).invokeSuspend(Unit.INSTANCE);
    }

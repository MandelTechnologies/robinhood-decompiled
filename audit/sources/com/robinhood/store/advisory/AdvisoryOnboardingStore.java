...
import advisory.proto.p008v1.GetIRAManagementStyleSelectionRequestDto;
import advisory.proto.p008v1.GetIRAManagementStyleSelectionResponseDto;
import advisory.proto.p008v1.GetStrategiesValuePropsRequestDto;
import advisory.proto.p008v1.GetStrategiesValuePropsResponseDto;
...
import com.robinhood.models.advisory.p304db.onboarding.IraManagementStyleSelectionData2;
import com.robinhood.models.advisory.p304db.onboarding.StrategiesValuePropsData;
import com.robinhood.models.advisory.p304db.onboarding.StrategiesValuePropsData2;
...
/* compiled from: AdvisoryOnboardingStore.kt */
@Metadata(m3635d1 = {"\u0000z\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010%\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0007\b\u0007\u0018\u00002\u00020\u0001B!\b\u0007\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0004\b\b\u0010\tJ\u001e\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\u00142\u0006\u0010\u0015\u001a\u00020\fH\u0086@¢\u0006\u0002\u0010\u0016J\u0016\u0010\u0017\u001a\u00020\u00182\u0006\u0010\u0013\u001a\u00020\u0014H\u0086@¢\u0006\u0002\u0010\u0019J\u000e\u0010\u001a\u001a\u00020\u001bH\u0086@¢\u0006\u0002\u0010\u001cJ\u0016\u0010\u001d\u001a\u00020\u001e2\u0006\u0010\u001f\u001a\u00020 H\u0086@¢\u0006\u0002\u0010!J\u0018\u0010\"\u001a\u00020#2\b\u0010$\u001a\u0004\u0018\u00010 H\u0086@¢\u0006\u0002\u0010!J\u0016\u0010%\u001a\u00020&2\u0006\u0010'\u001a\u00020\u0014H\u0086@¢\u0006\u0002\u0010\u0019J\u0016\u0010(\u001a\u00020)2\u0006\u0010\u0015\u001a\u00020\f2\u0006\u0010*\u001a\u00020\rJ\u000e\u0010+\u001a\u00020)2\u0006\u0010\u0015\u001a\u00020\fJ\u001e\u0010,\u001a\u00020)2\u0006\u0010\u0015\u001a\u00020\f2\u0006\u0010'\u001a\u00020\u00142\u0006\u0010-\u001a\u00020 J\u0010\u0010.\u001a\u0004\u0018\u00010\r2\u0006\u0010\u0015\u001a\u00020\fJ\u0016\u0010/\u001a\n\u0018\u00010\u000fj\u0004\u0018\u0001`\u00102\u0006\u0010\u0015\u001a\u00020\fR\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\n\u001a\u000e\u0012\u0004\u0012\u00020\f\u0012\u0004\u0012\u00020\r0\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u001e\u0010\u000e\u001a\u0012\u0012\u0004\u0012\u00020\f\u0012\b\u0012\u00060\u000fj\u0002`\u00100\u000bX\u0082\u0004¢\u0006\u0002\n\u0000¨\u00060"}, m3636d2 = {"Lcom/robinhood/store/advisory/AdvisoryOnboardingStore;", "Lcom/robinhood/store/Store;", "advisoryApi", "Lcom/robinhood/android/advisory/api/AdvisoryApi;", "advisoryService", "Ladvisory/proto/v1/AdvisoryService;", "storeBundle", "Lcom/robinhood/store/StoreBundle;", "<init>", "(Lcom/robinhood/android/advisory/api/AdvisoryApi;Ladvisory/proto/v1/AdvisoryService;Lcom/robinhood/store/StoreBundle;)V", "firstDepositConfigMap", "", "Ljava/util/UUID;", "Lcom/robinhood/store/advisory/AdvisoryFirstDepositConfig;", "fundingEventContextMap", "Lcom/robinhood/rosetta/eventlogging/Context;", "Lcom/robinhood/rosetta/eventlogging/EventContext;", "streamPortfolioRevealViewModel", "Lcom/robinhood/models/advisory/api/portfolio/ApiPortfolioRevealViewModel;", "accountType", "Lcom/robinhood/models/api/BrokerageAccountType;", "applicationId", "(Lcom/robinhood/models/api/BrokerageAccountType;Ljava/util/UUID;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "streamFirstTimeContributionViewModel", "Lcom/robinhood/models/advisory/api/contribution/ApiAdvisoryFirstTimeContributionViewModel;", "(Lcom/robinhood/models/api/BrokerageAccountType;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "streamAccountTypeRecommendationIntro", "Lcom/robinhood/models/advisory/api/onboarding/recommendation/ApiAccountTypeRecommendationIntroViewModel;", "(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "streamAccountTypeRecommendationResults", "Lcom/robinhood/models/advisory/api/onboarding/recommendation/ApiAccountTypeRecommendationResults;", "context", "", "(Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "streamValueProps", "Lcom/robinhood/models/advisory/db/onboarding/StrategiesValuePropsData;", "campaign", "streamIraManagementStyleSelection", "Lcom/robinhood/models/advisory/db/onboarding/IraManagementStyleSelectionData;", "brokerageAccountType", "setFirstDepositConfig", "", "firstDepositConfig", "clearFirstDepositConfig", "setFundingMethodContext", "fundingTypeIdentifier", "fetchFirstDepositConfig", "fetchFundingMethodContext", "lib-store-advisory_externalDebug"}, m3637k = 1, m3638mv = {2, 1, 0}, m3640xi = 48)
/* loaded from: classes12.dex */
public final class AdvisoryOnboardingStore extends Store {
    private final AdvisoryApi advisoryApi;
    private final AdvisoryService advisoryService;
    private final Map<UUID, AdvisoryFirstDepositConfig> firstDepositConfigMap;
    private final Map<UUID, Context> fundingEventContextMap;

    /* compiled from: AdvisoryOnboardingStore.kt */
    @Metadata(m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "com.robinhood.store.advisory.AdvisoryOnboardingStore", m3645f = "AdvisoryOnboardingStore.kt", m3646l = {75}, m3647m = "streamIraManagementStyleSelection")
    /* renamed from: com.robinhood.store.advisory.AdvisoryOnboardingStore$streamIraManagementStyleSelection$1 */
    static final class C413191 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        C413191(Continuation<? super C413191> continuation) {
            super(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return AdvisoryOnboardingStore.this.streamIraManagementStyleSelection(null, this);
        }
    }

    /* compiled from: AdvisoryOnboardingStore.kt */
    @Metadata(m3637k = 3, m3638mv = {2, 1, 0}, m3640xi = 48)
    @DebugMetadata(m3644c = "com.robinhood.store.advisory.AdvisoryOnboardingStore", m3645f = "AdvisoryOnboardingStore.kt", m3646l = {65}, m3647m = "streamValueProps")
    /* renamed from: com.robinhood.store.advisory.AdvisoryOnboardingStore$streamValueProps$1 */
    static final class C413201 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        C413201(Continuation<? super C413201> continuation) {
            super(continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            this.result = obj;
            this.label |= Integer.MIN_VALUE;
            return AdvisoryOnboardingStore.this.streamValueProps(null, this);
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AdvisoryOnboardingStore(AdvisoryApi advisoryApi, AdvisoryService advisoryService, StoreBundle storeBundle) {
        super(storeBundle);
        ...
        this.firstDepositConfigMap = new LinkedHashMap();
        this.fundingEventContextMap = new LinkedHashMap();
    }

    public final Object streamPortfolioRevealViewModel(BrokerageAccountType brokerageAccountType, UUID uuid, Continuation<? super ApiPortfolioRevealViewModel> continuation) {
        return this.advisoryApi.getPortfolioRevealViewModel(brokerageAccountType, uuid, continuation);
    }

    public final Object streamFirstTimeContributionViewModel(BrokerageAccountType brokerageAccountType, Continuation<? super ApiAdvisoryFirstTimeContributionViewModel> continuation) {
        return this.advisoryApi.getFirstTimeContributionViewModel(brokerageAccountType, continuation);
    }

    public final Object streamAccountTypeRecommendationIntro(Continuation<? super ApiAccountTypeRecommendationIntroViewModel> continuation) {
        return this.advisoryApi.getAccountTypeRecommendationIntro(continuation);
    }

    public final Object streamAccountTypeRecommendationResults(String str, Continuation<? super ApiAccountTypeRecommendationResults> continuation) {
        return this.advisoryApi.getAccountTypeRecommendationResults(str, continuation);
    }
    ...
    */
    public final Object streamValueProps(String str, Continuation<? super StrategiesValuePropsData> continuation) {
        C413201 c413201;
        if (continuation instanceof C413201) {
            c413201 = (C413201) continuation;
            int i = c413201.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c413201.label = i - Integer.MIN_VALUE;
            } else {
                c413201 = new C413201(continuation);
            }
        }
        Object objGetStrategiesValueProps = c413201.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c413201.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(objGetStrategiesValueProps);
            AdvisoryService advisoryService = this.advisoryService;
            GetStrategiesValuePropsRequestDto getStrategiesValuePropsRequestDto = new GetStrategiesValuePropsRequestDto(str);
            c413201.label = 1;
            objGetStrategiesValueProps = advisoryService.GetStrategiesValueProps(getStrategiesValuePropsRequestDto, c413201);
        ...
        return StrategiesValuePropsData2.toDbModel((GetStrategiesValuePropsResponseDto) objGetStrategiesValueProps);
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final Object streamIraManagementStyleSelection(BrokerageAccountType brokerageAccountType, Continuation<? super IraManagementStyleSelectionData> continuation) {
        C413191 c413191;
        if (continuation instanceof C413191) {
            c413191 = (C413191) continuation;
            int i = c413191.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c413191.label = i - Integer.MIN_VALUE;
            } else {
                c413191 = new C413191(continuation);
            }
        }
        Object objGetIRAManagementStyleSelection = c413191.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c413191.label;
        if (i2 == 0) {
            ResultKt.throwOnFailure(objGetIRAManagementStyleSelection);
            AdvisoryService advisoryService = this.advisoryService;
            GetIRAManagementStyleSelectionRequestDto getIRAManagementStyleSelectionRequestDto = new GetIRAManagementStyleSelectionRequestDto(BrokerageAccountTypeDto.INSTANCE.fromProto(BrokerageAccountTypes3.toProtobuf(brokerageAccountType)));
            c413191.label = 1;
            objGetIRAManagementStyleSelection = advisoryService.GetIRAManagementStyleSelection(getIRAManagementStyleSelectionRequestDto, c413191);
        ...
        return IraManagementStyleSelectionData2.toDbModel((GetIRAManagementStyleSelectionResponseDto) objGetIRAManagementStyleSelection);
    }

    public final void setFirstDepositConfig(UUID applicationId, AdvisoryFirstDepositConfig firstDepositConfig) {
        Intrinsics.checkNotNullParameter(applicationId, "applicationId");
        Intrinsics.checkNotNullParameter(firstDepositConfig, "firstDepositConfig");
        this.firstDepositConfigMap.put(applicationId, firstDepositConfig);
    }

    public final void clearFirstDepositConfig(UUID applicationId) {
        Intrinsics.checkNotNullParameter(applicationId, "applicationId");
        this.firstDepositConfigMap.remove(applicationId);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final void setFundingMethodContext(UUID applicationId, BrokerageAccountType brokerageAccountType, String fundingTypeIdentifier) {
        Intrinsics.checkNotNullParameter(applicationId, "applicationId");
        Intrinsics.checkNotNullParameter(brokerageAccountType, "brokerageAccountType");
        Intrinsics.checkNotNullParameter(fundingTypeIdentifier, "fundingTypeIdentifier");
        String str = null;
        String str2 = null;
        int i = 0;
        int i2 = 0;

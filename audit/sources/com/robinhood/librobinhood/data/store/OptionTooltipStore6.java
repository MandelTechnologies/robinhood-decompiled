...
@DebugMetadata(m3644c = "com.robinhood.librobinhood.data.store.OptionTooltipStore$getOptionSimulatedReturnTooltipEndpoint$1", m3645f = "OptionTooltipStore.kt", m3646l = {67}, m3647m = "invokeSuspend")
/* renamed from: com.robinhood.librobinhood.data.store.OptionTooltipStore$getOptionSimulatedReturnTooltipEndpoint$1, reason: use source file name */
/* loaded from: classes13.dex */
final class OptionTooltipStore6 extends ContinuationImpl7 implements Function2<Tuples3<? extends String, ? extends ApiOptionTooltip6, ? extends String>, Continuation<? super Optional<? extends OptionTooltip>>, Object> {
    /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ OptionTooltipStore this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    OptionTooltipStore6(OptionTooltipStore optionTooltipStore, Continuation<? super OptionTooltipStore6> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        OptionTooltipStore6 optionTooltipStore6 = new OptionTooltipStore6(this.this$0, continuation);
        optionTooltipStore6.L$0 = obj;
        return optionTooltipStore6;
    }
    ...
    public final Object invoke2(Tuples3<String, ? extends ApiOptionTooltip6, String> tuples3, Continuation<? super Optional<OptionTooltip>> continuation) {
        return ((OptionTooltipStore6) create(tuples3, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = optionsProduct.getOptionSimulatedReturnTooltip(str, serverValue, str2, this);

...
@DebugMetadata(m3644c = "com.robinhood.librobinhood.data.store.MerchantOfferStore$halfSheetEndpoint$2", m3645f = "MerchantOfferStore.kt", m3646l = {}, m3647m = "invokeSuspend")
@SourceDebugExtension
/* loaded from: classes13.dex */
final class MerchantOfferStore$halfSheetEndpoint$2 extends ContinuationImpl7 implements Function2<PaginatedResult<? extends ApiMerchantOfferV2>, Continuation<? super Unit>, Object> {
    /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ MerchantOfferStore this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    MerchantOfferStore$halfSheetEndpoint$2(MerchantOfferStore merchantOfferStore, Continuation<? super MerchantOfferStore$halfSheetEndpoint$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        MerchantOfferStore$halfSheetEndpoint$2 merchantOfferStore$halfSheetEndpoint$2 = new MerchantOfferStore$halfSheetEndpoint$2(this.this$0, continuation);
        merchantOfferStore$halfSheetEndpoint$2.L$0 = obj;
        return merchantOfferStore$halfSheetEndpoint$2;
    }
    ...
    public final Object invoke2(PaginatedResult<ApiMerchantOfferV2> paginatedResult, Continuation<? super Unit> continuation) {
        return ((MerchantOfferStore$halfSheetEndpoint$2) create(paginatedResult, continuation)).invokeSuspend(Unit.INSTANCE);
    }

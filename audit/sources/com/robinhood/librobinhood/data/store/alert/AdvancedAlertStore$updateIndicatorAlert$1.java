...
@DebugMetadata(m3644c = "com.robinhood.librobinhood.data.store.alert.AdvancedAlertStore$updateIndicatorAlert$1", m3645f = "AdvancedAlertStore.kt", m3646l = {EnumC7081g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_ONLY_DARK_APPEARANCE_VALUE}, m3647m = "invokeSuspend")
/* loaded from: classes13.dex */
final class AdvancedAlertStore$updateIndicatorAlert$1 extends ContinuationImpl7 implements Function2<Tuples2<? extends UUID, ? extends ApiCreateIndicatorAlertRequest>, Continuation<? super Optional<? extends ApiAdvancedAlert>>, Object> {
    /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ AdvancedAlertStore this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    AdvancedAlertStore$updateIndicatorAlert$1(AdvancedAlertStore advancedAlertStore, Continuation<? super AdvancedAlertStore$updateIndicatorAlert$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        AdvancedAlertStore$updateIndicatorAlert$1 advancedAlertStore$updateIndicatorAlert$1 = new AdvancedAlertStore$updateIndicatorAlert$1(this.this$0, continuation);
        advancedAlertStore$updateIndicatorAlert$1.L$0 = obj;
        return advancedAlertStore$updateIndicatorAlert$1;
    }
    ...
    public final Object invoke2(Tuples2<UUID, ApiCreateIndicatorAlertRequest> tuples2, Continuation<? super Optional<ApiAdvancedAlert>> continuation) {
        return ((AdvancedAlertStore$updateIndicatorAlert$1) create(tuples2, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.L$0 = companion2;
            this.label = 1;
            Object objUpdateAdvancedAlertSettingsV2 = advancedAlertApi.updateAdvancedAlertSettingsV2(uuid, uuidRandomUUID, true, apiCreateIndicatorAlertRequest, this);
            if (objUpdateAdvancedAlertSettingsV2 == coroutine_suspended) {
                return coroutine_suspended;
            }
            companion = companion2;
            obj = objUpdateAdvancedAlertSettingsV2;
        } else {
            if (i != 1) {

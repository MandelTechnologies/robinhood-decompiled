...
@DebugMetadata(m3644c = "com.robinhood.librobinhood.data.store.bonfire.PaycheckStore$rhsPaycheckEndpointV2$2", m3645f = "PaycheckStore.kt", m3646l = {}, m3647m = "invokeSuspend")
@SourceDebugExtension
/* renamed from: com.robinhood.librobinhood.data.store.bonfire.PaycheckStore$rhsPaycheckEndpointV2$2, reason: use source file name */
/* loaded from: classes13.dex */
final class PaycheckStore3 extends ContinuationImpl7 implements Function2<PaginatedResult<? extends ApiPaycheckV2>, Continuation<? super Unit>, Object> {
    /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ PaycheckStore this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    PaycheckStore3(PaycheckStore paycheckStore, Continuation<? super PaycheckStore3> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        PaycheckStore3 paycheckStore3 = new PaycheckStore3(this.this$0, continuation);
        paycheckStore3.L$0 = obj;
        return paycheckStore3;
    }
    ...
    public final Object invoke2(PaginatedResult<ApiPaycheckV2> paginatedResult, Continuation<? super Unit> continuation) {
        return ((PaycheckStore3) create(paginatedResult, continuation)).invokeSuspend(Unit.INSTANCE);
    }
